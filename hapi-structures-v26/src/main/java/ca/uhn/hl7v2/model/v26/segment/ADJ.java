    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(SI.class, true, 1, 4, new Object[]{ getMessage() }, "Adjustment Sequence Number");
                                              this.add(IS.class, true, 1, 4, new Object[]{ getMessage(), new Integer(564) }, "Adjustment Category");
                                  ...
                                  this.add(NM.class, false, 1, 250, new Object[]{ getMessage() }, "Substitute Value");
                                              this.add(IS.class, false, 1, 4, new Object[]{ getMessage(), new Integer(569) }, "Adjustment Action");
