 ...
 * <ul>
                         ...
                         * <li>2: AUT (Authorization Information) <b>optional  choice</b></li>
...
public class EHC_E24_PSL_ITEM_INFO extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating EHC_E24_PSL_ITEM_INFO - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * </p>
     */ 
    public java.util.List<EHC_E24_PAYER_ADJUSTMENT> getPAYER_ADJUSTMENTAll() throws HL7Exception {
