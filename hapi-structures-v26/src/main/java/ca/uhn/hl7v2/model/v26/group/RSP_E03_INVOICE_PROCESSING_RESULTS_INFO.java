 ...
 * </p>
 * <ul>
                         * <li>1: IPR (Invoice Processing Results) <b>  choice</b></li>
 * </ul>
 * <p>
...
public class RSP_E03_INVOICE_PROCESSING_RESULTS_INFO extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(IPR.class, true, false, true);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating RSP_E03_INVOICE_PROCESSING_RESULTS_INFO - this is probably a bug in the source code generator.", e);
       }
    }
