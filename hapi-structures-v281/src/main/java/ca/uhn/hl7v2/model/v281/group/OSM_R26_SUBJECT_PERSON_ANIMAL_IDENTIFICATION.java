...
/**
 * <p>Represents a OSM_R26_SUBJECT_PERSON_ANIMAL_IDENTIFICATION group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>4: OSM_R26_PATIENT_OBSERVATION (a Group object) <b>optional repeating </b></li>
                         * <li>5: NK1 (Next of Kin / Associated Parties) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class OSM_R26_SUBJECT_PERSON_ANIMAL_IDENTIFICATION extends AbstractGroup {

    /** 
     * Creates a new OSM_R26_SUBJECT_PERSON_ANIMAL_IDENTIFICATION group
     */
    public OSM_R26_SUBJECT_PERSON_ANIMAL_IDENTIFICATION(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(OSM_R26_PATIENT_OBSERVATION.class, false, true, false);
                                  this.add(NK1.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating OSM_R26_SUBJECT_PERSON_ANIMAL_IDENTIFICATION - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public OSM_R26_PATIENT_OBSERVATION getPATIENT_OBSERVATION() { 
       OSM_R26_PATIENT_OBSERVATION retVal = getTyped("PATIENT_OBSERVATION", OSM_R26_PATIENT_OBSERVATION.class);
       return retVal;
    }
    ...
    public OSM_R26_PATIENT_OBSERVATION getPATIENT_OBSERVATION(int rep) { 
       OSM_R26_PATIENT_OBSERVATION retVal = getTyped("PATIENT_OBSERVATION", rep, OSM_R26_PATIENT_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<OSM_R26_PATIENT_OBSERVATION> getPATIENT_OBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("PATIENT_OBSERVATION", OSM_R26_PATIENT_OBSERVATION.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertPATIENT_OBSERVATION(OSM_R26_PATIENT_OBSERVATION structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public OSM_R26_PATIENT_OBSERVATION insertPATIENT_OBSERVATION(int rep) throws HL7Exception { 
       return (OSM_R26_PATIENT_OBSERVATION)super.insertRepetition("PATIENT_OBSERVATION", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public OSM_R26_PATIENT_OBSERVATION removePATIENT_OBSERVATION(int rep) throws HL7Exception { 
       return (OSM_R26_PATIENT_OBSERVATION)super.removeRepetition("PATIENT_OBSERVATION", rep);
    }
