 ...
 * <ul>
     ...
     * <li>AL1-6: Identification Date (NULLDT) <b>optional </b>
 * </ul>
 */
...
public class AL1 extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(SI.class, true, 1, 0, new Object[]{ getMessage() }, "Set ID - AL1");
                                  ...
                                  this.add(NULLDT.class, false, 1, 0, new Object[]{ getMessage() }, "Identification Date");
     ...
     */
    public NULLDT getIdentificationDate() { 
     ...
     * AL1-6: "Identification Date" - creates it if necessary
     */
    public NULLDT getAl16_IdentificationDate() { 
		NULLDT retVal = this.getTypedField(6, 0);
		return retVal;
    }
