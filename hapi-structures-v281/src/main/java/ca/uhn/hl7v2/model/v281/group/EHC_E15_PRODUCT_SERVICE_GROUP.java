...
public class EHC_E15_PRODUCT_SERVICE_GROUP extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(EHC_E15_PSL_ITEM_INFO.class, true, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating EHC_E15_PRODUCT_SERVICE_GROUP - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * </p>
     */ 
    public java.util.List<EHC_E15_PSL_ITEM_INFO> getPSL_ITEM_INFOAll() throws HL7Exception {
