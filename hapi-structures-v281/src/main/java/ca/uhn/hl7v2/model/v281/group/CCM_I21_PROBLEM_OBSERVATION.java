...
/**
 * <p>Represents a CCM_I21_PROBLEM_OBSERVATION group structure (a Group object).
...
public class CCM_I21_PROBLEM_OBSERVATION extends AbstractGroup {

    /** 
     * Creates a new CCM_I21_PROBLEM_OBSERVATION group
     */
    public CCM_I21_PROBLEM_OBSERVATION(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating CCM_I21_PROBLEM_OBSERVATION - this is probably a bug in the source code generator.", e);
       }
    }
