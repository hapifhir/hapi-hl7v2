 ...
 * <ul>
     ...
     * <li>PR1-6: Procedure Functional Type (CWE) <b>optional </b>
     * <li>PR1-7: Procedure Minutes (NM) <b>optional </b>
     * <li>PR1-8: Anesthesiologist (NULLDT) <b>optional </b>
     * <li>PR1-9: Anesthesia Code (CWE) <b>optional </b>
     ...
     * <li>PR1-17: Procedure DRG Type (CWE) <b>optional </b>
     ...
     * <li>PR1-21: DRG Procedure Determination Status (CWE) <b>optional </b>
     * <li>PR1-22: DRG Procedure Relevance (CWE) <b>optional </b>
     * <li>PR1-23: Treating Organizational Unit (PL) <b>optional repeating</b>
     * <li>PR1-24: Respiratory Within Surgery (ID) <b>optional </b>
     * <li>PR1-25: Parent Procedure ID (EI) <b>optional </b>
 * </ul>
 */
...
public class PR1 extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(SI.class, true, 1, 0, new Object[]{ getMessage() }, "Set ID - PR1");
                                  this.add(NULLDT.class, false, 1, 0, new Object[]{ getMessage() }, "Procedure Coding Method");
                                  this.add(CNE.class, true, 1, 0, new Object[]{ getMessage() }, "Procedure Code");
                                  this.add(NULLDT.class, false, 1, 0, new Object[]{ getMessage() }, "Procedure Description");
                                  this.add(DTM.class, true, 1, 0, new Object[]{ getMessage() }, "Procedure Date/Time");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Procedure Functional Type");
                                  this.add(NM.class, false, 1, 0, new Object[]{ getMessage() }, "Procedure Minutes");
                                  this.add(NULLDT.class, false, 1, 0, new Object[]{ getMessage() }, "Anesthesiologist");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Anesthesia Code");
                                  this.add(NM.class, false, 1, 0, new Object[]{ getMessage() }, "Anesthesia Minutes");
                                  ...
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Consent Code");
                                  this.add(NM.class, false, 1, 0, new Object[]{ getMessage() }, "Procedure Priority");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Associated Diagnosis Code");
                                  this.add(CNE.class, false, 0, 0, new Object[]{ getMessage() }, "Procedure Code Modifier");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Procedure DRG Type");
                                  this.add(CWE.class, false, 0, 0, new Object[]{ getMessage() }, "Tissue Type Code");
                                  this.add(EI.class, false, 1, 0, new Object[]{ getMessage() }, "Procedure Identifier");
                                              this.add(ID.class, false, 1, 0, new Object[]{ getMessage(), new Integer(206) }, "Procedure Action Code");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "DRG Procedure Determination Status");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "DRG Procedure Relevance");
                                  this.add(PL.class, false, 0, 0, new Object[]{ getMessage() }, "Treating Organizational Unit");
                                              this.add(ID.class, false, 1, 0, new Object[]{ getMessage(), new Integer(136) }, "Respiratory Within Surgery");
                                  this.add(EI.class, false, 1, 0, new Object[]{ getMessage() }, "Parent Procedure ID");
    ...
    public PL[] getTreatingOrganizationalUnit() {
    	PL[] retVal = this.getTypedField(23, new PL[0]);
    	return retVal;
    }
    ...
    public PL getTreatingOrganizationalUnit(int rep) { 
		PL retVal = this.getTypedField(23, rep);
		return retVal;
    }
    ...
    protected Type createNewTypeWithoutReflection(int field) {
       switch (field) {
          ...
          case 22: return new PL(getMessage());
