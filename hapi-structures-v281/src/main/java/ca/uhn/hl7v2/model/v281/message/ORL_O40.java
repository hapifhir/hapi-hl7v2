...
/**
 * <p>Represents a ORL_O40 message structure (see chapter 4.4.13.1). This structure contains the 
 ...
 * <ul>
		                 ...
		                 * <li>7: ORL_O40_RESPONSE (a Group object) <b>optional </b> </li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class ORL_O40 extends AbstractMessage  {

    /**
     * Creates a new ORL_O40 message with DefaultModelClassFactory. 
     */ 
    public ORL_O40() { 
    ...
    /** 
     * Creates a new ORL_O40 message with custom ModelClassFactory.
     */
    public ORL_O40(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(ORL_O40_RESPONSE.class, false, false);
	       } catch(HL7Exception e) {
          log.error("Unexpected error creating ORL_O40 - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     *
     */
    public ORL_O40_RESPONSE getRESPONSE() { 
       return getTyped("RESPONSE", ORL_O40_RESPONSE.class);
    }
