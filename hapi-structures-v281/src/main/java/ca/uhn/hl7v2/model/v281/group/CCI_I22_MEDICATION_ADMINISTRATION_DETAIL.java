...
/**
 * <p>Represents a CCI_I22_MEDICATION_ADMINISTRATION_DETAIL group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>3: CCI_I22_MEDICATION_ADMINISTRATION_OBSERVATION (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class CCI_I22_MEDICATION_ADMINISTRATION_DETAIL extends AbstractGroup {

    /** 
     * Creates a new CCI_I22_MEDICATION_ADMINISTRATION_DETAIL group
     */
    public CCI_I22_MEDICATION_ADMINISTRATION_DETAIL(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CCI_I22_MEDICATION_ADMINISTRATION_OBSERVATION.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating CCI_I22_MEDICATION_ADMINISTRATION_DETAIL - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public CCI_I22_MEDICATION_ADMINISTRATION_OBSERVATION getMEDICATION_ADMINISTRATION_OBSERVATION() { 
       CCI_I22_MEDICATION_ADMINISTRATION_OBSERVATION retVal = getTyped("MEDICATION_ADMINISTRATION_OBSERVATION", CCI_I22_MEDICATION_ADMINISTRATION_OBSERVATION.class);
       return retVal;
    }
    ...
    public CCI_I22_MEDICATION_ADMINISTRATION_OBSERVATION getMEDICATION_ADMINISTRATION_OBSERVATION(int rep) { 
       CCI_I22_MEDICATION_ADMINISTRATION_OBSERVATION retVal = getTyped("MEDICATION_ADMINISTRATION_OBSERVATION", rep, CCI_I22_MEDICATION_ADMINISTRATION_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<CCI_I22_MEDICATION_ADMINISTRATION_OBSERVATION> getMEDICATION_ADMINISTRATION_OBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("MEDICATION_ADMINISTRATION_OBSERVATION", CCI_I22_MEDICATION_ADMINISTRATION_OBSERVATION.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertMEDICATION_ADMINISTRATION_OBSERVATION(CCI_I22_MEDICATION_ADMINISTRATION_OBSERVATION structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public CCI_I22_MEDICATION_ADMINISTRATION_OBSERVATION insertMEDICATION_ADMINISTRATION_OBSERVATION(int rep) throws HL7Exception { 
       return (CCI_I22_MEDICATION_ADMINISTRATION_OBSERVATION)super.insertRepetition("MEDICATION_ADMINISTRATION_OBSERVATION", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public CCI_I22_MEDICATION_ADMINISTRATION_OBSERVATION removeMEDICATION_ADMINISTRATION_OBSERVATION(int rep) throws HL7Exception { 
       return (CCI_I22_MEDICATION_ADMINISTRATION_OBSERVATION)super.removeRepetition("MEDICATION_ADMINISTRATION_OBSERVATION", rep);
    }
