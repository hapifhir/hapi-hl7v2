...
/**
 * <p>Represents a CQU_I19_RESOURCE_DETAIL group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>5: CQU_I19_RESOURCE_OBSERVATION (a Group object) <b>optional repeating </b></li>
 * </ul>
 * <p>
...
public class CQU_I19_RESOURCE_DETAIL extends AbstractGroup {

    /** 
     * Creates a new CQU_I19_RESOURCE_DETAIL group
     */
    public CQU_I19_RESOURCE_DETAIL(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CQU_I19_RESOURCE_OBSERVATION.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating CQU_I19_RESOURCE_DETAIL - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public CQU_I19_RESOURCE_OBSERVATION getRESOURCE_OBSERVATION() { 
       CQU_I19_RESOURCE_OBSERVATION retVal = getTyped("RESOURCE_OBSERVATION", CQU_I19_RESOURCE_OBSERVATION.class);
       return retVal;
    }
    ...
    public CQU_I19_RESOURCE_OBSERVATION getRESOURCE_OBSERVATION(int rep) { 
       CQU_I19_RESOURCE_OBSERVATION retVal = getTyped("RESOURCE_OBSERVATION", rep, CQU_I19_RESOURCE_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<CQU_I19_RESOURCE_OBSERVATION> getRESOURCE_OBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("RESOURCE_OBSERVATION", CQU_I19_RESOURCE_OBSERVATION.class);
    } 
     ...
     */
    public void insertRESOURCE_OBSERVATION(CQU_I19_RESOURCE_OBSERVATION structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public CQU_I19_RESOURCE_OBSERVATION insertRESOURCE_OBSERVATION(int rep) throws HL7Exception { 
       return (CQU_I19_RESOURCE_OBSERVATION)super.insertRepetition("RESOURCE_OBSERVATION", rep);
    }
     ...
     */
    public CQU_I19_RESOURCE_OBSERVATION removeRESOURCE_OBSERVATION(int rep) throws HL7Exception { 
       return (CQU_I19_RESOURCE_OBSERVATION)super.removeRepetition("RESOURCE_OBSERVATION", rep);
    }
