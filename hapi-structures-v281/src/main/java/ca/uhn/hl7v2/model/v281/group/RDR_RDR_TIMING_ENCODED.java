...
/**
 * <p>Represents a RDR_RDR_TIMING_ENCODED group structure (a Group object).
...
public class RDR_RDR_TIMING_ENCODED extends AbstractGroup {

    /** 
     * Creates a new RDR_RDR_TIMING_ENCODED group
     */
    public RDR_RDR_TIMING_ENCODED(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RDR_RDR_TIMING_ENCODED - this is probably a bug in the source code generator.", e);
       }
    }
