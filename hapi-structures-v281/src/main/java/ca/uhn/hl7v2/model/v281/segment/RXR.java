...
public class RXR extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(CWE.class, true, 1, 0, new Object[]{ getMessage() }, "Route");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Administration Site");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Administration Device");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Administration Method");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Routing Instruction");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Administration Site Modifier");
