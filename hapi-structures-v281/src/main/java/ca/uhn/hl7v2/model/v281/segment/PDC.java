...
public class PDC extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(XON.class, true, 0, 0, new Object[]{ getMessage() }, "Manufacturer/Distributor");
                                  this.add(CWE.class, true, 1, 0, new Object[]{ getMessage() }, "Country");
                                  this.add(ST.class, true, 1, 0, new Object[]{ getMessage() }, "Brand Name");
                                  this.add(ST.class, false, 1, 0, new Object[]{ getMessage() }, "Device Family Name");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Generic Name");
                                  this.add(ST.class, false, 0, 0, new Object[]{ getMessage() }, "Model Identifier");
                                  this.add(ST.class, false, 1, 0, new Object[]{ getMessage() }, "Catalogue Identifier");
                                  this.add(ST.class, false, 0, 0, new Object[]{ getMessage() }, "Other Identifier");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Product Code");
                                              this.add(ID.class, false, 1, 0, new Object[]{ getMessage(), new Integer(330) }, "Marketing Basis");
                                  this.add(ST.class, false, 1, 0, new Object[]{ getMessage() }, "Marketing Approval ID");
                                  this.add(CQ.class, false, 1, 0, new Object[]{ getMessage() }, "Labeled Shelf Life");
                                  this.add(CQ.class, false, 1, 0, new Object[]{ getMessage() }, "Expected Shelf Life");
                                  this.add(DTM.class, false, 1, 0, new Object[]{ getMessage() }, "Date First Marketed");
                                  this.add(DTM.class, false, 1, 0, new Object[]{ getMessage() }, "Date Last Marketed");
