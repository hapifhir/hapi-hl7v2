...
public class MOP extends AbstractComposite {
    ...
    /**
     * Returns Monetary  Denomination (component 3).  This is a convenience method that saves you from 
     * casting and handling an exception.
     */
    public ID getMonetaryDenomination() {
     ...
     * casting and handling an exception.
     */
    public ID getMop3_MonetaryDenomination() {
       return getTyped(2, ID.class);
    }
