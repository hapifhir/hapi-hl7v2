...
public class QPD extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(CWE.class, true, 1, 0, new Object[]{ getMessage() }, "Message Query Name");
                                  this.add(ST.class, false, 1, 0, new Object[]{ getMessage() }, "Query Tag");
                                  this.add(Varies.class, false, 1, 0, new Object[]{ getMessage() }, "User Parameters (in successive fields)");
