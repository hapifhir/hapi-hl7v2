...
public class MSA extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                              this.add(ID.class, true, 1, 0, new Object[]{ getMessage(), new Integer(8) }, "Acknowledgment Code");
                                  ...
                                  this.add(NM.class, false, 1, 0, new Object[]{ getMessage() }, "Message Waiting Number");
                                              this.add(ID.class, false, 1, 0, new Object[]{ getMessage(), new Integer(520) }, "Message Waiting Priority");
