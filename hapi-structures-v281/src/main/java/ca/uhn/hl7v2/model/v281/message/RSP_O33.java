...
/**
 * <p>Represents a RSP_O33 message structure (see chapter 4.16.7). This structure contains the 
 ...
 * <ul>
		                 ...
		                 * <li>8: RSP_O33_DONOR (a Group object) <b>optional </b> </li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class RSP_O33 extends AbstractMessage  {

    /**
     * Creates a new RSP_O33 message with DefaultModelClassFactory. 
     */ 
    public RSP_O33() { 
    ...
    /** 
     * Creates a new RSP_O33 message with custom ModelClassFactory.
     */
    public RSP_O33(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(RSP_O33_DONOR.class, false, false);
	       } catch(HL7Exception e) {
          log.error("Unexpected error creating RSP_O33 - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     *
     */
    public RSP_O33_DONOR getDONOR() { 
       return getTyped("DONOR", RSP_O33_DONOR.class);
    }
