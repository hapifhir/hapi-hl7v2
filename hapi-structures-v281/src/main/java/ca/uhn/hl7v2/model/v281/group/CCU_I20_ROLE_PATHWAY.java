...
/**
 * <p>Represents a CCU_I20_ROLE_PATHWAY group structure (a Group object).
...
public class CCU_I20_ROLE_PATHWAY extends AbstractGroup {

    /** 
     * Creates a new CCU_I20_ROLE_PATHWAY group
     */
    public CCU_I20_ROLE_PATHWAY(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating CCU_I20_ROLE_PATHWAY - this is probably a bug in the source code generator.", e);
       }
    }
