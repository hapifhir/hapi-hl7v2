...
/**
 * <p>Represents a PEX_P07_OBSERVATION group structure (a Group object).
...
public class PEX_P07_OBSERVATION extends AbstractGroup {

    /** 
     * Creates a new PEX_P07_OBSERVATION group
     */
    public PEX_P07_OBSERVATION(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PEX_P07_OBSERVATION - this is probably a bug in the source code generator.", e);
       }
    }
