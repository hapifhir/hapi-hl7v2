...
public class BHS extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(ST.class, true, 1, 0, new Object[]{ getMessage() }, "Batch Field Separator");
                                  this.add(ST.class, true, 1, 0, new Object[]{ getMessage() }, "Batch Encoding Characters");
                                  this.add(HD.class, false, 1, 0, new Object[]{ getMessage() }, "Batch Sending Application");
                                  this.add(HD.class, false, 1, 0, new Object[]{ getMessage() }, "Batch Sending Facility");
                                  this.add(HD.class, false, 1, 0, new Object[]{ getMessage() }, "Batch Receiving Application");
                                  this.add(HD.class, false, 1, 0, new Object[]{ getMessage() }, "Batch Receiving Facility");
                                  this.add(DTM.class, false, 1, 0, new Object[]{ getMessage() }, "Batch Creation Date/Time");
                                  this.add(ST.class, false, 1, 0, new Object[]{ getMessage() }, "Batch Security");
                                  this.add(ST.class, false, 1, 0, new Object[]{ getMessage() }, "Batch Name/ID/Type");
                                  this.add(ST.class, false, 1, 0, new Object[]{ getMessage() }, "Batch Comment");
                                  this.add(ST.class, false, 1, 0, new Object[]{ getMessage() }, "Batch Control ID");
                                  this.add(ST.class, false, 1, 0, new Object[]{ getMessage() }, "Reference Batch Control ID");
                                  this.add(HD.class, false, 1, 0, new Object[]{ getMessage() }, "Batch Sending Network Address");
                                  this.add(HD.class, false, 1, 0, new Object[]{ getMessage() }, "Batch Receiving Network Address");
