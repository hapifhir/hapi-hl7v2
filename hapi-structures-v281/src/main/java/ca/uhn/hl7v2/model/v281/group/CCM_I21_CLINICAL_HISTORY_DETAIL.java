...
/**
 * <p>Represents a CCM_I21_CLINICAL_HISTORY_DETAIL group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>13: CCM_I21_CLINICAL_HISTORY_OBSERVATION (a Group object) <b>optional repeating </b></li>
 * </ul>
 * <p>
...
public class CCM_I21_CLINICAL_HISTORY_DETAIL extends AbstractGroup {
     ...
     */
    public CCM_I21_CLINICAL_HISTORY_DETAIL(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CCM_I21_CLINICAL_HISTORY_OBSERVATION.class, false, true, false);
    ...
    public CCM_I21_CLINICAL_HISTORY_OBSERVATION getCLINICAL_HISTORY_OBSERVATION() { 
       CCM_I21_CLINICAL_HISTORY_OBSERVATION retVal = getTyped("CLINICAL_HISTORY_OBSERVATION", CCM_I21_CLINICAL_HISTORY_OBSERVATION.class);
       return retVal;
    }
    ...
    public CCM_I21_CLINICAL_HISTORY_OBSERVATION getCLINICAL_HISTORY_OBSERVATION(int rep) { 
       CCM_I21_CLINICAL_HISTORY_OBSERVATION retVal = getTyped("CLINICAL_HISTORY_OBSERVATION", rep, CCM_I21_CLINICAL_HISTORY_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<CCM_I21_CLINICAL_HISTORY_OBSERVATION> getCLINICAL_HISTORY_OBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("CLINICAL_HISTORY_OBSERVATION", CCM_I21_CLINICAL_HISTORY_OBSERVATION.class);
    } 
     ...
     */
    public void insertCLINICAL_HISTORY_OBSERVATION(CCM_I21_CLINICAL_HISTORY_OBSERVATION structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public CCM_I21_CLINICAL_HISTORY_OBSERVATION insertCLINICAL_HISTORY_OBSERVATION(int rep) throws HL7Exception { 
       return (CCM_I21_CLINICAL_HISTORY_OBSERVATION)super.insertRepetition("CLINICAL_HISTORY_OBSERVATION", rep);
    }
     ...
     */
    public CCM_I21_CLINICAL_HISTORY_OBSERVATION removeCLINICAL_HISTORY_OBSERVATION(int rep) throws HL7Exception { 
       return (CCM_I21_CLINICAL_HISTORY_OBSERVATION)super.removeRepetition("CLINICAL_HISTORY_OBSERVATION", rep);
    }
