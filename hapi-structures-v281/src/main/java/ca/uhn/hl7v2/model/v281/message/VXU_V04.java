...
/**
 * <p>Represents a VXU_V04 message structure (see chapter 4.A.6). This structure contains the 
 ...
 * <ul>
		                 ...
		                 * <li>8: VXU_V04_PATIENT_VISIT (a Group object) <b>optional </b> </li>
		                 * <li>9: GT1 (Guarantor) <b>optional repeating</b> </li>
		                 * <li>10: VXU_V04_INSURANCE (a Group object) <b>optional repeating</b> </li>
		                 * <li>11: VXU_V04_PERSON_OBSERVATION (a Group object) <b>optional repeating</b> </li>
		                 * <li>12: VXU_V04_ORDER (a Group object) <b>optional repeating</b> </li>
 * </ul>
 */
...
public class VXU_V04 extends AbstractMessage  {
    ...
    public VXU_V04_PATIENT_VISIT getPATIENT_VISIT() { 
       return getTyped("PATIENT_VISIT", VXU_V04_PATIENT_VISIT.class);
    }
     ...
     * Returns
     * the first repetition of 
     * PERSON_OBSERVATION (a Group object) - creates it if necessary
     * </p>
     * 
     *
     */
    public VXU_V04_PERSON_OBSERVATION getPERSON_OBSERVATION() { 
       return getTyped("PERSON_OBSERVATION", VXU_V04_PERSON_OBSERVATION.class);
    }
    ...
    public VXU_V04_PERSON_OBSERVATION getPERSON_OBSERVATION(int rep) { 
       return getTyped("PERSON_OBSERVATION", rep, VXU_V04_PERSON_OBSERVATION.class);
    }

    /** 
     * <p>
     * Returns the number of existing repetitions of PERSON_OBSERVATION 
     * </p>
     * 
     */ 
    public int getPERSON_OBSERVATIONReps() { 
    	return getReps("PERSON_OBSERVATION");
    } 

    /** 
     * <p>
     * Returns a non-modifiable List containing all current existing repetitions of PERSON_OBSERVATION.
     * <p>
     * <p>
     * Note that unlike {@link #getPERSON_OBSERVATION()}, this method will not create any reps
     * if none are already present, so an empty list may be returned.
     * </p>
     * 
     */ 
    public java.util.List<VXU_V04_PERSON_OBSERVATION> getPERSON_OBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("PERSON_OBSERVATION", VXU_V04_PERSON_OBSERVATION.class);
    } 

    /**
     * <p>
     * Inserts a specific repetition of PERSON_OBSERVATION (a Group object)
     * </p>
     * 
     *
     * @see AbstractGroup#insertRepetition(Structure, int) 
    ...
    public void insertPERSON_OBSERVATION(VXU_V04_PERSON_OBSERVATION structure, int rep) throws HL7Exception { 
       super.insertRepetition( "PERSON_OBSERVATION", structure, rep);
    }
    ...
    /**
     * <p>
     * Removes a specific repetition of PERSON_OBSERVATION (a Group object)
     * </p>
     * 
     *
     * @see AbstractGroup#removeRepetition(String, int) 
