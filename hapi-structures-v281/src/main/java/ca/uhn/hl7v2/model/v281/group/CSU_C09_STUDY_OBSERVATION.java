 ...
 * </p>
 * <ul>
                         * <li>1: CSU_C09_ORCPRT (a Group object) <b>optional  </b></li>
...
public class CSU_C09_STUDY_OBSERVATION extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(CSU_C09_ORCPRT.class, false, false, false);
    ...
    /**
     * Returns
     * ORCPRT (a Group object) - creates it if necessary
     */
    public CSU_C09_ORCPRT getORCPRT() { 
       CSU_C09_ORCPRT retVal = getTyped("ORCPRT", CSU_C09_ORCPRT.class);
       return retVal;
    }
