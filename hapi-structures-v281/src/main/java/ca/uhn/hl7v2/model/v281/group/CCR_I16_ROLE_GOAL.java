...
/**
 * <p>Represents a CCR_I16_ROLE_GOAL group structure (a Group object).
...
public class CCR_I16_ROLE_GOAL extends AbstractGroup {

    /** 
     * Creates a new CCR_I16_ROLE_GOAL group
     */
    public CCR_I16_ROLE_GOAL(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating CCR_I16_ROLE_GOAL - this is probably a bug in the source code generator.", e);
       }
    }
