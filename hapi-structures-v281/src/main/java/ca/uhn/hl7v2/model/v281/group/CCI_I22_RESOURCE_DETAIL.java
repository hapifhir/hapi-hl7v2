 ...
 * <ul>
                         ...
                         * <li>5: CCI_I22_RESOURCE_OBSERVATION (a Group object) <b>optional repeating </b></li>
 * </ul>
 * <p>
...
public class CCI_I22_RESOURCE_DETAIL extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CCI_I22_RESOURCE_OBSERVATION.class, false, true, false);
    ...
    public CCI_I22_RESOURCE_OBSERVATION getRESOURCE_OBSERVATION() { 
       CCI_I22_RESOURCE_OBSERVATION retVal = getTyped("RESOURCE_OBSERVATION", CCI_I22_RESOURCE_OBSERVATION.class);
       return retVal;
    }
    ...
    public CCI_I22_RESOURCE_OBSERVATION getRESOURCE_OBSERVATION(int rep) { 
       CCI_I22_RESOURCE_OBSERVATION retVal = getTyped("RESOURCE_OBSERVATION", rep, CCI_I22_RESOURCE_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<CCI_I22_RESOURCE_OBSERVATION> getRESOURCE_OBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("RESOURCE_OBSERVATION", CCI_I22_RESOURCE_OBSERVATION.class);
    } 
     ...
     */
    public void insertRESOURCE_OBSERVATION(CCI_I22_RESOURCE_OBSERVATION structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public CCI_I22_RESOURCE_OBSERVATION insertRESOURCE_OBSERVATION(int rep) throws HL7Exception { 
       return (CCI_I22_RESOURCE_OBSERVATION)super.insertRepetition("RESOURCE_OBSERVATION", rep);
    }
     ...
     */
    public CCI_I22_RESOURCE_OBSERVATION removeRESOURCE_OBSERVATION(int rep) throws HL7Exception { 
       return (CCI_I22_RESOURCE_OBSERVATION)super.removeRepetition("RESOURCE_OBSERVATION", rep);
    }
