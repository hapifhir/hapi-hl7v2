...
/**
 * <p>Represents a SRM_S01_OBXPRT group structure (a Group object).
...
public class SRM_S01_OBXPRT extends AbstractGroup {

    /** 
     * Creates a new SRM_S01_OBXPRT group
     */
    public SRM_S01_OBXPRT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating SRM_S01_OBXPRT - this is probably a bug in the source code generator.", e);
       }
    }
