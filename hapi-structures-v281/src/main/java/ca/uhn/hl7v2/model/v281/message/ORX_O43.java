...
/**
 * <p>Represents a ORX_O43 message structure (see chapter 4.4.20). This structure contains the 
 ...
 * <ul>
		                 ...
		                 * <li>7: ORX_O43_RESPONSE (a Group object) <b>optional </b> </li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class ORX_O43 extends AbstractMessage  {

    /**
     * Creates a new ORX_O43 message with DefaultModelClassFactory. 
     */ 
    public ORX_O43() { 
    ...
    /** 
     * Creates a new ORX_O43 message with custom ModelClassFactory.
     */
    public ORX_O43(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(ORX_O43_RESPONSE.class, false, false);
	       } catch(HL7Exception e) {
          log.error("Unexpected error creating ORX_O43 - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     *
     */
    public ORX_O43_RESPONSE getRESPONSE() { 
       return getTyped("RESPONSE", ORX_O43_RESPONSE.class);
    }
