...
public class VAR extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(EI.class, true, 1, 0, new Object[]{ getMessage() }, "Variance Instance ID");
                                  this.add(DTM.class, true, 1, 0, new Object[]{ getMessage() }, "Documented Date/Time");
                                  this.add(DTM.class, false, 1, 0, new Object[]{ getMessage() }, "Stated Variance Date/Time");
                                  this.add(XCN.class, false, 0, 0, new Object[]{ getMessage() }, "Variance Originator");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Variance Classification");
                                  this.add(ST.class, false, 0, 0, new Object[]{ getMessage() }, "Variance Description");
