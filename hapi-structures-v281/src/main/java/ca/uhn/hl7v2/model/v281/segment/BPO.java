...
public class BPO extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(SI.class, true, 1, 0, new Object[]{ getMessage() }, "Set ID - BPO");
                                  ...
                                  this.add(CWE.class, false, 0, 0, new Object[]{ getMessage() }, "BP Indication for Use");
                                              this.add(ID.class, false, 1, 0, new Object[]{ getMessage(), new Integer(136) }, "BP Informed Consent Indicator");
