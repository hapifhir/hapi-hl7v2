...
public class PSH extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(ST.class, true, 1, 0, new Object[]{ getMessage() }, "Report Type");
                                  this.add(ST.class, false, 1, 0, new Object[]{ getMessage() }, "Report Form Identifier");
                                  this.add(DTM.class, true, 1, 0, new Object[]{ getMessage() }, "Report Date");
                                  this.add(DTM.class, false, 1, 0, new Object[]{ getMessage() }, "Report Interval Start Date");
                                  this.add(DTM.class, false, 1, 0, new Object[]{ getMessage() }, "Report Interval End Date");
                                  this.add(CQ.class, false, 1, 0, new Object[]{ getMessage() }, "Quantity Manufactured");
                                  this.add(CQ.class, false, 1, 0, new Object[]{ getMessage() }, "Quantity Distributed");
                                              this.add(ID.class, false, 1, 0, new Object[]{ getMessage(), new Integer(329) }, "Quantity Distributed Method");
                                  this.add(FT.class, false, 1, 0, new Object[]{ getMessage() }, "Quantity Distributed Comment");
                                  this.add(CQ.class, false, 1, 0, new Object[]{ getMessage() }, "Quantity in Use");
                                              this.add(ID.class, false, 1, 0, new Object[]{ getMessage(), new Integer(329) }, "Quantity in Use Method");
                                  this.add(FT.class, false, 1, 0, new Object[]{ getMessage() }, "Quantity in Use Comment");
                                  this.add(NM.class, false, 8, 0, new Object[]{ getMessage() }, "Number of Product Experience Reports Filed by Facility");
                                  this.add(NM.class, false, 8, 0, new Object[]{ getMessage() }, "Number of Product Experience Reports Filed by Distributor");
