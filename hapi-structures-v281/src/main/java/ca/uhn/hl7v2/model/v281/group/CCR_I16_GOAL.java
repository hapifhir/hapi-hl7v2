...
/**
 * <p>Represents a CCR_I16_GOAL group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>3: CCR_I16_ROLE_GOAL (a Group object) <b>optional repeating </b></li>
                         * <li>4: CCR_I16_GOAL_OBSERVATION (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class CCR_I16_GOAL extends AbstractGroup {

    /** 
     * Creates a new CCR_I16_GOAL group
     */
    public CCR_I16_GOAL(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CCR_I16_ROLE_GOAL.class, false, true, false);
                                  this.add(CCR_I16_GOAL_OBSERVATION.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating CCR_I16_GOAL - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public CCR_I16_ROLE_GOAL getROLE_GOAL() { 
       CCR_I16_ROLE_GOAL retVal = getTyped("ROLE_GOAL", CCR_I16_ROLE_GOAL.class);
       return retVal;
    }
    ...
    public CCR_I16_ROLE_GOAL getROLE_GOAL(int rep) { 
       CCR_I16_ROLE_GOAL retVal = getTyped("ROLE_GOAL", rep, CCR_I16_ROLE_GOAL.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<CCR_I16_ROLE_GOAL> getROLE_GOALAll() throws HL7Exception {
    	return getAllAsList("ROLE_GOAL", CCR_I16_ROLE_GOAL.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertROLE_GOAL(CCR_I16_ROLE_GOAL structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public CCR_I16_ROLE_GOAL insertROLE_GOAL(int rep) throws HL7Exception { 
       return (CCR_I16_ROLE_GOAL)super.insertRepetition("ROLE_GOAL", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public CCR_I16_ROLE_GOAL removeROLE_GOAL(int rep) throws HL7Exception { 
       return (CCR_I16_ROLE_GOAL)super.removeRepetition("ROLE_GOAL", rep);
    }
    ...
    public CCR_I16_GOAL_OBSERVATION getGOAL_OBSERVATION() { 
       CCR_I16_GOAL_OBSERVATION retVal = getTyped("GOAL_OBSERVATION", CCR_I16_GOAL_OBSERVATION.class);
       return retVal;
    }
    ...
    public CCR_I16_GOAL_OBSERVATION getGOAL_OBSERVATION(int rep) { 
       CCR_I16_GOAL_OBSERVATION retVal = getTyped("GOAL_OBSERVATION", rep, CCR_I16_GOAL_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<CCR_I16_GOAL_OBSERVATION> getGOAL_OBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("GOAL_OBSERVATION", CCR_I16_GOAL_OBSERVATION.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertGOAL_OBSERVATION(CCR_I16_GOAL_OBSERVATION structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public CCR_I16_GOAL_OBSERVATION insertGOAL_OBSERVATION(int rep) throws HL7Exception { 
       return (CCR_I16_GOAL_OBSERVATION)super.insertRepetition("GOAL_OBSERVATION", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public CCR_I16_GOAL_OBSERVATION removeGOAL_OBSERVATION(int rep) throws HL7Exception { 
       return (CCR_I16_GOAL_OBSERVATION)super.removeRepetition("GOAL_OBSERVATION", rep);
    }
