...
/**
 * <p>Represents a CCR_I16_CLINICAL_HISTORY group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: ORC (Common Order) <b>  </b></li>
                         * <li>2: CCR_I16_CLINICAL_HISTORY_DETAIL (a Group object) <b>optional repeating </b></li>
                         * <li>3: CCR_I16_ROLE_CLINICAL_HISTORY (a Group object) <b>optional repeating </b></li>
                         * <li>4: CTI (Clinical Trial Identification) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class CCR_I16_CLINICAL_HISTORY extends AbstractGroup {

    /** 
     * Creates a new CCR_I16_CLINICAL_HISTORY group
     */
    public CCR_I16_CLINICAL_HISTORY(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CCR_I16_CLINICAL_HISTORY_DETAIL.class, false, true, false);
                                  this.add(CCR_I16_ROLE_CLINICAL_HISTORY.class, false, true, false);
                                  this.add(CTI.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating CCR_I16_CLINICAL_HISTORY - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public CCR_I16_CLINICAL_HISTORY_DETAIL getCLINICAL_HISTORY_DETAIL() { 
       CCR_I16_CLINICAL_HISTORY_DETAIL retVal = getTyped("CLINICAL_HISTORY_DETAIL", CCR_I16_CLINICAL_HISTORY_DETAIL.class);
       return retVal;
    }
    ...
    public CCR_I16_CLINICAL_HISTORY_DETAIL getCLINICAL_HISTORY_DETAIL(int rep) { 
       CCR_I16_CLINICAL_HISTORY_DETAIL retVal = getTyped("CLINICAL_HISTORY_DETAIL", rep, CCR_I16_CLINICAL_HISTORY_DETAIL.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<CCR_I16_CLINICAL_HISTORY_DETAIL> getCLINICAL_HISTORY_DETAILAll() throws HL7Exception {
    	return getAllAsList("CLINICAL_HISTORY_DETAIL", CCR_I16_CLINICAL_HISTORY_DETAIL.class);
    } 
     ...
     */
    public void insertCLINICAL_HISTORY_DETAIL(CCR_I16_CLINICAL_HISTORY_DETAIL structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public CCR_I16_CLINICAL_HISTORY_DETAIL insertCLINICAL_HISTORY_DETAIL(int rep) throws HL7Exception { 
       return (CCR_I16_CLINICAL_HISTORY_DETAIL)super.insertRepetition("CLINICAL_HISTORY_DETAIL", rep);
    }
     ...
     */
    public CCR_I16_CLINICAL_HISTORY_DETAIL removeCLINICAL_HISTORY_DETAIL(int rep) throws HL7Exception { 
       return (CCR_I16_CLINICAL_HISTORY_DETAIL)super.removeRepetition("CLINICAL_HISTORY_DETAIL", rep);
    }
    ...
    public CCR_I16_ROLE_CLINICAL_HISTORY getROLE_CLINICAL_HISTORY() { 
       CCR_I16_ROLE_CLINICAL_HISTORY retVal = getTyped("ROLE_CLINICAL_HISTORY", CCR_I16_ROLE_CLINICAL_HISTORY.class);
       return retVal;
    }
    ...
    public CCR_I16_ROLE_CLINICAL_HISTORY getROLE_CLINICAL_HISTORY(int rep) { 
       CCR_I16_ROLE_CLINICAL_HISTORY retVal = getTyped("ROLE_CLINICAL_HISTORY", rep, CCR_I16_ROLE_CLINICAL_HISTORY.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<CCR_I16_ROLE_CLINICAL_HISTORY> getROLE_CLINICAL_HISTORYAll() throws HL7Exception {
    	return getAllAsList("ROLE_CLINICAL_HISTORY", CCR_I16_ROLE_CLINICAL_HISTORY.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertROLE_CLINICAL_HISTORY(CCR_I16_ROLE_CLINICAL_HISTORY structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public CCR_I16_ROLE_CLINICAL_HISTORY insertROLE_CLINICAL_HISTORY(int rep) throws HL7Exception { 
       return (CCR_I16_ROLE_CLINICAL_HISTORY)super.insertRepetition("ROLE_CLINICAL_HISTORY", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public CCR_I16_ROLE_CLINICAL_HISTORY removeROLE_CLINICAL_HISTORY(int rep) throws HL7Exception { 
       return (CCR_I16_ROLE_CLINICAL_HISTORY)super.removeRepetition("ROLE_CLINICAL_HISTORY", rep);
    }
