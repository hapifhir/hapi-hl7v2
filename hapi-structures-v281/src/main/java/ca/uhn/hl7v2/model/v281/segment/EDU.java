 ...
 * <ul>
     ...
     * <li>EDU-2: Academic Degree (CWE) <b>optional </b>
...
public class EDU extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(SI.class, true, 1, 0, new Object[]{ getMessage() }, "Set ID - EDU");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Academic Degree");
                                  this.add(DR.class, false, 1, 0, new Object[]{ getMessage() }, "Academic Degree Program Date Range");
                                  this.add(DR.class, false, 1, 0, new Object[]{ getMessage() }, "Academic Degree Program Participation Date Range");
                                  this.add(DT.class, false, 1, 0, new Object[]{ getMessage() }, "Academic Degree Granted Date");
                                  this.add(XON.class, false, 1, 0, new Object[]{ getMessage() }, "School");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "School Type Code");
                                  this.add(XAD.class, false, 1, 0, new Object[]{ getMessage() }, "School Address");
                                  this.add(CWE.class, false, 0, 0, new Object[]{ getMessage() }, "Major Field of Study");
