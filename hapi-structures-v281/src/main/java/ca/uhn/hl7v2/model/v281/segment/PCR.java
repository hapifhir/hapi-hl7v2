    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Product Evaluation Results");
                                              this.add(ID.class, false, 1, 0, new Object[]{ getMessage(), new Integer(248) }, "Evaluated Product Source");
                                  this.add(DTM.class, false, 1, 0, new Object[]{ getMessage() }, "Date Product Returned To Manufacturer");
                                              this.add(ID.class, false, 1, 0, new Object[]{ getMessage(), new Integer(242) }, "Device Operator Qualifications");
                                              this.add(ID.class, false, 1, 0, new Object[]{ getMessage(), new Integer(250) }, "Relatedness Assessment");
                                              this.add(ID.class, false, 6, 0, new Object[]{ getMessage(), new Integer(251) }, "Action Taken In Response To The Event");
                                              this.add(ID.class, false, 6, 0, new Object[]{ getMessage(), new Integer(252) }, "Event Causality Observations");
                                              this.add(ID.class, false, 3, 0, new Object[]{ getMessage(), new Integer(253) }, "Indirect Exposure Mechanism");
