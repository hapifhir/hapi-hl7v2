...
public class OBX extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(SI.class, false, 1, 0, new Object[]{ getMessage() }, "Set ID - OBX");
                                  ...
                                  this.add(NM.class, false, 1, 0, new Object[]{ getMessage() }, "Probability");
                                              this.add(ID.class, false, 0, 0, new Object[]{ getMessage(), new Integer(80) }, "Nature of Abnormal Test");
                                  ...
                                  this.add(XCN.class, false, 1, 0, new Object[]{ getMessage() }, "Performing Organization Medical Director");
                                              this.add(ID.class, false, 1, 0, new Object[]{ getMessage(), new Integer(909) }, "Patient Results Release Category");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Root Cause");
                                  this.add(CWE.class, false, 0, 0, new Object[]{ getMessage() }, "Local Process Control");
                                              this.add(ID.class, false, 1, 0, new Object[]{ getMessage(), new Integer(936) }, "Observation Type");
    ...
    protected Type createNewTypeWithoutReflection(int field) {
       switch (field) {
          ...
          case 25: return new ID(getMessage(), new Integer( 909 ));
          case 26: return new CWE(getMessage());
          case 27: return new CWE(getMessage());
          case 28: return new ID(getMessage(), new Integer( 936 ));
          default: return null;
       }
   }
