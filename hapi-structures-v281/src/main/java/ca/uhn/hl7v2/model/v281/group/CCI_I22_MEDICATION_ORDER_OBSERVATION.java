...
/**
 * <p>Represents a CCI_I22_MEDICATION_ORDER_OBSERVATION group structure (a Group object).
...
public class CCI_I22_MEDICATION_ORDER_OBSERVATION extends AbstractGroup {

    /** 
     * Creates a new CCI_I22_MEDICATION_ORDER_OBSERVATION group
     */
    public CCI_I22_MEDICATION_ORDER_OBSERVATION(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating CCI_I22_MEDICATION_ORDER_OBSERVATION - this is probably a bug in the source code generator.", e);
       }
    }
