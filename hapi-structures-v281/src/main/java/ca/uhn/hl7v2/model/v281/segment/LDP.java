 ...
 * <ul>
     ...
     * <li>LDP-3: Location Service (CWE) <b>optional repeating</b>
     * <li>LDP-4: Specialty Type (CWE) <b>optional repeating</b>
     * <li>LDP-5: Valid Patient Classes (CWE) <b>optional repeating</b>
...
public class LDP extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(PL.class, true, 1, 0, new Object[]{ getMessage() }, "Primary Key Value - LDP");
                                  this.add(CWE.class, true, 1, 0, new Object[]{ getMessage() }, "Location Department");
                                  this.add(CWE.class, false, 0, 0, new Object[]{ getMessage() }, "Location Service");
                                  this.add(CWE.class, false, 0, 0, new Object[]{ getMessage() }, "Specialty Type");
                                  ...
                                  this.add(DTM.class, false, 1, 0, new Object[]{ getMessage() }, "Activation Date - LDP");
                                  this.add(DTM.class, false, 1, 0, new Object[]{ getMessage() }, "Inactivation Date - LDP");
                                  this.add(ST.class, false, 1, 0, new Object[]{ getMessage() }, "Inactivated Reason");
                                  this.add(VH.class, false, 0, 0, new Object[]{ getMessage() }, "Visiting Hours");
                                  this.add(XTN.class, false, 1, 0, new Object[]{ getMessage() }, "Contact Phone");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Location Cost Center");
