...
/**
 * <p>Represents a CCI_I22_CLINICAL_HISTORY_DETAIL group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>12: PDA (Patient Death and Autopsy) <b>  choice</b></li>
                         * <li>13: CCI_I22_CLINICAL_HISTORY_OBSERVATION (a Group object) <b>optional repeating </b></li>
 * </ul>
 * <p>
...
public class CCI_I22_CLINICAL_HISTORY_DETAIL extends AbstractGroup {

    /** 
     * Creates a new CCI_I22_CLINICAL_HISTORY_DETAIL group
     */
    public CCI_I22_CLINICAL_HISTORY_DETAIL(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(PDA.class, true, false, true);
                                  this.add(CCI_I22_CLINICAL_HISTORY_OBSERVATION.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating CCI_I22_CLINICAL_HISTORY_DETAIL - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     */
    public PDA getPDA() { 
       PDA retVal = getTyped("PDA", PDA.class);
       return retVal;
    }
    ...
    public CCI_I22_CLINICAL_HISTORY_OBSERVATION getCLINICAL_HISTORY_OBSERVATION() { 
       CCI_I22_CLINICAL_HISTORY_OBSERVATION retVal = getTyped("CLINICAL_HISTORY_OBSERVATION", CCI_I22_CLINICAL_HISTORY_OBSERVATION.class);
       return retVal;
    }
    ...
    public CCI_I22_CLINICAL_HISTORY_OBSERVATION getCLINICAL_HISTORY_OBSERVATION(int rep) { 
       CCI_I22_CLINICAL_HISTORY_OBSERVATION retVal = getTyped("CLINICAL_HISTORY_OBSERVATION", rep, CCI_I22_CLINICAL_HISTORY_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<CCI_I22_CLINICAL_HISTORY_OBSERVATION> getCLINICAL_HISTORY_OBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("CLINICAL_HISTORY_OBSERVATION", CCI_I22_CLINICAL_HISTORY_OBSERVATION.class);
    } 
     ...
     */
    public void insertCLINICAL_HISTORY_OBSERVATION(CCI_I22_CLINICAL_HISTORY_OBSERVATION structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public CCI_I22_CLINICAL_HISTORY_OBSERVATION insertCLINICAL_HISTORY_OBSERVATION(int rep) throws HL7Exception { 
       return (CCI_I22_CLINICAL_HISTORY_OBSERVATION)super.insertRepetition("CLINICAL_HISTORY_OBSERVATION", rep);
    }
     ...
     */
    public CCI_I22_CLINICAL_HISTORY_OBSERVATION removeCLINICAL_HISTORY_OBSERVATION(int rep) throws HL7Exception { 
       return (CCI_I22_CLINICAL_HISTORY_OBSERVATION)super.removeRepetition("CLINICAL_HISTORY_OBSERVATION", rep);
    }
