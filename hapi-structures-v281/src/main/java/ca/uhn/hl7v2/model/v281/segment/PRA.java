 ...
 * <ul>
     ...
     * <li>PRA-3: Practitioner Category (CWE) <b>optional repeating</b>
...
public class PRA extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Primary Key Value - PRA");
                                  this.add(CWE.class, false, 0, 0, new Object[]{ getMessage() }, "Practitioner Group");
                                  this.add(CWE.class, false, 0, 0, new Object[]{ getMessage() }, "Practitioner Category");
                                              this.add(ID.class, false, 1, 0, new Object[]{ getMessage(), new Integer(187) }, "Provider Billing");
                                  this.add(SPD.class, false, 0, 0, new Object[]{ getMessage() }, "Specialty");
                                  this.add(PLN.class, false, 0, 0, new Object[]{ getMessage() }, "Practitioner ID Numbers");
                                  this.add(PIP.class, false, 0, 0, new Object[]{ getMessage() }, "Privileges");
                                  this.add(DT.class, false, 1, 0, new Object[]{ getMessage() }, "Date Entered Practice");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Institution");
                                  this.add(DT.class, false, 1, 0, new Object[]{ getMessage() }, "Date Left Practice");
                                  this.add(CWE.class, false, 0, 0, new Object[]{ getMessage() }, "Government Reimbursement Billing Eligibility");
                                  this.add(SI.class, false, 1, 0, new Object[]{ getMessage() }, "Set ID - PRA");
