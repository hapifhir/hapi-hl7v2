...
public class CSP extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(DTM.class, true, 1, 0, new Object[]{ getMessage() }, "Date/time Study Phase Began");
                                  this.add(DTM.class, false, 1, 0, new Object[]{ getMessage() }, "Date/time Study Phase Ended");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Study Phase Evaluability");
