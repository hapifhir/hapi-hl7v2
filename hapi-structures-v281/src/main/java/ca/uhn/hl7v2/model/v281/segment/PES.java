...
public class PES extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(XON.class, false, 0, 0, new Object[]{ getMessage() }, "Sender Organization Name");
                                  this.add(XCN.class, false, 0, 0, new Object[]{ getMessage() }, "Sender Individual Name");
                                  this.add(XAD.class, false, 0, 0, new Object[]{ getMessage() }, "Sender Address");
                                  this.add(XTN.class, false, 0, 0, new Object[]{ getMessage() }, "Sender Telephone");
                                  this.add(EI.class, false, 1, 0, new Object[]{ getMessage() }, "Sender Event Identifier");
                                  this.add(NM.class, false, 1, 0, new Object[]{ getMessage() }, "Sender Sequence Number");
                                  this.add(FT.class, false, 0, 0, new Object[]{ getMessage() }, "Sender Event Description");
                                  this.add(FT.class, false, 1, 0, new Object[]{ getMessage() }, "Sender Comment");
                                  this.add(DTM.class, false, 1, 0, new Object[]{ getMessage() }, "Sender Aware Date/Time");
                                  this.add(DTM.class, true, 1, 0, new Object[]{ getMessage() }, "Event Report Date");
                                              this.add(ID.class, false, 2, 0, new Object[]{ getMessage(), new Integer(234) }, "Event Report Timing/Type");
                                              this.add(ID.class, false, 1, 0, new Object[]{ getMessage(), new Integer(235) }, "Event Report Source");
                                              this.add(ID.class, false, 0, 0, new Object[]{ getMessage(), new Integer(236) }, "Event Reported To");
