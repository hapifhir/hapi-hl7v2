 ...
 * <ul>
		                 ...
		                 * <li>5: DEO_O45_DONATION_ORDER (a Group object) <b> repeating</b> </li>
 * </ul>
 */
...
public class DEO_O45 extends AbstractMessage  {
    ...
    public DEO_O45_DONATION_ORDER getDONATION_ORDER() { 
       return getTyped("DONATION_ORDER", DEO_O45_DONATION_ORDER.class);
    }
    ...
    public DEO_O45_DONATION_ORDER getDONATION_ORDER(int rep) { 
       return getTyped("DONATION_ORDER", rep, DEO_O45_DONATION_ORDER.class);
    }
     ...
     * 
     */ 
    public java.util.List<DEO_O45_DONATION_ORDER> getDONATION_ORDERAll() throws HL7Exception {
    	return getAllAsList("DONATION_ORDER", DEO_O45_DONATION_ORDER.class);
    } 
