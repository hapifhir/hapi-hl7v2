 ...
 * <ul>
     ...
     * <li>RXA-11: Administered-at Location (NULLDT) <b>optional </b>
     ...
     * <li>RXA-29: Administered Tag Identifier (EI) <b>optional repeating</b>
 * </ul>
 */
...
public class RXA extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(NM.class, true, 1, 0, new Object[]{ getMessage() }, "Administration Sub-ID Counter");
                                  this.add(DTM.class, true, 1, 0, new Object[]{ getMessage() }, "Date/Time Start of Administration");
                                  this.add(DTM.class, true, 1, 0, new Object[]{ getMessage() }, "Date/Time End of Administration");
                                  this.add(CWE.class, true, 1, 0, new Object[]{ getMessage() }, "Administered Code");
                                  this.add(NM.class, true, 1, 0, new Object[]{ getMessage() }, "Administered Amount");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Administered Units");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Administered Dosage Form");
                                  this.add(CWE.class, false, 0, 0, new Object[]{ getMessage() }, "Administration Notes");
                                  this.add(XCN.class, false, 0, 0, new Object[]{ getMessage() }, "Administering Provider");
                                  this.add(NULLDT.class, false, 1, 0, new Object[]{ getMessage() }, "Administered-at Location");
                                  this.add(ST.class, false, 1, 0, new Object[]{ getMessage() }, "Administered Per (Time Unit)");
                                  this.add(NM.class, false, 1, 0, new Object[]{ getMessage() }, "Administered Strength");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Administered Strength Units");
                                  ...
                                  this.add(CWE.class, false, 0, 0, new Object[]{ getMessage() }, "Substance/Treatment Refusal Reason");
                                  this.add(CWE.class, false, 0, 0, new Object[]{ getMessage() }, "Indication");
                                              this.add(ID.class, false, 1, 0, new Object[]{ getMessage(), new Integer(322) }, "Completion Status");
                                              this.add(ID.class, false, 1, 0, new Object[]{ getMessage(), new Integer(206) }, "Action Code - RXA");
                                  this.add(DTM.class, false, 1, 0, new Object[]{ getMessage() }, "System Entry Date/Time");
                                  this.add(NM.class, false, 1, 0, new Object[]{ getMessage() }, "Administered Drug Strength Volume");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Administered Drug Strength Volume Units");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Administered Barcode Identifier");
                                              this.add(ID.class, false, 1, 0, new Object[]{ getMessage(), new Integer(480) }, "Pharmacy Order Type");
                                  this.add(PL.class, false, 1, 0, new Object[]{ getMessage() }, "Administer-at");
                                  this.add(XAD.class, false, 1, 0, new Object[]{ getMessage() }, "Administered-at Address");
                                  this.add(EI.class, false, 0, 0, new Object[]{ getMessage() }, "Administered Tag Identifier");
     ...
     */
    public NULLDT getAdministeredAtLocation() { 
     ...
     * RXA-11: "Administered-at Location" - creates it if necessary
     */
    public NULLDT getRxa11_AdministeredAtLocation() { 
		NULLDT retVal = this.getTypedField(11, 0);
		return retVal;
    }
    ...
    public EI[] getAdministeredTagIdentifier() {
    	EI[] retVal = this.getTypedField(29, new EI[0]);
    	return retVal;
    }
     ...
     * Returns all repetitions of Administered Tag Identifier (RXA-29).
     */
    public EI[] getRxa29_AdministeredTagIdentifier() {
    	EI[] retVal = this.getTypedField(29, new EI[0]);
    	return retVal;
    }
    ...
    /**
     * Returns a count of the current number of repetitions of Administered Tag Identifier (RXA-29).
     * This method does not create a repetition, so if no repetitions have currently been defined or accessed,
     * it will return zero.
     */
    public int getAdministeredTagIdentifierReps() {
    ...
    /**
     * Returns a specific repetition of
     * RXA-29: "Administered Tag Identifier" - creates it if necessary
     *
     * @param rep The repetition index (0-indexed)
     */
    public EI getAdministeredTagIdentifier(int rep) { 
		EI retVal = this.getTypedField(29, rep);
		return retVal;
    }
     ...
     * @param rep The repetition index (0-indexed)
     */
    public EI getRxa29_AdministeredTagIdentifier(int rep) { 
		EI retVal = this.getTypedField(29, rep);
		return retVal;
    }
     ...
     * it will return zero.
     */
    public int getRxa29_AdministeredTagIdentifierReps() {
    	return this.getReps(29);
    }
    ...
    /**
     * Inserts a repetition of
     * RXA-29: "Administered Tag Identifier" at a specific index
     *
     * @param rep The repetition index (0-indexed)
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public EI insertAdministeredTagIdentifier(int rep) throws HL7Exception { 
        return (EI) super.insertRepetition(29, rep);
    }
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public EI insertRxa29_AdministeredTagIdentifier(int rep) throws HL7Exception { 
        return (EI) super.insertRepetition(29, rep);
    }
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public EI removeAdministeredTagIdentifier(int rep) throws HL7Exception { 
        return (EI) super.removeRepetition(29, rep);
    }
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public EI removeRxa29_AdministeredTagIdentifier(int rep) throws HL7Exception { 
        return (EI) super.removeRepetition(29, rep);
    }
