...
/**
 * <p>Represents a RDE_O11_PHARMACY_TREATMENT_INFUSION_ORDER group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: RXV (Pharmacy/Treatment Infusion) <b>  </b></li>
                         * <li>2: PRT (Participation Information) <b>optional repeating </b></li>
                         * <li>3: NTE (Notes and Comments) <b>optional repeating </b></li>
                         * <li>4: RDE_O11_TIMING_ENCODED (a Group object) <b> repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class RDE_O11_PHARMACY_TREATMENT_INFUSION_ORDER extends AbstractGroup {

    /** 
     * Creates a new RDE_O11_PHARMACY_TREATMENT_INFUSION_ORDER group
     */
    public RDE_O11_PHARMACY_TREATMENT_INFUSION_ORDER(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(RXV.class, true, false, false);
                                  this.add(PRT.class, false, true, false);
                                  this.add(NTE.class, false, true, false);
                                  this.add(RDE_O11_TIMING_ENCODED.class, true, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating RDE_O11_PHARMACY_TREATMENT_INFUSION_ORDER - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    /**
     * Returns
     * RXV (Pharmacy/Treatment Infusion) - creates it if necessary
     */
    public RXV getRXV() { 
       RXV retVal = getTyped("RXV", RXV.class);
       return retVal;
    }
