    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(XAD.class, false, 0, 0, new Object[]{ getMessage() }, "Event Location Occurred Address");
                                              this.add(ID.class, false, 0, 0, new Object[]{ getMessage(), new Integer(237) }, "Event Qualification");
                                              this.add(ID.class, false, 1, 0, new Object[]{ getMessage(), new Integer(238) }, "Event Serious");
                                              this.add(ID.class, false, 1, 0, new Object[]{ getMessage(), new Integer(239) }, "Event Expected");
                                              this.add(ID.class, false, 0, 0, new Object[]{ getMessage(), new Integer(240) }, "Event Outcome");
                                              this.add(ID.class, false, 1, 0, new Object[]{ getMessage(), new Integer(241) }, "Patient Outcome");
                                  ...
                                  this.add(XTN.class, false, 0, 0, new Object[]{ getMessage() }, "Primary Observer Telephone");
                                              this.add(ID.class, false, 1, 0, new Object[]{ getMessage(), new Integer(242) }, "Primary Observer's Qualification");
                                              this.add(ID.class, false, 1, 0, new Object[]{ getMessage(), new Integer(242) }, "Confirmation Provided By");
                                  this.add(DTM.class, false, 1, 0, new Object[]{ getMessage() }, "Primary Observer Aware Date/Time");
                                              this.add(ID.class, false, 1, 0, new Object[]{ getMessage(), new Integer(243) }, "Primary Observer's identity May Be Divulged");
