...
/**
 * <p>Represents a CCU_I20_PATIENT group structure (a Group object).
...
public class CCU_I20_PATIENT extends AbstractGroup {

    /** 
     * Creates a new CCU_I20_PATIENT group
     */
    public CCU_I20_PATIENT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating CCU_I20_PATIENT - this is probably a bug in the source code generator.", e);
       }
    }
