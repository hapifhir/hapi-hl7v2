...
/**
 * <p>Represents a ORA_R33 message structure (see chapter 7.3.7). This structure contains the 
 ...
 * <ul>
		                 ...
		                 * <li>6: ORC (Common Order) <b>optional </b> </li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class ORA_R33 extends AbstractMessage  {

    /**
     * Creates a new ORA_R33 message with DefaultModelClassFactory. 
     */ 
    public ORA_R33() { 
    ...
    /** 
     * Creates a new ORA_R33 message with custom ModelClassFactory.
     */
    public ORA_R33(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ORA_R33 - this is probably a bug in the source code generator.", e);
       }
    }
