...
/**
 * <p>Represents a CCU_I20_PROBLEM group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>3: CCU_I20_ROLE_PROBLEM (a Group object) <b>optional repeating </b></li>
                         * <li>4: CCU_I20_PROBLEM_OBSERVATION (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class CCU_I20_PROBLEM extends AbstractGroup {
    ...
    public CCU_I20_ROLE_PROBLEM getROLE_PROBLEM() { 
       CCU_I20_ROLE_PROBLEM retVal = getTyped("ROLE_PROBLEM", CCU_I20_ROLE_PROBLEM.class);
       return retVal;
    }
    ...
    public CCU_I20_ROLE_PROBLEM getROLE_PROBLEM(int rep) { 
       CCU_I20_ROLE_PROBLEM retVal = getTyped("ROLE_PROBLEM", rep, CCU_I20_ROLE_PROBLEM.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<CCU_I20_ROLE_PROBLEM> getROLE_PROBLEMAll() throws HL7Exception {
    	return getAllAsList("ROLE_PROBLEM", CCU_I20_ROLE_PROBLEM.class);
    } 
    ...
    public CCU_I20_PROBLEM_OBSERVATION getPROBLEM_OBSERVATION() { 
       CCU_I20_PROBLEM_OBSERVATION retVal = getTyped("PROBLEM_OBSERVATION", CCU_I20_PROBLEM_OBSERVATION.class);
       return retVal;
    }
    ...
    public CCU_I20_PROBLEM_OBSERVATION getPROBLEM_OBSERVATION(int rep) { 
       CCU_I20_PROBLEM_OBSERVATION retVal = getTyped("PROBLEM_OBSERVATION", rep, CCU_I20_PROBLEM_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<CCU_I20_PROBLEM_OBSERVATION> getPROBLEM_OBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("PROBLEM_OBSERVATION", CCU_I20_PROBLEM_OBSERVATION.class);
    } 
