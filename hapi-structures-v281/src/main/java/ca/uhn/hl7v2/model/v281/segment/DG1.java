...
public class DG1 extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(SI.class, true, 1, 0, new Object[]{ getMessage() }, "Set ID - DG1");
                                  ...
                                  this.add(CNE.class, false, 1, 0, new Object[]{ getMessage() }, "Diagnostic Related Group");
                                              this.add(ID.class, false, 1, 0, new Object[]{ getMessage(), new Integer(136) }, "DRG Approval Indicator");
                                  ...
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Diagnosis Classification");
                                              this.add(ID.class, false, 1, 0, new Object[]{ getMessage(), new Integer(136) }, "Confidential Indicator");
                                  ...
                                  this.add(EI.class, false, 1, 0, new Object[]{ getMessage() }, "Diagnosis Identifier");
                                              this.add(ID.class, false, 1, 0, new Object[]{ getMessage(), new Integer(206) }, "Diagnosis Action Code");
                                  ...
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "DRG CCL Value Code");
                                              this.add(ID.class, false, 1, 0, new Object[]{ getMessage(), new Integer(136) }, "DRG Grouping Usage");
