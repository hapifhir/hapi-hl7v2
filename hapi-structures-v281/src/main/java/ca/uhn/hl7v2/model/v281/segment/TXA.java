 ...
 * <ul>
     ...
     * <li>TXA-2: Document Type (CWE) <b> </b>
     ...
     * <li>TXA-24: Folder Assignment (CWE) <b>optional repeating</b>
     * <li>TXA-25: Document Title (ST) <b>optional repeating</b>
     * <li>TXA-26: Agreed Due Date/Time (DTM) <b>optional </b>
 * </ul>
 */
...
public class TXA extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(SI.class, true, 1, 0, new Object[]{ getMessage() }, "Set ID- TXA");
                                  this.add(CWE.class, true, 1, 0, new Object[]{ getMessage() }, "Document Type");
                                              this.add(ID.class, false, 1, 0, new Object[]{ getMessage(), new Integer(191) }, "Document Content Presentation");
                                  this.add(DTM.class, false, 1, 0, new Object[]{ getMessage() }, "Activity Date/Time");
                                  this.add(XCN.class, false, 0, 0, new Object[]{ getMessage() }, "Primary Activity Provider Code/Name");
                                  this.add(DTM.class, false, 1, 0, new Object[]{ getMessage() }, "Origination Date/Time");
                                  this.add(DTM.class, false, 1, 0, new Object[]{ getMessage() }, "Transcription Date/Time");
                                  this.add(DTM.class, false, 0, 0, new Object[]{ getMessage() }, "Edit Date/Time");
                                  this.add(XCN.class, false, 0, 0, new Object[]{ getMessage() }, "Originator Code/Name");
                                  this.add(XCN.class, false, 0, 0, new Object[]{ getMessage() }, "Assigned Document Authenticator");
                                  this.add(XCN.class, false, 0, 0, new Object[]{ getMessage() }, "Transcriptionist Code/Name");
                                  this.add(EI.class, true, 1, 0, new Object[]{ getMessage() }, "Unique Document Number");
                                  this.add(EI.class, false, 1, 0, new Object[]{ getMessage() }, "Parent Document Number");
                                  ...
                                  this.add(ST.class, false, 1, 0, new Object[]{ getMessage() }, "Unique Document File Name");
                                              this.add(ID.class, true, 1, 0, new Object[]{ getMessage(), new Integer(271) }, "Document Completion Status");
                                              this.add(ID.class, false, 1, 0, new Object[]{ getMessage(), new Integer(272) }, "Document Confidentiality Status");
                                              this.add(ID.class, false, 1, 0, new Object[]{ getMessage(), new Integer(273) }, "Document Availability Status");
                                              this.add(ID.class, false, 1, 0, new Object[]{ getMessage(), new Integer(275) }, "Document Storage Status");
                                  this.add(ST.class, false, 1, 0, new Object[]{ getMessage() }, "Document Change Reason");
                                  this.add(PPN.class, false, 0, 0, new Object[]{ getMessage() }, "Authentication Person, Time Stamp (set)");
                                  this.add(XCN.class, false, 0, 0, new Object[]{ getMessage() }, "Distributed Copies (Code and Name of Recipient(s) )");
                                  this.add(CWE.class, false, 0, 0, new Object[]{ getMessage() }, "Folder Assignment");
                                  this.add(ST.class, false, 0, 0, new Object[]{ getMessage() }, "Document Title");
                                  this.add(DTM.class, false, 1, 0, new Object[]{ getMessage() }, "Agreed Due Date/Time");
     ...
     * TXA-2: "Document Type" - creates it if necessary
     */
    public CWE getTxa2_DocumentType() { 
		CWE retVal = this.getTypedField(2, 0);
		return retVal;
    }
     ...
     * Returns all repetitions of Folder Assignment (TXA-24).
     */
    public CWE[] getTxa24_FolderAssignment() {
    	CWE[] retVal = this.getTypedField(24, new CWE[0]);
    	return retVal;
    }
    ...
    /**
     * Returns a count of the current number of repetitions of Folder Assignment (TXA-24).
     * This method does not create a repetition, so if no repetitions have currently been defined or accessed,
     * it will return zero.
     */
    public int getFolderAssignmentReps() {
    ...
    /**
     * Returns a specific repetition of
     * TXA-24: "Folder Assignment" - creates it if necessary
     *
     * @param rep The repetition index (0-indexed)
     */
     ...
     * @param rep The repetition index (0-indexed)
     */
    public CWE getTxa24_FolderAssignment(int rep) { 
		CWE retVal = this.getTypedField(24, rep);
		return retVal;
    }
     ...
     * it will return zero.
     */
    public int getTxa24_FolderAssignmentReps() {
    	return this.getReps(24);
    }
    ...
    /**
     * Inserts a repetition of
     * TXA-24: "Folder Assignment" at a specific index
     *
     * @param rep The repetition index (0-indexed)
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public CWE insertFolderAssignment(int rep) throws HL7Exception { 
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public CWE insertTxa24_FolderAssignment(int rep) throws HL7Exception { 
        return (CWE) super.insertRepetition(24, rep);
    }
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public CWE removeFolderAssignment(int rep) throws HL7Exception { 
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public CWE removeTxa24_FolderAssignment(int rep) throws HL7Exception { 
        return (CWE) super.removeRepetition(24, rep);
    }
    ...
    public ST[] getDocumentTitle() {
    	ST[] retVal = this.getTypedField(25, new ST[0]);
    	return retVal;
    }
     ...
     * Returns all repetitions of Document Title (TXA-25).
     */
    public ST[] getTxa25_DocumentTitle() {
    	ST[] retVal = this.getTypedField(25, new ST[0]);
    	return retVal;
    }
    ...
    /**
     * Returns a count of the current number of repetitions of Document Title (TXA-25).
     * This method does not create a repetition, so if no repetitions have currently been defined or accessed,
     * it will return zero.
     */
    public int getDocumentTitleReps() {
    ...
    /**
     * Returns a specific repetition of
     * TXA-25: "Document Title" - creates it if necessary
     *
     * @param rep The repetition index (0-indexed)
     */
    public ST getDocumentTitle(int rep) { 
		ST retVal = this.getTypedField(25, rep);
		return retVal;
    }
     ...
     * @param rep The repetition index (0-indexed)
     */
    public ST getTxa25_DocumentTitle(int rep) { 
		ST retVal = this.getTypedField(25, rep);
		return retVal;
    }
     ...
     * it will return zero.
     */
    public int getTxa25_DocumentTitleReps() {
    	return this.getReps(25);
    }
    ...
    /**
     * Inserts a repetition of
     * TXA-25: "Document Title" at a specific index
     *
     * @param rep The repetition index (0-indexed)
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public ST insertDocumentTitle(int rep) throws HL7Exception { 
        return (ST) super.insertRepetition(25, rep);
    }
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public ST insertTxa25_DocumentTitle(int rep) throws HL7Exception { 
        return (ST) super.insertRepetition(25, rep);
    }
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public ST removeDocumentTitle(int rep) throws HL7Exception { 
        return (ST) super.removeRepetition(25, rep);
    }
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public ST removeTxa25_DocumentTitle(int rep) throws HL7Exception { 
        return (ST) super.removeRepetition(25, rep);
    }
    ...
    /**
     * Returns
     * TXA-26: "Agreed Due Date/Time" - creates it if necessary
     */
     ...
     * TXA-26: "Agreed Due Date/Time" - creates it if necessary
     */
    public DTM getTxa26_AgreedDueDateTime() { 
		DTM retVal = this.getTypedField(26, 0);
		return retVal;
    }
