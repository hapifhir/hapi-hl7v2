...
public class IN1 extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(SI.class, true, 1, 0, new Object[]{ getMessage() }, "Set ID - IN1");
                                  ...
                                  this.add(ST.class, false, 1, 0, new Object[]{ getMessage() }, "Coord Of Ben. Priority");
                                              this.add(ID.class, false, 1, 0, new Object[]{ getMessage(), new Integer(136) }, "Notice Of Admission Flag");
                                  this.add(DT.class, false, 1, 0, new Object[]{ getMessage() }, "Notice Of Admission Date");
                                              this.add(ID.class, false, 1, 0, new Object[]{ getMessage(), new Integer(136) }, "Report Of Eligibility Flag");
                                  ...
                                  this.add(CX.class, false, 0, 0, new Object[]{ getMessage() }, "External Health Plan Identifiers");
                                              this.add(ID.class, false, 1, 0, new Object[]{ getMessage(), new Integer(206) }, "Insurance Action Code");
     ...
     * IN1-2: "Health Plan ID" - creates it if necessary
     */
    public CWE getIn12_HealthPlanID() { 
		CWE retVal = this.getTypedField(2, 0);
		return retVal;
    }
    ...
    protected Type createNewTypeWithoutReflection(int field) {
       switch (field) {
          ...
          case 54: return new ID(getMessage(), new Integer( 206 ));
          default: return null;
       }
   }
