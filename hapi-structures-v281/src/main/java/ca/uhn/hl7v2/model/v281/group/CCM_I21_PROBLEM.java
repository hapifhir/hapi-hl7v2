...
/**
 * <p>Represents a CCM_I21_PROBLEM group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>3: CCM_I21_ROLE_PROBLEM (a Group object) <b>optional repeating </b></li>
                         * <li>4: CCM_I21_PROBLEM_OBSERVATION (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class CCM_I21_PROBLEM extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating CCM_I21_PROBLEM - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public CCM_I21_ROLE_PROBLEM getROLE_PROBLEM() { 
       CCM_I21_ROLE_PROBLEM retVal = getTyped("ROLE_PROBLEM", CCM_I21_ROLE_PROBLEM.class);
       return retVal;
    }
    ...
    public CCM_I21_ROLE_PROBLEM getROLE_PROBLEM(int rep) { 
       CCM_I21_ROLE_PROBLEM retVal = getTyped("ROLE_PROBLEM", rep, CCM_I21_ROLE_PROBLEM.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<CCM_I21_ROLE_PROBLEM> getROLE_PROBLEMAll() throws HL7Exception {
    	return getAllAsList("ROLE_PROBLEM", CCM_I21_ROLE_PROBLEM.class);
    } 
    ...
    public CCM_I21_PROBLEM_OBSERVATION getPROBLEM_OBSERVATION() { 
       CCM_I21_PROBLEM_OBSERVATION retVal = getTyped("PROBLEM_OBSERVATION", CCM_I21_PROBLEM_OBSERVATION.class);
       return retVal;
    }
    ...
    public CCM_I21_PROBLEM_OBSERVATION getPROBLEM_OBSERVATION(int rep) { 
       CCM_I21_PROBLEM_OBSERVATION retVal = getTyped("PROBLEM_OBSERVATION", rep, CCM_I21_PROBLEM_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<CCM_I21_PROBLEM_OBSERVATION> getPROBLEM_OBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("PROBLEM_OBSERVATION", CCM_I21_PROBLEM_OBSERVATION.class);
    } 
