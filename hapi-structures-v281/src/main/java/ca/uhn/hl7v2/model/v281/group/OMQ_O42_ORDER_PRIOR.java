...
/**
 * <p>Represents a OMQ_O42_ORDER_PRIOR group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>4: OMQ_O42_TIMING_PRIOR (a Group object) <b>optional repeating </b></li>
                         ...
                         * <li>8: OMQ_O42_OBSERVATION_PRIOR (a Group object) <b> repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class OMQ_O42_ORDER_PRIOR extends AbstractGroup {

    /** 
     * Creates a new OMQ_O42_ORDER_PRIOR group
     */
    public OMQ_O42_ORDER_PRIOR(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(OMQ_O42_TIMING_PRIOR.class, false, true, false);
                                  this.add(NTE.class, false, true, false);
                                  this.add(PRT.class, false, true, false);
                                  this.add(CTD.class, false, false, false);
                                  this.add(OMQ_O42_OBSERVATION_PRIOR.class, true, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating OMQ_O42_ORDER_PRIOR - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public OMQ_O42_TIMING_PRIOR getTIMING_PRIOR() { 
       OMQ_O42_TIMING_PRIOR retVal = getTyped("TIMING_PRIOR", OMQ_O42_TIMING_PRIOR.class);
       return retVal;
    }
    ...
    public OMQ_O42_TIMING_PRIOR getTIMING_PRIOR(int rep) { 
       OMQ_O42_TIMING_PRIOR retVal = getTyped("TIMING_PRIOR", rep, OMQ_O42_TIMING_PRIOR.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<OMQ_O42_TIMING_PRIOR> getTIMING_PRIORAll() throws HL7Exception {
    	return getAllAsList("TIMING_PRIOR", OMQ_O42_TIMING_PRIOR.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertTIMING_PRIOR(OMQ_O42_TIMING_PRIOR structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public OMQ_O42_TIMING_PRIOR insertTIMING_PRIOR(int rep) throws HL7Exception { 
       return (OMQ_O42_TIMING_PRIOR)super.insertRepetition("TIMING_PRIOR", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public OMQ_O42_TIMING_PRIOR removeTIMING_PRIOR(int rep) throws HL7Exception { 
       return (OMQ_O42_TIMING_PRIOR)super.removeRepetition("TIMING_PRIOR", rep);
    }
    ...
    public OMQ_O42_OBSERVATION_PRIOR getOBSERVATION_PRIOR() { 
       OMQ_O42_OBSERVATION_PRIOR retVal = getTyped("OBSERVATION_PRIOR", OMQ_O42_OBSERVATION_PRIOR.class);
       return retVal;
    }
    ...
    public OMQ_O42_OBSERVATION_PRIOR getOBSERVATION_PRIOR(int rep) { 
       OMQ_O42_OBSERVATION_PRIOR retVal = getTyped("OBSERVATION_PRIOR", rep, OMQ_O42_OBSERVATION_PRIOR.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<OMQ_O42_OBSERVATION_PRIOR> getOBSERVATION_PRIORAll() throws HL7Exception {
    	return getAllAsList("OBSERVATION_PRIOR", OMQ_O42_OBSERVATION_PRIOR.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertOBSERVATION_PRIOR(OMQ_O42_OBSERVATION_PRIOR structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public OMQ_O42_OBSERVATION_PRIOR insertOBSERVATION_PRIOR(int rep) throws HL7Exception { 
       return (OMQ_O42_OBSERVATION_PRIOR)super.insertRepetition("OBSERVATION_PRIOR", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public OMQ_O42_OBSERVATION_PRIOR removeOBSERVATION_PRIOR(int rep) throws HL7Exception { 
       return (OMQ_O42_OBSERVATION_PRIOR)super.removeRepetition("OBSERVATION_PRIOR", rep);
    }
