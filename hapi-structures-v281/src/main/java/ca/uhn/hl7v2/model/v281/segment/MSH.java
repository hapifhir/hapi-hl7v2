    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(ST.class, false, 1, 0, new Object[]{ getMessage() }, "Continuation Pointer");
                                              ...
                                              this.add(ID.class, false, 1, 0, new Object[]{ getMessage(), new Integer(399) }, "Country Code");
                                              this.add(ID.class, false, 0, 0, new Object[]{ getMessage(), new Integer(211) }, "Character Set");
