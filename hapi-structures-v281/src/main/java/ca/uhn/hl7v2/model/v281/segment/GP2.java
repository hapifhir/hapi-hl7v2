 ...
 * <ul>
     * <li>GP2-1: Revenue Code (CWE) <b>optional </b>
     * <li>GP2-2: Number of Service Units (NM) <b>optional </b>
     * <li>GP2-3: Charge (CP) <b>optional </b>
     * <li>GP2-4: Reimbursement Action Code (CWE) <b>optional </b>
     * <li>GP2-5: Denial or Rejection Code (CWE) <b>optional </b>
     * <li>GP2-6: OCE Edit Code (CWE) <b>optional repeating</b>
     * <li>GP2-7: Ambulatory Payment Classification Code (CWE) <b>optional </b>
     * <li>GP2-8: Modifier Edit Code (CWE) <b>optional repeating</b>
     * <li>GP2-9: Payment Adjustment Code (CWE) <b>optional </b>
     * <li>GP2-10: Packaging Status Code (CWE) <b>optional </b>
     * <li>GP2-11: Expected CMS Payment Amount (CP) <b>optional </b>
     * <li>GP2-12: Reimbursement Type Code (CWE) <b>optional </b>
...
public class GP2 extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(NM.class, false, 1, 0, new Object[]{ getMessage() }, "Number of Service Units");
                                  this.add(CP.class, false, 1, 0, new Object[]{ getMessage() }, "Charge");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Reimbursement Action Code");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Denial or Rejection Code");
                                  this.add(CWE.class, false, 0, 0, new Object[]{ getMessage() }, "OCE Edit Code");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Ambulatory Payment Classification Code");
                                  this.add(CWE.class, false, 0, 0, new Object[]{ getMessage() }, "Modifier Edit Code");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Payment Adjustment Code");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Packaging Status Code");
                                  this.add(CP.class, false, 1, 0, new Object[]{ getMessage() }, "Expected CMS Payment Amount");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Reimbursement Type Code");
                                  this.add(CP.class, false, 1, 0, new Object[]{ getMessage() }, "Co-Pay Amount");
                                  this.add(NM.class, false, 1, 0, new Object[]{ getMessage() }, "Pay Rate per Service Unit");
