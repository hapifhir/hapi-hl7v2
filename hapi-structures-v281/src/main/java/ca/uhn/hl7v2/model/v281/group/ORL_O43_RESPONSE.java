...
/**
 * <p>Represents a ORL_O43_RESPONSE group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: ORL_O43_PATIENT (a Group object) <b>optional  </b></li>
                         * <li>2: ORL_O43_SPECIMEN (a Group object) <b> repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class ORL_O43_RESPONSE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ORL_O43_RESPONSE - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public ORL_O43_PATIENT getPATIENT() { 
       ORL_O43_PATIENT retVal = getTyped("PATIENT", ORL_O43_PATIENT.class);
       return retVal;
    }
    ...
    public ORL_O43_SPECIMEN getSPECIMEN() { 
       ORL_O43_SPECIMEN retVal = getTyped("SPECIMEN", ORL_O43_SPECIMEN.class);
       return retVal;
    }
    ...
    public ORL_O43_SPECIMEN getSPECIMEN(int rep) { 
       ORL_O43_SPECIMEN retVal = getTyped("SPECIMEN", rep, ORL_O43_SPECIMEN.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<ORL_O43_SPECIMEN> getSPECIMENAll() throws HL7Exception {
    	return getAllAsList("SPECIMEN", ORL_O43_SPECIMEN.class);
    } 
