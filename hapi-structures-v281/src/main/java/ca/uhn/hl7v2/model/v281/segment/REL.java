...
public class REL extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(SI.class, false, 1, 0, new Object[]{ getMessage() }, "Set ID -REL");
                                  ...
                                  this.add(DR.class, false, 1, 0, new Object[]{ getMessage() }, "Assertion Date Range");
                                              this.add(ID.class, false, 1, 0, new Object[]{ getMessage(), new Integer(136) }, "Negation Indicator");
                                  ...
                                  this.add(NM.class, false, 1, 0, new Object[]{ getMessage() }, "Priority  Sequence No (rel preference for consideration)");
                                              this.add(ID.class, false, 1, 0, new Object[]{ getMessage(), new Integer(136) }, "Separability Indicator");
