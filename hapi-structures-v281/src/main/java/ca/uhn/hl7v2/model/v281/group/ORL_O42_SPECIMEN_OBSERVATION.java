...
/**
 * <p>Represents a ORL_O42_SPECIMEN_OBSERVATION group structure (a Group object).
...
public class ORL_O42_SPECIMEN_OBSERVATION extends AbstractGroup {

    /** 
     * Creates a new ORL_O42_SPECIMEN_OBSERVATION group
     */
    public ORL_O42_SPECIMEN_OBSERVATION(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ORL_O42_SPECIMEN_OBSERVATION - this is probably a bug in the source code generator.", e);
       }
    }
