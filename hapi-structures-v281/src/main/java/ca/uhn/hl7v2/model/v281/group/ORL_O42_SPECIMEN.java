...
/**
 * <p>Represents a ORL_O42_SPECIMEN group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: SPM (Specimen) <b>  </b></li>
                         * <li>2: ORL_O42_SPECIMEN_OBSERVATION (a Group object) <b>optional repeating </b></li>
                         * <li>3: SAC (Specimen Container detail) <b>optional repeating </b></li>
                         * <li>4: ORL_O42_ORDER (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class ORL_O42_SPECIMEN extends AbstractGroup {

    /** 
     * Creates a new ORL_O42_SPECIMEN group
     */
    public ORL_O42_SPECIMEN(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(ORL_O42_SPECIMEN_OBSERVATION.class, false, true, false);
                                  this.add(SAC.class, false, true, false);
                                  this.add(ORL_O42_ORDER.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating ORL_O42_SPECIMEN - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public ORL_O42_SPECIMEN_OBSERVATION getSPECIMEN_OBSERVATION() { 
       ORL_O42_SPECIMEN_OBSERVATION retVal = getTyped("SPECIMEN_OBSERVATION", ORL_O42_SPECIMEN_OBSERVATION.class);
       return retVal;
    }
    ...
    public ORL_O42_SPECIMEN_OBSERVATION getSPECIMEN_OBSERVATION(int rep) { 
       ORL_O42_SPECIMEN_OBSERVATION retVal = getTyped("SPECIMEN_OBSERVATION", rep, ORL_O42_SPECIMEN_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<ORL_O42_SPECIMEN_OBSERVATION> getSPECIMEN_OBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("SPECIMEN_OBSERVATION", ORL_O42_SPECIMEN_OBSERVATION.class);
    } 
     ...
     */
    public void insertSPECIMEN_OBSERVATION(ORL_O42_SPECIMEN_OBSERVATION structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public ORL_O42_SPECIMEN_OBSERVATION insertSPECIMEN_OBSERVATION(int rep) throws HL7Exception { 
       return (ORL_O42_SPECIMEN_OBSERVATION)super.insertRepetition("SPECIMEN_OBSERVATION", rep);
    }
     ...
     */
    public ORL_O42_SPECIMEN_OBSERVATION removeSPECIMEN_OBSERVATION(int rep) throws HL7Exception { 
       return (ORL_O42_SPECIMEN_OBSERVATION)super.removeRepetition("SPECIMEN_OBSERVATION", rep);
    }
    ...
    public ORL_O42_ORDER getORDER() { 
       ORL_O42_ORDER retVal = getTyped("ORDER", ORL_O42_ORDER.class);
       return retVal;
    }
    ...
    public ORL_O42_ORDER getORDER(int rep) { 
       ORL_O42_ORDER retVal = getTyped("ORDER", rep, ORL_O42_ORDER.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<ORL_O42_ORDER> getORDERAll() throws HL7Exception {
    	return getAllAsList("ORDER", ORL_O42_ORDER.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertORDER(ORL_O42_ORDER structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public ORL_O42_ORDER insertORDER(int rep) throws HL7Exception { 
       return (ORL_O42_ORDER)super.insertRepetition("ORDER", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public ORL_O42_ORDER removeORDER(int rep) throws HL7Exception { 
       return (ORL_O42_ORDER)super.removeRepetition("ORDER", rep);
    }
