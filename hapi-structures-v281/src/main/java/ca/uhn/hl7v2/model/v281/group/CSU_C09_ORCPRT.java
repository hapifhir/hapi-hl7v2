...
/**
 * <p>Represents a CSU_C09_ORCPRT group structure (a Group object).
...
public class CSU_C09_ORCPRT extends AbstractGroup {

    /** 
     * Creates a new CSU_C09_ORCPRT group
     */
    public CSU_C09_ORCPRT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating CSU_C09_ORCPRT - this is probably a bug in the source code generator.", e);
       }
    }
