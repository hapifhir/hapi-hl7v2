...
/**
 * <p>Represents a CCU_I20_INSURANCE group structure (a Group object).
...
public class CCU_I20_INSURANCE extends AbstractGroup {

    /** 
     * Creates a new CCU_I20_INSURANCE group
     */
    public CCU_I20_INSURANCE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating CCU_I20_INSURANCE - this is probably a bug in the source code generator.", e);
       }
    }
