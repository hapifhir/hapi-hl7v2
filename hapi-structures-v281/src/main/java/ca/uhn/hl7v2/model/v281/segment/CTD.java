...
public class CTD extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(CWE.class, true, 0, 0, new Object[]{ getMessage() }, "Contact Role");
                                  this.add(XPN.class, false, 0, 0, new Object[]{ getMessage() }, "Contact Name");
                                  ...
                                  this.add(XTN.class, false, 0, 0, new Object[]{ getMessage() }, "Contact Communication Information");
