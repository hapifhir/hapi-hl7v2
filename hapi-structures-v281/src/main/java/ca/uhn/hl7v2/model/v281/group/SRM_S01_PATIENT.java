 ...
 * <ul>
                         ...
                         * <li>4: SRM_S01_OBXPRT (a Group object) <b>optional repeating </b></li>
...
public class SRM_S01_PATIENT extends AbstractGroup {
    ...
    public SRM_S01_OBXPRT getOBXPRT() { 
       SRM_S01_OBXPRT retVal = getTyped("OBXPRT", SRM_S01_OBXPRT.class);
       return retVal;
    }
    ...
    public SRM_S01_OBXPRT getOBXPRT(int rep) { 
       SRM_S01_OBXPRT retVal = getTyped("OBXPRT", rep, SRM_S01_OBXPRT.class);
       return retVal;
    }

    /** 
     * Returns the number of existing repetitions of OBXPRT 
     */ 
    public int getOBXPRTReps() {  
        return getReps("OBXPRT");
    } 
     ...
     * <p>
     * <p>
     * Note that unlike {@link #getOBXPRT()}, this method will not create any reps
     * if none are already present, so an empty list may be returned.
     * </p>
     */ 
    public java.util.List<SRM_S01_OBXPRT> getOBXPRTAll() throws HL7Exception {
    	return getAllAsList("OBXPRT", SRM_S01_OBXPRT.class);
    } 
    ...
    public void insertOBXPRT(SRM_S01_OBXPRT structure, int rep) throws HL7Exception { 
       super.insertRepetition("OBXPRT", structure, rep);
    }
