 ...
 * <ul>
                         ...
                         * <li>4: CCI_I22_PATHWAY_OBSERVATION (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
...
public class CCI_I22_PATHWAY extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CCI_I22_PATHWAY_OBSERVATION.class, false, true, false);
    ...
    public CCI_I22_PATHWAY_OBSERVATION getPATHWAY_OBSERVATION() { 
       CCI_I22_PATHWAY_OBSERVATION retVal = getTyped("PATHWAY_OBSERVATION", CCI_I22_PATHWAY_OBSERVATION.class);
       return retVal;
    }
    ...
    public CCI_I22_PATHWAY_OBSERVATION getPATHWAY_OBSERVATION(int rep) { 
       CCI_I22_PATHWAY_OBSERVATION retVal = getTyped("PATHWAY_OBSERVATION", rep, CCI_I22_PATHWAY_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<CCI_I22_PATHWAY_OBSERVATION> getPATHWAY_OBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("PATHWAY_OBSERVATION", CCI_I22_PATHWAY_OBSERVATION.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertPATHWAY_OBSERVATION(CCI_I22_PATHWAY_OBSERVATION structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public CCI_I22_PATHWAY_OBSERVATION insertPATHWAY_OBSERVATION(int rep) throws HL7Exception { 
       return (CCI_I22_PATHWAY_OBSERVATION)super.insertRepetition("PATHWAY_OBSERVATION", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public CCI_I22_PATHWAY_OBSERVATION removePATHWAY_OBSERVATION(int rep) throws HL7Exception { 
       return (CCI_I22_PATHWAY_OBSERVATION)super.removeRepetition("PATHWAY_OBSERVATION", rep);
    }
