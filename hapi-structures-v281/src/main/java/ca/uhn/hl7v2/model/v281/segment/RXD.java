 ...
 * <ul>
     ...
     * <li>RXD-13: Dispense-to Location (NULLDT) <b>optional </b>
     * <li>RXD-14: Needs Human Review (ID) <b>optional </b>
     * <li>RXD-15: Special Dispensing Instructions (CWE) <b>optional repeating</b>
     ...
     * <li>RXD-35: Dispense Tag Identifier (EI) <b>optional repeating</b>
 * </ul>
 */
...
public class RXD extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Dispense Package Size Unit");
                                              this.add(ID.class, false, 1, 0, new Object[]{ getMessage(), new Integer(321) }, "Dispense Package Method");
                                  ...
                                  this.add(EI.class, false, 0, 0, new Object[]{ getMessage() }, "Dispense Tag Identifier");
    ...
    /**
     * Returns a count of the current number of repetitions of Special Dispensing Instructions (RXD-15).
     * This method does not create a repetition, so if no repetitions have currently been defined or accessed,
     * it will return zero.
     */
    ...
    /**
     * Returns a specific repetition of
     * RXD-15: "Special Dispensing Instructions" - creates it if necessary
     *
     * @param rep The repetition index (0-indexed)
     */
    ...
    /**
     * Inserts a repetition of
     * RXD-15: "Special Dispensing Instructions" at a specific index
     *
     * @param rep The repetition index (0-indexed)
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    ...
    public EI[] getDispenseTagIdentifier() {
    	EI[] retVal = this.getTypedField(35, new EI[0]);
    	return retVal;
    }
    ...
    /**
     * Returns a count of the current number of repetitions of Dispense Tag Identifier (RXD-35).
     * This method does not create a repetition, so if no repetitions have currently been defined or accessed,
     * it will return zero.
     */
    ...
    /**
     * Returns a specific repetition of
     * RXD-35: "Dispense Tag Identifier" - creates it if necessary
     *
     * @param rep The repetition index (0-indexed)
     */
    public EI getDispenseTagIdentifier(int rep) { 
		EI retVal = this.getTypedField(35, rep);
		return retVal;
    }
    ...
    /**
     * Inserts a repetition of
     * RXD-35: "Dispense Tag Identifier" at a specific index
     *
     * @param rep The repetition index (0-indexed)
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    ...
    protected Type createNewTypeWithoutReflection(int field) {
       switch (field) {
          ...
          case 34: return new EI(getMessage());
          default: return null;
       }
   }
