...
public class PSL extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(SI.class, true, 1, 0, new Object[]{ getMessage() }, "Product/Service Line Item Sequence Number");
                                  ...
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Processing Consideration Code");
                                              this.add(ID.class, true, 1, 0, new Object[]{ getMessage(), new Integer(532) }, "Restricted Disclosure Indicator");
                                  ...
                                  this.add(NM.class, false, 1, 0, new Object[]{ getMessage() }, "Session-No");
                                  ...
                                  this.add(NM.class, false, 1, 0, new Object[]{ getMessage() }, "VAT-Rate");
                                              this.add(ID.class, false, 1, 0, new Object[]{ getMessage(), new Integer(0) }, "Main-Service");
                                              this.add(ID.class, false, 1, 0, new Object[]{ getMessage(), new Integer(136) }, "Validation");
