...
public class PSG extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(SI.class, true, 1, 0, new Object[]{ getMessage() }, "Product/Service Group Sequence Number");
                                              this.add(ID.class, true, 1, 0, new Object[]{ getMessage(), new Integer(136) }, "Adjudicate as Group");
