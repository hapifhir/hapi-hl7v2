...
/**
 * <p>Represents a CCI_I22_ROLE_CLINICAL_HISTORY group structure (a Group object).
...
public class CCI_I22_ROLE_CLINICAL_HISTORY extends AbstractGroup {

    /** 
     * Creates a new CCI_I22_ROLE_CLINICAL_HISTORY group
     */
    public CCI_I22_ROLE_CLINICAL_HISTORY(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating CCI_I22_ROLE_CLINICAL_HISTORY - this is probably a bug in the source code generator.", e);
       }
    }
