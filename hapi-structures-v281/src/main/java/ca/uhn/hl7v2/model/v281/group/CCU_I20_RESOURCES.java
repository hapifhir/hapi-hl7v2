...
/**
 * <p>Represents a CCU_I20_RESOURCES group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: RGS (Resource Group) <b>  </b></li>
                         * <li>2: CCU_I20_RESOURCE_DETAIL (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
...
public class CCU_I20_RESOURCES extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CCU_I20_RESOURCE_DETAIL.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating CCU_I20_RESOURCES - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public CCU_I20_RESOURCE_DETAIL getRESOURCE_DETAIL() { 
       CCU_I20_RESOURCE_DETAIL retVal = getTyped("RESOURCE_DETAIL", CCU_I20_RESOURCE_DETAIL.class);
       return retVal;
    }
    ...
    public CCU_I20_RESOURCE_DETAIL getRESOURCE_DETAIL(int rep) { 
       CCU_I20_RESOURCE_DETAIL retVal = getTyped("RESOURCE_DETAIL", rep, CCU_I20_RESOURCE_DETAIL.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<CCU_I20_RESOURCE_DETAIL> getRESOURCE_DETAILAll() throws HL7Exception {
    	return getAllAsList("RESOURCE_DETAIL", CCU_I20_RESOURCE_DETAIL.class);
    } 
    ...
    public CCU_I20_RESOURCE_DETAIL insertRESOURCE_DETAIL(int rep) throws HL7Exception { 
       return (CCU_I20_RESOURCE_DETAIL)super.insertRepetition("RESOURCE_DETAIL", rep);
    }
    ...
    public CCU_I20_RESOURCE_DETAIL removeRESOURCE_DETAIL(int rep) throws HL7Exception { 
       return (CCU_I20_RESOURCE_DETAIL)super.removeRepetition("RESOURCE_DETAIL", rep);
    }
