...
/**
 * <p>Represents a OMQ_O42_ORDER_DOCUMENT group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: SGH (Segment Group Header) <b>  </b></li>
                         * <li>2: OBX (Observation/Result) <b>  </b></li>
                         * <li>3: PRT (Participation Information) <b>optional repeating </b></li>
                         * <li>4: TXA (Transcription Document Header) <b>optional  </b></li>
                         * <li>5: NTE (Notes and Comments) <b>optional repeating </b></li>
                         * <li>6: SGT (Segment Group Trailer) <b>  </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class OMQ_O42_ORDER_DOCUMENT extends AbstractGroup {

    /** 
     * Creates a new OMQ_O42_ORDER_DOCUMENT group
     */
    public OMQ_O42_ORDER_DOCUMENT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(SGH.class, true, false, false);
                                  this.add(OBX.class, true, false, false);
                                  this.add(PRT.class, false, true, false);
                                  this.add(TXA.class, false, false, false);
                                  this.add(NTE.class, false, true, false);
                                  this.add(SGT.class, true, false, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating OMQ_O42_ORDER_DOCUMENT - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    /**
     * Returns
     * SGH (Segment Group Header) - creates it if necessary
     */
    public SGH getSGH() { 
       SGH retVal = getTyped("SGH", SGH.class);
       return retVal;
    }
    ...
    /**
     * Returns
     * SGT (Segment Group Trailer) - creates it if necessary
     */
    public SGT getSGT() { 
       SGT retVal = getTyped("SGT", SGT.class);
       return retVal;
    }
