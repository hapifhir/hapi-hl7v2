...
/**
 * <p>Represents a VXU_V04_PERSON_OBSERVATION group structure (a Group object).
...
public class VXU_V04_PERSON_OBSERVATION extends AbstractGroup {

    /** 
     * Creates a new VXU_V04_PERSON_OBSERVATION group
     */
    public VXU_V04_PERSON_OBSERVATION(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating VXU_V04_PERSON_OBSERVATION - this is probably a bug in the source code generator.", e);
       }
    }
