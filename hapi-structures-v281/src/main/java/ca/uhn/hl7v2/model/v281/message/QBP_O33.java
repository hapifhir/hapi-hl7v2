...
/**
 * <p>Represents a QBP_O33 message structure (see chapter 4.16.6). This structure contains the 
...
public class QBP_O33 extends AbstractMessage  {

    /**
     * Creates a new QBP_O33 message with DefaultModelClassFactory. 
     */ 
    public QBP_O33() { 
    ...
    /** 
     * Creates a new QBP_O33 message with custom ModelClassFactory.
     */
    public QBP_O33(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating QBP_O33 - this is probably a bug in the source code generator.", e);
       }
    }
