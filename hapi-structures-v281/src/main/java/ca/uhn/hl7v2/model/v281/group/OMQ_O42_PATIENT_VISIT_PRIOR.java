...
/**
 * <p>Represents a OMQ_O42_PATIENT_VISIT_PRIOR group structure (a Group object).
...
public class OMQ_O42_PATIENT_VISIT_PRIOR extends AbstractGroup {

    /** 
     * Creates a new OMQ_O42_PATIENT_VISIT_PRIOR group
     */
    public OMQ_O42_PATIENT_VISIT_PRIOR(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating OMQ_O42_PATIENT_VISIT_PRIOR - this is probably a bug in the source code generator.", e);
       }
    }
