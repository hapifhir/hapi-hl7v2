...
/**
 * <p>Represents a RSP_O34_DONATION group structure (a Group object).
...
public class RSP_O34_DONATION extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RSP_O34_DONATION - this is probably a bug in the source code generator.", e);
       }
    }
