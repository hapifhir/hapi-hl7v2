...
public class MFA extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                              this.add(ID.class, true, 1, 0, new Object[]{ getMessage(), new Integer(180) }, "Record-Level Event Code");
                                  this.add(ST.class, false, 1, 0, new Object[]{ getMessage() }, "MFN Control ID");
                                  this.add(DTM.class, false, 1, 0, new Object[]{ getMessage() }, "Event Completion Date/Time");
                                  this.add(CWE.class, true, 1, 0, new Object[]{ getMessage() }, "MFN Record Level Error Return");
                                  this.add(Varies.class, true, 0, 0, new Object[]{ getMessage() }, "Primary Key Value - MFA");
                                              this.add(ID.class, true, 0, 0, new Object[]{ getMessage(), new Integer(355) }, "Primary Key Value Type - MFA");
