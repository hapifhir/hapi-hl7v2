...
/**
 *<p>Represents an HL7 SGT message segment (Segment Group Trailer). 
 * This segment has the following fields:</p>
 * <ul>
     * <li>SGT-1: Set ID - SGT (SI) <b> </b>
     * <li>SGT-2: Segment Group Name (ST) <b>optional </b>
 * </ul>
 */
...
public class SGT extends AbstractSegment {
     ...
     */
    public SGT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(SI.class, true, 1, 0, new Object[]{ getMessage() }, "Set ID - SGT");
