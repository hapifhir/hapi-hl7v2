...
/**
 * <p>Represents a CCU_I20_ROLE_GOAL group structure (a Group object).
...
public class CCU_I20_ROLE_GOAL extends AbstractGroup {

    /** 
     * Creates a new CCU_I20_ROLE_GOAL group
     */
    public CCU_I20_ROLE_GOAL(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating CCU_I20_ROLE_GOAL - this is probably a bug in the source code generator.", e);
       }
    }
