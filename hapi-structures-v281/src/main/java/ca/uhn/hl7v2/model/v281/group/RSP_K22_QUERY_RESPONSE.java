...
/**
 * <p>Represents a RSP_K22_QUERY_RESPONSE group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>4: QRI (Query Response Instance) <b>optional  </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class RSP_K22_QUERY_RESPONSE extends AbstractGroup {

    /** 
     * Creates a new RSP_K22_QUERY_RESPONSE group
     */
    public RSP_K22_QUERY_RESPONSE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(QRI.class, false, false, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating RSP_K22_QUERY_RESPONSE - this is probably a bug in the source code generator.", e);
       }
    }
