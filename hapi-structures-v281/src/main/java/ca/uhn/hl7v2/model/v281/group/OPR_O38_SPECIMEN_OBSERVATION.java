...
/**
 * <p>Represents a OPR_O38_SPECIMEN_OBSERVATION group structure (a Group object).
...
public class OPR_O38_SPECIMEN_OBSERVATION extends AbstractGroup {

    /** 
     * Creates a new OPR_O38_SPECIMEN_OBSERVATION group
     */
    public OPR_O38_SPECIMEN_OBSERVATION(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating OPR_O38_SPECIMEN_OBSERVATION - this is probably a bug in the source code generator.", e);
       }
    }
