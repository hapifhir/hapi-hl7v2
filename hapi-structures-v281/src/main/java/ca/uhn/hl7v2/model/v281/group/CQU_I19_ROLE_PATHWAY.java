...
/**
 * <p>Represents a CQU_I19_ROLE_PATHWAY group structure (a Group object).
...
public class CQU_I19_ROLE_PATHWAY extends AbstractGroup {

    /** 
     * Creates a new CQU_I19_ROLE_PATHWAY group
     */
    public CQU_I19_ROLE_PATHWAY(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating CQU_I19_ROLE_PATHWAY - this is probably a bug in the source code generator.", e);
       }
    }
