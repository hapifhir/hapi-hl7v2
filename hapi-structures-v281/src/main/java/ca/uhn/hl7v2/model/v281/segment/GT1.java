...
public class GT1 extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(SI.class, true, 1, 0, new Object[]{ getMessage() }, "Set ID - GT1");
                                  ...
                                  this.add(NM.class, false, 1, 0, new Object[]{ getMessage() }, "Guarantor Priority");
                                  ...
                                  this.add(XON.class, false, 0, 0, new Object[]{ getMessage() }, "Guarantor Organization Name");
                                              this.add(ID.class, false, 1, 0, new Object[]{ getMessage(), new Integer(136) }, "Guarantor Billing Hold Flag");
                                  ...
                                  this.add(DTM.class, false, 1, 0, new Object[]{ getMessage() }, "Guarantor Death Date And Time");
                                              this.add(ID.class, false, 1, 0, new Object[]{ getMessage(), new Integer(136) }, "Guarantor Death Flag");
