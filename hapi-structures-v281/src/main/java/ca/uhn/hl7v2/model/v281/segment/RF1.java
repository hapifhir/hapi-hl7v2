 ...
 * <ul>
     ...
     * <li>RF1-18: Authorized Provider (XON) <b>optional </b>
     * <li>RF1-19: Authorized Health Professional (XCN) <b>optional </b>
     * <li>RF1-20: Source Text (ST) <b>optional </b>
     * <li>RF1-21: Source Date (DTM) <b>optional </b>
     * <li>RF1-22: Source Phone (XTN) <b>optional </b>
     * <li>RF1-23: Comment (ST) <b>optional </b>
     * <li>RF1-24: Action Code (ID) <b>optional </b>
 * </ul>
 */
...
public class RF1 extends AbstractSegment {
    ...
    public XTN getSourcePhone() { 
		XTN retVal = this.getTypedField(22, 0);
		return retVal;
    }
    ...
    protected Type createNewTypeWithoutReflection(int field) {
       switch (field) {
          ...
          case 21: return new XTN(getMessage());
          case 22: return new ST(getMessage());
          case 23: return new ID(getMessage(), new Integer( 206 ));
          default: return null;
       }
   }
