...
/**
 * <p>Represents a CCU_I20_MEDICATION_HISTORY group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: ORC (Common Order) <b>  </b></li>
                         * <li>2: CCU_I20_MEDICATION_ORDER_DETAIL (a Group object) <b>optional  </b></li>
                         * <li>3: CCU_I20_MEDICATION_ENCODING_DETAIL (a Group object) <b>optional  </b></li>
                         * <li>4: CCU_I20_MEDICATION_ADMINISTRATION_DETAIL (a Group object) <b>optional repeating </b></li>
                         * <li>5: CTI (Clinical Trial Identification) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class CCU_I20_MEDICATION_HISTORY extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating CCU_I20_MEDICATION_HISTORY - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public CCU_I20_MEDICATION_ORDER_DETAIL getMEDICATION_ORDER_DETAIL() { 
       CCU_I20_MEDICATION_ORDER_DETAIL retVal = getTyped("MEDICATION_ORDER_DETAIL", CCU_I20_MEDICATION_ORDER_DETAIL.class);
       return retVal;
    }
    ...
    public CCU_I20_MEDICATION_ENCODING_DETAIL getMEDICATION_ENCODING_DETAIL() { 
       CCU_I20_MEDICATION_ENCODING_DETAIL retVal = getTyped("MEDICATION_ENCODING_DETAIL", CCU_I20_MEDICATION_ENCODING_DETAIL.class);
       return retVal;
    }
    ...
    public CCU_I20_MEDICATION_ADMINISTRATION_DETAIL getMEDICATION_ADMINISTRATION_DETAIL() { 
       CCU_I20_MEDICATION_ADMINISTRATION_DETAIL retVal = getTyped("MEDICATION_ADMINISTRATION_DETAIL", CCU_I20_MEDICATION_ADMINISTRATION_DETAIL.class);
       return retVal;
    }
    ...
    public CCU_I20_MEDICATION_ADMINISTRATION_DETAIL getMEDICATION_ADMINISTRATION_DETAIL(int rep) { 
       CCU_I20_MEDICATION_ADMINISTRATION_DETAIL retVal = getTyped("MEDICATION_ADMINISTRATION_DETAIL", rep, CCU_I20_MEDICATION_ADMINISTRATION_DETAIL.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<CCU_I20_MEDICATION_ADMINISTRATION_DETAIL> getMEDICATION_ADMINISTRATION_DETAILAll() throws HL7Exception {
    	return getAllAsList("MEDICATION_ADMINISTRATION_DETAIL", CCU_I20_MEDICATION_ADMINISTRATION_DETAIL.class);
    } 
