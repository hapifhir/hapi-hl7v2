...
/**
 * <p>Represents a CQU_I19_PATIENT group structure (a Group object).
...
public class CQU_I19_PATIENT extends AbstractGroup {

    /** 
     * Creates a new CQU_I19_PATIENT group
     */
    public CQU_I19_PATIENT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating CQU_I19_PATIENT - this is probably a bug in the source code generator.", e);
       }
    }
