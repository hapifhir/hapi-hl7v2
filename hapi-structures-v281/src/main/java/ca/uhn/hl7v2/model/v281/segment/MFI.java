    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(HD.class, false, 0, 0, new Object[]{ getMessage() }, "Master File Application Identifier");
                                              this.add(ID.class, true, 1, 0, new Object[]{ getMessage(), new Integer(178) }, "File-Level Event Code");
                                  ...
                                  this.add(DTM.class, false, 1, 0, new Object[]{ getMessage() }, "Effective Date/Time");
                                              this.add(ID.class, true, 1, 0, new Object[]{ getMessage(), new Integer(179) }, "Response Level Code");
