...
/**
 * <p>Represents a RSP_K22 message structure (see chapter 3.3.57). This structure contains the 
 ...
 * <ul>
		                 ...
		                 * <li>8: RSP_K22_QUERY_RESPONSE (a Group object) <b>optional repeating</b> </li>
		                 * <li>9: DSC (Continuation Pointer) <b>optional </b> </li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class RSP_K22 extends AbstractMessage  {

    /**
     * Creates a new RSP_K22 message with DefaultModelClassFactory. 
     */ 
    public RSP_K22() { 
    ...
    /** 
     * Creates a new RSP_K22 message with custom ModelClassFactory.
     */
    public RSP_K22(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(RSP_K22_QUERY_RESPONSE.class, false, true);
	                          this.add(DSC.class, false, false);
	       } catch(HL7Exception e) {
          log.error("Unexpected error creating RSP_K22 - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public RSP_K22_QUERY_RESPONSE getQUERY_RESPONSE() { 
       return getTyped("QUERY_RESPONSE", RSP_K22_QUERY_RESPONSE.class);
    }
    ...
    public RSP_K22_QUERY_RESPONSE getQUERY_RESPONSE(int rep) { 
       return getTyped("QUERY_RESPONSE", rep, RSP_K22_QUERY_RESPONSE.class);
    }
     ...
     * 
     */ 
    public java.util.List<RSP_K22_QUERY_RESPONSE> getQUERY_RESPONSEAll() throws HL7Exception {
    	return getAllAsList("QUERY_RESPONSE", RSP_K22_QUERY_RESPONSE.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertQUERY_RESPONSE(RSP_K22_QUERY_RESPONSE structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public RSP_K22_QUERY_RESPONSE insertQUERY_RESPONSE(int rep) throws HL7Exception { 
       return (RSP_K22_QUERY_RESPONSE)super.insertRepetition("QUERY_RESPONSE", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public RSP_K22_QUERY_RESPONSE removeQUERY_RESPONSE(int rep) throws HL7Exception { 
       return (RSP_K22_QUERY_RESPONSE)super.removeRepetition("QUERY_RESPONSE", rep);
    }
