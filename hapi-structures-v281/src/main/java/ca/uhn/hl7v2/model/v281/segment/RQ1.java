...
public class RQ1 extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(ST.class, false, 1, 0, new Object[]{ getMessage() }, "Anticipated Price");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Manufacturer Identifier");
                                  this.add(ST.class, false, 1, 0, new Object[]{ getMessage() }, "Manufacturer's Catalog");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Vendor ID");
                                  this.add(ST.class, false, 1, 0, new Object[]{ getMessage() }, "Vendor Catalog");
                                              this.add(ID.class, false, 1, 0, new Object[]{ getMessage(), new Integer(136) }, "Taxable");
                                              this.add(ID.class, false, 1, 0, new Object[]{ getMessage(), new Integer(136) }, "Substitute Allowed");
