 ...
 * <ul>
                         ...
                         * <li>5: PEX_P07_ASSOCIATED_OBSERVATION (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
...
public class PEX_P07_ASSOCIATED_PERSON extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(PEX_P07_ASSOCIATED_OBSERVATION.class, false, true, false);
     ...
     * Returns
     * the first repetition of 
     * ASSOCIATED_OBSERVATION (a Group object) - creates it if necessary
     */
    public PEX_P07_ASSOCIATED_OBSERVATION getASSOCIATED_OBSERVATION() { 
       PEX_P07_ASSOCIATED_OBSERVATION retVal = getTyped("ASSOCIATED_OBSERVATION", PEX_P07_ASSOCIATED_OBSERVATION.class);
       return retVal;
    }
    ...
    public PEX_P07_ASSOCIATED_OBSERVATION getASSOCIATED_OBSERVATION(int rep) { 
       PEX_P07_ASSOCIATED_OBSERVATION retVal = getTyped("ASSOCIATED_OBSERVATION", rep, PEX_P07_ASSOCIATED_OBSERVATION.class);
       return retVal;
    }

    /** 
     * Returns the number of existing repetitions of ASSOCIATED_OBSERVATION 
     */ 
    public int getASSOCIATED_OBSERVATIONReps() {  
        return getReps("ASSOCIATED_OBSERVATION");
    } 

    /** 
     * <p>
     * Returns a non-modifiable List containing all current existing repetitions of ASSOCIATED_OBSERVATION.
     * <p>
     * <p>
     * Note that unlike {@link #getASSOCIATED_OBSERVATION()}, this method will not create any reps
     * if none are already present, so an empty list may be returned.
     * </p>
     */ 
    public java.util.List<PEX_P07_ASSOCIATED_OBSERVATION> getASSOCIATED_OBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("ASSOCIATED_OBSERVATION", PEX_P07_ASSOCIATED_OBSERVATION.class);
    } 

    /**
     * Inserts a specific repetition of ASSOCIATED_OBSERVATION (a Group object)
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertASSOCIATED_OBSERVATION(PEX_P07_ASSOCIATED_OBSERVATION structure, int rep) throws HL7Exception { 
       super.insertRepetition("ASSOCIATED_OBSERVATION", structure, rep);
    }
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public PEX_P07_ASSOCIATED_OBSERVATION insertASSOCIATED_OBSERVATION(int rep) throws HL7Exception { 
       return (PEX_P07_ASSOCIATED_OBSERVATION)super.insertRepetition("ASSOCIATED_OBSERVATION", rep);
    }


    /**
     * Removes a specific repetition of ASSOCIATED_OBSERVATION (a Group object)
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public PEX_P07_ASSOCIATED_OBSERVATION removeASSOCIATED_OBSERVATION(int rep) throws HL7Exception { 
       return (PEX_P07_ASSOCIATED_OBSERVATION)super.removeRepetition("ASSOCIATED_OBSERVATION", rep);
    }
