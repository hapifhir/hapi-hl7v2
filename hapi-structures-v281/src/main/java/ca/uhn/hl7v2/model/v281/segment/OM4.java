    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(NM.class, false, 1, 0, new Object[]{ getMessage() }, "Sequence Number - Test/Observation Master File");
                                              this.add(ID.class, false, 1, 0, new Object[]{ getMessage(), new Integer(170) }, "Derived Specimen");
                                  this.add(TX.class, false, 0, 0, new Object[]{ getMessage() }, "Container Description");
                                  ...
                                  this.add(TX.class, false, 1, 0, new Object[]{ getMessage() }, "Specimen Requirements");
                                              this.add(ID.class, false, 0, 0, new Object[]{ getMessage(), new Integer(27) }, "Specimen Priorities");
