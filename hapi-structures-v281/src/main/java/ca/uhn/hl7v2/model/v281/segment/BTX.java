 ...
 * <ul>
     ...
     * <li>BTX-20: BP Unique ID (EI) <b>optional </b>
 * </ul>
 */
...
public class BTX extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(SI.class, true, 1, 0, new Object[]{ getMessage() }, "Set ID - BTX");
                                  ...
                                  this.add(CWE.class, true, 1, 0, new Object[]{ getMessage() }, "BP Transfusion/Disposition Status");
                                              this.add(ID.class, true, 1, 0, new Object[]{ getMessage(), new Integer(511) }, "BP Message Status");
    ...
    /**
     * Returns
     * BTX-20: "BP Unique ID" - creates it if necessary
     */
