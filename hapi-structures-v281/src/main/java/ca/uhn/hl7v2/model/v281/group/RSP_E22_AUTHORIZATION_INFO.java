 ...
 * </p>
 * <ul>
                         * <li>1: IVC (Invoice Segment) <b>  choice</b></li>
                         * <li>2: PSG (Product/Service Group) <b>  choice</b></li>
...
public class RSP_E22_AUTHORIZATION_INFO extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(IVC.class, true, false, true);
                                  this.add(PSG.class, true, false, true);
                                  this.add(RSP_E22_PSL_ITEM_INFO.class, true, true, false);
     ...
     * </p>
     */ 
    public java.util.List<RSP_E22_PSL_ITEM_INFO> getPSL_ITEM_INFOAll() throws HL7Exception {
