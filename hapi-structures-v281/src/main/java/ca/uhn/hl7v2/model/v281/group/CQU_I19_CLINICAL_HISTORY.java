...
/**
 * <p>Represents a CQU_I19_CLINICAL_HISTORY group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: ORC (Common Order) <b>  </b></li>
                         * <li>2: CQU_I19_CLINICAL_HISTORY_DETAIL (a Group object) <b>optional repeating </b></li>
                         * <li>3: CQU_I19_ROLE_CLINICAL_HISTORY (a Group object) <b>optional repeating </b></li>
                         * <li>4: CTI (Clinical Trial Identification) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class CQU_I19_CLINICAL_HISTORY extends AbstractGroup {

    /** 
     * Creates a new CQU_I19_CLINICAL_HISTORY group
     */
    public CQU_I19_CLINICAL_HISTORY(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CQU_I19_CLINICAL_HISTORY_DETAIL.class, false, true, false);
                                  this.add(CQU_I19_ROLE_CLINICAL_HISTORY.class, false, true, false);
                                  this.add(CTI.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating CQU_I19_CLINICAL_HISTORY - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public CQU_I19_CLINICAL_HISTORY_DETAIL getCLINICAL_HISTORY_DETAIL() { 
       CQU_I19_CLINICAL_HISTORY_DETAIL retVal = getTyped("CLINICAL_HISTORY_DETAIL", CQU_I19_CLINICAL_HISTORY_DETAIL.class);
       return retVal;
    }
    ...
    public CQU_I19_CLINICAL_HISTORY_DETAIL getCLINICAL_HISTORY_DETAIL(int rep) { 
       CQU_I19_CLINICAL_HISTORY_DETAIL retVal = getTyped("CLINICAL_HISTORY_DETAIL", rep, CQU_I19_CLINICAL_HISTORY_DETAIL.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<CQU_I19_CLINICAL_HISTORY_DETAIL> getCLINICAL_HISTORY_DETAILAll() throws HL7Exception {
    	return getAllAsList("CLINICAL_HISTORY_DETAIL", CQU_I19_CLINICAL_HISTORY_DETAIL.class);
    } 
     ...
     */
    public void insertCLINICAL_HISTORY_DETAIL(CQU_I19_CLINICAL_HISTORY_DETAIL structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public CQU_I19_CLINICAL_HISTORY_DETAIL insertCLINICAL_HISTORY_DETAIL(int rep) throws HL7Exception { 
       return (CQU_I19_CLINICAL_HISTORY_DETAIL)super.insertRepetition("CLINICAL_HISTORY_DETAIL", rep);
    }
     ...
     */
    public CQU_I19_CLINICAL_HISTORY_DETAIL removeCLINICAL_HISTORY_DETAIL(int rep) throws HL7Exception { 
       return (CQU_I19_CLINICAL_HISTORY_DETAIL)super.removeRepetition("CLINICAL_HISTORY_DETAIL", rep);
    }
    ...
    public CQU_I19_ROLE_CLINICAL_HISTORY getROLE_CLINICAL_HISTORY() { 
       CQU_I19_ROLE_CLINICAL_HISTORY retVal = getTyped("ROLE_CLINICAL_HISTORY", CQU_I19_ROLE_CLINICAL_HISTORY.class);
       return retVal;
    }
    ...
    public CQU_I19_ROLE_CLINICAL_HISTORY getROLE_CLINICAL_HISTORY(int rep) { 
       CQU_I19_ROLE_CLINICAL_HISTORY retVal = getTyped("ROLE_CLINICAL_HISTORY", rep, CQU_I19_ROLE_CLINICAL_HISTORY.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<CQU_I19_ROLE_CLINICAL_HISTORY> getROLE_CLINICAL_HISTORYAll() throws HL7Exception {
    	return getAllAsList("ROLE_CLINICAL_HISTORY", CQU_I19_ROLE_CLINICAL_HISTORY.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertROLE_CLINICAL_HISTORY(CQU_I19_ROLE_CLINICAL_HISTORY structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public CQU_I19_ROLE_CLINICAL_HISTORY insertROLE_CLINICAL_HISTORY(int rep) throws HL7Exception { 
       return (CQU_I19_ROLE_CLINICAL_HISTORY)super.insertRepetition("ROLE_CLINICAL_HISTORY", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public CQU_I19_ROLE_CLINICAL_HISTORY removeROLE_CLINICAL_HISTORY(int rep) throws HL7Exception { 
       return (CQU_I19_ROLE_CLINICAL_HISTORY)super.removeRepetition("ROLE_CLINICAL_HISTORY", rep);
    }
