 ...
 * </p>
 * <ul>
                         * <li>1: IN1 (Insurance) <b>  choice</b></li>
                         * <li>2: IN2 (Insurance Additional Information) <b>optional  choice</b></li>
 * </ul>
 * <p>
...
public class EHC_E01_INSURANCE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(IN1.class, true, false, true);
                                  this.add(IN2.class, false, false, true);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating EHC_E01_INSURANCE - this is probably a bug in the source code generator.", e);
       }
    }
