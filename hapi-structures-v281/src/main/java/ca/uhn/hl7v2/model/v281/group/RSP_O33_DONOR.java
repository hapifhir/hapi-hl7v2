...
/**
 * <p>Represents a RSP_O33_DONOR group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: PID (Patient Identification) <b>  </b></li>
                         * <li>2: ARV (Access Restriction) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class RSP_O33_DONOR extends AbstractGroup {

    /** 
     * Creates a new RSP_O33_DONOR group
     */
    public RSP_O33_DONOR(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RSP_O33_DONOR - this is probably a bug in the source code generator.", e);
       }
    }
