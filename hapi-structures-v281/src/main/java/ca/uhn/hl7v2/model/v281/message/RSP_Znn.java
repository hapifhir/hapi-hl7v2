...
/**
 * <p>Represents a RSP_Znn message structure (see chapter 5.3.3.2). This structure contains the 
...
public class RSP_Znn extends AbstractMessage  {

    /**
     * Creates a new RSP_Znn message with DefaultModelClassFactory. 
     */ 
    public RSP_Znn() { 
    ...
    /** 
     * Creates a new RSP_Znn message with custom ModelClassFactory.
     */
    public RSP_Znn(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RSP_Znn - this is probably a bug in the source code generator.", e);
       }
    }
