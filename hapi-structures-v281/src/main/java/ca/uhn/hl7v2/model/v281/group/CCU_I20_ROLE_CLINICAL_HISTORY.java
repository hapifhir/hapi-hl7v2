...
/**
 * <p>Represents a CCU_I20_ROLE_CLINICAL_HISTORY group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: ROL (Role) <b>  choice</b></li>
                         * <li>2: PRD (Provider Data) <b>  choice</b></li>
...
public class CCU_I20_ROLE_CLINICAL_HISTORY extends AbstractGroup {

    /** 
     * Creates a new CCU_I20_ROLE_CLINICAL_HISTORY group
     */
    public CCU_I20_ROLE_CLINICAL_HISTORY(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(ROL.class, true, false, true);
                                  this.add(PRD.class, true, false, true);
                                  this.add(VAR.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating CCU_I20_ROLE_CLINICAL_HISTORY - this is probably a bug in the source code generator.", e);
       }
    }
