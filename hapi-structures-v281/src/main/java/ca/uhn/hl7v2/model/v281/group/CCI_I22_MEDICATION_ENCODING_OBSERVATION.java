...
/**
 * <p>Represents a CCI_I22_MEDICATION_ENCODING_OBSERVATION group structure (a Group object).
...
public class CCI_I22_MEDICATION_ENCODING_OBSERVATION extends AbstractGroup {

    /** 
     * Creates a new CCI_I22_MEDICATION_ENCODING_OBSERVATION group
     */
    public CCI_I22_MEDICATION_ENCODING_OBSERVATION(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating CCI_I22_MEDICATION_ENCODING_OBSERVATION - this is probably a bug in the source code generator.", e);
       }
    }
