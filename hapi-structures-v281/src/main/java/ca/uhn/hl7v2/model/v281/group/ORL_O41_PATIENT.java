...
/**
 * <p>Represents a ORL_O41_PATIENT group structure (a Group object).
...
public class ORL_O41_PATIENT extends AbstractGroup {

    /** 
     * Creates a new ORL_O41_PATIENT group
     */
    public ORL_O41_PATIENT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ORL_O41_PATIENT - this is probably a bug in the source code generator.", e);
       }
    }
