    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Case Category Code");
                                              this.add(ID.class, false, 1, 0, new Object[]{ getMessage(), new Integer(136) }, "Caesarian Section Indicator");
                                  ...
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Newborn Code");
                                              this.add(ID.class, false, 1, 0, new Object[]{ getMessage(), new Integer(136) }, "Stillborn Indicator");
