...
/**
 * <p>Represents a OMQ_O42_INSURANCE group structure (a Group object).
...
public class OMQ_O42_INSURANCE extends AbstractGroup {

    /** 
     * Creates a new OMQ_O42_INSURANCE group
     */
    public OMQ_O42_INSURANCE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating OMQ_O42_INSURANCE - this is probably a bug in the source code generator.", e);
       }
    }
