...
/**
 * <p>Represents a CCU_I20_ROLE_PROBLEM group structure (a Group object).
...
public class CCU_I20_ROLE_PROBLEM extends AbstractGroup {

    /** 
     * Creates a new CCU_I20_ROLE_PROBLEM group
     */
    public CCU_I20_ROLE_PROBLEM(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating CCU_I20_ROLE_PROBLEM - this is probably a bug in the source code generator.", e);
       }
    }
