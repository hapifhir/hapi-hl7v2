 ...
 * <ul>
                         ...
                         * <li>4: CQU_I19_MEDICATION_ENCODING_OBSERVATION (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
...
public class CQU_I19_MEDICATION_ENCODING_DETAIL extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CQU_I19_MEDICATION_ENCODING_OBSERVATION.class, false, true, false);
    ...
    public CQU_I19_MEDICATION_ENCODING_OBSERVATION getMEDICATION_ENCODING_OBSERVATION() { 
       CQU_I19_MEDICATION_ENCODING_OBSERVATION retVal = getTyped("MEDICATION_ENCODING_OBSERVATION", CQU_I19_MEDICATION_ENCODING_OBSERVATION.class);
       return retVal;
    }
    ...
    public CQU_I19_MEDICATION_ENCODING_OBSERVATION getMEDICATION_ENCODING_OBSERVATION(int rep) { 
       CQU_I19_MEDICATION_ENCODING_OBSERVATION retVal = getTyped("MEDICATION_ENCODING_OBSERVATION", rep, CQU_I19_MEDICATION_ENCODING_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<CQU_I19_MEDICATION_ENCODING_OBSERVATION> getMEDICATION_ENCODING_OBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("MEDICATION_ENCODING_OBSERVATION", CQU_I19_MEDICATION_ENCODING_OBSERVATION.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertMEDICATION_ENCODING_OBSERVATION(CQU_I19_MEDICATION_ENCODING_OBSERVATION structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public CQU_I19_MEDICATION_ENCODING_OBSERVATION insertMEDICATION_ENCODING_OBSERVATION(int rep) throws HL7Exception { 
       return (CQU_I19_MEDICATION_ENCODING_OBSERVATION)super.insertRepetition("MEDICATION_ENCODING_OBSERVATION", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public CQU_I19_MEDICATION_ENCODING_OBSERVATION removeMEDICATION_ENCODING_OBSERVATION(int rep) throws HL7Exception { 
       return (CQU_I19_MEDICATION_ENCODING_OBSERVATION)super.removeRepetition("MEDICATION_ENCODING_OBSERVATION", rep);
    }
