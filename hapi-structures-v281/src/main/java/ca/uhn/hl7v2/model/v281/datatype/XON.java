 ...
 * <li>Organization Name Type Code (CWE)
 * <li>ID Number (ST)
 * <li>Identifier Check Digit (ST)
 * <li>Check Digit Scheme (ST)
...
public class XON extends AbstractComposite {
     ...
     * casting and handling an exception.
     */
    public CWE getXon2_OrganizationNameTypeCode() {
       return getTyped(1, CWE.class);
    }
     ...
     * casting and handling an exception.
     */
    public ST getXon4_IdentifierCheckDigit() {
       return getTyped(3, ST.class);
    }
     ...
     * casting and handling an exception.
     */
    public ST getXon5_CheckDigitScheme() {
       return getTyped(4, ST.class);
    }
