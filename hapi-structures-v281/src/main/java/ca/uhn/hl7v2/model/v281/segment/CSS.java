...
public class CSS extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(CWE.class, true, 1, 0, new Object[]{ getMessage() }, "Study Scheduled Time Point");
                                  this.add(DTM.class, false, 1, 0, new Object[]{ getMessage() }, "Study Scheduled Patient Time Point");
                                  this.add(CWE.class, false, 3, 0, new Object[]{ getMessage() }, "Study Quality Control Codes");
