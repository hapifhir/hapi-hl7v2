 ...
 * <ul>
                         ...
                         * <li>2: OUL_R24_SPECIMEN_OBSERVATION (a Group object) <b>optional repeating </b></li>
...
public class OUL_R24_SPECIMEN extends AbstractGroup {
    ...
    public OUL_R24_SPECIMEN_OBSERVATION getSPECIMEN_OBSERVATION() { 
       OUL_R24_SPECIMEN_OBSERVATION retVal = getTyped("SPECIMEN_OBSERVATION", OUL_R24_SPECIMEN_OBSERVATION.class);
       return retVal;
    }
    ...
    public OUL_R24_SPECIMEN_OBSERVATION getSPECIMEN_OBSERVATION(int rep) { 
       OUL_R24_SPECIMEN_OBSERVATION retVal = getTyped("SPECIMEN_OBSERVATION", rep, OUL_R24_SPECIMEN_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<OUL_R24_SPECIMEN_OBSERVATION> getSPECIMEN_OBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("SPECIMEN_OBSERVATION", OUL_R24_SPECIMEN_OBSERVATION.class);
    } 
