...
/**
 * <p>Represents a ORL_O44 message structure (see chapter 4.4.13.2). This structure contains the 
 ...
 * <ul>
		                 ...
		                 * <li>7: ORL_O44_RESPONSE (a Group object) <b>optional </b> </li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class ORL_O44 extends AbstractMessage  {

    /**
     * Creates a new ORL_O44 message with DefaultModelClassFactory. 
     */ 
    public ORL_O44() { 
    ...
    /** 
     * Creates a new ORL_O44 message with custom ModelClassFactory.
     */
    public ORL_O44(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(ORL_O44_RESPONSE.class, false, false);
	       } catch(HL7Exception e) {
          log.error("Unexpected error creating ORL_O44 - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     *
     */
    public ORL_O44_RESPONSE getRESPONSE() { 
       return getTyped("RESPONSE", ORL_O44_RESPONSE.class);
    }
