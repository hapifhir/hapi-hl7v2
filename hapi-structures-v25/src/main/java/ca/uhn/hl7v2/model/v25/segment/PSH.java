...
public class PSH extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(NM.class, false, 0, 2, new Object[]{ getMessage() }, "Number of Product Experience Reports Filed by Facility");
                                  this.add(NM.class, false, 0, 2, new Object[]{ getMessage() }, "Number of Product Experience Reports Filed by Distributor");
