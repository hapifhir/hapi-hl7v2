...
public class PCR extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(ST.class, false, 0, 30, new Object[]{ getMessage() }, "Product Serial/Lot Number");
                                  ...
                                  this.add(TS.class, false, 1, 26, new Object[]{ getMessage() }, "Date Product Returned To Manufacturer");
                                              ...
                                              this.add(ID.class, false, 0, 2, new Object[]{ getMessage(), new Integer(251) }, "Action Taken In Response To The Event");
                                              this.add(ID.class, false, 0, 2, new Object[]{ getMessage(), new Integer(252) }, "Event Causality Observations");
                                              this.add(ID.class, false, 0, 1, new Object[]{ getMessage(), new Integer(253) }, "Indirect Exposure Mechanism");
