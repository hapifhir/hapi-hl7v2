...
public class ODS extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CE.class, false, 0, 250, new Object[]{ getMessage() }, "Service Period");
                                  this.add(CE.class, true, 0, 250, new Object[]{ getMessage() }, "Diet, Supplement, or Preference Code");
                                  this.add(ST.class, false, 0, 80, new Object[]{ getMessage() }, "Text Instruction");
