 ...
 * <ul>
     ...
     * <li>MSH-21: Conformance Statement ID (ID) <b>optional repeating</b>
 * </ul>
 */
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CE.class, false, 1, 250, new Object[]{ getMessage() }, "Principal Language Of Message");
                                              ...
                                              this.add(ID.class, false, 0, 10, new Object[]{ getMessage(), new Integer(449) }, "Conformance Statement ID");
