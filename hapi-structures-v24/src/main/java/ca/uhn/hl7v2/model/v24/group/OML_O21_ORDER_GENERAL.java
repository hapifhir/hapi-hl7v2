...
/**
 * <p>Represents a OML_O21_ORDER_GENERAL group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: OML_O21_CONTAINER_1 (a Group object) <b>optional  </b></li>
                         * <li>2: OML_O21_ORDER (a Group object) <b> repeating </b></li>
 * </ul>
 */
...
public class OML_O21_ORDER_GENERAL extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(OML_O21_CONTAINER_1.class, false, false, false);
                                  this.add(OML_O21_ORDER.class, true, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating OML_O21_ORDER_GENERAL - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    /**
     * Returns
     * CONTAINER_1 (a Group object) - creates it if necessary
     */
    public OML_O21_CONTAINER_1 getCONTAINER_1() { 
       OML_O21_CONTAINER_1 retVal = getTyped("CONTAINER_1", OML_O21_CONTAINER_1.class);
       return retVal;
    }
    ...
    public OML_O21_ORDER getORDER() { 
       OML_O21_ORDER retVal = getTyped("ORDER", OML_O21_ORDER.class);
       return retVal;
    }
    ...
    public OML_O21_ORDER getORDER(int rep) { 
       OML_O21_ORDER retVal = getTyped("ORDER", rep, OML_O21_ORDER.class);
       return retVal;
    }
