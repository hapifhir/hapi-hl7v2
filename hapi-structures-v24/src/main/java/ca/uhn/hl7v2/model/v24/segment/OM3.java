...
public class OM3 extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CE.class, false, 1, 250, new Object[]{ getMessage() }, "Abnormal Text/Codes for Categorical Observations");
                                  this.add(CE.class, false, 1, 250, new Object[]{ getMessage() }, "Critical Text/Codes for Categorical Observations");
