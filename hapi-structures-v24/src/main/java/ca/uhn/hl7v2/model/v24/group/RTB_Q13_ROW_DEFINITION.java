...
/**
 * <p>Represents a RTB_Q13_ROW_DEFINITION group structure (a Group object).
...
public class RTB_Q13_ROW_DEFINITION extends AbstractGroup {

    /** 
     * Creates a new RTB_Q13_ROW_DEFINITION group
     */
    public RTB_Q13_ROW_DEFINITION(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RTB_Q13_ROW_DEFINITION - this is probably a bug in the source code generator.", e);
       }
    }
