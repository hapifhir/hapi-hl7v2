 ...
 * <ul>
                         ...
                         * <li>2: ORL_O22_GENERAL_ORDER (a Group object) <b> repeating </b></li>
 * </ul>
 */
...
public class ORL_O22_PATIENT extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(ORL_O22_GENERAL_ORDER.class, true, true, false);
    ...
    public ORL_O22_GENERAL_ORDER getGENERAL_ORDER() { 
       ORL_O22_GENERAL_ORDER retVal = getTyped("GENERAL_ORDER", ORL_O22_GENERAL_ORDER.class);
       return retVal;
    }
    ...
    public ORL_O22_GENERAL_ORDER getGENERAL_ORDER(int rep) { 
       ORL_O22_GENERAL_ORDER retVal = getTyped("GENERAL_ORDER", rep, ORL_O22_GENERAL_ORDER.class);
       return retVal;
    }

    /** 
     * Returns the number of existing repetitions of GENERAL_ORDER 
     */ 
    public int getGENERAL_ORDERReps() {  
        return getReps("GENERAL_ORDER");
    } 
     ...
     * <p>
     * <p>
     * Note that unlike {@link #getGENERAL_ORDER()}, this method will not create any reps
     * if none are already present, so an empty list may be returned.
     * </p>
     */ 
    public java.util.List<ORL_O22_GENERAL_ORDER> getGENERAL_ORDERAll() throws HL7Exception {
    	return getAllAsList("GENERAL_ORDER", ORL_O22_GENERAL_ORDER.class);
    } 
    ...
    public void insertGENERAL_ORDER(ORL_O22_GENERAL_ORDER structure, int rep) throws HL7Exception { 
       super.insertRepetition("GENERAL_ORDER", structure, rep);
    }
