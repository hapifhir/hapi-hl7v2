 ...
 * <li>sample 1 from channel 4 (NM)
 * <li>sample 1 from channel 5 (NM)
 * <li>sample 1 from channel 6 (NM)
 * </ul>
 */
...
public class MA extends AbstractComposite {
    ...
    /**
     * Returns sample 1 from channel 4 (component 4).  This is a convenience method that saves you from 
     * casting and handling an exception.
     */
     ...
     * casting and handling an exception.
     */
    public NM getMa4_Sample1FromChannel4() {
       return getTyped(3, NM.class);
    }


    /**
     * Returns sample 1 from channel 5 (component 5).  This is a convenience method that saves you from 
     * casting and handling an exception.
     */
     ...
     * casting and handling an exception.
     */
    public NM getMa5_Sample1FromChannel5() {
       return getTyped(4, NM.class);
    }


    /**
     * Returns sample 1 from channel 6 (component 6).  This is a convenience method that saves you from 
     * casting and handling an exception.
     */
     ...
     * casting and handling an exception.
     */
    public NM getMa6_Sample1FromChannel6() {
       return getTyped(5, NM.class);
    }
