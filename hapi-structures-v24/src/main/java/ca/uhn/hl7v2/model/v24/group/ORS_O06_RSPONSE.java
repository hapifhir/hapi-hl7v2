...
/**
 * <p>Represents a ORS_O06_RSPONSE group structure (a Group object).
...
public class ORS_O06_RSPONSE extends AbstractGroup {

    /** 
     * Creates a new ORS_O06_RSPONSE group
     */
    public ORS_O06_RSPONSE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ORS_O06_RSPONSE - this is probably a bug in the source code generator.", e);
       }
    }
