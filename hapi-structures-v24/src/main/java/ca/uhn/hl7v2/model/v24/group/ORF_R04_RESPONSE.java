...
/**
 * <p>Represents a ORF_R04_RESPONSE group structure (a Group object).
...
public class ORF_R04_RESPONSE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ORF_R04_RESPONSE - this is probably a bug in the source code generator.", e);
       }
    }
