 ...
 * <ul>
		                 ...
		                 * <li>3: OML_O21_PATIENT (a Group object) <b>optional </b> </li>
		                 * <li>4: OML_O21_ORDER_GENERAL (a Group object) <b> repeating</b> </li>
 * </ul>
 */
...
public class OML_O21 extends AbstractMessage  {
     ...
     * Returns
     * the first repetition of 
     * ORDER_GENERAL (a Group object) - creates it if necessary
     * </p>
     * 
     *
     */
    public OML_O21_ORDER_GENERAL getORDER_GENERAL() { 
       return getTyped("ORDER_GENERAL", OML_O21_ORDER_GENERAL.class);
    }
    ...
    public OML_O21_ORDER_GENERAL getORDER_GENERAL(int rep) { 
       return getTyped("ORDER_GENERAL", rep, OML_O21_ORDER_GENERAL.class);
    }
     ...
     * <p>
     * <p>
     * Note that unlike {@link #getORDER_GENERAL()}, this method will not create any reps
     * if none are already present, so an empty list may be returned.
     * </p>
     * 
     */ 
    public java.util.List<OML_O21_ORDER_GENERAL> getORDER_GENERALAll() throws HL7Exception {
    	return getAllAsList("ORDER_GENERAL", OML_O21_ORDER_GENERAL.class);
    } 
