...
/**
 * <p>Represents a RGR_RGR_DEFINTION group structure (a Group object).
...
public class RGR_RGR_DEFINTION extends AbstractGroup {

    /** 
     * Creates a new RGR_RGR_DEFINTION group
     */
    public RGR_RGR_DEFINTION(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RGR_RGR_DEFINTION - this is probably a bug in the source code generator.", e);
       }
    }
