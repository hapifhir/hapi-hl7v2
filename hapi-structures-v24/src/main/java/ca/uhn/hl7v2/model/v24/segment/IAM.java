...
/**
 *<p>Represents an HL7 IAM message segment (Patient adverse reaction information - unique iden). 
 ...
 * <ul>
     ...
     * <li>IAM-7: Allergy Unique Identifier (EI) <b> </b>
...
public class IAM extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(EI.class, true, 1, 80, new Object[]{ getMessage() }, "Allergy Unique Identifier");
