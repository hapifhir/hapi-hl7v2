 ...
 * <ul>
                         ...
                         * <li>2: OML_O21_CONTAINER_2 (a Group object) <b>optional repeating </b></li>
                         ...
                         * <li>7: OML_O21_PRIOR_RESULT (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
...
public class OML_O21_OBSERVATION_REQUEST extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(OML_O21_CONTAINER_2.class, false, true, false);
     ...
     * CONTAINER_2 (a Group object) - creates it if necessary
     */
    public OML_O21_CONTAINER_2 getCONTAINER_2() { 
       OML_O21_CONTAINER_2 retVal = getTyped("CONTAINER_2", OML_O21_CONTAINER_2.class);
       return retVal;
    }
    ...
    public OML_O21_CONTAINER_2 getCONTAINER_2(int rep) { 
       OML_O21_CONTAINER_2 retVal = getTyped("CONTAINER_2", rep, OML_O21_CONTAINER_2.class);
       return retVal;
    }

    /** 
     * Returns the number of existing repetitions of CONTAINER_2 
     */ 
    public int getCONTAINER_2Reps() {  
        return getReps("CONTAINER_2");
    } 

    /** 
     * <p>
     * Returns a non-modifiable List containing all current existing repetitions of CONTAINER_2.
     * <p>
     * <p>
     * Note that unlike {@link #getCONTAINER_2()}, this method will not create any reps
     * if none are already present, so an empty list may be returned.
     * </p>
     */ 
    public java.util.List<OML_O21_CONTAINER_2> getCONTAINER_2All() throws HL7Exception {
    	return getAllAsList("CONTAINER_2", OML_O21_CONTAINER_2.class);
    } 

    /**
     * Inserts a specific repetition of CONTAINER_2 (a Group object)
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertCONTAINER_2(OML_O21_CONTAINER_2 structure, int rep) throws HL7Exception { 
       super.insertRepetition("CONTAINER_2", structure, rep);
    }
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public OML_O21_CONTAINER_2 insertCONTAINER_2(int rep) throws HL7Exception { 
       return (OML_O21_CONTAINER_2)super.insertRepetition("CONTAINER_2", rep);
    }


    /**
     * Removes a specific repetition of CONTAINER_2 (a Group object)
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public OML_O21_CONTAINER_2 removeCONTAINER_2(int rep) throws HL7Exception { 
       return (OML_O21_CONTAINER_2)super.removeRepetition("CONTAINER_2", rep);
    }
