...
/**
 * <p>Represents a ORL_O22_GENERAL_ORDER group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: ORL_O22_CONTAINER (a Group object) <b>optional  </b></li>
...
public class ORL_O22_GENERAL_ORDER extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(ORL_O22_CONTAINER.class, false, false, false);
                                  this.add(ORL_O22_ORDER.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating ORL_O22_GENERAL_ORDER - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public ORL_O22_CONTAINER getCONTAINER() { 
       ORL_O22_CONTAINER retVal = getTyped("CONTAINER", ORL_O22_CONTAINER.class);
       return retVal;
    }
