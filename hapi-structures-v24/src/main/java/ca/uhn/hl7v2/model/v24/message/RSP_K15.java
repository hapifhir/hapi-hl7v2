...
public class RSP_K15 extends AbstractMessage  {

    /**
     * Creates a new RSP_K15 message with DefaultModelClassFactory. 
     */ 
    public RSP_K15() { 
    ...
    /** 
     * Creates a new RSP_K15 message with custom ModelClassFactory.
     */
    public RSP_K15(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RSP_K15 - this is probably a bug in the source code generator.", e);
       }
    }
