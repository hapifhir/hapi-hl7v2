 ...
 * <ul>
		                 ...
		                 * <li>6: RSP_K13_ROW_DEFINITION (a Group object) <b>optional </b> </li>
		                 * <li>7: DSC (Continuation Pointer) <b>optional </b> </li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class RSP_K13 extends AbstractMessage  {

    /**
     * Creates a new RSP_K13 message with DefaultModelClassFactory. 
     */ 
    public RSP_K13() { 
    ...
    /** 
     * Creates a new RSP_K13 message with custom ModelClassFactory.
     */
    public RSP_K13(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(RSP_K13_ROW_DEFINITION.class, false, false);
	                          this.add(DSC.class, false, false);
	       } catch(HL7Exception e) {
          log.error("Unexpected error creating RSP_K13 - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     *
     */
    public RSP_K13_ROW_DEFINITION getROW_DEFINITION() { 
       return getTyped("ROW_DEFINITION", RSP_K13_ROW_DEFINITION.class);
    }
