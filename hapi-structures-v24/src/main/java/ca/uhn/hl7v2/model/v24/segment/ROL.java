 ...
 * <ul>
     ...
     * <li>ROL-10: Organization Unit Type - ROL (CE) <b>optional </b>
     * <li>ROL-11: Office/Home Address (XAD) <b>optional repeating</b>
...
public class ROL extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CE.class, false, 1, 250, new Object[]{ getMessage() }, "Organization Unit Type - ROL");
    ...
    /**
     * Returns
     * ROL-10: "Organization Unit Type - ROL" - creates it if necessary
     */
     ...
     * Returns all repetitions of Office/Home Address (ROL-11).
     */
    public XAD[] getRol11_OfficeHomeAddress() {
    	XAD[] retVal = this.getTypedField(11, new XAD[0]);
    	return retVal;
    }
    ...
    /**
     * Returns a specific repetition of
     * ROL-11: "Office/Home Address" - creates it if necessary
     *
     * @param rep The repetition index (0-indexed)
     */
    ...
    /**
     * Inserts a repetition of
     * ROL-11: "Office/Home Address" at a specific index
     *
     * @param rep The repetition index (0-indexed)
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public XAD insertRol11_OfficeHomeAddress(int rep) throws HL7Exception { 
        return (XAD) super.insertRepetition(11, rep);
    }
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public XAD removeRol11_OfficeHomeAddress(int rep) throws HL7Exception { 
        return (XAD) super.removeRepetition(11, rep);
    }
