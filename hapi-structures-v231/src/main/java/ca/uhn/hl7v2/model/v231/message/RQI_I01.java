...
/**
 * <p>Represents a RQI_I01 message structure (see chapter ?). This structure contains the 
 * following elements: </p>
 * <ul>
		                 * <li>1: MSH (MSH - message header segment) <b> </b> </li>
		                 * <li>2: RQI_I01_PRDCTD (a Group object) <b> repeating</b> </li>
		                 ...
		                 * <li>5: RQI_I01_GT1IN1IN2IN3 (a Group object) <b>optional </b> </li>
...
public class RQI_I01 extends AbstractMessage  {
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(RQI_I01_GT1IN1IN2IN3.class, false, false);
    ...
    public RQI_I01_PRDCTD getPRDCTD() { 
       return getTyped("PRDCTD", RQI_I01_PRDCTD.class);
    }
    ...
    public RQI_I01_PRDCTD getPRDCTD(int rep) { 
       return getTyped("PRDCTD", rep, RQI_I01_PRDCTD.class);
    }
     ...
     * 
     */ 
    public java.util.List<RQI_I01_PRDCTD> getPRDCTDAll() throws HL7Exception {
    ...
    public RQI_I01_GT1IN1IN2IN3 getGT1IN1IN2IN3() { 
       return getTyped("GT1IN1IN2IN3", RQI_I01_GT1IN1IN2IN3.class);
    }
