...
/**
 * <p>Represents a OMD_O01_ORCODTNTE group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: ORC (ORC - common order segment) <b>  </b></li>
                         * <li>2: ODT (ODT - diet tray instructions segment) <b> repeating </b></li>
                         * <li>3: NTE (NTE - notes and comments segment) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class OMD_O01_ORCODTNTE extends AbstractGroup {

    /** 
     * Creates a new OMD_O01_ORCODTNTE group
     */
    public OMD_O01_ORCODTNTE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating OMD_O01_ORCODTNTE - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    /**
     * Inserts a specific repetition of ODT (ODT - diet tray instructions segment)
    ...
    /**
     * Removes a specific repetition of ODT (ODT - diet tray instructions segment)
