...
/**
 * <p>Represents a ADR_A19_EVNPIDPD1NK1PV1PV2DB1OBXAL1DG1DRGPR1ROLGT1IN1IN2IN3ACCUB1UB2 group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: EVN (EVN - event type segment) <b>optional  </b></li>
                         * <li>2: PID (PID - patient identification segment) <b>  </b></li>
                         * <li>3: PD1 (PD1 - patient additional demographic segment) <b>optional  </b></li>
                         ...
                         * <li>11: DRG (DRG - diagnosis related group segment) <b>optional  </b></li>
                         * <li>12: ADR_A19_PR1ROL (a Group object) <b>optional repeating </b></li>
                         * <li>13: GT1 (GT1 - guarantor segment) <b>optional repeating </b></li>
                         * <li>14: ADR_A19_IN1IN2IN3 (a Group object) <b>optional repeating </b></li>
                         * <li>15: ACC (ACC - accident segment) <b>optional  </b></li>
                         * <li>16: UB1 (UB1 - UB82 data segment) <b>optional  </b></li>
                         * <li>17: UB2 (UB2 - UB92 data segment) <b>optional  </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class ADR_A19_EVNPIDPD1NK1PV1PV2DB1OBXAL1DG1DRGPR1ROLGT1IN1IN2IN3ACCUB1UB2 extends AbstractGroup {

    /** 
     * Creates a new ADR_A19_EVNPIDPD1NK1PV1PV2DB1OBXAL1DG1DRGPR1ROLGT1IN1IN2IN3ACCUB1UB2 group
     */
    public ADR_A19_EVNPIDPD1NK1PV1PV2DB1OBXAL1DG1DRGPR1ROLGT1IN1IN2IN3ACCUB1UB2(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(ADR_A19_PR1ROL.class, false, true, false);
                                  this.add(GT1.class, false, true, false);
                                  this.add(ADR_A19_IN1IN2IN3.class, false, true, false);
                                  this.add(ACC.class, false, false, false);
                                  this.add(UB1.class, false, false, false);
                                  this.add(UB2.class, false, false, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating ADR_A19_EVNPIDPD1NK1PV1PV2DB1OBXAL1DG1DRGPR1ROLGT1IN1IN2IN3ACCUB1UB2 - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     */
    public ADR_A19_PR1ROL getPR1ROL() { 
       ADR_A19_PR1ROL retVal = getTyped("PR1ROL", ADR_A19_PR1ROL.class);
       return retVal;
    }
     ...
     *     greater than the number of existing repetitions.
     */
    public ADR_A19_PR1ROL getPR1ROL(int rep) { 
       ADR_A19_PR1ROL retVal = getTyped("PR1ROL", rep, ADR_A19_PR1ROL.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<ADR_A19_PR1ROL> getPR1ROLAll() throws HL7Exception {
    	return getAllAsList("PR1ROL", ADR_A19_PR1ROL.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertPR1ROL(ADR_A19_PR1ROL structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public ADR_A19_PR1ROL insertPR1ROL(int rep) throws HL7Exception { 
       return (ADR_A19_PR1ROL)super.insertRepetition("PR1ROL", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public ADR_A19_PR1ROL removePR1ROL(int rep) throws HL7Exception { 
       return (ADR_A19_PR1ROL)super.removeRepetition("PR1ROL", rep);
    }
     ...
     */
    public ADR_A19_IN1IN2IN3 getIN1IN2IN3() { 
       ADR_A19_IN1IN2IN3 retVal = getTyped("IN1IN2IN3", ADR_A19_IN1IN2IN3.class);
       return retVal;
    }
     ...
     *     greater than the number of existing repetitions.
     */
    public ADR_A19_IN1IN2IN3 getIN1IN2IN3(int rep) { 
       ADR_A19_IN1IN2IN3 retVal = getTyped("IN1IN2IN3", rep, ADR_A19_IN1IN2IN3.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<ADR_A19_IN1IN2IN3> getIN1IN2IN3All() throws HL7Exception {
    	return getAllAsList("IN1IN2IN3", ADR_A19_IN1IN2IN3.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertIN1IN2IN3(ADR_A19_IN1IN2IN3 structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public ADR_A19_IN1IN2IN3 insertIN1IN2IN3(int rep) throws HL7Exception { 
       return (ADR_A19_IN1IN2IN3)super.insertRepetition("IN1IN2IN3", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public ADR_A19_IN1IN2IN3 removeIN1IN2IN3(int rep) throws HL7Exception { 
       return (ADR_A19_IN1IN2IN3)super.removeRepetition("IN1IN2IN3", rep);
    }
