...
/**
 * <p>Represents a RRE_O02_RXERXRRXC group structure (a Group object).
...
public class RRE_O02_RXERXRRXC extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RRE_O02_RXERXRRXC - this is probably a bug in the source code generator.", e);
       }
    }
