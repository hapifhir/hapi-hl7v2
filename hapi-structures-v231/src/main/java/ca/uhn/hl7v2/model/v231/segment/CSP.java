...
/**
 *<p>Represents an HL7 CSP message segment (CSP - clinical study phase segment). 
...
public class CSP extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(CE.class, true, 1, 60, new Object[]{ getMessage() }, "Study Phase Identifier");
                                  ...
                                  this.add(CE.class, false, 1, 60, new Object[]{ getMessage() }, "Study Phase Evaluability");
