...
/**
 * <p>Represents a ORN_O02_ORCRQDRQ1NTE group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: ORC (ORC - common order segment) <b>  </b></li>
                         * <li>2: RQD (RQD - requisition detail segment) <b>  </b></li>
                         * <li>3: RQ1 (RQ1 - requisition detail-1 segment) <b>optional  </b></li>
                         * <li>4: NTE (NTE - notes and comments segment) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class ORN_O02_ORCRQDRQ1NTE extends AbstractGroup {

    /** 
     * Creates a new ORN_O02_ORCRQDRQ1NTE group
     */
    public ORN_O02_ORCRQDRQ1NTE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ORN_O02_ORCRQDRQ1NTE - this is probably a bug in the source code generator.", e);
       }
    }
