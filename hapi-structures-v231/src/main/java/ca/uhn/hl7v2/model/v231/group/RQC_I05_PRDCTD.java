...
/**
 * <p>Represents a RQC_I05_PRDCTD group structure (a Group object).
...
public class RQC_I05_PRDCTD extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RQC_I05_PRDCTD - this is probably a bug in the source code generator.", e);
       }
    }
