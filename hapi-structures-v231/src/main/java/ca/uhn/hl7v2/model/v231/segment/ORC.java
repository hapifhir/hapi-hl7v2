...
/**
 *<p>Represents an HL7 ORC message segment (ORC - common order segment). 
 ...
 * <ul>
     ...
     * <li>ORC-7: Quantity/Timing (TQ) <b>optional </b>
...
public class ORC extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                              this.add(ID.class, false, 1, 2, new Object[]{ getMessage(), new Integer(119) }, "Order Control");
                                  ...
                                  this.add(XCN.class, false, 0, 120, new Object[]{ getMessage() }, "Entered By");
                                  this.add(XCN.class, false, 0, 120, new Object[]{ getMessage() }, "Verified By");
                                  ...
                                  this.add(XCN.class, false, 0, 120, new Object[]{ getMessage() }, "Action By");
                                  this.add(CE.class, false, 1, 40, new Object[]{ getMessage() }, "Advanced Beneficiary Notice Code");
                                  this.add(XON.class, false, 0, 60, new Object[]{ getMessage() }, "Ordering Facility Name");
                                  this.add(XAD.class, false, 0, 106, new Object[]{ getMessage() }, "Ordering Facility Address");
                                  this.add(XTN.class, false, 0, 48, new Object[]{ getMessage() }, "Ordering Facility Phone Number");
                                  this.add(XAD.class, false, 0, 106, new Object[]{ getMessage() }, "Ordering Provider Address");
