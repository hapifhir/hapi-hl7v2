...
public class OMS_O01 extends AbstractMessage  {
    ...
    public OMS_O01_PIDPD1NTEPV1PV2IN1IN2IN3GT1AL1 getPIDPD1NTEPV1PV2IN1IN2IN3GT1AL1() { 
       return getTyped("PIDPD1NTEPV1PV2IN1IN2IN3GT1AL1", OMS_O01_PIDPD1NTEPV1PV2IN1IN2IN3GT1AL1.class);
    }
    ...
    public OMS_O01_ORCRQDNTEOBXNTEBLG getORCRQDNTEOBXNTEBLG() { 
       return getTyped("ORCRQDNTEOBXNTEBLG", OMS_O01_ORCRQDNTEOBXNTEBLG.class);
    }
    ...
    public OMS_O01_ORCRQDNTEOBXNTEBLG getORCRQDNTEOBXNTEBLG(int rep) { 
       return getTyped("ORCRQDNTEOBXNTEBLG", rep, OMS_O01_ORCRQDNTEOBXNTEBLG.class);
    }
    ...
    public int getORCRQDNTEOBXNTEBLGReps() { 
    	return getReps("ORCRQDNTEOBXNTEBLG");
    } 

    /** 
     * <p>
     * Returns a non-modifiable List containing all current existing repetitions of ORCRQDNTEOBXNTEBLG.
     * <p>
     * <p>
     * Note that unlike {@link #getORCRQDNTEOBXNTEBLG()}, this method will not create any reps
     * if none are already present, so an empty list may be returned.
     * </p>
     * 
     */ 
    public java.util.List<OMS_O01_ORCRQDNTEOBXNTEBLG> getORCRQDNTEOBXNTEBLGAll() throws HL7Exception {
    	return getAllAsList("ORCRQDNTEOBXNTEBLG", OMS_O01_ORCRQDNTEOBXNTEBLG.class);
    } 
