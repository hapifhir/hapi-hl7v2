...
/**
 * <p>Represents a PPR_PC1_PTHVAR group structure (a Group object).
...
public class PPR_PC1_PTHVAR extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PPR_PC1_PTHVAR - this is probably a bug in the source code generator.", e);
       }
    }
