...
/**
 * <p>Represents a SQR_S25_AILNTE group structure (a Group object).
...
public class SQR_S25_AILNTE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating SQR_S25_AILNTE - this is probably a bug in the source code generator.", e);
       }
    }
