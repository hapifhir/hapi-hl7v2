...
/**
 * <p>Represents a RRI_I12_OBXNTE group structure (a Group object).
...
public class RRI_I12_OBXNTE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RRI_I12_OBXNTE - this is probably a bug in the source code generator.", e);
       }
    }
