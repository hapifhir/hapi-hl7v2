...
/**
 * <p>Represents a RGV_O01_RXERXRRXC group structure (a Group object).
...
public class RGV_O01_RXERXRRXC extends AbstractGroup {

    /** 
     * Creates a new RGV_O01_RXERXRRXC group
     */
    public RGV_O01_RXERXRRXC(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RGV_O01_RXERXRRXC - this is probably a bug in the source code generator.", e);
       }
    }
