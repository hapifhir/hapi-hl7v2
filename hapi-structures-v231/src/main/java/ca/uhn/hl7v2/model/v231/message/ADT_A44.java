...
public class ADT_A44 extends AbstractMessage  {
    ...
    public ADT_A44_PIDPD1MRG getPIDPD1MRG() { 
       return getTyped("PIDPD1MRG", ADT_A44_PIDPD1MRG.class);
    }
    ...
    public ADT_A44_PIDPD1MRG getPIDPD1MRG(int rep) { 
       return getTyped("PIDPD1MRG", rep, ADT_A44_PIDPD1MRG.class);
    }
     ...
     * 
     */ 
    public java.util.List<ADT_A44_PIDPD1MRG> getPIDPD1MRGAll() throws HL7Exception {
    	return getAllAsList("PIDPD1MRG", ADT_A44_PIDPD1MRG.class);
    } 
