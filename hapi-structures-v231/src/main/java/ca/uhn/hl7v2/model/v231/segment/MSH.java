...
/**
 *<p>Represents an HL7 MSH message segment (MSH - message header segment). 
...
public class MSH extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(MSG.class, true, 1, 7, new Object[]{ getMessage() }, "Message Type");
                                  ...
                                  this.add(CE.class, false, 1, 60, new Object[]{ getMessage() }, "Principal Language Of Message");
