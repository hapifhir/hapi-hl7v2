...
/**
 * <p>Represents a PPT_PCL_OBRRXONTEVAROBXNTEVAR group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>5: PPT_PCL_OBXNTEVAR (a Group object) <b>optional repeating </b></li>
 * </ul>
 * <p>
...
public class PPT_PCL_OBRRXONTEVAROBXNTEVAR extends AbstractGroup {

    /** 
     * Creates a new PPT_PCL_OBRRXONTEVAROBXNTEVAR group
     */
    public PPT_PCL_OBRRXONTEVAROBXNTEVAR(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(PPT_PCL_OBXNTEVAR.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating PPT_PCL_OBRRXONTEVAROBXNTEVAR - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     */
    public PPT_PCL_OBXNTEVAR getOBXNTEVAR() { 
       PPT_PCL_OBXNTEVAR retVal = getTyped("OBXNTEVAR", PPT_PCL_OBXNTEVAR.class);
       return retVal;
    }
     ...
     *     greater than the number of existing repetitions.
     */
    public PPT_PCL_OBXNTEVAR getOBXNTEVAR(int rep) { 
       PPT_PCL_OBXNTEVAR retVal = getTyped("OBXNTEVAR", rep, PPT_PCL_OBXNTEVAR.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PPT_PCL_OBXNTEVAR> getOBXNTEVARAll() throws HL7Exception {
    	return getAllAsList("OBXNTEVAR", PPT_PCL_OBXNTEVAR.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertOBXNTEVAR(PPT_PCL_OBXNTEVAR structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public PPT_PCL_OBXNTEVAR insertOBXNTEVAR(int rep) throws HL7Exception { 
       return (PPT_PCL_OBXNTEVAR)super.insertRepetition("OBXNTEVAR", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public PPT_PCL_OBXNTEVAR removeOBXNTEVAR(int rep) throws HL7Exception { 
       return (PPT_PCL_OBXNTEVAR)super.removeRepetition("OBXNTEVAR", rep);
    }
