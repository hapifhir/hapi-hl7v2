...
/**
 * <p>Represents a SQR_S25_AISNTE group structure (a Group object).
...
public class SQR_S25_AISNTE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating SQR_S25_AISNTE - this is probably a bug in the source code generator.", e);
       }
    }
