...
/**
 * <p>Represents a MFN_M02 message structure. This structure contains the 
...
public class MFN_M02 extends AbstractMessage  {
    ...
    public MFN_M02_MFESTFPRA getMFESTFPRA() { 
       return getTyped("MFESTFPRA", MFN_M02_MFESTFPRA.class);
    }
    ...
    public MFN_M02_MFESTFPRA getMFESTFPRA(int rep) { 
       return getTyped("MFESTFPRA", rep, MFN_M02_MFESTFPRA.class);
    }
    ...
    public int getMFESTFPRAReps() { 
    	return getReps("MFESTFPRA");
    } 

    /** 
     * <p>
     * Returns a non-modifiable List containing all current existing repetitions of MFESTFPRA.
     * <p>
     * <p>
     * Note that unlike {@link #getMFESTFPRA()}, this method will not create any reps
     * if none are already present, so an empty list may be returned.
     * </p>
     * 
     */ 
    public java.util.List<MFN_M02_MFESTFPRA> getMFESTFPRAAll() throws HL7Exception {
    	return getAllAsList("MFESTFPRA", MFN_M02_MFESTFPRA.class);
    } 
