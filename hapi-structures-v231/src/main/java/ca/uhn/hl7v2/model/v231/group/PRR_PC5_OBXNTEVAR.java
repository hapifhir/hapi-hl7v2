...
/**
 * <p>Represents a PRR_PC5_OBXNTEVAR group structure (a Group object).
...
public class PRR_PC5_OBXNTEVAR extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PRR_PC5_OBXNTEVAR - this is probably a bug in the source code generator.", e);
       }
    }
