...
/**
 * <p>Represents a ORU_R01_OBXNTE group structure (a Group object).
...
public class ORU_R01_OBXNTE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ORU_R01_OBXNTE - this is probably a bug in the source code generator.", e);
       }
    }
