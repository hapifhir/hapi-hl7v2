...
/**
 * <p>Represents a VXU_V04_OBXNTE group structure (a Group object).
...
public class VXU_V04_OBXNTE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating VXU_V04_OBXNTE - this is probably a bug in the source code generator.", e);
       }
    }
