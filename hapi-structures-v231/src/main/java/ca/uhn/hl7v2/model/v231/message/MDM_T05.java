...
/**
 * <p>Represents a MDM_T05 message structure (see chapter ?). This structure contains the 
...
public class MDM_T05 extends AbstractMessage  {

    /**
     * Creates a new MDM_T05 message with DefaultModelClassFactory. 
     */ 
    public MDM_T05() { 
    ...
    /** 
     * Creates a new MDM_T05 message with custom ModelClassFactory.
     */
    public MDM_T05(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating MDM_T05 - this is probably a bug in the source code generator.", e);
       }
    }
