 ...
 * <ul>
     ...
     * <li>PRD-7: Provider Identifiers (PI) <b>optional repeating</b>
...
public class PRD extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(CE.class, true, 0, 200, new Object[]{ getMessage() }, "Provider Role");
                                  this.add(XPN.class, false, 0, 106, new Object[]{ getMessage() }, "Provider Name");
                                  this.add(XAD.class, false, 0, 60, new Object[]{ getMessage() }, "Provider Address");
                                  this.add(PL.class, false, 1, 60, new Object[]{ getMessage() }, "Provider Location");
                                  this.add(XTN.class, false, 0, 100, new Object[]{ getMessage() }, "Provider Communication Information");
                                  this.add(CE.class, false, 1, 200, new Object[]{ getMessage() }, "Preferred Method Of Contact");
                                  this.add(PI.class, false, 0, 100, new Object[]{ getMessage() }, "Provider Identifiers");
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public PI insertPrd7_ProviderIdentifiers(int rep) throws HL7Exception { 
        return (PI) super.insertRepetition(7, rep);
    }
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public PI removePrd7_ProviderIdentifiers(int rep) throws HL7Exception { 
        return (PI) super.removeRepetition(7, rep);
    }
