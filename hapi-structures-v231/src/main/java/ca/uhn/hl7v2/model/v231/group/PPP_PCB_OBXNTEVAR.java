...
/**
 * <p>Represents a PPP_PCB_OBXNTEVAR group structure (a Group object).
...
public class PPP_PCB_OBXNTEVAR extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PPP_PCB_OBXNTEVAR - this is probably a bug in the source code generator.", e);
       }
    }
