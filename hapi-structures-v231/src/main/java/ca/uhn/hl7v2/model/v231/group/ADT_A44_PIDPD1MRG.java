...
/**
 * <p>Represents a ADT_A44_PIDPD1MRG group structure (a Group object).
...
public class ADT_A44_PIDPD1MRG extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ADT_A44_PIDPD1MRG - this is probably a bug in the source code generator.", e);
       }
    }
