...
/**
 *<p>Represents an HL7 FAC message segment (FAC - facility segment). 
...
public class FAC extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(XAD.class, true, 0, 200, new Object[]{ getMessage() }, "Facility Address");
                                  ...
                                  this.add(XCN.class, true, 0, 60, new Object[]{ getMessage() }, "Signature Authority");
                                  this.add(ST.class, false, 1, 60, new Object[]{ getMessage() }, "Signature Authority Title");
                                  this.add(XAD.class, false, 0, 200, new Object[]{ getMessage() }, "Signature Authority Address");
