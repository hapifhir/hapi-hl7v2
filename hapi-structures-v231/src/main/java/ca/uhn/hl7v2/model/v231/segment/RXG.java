...
/**
 *<p>Represents an HL7 RXG message segment (RXG - pharmacy/treatment give segment). 
...
public class RXG extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CE.class, false, 0, 200, new Object[]{ getMessage() }, "Pharmacy/Treatment Supplier’s Special Administration Instructions");
