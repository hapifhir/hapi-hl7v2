...
/**
 * <p>Represents a PGL_PC6_GOLNTEVARROLVARPTHVAROBXNTEPRBNTEVARROLVAROBXNTEORCOBRRXONTEVAROBXNTEVAR group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>4: PGL_PC6_ROLVAR (a Group object) <b>optional repeating </b></li>
                         * <li>5: PGL_PC6_PTHVAR (a Group object) <b>optional repeating </b></li>
                         * <li>6: PGL_PC6_OBXNTE (a Group object) <b>optional repeating </b></li>
                         * <li>7: PGL_PC6_PRBNTEVARROLVAROBXNTE (a Group object) <b>optional repeating </b></li>
                         * <li>8: PGL_PC6_ORCOBRRXONTEVAROBXNTEVAR (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
...
public class PGL_PC6_GOLNTEVARROLVARPTHVAROBXNTEPRBNTEVARROLVAROBXNTEORCOBRRXONTEVAROBXNTEVAR extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(PGL_PC6_ROLVAR.class, false, true, false);
                                  this.add(PGL_PC6_PTHVAR.class, false, true, false);
                                  this.add(PGL_PC6_OBXNTE.class, false, true, false);
                                  this.add(PGL_PC6_PRBNTEVARROLVAROBXNTE.class, false, true, false);
                                  this.add(PGL_PC6_ORCOBRRXONTEVAROBXNTEVAR.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating PGL_PC6_GOLNTEVARROLVARPTHVAROBXNTEPRBNTEVARROLVAROBXNTEORCOBRRXONTEVAROBXNTEVAR - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public PGL_PC6_ROLVAR getROLVAR() { 
       PGL_PC6_ROLVAR retVal = getTyped("ROLVAR", PGL_PC6_ROLVAR.class);
       return retVal;
    }
     ...
     *     greater than the number of existing repetitions.
     */
    public PGL_PC6_ROLVAR getROLVAR(int rep) { 
       PGL_PC6_ROLVAR retVal = getTyped("ROLVAR", rep, PGL_PC6_ROLVAR.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PGL_PC6_ROLVAR> getROLVARAll() throws HL7Exception {
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertROLVAR(PGL_PC6_ROLVAR structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public PGL_PC6_ROLVAR insertROLVAR(int rep) throws HL7Exception { 
       return (PGL_PC6_ROLVAR)super.insertRepetition("ROLVAR", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public PGL_PC6_ROLVAR removeROLVAR(int rep) throws HL7Exception { 
       return (PGL_PC6_ROLVAR)super.removeRepetition("ROLVAR", rep);
    }
    ...
    public PGL_PC6_PTHVAR getPTHVAR() { 
       PGL_PC6_PTHVAR retVal = getTyped("PTHVAR", PGL_PC6_PTHVAR.class);
       return retVal;
    }
     ...
     *     greater than the number of existing repetitions.
     */
    public PGL_PC6_PTHVAR getPTHVAR(int rep) { 
       PGL_PC6_PTHVAR retVal = getTyped("PTHVAR", rep, PGL_PC6_PTHVAR.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PGL_PC6_PTHVAR> getPTHVARAll() throws HL7Exception {
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertPTHVAR(PGL_PC6_PTHVAR structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public PGL_PC6_PTHVAR insertPTHVAR(int rep) throws HL7Exception { 
       return (PGL_PC6_PTHVAR)super.insertRepetition("PTHVAR", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public PGL_PC6_PTHVAR removePTHVAR(int rep) throws HL7Exception { 
       return (PGL_PC6_PTHVAR)super.removeRepetition("PTHVAR", rep);
    }
    ...
    public PGL_PC6_OBXNTE getOBXNTE() { 
       PGL_PC6_OBXNTE retVal = getTyped("OBXNTE", PGL_PC6_OBXNTE.class);
       return retVal;
    }
     ...
     *     greater than the number of existing repetitions.
     */
    public PGL_PC6_OBXNTE getOBXNTE(int rep) { 
       PGL_PC6_OBXNTE retVal = getTyped("OBXNTE", rep, PGL_PC6_OBXNTE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PGL_PC6_OBXNTE> getOBXNTEAll() throws HL7Exception {
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertOBXNTE(PGL_PC6_OBXNTE structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public PGL_PC6_OBXNTE insertOBXNTE(int rep) throws HL7Exception { 
       return (PGL_PC6_OBXNTE)super.insertRepetition("OBXNTE", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public PGL_PC6_OBXNTE removeOBXNTE(int rep) throws HL7Exception { 
       return (PGL_PC6_OBXNTE)super.removeRepetition("OBXNTE", rep);
    }
    ...
    public PGL_PC6_PRBNTEVARROLVAROBXNTE getPRBNTEVARROLVAROBXNTE() { 
       PGL_PC6_PRBNTEVARROLVAROBXNTE retVal = getTyped("PRBNTEVARROLVAROBXNTE", PGL_PC6_PRBNTEVARROLVAROBXNTE.class);
       return retVal;
    }
     ...
     *     greater than the number of existing repetitions.
     */
    public PGL_PC6_PRBNTEVARROLVAROBXNTE getPRBNTEVARROLVAROBXNTE(int rep) { 
       PGL_PC6_PRBNTEVARROLVAROBXNTE retVal = getTyped("PRBNTEVARROLVAROBXNTE", rep, PGL_PC6_PRBNTEVARROLVAROBXNTE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PGL_PC6_PRBNTEVARROLVAROBXNTE> getPRBNTEVARROLVAROBXNTEAll() throws HL7Exception {
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertPRBNTEVARROLVAROBXNTE(PGL_PC6_PRBNTEVARROLVAROBXNTE structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public PGL_PC6_PRBNTEVARROLVAROBXNTE insertPRBNTEVARROLVAROBXNTE(int rep) throws HL7Exception { 
       return (PGL_PC6_PRBNTEVARROLVAROBXNTE)super.insertRepetition("PRBNTEVARROLVAROBXNTE", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public PGL_PC6_PRBNTEVARROLVAROBXNTE removePRBNTEVARROLVAROBXNTE(int rep) throws HL7Exception { 
       return (PGL_PC6_PRBNTEVARROLVAROBXNTE)super.removeRepetition("PRBNTEVARROLVAROBXNTE", rep);
    }
    ...
    public PGL_PC6_ORCOBRRXONTEVAROBXNTEVAR getORCOBRRXONTEVAROBXNTEVAR() { 
       PGL_PC6_ORCOBRRXONTEVAROBXNTEVAR retVal = getTyped("ORCOBRRXONTEVAROBXNTEVAR", PGL_PC6_ORCOBRRXONTEVAROBXNTEVAR.class);
       return retVal;
    }
     ...
     *     greater than the number of existing repetitions.
     */
    public PGL_PC6_ORCOBRRXONTEVAROBXNTEVAR getORCOBRRXONTEVAROBXNTEVAR(int rep) { 
       PGL_PC6_ORCOBRRXONTEVAROBXNTEVAR retVal = getTyped("ORCOBRRXONTEVAROBXNTEVAR", rep, PGL_PC6_ORCOBRRXONTEVAROBXNTEVAR.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PGL_PC6_ORCOBRRXONTEVAROBXNTEVAR> getORCOBRRXONTEVAROBXNTEVARAll() throws HL7Exception {
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertORCOBRRXONTEVAROBXNTEVAR(PGL_PC6_ORCOBRRXONTEVAROBXNTEVAR structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public PGL_PC6_ORCOBRRXONTEVAROBXNTEVAR insertORCOBRRXONTEVAROBXNTEVAR(int rep) throws HL7Exception { 
       return (PGL_PC6_ORCOBRRXONTEVAROBXNTEVAR)super.insertRepetition("ORCOBRRXONTEVAROBXNTEVAR", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public PGL_PC6_ORCOBRRXONTEVAROBXNTEVAR removeORCOBRRXONTEVAROBXNTEVAR(int rep) throws HL7Exception { 
       return (PGL_PC6_ORCOBRRXONTEVAROBXNTEVAR)super.removeRepetition("ORCOBRRXONTEVAROBXNTEVAR", rep);
    }
