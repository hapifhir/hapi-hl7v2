...
/**
 * <p>Represents a OMN_O01_PIDPD1NTEPV1PV2IN1IN2IN3GT1AL1 group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>4: OMN_O01_PV1PV2 (a Group object) <b>optional  </b></li>
                         * <li>5: OMN_O01_IN1IN2IN3 (a Group object) <b>optional repeating </b></li>
...
public class OMN_O01_PIDPD1NTEPV1PV2IN1IN2IN3GT1AL1 extends AbstractGroup {

    /** 
     * Creates a new OMN_O01_PIDPD1NTEPV1PV2IN1IN2IN3GT1AL1 group
     */
    public OMN_O01_PIDPD1NTEPV1PV2IN1IN2IN3GT1AL1(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(OMN_O01_PV1PV2.class, false, false, false);
                                  this.add(OMN_O01_IN1IN2IN3.class, false, true, false);
                                  this.add(GT1.class, false, false, false);
                                  this.add(AL1.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating OMN_O01_PIDPD1NTEPV1PV2IN1IN2IN3GT1AL1 - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     */
    public OMN_O01_PV1PV2 getPV1PV2() { 
       OMN_O01_PV1PV2 retVal = getTyped("PV1PV2", OMN_O01_PV1PV2.class);
       return retVal;
    }
     ...
     */
    public OMN_O01_IN1IN2IN3 getIN1IN2IN3() { 
       OMN_O01_IN1IN2IN3 retVal = getTyped("IN1IN2IN3", OMN_O01_IN1IN2IN3.class);
       return retVal;
    }
     ...
     *     greater than the number of existing repetitions.
     */
    public OMN_O01_IN1IN2IN3 getIN1IN2IN3(int rep) { 
       OMN_O01_IN1IN2IN3 retVal = getTyped("IN1IN2IN3", rep, OMN_O01_IN1IN2IN3.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<OMN_O01_IN1IN2IN3> getIN1IN2IN3All() throws HL7Exception {
    	return getAllAsList("IN1IN2IN3", OMN_O01_IN1IN2IN3.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertIN1IN2IN3(OMN_O01_IN1IN2IN3 structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public OMN_O01_IN1IN2IN3 insertIN1IN2IN3(int rep) throws HL7Exception { 
       return (OMN_O01_IN1IN2IN3)super.insertRepetition("IN1IN2IN3", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public OMN_O01_IN1IN2IN3 removeIN1IN2IN3(int rep) throws HL7Exception { 
       return (OMN_O01_IN1IN2IN3)super.removeRepetition("IN1IN2IN3", rep);
    }
