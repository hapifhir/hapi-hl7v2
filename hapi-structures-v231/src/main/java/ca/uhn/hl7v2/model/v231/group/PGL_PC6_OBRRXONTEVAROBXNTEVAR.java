...
/**
 * <p>Represents a PGL_PC6_OBRRXONTEVAROBXNTEVAR group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>5: PGL_PC6_OBXNTEVAR (a Group object) <b>optional repeating </b></li>
 * </ul>
 * <p>
...
public class PGL_PC6_OBRRXONTEVAROBXNTEVAR extends AbstractGroup {

    /** 
     * Creates a new PGL_PC6_OBRRXONTEVAROBXNTEVAR group
     */
    public PGL_PC6_OBRRXONTEVAROBXNTEVAR(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(PGL_PC6_OBXNTEVAR.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating PGL_PC6_OBRRXONTEVAROBXNTEVAR - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     */
    public PGL_PC6_OBXNTEVAR getOBXNTEVAR() { 
       PGL_PC6_OBXNTEVAR retVal = getTyped("OBXNTEVAR", PGL_PC6_OBXNTEVAR.class);
       return retVal;
    }
     ...
     *     greater than the number of existing repetitions.
     */
    public PGL_PC6_OBXNTEVAR getOBXNTEVAR(int rep) { 
       PGL_PC6_OBXNTEVAR retVal = getTyped("OBXNTEVAR", rep, PGL_PC6_OBXNTEVAR.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PGL_PC6_OBXNTEVAR> getOBXNTEVARAll() throws HL7Exception {
    	return getAllAsList("OBXNTEVAR", PGL_PC6_OBXNTEVAR.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertOBXNTEVAR(PGL_PC6_OBXNTEVAR structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public PGL_PC6_OBXNTEVAR insertOBXNTEVAR(int rep) throws HL7Exception { 
       return (PGL_PC6_OBXNTEVAR)super.insertRepetition("OBXNTEVAR", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public PGL_PC6_OBXNTEVAR removeOBXNTEVAR(int rep) throws HL7Exception { 
       return (PGL_PC6_OBXNTEVAR)super.removeRepetition("OBXNTEVAR", rep);
    }
