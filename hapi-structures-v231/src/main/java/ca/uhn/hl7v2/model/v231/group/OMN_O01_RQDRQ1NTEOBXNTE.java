...
/**
 * <p>Represents a OMN_O01_RQDRQ1NTEOBXNTE group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: RQD (RQD - requisition detail segment) <b>  </b></li>
                         * <li>2: RQ1 (RQ1 - requisition detail-1 segment) <b>optional  </b></li>
                         * <li>3: NTE (NTE - notes and comments segment) <b>optional repeating </b></li>
                         * <li>4: OMN_O01_OBXNTE (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
...
public class OMN_O01_RQDRQ1NTEOBXNTE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(OMN_O01_OBXNTE.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating OMN_O01_RQDRQ1NTEOBXNTE - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public OMN_O01_OBXNTE getOBXNTE() { 
       OMN_O01_OBXNTE retVal = getTyped("OBXNTE", OMN_O01_OBXNTE.class);
       return retVal;
    }
    ...
    public OMN_O01_OBXNTE getOBXNTE(int rep) { 
       OMN_O01_OBXNTE retVal = getTyped("OBXNTE", rep, OMN_O01_OBXNTE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<OMN_O01_OBXNTE> getOBXNTEAll() throws HL7Exception {
    	return getAllAsList("OBXNTE", OMN_O01_OBXNTE.class);
    } 
