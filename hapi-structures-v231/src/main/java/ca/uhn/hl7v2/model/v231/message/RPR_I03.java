 ...
 * <ul>
		                 ...
		                 * <li>3: RPR_I03_PRDCTD (a Group object) <b> repeating</b> </li>
		                 * <li>4: PID (PID - patient identification segment) <b>optional repeating</b> </li>
...
public class RPR_I03 extends AbstractMessage  {
    ...
    public RPR_I03_PRDCTD getPRDCTD() { 
       return getTyped("PRDCTD", RPR_I03_PRDCTD.class);
    }
    ...
    public RPR_I03_PRDCTD getPRDCTD(int rep) { 
       return getTyped("PRDCTD", rep, RPR_I03_PRDCTD.class);
    }
     ...
     * 
     */ 
    public java.util.List<RPR_I03_PRDCTD> getPRDCTDAll() throws HL7Exception {
    ...
    /**
     * <p>
     * Inserts a specific repetition of PID (PID - patient identification segment)
     * </p>
     * 
     *
     * @see AbstractGroup#insertRepetition(Structure, int) 
    ...
    /**
     * <p>
     * Removes a specific repetition of PID (PID - patient identification segment)
     * </p>
     * 
     *
     * @see AbstractGroup#removeRepetition(String, int) 
