...
/**
 * <p>Represents a PTR_PCF_OBXNTEVAR group structure (a Group object).
...
public class PTR_PCF_OBXNTEVAR extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PTR_PCF_OBXNTEVAR - this is probably a bug in the source code generator.", e);
       }
    }
