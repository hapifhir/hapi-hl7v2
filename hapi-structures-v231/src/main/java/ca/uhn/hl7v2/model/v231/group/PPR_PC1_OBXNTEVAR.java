...
/**
 * <p>Represents a PPR_PC1_OBXNTEVAR group structure (a Group object).
...
public class PPR_PC1_OBXNTEVAR extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PPR_PC1_OBXNTEVAR - this is probably a bug in the source code generator.", e);
       }
    }
