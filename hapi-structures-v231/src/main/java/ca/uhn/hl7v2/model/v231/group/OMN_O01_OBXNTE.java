...
/**
 * <p>Represents a OMN_O01_OBXNTE group structure (a Group object).
...
public class OMN_O01_OBXNTE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating OMN_O01_OBXNTE - this is probably a bug in the source code generator.", e);
       }
    }
