...
/**
 * <p>Represents a RER_RER_PIDNTE group structure (a Group object).
...
public class RER_RER_PIDNTE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RER_RER_PIDNTE - this is probably a bug in the source code generator.", e);
       }
    }
