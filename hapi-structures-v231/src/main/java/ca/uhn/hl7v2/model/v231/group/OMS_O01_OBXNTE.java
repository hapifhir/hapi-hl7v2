...
/**
 * <p>Represents a OMS_O01_OBXNTE group structure (a Group object).
...
public class OMS_O01_OBXNTE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating OMS_O01_OBXNTE - this is probably a bug in the source code generator.", e);
       }
    }
