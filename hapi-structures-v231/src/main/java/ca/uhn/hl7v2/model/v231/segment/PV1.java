...
/**
 *<p>Represents an HL7 PV1 message segment (PV1 - patient visit segment-). 
...
public class PV1 extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CX.class, false, 1, 20, new Object[]{ getMessage() }, "Visit Number");
                                  ...
                                  this.add(DLD.class, false, 1, 25, new Object[]{ getMessage() }, "Discharged to Location");
