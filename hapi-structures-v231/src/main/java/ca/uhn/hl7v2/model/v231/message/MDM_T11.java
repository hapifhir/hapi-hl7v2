...
/**
 * <p>Represents a MDM_T11 message structure (see chapter ?). This structure contains the 
...
public class MDM_T11 extends AbstractMessage  {

    /**
     * Creates a new MDM_T11 message with DefaultModelClassFactory. 
     */ 
    public MDM_T11() { 
    ...
    /** 
     * Creates a new MDM_T11 message with custom ModelClassFactory.
     */
    public MDM_T11(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating MDM_T11 - this is probably a bug in the source code generator.", e);
       }
    }
