...
/**
 * <p>Represents a RDE_O01_PIDPD1NTEPV1PV2IN1IN2IN3GT1AL1 group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: PID (PID - patient identification segment) <b>  </b></li>
                         * <li>2: PD1 (PD1 - patient additional demographic segment) <b>optional  </b></li>
                         * <li>3: NTE (NTE - notes and comments segment) <b>optional repeating </b></li>
                         * <li>4: RDE_O01_PV1PV2 (a Group object) <b>optional  </b></li>
                         * <li>5: RDE_O01_IN1IN2IN3 (a Group object) <b>optional repeating </b></li>
                         * <li>6: GT1 (GT1 - guarantor segment) <b>optional  </b></li>
                         * <li>7: AL1 (AL1 - patient allergy information segment) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class RDE_O01_PIDPD1NTEPV1PV2IN1IN2IN3GT1AL1 extends AbstractGroup {

    /** 
     * Creates a new RDE_O01_PIDPD1NTEPV1PV2IN1IN2IN3GT1AL1 group
     */
    public RDE_O01_PIDPD1NTEPV1PV2IN1IN2IN3GT1AL1(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(RDE_O01_PV1PV2.class, false, false, false);
                                  this.add(RDE_O01_IN1IN2IN3.class, false, true, false);
                                  this.add(GT1.class, false, false, false);
                                  this.add(AL1.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating RDE_O01_PIDPD1NTEPV1PV2IN1IN2IN3GT1AL1 - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     */
    public RDE_O01_PV1PV2 getPV1PV2() { 
       RDE_O01_PV1PV2 retVal = getTyped("PV1PV2", RDE_O01_PV1PV2.class);
       return retVal;
    }
     ...
     */
    public RDE_O01_IN1IN2IN3 getIN1IN2IN3() { 
       RDE_O01_IN1IN2IN3 retVal = getTyped("IN1IN2IN3", RDE_O01_IN1IN2IN3.class);
       return retVal;
    }
     ...
     *     greater than the number of existing repetitions.
     */
    public RDE_O01_IN1IN2IN3 getIN1IN2IN3(int rep) { 
       RDE_O01_IN1IN2IN3 retVal = getTyped("IN1IN2IN3", rep, RDE_O01_IN1IN2IN3.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<RDE_O01_IN1IN2IN3> getIN1IN2IN3All() throws HL7Exception {
    	return getAllAsList("IN1IN2IN3", RDE_O01_IN1IN2IN3.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertIN1IN2IN3(RDE_O01_IN1IN2IN3 structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public RDE_O01_IN1IN2IN3 insertIN1IN2IN3(int rep) throws HL7Exception { 
       return (RDE_O01_IN1IN2IN3)super.insertRepetition("IN1IN2IN3", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public RDE_O01_IN1IN2IN3 removeIN1IN2IN3(int rep) throws HL7Exception { 
       return (RDE_O01_IN1IN2IN3)super.removeRepetition("IN1IN2IN3", rep);
    }
