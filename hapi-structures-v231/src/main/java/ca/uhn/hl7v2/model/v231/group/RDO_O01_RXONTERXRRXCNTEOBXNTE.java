...
/**
 * <p>Represents a RDO_O01_RXONTERXRRXCNTEOBXNTE group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>4: RDO_O01_RXCNTE (a Group object) <b>optional  </b></li>
                         * <li>5: RDO_O01_OBXNTE (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
...
public class RDO_O01_RXONTERXRRXCNTEOBXNTE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(RDO_O01_RXCNTE.class, false, false, false);
                                  this.add(RDO_O01_OBXNTE.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating RDO_O01_RXONTERXRRXCNTEOBXNTE - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public RDO_O01_RXCNTE getRXCNTE() { 
       RDO_O01_RXCNTE retVal = getTyped("RXCNTE", RDO_O01_RXCNTE.class);
       return retVal;
    }
    ...
    public RDO_O01_OBXNTE getOBXNTE() { 
       RDO_O01_OBXNTE retVal = getTyped("OBXNTE", RDO_O01_OBXNTE.class);
       return retVal;
    }
     ...
     *     greater than the number of existing repetitions.
     */
    public RDO_O01_OBXNTE getOBXNTE(int rep) { 
       RDO_O01_OBXNTE retVal = getTyped("OBXNTE", rep, RDO_O01_OBXNTE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<RDO_O01_OBXNTE> getOBXNTEAll() throws HL7Exception {
    	return getAllAsList("OBXNTE", RDO_O01_OBXNTE.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertOBXNTE(RDO_O01_OBXNTE structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public RDO_O01_OBXNTE insertOBXNTE(int rep) throws HL7Exception { 
       return (RDO_O01_OBXNTE)super.insertRepetition("OBXNTE", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public RDO_O01_OBXNTE removeOBXNTE(int rep) throws HL7Exception { 
       return (RDO_O01_OBXNTE)super.removeRepetition("OBXNTE", rep);
    }
