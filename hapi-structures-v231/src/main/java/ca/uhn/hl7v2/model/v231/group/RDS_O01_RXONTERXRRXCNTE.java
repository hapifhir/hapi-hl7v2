...
public class RDS_O01_RXONTERXRRXCNTE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(RDS_O01_NTERXRRXCNTE.class, false, false, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating RDS_O01_RXONTERXRRXCNTE - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public RDS_O01_NTERXRRXCNTE getNTERXRRXCNTE() { 
       RDS_O01_NTERXRRXCNTE retVal = getTyped("NTERXRRXCNTE", RDS_O01_NTERXRRXCNTE.class);
       return retVal;
    }
