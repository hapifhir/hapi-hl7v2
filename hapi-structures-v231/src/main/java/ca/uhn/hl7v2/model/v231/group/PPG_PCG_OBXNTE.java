...
/**
 * <p>Represents a PPG_PCG_OBXNTE group structure (a Group object).
...
public class PPG_PCG_OBXNTE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PPG_PCG_OBXNTE - this is probably a bug in the source code generator.", e);
       }
    }
