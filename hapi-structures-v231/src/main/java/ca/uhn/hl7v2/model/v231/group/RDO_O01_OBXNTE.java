...
/**
 * <p>Represents a RDO_O01_OBXNTE group structure (a Group object).
...
public class RDO_O01_OBXNTE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RDO_O01_OBXNTE - this is probably a bug in the source code generator.", e);
       }
    }
