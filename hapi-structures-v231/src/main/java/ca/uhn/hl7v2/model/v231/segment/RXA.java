...
/**
 *<p>Represents an HL7 RXA message segment (RXA - pharmacy/treatment administration segment). 
...
public class RXA extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(XCN.class, false, 0, 200, new Object[]{ getMessage() }, "Administering Provider");
                                  ...
                                  this.add(CE.class, false, 0, 200, new Object[]{ getMessage() }, "Substance Refusal Reason");
