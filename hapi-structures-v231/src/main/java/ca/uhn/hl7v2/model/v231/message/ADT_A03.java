...
/**
 * <p>Represents a ADT_A03 message structure (see chapter ?). This structure contains the 
 ...
 * <ul>
		                 ...
		                 * <li>9: DRG (DRG - diagnosis related group segment) <b>optional </b> </li>
		                 * <li>10: ADT_A03_PR1ROL (a Group object) <b>optional repeating</b> </li>
		                 * <li>11: OBX (OBX - observation/result segment) <b>optional repeating</b> </li>
 * </ul>
 */
...
public class ADT_A03 extends AbstractMessage  {
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(ADT_A03_PR1ROL.class, false, true);
    ...
    public ADT_A03_PR1ROL getPR1ROL() { 
       return getTyped("PR1ROL", ADT_A03_PR1ROL.class);
    }
     ...
     *     greater than the number of existing repetitions.
     */
    public ADT_A03_PR1ROL getPR1ROL(int rep) { 
       return getTyped("PR1ROL", rep, ADT_A03_PR1ROL.class);
    }
     ...
     * 
     */ 
    public java.util.List<ADT_A03_PR1ROL> getPR1ROLAll() throws HL7Exception {
    	return getAllAsList("PR1ROL", ADT_A03_PR1ROL.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertPR1ROL(ADT_A03_PR1ROL structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public ADT_A03_PR1ROL insertPR1ROL(int rep) throws HL7Exception { 
       return (ADT_A03_PR1ROL)super.insertRepetition("PR1ROL", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public ADT_A03_PR1ROL removePR1ROL(int rep) throws HL7Exception { 
       return (ADT_A03_PR1ROL)super.removeRepetition("PR1ROL", rep);
    }
