...
/**
 * <p>Represents a RPR_I03_PRDCTD group structure (a Group object).
...
public class RPR_I03_PRDCTD extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RPR_I03_PRDCTD - this is probably a bug in the source code generator.", e);
       }
    }
