...
/**
 * <p>Represents a PPP_PCB_PV1PV2 group structure (a Group object).
...
public class PPP_PCB_PV1PV2 extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PPP_PCB_PV1PV2 - this is probably a bug in the source code generator.", e);
       }
    }
