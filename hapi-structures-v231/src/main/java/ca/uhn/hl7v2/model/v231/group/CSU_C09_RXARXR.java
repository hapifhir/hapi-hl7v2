...
/**
 * <p>Represents a CSU_C09_RXARXR group structure (a Group object).
...
public class CSU_C09_RXARXR extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating CSU_C09_RXARXR - this is probably a bug in the source code generator.", e);
       }
    }
