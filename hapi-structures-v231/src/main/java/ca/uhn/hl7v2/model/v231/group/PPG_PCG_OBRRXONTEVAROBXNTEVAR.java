...
/**
 * <p>Represents a PPG_PCG_OBRRXONTEVAROBXNTEVAR group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>5: PPG_PCG_OBXNTEVAR (a Group object) <b>optional repeating </b></li>
 * </ul>
 * <p>
...
public class PPG_PCG_OBRRXONTEVAROBXNTEVAR extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(PPG_PCG_OBXNTEVAR.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating PPG_PCG_OBRRXONTEVAROBXNTEVAR - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public PPG_PCG_OBXNTEVAR getOBXNTEVAR() { 
       PPG_PCG_OBXNTEVAR retVal = getTyped("OBXNTEVAR", PPG_PCG_OBXNTEVAR.class);
       return retVal;
    }
     ...
     *     greater than the number of existing repetitions.
     */
    public PPG_PCG_OBXNTEVAR getOBXNTEVAR(int rep) { 
       PPG_PCG_OBXNTEVAR retVal = getTyped("OBXNTEVAR", rep, PPG_PCG_OBXNTEVAR.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PPG_PCG_OBXNTEVAR> getOBXNTEVARAll() throws HL7Exception {
    	return getAllAsList("OBXNTEVAR", PPG_PCG_OBXNTEVAR.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertOBXNTEVAR(PPG_PCG_OBXNTEVAR structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public PPG_PCG_OBXNTEVAR insertOBXNTEVAR(int rep) throws HL7Exception { 
       return (PPG_PCG_OBXNTEVAR)super.insertRepetition("OBXNTEVAR", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public PPG_PCG_OBXNTEVAR removeOBXNTEVAR(int rep) throws HL7Exception { 
       return (PPG_PCG_OBXNTEVAR)super.removeRepetition("OBXNTEVAR", rep);
    }
