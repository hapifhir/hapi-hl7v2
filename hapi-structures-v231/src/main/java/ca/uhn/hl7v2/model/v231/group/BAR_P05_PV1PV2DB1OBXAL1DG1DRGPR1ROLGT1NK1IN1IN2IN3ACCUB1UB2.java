...
/**
 * <p>Represents a BAR_P05_PV1PV2DB1OBXAL1DG1DRGPR1ROLGT1NK1IN1IN2IN3ACCUB1UB2 group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>8: BAR_P05_PR1ROL (a Group object) <b>optional repeating </b></li>
                         ...
                         * <li>11: BAR_P05_IN1IN2IN3 (a Group object) <b>optional repeating </b></li>
...
public class BAR_P05_PV1PV2DB1OBXAL1DG1DRGPR1ROLGT1NK1IN1IN2IN3ACCUB1UB2 extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(BAR_P05_PR1ROL.class, false, true, false);
                                  this.add(GT1.class, false, true, false);
                                  this.add(NK1.class, false, true, false);
                                  this.add(BAR_P05_IN1IN2IN3.class, false, true, false);
                                  this.add(ACC.class, false, false, false);
                                  this.add(UB1.class, false, false, false);
                                  this.add(UB2.class, false, false, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating BAR_P05_PV1PV2DB1OBXAL1DG1DRGPR1ROLGT1NK1IN1IN2IN3ACCUB1UB2 - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public BAR_P05_PR1ROL getPR1ROL() { 
       BAR_P05_PR1ROL retVal = getTyped("PR1ROL", BAR_P05_PR1ROL.class);
       return retVal;
    }
     ...
     *     greater than the number of existing repetitions.
     */
    public BAR_P05_PR1ROL getPR1ROL(int rep) { 
       BAR_P05_PR1ROL retVal = getTyped("PR1ROL", rep, BAR_P05_PR1ROL.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<BAR_P05_PR1ROL> getPR1ROLAll() throws HL7Exception {
    	return getAllAsList("PR1ROL", BAR_P05_PR1ROL.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertPR1ROL(BAR_P05_PR1ROL structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public BAR_P05_PR1ROL insertPR1ROL(int rep) throws HL7Exception { 
       return (BAR_P05_PR1ROL)super.insertRepetition("PR1ROL", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public BAR_P05_PR1ROL removePR1ROL(int rep) throws HL7Exception { 
       return (BAR_P05_PR1ROL)super.removeRepetition("PR1ROL", rep);
    }
    ...
    public BAR_P05_IN1IN2IN3 getIN1IN2IN3() { 
       BAR_P05_IN1IN2IN3 retVal = getTyped("IN1IN2IN3", BAR_P05_IN1IN2IN3.class);
       return retVal;
    }
     ...
     *     greater than the number of existing repetitions.
     */
    public BAR_P05_IN1IN2IN3 getIN1IN2IN3(int rep) { 
       BAR_P05_IN1IN2IN3 retVal = getTyped("IN1IN2IN3", rep, BAR_P05_IN1IN2IN3.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<BAR_P05_IN1IN2IN3> getIN1IN2IN3All() throws HL7Exception {
    	return getAllAsList("IN1IN2IN3", BAR_P05_IN1IN2IN3.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertIN1IN2IN3(BAR_P05_IN1IN2IN3 structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public BAR_P05_IN1IN2IN3 insertIN1IN2IN3(int rep) throws HL7Exception { 
       return (BAR_P05_IN1IN2IN3)super.insertRepetition("IN1IN2IN3", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public BAR_P05_IN1IN2IN3 removeIN1IN2IN3(int rep) throws HL7Exception { 
       return (BAR_P05_IN1IN2IN3)super.removeRepetition("IN1IN2IN3", rep);
    }
