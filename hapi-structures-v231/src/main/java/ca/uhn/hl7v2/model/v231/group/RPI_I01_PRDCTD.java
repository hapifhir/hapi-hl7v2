...
/**
 * <p>Represents a RPI_I01_PRDCTD group structure (a Group object).
...
public class RPI_I01_PRDCTD extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RPI_I01_PRDCTD - this is probably a bug in the source code generator.", e);
       }
    }
