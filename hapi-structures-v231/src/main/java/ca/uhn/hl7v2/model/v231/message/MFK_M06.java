...
/**
 * <p>Represents a MFK_M06 message structure (see chapter ?). This structure contains the 
 * following elements: </p>
 * <ul>
		                 * <li>1: MSH (MSH - message header segment) <b> </b> </li>
		                 * <li>2: MSA (MSA - message acknowledgment segment) <b> </b> </li>
		                 * <li>3: MFI (MFI - master file identification segment) <b> </b> </li>
		                 * <li>4: MFA (MFA - master file acknowledgment segment) <b>optional repeating</b> </li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class MFK_M06 extends AbstractMessage  {

    /**
     * Creates a new MFK_M06 message with DefaultModelClassFactory. 
     */ 
    public MFK_M06() { 
    ...
    /** 
     * Creates a new MFK_M06 message with custom ModelClassFactory.
     */
    public MFK_M06(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating MFK_M06 - this is probably a bug in the source code generator.", e);
       }
    }
