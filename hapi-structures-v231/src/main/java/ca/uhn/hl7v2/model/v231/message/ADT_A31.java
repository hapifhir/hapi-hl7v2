...
/**
 * <p>Represents a ADT_A31 message structure (see chapter ?). This structure contains the 
 ...
 * <ul>
		                 ...
		                 * <li>13: ADT_A31_PR1ROL (a Group object) <b>optional repeating</b> </li>
		                 * <li>14: GT1 (GT1 - guarantor segment) <b>optional repeating</b> </li>
		                 * <li>15: ADT_A31_IN1IN2IN3 (a Group object) <b>optional repeating</b> </li>
...
public class ADT_A31 extends AbstractMessage  {
    ...
    /**
     * Creates a new ADT_A31 message with DefaultModelClassFactory. 
     */ 
    public ADT_A31() { 
    ...
    /** 
     * Creates a new ADT_A31 message with custom ModelClassFactory.
     */
    public ADT_A31(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(ADT_A31_PR1ROL.class, false, true);
	                          this.add(GT1.class, false, true);
	                          this.add(ADT_A31_IN1IN2IN3.class, false, true);
	                          this.add(ACC.class, false, false);
	                          this.add(UB1.class, false, false);
	                          this.add(UB2.class, false, false);
	       } catch(HL7Exception e) {
          log.error("Unexpected error creating ADT_A31 - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     *
     */
    public ADT_A31_PR1ROL getPR1ROL() { 
       return getTyped("PR1ROL", ADT_A31_PR1ROL.class);
    }
     ...
     *     greater than the number of existing repetitions.
     */
    public ADT_A31_PR1ROL getPR1ROL(int rep) { 
       return getTyped("PR1ROL", rep, ADT_A31_PR1ROL.class);
    }
     ...
     * 
     */ 
    public java.util.List<ADT_A31_PR1ROL> getPR1ROLAll() throws HL7Exception {
    	return getAllAsList("PR1ROL", ADT_A31_PR1ROL.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertPR1ROL(ADT_A31_PR1ROL structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public ADT_A31_PR1ROL insertPR1ROL(int rep) throws HL7Exception { 
       return (ADT_A31_PR1ROL)super.insertRepetition("PR1ROL", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public ADT_A31_PR1ROL removePR1ROL(int rep) throws HL7Exception { 
       return (ADT_A31_PR1ROL)super.removeRepetition("PR1ROL", rep);
    }
     ...
     *
     */
    public ADT_A31_IN1IN2IN3 getIN1IN2IN3() { 
       return getTyped("IN1IN2IN3", ADT_A31_IN1IN2IN3.class);
    }
     ...
     *     greater than the number of existing repetitions.
     */
    public ADT_A31_IN1IN2IN3 getIN1IN2IN3(int rep) { 
       return getTyped("IN1IN2IN3", rep, ADT_A31_IN1IN2IN3.class);
    }
     ...
     * 
     */ 
    public java.util.List<ADT_A31_IN1IN2IN3> getIN1IN2IN3All() throws HL7Exception {
    	return getAllAsList("IN1IN2IN3", ADT_A31_IN1IN2IN3.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertIN1IN2IN3(ADT_A31_IN1IN2IN3 structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public ADT_A31_IN1IN2IN3 insertIN1IN2IN3(int rep) throws HL7Exception { 
       return (ADT_A31_IN1IN2IN3)super.insertRepetition("IN1IN2IN3", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public ADT_A31_IN1IN2IN3 removeIN1IN2IN3(int rep) throws HL7Exception { 
       return (ADT_A31_IN1IN2IN3)super.removeRepetition("IN1IN2IN3", rep);
    }
