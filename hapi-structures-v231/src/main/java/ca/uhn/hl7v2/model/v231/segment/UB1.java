...
/**
 *<p>Represents an HL7 UB1 message segment (UB1 - UB82 data segment). 
...
public class UB1 extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(UVC.class, false, 8, 12, new Object[]{ getMessage() }, "Value Amount & Code (46-49)");
                                  this.add(NM.class, false, 1, 2, new Object[]{ getMessage() }, "Number Of Grace Days (90)");
                                  this.add(CE.class, false, 1, 60, new Object[]{ getMessage() }, "Special Program Indicator (44)");
                                  this.add(CE.class, false, 1, 60, new Object[]{ getMessage() }, "PSRO/UR Approval Indicator (87)");
                                  ...
                                  this.add(OCD.class, false, 5, 20, new Object[]{ getMessage() }, "Occurrence (28-32)");
                                  this.add(CE.class, false, 1, 60, new Object[]{ getMessage() }, "Occurrence Span (33)");
