...
/**
 * <p>Represents a ORS_O02_ORCRQDNTE group structure (a Group object).
...
public class ORS_O02_ORCRQDNTE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ORS_O02_ORCRQDNTE - this is probably a bug in the source code generator.", e);
       }
    }
