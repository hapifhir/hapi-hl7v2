...
public class DOC_T12 extends AbstractMessage  {
    ...
    public DOC_T12_EVNPIDPV1TXAOBX getEVNPIDPV1TXAOBX() { 
       return getTyped("EVNPIDPV1TXAOBX", DOC_T12_EVNPIDPV1TXAOBX.class);
    }
    ...
    public DOC_T12_EVNPIDPV1TXAOBX getEVNPIDPV1TXAOBX(int rep) { 
       return getTyped("EVNPIDPV1TXAOBX", rep, DOC_T12_EVNPIDPV1TXAOBX.class);
    }
    ...
    public int getEVNPIDPV1TXAOBXReps() { 
    	return getReps("EVNPIDPV1TXAOBX");
    } 

    /** 
     * <p>
     * Returns a non-modifiable List containing all current existing repetitions of EVNPIDPV1TXAOBX.
     * <p>
     * <p>
     * Note that unlike {@link #getEVNPIDPV1TXAOBX()}, this method will not create any reps
     * if none are already present, so an empty list may be returned.
     * </p>
     * 
     */ 
    public java.util.List<DOC_T12_EVNPIDPV1TXAOBX> getEVNPIDPV1TXAOBXAll() throws HL7Exception {
    	return getAllAsList("EVNPIDPV1TXAOBX", DOC_T12_EVNPIDPV1TXAOBX.class);
    } 
