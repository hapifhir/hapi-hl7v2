...
/**
 * <p>Represents a REF_I12_PV1PV2 group structure (a Group object).
...
public class REF_I12_PV1PV2 extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating REF_I12_PV1PV2 - this is probably a bug in the source code generator.", e);
       }
    }
