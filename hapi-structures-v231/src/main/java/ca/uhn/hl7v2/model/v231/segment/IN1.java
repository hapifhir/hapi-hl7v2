...
/**
 *<p>Represents an HL7 IN1 message segment (IN1 - insurance segment). 
...
public class IN1 extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CE.class, true, 1, 60, new Object[]{ getMessage() }, "Insurance Plan ID");
                                  this.add(CX.class, true, 0, 59, new Object[]{ getMessage() }, "Insurance Company ID");
                                  this.add(XON.class, false, 0, 130, new Object[]{ getMessage() }, "Insurance Company Name");
                                  this.add(XAD.class, false, 0, 106, new Object[]{ getMessage() }, "Insurance Company Address");
                                  this.add(XPN.class, false, 0, 48, new Object[]{ getMessage() }, "Insurance Co Contact Person");
                                  this.add(XTN.class, false, 0, 40, new Object[]{ getMessage() }, "Insurance Co Phone Number");
                                  this.add(ST.class, false, 1, 12, new Object[]{ getMessage() }, "Group Number");
                                  this.add(XON.class, false, 0, 130, new Object[]{ getMessage() }, "Group Name");
                                  this.add(CX.class, false, 0, 12, new Object[]{ getMessage() }, "Insured’s Group Emp ID");
                                  this.add(XON.class, false, 0, 130, new Object[]{ getMessage() }, "Insured’s Group Emp Name");
                                  ...
                                  this.add(AUI.class, false, 1, 55, new Object[]{ getMessage() }, "Authorization Information");
                                              this.add(IS.class, false, 1, 3, new Object[]{ getMessage(), new Integer(86) }, "Plan Type");
                                  this.add(XPN.class, false, 0, 48, new Object[]{ getMessage() }, "Name Of Insured");
                                  this.add(CE.class, false, 1, 80, new Object[]{ getMessage() }, "Insured’s Relationship To Patient");
                                  this.add(TS.class, false, 1, 26, new Object[]{ getMessage() }, "Insured’s Date Of Birth");
                                  this.add(XAD.class, false, 0, 106, new Object[]{ getMessage() }, "Insured’s Address");
                                  ...
                                  this.add(XCN.class, false, 0, 60, new Object[]{ getMessage() }, "Verification By");
                                  ...
                                  this.add(XAD.class, false, 0, 106, new Object[]{ getMessage() }, "Insured’s Employer’s Address");
                                  ...
                                  this.add(CX.class, false, 0, 12, new Object[]{ getMessage() }, "Insured’s ID Number");
