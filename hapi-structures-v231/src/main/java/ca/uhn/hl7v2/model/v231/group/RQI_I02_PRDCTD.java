...
/**
 * <p>Represents a RQI_I02_PRDCTD group structure (a Group object).
...
public class RQI_I02_PRDCTD extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RQI_I02_PRDCTD - this is probably a bug in the source code generator.", e);
       }
    }
