...
/**
 *<p>Represents an HL7 AL1 message segment (AL1 - patient allergy information segment). 
 * This segment has the following fields:</p>
 * <ul>
     * <li>AL1-1: Set ID - AL1 (SI) <b> </b>
     * <li>AL1-2: Allergy Type (IS) <b>optional </b>
     * <li>AL1-3: Allergy Code/Mnemonic/Description (CE) <b> </b>
     * <li>AL1-4: Allergy Severity (IS) <b>optional </b>
     * <li>AL1-5: Allergy Reaction (ST) <b>optional repeating</b>
...
public class AL1 extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(SI.class, true, 1, 4, new Object[]{ getMessage() }, "Set ID - AL1");
                                              this.add(IS.class, false, 1, 2, new Object[]{ getMessage(), new Integer(127) }, "Allergy Type");
                                  this.add(CE.class, true, 1, 60, new Object[]{ getMessage() }, "Allergy Code/Mnemonic/Description");
                                              this.add(IS.class, false, 1, 2, new Object[]{ getMessage(), new Integer(128) }, "Allergy Severity");
                                  this.add(ST.class, false, 0, 15, new Object[]{ getMessage() }, "Allergy Reaction");
     ...
     * AL1-5: "Allergy Reaction" at a specific index
     *
     * @param rep The repetition index (0-indexed)
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public ST insertAllergyReaction(int rep) throws HL7Exception { 
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public ST insertAl15_AllergyReaction(int rep) throws HL7Exception { 
        return (ST) super.insertRepetition(5, rep);
    }
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public ST removeAllergyReaction(int rep) throws HL7Exception { 
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public ST removeAl15_AllergyReaction(int rep) throws HL7Exception { 
        return (ST) super.removeRepetition(5, rep);
    }
