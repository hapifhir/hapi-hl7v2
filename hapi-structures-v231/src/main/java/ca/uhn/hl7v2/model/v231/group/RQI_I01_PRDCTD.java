...
/**
 * <p>Represents a RQI_I01_PRDCTD group structure (a Group object).
...
public class RQI_I01_PRDCTD extends AbstractGroup {

    /** 
     * Creates a new RQI_I01_PRDCTD group
     */
    public RQI_I01_PRDCTD(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RQI_I01_PRDCTD - this is probably a bug in the source code generator.", e);
       }
    }
