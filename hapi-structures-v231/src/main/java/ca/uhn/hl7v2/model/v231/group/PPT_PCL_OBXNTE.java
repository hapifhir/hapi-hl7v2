...
/**
 * <p>Represents a PPT_PCL_OBXNTE group structure (a Group object).
...
public class PPT_PCL_OBXNTE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PPT_PCL_OBXNTE - this is probably a bug in the source code generator.", e);
       }
    }
