...
/**
 * <p>Represents a RQP_I04 message structure (see chapter ?). This structure contains the 
 * following elements: </p>
 * <ul>
		                 * <li>1: MSH (MSH - message header segment) <b> </b> </li>
		                 * <li>2: RQP_I04_PRDCTD (a Group object) <b> repeating</b> </li>
		                 ...
		                 * <li>5: GT1 (GT1 - guarantor segment) <b>optional repeating</b> </li>
...
public class RQP_I04 extends AbstractMessage  {
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          this.add(RQP_I04_PRDCTD.class, true, true);
     ...
     *
     */
    public RQP_I04_PRDCTD getPRDCTD() { 
       return getTyped("PRDCTD", RQP_I04_PRDCTD.class);
    }
     ...
     */
    public RQP_I04_PRDCTD getPRDCTD(int rep) { 
       return getTyped("PRDCTD", rep, RQP_I04_PRDCTD.class);
    }
     ...
     * 
     */ 
    public java.util.List<RQP_I04_PRDCTD> getPRDCTDAll() throws HL7Exception {
    	return getAllAsList("PRDCTD", RQP_I04_PRDCTD.class);
    } 
     ...
     */
    public void insertPRDCTD(RQP_I04_PRDCTD structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public RQP_I04_PRDCTD insertPRDCTD(int rep) throws HL7Exception { 
       return (RQP_I04_PRDCTD)super.insertRepetition("PRDCTD", rep);
    }
     ...
     */
    public RQP_I04_PRDCTD removePRDCTD(int rep) throws HL7Exception { 
       return (RQP_I04_PRDCTD)super.removeRepetition("PRDCTD", rep);
    }
