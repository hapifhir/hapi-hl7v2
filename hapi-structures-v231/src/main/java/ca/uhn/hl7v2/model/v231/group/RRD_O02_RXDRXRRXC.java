...
/**
 * <p>Represents a RRD_O02_RXDRXRRXC group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: RXD (RXD - pharmacy/treatment dispense segment) <b>  </b></li>
...
public class RRD_O02_RXDRXRRXC extends AbstractGroup {

    /** 
     * Creates a new RRD_O02_RXDRXRRXC group
     */
    public RRD_O02_RXDRXRRXC(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RRD_O02_RXDRXRRXC - this is probably a bug in the source code generator.", e);
       }
    }
