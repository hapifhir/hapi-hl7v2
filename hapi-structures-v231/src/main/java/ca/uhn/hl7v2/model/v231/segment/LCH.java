...
/**
 *<p>Represents an HL7 LCH message segment (LCH - location characteristic segment). 
 ...
 * <ul>
     ...
     * <li>LCH-5: Location Characteristic Value (CE) <b>optional </b>
 * </ul>
 */
...
public class LCH extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CE.class, true, 1, 80, new Object[]{ getMessage() }, "Location Characteristic ID");
                                  this.add(CE.class, false, 1, 80, new Object[]{ getMessage() }, "Location Characteristic Value");
    ...
    /**
     * Returns
     * LCH-5: "Location Characteristic Value" - creates it if necessary
     */
