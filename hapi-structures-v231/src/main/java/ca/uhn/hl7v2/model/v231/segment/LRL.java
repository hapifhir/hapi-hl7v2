...
/**
 *<p>Represents an HL7 LRL message segment (LRL - location relationship segment). 
...
public class LRL extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(XON.class, false, 0, 80, new Object[]{ getMessage() }, "Organizational Location Relationship Value");
