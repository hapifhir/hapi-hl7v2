...
/**
 * <p>Represents a MFN_M05_LDPLCHLCC group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: LDP (LDP - location department segment) <b>  </b></li>
                         * <li>2: LCH (LCH - location characteristic segment) <b>optional repeating </b></li>
                         * <li>3: LCC (LCC - location charge code segment) <b>optional repeating </b></li>
 * </ul>
 */
...
public class MFN_M05_LDPLCHLCC extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating MFN_M05_LDPLCHLCC - this is probably a bug in the source code generator.", e);
       }
    }
