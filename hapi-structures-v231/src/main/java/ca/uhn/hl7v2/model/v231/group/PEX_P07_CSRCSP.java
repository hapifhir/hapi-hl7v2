...
/**
 * <p>Represents a PEX_P07_CSRCSP group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: CSR (CSR - clinical study registration segment) <b>  </b></li>
                         * <li>2: CSP (CSP - clinical study phase segment) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class PEX_P07_CSRCSP extends AbstractGroup {

    /** 
     * Creates a new PEX_P07_CSRCSP group
     */
    public PEX_P07_CSRCSP(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PEX_P07_CSRCSP - this is probably a bug in the source code generator.", e);
       }
    }
