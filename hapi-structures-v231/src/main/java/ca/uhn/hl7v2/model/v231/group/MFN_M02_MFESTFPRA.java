...
/**
 * <p>Represents a MFN_M02_MFESTFPRA group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: MFE (MFE - master file entry segment) <b>  </b></li>
                         * <li>2: STF (STF - staff identification segment) <b>  </b></li>
                         * <li>3: PRA (PRA - practitioner detail segment) <b>optional  </b></li>
 * </ul>
 */
...
public class MFN_M02_MFESTFPRA extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating MFN_M02_MFESTFPRA - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    /**
     * Returns
     * STF (STF - staff identification segment) - creates it if necessary
     */
    public STF getSTF() { 
    ...
    /**
     * Returns
     * PRA (PRA - practitioner detail segment) - creates it if necessary
     */
    public PRA getPRA() { 
