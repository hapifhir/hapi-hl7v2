...
/**
 * <p>Represents a MDM_T07 message structure (see chapter ?). This structure contains the 
...
public class MDM_T07 extends AbstractMessage  {

    /**
     * Creates a new MDM_T07 message with DefaultModelClassFactory. 
     */ 
    public MDM_T07() { 
    ...
    /** 
     * Creates a new MDM_T07 message with custom ModelClassFactory.
     */
    public MDM_T07(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating MDM_T07 - this is probably a bug in the source code generator.", e);
       }
    }
