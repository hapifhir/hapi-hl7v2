...
/**
 * <p>Represents a MFN_M10_OM5OM4 group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: OM5 (OM5 - observation batteries (sets)  segment) <b>  </b></li>
                         * <li>2: OM4 (OM4 - observations that require specimens segment) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class MFN_M10_OM5OM4 extends AbstractGroup {

    /** 
     * Creates a new MFN_M10_OM5OM4 group
     */
    public MFN_M10_OM5OM4(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating MFN_M10_OM5OM4 - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    /**
     * Returns
     * OM5 (OM5 - observation batteries (sets)  segment) - creates it if necessary
     */
    public OM5 getOM5() { 
