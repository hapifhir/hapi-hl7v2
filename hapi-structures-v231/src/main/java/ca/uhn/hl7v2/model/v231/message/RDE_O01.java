 ...
 * <ul>
		                 ...
		                 * <li>3: RDE_O01_PIDPD1NTEPV1PV2IN1IN2IN3GT1AL1 (a Group object) <b>optional </b> </li>
		                 * <li>4: RDE_O01_ORCRXONTERXRRXCNTERXERXRRXCOBXNTECTI (a Group object) <b> repeating</b> </li>
 * </ul>
 */
...
public class RDE_O01 extends AbstractMessage  {
    ...
    /**
     * Creates a new RDE_O01 message with DefaultModelClassFactory. 
     */ 
    public RDE_O01() { 
    ...
    /** 
     * Creates a new RDE_O01 message with custom ModelClassFactory.
     */
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RDE_O01 - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public RDE_O01_PIDPD1NTEPV1PV2IN1IN2IN3GT1AL1 getPIDPD1NTEPV1PV2IN1IN2IN3GT1AL1() { 
       return getTyped("PIDPD1NTEPV1PV2IN1IN2IN3GT1AL1", RDE_O01_PIDPD1NTEPV1PV2IN1IN2IN3GT1AL1.class);
    }
     ...
     * Returns
     * the first repetition of 
     * ORCRXONTERXRRXCNTERXERXRRXCOBXNTECTI (a Group object) - creates it if necessary
     * </p>
     * 
     *
     */
    public RDE_O01_ORCRXONTERXRRXCNTERXERXRRXCOBXNTECTI getORCRXONTERXRRXCNTERXERXRRXCOBXNTECTI() { 
       return getTyped("ORCRXONTERXRRXCNTERXERXRRXCOBXNTECTI", RDE_O01_ORCRXONTERXRRXCNTERXERXRRXCOBXNTECTI.class);
    }
    ...
    public RDE_O01_ORCRXONTERXRRXCNTERXERXRRXCOBXNTECTI getORCRXONTERXRRXCNTERXERXRRXCOBXNTECTI(int rep) { 
       return getTyped("ORCRXONTERXRRXCNTERXERXRRXCOBXNTECTI", rep, RDE_O01_ORCRXONTERXRRXCNTERXERXRRXCOBXNTECTI.class);
    }

    /** 
     * <p>
     * Returns the number of existing repetitions of ORCRXONTERXRRXCNTERXERXRRXCOBXNTECTI 
     * </p>
     * 
     */ 
    public int getORCRXONTERXRRXCNTERXERXRRXCOBXNTECTIReps() { 
    	return getReps("ORCRXONTERXRRXCNTERXERXRRXCOBXNTECTI");
    } 

    /** 
     * <p>
     * Returns a non-modifiable List containing all current existing repetitions of ORCRXONTERXRRXCNTERXERXRRXCOBXNTECTI.
     * <p>
     * <p>
     * Note that unlike {@link #getORCRXONTERXRRXCNTERXERXRRXCOBXNTECTI()}, this method will not create any reps
     * if none are already present, so an empty list may be returned.
     * </p>
     * 
     */ 
    public java.util.List<RDE_O01_ORCRXONTERXRRXCNTERXERXRRXCOBXNTECTI> getORCRXONTERXRRXCNTERXERXRRXCOBXNTECTIAll() throws HL7Exception {
    	return getAllAsList("ORCRXONTERXRRXCNTERXERXRRXCOBXNTECTI", RDE_O01_ORCRXONTERXRRXCNTERXERXRRXCOBXNTECTI.class);
    } 

    /**
     * <p>
     * Inserts a specific repetition of ORCRXONTERXRRXCNTERXERXRRXCOBXNTECTI (a Group object)
     * </p>
     * 
     *
     * @see AbstractGroup#insertRepetition(Structure, int) 
    ...
    public void insertORCRXONTERXRRXCNTERXERXRRXCOBXNTECTI(RDE_O01_ORCRXONTERXRRXCNTERXERXRRXCOBXNTECTI structure, int rep) throws HL7Exception { 
       super.insertRepetition( "ORCRXONTERXRRXCNTERXERXRRXCOBXNTECTI", structure, rep);
    }
    ...
    /**
     * <p>
     * Removes a specific repetition of ORCRXONTERXRRXCNTERXERXRRXCOBXNTECTI (a Group object)
     * </p>
     * 
     *
     * @see AbstractGroup#removeRepetition(String, int) 
