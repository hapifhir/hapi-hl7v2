...
/**
 *<p>Represents an HL7 AIP message segment (AIP - appointment information - personnel resource segment). 
...
public class AIP extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(XCN.class, false, 0, 80, new Object[]{ getMessage() }, "Personnel Resource ID");
                                  this.add(CE.class, true, 1, 200, new Object[]{ getMessage() }, "Resource Role");
                                  this.add(CE.class, false, 1, 200, new Object[]{ getMessage() }, "Resource Group");
