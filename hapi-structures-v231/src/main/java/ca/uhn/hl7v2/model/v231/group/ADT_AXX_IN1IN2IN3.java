...
/**
 * <p>Represents a ADT_AXX_IN1IN2IN3 group structure (a Group object).
...
public class ADT_AXX_IN1IN2IN3 extends AbstractGroup {

    /** 
     * Creates a new ADT_AXX_IN1IN2IN3 group
     */
    public ADT_AXX_IN1IN2IN3(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ADT_AXX_IN1IN2IN3 - this is probably a bug in the source code generator.", e);
       }
    }
