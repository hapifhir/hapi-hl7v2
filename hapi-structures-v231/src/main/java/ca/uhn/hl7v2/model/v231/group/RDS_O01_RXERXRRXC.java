...
/**
 * <p>Represents a RDS_O01_RXERXRRXC group structure (a Group object).
...
public class RDS_O01_RXERXRRXC extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RDS_O01_RXERXRRXC - this is probably a bug in the source code generator.", e);
       }
    }
