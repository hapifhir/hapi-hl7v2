...
/**
 * <p>Represents a CRM_C01_PIDPV1CSRCSP group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>3: CSR (CSR - clinical study registration segment) <b>  </b></li>
                         * <li>4: CSP (CSP - clinical study phase segment) <b>optional repeating </b></li>
 * </ul>
 */
...
public class CRM_C01_PIDPV1CSRCSP extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating CRM_C01_PIDPV1CSRCSP - this is probably a bug in the source code generator.", e);
       }
    }
