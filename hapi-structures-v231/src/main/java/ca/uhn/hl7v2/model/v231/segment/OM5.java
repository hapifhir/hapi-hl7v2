...
/**
 *<p>Represents an HL7 OM5 message segment (OM5 - observation batteries (sets)  segment). 
...
public class OM5 extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CE.class, false, 0, 200, new Object[]{ getMessage() }, "Test/Observations Included within an Ordered Test Battery");
