...
/**
 * <p>Represents a RPI_I04 message structure (see chapter ?). This structure contains the 
 * following elements: </p>
 * <ul>
		                 * <li>1: MSH (MSH - message header segment) <b> </b> </li>
		                 * <li>2: MSA (MSA - message acknowledgment segment) <b> </b> </li>
		                 * <li>3: RPI_I04_PRDCTD (a Group object) <b> repeating</b> </li>
		                 * <li>4: PID (PID - patient identification segment) <b> </b> </li>
		                 * <li>5: NK1 (NK1 - next of kin / associated parties segment-) <b>optional repeating</b> </li>
		                 * <li>6: RPI_I04_GT1IN1IN2IN3 (a Group object) <b>optional </b> </li>
...
public class RPI_I04 extends AbstractMessage  {
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(RPI_I04_PRDCTD.class, true, true);
	                          this.add(PID.class, true, false);
	                          this.add(NK1.class, false, true);
	                          this.add(RPI_I04_GT1IN1IN2IN3.class, false, false);
     ...
     *
     */
    public RPI_I04_PRDCTD getPRDCTD() { 
       return getTyped("PRDCTD", RPI_I04_PRDCTD.class);
    }
     ...
     */
    public RPI_I04_PRDCTD getPRDCTD(int rep) { 
       return getTyped("PRDCTD", rep, RPI_I04_PRDCTD.class);
    }
     ...
     * 
     */ 
    public java.util.List<RPI_I04_PRDCTD> getPRDCTDAll() throws HL7Exception {
    	return getAllAsList("PRDCTD", RPI_I04_PRDCTD.class);
    } 
     ...
     */
    public void insertPRDCTD(RPI_I04_PRDCTD structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public RPI_I04_PRDCTD insertPRDCTD(int rep) throws HL7Exception { 
       return (RPI_I04_PRDCTD)super.insertRepetition("PRDCTD", rep);
    }
     ...
     */
    public RPI_I04_PRDCTD removePRDCTD(int rep) throws HL7Exception { 
       return (RPI_I04_PRDCTD)super.removeRepetition("PRDCTD", rep);
    }
     ...
     *
     */
    public RPI_I04_GT1IN1IN2IN3 getGT1IN1IN2IN3() { 
       return getTyped("GT1IN1IN2IN3", RPI_I04_GT1IN1IN2IN3.class);
    }
