...
public class DFT_P03_FT1PR1ROL extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(DFT_P03_PR1ROL.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating DFT_P03_FT1PR1ROL - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public DFT_P03_PR1ROL getPR1ROL() { 
       DFT_P03_PR1ROL retVal = getTyped("PR1ROL", DFT_P03_PR1ROL.class);
       return retVal;
    }
    ...
    public DFT_P03_PR1ROL getPR1ROL(int rep) { 
       DFT_P03_PR1ROL retVal = getTyped("PR1ROL", rep, DFT_P03_PR1ROL.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<DFT_P03_PR1ROL> getPR1ROLAll() throws HL7Exception {
    	return getAllAsList("PR1ROL", DFT_P03_PR1ROL.class);
    } 
