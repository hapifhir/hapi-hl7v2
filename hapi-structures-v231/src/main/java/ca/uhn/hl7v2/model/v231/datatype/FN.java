...
/**
 * <p>Represents an HL7 FN (family + last name prefix) data type. 
 * This type consists of the following components:</p>
 * <ul>
 * <li>family name (ST)
 * <li>last name prefix (ST)
 * </ul>
 */
...
public class FN extends AbstractComposite {
     ...
     * casting and handling an exception.
     */
    public ST getFn1_FamilyName() {
       return getTyped(0, ST.class);
    }


    /**
     * Returns last name prefix (component 2).  This is a convenience method that saves you from 
     * casting and handling an exception.
     */
     ...
     * casting and handling an exception.
     */
    public ST getFn2_LastNamePrefix() {
       return getTyped(1, ST.class);
    }
