...
/**
 * <p>Represents a RRD_O02_PIDNTE group structure (a Group object).
...
public class RRD_O02_PIDNTE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RRD_O02_PIDNTE - this is probably a bug in the source code generator.", e);
       }
    }
