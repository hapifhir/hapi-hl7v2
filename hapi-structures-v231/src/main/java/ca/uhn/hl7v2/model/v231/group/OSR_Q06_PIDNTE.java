...
/**
 * <p>Represents a OSR_Q06_PIDNTE group structure (a Group object).
...
public class OSR_Q06_PIDNTE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating OSR_Q06_PIDNTE - this is probably a bug in the source code generator.", e);
       }
    }
