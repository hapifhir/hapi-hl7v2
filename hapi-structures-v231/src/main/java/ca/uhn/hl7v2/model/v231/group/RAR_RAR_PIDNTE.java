...
/**
 * <p>Represents a RAR_RAR_PIDNTE group structure (a Group object).
...
public class RAR_RAR_PIDNTE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RAR_RAR_PIDNTE - this is probably a bug in the source code generator.", e);
       }
    }
