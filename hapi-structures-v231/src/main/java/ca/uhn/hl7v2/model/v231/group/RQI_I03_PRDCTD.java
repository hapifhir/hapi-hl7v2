...
/**
 * <p>Represents a RQI_I03_PRDCTD group structure (a Group object).
...
public class RQI_I03_PRDCTD extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RQI_I03_PRDCTD - this is probably a bug in the source code generator.", e);
       }
    }
