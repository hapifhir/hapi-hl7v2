...
public class RCL_I06 extends AbstractMessage  {
    ...
    public RCL_I06_PRDCTD getPRDCTD() { 
       return getTyped("PRDCTD", RCL_I06_PRDCTD.class);
    }
    ...
    public RCL_I06_PRDCTD getPRDCTD(int rep) { 
       return getTyped("PRDCTD", rep, RCL_I06_PRDCTD.class);
    }
     ...
     * 
     */ 
    public java.util.List<RCL_I06_PRDCTD> getPRDCTDAll() throws HL7Exception {
    	return getAllAsList("PRDCTD", RCL_I06_PRDCTD.class);
    } 
