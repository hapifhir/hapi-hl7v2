...
/**
 * <p>Represents a PPV_PCA_ROLVAR group structure (a Group object).
...
public class PPV_PCA_ROLVAR extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PPV_PCA_ROLVAR - this is probably a bug in the source code generator.", e);
       }
    }
