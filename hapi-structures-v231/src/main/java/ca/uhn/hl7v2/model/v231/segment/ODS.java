...
/**
 *<p>Represents an HL7 ODS message segment (ODS - dietary orders, supplements, and preferences segment). 
...
public class ODS extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CE.class, true, 20, 60, new Object[]{ getMessage() }, "Diet, Supplement, or Preference Code");
