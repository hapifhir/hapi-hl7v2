...
/**
 * <p>Represents a ORF_R04_OBXNTE group structure (a Group object).
...
public class ORF_R04_OBXNTE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ORF_R04_OBXNTE - this is probably a bug in the source code generator.", e);
       }
    }
