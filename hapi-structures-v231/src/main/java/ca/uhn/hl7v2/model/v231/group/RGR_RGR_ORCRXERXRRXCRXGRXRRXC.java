...
/**
 * <p>Represents a RGR_RGR_ORCRXERXRRXCRXGRXRRXC group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: ORC (ORC - common order segment) <b>  </b></li>
                         * <li>2: RGR_RGR_RXERXRRXC (a Group object) <b>optional  </b></li>
                         * <li>3: RXG (RXG - pharmacy/treatment give segment) <b> repeating </b></li>
...
public class RGR_RGR_ORCRXERXRRXCRXGRXRRXC extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(RGR_RGR_RXERXRRXC.class, false, false, false);
                                  this.add(RXG.class, true, true, false);
                                  this.add(RXR.class, true, true, false);
                                  this.add(RXC.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating RGR_RGR_ORCRXERXRRXCRXGRXRRXC - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public RGR_RGR_RXERXRRXC getRXERXRRXC() { 
       RGR_RGR_RXERXRRXC retVal = getTyped("RXERXRRXC", RGR_RGR_RXERXRRXC.class);
       return retVal;
    }
    ...
    /**
     * Inserts a specific repetition of RXG (RXG - pharmacy/treatment give segment)
    ...
    /**
     * Removes a specific repetition of RXG (RXG - pharmacy/treatment give segment)
