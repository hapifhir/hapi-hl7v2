...
/**
 * <p>Represents a REF_I12_PRDCTD group structure (a Group object).
...
public class REF_I12_PRDCTD extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating REF_I12_PRDCTD - this is probably a bug in the source code generator.", e);
       }
    }
