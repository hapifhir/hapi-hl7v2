...
/**
 * <p>Represents a VXR_V03_ORCRXARXROBXNTE group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: ORC (ORC - common order segment) <b>optional  </b></li>
                         * <li>2: RXA (RXA - pharmacy/treatment administration segment) <b>  </b></li>
                         * <li>3: RXR (RXR - pharmacy/treatment route segment) <b>optional  </b></li>
                         * <li>4: VXR_V03_OBXNTE (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
...
public class VXR_V03_ORCRXARXROBXNTE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(VXR_V03_OBXNTE.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating VXR_V03_ORCRXARXROBXNTE - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public VXR_V03_OBXNTE getOBXNTE() { 
       VXR_V03_OBXNTE retVal = getTyped("OBXNTE", VXR_V03_OBXNTE.class);
       return retVal;
    }
     ...
     */
    public VXR_V03_OBXNTE getOBXNTE(int rep) { 
       VXR_V03_OBXNTE retVal = getTyped("OBXNTE", rep, VXR_V03_OBXNTE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<VXR_V03_OBXNTE> getOBXNTEAll() throws HL7Exception {
    	return getAllAsList("OBXNTE", VXR_V03_OBXNTE.class);
    } 
     ...
     */
    public void insertOBXNTE(VXR_V03_OBXNTE structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public VXR_V03_OBXNTE insertOBXNTE(int rep) throws HL7Exception { 
       return (VXR_V03_OBXNTE)super.insertRepetition("OBXNTE", rep);
    }
     ...
     */
    public VXR_V03_OBXNTE removeOBXNTE(int rep) throws HL7Exception { 
       return (VXR_V03_OBXNTE)super.removeRepetition("OBXNTE", rep);
    }
