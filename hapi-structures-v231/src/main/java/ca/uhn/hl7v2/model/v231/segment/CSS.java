...
/**
 *<p>Represents an HL7 CSS message segment (CSS - clinical study data schedule segment). 
...
public class CSS extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(CE.class, true, 1, 60, new Object[]{ getMessage() }, "Study Scheduled Time Point");
