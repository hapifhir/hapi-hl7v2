...
/**
 * <p>Represents a RAS_O01_NTERXRRXCNTE group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: NTE (NTE - notes and comments segment) <b> repeating </b></li>
                         * <li>2: RXR (RXR - pharmacy/treatment route segment) <b> repeating </b></li>
                         * <li>3: RAS_O01_RXCNTE (a Group object) <b>optional  </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class RAS_O01_NTERXRRXCNTE extends AbstractGroup {

    /** 
     * Creates a new RAS_O01_NTERXRRXCNTE group
     */
    public RAS_O01_NTERXRRXCNTE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(RAS_O01_RXCNTE.class, false, false, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating RAS_O01_NTERXRRXCNTE - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     */
    public RAS_O01_RXCNTE getRXCNTE() { 
       RAS_O01_RXCNTE retVal = getTyped("RXCNTE", RAS_O01_RXCNTE.class);
       return retVal;
    }
