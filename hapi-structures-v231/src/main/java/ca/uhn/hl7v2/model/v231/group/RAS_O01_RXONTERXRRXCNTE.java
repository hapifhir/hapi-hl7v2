...
/**
 * <p>Represents a RAS_O01_RXONTERXRRXCNTE group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: RXO (RXO - pharmacy/treatment order segment) <b>  </b></li>
                         * <li>2: RAS_O01_NTERXRRXCNTE (a Group object) <b>optional  </b></li>
 * </ul>
 */
...
public class RAS_O01_RXONTERXRRXCNTE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(RAS_O01_NTERXRRXCNTE.class, false, false, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating RAS_O01_RXONTERXRRXCNTE - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public RAS_O01_NTERXRRXCNTE getNTERXRRXCNTE() { 
       RAS_O01_NTERXRRXCNTE retVal = getTyped("NTERXRRXCNTE", RAS_O01_NTERXRRXCNTE.class);
       return retVal;
    }
