...
/**
 * <p>Represents a ADT_A41_PIDPD1MRGPV1 group structure (a Group object).
...
public class ADT_A41_PIDPD1MRGPV1 extends AbstractGroup {

    /** 
     * Creates a new ADT_A41_PIDPD1MRGPV1 group
     */
    public ADT_A41_PIDPD1MRGPV1(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ADT_A41_PIDPD1MRGPV1 - this is probably a bug in the source code generator.", e);
       }
    }
