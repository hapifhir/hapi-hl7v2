...
/**
 * <p>Represents a RCI_I05_OBXNTE group structure (a Group object).
...
public class RCI_I05_OBXNTE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RCI_I05_OBXNTE - this is probably a bug in the source code generator.", e);
       }
    }
