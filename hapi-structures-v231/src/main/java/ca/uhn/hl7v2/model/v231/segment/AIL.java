...
/**
 *<p>Represents an HL7 AIL message segment (AIL - appointment information - location resource segment). 
 * This segment has the following fields:</p>
 * <ul>
     * <li>AIL-1: Set ID - AIL (SI) <b> </b>
     * <li>AIL-2: Segment Action Code (ID) <b>optional </b>
     * <li>AIL-3: Location Resource ID (PL) <b>optional </b>
     * <li>AIL-4: Location Type-AIL (CE) <b> </b>
...
public class AIL extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(PL.class, false, 1, 80, new Object[]{ getMessage() }, "Location Resource ID");
                                  this.add(CE.class, true, 1, 200, new Object[]{ getMessage() }, "Location Type-AIL");
                                  this.add(CE.class, false, 1, 200, new Object[]{ getMessage() }, "Location Group");
