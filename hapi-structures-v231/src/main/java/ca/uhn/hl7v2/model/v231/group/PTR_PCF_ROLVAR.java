...
/**
 * <p>Represents a PTR_PCF_ROLVAR group structure (a Group object).
...
public class PTR_PCF_ROLVAR extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PTR_PCF_ROLVAR - this is probably a bug in the source code generator.", e);
       }
    }
