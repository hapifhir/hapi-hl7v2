...
/**
 * <p>Represents a ADT_A45_MRGPV1 group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: MRG (MRG - merge patient information segment-) <b>  </b></li>
                         * <li>2: PV1 (PV1 - patient visit segment-) <b>  </b></li>
 * </ul>
 */
...
public class ADT_A45_MRGPV1 extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ADT_A45_MRGPV1 - this is probably a bug in the source code generator.", e);
       }
    }
