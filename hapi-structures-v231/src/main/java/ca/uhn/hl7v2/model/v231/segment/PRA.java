...
/**
 *<p>Represents an HL7 PRA message segment (PRA - practitioner detail segment). 
 * This segment has the following fields:</p>
 * <ul>
     * <li>PRA-1: Primary Key Value - PRA (CE) <b> </b>
...
public class PRA extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(CE.class, true, 1, 60, new Object[]{ getMessage() }, "Primary Key Value - PRA");
                                  ...
                                  this.add(SPD.class, false, 0, 100, new Object[]{ getMessage() }, "Specialty");
                                  this.add(PLN.class, false, 0, 100, new Object[]{ getMessage() }, "Practitioner ID Numbers");
                                  this.add(PIP.class, false, 0, 200, new Object[]{ getMessage() }, "Privileges");
