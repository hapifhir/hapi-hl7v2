...
/**
 * <p>Represents a RDR_RDR_RXDRXRRXC group structure (a Group object).
...
public class RDR_RDR_RXDRXRRXC extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RDR_RDR_RXDRXRRXC - this is probably a bug in the source code generator.", e);
       }
    }
