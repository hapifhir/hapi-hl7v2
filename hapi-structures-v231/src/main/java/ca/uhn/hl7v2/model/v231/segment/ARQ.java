...
/**
 *<p>Represents an HL7 ARQ message segment (ARQ - appointment request segment). 
...
public class ARQ extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(XCN.class, true, 0, 48, new Object[]{ getMessage() }, "Placer Contact Person");
                                  this.add(XTN.class, false, 0, 40, new Object[]{ getMessage() }, "Placer Contact Phone Number");
