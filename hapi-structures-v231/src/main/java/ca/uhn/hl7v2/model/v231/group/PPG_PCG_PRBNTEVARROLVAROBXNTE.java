...
/**
 * <p>Represents a PPG_PCG_PRBNTEVARROLVAROBXNTE group structure (a Group object).
...
public class PPG_PCG_PRBNTEVARROLVAROBXNTE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PPG_PCG_PRBNTEVARROLVAROBXNTE - this is probably a bug in the source code generator.", e);
       }
    }
