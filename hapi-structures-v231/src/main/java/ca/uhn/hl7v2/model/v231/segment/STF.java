...
/**
 *<p>Represents an HL7 STF message segment (STF - staff identification segment). 
 * This segment has the following fields:</p>
 * <ul>
     * <li>STF-1: Primary Key Value - STF (CE) <b> </b>
...
public class STF extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(CE.class, true, 1, 60, new Object[]{ getMessage() }, "Primary Key Value - STF");
                                  this.add(CX.class, false, 0, 60, new Object[]{ getMessage() }, "Staff ID Code");
                                  this.add(XPN.class, false, 0, 48, new Object[]{ getMessage() }, "Staff Name");
                                  ...
                                  this.add(CE.class, false, 0, 200, new Object[]{ getMessage() }, "Hospital Service");
                                  this.add(XTN.class, false, 0, 40, new Object[]{ getMessage() }, "Phone");
                                  this.add(XAD.class, false, 0, 106, new Object[]{ getMessage() }, "Office/Home Address");
