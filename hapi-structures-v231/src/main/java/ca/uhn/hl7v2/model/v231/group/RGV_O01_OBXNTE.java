...
/**
 * <p>Represents a RGV_O01_OBXNTE group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: OBX (OBX - observation/result segment) <b>optional  </b></li>
...
public class RGV_O01_OBXNTE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RGV_O01_OBXNTE - this is probably a bug in the source code generator.", e);
       }
    }
