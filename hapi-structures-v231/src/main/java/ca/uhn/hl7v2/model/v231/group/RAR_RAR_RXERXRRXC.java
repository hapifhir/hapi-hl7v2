...
/**
 * <p>Represents a RAR_RAR_RXERXRRXC group structure (a Group object).
...
public class RAR_RAR_RXERXRRXC extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RAR_RAR_RXERXRRXC - this is probably a bug in the source code generator.", e);
       }
    }
