...
/**
 * <p>Represents a RDR_RDR_PIDNTE group structure (a Group object).
...
public class RDR_RDR_PIDNTE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RDR_RDR_PIDNTE - this is probably a bug in the source code generator.", e);
       }
    }
