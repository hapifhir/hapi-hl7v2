...
/**
 * <p>Represents a RQA_I08_OBXNTE group structure (a Group object).
...
public class RQA_I08_OBXNTE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RQA_I08_OBXNTE - this is probably a bug in the source code generator.", e);
       }
    }
