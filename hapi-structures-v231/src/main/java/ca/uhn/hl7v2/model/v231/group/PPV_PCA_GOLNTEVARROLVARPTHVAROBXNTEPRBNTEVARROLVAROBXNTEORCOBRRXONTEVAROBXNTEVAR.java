...
/**
 * <p>Represents a PPV_PCA_GOLNTEVARROLVARPTHVAROBXNTEPRBNTEVARROLVAROBXNTEORCOBRRXONTEVAROBXNTEVAR group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>4: PPV_PCA_ROLVAR (a Group object) <b>optional repeating </b></li>
                         * <li>5: PPV_PCA_PTHVAR (a Group object) <b>optional repeating </b></li>
                         * <li>6: PPV_PCA_OBXNTE (a Group object) <b>optional repeating </b></li>
                         * <li>7: PPV_PCA_PRBNTEVARROLVAROBXNTE (a Group object) <b>optional repeating </b></li>
                         * <li>8: PPV_PCA_ORCOBRRXONTEVAROBXNTEVAR (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
...
public class PPV_PCA_GOLNTEVARROLVARPTHVAROBXNTEPRBNTEVARROLVAROBXNTEORCOBRRXONTEVAROBXNTEVAR extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(PPV_PCA_ROLVAR.class, false, true, false);
                                  this.add(PPV_PCA_PTHVAR.class, false, true, false);
                                  this.add(PPV_PCA_OBXNTE.class, false, true, false);
                                  this.add(PPV_PCA_PRBNTEVARROLVAROBXNTE.class, false, true, false);
                                  this.add(PPV_PCA_ORCOBRRXONTEVAROBXNTEVAR.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating PPV_PCA_GOLNTEVARROLVARPTHVAROBXNTEPRBNTEVARROLVAROBXNTEORCOBRRXONTEVAROBXNTEVAR - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public PPV_PCA_ROLVAR getROLVAR() { 
       PPV_PCA_ROLVAR retVal = getTyped("ROLVAR", PPV_PCA_ROLVAR.class);
       return retVal;
    }
     ...
     *     greater than the number of existing repetitions.
     */
    public PPV_PCA_ROLVAR getROLVAR(int rep) { 
       PPV_PCA_ROLVAR retVal = getTyped("ROLVAR", rep, PPV_PCA_ROLVAR.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PPV_PCA_ROLVAR> getROLVARAll() throws HL7Exception {
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertROLVAR(PPV_PCA_ROLVAR structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public PPV_PCA_ROLVAR insertROLVAR(int rep) throws HL7Exception { 
       return (PPV_PCA_ROLVAR)super.insertRepetition("ROLVAR", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public PPV_PCA_ROLVAR removeROLVAR(int rep) throws HL7Exception { 
       return (PPV_PCA_ROLVAR)super.removeRepetition("ROLVAR", rep);
    }
    ...
    public PPV_PCA_PTHVAR getPTHVAR() { 
       PPV_PCA_PTHVAR retVal = getTyped("PTHVAR", PPV_PCA_PTHVAR.class);
       return retVal;
    }
     ...
     *     greater than the number of existing repetitions.
     */
    public PPV_PCA_PTHVAR getPTHVAR(int rep) { 
       PPV_PCA_PTHVAR retVal = getTyped("PTHVAR", rep, PPV_PCA_PTHVAR.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PPV_PCA_PTHVAR> getPTHVARAll() throws HL7Exception {
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertPTHVAR(PPV_PCA_PTHVAR structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public PPV_PCA_PTHVAR insertPTHVAR(int rep) throws HL7Exception { 
       return (PPV_PCA_PTHVAR)super.insertRepetition("PTHVAR", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public PPV_PCA_PTHVAR removePTHVAR(int rep) throws HL7Exception { 
       return (PPV_PCA_PTHVAR)super.removeRepetition("PTHVAR", rep);
    }
    ...
    public PPV_PCA_OBXNTE getOBXNTE() { 
       PPV_PCA_OBXNTE retVal = getTyped("OBXNTE", PPV_PCA_OBXNTE.class);
       return retVal;
    }
     ...
     *     greater than the number of existing repetitions.
     */
    public PPV_PCA_OBXNTE getOBXNTE(int rep) { 
       PPV_PCA_OBXNTE retVal = getTyped("OBXNTE", rep, PPV_PCA_OBXNTE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PPV_PCA_OBXNTE> getOBXNTEAll() throws HL7Exception {
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertOBXNTE(PPV_PCA_OBXNTE structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public PPV_PCA_OBXNTE insertOBXNTE(int rep) throws HL7Exception { 
       return (PPV_PCA_OBXNTE)super.insertRepetition("OBXNTE", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public PPV_PCA_OBXNTE removeOBXNTE(int rep) throws HL7Exception { 
       return (PPV_PCA_OBXNTE)super.removeRepetition("OBXNTE", rep);
    }
    ...
    public PPV_PCA_PRBNTEVARROLVAROBXNTE getPRBNTEVARROLVAROBXNTE() { 
       PPV_PCA_PRBNTEVARROLVAROBXNTE retVal = getTyped("PRBNTEVARROLVAROBXNTE", PPV_PCA_PRBNTEVARROLVAROBXNTE.class);
       return retVal;
    }
     ...
     *     greater than the number of existing repetitions.
     */
    public PPV_PCA_PRBNTEVARROLVAROBXNTE getPRBNTEVARROLVAROBXNTE(int rep) { 
       PPV_PCA_PRBNTEVARROLVAROBXNTE retVal = getTyped("PRBNTEVARROLVAROBXNTE", rep, PPV_PCA_PRBNTEVARROLVAROBXNTE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PPV_PCA_PRBNTEVARROLVAROBXNTE> getPRBNTEVARROLVAROBXNTEAll() throws HL7Exception {
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertPRBNTEVARROLVAROBXNTE(PPV_PCA_PRBNTEVARROLVAROBXNTE structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public PPV_PCA_PRBNTEVARROLVAROBXNTE insertPRBNTEVARROLVAROBXNTE(int rep) throws HL7Exception { 
       return (PPV_PCA_PRBNTEVARROLVAROBXNTE)super.insertRepetition("PRBNTEVARROLVAROBXNTE", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public PPV_PCA_PRBNTEVARROLVAROBXNTE removePRBNTEVARROLVAROBXNTE(int rep) throws HL7Exception { 
       return (PPV_PCA_PRBNTEVARROLVAROBXNTE)super.removeRepetition("PRBNTEVARROLVAROBXNTE", rep);
    }
    ...
    public PPV_PCA_ORCOBRRXONTEVAROBXNTEVAR getORCOBRRXONTEVAROBXNTEVAR() { 
       PPV_PCA_ORCOBRRXONTEVAROBXNTEVAR retVal = getTyped("ORCOBRRXONTEVAROBXNTEVAR", PPV_PCA_ORCOBRRXONTEVAROBXNTEVAR.class);
       return retVal;
    }
     ...
     *     greater than the number of existing repetitions.
     */
    public PPV_PCA_ORCOBRRXONTEVAROBXNTEVAR getORCOBRRXONTEVAROBXNTEVAR(int rep) { 
       PPV_PCA_ORCOBRRXONTEVAROBXNTEVAR retVal = getTyped("ORCOBRRXONTEVAROBXNTEVAR", rep, PPV_PCA_ORCOBRRXONTEVAROBXNTEVAR.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PPV_PCA_ORCOBRRXONTEVAROBXNTEVAR> getORCOBRRXONTEVAROBXNTEVARAll() throws HL7Exception {
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertORCOBRRXONTEVAROBXNTEVAR(PPV_PCA_ORCOBRRXONTEVAROBXNTEVAR structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public PPV_PCA_ORCOBRRXONTEVAROBXNTEVAR insertORCOBRRXONTEVAROBXNTEVAR(int rep) throws HL7Exception { 
       return (PPV_PCA_ORCOBRRXONTEVAROBXNTEVAR)super.insertRepetition("ORCOBRRXONTEVAROBXNTEVAR", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public PPV_PCA_ORCOBRRXONTEVAROBXNTEVAR removeORCOBRRXONTEVAROBXNTEVAR(int rep) throws HL7Exception { 
       return (PPV_PCA_ORCOBRRXONTEVAROBXNTEVAR)super.removeRepetition("ORCOBRRXONTEVAROBXNTEVAR", rep);
    }
