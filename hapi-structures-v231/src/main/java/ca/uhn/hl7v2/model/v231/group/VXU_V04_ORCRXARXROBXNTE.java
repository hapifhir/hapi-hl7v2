...
/**
 * <p>Represents a VXU_V04_ORCRXARXROBXNTE group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>4: VXU_V04_OBXNTE (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
...
public class VXU_V04_ORCRXARXROBXNTE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(VXU_V04_OBXNTE.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating VXU_V04_ORCRXARXROBXNTE - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public VXU_V04_OBXNTE getOBXNTE() { 
       VXU_V04_OBXNTE retVal = getTyped("OBXNTE", VXU_V04_OBXNTE.class);
       return retVal;
    }
    ...
    public VXU_V04_OBXNTE getOBXNTE(int rep) { 
       VXU_V04_OBXNTE retVal = getTyped("OBXNTE", rep, VXU_V04_OBXNTE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<VXU_V04_OBXNTE> getOBXNTEAll() throws HL7Exception {
    	return getAllAsList("OBXNTE", VXU_V04_OBXNTE.class);
    } 
