...
/**
 * <p>Represents a RGV_O01_RXONTERXRRXCNTE group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: RXO (RXO - pharmacy/treatment order segment) <b>  </b></li>
                         * <li>2: RGV_O01_NTERXRRXCNTE (a Group object) <b>optional  </b></li>
 * </ul>
 */
...
public class RGV_O01_RXONTERXRRXCNTE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(RGV_O01_NTERXRRXCNTE.class, false, false, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating RGV_O01_RXONTERXRRXCNTE - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public RGV_O01_NTERXRRXCNTE getNTERXRRXCNTE() { 
       RGV_O01_NTERXRRXCNTE retVal = getTyped("NTERXRRXCNTE", RGV_O01_NTERXRRXCNTE.class);
       return retVal;
    }
