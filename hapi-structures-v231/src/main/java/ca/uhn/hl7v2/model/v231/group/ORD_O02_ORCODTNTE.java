...
/**
 * <p>Represents a ORD_O02_ORCODTNTE group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: ORC (ORC - common order segment) <b>  </b></li>
                         * <li>2: ODT (ODT - diet tray instructions segment) <b>optional repeating </b></li>
...
public class ORD_O02_ORCODTNTE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ORD_O02_ORCODTNTE - this is probably a bug in the source code generator.", e);
       }
    }
