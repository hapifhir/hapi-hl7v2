...
public class ROR_R0R extends AbstractMessage  {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ROR_R0R - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public ROR_R0R_QRDQRFPIDNTEORCRXORXRRXC getQRDQRFPIDNTEORCRXORXRRXC() { 
       return getTyped("QRDQRFPIDNTEORCRXORXRRXC", ROR_R0R_QRDQRFPIDNTEORCRXORXRRXC.class);
    }
    ...
    public ROR_R0R_QRDQRFPIDNTEORCRXORXRRXC getQRDQRFPIDNTEORCRXORXRRXC(int rep) { 
       return getTyped("QRDQRFPIDNTEORCRXORXRRXC", rep, ROR_R0R_QRDQRFPIDNTEORCRXORXRRXC.class);
    }
    ...
    public int getQRDQRFPIDNTEORCRXORXRRXCReps() { 
    	return getReps("QRDQRFPIDNTEORCRXORXRRXC");
    } 

    /** 
     * <p>
     * Returns a non-modifiable List containing all current existing repetitions of QRDQRFPIDNTEORCRXORXRRXC.
     * <p>
     * <p>
     * Note that unlike {@link #getQRDQRFPIDNTEORCRXORXRRXC()}, this method will not create any reps
     * if none are already present, so an empty list may be returned.
     * </p>
     * 
     */ 
    public java.util.List<ROR_R0R_QRDQRFPIDNTEORCRXORXRRXC> getQRDQRFPIDNTEORCRXORXRRXCAll() throws HL7Exception {
    	return getAllAsList("QRDQRFPIDNTEORCRXORXRRXC", ROR_R0R_QRDQRFPIDNTEORCRXORXRRXC.class);
    } 
