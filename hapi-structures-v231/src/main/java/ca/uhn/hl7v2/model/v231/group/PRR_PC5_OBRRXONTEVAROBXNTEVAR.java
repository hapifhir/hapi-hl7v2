...
/**
 * <p>Represents a PRR_PC5_OBRRXONTEVAROBXNTEVAR group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>5: PRR_PC5_OBXNTEVAR (a Group object) <b>optional repeating </b></li>
 * </ul>
 * <p>
...
public class PRR_PC5_OBRRXONTEVAROBXNTEVAR extends AbstractGroup {

    /** 
     * Creates a new PRR_PC5_OBRRXONTEVAROBXNTEVAR group
     */
    public PRR_PC5_OBRRXONTEVAROBXNTEVAR(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(PRR_PC5_OBXNTEVAR.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating PRR_PC5_OBRRXONTEVAROBXNTEVAR - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     */
    public PRR_PC5_OBXNTEVAR getOBXNTEVAR() { 
       PRR_PC5_OBXNTEVAR retVal = getTyped("OBXNTEVAR", PRR_PC5_OBXNTEVAR.class);
       return retVal;
    }
     ...
     *     greater than the number of existing repetitions.
     */
    public PRR_PC5_OBXNTEVAR getOBXNTEVAR(int rep) { 
       PRR_PC5_OBXNTEVAR retVal = getTyped("OBXNTEVAR", rep, PRR_PC5_OBXNTEVAR.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PRR_PC5_OBXNTEVAR> getOBXNTEVARAll() throws HL7Exception {
    	return getAllAsList("OBXNTEVAR", PRR_PC5_OBXNTEVAR.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertOBXNTEVAR(PRR_PC5_OBXNTEVAR structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public PRR_PC5_OBXNTEVAR insertOBXNTEVAR(int rep) throws HL7Exception { 
       return (PRR_PC5_OBXNTEVAR)super.insertRepetition("OBXNTEVAR", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public PRR_PC5_OBXNTEVAR removeOBXNTEVAR(int rep) throws HL7Exception { 
       return (PRR_PC5_OBXNTEVAR)super.removeRepetition("OBXNTEVAR", rep);
    }
