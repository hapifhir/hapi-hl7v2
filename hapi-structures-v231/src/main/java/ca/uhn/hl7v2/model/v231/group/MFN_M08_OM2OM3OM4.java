...
/**
 * <p>Represents a MFN_M08_OM2OM3OM4 group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: OM2 (OM2 - numeric observation segment) <b>optional  </b></li>
                         * <li>2: OM3 (OM3 - categorical test/observation segment) <b>optional  </b></li>
                         * <li>3: OM4 (OM4 - observations that require specimens segment) <b>optional  </b></li>
 * </ul>
 */
...
public class MFN_M08_OM2OM3OM4 extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating MFN_M08_OM2OM3OM4 - this is probably a bug in the source code generator.", e);
       }
    }
