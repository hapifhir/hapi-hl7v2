...
/**
 * <p>Represents a MFN_M05_MFELOCLCHLRLLDPLCHLCC group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: MFE (MFE - master file entry segment) <b>  </b></li>
                         * <li>2: LOC (LOC - location identification segment) <b>  </b></li>
                         * <li>3: LCH (LCH - location characteristic segment) <b>optional repeating </b></li>
                         * <li>4: LRL (LRL - location relationship segment) <b>optional repeating </b></li>
                         * <li>5: MFN_M05_LDPLCHLCC (a Group object) <b> repeating </b></li>
 * </ul>
 */
...
public class MFN_M05_MFELOCLCHLRLLDPLCHLCC extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating MFN_M05_MFELOCLCHLRLLDPLCHLCC - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public MFN_M05_LDPLCHLCC getLDPLCHLCC() { 
       MFN_M05_LDPLCHLCC retVal = getTyped("LDPLCHLCC", MFN_M05_LDPLCHLCC.class);
       return retVal;
    }
    ...
    public MFN_M05_LDPLCHLCC getLDPLCHLCC(int rep) { 
       MFN_M05_LDPLCHLCC retVal = getTyped("LDPLCHLCC", rep, MFN_M05_LDPLCHLCC.class);
       return retVal;
    }
     ...
     * <p>
     * <p>
     * Note that unlike {@link #getLDPLCHLCC()}, this method will not create any reps
     * if none are already present, so an empty list may be returned.
     * </p>
     */ 
    public java.util.List<MFN_M05_LDPLCHLCC> getLDPLCHLCCAll() throws HL7Exception {
    ...
    public void insertLDPLCHLCC(MFN_M05_LDPLCHLCC structure, int rep) throws HL7Exception { 
       super.insertRepetition("LDPLCHLCC", structure, rep);
    }
