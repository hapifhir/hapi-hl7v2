...
/**
 * <p>Represents a ADT_AXX_PIDPD1MRGPV1 group structure (a Group object).
...
public class ADT_AXX_PIDPD1MRGPV1 extends AbstractGroup {

    /** 
     * Creates a new ADT_AXX_PIDPD1MRGPV1 group
     */
    public ADT_AXX_PIDPD1MRGPV1(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ADT_AXX_PIDPD1MRGPV1 - this is probably a bug in the source code generator.", e);
       }
    }
