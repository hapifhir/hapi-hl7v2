...
/**
 * <p>Represents a ADT_AXX_PR1ROL group structure (a Group object).
...
public class ADT_AXX_PR1ROL extends AbstractGroup {

    /** 
     * Creates a new ADT_AXX_PR1ROL group
     */
    public ADT_AXX_PR1ROL(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ADT_AXX_PR1ROL - this is probably a bug in the source code generator.", e);
       }
    }
