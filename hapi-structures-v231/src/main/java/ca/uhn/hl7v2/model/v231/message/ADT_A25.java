...
/**
 * <p>Represents a ADT_A25 message structure (see chapter ?). This structure contains the 
...
public class ADT_A25 extends AbstractMessage  {

    /**
     * Creates a new ADT_A25 message with DefaultModelClassFactory. 
     */ 
    public ADT_A25() { 
    ...
    /** 
     * Creates a new ADT_A25 message with custom ModelClassFactory.
     */
    public ADT_A25(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ADT_A25 - this is probably a bug in the source code generator.", e);
       }
    }
