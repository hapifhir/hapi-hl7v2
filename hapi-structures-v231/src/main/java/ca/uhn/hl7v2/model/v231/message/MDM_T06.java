...
/**
 * <p>Represents a MDM_T06 message structure (see chapter ?). This structure contains the 
...
public class MDM_T06 extends AbstractMessage  {

    /**
     * Creates a new MDM_T06 message with DefaultModelClassFactory. 
     */ 
    public MDM_T06() { 
    ...
    /** 
     * Creates a new MDM_T06 message with custom ModelClassFactory.
     */
    public MDM_T06(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating MDM_T06 - this is probably a bug in the source code generator.", e);
       }
    }
