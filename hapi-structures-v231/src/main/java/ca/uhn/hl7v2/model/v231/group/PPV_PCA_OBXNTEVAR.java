...
/**
 * <p>Represents a PPV_PCA_OBXNTEVAR group structure (a Group object).
...
public class PPV_PCA_OBXNTEVAR extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PPV_PCA_OBXNTEVAR - this is probably a bug in the source code generator.", e);
       }
    }
