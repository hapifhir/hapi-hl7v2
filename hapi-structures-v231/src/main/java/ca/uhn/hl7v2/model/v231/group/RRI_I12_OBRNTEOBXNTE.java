...
/**
 * <p>Represents a RRI_I12_OBRNTEOBXNTE group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>3: RRI_I12_OBXNTE (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
...
public class RRI_I12_OBRNTEOBXNTE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(RRI_I12_OBXNTE.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating RRI_I12_OBRNTEOBXNTE - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public RRI_I12_OBXNTE getOBXNTE() { 
       RRI_I12_OBXNTE retVal = getTyped("OBXNTE", RRI_I12_OBXNTE.class);
       return retVal;
    }
     ...
     *     greater than the number of existing repetitions.
     */
    public RRI_I12_OBXNTE getOBXNTE(int rep) { 
       RRI_I12_OBXNTE retVal = getTyped("OBXNTE", rep, RRI_I12_OBXNTE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<RRI_I12_OBXNTE> getOBXNTEAll() throws HL7Exception {
    	return getAllAsList("OBXNTE", RRI_I12_OBXNTE.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertOBXNTE(RRI_I12_OBXNTE structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public RRI_I12_OBXNTE insertOBXNTE(int rep) throws HL7Exception { 
       return (RRI_I12_OBXNTE)super.insertRepetition("OBXNTE", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public RRI_I12_OBXNTE removeOBXNTE(int rep) throws HL7Exception { 
       return (RRI_I12_OBXNTE)super.removeRepetition("OBXNTE", rep);
    }
