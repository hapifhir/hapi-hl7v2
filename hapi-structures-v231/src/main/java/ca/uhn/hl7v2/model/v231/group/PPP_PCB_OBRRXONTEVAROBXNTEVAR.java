...
/**
 * <p>Represents a PPP_PCB_OBRRXONTEVAROBXNTEVAR group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>5: PPP_PCB_OBXNTEVAR (a Group object) <b>optional repeating </b></li>
 * </ul>
 * <p>
...
public class PPP_PCB_OBRRXONTEVAROBXNTEVAR extends AbstractGroup {

    /** 
     * Creates a new PPP_PCB_OBRRXONTEVAROBXNTEVAR group
     */
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(PPP_PCB_OBXNTEVAR.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating PPP_PCB_OBRRXONTEVAROBXNTEVAR - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public PPP_PCB_OBXNTEVAR getOBXNTEVAR() { 
       PPP_PCB_OBXNTEVAR retVal = getTyped("OBXNTEVAR", PPP_PCB_OBXNTEVAR.class);
       return retVal;
    }
    ...
    public PPP_PCB_OBXNTEVAR getOBXNTEVAR(int rep) { 
       PPP_PCB_OBXNTEVAR retVal = getTyped("OBXNTEVAR", rep, PPP_PCB_OBXNTEVAR.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PPP_PCB_OBXNTEVAR> getOBXNTEVARAll() throws HL7Exception {
    	return getAllAsList("OBXNTEVAR", PPP_PCB_OBXNTEVAR.class);
    } 
