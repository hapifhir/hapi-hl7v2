...
/**
 * <p>Represents a PPP_PCB_ROLVAR group structure (a Group object).
...
public class PPP_PCB_ROLVAR extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PPP_PCB_ROLVAR - this is probably a bug in the source code generator.", e);
       }
    }
