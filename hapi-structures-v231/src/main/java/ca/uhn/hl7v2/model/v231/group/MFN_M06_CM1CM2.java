...
/**
 * <p>Represents a MFN_M06_CM1CM2 group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: CM1 (CM1 - clinical study phase master segment) <b>  </b></li>
                         * <li>2: CM2 (CM2 - clinical study schedule master segment) <b>optional repeating </b></li>
 * </ul>
 */
...
public class MFN_M06_CM1CM2 extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating MFN_M06_CM1CM2 - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    /**
     * Returns
     * CM1 (CM1 - clinical study phase master segment) - creates it if necessary
     */
    public CM1 getCM1() { 
     ...
     * CM2 (CM2 - clinical study schedule master segment) - creates it if necessary
     */
    public CM2 getCM2() { 
