...
/**
 * <p>Represents a RGR_RGR_PIDNTE group structure (a Group object).
...
public class RGR_RGR_PIDNTE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RGR_RGR_PIDNTE - this is probably a bug in the source code generator.", e);
       }
    }
