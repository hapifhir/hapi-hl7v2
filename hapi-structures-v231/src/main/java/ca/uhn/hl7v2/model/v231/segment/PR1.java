...
/**
 *<p>Represents an HL7 PR1 message segment (PR1 - procedures segment). 
 ...
 * <ul>
     ...
     * <li>PR1-6: Procedure Functional Type (IS) <b> </b>
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(SI.class, true, 1, 4, new Object[]{ getMessage() }, "Set ID - PR1");
                                              this.add(IS.class, false, 1, 2, new Object[]{ getMessage(), new Integer(89) }, "Procedure Coding Method");
                                  this.add(CE.class, true, 1, 80, new Object[]{ getMessage() }, "Procedure Code");
                                  ...
                                  this.add(TS.class, true, 1, 26, new Object[]{ getMessage() }, "Procedure Date/Time");
                                              this.add(IS.class, true, 1, 2, new Object[]{ getMessage(), new Integer(230) }, "Procedure Functional Type");
