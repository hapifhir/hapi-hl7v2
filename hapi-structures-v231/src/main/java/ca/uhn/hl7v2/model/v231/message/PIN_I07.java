 ...
 * <ul>
		                 ...
		                 * <li>2: PIN_I07_PRDCTD (a Group object) <b> repeating</b> </li>
		                 ...
		                 * <li>5: PIN_I07_GT1IN1IN2IN3 (a Group object) <b>optional </b> </li>
...
public class PIN_I07 extends AbstractMessage  {
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          this.add(PIN_I07_PRDCTD.class, true, true);
	                          this.add(PID.class, true, false);
	                          this.add(NK1.class, false, true);
	                          this.add(PIN_I07_GT1IN1IN2IN3.class, false, false);
     ...
     *
     */
    public PIN_I07_PRDCTD getPRDCTD() { 
       return getTyped("PRDCTD", PIN_I07_PRDCTD.class);
    }
     ...
     */
    public PIN_I07_PRDCTD getPRDCTD(int rep) { 
       return getTyped("PRDCTD", rep, PIN_I07_PRDCTD.class);
    }
     ...
     * 
     */ 
    public java.util.List<PIN_I07_PRDCTD> getPRDCTDAll() throws HL7Exception {
    	return getAllAsList("PRDCTD", PIN_I07_PRDCTD.class);
    } 
     ...
     */
    public void insertPRDCTD(PIN_I07_PRDCTD structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public PIN_I07_PRDCTD insertPRDCTD(int rep) throws HL7Exception { 
       return (PIN_I07_PRDCTD)super.insertRepetition("PRDCTD", rep);
    }
     ...
     */
    public PIN_I07_PRDCTD removePRDCTD(int rep) throws HL7Exception { 
       return (PIN_I07_PRDCTD)super.removeRepetition("PRDCTD", rep);
    }
     ...
     *
     */
    public PIN_I07_GT1IN1IN2IN3 getGT1IN1IN2IN3() { 
       return getTyped("GT1IN1IN2IN3", PIN_I07_GT1IN1IN2IN3.class);
    }
