...
/**
 * <p>Represents a PEX_P07_RXERXR group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: RXE (RXE - pharmacy/treatment encoded order segment) <b>  </b></li>
                         * <li>2: RXR (RXR - pharmacy/treatment route segment) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class PEX_P07_RXERXR extends AbstractGroup {

    /** 
     * Creates a new PEX_P07_RXERXR group
     */
    public PEX_P07_RXERXR(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PEX_P07_RXERXR - this is probably a bug in the source code generator.", e);
       }
    }
