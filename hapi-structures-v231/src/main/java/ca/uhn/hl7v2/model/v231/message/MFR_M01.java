...
/**
 * <p>Represents a MFR_M01 message structure. This structure contains the 
 ...
 * <ul>
		                 ...
		                 * <li>7: MFI (MFI - master file identification segment) <b> </b> </li>
		                 * <li>8: MFR_M01_MFEZxx (a Group object) <b> repeating</b> </li>
		                 * <li>9: DSC (DSC - Continuation pointer segment) <b>optional </b> </li>
 * </ul>
 */
...
public class MFR_M01 extends AbstractMessage  {
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(MFR_M01_MFEZxx.class, true, true);
     ...
     * MFEZxx (a Group object) - creates it if necessary
     * </p>
     * 
     *
     */
    public MFR_M01_MFEZxx getMFEZxx() { 
       return getTyped("MFEZxx", MFR_M01_MFEZxx.class);
    }
     ...
     */
    public MFR_M01_MFEZxx getMFEZxx(int rep) { 
       return getTyped("MFEZxx", rep, MFR_M01_MFEZxx.class);
    }

    /** 
     * <p>
     * Returns the number of existing repetitions of MFEZxx 
     * </p>
     * 
     */ 
    ...
    /** 
     * <p>
     * Returns a non-modifiable List containing all current existing repetitions of MFEZxx.
     * <p>
     * <p>
     * Note that unlike {@link #getMFEZxx()}, this method will not create any reps
     * if none are already present, so an empty list may be returned.
     * </p>
     * 
     */ 
    public java.util.List<MFR_M01_MFEZxx> getMFEZxxAll() throws HL7Exception {
    	return getAllAsList("MFEZxx", MFR_M01_MFEZxx.class);
    } 

    /**
     * <p>
     * Inserts a specific repetition of MFEZxx (a Group object)
     * </p>
     * 
     *
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertMFEZxx(MFR_M01_MFEZxx structure, int rep) throws HL7Exception { 
       super.insertRepetition( "MFEZxx", structure, rep);
    }
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public MFR_M01_MFEZxx insertMFEZxx(int rep) throws HL7Exception { 
       return (MFR_M01_MFEZxx)super.insertRepetition("MFEZxx", rep);
    }


    /**
     * <p>
     * Removes a specific repetition of MFEZxx (a Group object)
     * </p>
     * 
     *
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public MFR_M01_MFEZxx removeMFEZxx(int rep) throws HL7Exception { 
       return (MFR_M01_MFEZxx)super.removeRepetition("MFEZxx", rep);
    }
