...
public class RQI_I01_GT1IN1IN2IN3 extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(RQI_I01_IN1IN2IN3.class, true, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating RQI_I01_GT1IN1IN2IN3 - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public RQI_I01_IN1IN2IN3 getIN1IN2IN3() { 
       RQI_I01_IN1IN2IN3 retVal = getTyped("IN1IN2IN3", RQI_I01_IN1IN2IN3.class);
       return retVal;
    }
    ...
    public RQI_I01_IN1IN2IN3 getIN1IN2IN3(int rep) { 
       RQI_I01_IN1IN2IN3 retVal = getTyped("IN1IN2IN3", rep, RQI_I01_IN1IN2IN3.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<RQI_I01_IN1IN2IN3> getIN1IN2IN3All() throws HL7Exception {
    	return getAllAsList("IN1IN2IN3", RQI_I01_IN1IN2IN3.class);
    } 
