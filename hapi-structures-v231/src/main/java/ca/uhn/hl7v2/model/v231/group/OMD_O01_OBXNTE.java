...
/**
 * <p>Represents a OMD_O01_OBXNTE group structure (a Group object).
...
public class OMD_O01_OBXNTE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating OMD_O01_OBXNTE - this is probably a bug in the source code generator.", e);
       }
    }
