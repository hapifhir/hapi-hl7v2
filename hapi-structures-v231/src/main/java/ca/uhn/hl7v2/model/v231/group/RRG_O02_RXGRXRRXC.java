...
/**
 * <p>Represents a RRG_O02_RXGRXRRXC group structure (a Group object).
...
public class RRG_O02_RXGRXRRXC extends AbstractGroup {

    /** 
     * Creates a new RRG_O02_RXGRXRRXC group
     */
    public RRG_O02_RXGRXRRXC(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RRG_O02_RXGRXRRXC - this is probably a bug in the source code generator.", e);
       }
    }
