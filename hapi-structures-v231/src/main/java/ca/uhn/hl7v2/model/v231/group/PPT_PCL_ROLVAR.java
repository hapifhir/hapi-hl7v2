...
/**
 * <p>Represents a PPT_PCL_ROLVAR group structure (a Group object).
...
public class PPT_PCL_ROLVAR extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PPT_PCL_ROLVAR - this is probably a bug in the source code generator.", e);
       }
    }
