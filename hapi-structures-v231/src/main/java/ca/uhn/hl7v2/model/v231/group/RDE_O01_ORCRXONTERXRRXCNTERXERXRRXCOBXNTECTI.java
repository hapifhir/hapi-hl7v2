...
/**
 * <p>Represents a RDE_O01_ORCRXONTERXRRXCNTERXERXRRXCOBXNTECTI group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: ORC (ORC - common order segment) <b>  </b></li>
                         * <li>2: RDE_O01_RXONTERXRRXCNTE (a Group object) <b>optional  </b></li>
                         * <li>3: RXE (RXE - pharmacy/treatment encoded order segment) <b>  </b></li>
                         * <li>4: RXR (RXR - pharmacy/treatment route segment) <b> repeating </b></li>
                         * <li>5: RXC (RXC - pharmacy/treatment component order segment) <b>optional repeating </b></li>
                         * <li>6: RDE_O01_OBXNTE (a Group object) <b>optional repeating </b></li>
...
public class RDE_O01_ORCRXONTERXRRXCNTERXERXRRXCOBXNTECTI extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(RDE_O01_RXONTERXRRXCNTE.class, false, false, false);
                                  this.add(RXE.class, true, false, false);
                                  this.add(RXR.class, true, true, false);
                                  this.add(RXC.class, false, true, false);
                                  this.add(RDE_O01_OBXNTE.class, false, true, false);
                                  this.add(CTI.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating RDE_O01_ORCRXONTERXRRXCNTERXERXRRXCOBXNTECTI - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public RDE_O01_RXONTERXRRXCNTE getRXONTERXRRXCNTE() { 
       RDE_O01_RXONTERXRRXCNTE retVal = getTyped("RXONTERXRRXCNTE", RDE_O01_RXONTERXRRXCNTE.class);
       return retVal;
    }
    ...
    public RDE_O01_OBXNTE getOBXNTE() { 
       RDE_O01_OBXNTE retVal = getTyped("OBXNTE", RDE_O01_OBXNTE.class);
       return retVal;
    }
    ...
    public RDE_O01_OBXNTE getOBXNTE(int rep) { 
       RDE_O01_OBXNTE retVal = getTyped("OBXNTE", rep, RDE_O01_OBXNTE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<RDE_O01_OBXNTE> getOBXNTEAll() throws HL7Exception {
    	return getAllAsList("OBXNTE", RDE_O01_OBXNTE.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertOBXNTE(RDE_O01_OBXNTE structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public RDE_O01_OBXNTE insertOBXNTE(int rep) throws HL7Exception { 
       return (RDE_O01_OBXNTE)super.insertRepetition("OBXNTE", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public RDE_O01_OBXNTE removeOBXNTE(int rep) throws HL7Exception { 
       return (RDE_O01_OBXNTE)super.removeRepetition("OBXNTE", rep);
    }
