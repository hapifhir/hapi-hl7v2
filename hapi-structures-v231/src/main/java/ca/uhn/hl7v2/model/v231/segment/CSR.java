...
/**
 *<p>Represents an HL7 CSR message segment (CSR - clinical study registration segment). 
...
public class CSR extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(XCN.class, false, 0, 60, new Object[]{ getMessage() }, "Person Performing Study Registration");
                                  this.add(XCN.class, true, 0, 60, new Object[]{ getMessage() }, "Study Authorizing Provider");
                                  ...
                                  this.add(CE.class, false, 3, 200, new Object[]{ getMessage() }, "Randomized Study Arm");
