...
/**
 * <p>Represents a OMN_O01_ORCRQDRQ1NTEOBXNTEBLG group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: ORC (ORC - common order segment) <b>  </b></li>
                         * <li>2: OMN_O01_RQDRQ1NTEOBXNTE (a Group object) <b>optional  </b></li>
...
public class OMN_O01_ORCRQDRQ1NTEOBXNTEBLG extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(OMN_O01_RQDRQ1NTEOBXNTE.class, false, false, false);
                                  this.add(BLG.class, false, false, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating OMN_O01_ORCRQDRQ1NTEOBXNTEBLG - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    /**
     * Returns
     * RQDRQ1NTEOBXNTE (a Group object) - creates it if necessary
     */
    public OMN_O01_RQDRQ1NTEOBXNTE getRQDRQ1NTEOBXNTE() { 
       OMN_O01_RQDRQ1NTEOBXNTE retVal = getTyped("RQDRQ1NTEOBXNTE", OMN_O01_RQDRQ1NTEOBXNTE.class);
       return retVal;
    }
