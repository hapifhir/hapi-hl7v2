...
/**
 * <p>Represents a ROR_R0R_PIDNTE group structure (a Group object).
...
public class ROR_R0R_PIDNTE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ROR_R0R_PIDNTE - this is probably a bug in the source code generator.", e);
       }
    }
