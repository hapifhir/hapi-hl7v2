...
/**
 * <p>Represents a MFK_M05 message structure (see chapter ?). This structure contains the 
...
public class MFK_M05 extends AbstractMessage  {

    /**
     * Creates a new MFK_M05 message with DefaultModelClassFactory. 
     */ 
    public MFK_M05() { 
    ...
    /** 
     * Creates a new MFK_M05 message with custom ModelClassFactory.
     */
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating MFK_M05 - this is probably a bug in the source code generator.", e);
       }
    }
