...
/**
 * <p>Represents a ADT_A20 message structure (see chapter ?). This structure contains the 
 * following elements: </p>
 * <ul>
		                 * <li>1: MSH (MSH - message header segment) <b> </b> </li>
		                 * <li>2: EVN (EVN - event type segment) <b> </b> </li>
		                 * <li>3: NPU (NPU - bed status update segment) <b> </b> </li>
 * </ul>
 */
...
public class ADT_A20 extends AbstractMessage  {
     ...
     * <p>
     * Returns
     * NPU (NPU - bed status update segment) - creates it if necessary
     * </p>
     * 
     *
     */
