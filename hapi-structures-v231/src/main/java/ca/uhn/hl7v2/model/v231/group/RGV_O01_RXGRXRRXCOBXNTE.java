...
/**
 * <p>Represents a RGV_O01_RXGRXRRXCOBXNTE group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: RXG (RXG - pharmacy/treatment give segment) <b>  </b></li>
                         ...
                         * <li>4: RGV_O01_OBXNTE (a Group object) <b> repeating </b></li>
 * </ul>
 */
...
public class RGV_O01_RXGRXRRXCOBXNTE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(RGV_O01_OBXNTE.class, true, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating RGV_O01_RXGRXRRXCOBXNTE - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    /**
     * Returns
     * RXG (RXG - pharmacy/treatment give segment) - creates it if necessary
     */
    public RXG getRXG() { 
    ...
    public RGV_O01_OBXNTE getOBXNTE() { 
       RGV_O01_OBXNTE retVal = getTyped("OBXNTE", RGV_O01_OBXNTE.class);
       return retVal;
    }
     ...
     *     greater than the number of existing repetitions.
     */
    public RGV_O01_OBXNTE getOBXNTE(int rep) { 
       RGV_O01_OBXNTE retVal = getTyped("OBXNTE", rep, RGV_O01_OBXNTE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<RGV_O01_OBXNTE> getOBXNTEAll() throws HL7Exception {
    	return getAllAsList("OBXNTE", RGV_O01_OBXNTE.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertOBXNTE(RGV_O01_OBXNTE structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public RGV_O01_OBXNTE insertOBXNTE(int rep) throws HL7Exception { 
       return (RGV_O01_OBXNTE)super.insertRepetition("OBXNTE", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public RGV_O01_OBXNTE removeOBXNTE(int rep) throws HL7Exception { 
       return (RGV_O01_OBXNTE)super.removeRepetition("OBXNTE", rep);
    }
