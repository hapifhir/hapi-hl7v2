...
/**
 *<p>Represents an HL7 OM2 message segment (OM2 - numeric observation segment). 
 ...
 * <ul>
     ...
     * <li>OM2-6: Reference (Normal) Range - Ordinal & Continuous Obs (RFR) <b>optional </b>
     * <li>OM2-7: Critical Range for Ordinal & Continuous Obs (NR) <b>optional </b>
     * <li>OM2-8: Absolute Range for Ordinal & Continuous Obs (RFR) <b>optional </b>
...
public class OM2 extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(RFR.class, false, 1, 200, new Object[]{ getMessage() }, "Reference (Normal) Range - Ordinal & Continuous Obs");
                                  this.add(NR.class, false, 1, 200, new Object[]{ getMessage() }, "Critical Range for Ordinal & Continuous Obs");
                                  this.add(RFR.class, false, 1, 200, new Object[]{ getMessage() }, "Absolute Range for Ordinal & Continuous Obs");
                                  this.add(DLT.class, false, 0, 200, new Object[]{ getMessage() }, "Delta Check Criteria");
     ...
     * OM2-6: "Reference (Normal) Range - Ordinal & Continuous Obs" - creates it if necessary
     */
    public RFR getOm26_ReferenceNormalRangeOrdinalContinuousObs() { 
		RFR retVal = this.getTypedField(6, 0);
		return retVal;
    }
     ...
     * OM2-7: "Critical Range for Ordinal & Continuous Obs" - creates it if necessary
     */
    public NR getOm27_CriticalRangeForOrdinalContinuousObs() { 
		NR retVal = this.getTypedField(7, 0);
		return retVal;
    }
     ...
     * OM2-8: "Absolute Range for Ordinal & Continuous Obs" - creates it if necessary
     */
    public RFR getOm28_AbsoluteRangeForOrdinalContinuousObs() { 
		RFR retVal = this.getTypedField(8, 0);
		return retVal;
    }
