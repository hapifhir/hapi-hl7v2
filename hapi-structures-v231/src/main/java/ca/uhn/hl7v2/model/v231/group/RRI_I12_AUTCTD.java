...
/**
 * <p>Represents a RRI_I12_AUTCTD group structure (a Group object).
...
public class RRI_I12_AUTCTD extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RRI_I12_AUTCTD - this is probably a bug in the source code generator.", e);
       }
    }
