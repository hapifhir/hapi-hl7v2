...
/**
 *<p>Represents an HL7 CM0 message segment (CM0 - clinical study master segment). 
...
public class CM0 extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(XCN.class, false, 0, 60, new Object[]{ getMessage() }, "Chairman of Study");
                                  ...
                                  this.add(XCN.class, false, 0, 60, new Object[]{ getMessage() }, "Contact for Study");
                                  this.add(XTN.class, false, 1, 40, new Object[]{ getMessage() }, "Contact's Tel. Number");
                                  this.add(XAD.class, false, 0, 100, new Object[]{ getMessage() }, "Contact's Address");
