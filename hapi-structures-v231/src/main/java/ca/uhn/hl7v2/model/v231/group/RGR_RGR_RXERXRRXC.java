...
/**
 * <p>Represents a RGR_RGR_RXERXRRXC group structure (a Group object).
...
public class RGR_RGR_RXERXRRXC extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RGR_RGR_RXERXRRXC - this is probably a bug in the source code generator.", e);
       }
    }
