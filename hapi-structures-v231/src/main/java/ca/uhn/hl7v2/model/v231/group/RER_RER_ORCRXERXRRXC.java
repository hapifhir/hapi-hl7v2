...
/**
 * <p>Represents a RER_RER_ORCRXERXRRXC group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: ORC (ORC - common order segment) <b>  </b></li>
                         * <li>2: RXE (RXE - pharmacy/treatment encoded order segment) <b>  </b></li>
                         * <li>3: RXR (RXR - pharmacy/treatment route segment) <b> repeating </b></li>
                         * <li>4: RXC (RXC - pharmacy/treatment component order segment) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class RER_RER_ORCRXERXRRXC extends AbstractGroup {

    /** 
     * Creates a new RER_RER_ORCRXERXRRXC group
     */
    public RER_RER_ORCRXERXRRXC(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RER_RER_ORCRXERXRRXC - this is probably a bug in the source code generator.", e);
       }
    }
