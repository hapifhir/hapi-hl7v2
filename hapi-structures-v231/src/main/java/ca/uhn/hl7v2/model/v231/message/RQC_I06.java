 ...
 * <ul>
		                 ...
		                 * <li>4: RQC_I06_PRDCTD (a Group object) <b> repeating</b> </li>
		                 ...
		                 * <li>7: GT1 (GT1 - guarantor segment) <b>optional </b> </li>
...
public class RQC_I06 extends AbstractMessage  {
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(RQC_I06_PRDCTD.class, true, true);
     ...
     *
     */
    public RQC_I06_PRDCTD getPRDCTD() { 
       return getTyped("PRDCTD", RQC_I06_PRDCTD.class);
    }
     ...
     */
    public RQC_I06_PRDCTD getPRDCTD(int rep) { 
       return getTyped("PRDCTD", rep, RQC_I06_PRDCTD.class);
    }
     ...
     * 
     */ 
    public java.util.List<RQC_I06_PRDCTD> getPRDCTDAll() throws HL7Exception {
    	return getAllAsList("PRDCTD", RQC_I06_PRDCTD.class);
    } 
     ...
     */
    public void insertPRDCTD(RQC_I06_PRDCTD structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public RQC_I06_PRDCTD insertPRDCTD(int rep) throws HL7Exception { 
       return (RQC_I06_PRDCTD)super.insertRepetition("PRDCTD", rep);
    }
     ...
     */
    public RQC_I06_PRDCTD removePRDCTD(int rep) throws HL7Exception { 
       return (RQC_I06_PRDCTD)super.removeRepetition("PRDCTD", rep);
    }
