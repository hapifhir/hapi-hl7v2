...
/**
 *<p>Represents an HL7 PID message segment (PID - patient identification segment). 
...
public class PID extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CX.class, true, 0, 20, new Object[]{ getMessage() }, "Patient Identifier List");
                                  this.add(CX.class, false, 0, 20, new Object[]{ getMessage() }, "Alternate Patient ID - PID");
                                  this.add(XPN.class, true, 0, 48, new Object[]{ getMessage() }, "Patient Name");
                                  ...
                                  this.add(CX.class, false, 0, 20, new Object[]{ getMessage() }, "Mother's Identifier");
