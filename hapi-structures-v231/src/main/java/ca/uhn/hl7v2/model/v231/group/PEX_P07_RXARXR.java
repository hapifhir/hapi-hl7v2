...
/**
 * <p>Represents a PEX_P07_RXARXR group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: RXA (RXA - pharmacy/treatment administration segment) <b>  </b></li>
                         * <li>2: RXR (RXR - pharmacy/treatment route segment) <b>optional  </b></li>
 * </ul>
 */
...
public class PEX_P07_RXARXR extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PEX_P07_RXARXR - this is probably a bug in the source code generator.", e);
       }
    }
