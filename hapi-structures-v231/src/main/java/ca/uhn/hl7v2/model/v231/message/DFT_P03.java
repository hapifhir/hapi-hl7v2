 ...
 * <ul>
		                 ...
		                 * <li>5: PV1 (PV1 - patient visit segment-) <b>optional </b> </li>
		                 ...
		                 * <li>9: DFT_P03_FT1PR1ROL (a Group object) <b> repeating</b> </li>
		                 * <li>10: DG1 (DG1 - diagnosis segment) <b>optional repeating</b> </li>
		                 * <li>11: DRG (DRG - diagnosis related group segment) <b>optional </b> </li>
		                 * <li>12: GT1 (GT1 - guarantor segment) <b>optional repeating</b> </li>
		                 * <li>13: DFT_P03_IN1IN2IN3 (a Group object) <b>optional repeating</b> </li>
		                 * <li>14: ACC (ACC - accident segment) <b>optional </b> </li>
 * </ul>
 */
...
public class DFT_P03 extends AbstractMessage  {
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(DFT_P03_FT1PR1ROL.class, true, true);
	                          this.add(DG1.class, false, true);
	                          this.add(DRG.class, false, false);
	                          this.add(GT1.class, false, true);
	                          this.add(DFT_P03_IN1IN2IN3.class, false, true);
     ...
     * Returns
     * the first repetition of 
     * FT1PR1ROL (a Group object) - creates it if necessary
     * </p>
     * 
     *
     */
    public DFT_P03_FT1PR1ROL getFT1PR1ROL() { 
       return getTyped("FT1PR1ROL", DFT_P03_FT1PR1ROL.class);
    }
     ...
     *     greater than the number of existing repetitions.
     */
    public DFT_P03_FT1PR1ROL getFT1PR1ROL(int rep) { 
       return getTyped("FT1PR1ROL", rep, DFT_P03_FT1PR1ROL.class);
    }

    /** 
     * <p>
     * Returns the number of existing repetitions of FT1PR1ROL 
     * </p>
     * 
     */ 
    public int getFT1PR1ROLReps() { 
    	return getReps("FT1PR1ROL");
    } 

    /** 
     * <p>
     * Returns a non-modifiable List containing all current existing repetitions of FT1PR1ROL.
     * <p>
     * <p>
     * Note that unlike {@link #getFT1PR1ROL()}, this method will not create any reps
     * if none are already present, so an empty list may be returned.
     * </p>
     * 
     */ 
    public java.util.List<DFT_P03_FT1PR1ROL> getFT1PR1ROLAll() throws HL7Exception {
    	return getAllAsList("FT1PR1ROL", DFT_P03_FT1PR1ROL.class);
    } 

    /**
     * <p>
     * Inserts a specific repetition of FT1PR1ROL (a Group object)
     * </p>
     * 
     *
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertFT1PR1ROL(DFT_P03_FT1PR1ROL structure, int rep) throws HL7Exception { 
       super.insertRepetition( "FT1PR1ROL", structure, rep);
    }
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public DFT_P03_FT1PR1ROL insertFT1PR1ROL(int rep) throws HL7Exception { 
       return (DFT_P03_FT1PR1ROL)super.insertRepetition("FT1PR1ROL", rep);
    }


    /**
     * <p>
     * Removes a specific repetition of FT1PR1ROL (a Group object)
     * </p>
     * 
     *
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public DFT_P03_FT1PR1ROL removeFT1PR1ROL(int rep) throws HL7Exception { 
       return (DFT_P03_FT1PR1ROL)super.removeRepetition("FT1PR1ROL", rep);
    }
     ...
     *
     */
    public DFT_P03_IN1IN2IN3 getIN1IN2IN3() { 
       return getTyped("IN1IN2IN3", DFT_P03_IN1IN2IN3.class);
    }
     ...
     *     greater than the number of existing repetitions.
     */
    public DFT_P03_IN1IN2IN3 getIN1IN2IN3(int rep) { 
       return getTyped("IN1IN2IN3", rep, DFT_P03_IN1IN2IN3.class);
    }
     ...
     * 
     */ 
    public java.util.List<DFT_P03_IN1IN2IN3> getIN1IN2IN3All() throws HL7Exception {
    	return getAllAsList("IN1IN2IN3", DFT_P03_IN1IN2IN3.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertIN1IN2IN3(DFT_P03_IN1IN2IN3 structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public DFT_P03_IN1IN2IN3 insertIN1IN2IN3(int rep) throws HL7Exception { 
       return (DFT_P03_IN1IN2IN3)super.insertRepetition("IN1IN2IN3", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public DFT_P03_IN1IN2IN3 removeIN1IN2IN3(int rep) throws HL7Exception { 
       return (DFT_P03_IN1IN2IN3)super.removeRepetition("IN1IN2IN3", rep);
    }
