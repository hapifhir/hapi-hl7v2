...
/**
 * <p>Represents a RCL_I06_PRDCTD group structure (a Group object).
...
public class RCL_I06_PRDCTD extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RCL_I06_PRDCTD - this is probably a bug in the source code generator.", e);
       }
    }
