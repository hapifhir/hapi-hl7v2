...
/**
 *<p>Represents an HL7 MFA message segment (MFA - master file acknowledgment segment). 
 ...
 * <ul>
     ...
     * <li>MFA-5: Primary Key Value – MFA (CE) <b> repeating</b>
...
public class MFA extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CE.class, true, 1, 60, new Object[]{ getMessage() }, "MFN Record Level Error Return");
                                  this.add(CE.class, true, 0, 60, new Object[]{ getMessage() }, "Primary Key Value – MFA");
     ...
     * Returns all repetitions of Primary Key Value – MFA (MFA-5).
     */
    public CE[] getMfa5_PrimaryKeyValueMFA() {
    	CE[] retVal = this.getTypedField(5, new CE[0]);
    	return retVal;
    }
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public CE insertMfa5_PrimaryKeyValueMFA(int rep) throws HL7Exception { 
        return (CE) super.insertRepetition(5, rep);
    }
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public CE removeMfa5_PrimaryKeyValueMFA(int rep) throws HL7Exception { 
        return (CE) super.removeRepetition(5, rep);
    }
