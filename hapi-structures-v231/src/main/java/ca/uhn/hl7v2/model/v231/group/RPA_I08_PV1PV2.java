...
/**
 * <p>Represents a RPA_I08_PV1PV2 group structure (a Group object).
...
public class RPA_I08_PV1PV2 extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RPA_I08_PV1PV2 - this is probably a bug in the source code generator.", e);
       }
    }
