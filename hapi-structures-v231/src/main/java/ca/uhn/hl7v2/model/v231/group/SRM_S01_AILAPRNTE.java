...
/**
 * <p>Represents a SRM_S01_AILAPRNTE group structure (a Group object).
...
public class SRM_S01_AILAPRNTE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating SRM_S01_AILAPRNTE - this is probably a bug in the source code generator.", e);
       }
    }
