...
/**
 * <p>Represents a ADT_A05_IN1IN2IN3 group structure (a Group object).
...
public class ADT_A05_IN1IN2IN3 extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ADT_A05_IN1IN2IN3 - this is probably a bug in the source code generator.", e);
       }
    }
