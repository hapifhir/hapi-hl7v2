...
/**
 * <p>Represents a RAR_RAR_ORCRXERXRRXCRXARXR group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: ORC (ORC - common order segment) <b>  </b></li>
                         * <li>2: RAR_RAR_RXERXRRXC (a Group object) <b>optional  </b></li>
                         * <li>3: RXA (RXA - pharmacy/treatment administration segment) <b> repeating </b></li>
                         * <li>4: RXR (RXR - pharmacy/treatment route segment) <b>  </b></li>
 * </ul>
 */
...
public class RAR_RAR_ORCRXERXRRXCRXARXR extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(RAR_RAR_RXERXRRXC.class, false, false, false);
                                  this.add(RXA.class, true, true, false);
                                  this.add(RXR.class, true, false, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating RAR_RAR_ORCRXERXRRXCRXARXR - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public RAR_RAR_RXERXRRXC getRXERXRRXC() { 
       RAR_RAR_RXERXRRXC retVal = getTyped("RXERXRRXC", RAR_RAR_RXERXRRXC.class);
       return retVal;
    }
