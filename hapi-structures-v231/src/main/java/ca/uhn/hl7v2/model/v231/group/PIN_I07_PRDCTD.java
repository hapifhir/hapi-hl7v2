...
/**
 * <p>Represents a PIN_I07_PRDCTD group structure (a Group object).
...
public class PIN_I07_PRDCTD extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PIN_I07_PRDCTD - this is probably a bug in the source code generator.", e);
       }
    }
