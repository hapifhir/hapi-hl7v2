...
/**
 * <p>Represents a MDM_T04 message structure (see chapter ?). This structure contains the 
 ...
 * <ul>
		                 ...
		                 * <li>6: OBX (OBX - observation/result segment) <b> </b> </li>
 * </ul>
 */
...
public class MDM_T04 extends AbstractMessage  {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating MDM_T04 - this is probably a bug in the source code generator.", e);
       }
    }
