...
/**
 * <p>Represents a RCI_I05_PRDCTD group structure (a Group object).
...
public class RCI_I05_PRDCTD extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RCI_I05_PRDCTD - this is probably a bug in the source code generator.", e);
       }
    }
