...
/**
 * <p>Represents a CSU_C09_PIDPD1NTEPV1PV2CSRCSPCSSORCOBROBXORCRXARXR group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>4: CSU_C09_PV1PV2 (a Group object) <b>optional  </b></li>
                         * <li>5: CSR (CSR - clinical study registration segment) <b>  </b></li>
                         * <li>6: CSU_C09_CSPCSSORCOBROBXORCRXARXR (a Group object) <b> repeating </b></li>
 * </ul>
 */
...
public class CSU_C09_PIDPD1NTEPV1PV2CSRCSPCSSORCOBROBXORCRXARXR extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating CSU_C09_PIDPD1NTEPV1PV2CSRCSPCSSORCOBROBXORCRXARXR - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public CSU_C09_PV1PV2 getPV1PV2() { 
       CSU_C09_PV1PV2 retVal = getTyped("PV1PV2", CSU_C09_PV1PV2.class);
       return retVal;
    }
     ...
     * Returns
     * the first repetition of 
     * CSPCSSORCOBROBXORCRXARXR (a Group object) - creates it if necessary
     */
    public CSU_C09_CSPCSSORCOBROBXORCRXARXR getCSPCSSORCOBROBXORCRXARXR() { 
       CSU_C09_CSPCSSORCOBROBXORCRXARXR retVal = getTyped("CSPCSSORCOBROBXORCRXARXR", CSU_C09_CSPCSSORCOBROBXORCRXARXR.class);
       return retVal;
    }
    ...
    public CSU_C09_CSPCSSORCOBROBXORCRXARXR getCSPCSSORCOBROBXORCRXARXR(int rep) { 
       CSU_C09_CSPCSSORCOBROBXORCRXARXR retVal = getTyped("CSPCSSORCOBROBXORCRXARXR", rep, CSU_C09_CSPCSSORCOBROBXORCRXARXR.class);
       return retVal;
    }

    /** 
     * Returns the number of existing repetitions of CSPCSSORCOBROBXORCRXARXR 
     */ 
    public int getCSPCSSORCOBROBXORCRXARXRReps() {  
        return getReps("CSPCSSORCOBROBXORCRXARXR");
    } 

    /** 
     * <p>
     * Returns a non-modifiable List containing all current existing repetitions of CSPCSSORCOBROBXORCRXARXR.
     * <p>
     * <p>
     * Note that unlike {@link #getCSPCSSORCOBROBXORCRXARXR()}, this method will not create any reps
     * if none are already present, so an empty list may be returned.
     * </p>
     */ 
    public java.util.List<CSU_C09_CSPCSSORCOBROBXORCRXARXR> getCSPCSSORCOBROBXORCRXARXRAll() throws HL7Exception {
    	return getAllAsList("CSPCSSORCOBROBXORCRXARXR", CSU_C09_CSPCSSORCOBROBXORCRXARXR.class);
    } 

    /**
     * Inserts a specific repetition of CSPCSSORCOBROBXORCRXARXR (a Group object)
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertCSPCSSORCOBROBXORCRXARXR(CSU_C09_CSPCSSORCOBROBXORCRXARXR structure, int rep) throws HL7Exception { 
       super.insertRepetition("CSPCSSORCOBROBXORCRXARXR", structure, rep);
    }
    ...
    /**
     * Removes a specific repetition of CSPCSSORCOBROBXORCRXARXR (a Group object)
     * @see AbstractGroup#removeRepetition(String, int) 
     */
