...
/**
 *<p>Represents an HL7 AIG message segment (AIG - appointment information - general resource segment). 
...
public class AIG extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CE.class, false, 1, 200, new Object[]{ getMessage() }, "Resource ID");
                                  this.add(CE.class, true, 1, 200, new Object[]{ getMessage() }, "Resource Type");
                                  ...
                                  this.add(CE.class, false, 1, 200, new Object[]{ getMessage() }, "Resource Quantity Units");
