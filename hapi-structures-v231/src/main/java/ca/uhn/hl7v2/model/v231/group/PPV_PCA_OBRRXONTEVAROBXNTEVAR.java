...
/**
 * <p>Represents a PPV_PCA_OBRRXONTEVAROBXNTEVAR group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>5: PPV_PCA_OBXNTEVAR (a Group object) <b>optional repeating </b></li>
 * </ul>
 * <p>
...
public class PPV_PCA_OBRRXONTEVAROBXNTEVAR extends AbstractGroup {

    /** 
     * Creates a new PPV_PCA_OBRRXONTEVAROBXNTEVAR group
     */
    public PPV_PCA_OBRRXONTEVAROBXNTEVAR(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(PPV_PCA_OBXNTEVAR.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating PPV_PCA_OBRRXONTEVAROBXNTEVAR - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     */
    public PPV_PCA_OBXNTEVAR getOBXNTEVAR() { 
       PPV_PCA_OBXNTEVAR retVal = getTyped("OBXNTEVAR", PPV_PCA_OBXNTEVAR.class);
       return retVal;
    }
     ...
     *     greater than the number of existing repetitions.
     */
    public PPV_PCA_OBXNTEVAR getOBXNTEVAR(int rep) { 
       PPV_PCA_OBXNTEVAR retVal = getTyped("OBXNTEVAR", rep, PPV_PCA_OBXNTEVAR.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PPV_PCA_OBXNTEVAR> getOBXNTEVARAll() throws HL7Exception {
    	return getAllAsList("OBXNTEVAR", PPV_PCA_OBXNTEVAR.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertOBXNTEVAR(PPV_PCA_OBXNTEVAR structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public PPV_PCA_OBXNTEVAR insertOBXNTEVAR(int rep) throws HL7Exception { 
       return (PPV_PCA_OBXNTEVAR)super.insertRepetition("OBXNTEVAR", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public PPV_PCA_OBXNTEVAR removeOBXNTEVAR(int rep) throws HL7Exception { 
       return (PPV_PCA_OBXNTEVAR)super.removeRepetition("OBXNTEVAR", rep);
    }
