...
/**
 * <p>Represents a PPG_PCG_ROLVAR group structure (a Group object).
...
public class PPG_PCG_ROLVAR extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PPG_PCG_ROLVAR - this is probably a bug in the source code generator.", e);
       }
    }
