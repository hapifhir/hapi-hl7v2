...
/**
 * <p>Represents a RQA_I08 message structure. This structure contains the 
...
public class RQA_I08 extends AbstractMessage  {
    ...
    public RQA_I08_AUTCTD getAUTCTD() { 
       return getTyped("AUTCTD", RQA_I08_AUTCTD.class);
    }
    ...
    public RQA_I08_PRDCTD getPRDCTD() { 
       return getTyped("PRDCTD", RQA_I08_PRDCTD.class);
    }
    ...
    public RQA_I08_PRDCTD getPRDCTD(int rep) { 
       return getTyped("PRDCTD", rep, RQA_I08_PRDCTD.class);
    }
     ...
     * 
     */ 
    public java.util.List<RQA_I08_PRDCTD> getPRDCTDAll() throws HL7Exception {
    	return getAllAsList("PRDCTD", RQA_I08_PRDCTD.class);
    } 
    ...
    public RQA_I08_GT1IN1IN2IN3 getGT1IN1IN2IN3() { 
       return getTyped("GT1IN1IN2IN3", RQA_I08_GT1IN1IN2IN3.class);
    }
    ...
    public RQA_I08_PR1AUTCTD getPR1AUTCTD() { 
       return getTyped("PR1AUTCTD", RQA_I08_PR1AUTCTD.class);
    }
    ...
    public RQA_I08_PR1AUTCTD getPR1AUTCTD(int rep) { 
       return getTyped("PR1AUTCTD", rep, RQA_I08_PR1AUTCTD.class);
    }
     ...
     * 
     */ 
    public java.util.List<RQA_I08_PR1AUTCTD> getPR1AUTCTDAll() throws HL7Exception {
    	return getAllAsList("PR1AUTCTD", RQA_I08_PR1AUTCTD.class);
    } 
    ...
    public RQA_I08_OBRNTEOBXNTE getOBRNTEOBXNTE() { 
       return getTyped("OBRNTEOBXNTE", RQA_I08_OBRNTEOBXNTE.class);
    }
    ...
    public RQA_I08_OBRNTEOBXNTE getOBRNTEOBXNTE(int rep) { 
       return getTyped("OBRNTEOBXNTE", rep, RQA_I08_OBRNTEOBXNTE.class);
    }
     ...
     * 
     */ 
    public java.util.List<RQA_I08_OBRNTEOBXNTE> getOBRNTEOBXNTEAll() throws HL7Exception {
    	return getAllAsList("OBRNTEOBXNTE", RQA_I08_OBRNTEOBXNTE.class);
    } 
    ...
    public RQA_I08_PV1PV2 getPV1PV2() { 
       return getTyped("PV1PV2", RQA_I08_PV1PV2.class);
    }
