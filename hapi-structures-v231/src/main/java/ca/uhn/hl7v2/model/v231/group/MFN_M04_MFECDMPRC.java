...
/**
 * <p>Represents a MFN_M04_MFECDMPRC group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: MFE (MFE - master file entry segment) <b>  </b></li>
                         * <li>2: CDM (CDM -  charge description master segment) <b>  </b></li>
                         * <li>3: PRC (PRC -  pricing segment) <b>optional repeating </b></li>
 * </ul>
 */
...
public class MFN_M04_MFECDMPRC extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating MFN_M04_MFECDMPRC - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    /**
     * Returns
     * CDM (CDM -  charge description master segment) - creates it if necessary
     */
    public CDM getCDM() { 
     ...
     * PRC (PRC -  pricing segment) - creates it if necessary
     */
    public PRC getPRC() { 
    ...
    /**
     * Inserts a specific repetition of PRC (PRC -  pricing segment)
    ...
    /**
     * Removes a specific repetition of PRC (PRC -  pricing segment)
