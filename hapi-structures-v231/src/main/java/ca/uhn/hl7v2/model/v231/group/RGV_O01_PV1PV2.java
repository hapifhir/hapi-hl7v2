...
/**
 * <p>Represents a RGV_O01_PV1PV2 group structure (a Group object).
...
public class RGV_O01_PV1PV2 extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RGV_O01_PV1PV2 - this is probably a bug in the source code generator.", e);
       }
    }
