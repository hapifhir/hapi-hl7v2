...
/**
 * <p>Represents a ORM_O01_IN1IN2IN3 group structure (a Group object).
...
public class ORM_O01_IN1IN2IN3 extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ORM_O01_IN1IN2IN3 - this is probably a bug in the source code generator.", e);
       }
    }
