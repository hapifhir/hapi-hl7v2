...
public class BAR_P06 extends AbstractMessage  {
    ...
    public BAR_P06_PIDPV1 getPIDPV1() { 
       return getTyped("PIDPV1", BAR_P06_PIDPV1.class);
    }
    ...
    public BAR_P06_PIDPV1 getPIDPV1(int rep) { 
       return getTyped("PIDPV1", rep, BAR_P06_PIDPV1.class);
    }
    ...
    public int getPIDPV1Reps() { 
    	return getReps("PIDPV1");
    } 

    /** 
     * <p>
     * Returns a non-modifiable List containing all current existing repetitions of PIDPV1.
     * <p>
     * <p>
     * Note that unlike {@link #getPIDPV1()}, this method will not create any reps
     * if none are already present, so an empty list may be returned.
     * </p>
     * 
     */ 
    public java.util.List<BAR_P06_PIDPV1> getPIDPV1All() throws HL7Exception {
    	return getAllAsList("PIDPV1", BAR_P06_PIDPV1.class);
    } 
