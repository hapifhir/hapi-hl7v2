...
/**
 * <p>Represents a RPI_I04_GT1IN1IN2IN3 group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: GT1 (GT1 - guarantor segment) <b>optional repeating </b></li>
                         * <li>2: RPI_I04_IN1IN2IN3 (a Group object) <b> repeating </b></li>
 * </ul>
 */
...
public class RPI_I04_GT1IN1IN2IN3 extends AbstractGroup {
     ...
     */
    public RPI_I04_GT1IN1IN2IN3(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(RPI_I04_IN1IN2IN3.class, true, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating RPI_I04_GT1IN1IN2IN3 - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     */
    public RPI_I04_IN1IN2IN3 getIN1IN2IN3() { 
       RPI_I04_IN1IN2IN3 retVal = getTyped("IN1IN2IN3", RPI_I04_IN1IN2IN3.class);
       return retVal;
    }
    ...
    public RPI_I04_IN1IN2IN3 getIN1IN2IN3(int rep) { 
       RPI_I04_IN1IN2IN3 retVal = getTyped("IN1IN2IN3", rep, RPI_I04_IN1IN2IN3.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<RPI_I04_IN1IN2IN3> getIN1IN2IN3All() throws HL7Exception {
    	return getAllAsList("IN1IN2IN3", RPI_I04_IN1IN2IN3.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertIN1IN2IN3(RPI_I04_IN1IN2IN3 structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public RPI_I04_IN1IN2IN3 insertIN1IN2IN3(int rep) throws HL7Exception { 
       return (RPI_I04_IN1IN2IN3)super.insertRepetition("IN1IN2IN3", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public RPI_I04_IN1IN2IN3 removeIN1IN2IN3(int rep) throws HL7Exception { 
       return (RPI_I04_IN1IN2IN3)super.removeRepetition("IN1IN2IN3", rep);
    }
