...
/**
 * <p>Represents a PPT_PCL_OBXNTEVAR group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: OBX (OBX - observation/result segment) <b>  </b></li>
...
public class PPT_PCL_OBXNTEVAR extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PPT_PCL_OBXNTEVAR - this is probably a bug in the source code generator.", e);
       }
    }
