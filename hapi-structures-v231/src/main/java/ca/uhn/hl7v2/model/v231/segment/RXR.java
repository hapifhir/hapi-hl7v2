...
/**
 *<p>Represents an HL7 RXR message segment (RXR - pharmacy/treatment route segment). 
 * This segment has the following fields:</p>
 * <ul>
     * <li>RXR-1: Route (CE) <b> </b>
     * <li>RXR-2: Site (CE) <b>optional </b>
...
public class RXR extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(CE.class, true, 1, 60, new Object[]{ getMessage() }, "Route");
                                  this.add(CE.class, false, 1, 60, new Object[]{ getMessage() }, "Site");
                                  this.add(CE.class, false, 1, 60, new Object[]{ getMessage() }, "Administration Device");
                                  this.add(CE.class, false, 1, 60, new Object[]{ getMessage() }, "Administration Method");
                                  this.add(CE.class, false, 1, 60, new Object[]{ getMessage() }, "Routing Instruction");
