...
public class SQR_S25_RGSAISNTEAIGNTEAIPNTEAILNTE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(SQR_S25_AISNTE.class, false, true, false);
                                  this.add(SQR_S25_AIGNTE.class, false, true, false);
                                  this.add(SQR_S25_AIPNTE.class, false, true, false);
                                  this.add(SQR_S25_AILNTE.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating SQR_S25_RGSAISNTEAIGNTEAIPNTEAILNTE - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public SQR_S25_AISNTE getAISNTE() { 
       SQR_S25_AISNTE retVal = getTyped("AISNTE", SQR_S25_AISNTE.class);
       return retVal;
    }
    ...
    public SQR_S25_AISNTE getAISNTE(int rep) { 
       SQR_S25_AISNTE retVal = getTyped("AISNTE", rep, SQR_S25_AISNTE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<SQR_S25_AISNTE> getAISNTEAll() throws HL7Exception {
    ...
    public SQR_S25_AIGNTE getAIGNTE() { 
       SQR_S25_AIGNTE retVal = getTyped("AIGNTE", SQR_S25_AIGNTE.class);
       return retVal;
    }
    ...
    public SQR_S25_AIGNTE getAIGNTE(int rep) { 
       SQR_S25_AIGNTE retVal = getTyped("AIGNTE", rep, SQR_S25_AIGNTE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<SQR_S25_AIGNTE> getAIGNTEAll() throws HL7Exception {
    ...
    public SQR_S25_AIPNTE getAIPNTE() { 
       SQR_S25_AIPNTE retVal = getTyped("AIPNTE", SQR_S25_AIPNTE.class);
       return retVal;
    }
    ...
    public SQR_S25_AIPNTE getAIPNTE(int rep) { 
       SQR_S25_AIPNTE retVal = getTyped("AIPNTE", rep, SQR_S25_AIPNTE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<SQR_S25_AIPNTE> getAIPNTEAll() throws HL7Exception {
    ...
    public SQR_S25_AILNTE getAILNTE() { 
       SQR_S25_AILNTE retVal = getTyped("AILNTE", SQR_S25_AILNTE.class);
       return retVal;
    }
    ...
    public SQR_S25_AILNTE getAILNTE(int rep) { 
       SQR_S25_AILNTE retVal = getTyped("AILNTE", rep, SQR_S25_AILNTE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<SQR_S25_AILNTE> getAILNTEAll() throws HL7Exception {
