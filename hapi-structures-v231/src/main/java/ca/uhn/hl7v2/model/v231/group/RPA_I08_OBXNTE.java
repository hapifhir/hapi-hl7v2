...
/**
 * <p>Represents a RPA_I08_OBXNTE group structure (a Group object).
...
public class RPA_I08_OBXNTE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RPA_I08_OBXNTE - this is probably a bug in the source code generator.", e);
       }
    }
