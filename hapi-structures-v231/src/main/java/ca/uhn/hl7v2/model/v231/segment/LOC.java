...
/**
 *<p>Represents an HL7 LOC message segment (LOC - location identification segment). 
...
public class LOC extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(XON.class, false, 0, 90, new Object[]{ getMessage() }, "Organization Name - LOC");
                                  this.add(XAD.class, false, 0, 106, new Object[]{ getMessage() }, "Location Address");
