...
/**
 *<p>Represents an HL7 PES message segment (PES - product experience sender segment). 
...
public class PES extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(XON.class, false, 0, 80, new Object[]{ getMessage() }, "Sender Organization Name");
