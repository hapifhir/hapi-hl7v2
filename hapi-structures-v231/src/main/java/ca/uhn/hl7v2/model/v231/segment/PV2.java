...
/**
 *<p>Represents an HL7 PV2 message segment (PV2 - patient visit - additional information segment). 
...
public class PV2 extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(XCN.class, false, 0, 90, new Object[]{ getMessage() }, "Referral Source Code");
                                  ...
                                  this.add(CE.class, false, 1, 80, new Object[]{ getMessage() }, "Patient Charge Adjustment Code");
