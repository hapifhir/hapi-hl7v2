...
/**
 * <p>Represents a PEX_P07_NK1RXERXRRXARXRPRBOBX group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: NK1 (NK1 - next of kin / associated parties segment-) <b>  </b></li>
...
public class PEX_P07_NK1RXERXRRXARXRPRBOBX extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PEX_P07_NK1RXERXRRXARXRPRBOBX - this is probably a bug in the source code generator.", e);
       }
    }
