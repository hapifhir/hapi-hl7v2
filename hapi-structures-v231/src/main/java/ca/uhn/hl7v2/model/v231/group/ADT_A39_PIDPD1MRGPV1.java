...
/**
 * <p>Represents a ADT_A39_PIDPD1MRGPV1 group structure (a Group object).
...
public class ADT_A39_PIDPD1MRGPV1 extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ADT_A39_PIDPD1MRGPV1 - this is probably a bug in the source code generator.", e);
       }
    }
