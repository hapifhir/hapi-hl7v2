...
/**
 * <p>Represents a PRR_PC5_PTHVAR group structure (a Group object).
...
public class PRR_PC5_PTHVAR extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PRR_PC5_PTHVAR - this is probably a bug in the source code generator.", e);
       }
    }
