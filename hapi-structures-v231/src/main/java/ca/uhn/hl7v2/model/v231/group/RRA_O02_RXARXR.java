...
/**
 * <p>Represents a RRA_O02_RXARXR group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: RXA (RXA - pharmacy/treatment administration segment) <b> repeating </b></li>
                         * <li>2: RXR (RXR - pharmacy/treatment route segment) <b>  </b></li>
 * </ul>
 */
...
public class RRA_O02_RXARXR extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RRA_O02_RXARXR - this is probably a bug in the source code generator.", e);
       }
    }
