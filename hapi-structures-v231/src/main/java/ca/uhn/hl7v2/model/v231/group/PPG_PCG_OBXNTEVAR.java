...
/**
 * <p>Represents a PPG_PCG_OBXNTEVAR group structure (a Group object).
...
public class PPG_PCG_OBXNTEVAR extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PPG_PCG_OBXNTEVAR - this is probably a bug in the source code generator.", e);
       }
    }
