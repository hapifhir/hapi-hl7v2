...
/**
 * <p>Represents a PPR_PC1_ROLVAR group structure (a Group object).
...
public class PPR_PC1_ROLVAR extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PPR_PC1_ROLVAR - this is probably a bug in the source code generator.", e);
       }
    }
