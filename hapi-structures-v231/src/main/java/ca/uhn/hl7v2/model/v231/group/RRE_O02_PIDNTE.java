...
/**
 * <p>Represents a RRE_O02_PIDNTE group structure (a Group object).
...
public class RRE_O02_PIDNTE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RRE_O02_PIDNTE - this is probably a bug in the source code generator.", e);
       }
    }
