...
public class ORN_O02_PIDNTEORCRQDRQ1NTE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(ORN_O02_PIDNTE.class, false, false, false);
                                  this.add(ORN_O02_ORCRQDRQ1NTE.class, true, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating ORN_O02_PIDNTEORCRQDRQ1NTE - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public ORN_O02_PIDNTE getPIDNTE() { 
       ORN_O02_PIDNTE retVal = getTyped("PIDNTE", ORN_O02_PIDNTE.class);
       return retVal;
    }
    ...
    public ORN_O02_ORCRQDRQ1NTE getORCRQDRQ1NTE() { 
       ORN_O02_ORCRQDRQ1NTE retVal = getTyped("ORCRQDRQ1NTE", ORN_O02_ORCRQDRQ1NTE.class);
       return retVal;
    }
    ...
    public ORN_O02_ORCRQDRQ1NTE getORCRQDRQ1NTE(int rep) { 
       ORN_O02_ORCRQDRQ1NTE retVal = getTyped("ORCRQDRQ1NTE", rep, ORN_O02_ORCRQDRQ1NTE.class);
       return retVal;
    }
    ...
    public int getORCRQDRQ1NTEReps() {  
        return getReps("ORCRQDRQ1NTE");
    } 

    /** 
     * <p>
     * Returns a non-modifiable List containing all current existing repetitions of ORCRQDRQ1NTE.
     * <p>
     * <p>
     * Note that unlike {@link #getORCRQDRQ1NTE()}, this method will not create any reps
     * if none are already present, so an empty list may be returned.
     * </p>
     */ 
    public java.util.List<ORN_O02_ORCRQDRQ1NTE> getORCRQDRQ1NTEAll() throws HL7Exception {
    	return getAllAsList("ORCRQDRQ1NTE", ORN_O02_ORCRQDRQ1NTE.class);
    } 
