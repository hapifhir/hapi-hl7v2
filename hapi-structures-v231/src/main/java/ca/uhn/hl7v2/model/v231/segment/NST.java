 ...
 * <ul>
     * <li>NST-1: Statistics Available (ID) <b>optional </b>
...
public class NST extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                              this.add(ID.class, false, 1, 0, new Object[]{ getMessage(), new Integer(136) }, "Statistics Available");
                                  this.add(ST.class, false, 1, 0, new Object[]{ getMessage() }, "Source Identifier");
                                              this.add(ID.class, false, 1, 0, new Object[]{ getMessage(), new Integer(0) }, "Source Type");
                                  this.add(TS.class, false, 1, 0, new Object[]{ getMessage() }, "Statistics Start");
                                  this.add(TS.class, false, 1, 0, new Object[]{ getMessage() }, "Statistics End");
                                  ...
                                  this.add(NM.class, false, 1, 0, new Object[]{ getMessage() }, "Network Errors");
