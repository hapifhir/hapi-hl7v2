...
/**
 * <p>Represents a PPR_PC1_OBRRXONTEVAROBXNTEVAR group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>5: PPR_PC1_OBXNTEVAR (a Group object) <b>optional repeating </b></li>
 * </ul>
 * <p>
...
public class PPR_PC1_OBRRXONTEVAROBXNTEVAR extends AbstractGroup {

    /** 
     * Creates a new PPR_PC1_OBRRXONTEVAROBXNTEVAR group
     */
    public PPR_PC1_OBRRXONTEVAROBXNTEVAR(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(PPR_PC1_OBXNTEVAR.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating PPR_PC1_OBRRXONTEVAROBXNTEVAR - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     */
    public PPR_PC1_OBXNTEVAR getOBXNTEVAR() { 
       PPR_PC1_OBXNTEVAR retVal = getTyped("OBXNTEVAR", PPR_PC1_OBXNTEVAR.class);
       return retVal;
    }
     ...
     *     greater than the number of existing repetitions.
     */
    public PPR_PC1_OBXNTEVAR getOBXNTEVAR(int rep) { 
       PPR_PC1_OBXNTEVAR retVal = getTyped("OBXNTEVAR", rep, PPR_PC1_OBXNTEVAR.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PPR_PC1_OBXNTEVAR> getOBXNTEVARAll() throws HL7Exception {
    	return getAllAsList("OBXNTEVAR", PPR_PC1_OBXNTEVAR.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertOBXNTEVAR(PPR_PC1_OBXNTEVAR structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public PPR_PC1_OBXNTEVAR insertOBXNTEVAR(int rep) throws HL7Exception { 
       return (PPR_PC1_OBXNTEVAR)super.insertRepetition("OBXNTEVAR", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public PPR_PC1_OBXNTEVAR removeOBXNTEVAR(int rep) throws HL7Exception { 
       return (PPR_PC1_OBXNTEVAR)super.removeRepetition("OBXNTEVAR", rep);
    }
