...
/**
 * <p>Represents an HL7 CK (composite ID with check digit) data type. 
 * This type consists of the following components:</p>
 * <ul>
 * <li>ID number (NM)
 * <li>check digit (NM)
 * <li>code identifying check digit scheme employed (ID)
 * </ul>
 */
...
public class CK extends AbstractComposite {
     ...
     * casting and handling an exception.
     */
    public NM getCk2_CheckDigit() {
       return getTyped(1, NM.class);
    }


    /**
     * Returns code identifying check digit scheme employed (component 3).  This is a convenience method that saves you from 
     * casting and handling an exception.
     */
     ...
     * casting and handling an exception.
     */
    public ID getCk3_CodeIdentifyingCheckDigitSchemeEmployed() {
       return getTyped(2, ID.class);
    }
