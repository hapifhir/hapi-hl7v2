...
/**
 *<p>Represents an HL7 NPU message segment (NON-PATIENT UPDATE). 
 * This segment has the following fields:</p>
 * <ul>
     * <li>NPU-1: BED LOCATION (ID) <b> </b>
     * <li>NPU-2: BED STATUS (ID) <b>optional </b>
 * </ul>
 */
...
public class NPU extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                              this.add(ID.class, true, 1, 12, new Object[]{ getMessage(), new Integer(79) }, "BED LOCATION");
    ...
    protected Type createNewTypeWithoutReflection(int field) {
       switch (field) {
          case 0: return new ID(getMessage(), new Integer( 79 ));
          case 1: return new ID(getMessage(), new Integer( 116 ));
          default: return null;
       }
   }
