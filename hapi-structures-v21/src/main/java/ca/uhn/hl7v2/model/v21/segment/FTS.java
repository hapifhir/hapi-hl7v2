 ...
 * <ul>
     * <li>FTS-1: FILE BATCH COUNT (ST) <b>optional </b>
...
public class FTS extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(ST.class, false, 1, 10, new Object[]{ getMessage() }, "FILE BATCH COUNT");
     ...
     * FTS-1: "FILE BATCH COUNT" - creates it if necessary
     */
    public ST getFts1_FILEBATCHCOUNT() { 
		ST retVal = this.getTypedField(1, 0);
		return retVal;
    }
