...
public class PN extends AbstractComposite {
    ...
    /**
     * Returns suffix (component 4).  This is a convenience method that saves you from 
     * casting and handling an exception.
     */
    public ST getSuffix() {
     ...
     * casting and handling an exception.
     */
    public ST getPn4_Suffix() {
       return getTyped(3, ST.class);
    }


    /**
     * Returns prefix (component 5).  This is a convenience method that saves you from 
     * casting and handling an exception.
     */
    public ST getPrefix() {
     ...
     * casting and handling an exception.
     */
    public ST getPn5_Prefix() {
       return getTyped(4, ST.class);
    }


    /**
     * Returns degree (component 6).  This is a convenience method that saves you from 
     * casting and handling an exception.
     */
    public ST getDegree() {
