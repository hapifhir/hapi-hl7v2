...
public class ORU_R03_PATIENT_RESULT extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(ORU_R03_PATIENT.class, false, false, false);
                                  this.add(ORU_R03_ORDER_OBSERVATION.class, true, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating ORU_R03_PATIENT_RESULT - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public ORU_R03_PATIENT getPATIENT() { 
       ORU_R03_PATIENT retVal = getTyped("PATIENT", ORU_R03_PATIENT.class);
       return retVal;
    }
    ...
    public ORU_R03_ORDER_OBSERVATION getORDER_OBSERVATION() { 
       ORU_R03_ORDER_OBSERVATION retVal = getTyped("ORDER_OBSERVATION", ORU_R03_ORDER_OBSERVATION.class);
       return retVal;
    }
    ...
    public ORU_R03_ORDER_OBSERVATION getORDER_OBSERVATION(int rep) { 
       ORU_R03_ORDER_OBSERVATION retVal = getTyped("ORDER_OBSERVATION", rep, ORU_R03_ORDER_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<ORU_R03_ORDER_OBSERVATION> getORDER_OBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("ORDER_OBSERVATION", ORU_R03_ORDER_OBSERVATION.class);
    } 
