 ...
 * <ul>
		                 ...
		                 * <li>3: ADT_A17_PATIENT (a Group object) <b> repeating</b> </li>
 * </ul>
 */
...
public class ADT_A17 extends AbstractMessage  {
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(ADT_A17_PATIENT.class, true, true);
    ...
    public ADT_A17_PATIENT getPATIENT() { 
       return getTyped("PATIENT", ADT_A17_PATIENT.class);
    }
    ...
    public ADT_A17_PATIENT getPATIENT(int rep) { 
       return getTyped("PATIENT", rep, ADT_A17_PATIENT.class);
    }
     ...
     * 
     */ 
    public java.util.List<ADT_A17_PATIENT> getPATIENTAll() throws HL7Exception {
    	return getAllAsList("PATIENT", ADT_A17_PATIENT.class);
    } 
     ...
     */
    public void insertPATIENT(ADT_A17_PATIENT structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public ADT_A17_PATIENT insertPATIENT(int rep) throws HL7Exception { 
       return (ADT_A17_PATIENT)super.insertRepetition("PATIENT", rep);
    }
     ...
     */
    public ADT_A17_PATIENT removePATIENT(int rep) throws HL7Exception { 
       return (ADT_A17_PATIENT)super.removeRepetition("PATIENT", rep);
    }
