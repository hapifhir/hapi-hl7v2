...
/**
 * <p>Represents a ORU_R03_PATIENT group structure (a Group object).
...
public class ORU_R03_PATIENT extends AbstractGroup {

    /** 
     * Creates a new ORU_R03_PATIENT group
     */
    public ORU_R03_PATIENT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ORU_R03_PATIENT - this is probably a bug in the source code generator.", e);
       }
    }
