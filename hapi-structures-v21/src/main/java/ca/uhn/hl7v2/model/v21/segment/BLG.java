...
public class BLG extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(CM.class, false, 1, 15, new Object[]{ getMessage() }, "WHEN TO CHARGE");
                                              this.add(ID.class, false, 1, 50, new Object[]{ getMessage(), new Integer(122) }, "CHARGE TYPE");
                                  this.add(CM.class, false, 1, 100, new Object[]{ getMessage() }, "ACCOUNT ID");
    ...
    public CM getWHENTOCHARGE() { 
		CM retVal = this.getTypedField(1, 0);
		return retVal;
    }
