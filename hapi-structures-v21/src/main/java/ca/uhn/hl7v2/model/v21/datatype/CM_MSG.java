 ...
 * 
 * The Original Code is "CM_MSG.java".  Description:
 * "Composite class CM_MSG"
 * 
...
/**
 * <p>Represents an HL7 CM_MSG (Message Type) data type. 
...
public class CM_MSG extends AbstractComposite {
    ...
    /**
     * Returns Message Type (component 1).  This is a convenience method that saves you from 
