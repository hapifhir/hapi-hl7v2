...
/**
 * <p>Represents a ADT_A17_PATIENT group structure (a Group object).
...
public class ADT_A17_PATIENT extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ADT_A17_PATIENT - this is probably a bug in the source code generator.", e);
       }
    }
