...
public class AntGenerator {
   ...
   private String antString(){
      ...
      StringBuilder ant =
              new StringBuilder("<!-- Build file for the Conformance Classes -->\n" +
