...
public class Location {
    ...
    /**
     * There's no such thing as a subsubcomponent in HL7 but some of the hapi-structures have other ideas, eg OBR-32-1-9 is a HD in V23
     */
    private int subsubcomponent = -1;
    ...
    public Location(Location l) {
        ...
        this.subsubcomponent = l.subsubcomponent;
    }
    ...
    public int getSubsubcomponent() {
        return subsubcomponent;
    }

    public Location withSubsubcomponent(int subsubcomponent) {
            ...
            if (field > 0) {
                ...
                if (component > 0) {
                    ...
                    if (subcomponent > 0) {
                        ...
                        if (subsubcomponent > 0) {
                            sb.append("-").append(subsubcomponent);
                        }
                    }
                }
            }
    ...
    public int hashCode() {
        ...
        result = prime * result + subsubcomponent;
        return result;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (subsubcomponent != other.subsubcomponent) {
			return false;
		}
        return true;
    }
