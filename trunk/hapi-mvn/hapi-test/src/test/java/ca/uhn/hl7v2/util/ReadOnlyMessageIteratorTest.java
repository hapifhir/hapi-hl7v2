...
//    public void testNext() throws EncodingNotSupportedException, HL7Exception {
//        PipeParser parser = new PipeParser();
//        Message msg = parser.parse(getMessageOne());
//        Iterator it = new ReadOnlyMessageIterator(msg);
//        
//        while (it.hasNext()) {
...
//            System.out.println(PipeParser.encode(s, new EncodingCharacters('|', "^~\\&")));
//        }
    }
