...
public class RQI_I02_GUARANTOR_INSURANCE extends AbstractGroup {
	...
	public RQI_I02_GUARANTOR_INSURANCE(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(RQI_I02_INSURANCE.class, true, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RQI_I02_GUARANTOR_INSURANCE - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public RQI_I02_INSURANCE getINSURANCE() { 
	   ...
	   try {
	      ret = (RQI_I02_INSURANCE)this.get("INSURANCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public RQI_I02_INSURANCE getINSURANCE(int rep) throws HL7Exception { 
	   return (RQI_I02_INSURANCE)this.get("INSURANCE", rep);
	}
