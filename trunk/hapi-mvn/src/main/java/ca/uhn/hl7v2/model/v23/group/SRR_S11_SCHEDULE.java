...
public class SRR_S11_SCHEDULE extends AbstractGroup {
	...
	public SRR_S11_SCHEDULE(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(SRR_S11_PATIENT.class, false, true);
	      this.add(SRR_S11_RESOURCES.class, true, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating SRR_S11_SCHEDULE - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public SRR_S11_PATIENT getPATIENT() { 
	   ...
	   try {
	      ret = (SRR_S11_PATIENT)this.get("PATIENT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public SRR_S11_PATIENT getPATIENT(int rep) throws HL7Exception { 
	   return (SRR_S11_PATIENT)this.get("PATIENT", rep);
	}
	...
	public SRR_S11_RESOURCES getRESOURCES() { 
	   ...
	   try {
	      ret = (SRR_S11_RESOURCES)this.get("RESOURCES");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public SRR_S11_RESOURCES getRESOURCES(int rep) throws HL7Exception { 
	   return (SRR_S11_RESOURCES)this.get("RESOURCES", rep);
	}
