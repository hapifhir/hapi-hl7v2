...
/**
 * <p>Represents the RAR_RAR_RXERXRRXC Group.  A Group is an ordered collection of message 
 ...
 */
public class RAR_RAR_RXERXRRXC extends AbstractGroup {

	/** 
	 * Creates a new RAR_RAR_RXERXRRXC Group.
	 */
	public RAR_RAR_RXERXRRXC(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RAR_RAR_RXERXRRXC - this is probably a bug in the source code generator.", e);
	   }
	}
