...
public class RQI_I01 extends AbstractMessage  {
	...
	public RQI_I01_PRDCTD getPRDCTD() { 
	   ...
	   try {
	      ret = (RQI_I01_PRDCTD)this.get("PRDCTD");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 */
	public RQI_I01_PRDCTD getPRDCTD(int rep) throws HL7Exception { 
	   return (RQI_I01_PRDCTD)this.get("PRDCTD", rep);
	}
	...
	/**
	 * Returns RQI_I01_GT1IN1IN2IN3 (a Group object) - creates it if necessary
	 */
	public RQI_I01_GT1IN1IN2IN3 getGT1IN1IN2IN3() { 
	   RQI_I01_GT1IN1IN2IN3 ret = null;
	   try {
	      ret = (RQI_I01_GT1IN1IN2IN3)this.get("GT1IN1IN2IN3");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
