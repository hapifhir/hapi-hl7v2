 ...
 */
public class PPG_PCH_ORDER extends AbstractGroup {
	...
	public PPG_PCH_ORDER(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(PPG_PCH_ORDER_DETAIL.class, false, false);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating PPG_PCH_ORDER - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public PPG_PCH_ORDER_DETAIL getORDER_DETAIL() { 
	   ...
	   try {
	      ret = (PPG_PCH_ORDER_DETAIL)this.get("ORDER_DETAIL");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
