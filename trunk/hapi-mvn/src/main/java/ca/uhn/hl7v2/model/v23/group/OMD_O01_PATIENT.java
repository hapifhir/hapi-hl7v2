...
public class OMD_O01_PATIENT extends AbstractGroup {
	...
	public OMD_O01_PATIENT(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(OMD_O01_PATIENT_VISIT.class, false, false);
	      this.add(OMD_O01_INSURANCE.class, false, true);
	      this.add(GT1.class, false, false);
	      this.add(AL1.class, false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating OMD_O01_PATIENT - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public OMD_O01_PATIENT_VISIT getPATIENT_VISIT() { 
	   ...
	   try {
	      ret = (OMD_O01_PATIENT_VISIT)this.get("PATIENT_VISIT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	...
	public OMD_O01_INSURANCE getINSURANCE() { 
	   ...
	   try {
	      ret = (OMD_O01_INSURANCE)this.get("INSURANCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public OMD_O01_INSURANCE getINSURANCE(int rep) throws HL7Exception { 
	   return (OMD_O01_INSURANCE)this.get("INSURANCE", rep);
	}
