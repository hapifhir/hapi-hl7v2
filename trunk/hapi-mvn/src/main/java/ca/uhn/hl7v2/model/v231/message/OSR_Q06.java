...
public class OSR_Q06 extends AbstractMessage  {
	...
	/**
	 * Returns OSR_Q06_PIDNTEORCOBRRXORQDRQ1ODSODTNTECTI (a Group object) - creates it if necessary
	 */
	public OSR_Q06_PIDNTEORCOBRRXORQDRQ1ODSODTNTECTI getPIDNTEORCOBRRXORQDRQ1ODSODTNTECTI() { 
	   ...
	   try {
	      ret = (OSR_Q06_PIDNTEORCOBRRXORQDRQ1ODSODTNTECTI)this.get("PIDNTEORCOBRRXORQDRQ1ODSODTNTECTI");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
