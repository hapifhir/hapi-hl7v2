...
public class ADT_A44 extends AbstractMessage  {
	...
	/**
	 * Returns  first repetition of ADT_A44_PIDPD1MRG (a Group object) - creates it if necessary
	 */
	...
	/**
	 * Returns a specific repetition of ADT_A44_PIDPD1MRG
	 * (a Group object) - creates it if necessary
	 * throws HL7Exception if the repetition requested is more than one 
	 *     greater than the number of existing repetitions.
	 */
	public ADT_A44_PIDPD1MRG getPIDPD1MRG(int rep) throws HL7Exception { 
	   return (ADT_A44_PIDPD1MRG)this.get("PIDPD1MRG", rep);
	}

	/** 
	 * Returns the number of existing repetitions of ADT_A44_PIDPD1MRG 
	 */ 
