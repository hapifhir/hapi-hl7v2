...
/**
 * <p>Represents the ADT_A42_PIDPD1MRGPV1 Group.  A Group is an ordered collection of message 
...
public class ADT_A42_PIDPD1MRGPV1 extends AbstractGroup {
	...
	public ADT_A42_PIDPD1MRGPV1(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating ADT_A42_PIDPD1MRGPV1 - this is probably a bug in the source code generator.", e);
	   }
	}
