...
/**
 * <p>Represents the RRE_O02_RXERXRRXC Group.  A Group is an ordered collection of message 
 ...
 */
public class RRE_O02_RXERXRRXC extends AbstractGroup {

	/** 
	 * Creates a new RRE_O02_RXERXRRXC Group.
	 */
	public RRE_O02_RXERXRRXC(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RRE_O02_RXERXRRXC - this is probably a bug in the source code generator.", e);
	   }
	}
