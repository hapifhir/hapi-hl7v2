...
public class SRR_S04 extends AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating SRR_S04 - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public SRR_S04_SCHEDULE getSCHEDULE() { 
	   ...
	   try {
	      ret = (SRR_S04_SCHEDULE)this.get("SCHEDULE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
