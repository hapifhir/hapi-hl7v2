...
public class REF_I13_PROCEDURE extends AbstractGroup {
	...
	public REF_I13_PROCEDURE(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating REF_I13_PROCEDURE - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public REF_I13_AUTHORIZATION getAUTHORIZATION() { 
	   ...
	   try {
	      ret = (REF_I13_AUTHORIZATION)this.get("AUTHORIZATION");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
