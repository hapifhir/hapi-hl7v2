...
public class PPP_PCC_PATHWAY extends AbstractGroup {
	...
	public PPP_PCC_PATHWAY(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(PPP_PCC_PATHWAY_ROLE.class, false, true);
	      this.add(PPP_PCC_PROBLEM.class, false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating PPP_PCC_PATHWAY - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public PPP_PCC_PATHWAY_ROLE getPATHWAY_ROLE() { 
	   ...
	   try {
	      ret = (PPP_PCC_PATHWAY_ROLE)this.get("PATHWAY_ROLE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public PPP_PCC_PATHWAY_ROLE getPATHWAY_ROLE(int rep) throws HL7Exception { 
	   return (PPP_PCC_PATHWAY_ROLE)this.get("PATHWAY_ROLE", rep);
	}
	...
	public PPP_PCC_PROBLEM getPROBLEM() { 
	   ...
	   try {
	      ret = (PPP_PCC_PROBLEM)this.get("PROBLEM");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public PPP_PCC_PROBLEM getPROBLEM(int rep) throws HL7Exception { 
	   return (PPP_PCC_PROBLEM)this.get("PROBLEM", rep);
	}
