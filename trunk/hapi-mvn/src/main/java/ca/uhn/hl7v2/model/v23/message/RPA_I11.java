...
public class RPA_I11 extends AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RPA_I11 - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public RPA_I11_AUTHORIZATION getAUTHORIZATION() { 
	   ...
	   try {
	      ret = (RPA_I11_AUTHORIZATION)this.get("AUTHORIZATION");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	...
	public RPA_I11_PROVIDER getPROVIDER() { 
	   ...
	   try {
	      ret = (RPA_I11_PROVIDER)this.get("PROVIDER");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 */
	public RPA_I11_PROVIDER getPROVIDER(int rep) throws HL7Exception { 
	   return (RPA_I11_PROVIDER)this.get("PROVIDER", rep);
	}
	...
	public RPA_I11_INSURANCE getINSURANCE() { 
	   ...
	   try {
	      ret = (RPA_I11_INSURANCE)this.get("INSURANCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public RPA_I11_INSURANCE getINSURANCE(int rep) throws HL7Exception { 
	   return (RPA_I11_INSURANCE)this.get("INSURANCE", rep);
	}
	...
	public RPA_I11_PROCEDURE getPROCEDURE() { 
	   ...
	   try {
	      ret = (RPA_I11_PROCEDURE)this.get("PROCEDURE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public RPA_I11_PROCEDURE getPROCEDURE(int rep) throws HL7Exception { 
	   return (RPA_I11_PROCEDURE)this.get("PROCEDURE", rep);
	}
	...
	public RPA_I11_RESULTS getRESULTS() { 
	   ...
	   try {
	      ret = (RPA_I11_RESULTS)this.get("RESULTS");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public RPA_I11_RESULTS getRESULTS(int rep) throws HL7Exception { 
	   return (RPA_I11_RESULTS)this.get("RESULTS", rep);
	}
	...
	public RPA_I11_VISIT getVISIT() { 
	   ...
	   try {
	      ret = (RPA_I11_VISIT)this.get("VISIT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
