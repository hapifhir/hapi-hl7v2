...
public class RRI_I12 extends AbstractMessage  {
	...
	public RRI_I12_PROVIDER getPROVIDER() { 
	   ...
	   try {
	      ret = (RRI_I12_PROVIDER)this.get("PROVIDER");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 */
	public RRI_I12_PROVIDER getPROVIDER(int rep) throws HL7Exception { 
	   return (RRI_I12_PROVIDER)this.get("PROVIDER", rep);
	}
	...
	public RRI_I12_RESULTS getRESULTS() { 
	   ...
	   try {
	      ret = (RRI_I12_RESULTS)this.get("RESULTS");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public RRI_I12_RESULTS getRESULTS(int rep) throws HL7Exception { 
	   return (RRI_I12_RESULTS)this.get("RESULTS", rep);
	}
	...
	public RRI_I12_VISIT getVISIT() { 
	   ...
	   try {
	      ret = (RRI_I12_VISIT)this.get("VISIT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
