...
public class PEX_P08_ASSOCIATED_RX_ADMIN extends AbstractGroup {
	...
	public PEX_P08_ASSOCIATED_RX_ADMIN(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating PEX_P08_ASSOCIATED_RX_ADMIN - this is probably a bug in the source code generator.", e);
	   }
	}
