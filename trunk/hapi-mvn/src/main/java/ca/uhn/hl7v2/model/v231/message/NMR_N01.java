...
public class NMR_N01 extends AbstractMessage  {
	...
	/**
	 * Returns  first repetition of NMR_N01_NCKNTENSTNTENSCNTE (a Group object) - creates it if necessary
	 */
	...
	/**
	 * Returns a specific repetition of NMR_N01_NCKNTENSTNTENSCNTE
	 * (a Group object) - creates it if necessary
	 * throws HL7Exception if the repetition requested is more than one 
	 *     greater than the number of existing repetitions.
	 */
	public NMR_N01_NCKNTENSTNTENSCNTE getNCKNTENSTNTENSCNTE(int rep) throws HL7Exception { 
	   return (NMR_N01_NCKNTENSTNTENSCNTE)this.get("NCKNTENSTNTENSCNTE", rep);
	}

	/** 
	 * Returns the number of existing repetitions of NMR_N01_NCKNTENSTNTENSCNTE 
	 */ 
