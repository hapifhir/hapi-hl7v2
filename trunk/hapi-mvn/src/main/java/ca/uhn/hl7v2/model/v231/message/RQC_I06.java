...
public class RQC_I06 extends AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RQC_I06 - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	/**
	 * Returns  first repetition of RQC_I06_PRDCTD (a Group object) - creates it if necessary
	 */
	public RQC_I06_PRDCTD getPRDCTD() { 
	   RQC_I06_PRDCTD ret = null;
	   try {
	      ret = (RQC_I06_PRDCTD)this.get("PRDCTD");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	...
	/**
	 * Returns a specific repetition of RQC_I06_PRDCTD
	 * (a Group object) - creates it if necessary
	 * throws HL7Exception if the repetition requested is more than one 
	 *     greater than the number of existing repetitions.
	 */
	public RQC_I06_PRDCTD getPRDCTD(int rep) throws HL7Exception { 
	   return (RQC_I06_PRDCTD)this.get("PRDCTD", rep);
	}

	/** 
	 * Returns the number of existing repetitions of RQC_I06_PRDCTD 
	 */ 
