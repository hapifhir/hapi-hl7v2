...
public class PRD extends AbstractSegment  {
  ...
  public PRD(Group parent, ModelClassFactory factory) {
    ...
    try {
       ...
       this.add(XAD.class, false, 1, 60, new Object[]{message});
       this.add(PL.class, false, 1, 60, new Object[]{message});
       this.add(XTN.class, false, 0, 20, new Object[]{message});
       this.add(CE.class, false, 1, 200, new Object[]{message});
       this.add(CM_PI.class, false, 0, 100, new Object[]{message});
   ...
   */
  public CE getRole(int rep) throws HL7Exception {
    CE ret = null;
    try {
   ...
   * @throws HL7Exception if the repetition number is invalid.
   */
  public CM_PI getProviderIdentifiers(int rep) throws HL7Exception {
    CM_PI ret = null;
    try {
