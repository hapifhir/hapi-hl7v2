...
public class CSU_C10_STUDY_PHARM extends AbstractGroup {
	...
	public CSU_C10_STUDY_PHARM(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(CSU_C10_RX_ADMIN.class, true, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating CSU_C10_STUDY_PHARM - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public CSU_C10_RX_ADMIN getRX_ADMIN() { 
	   ...
	   try {
	      ret = (CSU_C10_RX_ADMIN)this.get("RX_ADMIN");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 */
	public CSU_C10_RX_ADMIN getRX_ADMIN(int rep) throws HL7Exception { 
	   return (CSU_C10_RX_ADMIN)this.get("RX_ADMIN", rep);
	}
