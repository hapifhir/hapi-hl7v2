...
public class REF_I14_RESULTS extends AbstractGroup {
	...
	public REF_I14_RESULTS(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(REF_I14_OBSERVATION.class, false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating REF_I14_RESULTS - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public REF_I14_OBSERVATION getOBSERVATION() { 
	   ...
	   try {
	      ret = (REF_I14_OBSERVATION)this.get("OBSERVATION");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public REF_I14_OBSERVATION getOBSERVATION(int rep) throws HL7Exception { 
	   return (REF_I14_OBSERVATION)this.get("OBSERVATION", rep);
	}
