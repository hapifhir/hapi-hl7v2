...
/**
 * <p>Represents the NMQ_N01_NCKNSTNSC Group.  A Group is an ordered collection of message 
 ...
 */
public class NMQ_N01_NCKNSTNSC extends AbstractGroup {

	/** 
	 * Creates a new NMQ_N01_NCKNSTNSC Group.
	 */
	public NMQ_N01_NCKNSTNSC(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating NMQ_N01_NCKNSTNSC - this is probably a bug in the source code generator.", e);
	   }
	}
