...
/**
 * <p>Represents the PTR_PCF_GOLNTEVARROLVAROBXNTE Group.  A Group is an ordered collection of message 
...
public class PTR_PCF_GOLNTEVARROLVAROBXNTE extends AbstractGroup {
	...
	/** 
	 * Creates a new PTR_PCF_GOLNTEVARROLVAROBXNTE Group.
	 */
	public PTR_PCF_GOLNTEVARROLVAROBXNTE(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating PTR_PCF_GOLNTEVARROLVAROBXNTE - this is probably a bug in the source code generator.", e);
	   }
	}
