...
public class UB1 extends AbstractSegment  {
  ...
  public UB1(Group parent, ModelClassFactory factory) {
    ...
    try {
       ...
       this.add(NM.class, false, 1, 2, new Object[]{message});
       this.add(NM.class, false, 1, 2, new Object[]{message});
       this.add(IS.class, false, 5, 2, new Object[]{message, new Integer(43)});
       ...
       this.add(ID.class, false, 1, 60, new Object[]{message, new Integer(0)});
   ...
   * @throws HL7Exception if the repetition number is invalid.
   */
  public CM_UVC getValueAmountCode4649(int rep) throws HL7Exception {
    CM_UVC ret = null;
    try {
