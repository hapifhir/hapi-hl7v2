...
public class RRO_O02_RESPONSE extends AbstractGroup {
	...
	public RRO_O02_RESPONSE(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      this.add(RRO_O02_PATIENT.class, false, false);
	      this.add(RRO_O02_ORDER.class, true, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RRO_O02_RESPONSE - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public RRO_O02_PATIENT getPATIENT() { 
	   ...
	   try {
	      ret = (RRO_O02_PATIENT)this.get("PATIENT");
	   } catch(HL7Exception e) {
	...
	public RRO_O02_ORDER getORDER() { 
	   ...
	   try {
	      ret = (RRO_O02_ORDER)this.get("ORDER");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 */
	public RRO_O02_ORDER getORDER(int rep) throws HL7Exception { 
	   return (RRO_O02_ORDER)this.get("ORDER", rep);
	}
