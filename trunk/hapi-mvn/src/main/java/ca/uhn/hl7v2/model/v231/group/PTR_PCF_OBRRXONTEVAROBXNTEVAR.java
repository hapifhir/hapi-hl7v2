...
/**
 * <p>Represents the PTR_PCF_OBRRXONTEVAROBXNTEVAR Group.  A Group is an ordered collection of message 
...
public class PTR_PCF_OBRRXONTEVAROBXNTEVAR extends AbstractGroup {
	...
	public PTR_PCF_OBRRXONTEVAROBXNTEVAR(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(PTR_PCF_OBXNTEVAR.class, false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating PTR_PCF_OBRRXONTEVAROBXNTEVAR - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	/**
	 * Returns  first repetition of PTR_PCF_OBXNTEVAR (a Group object) - creates it if necessary
	 */
	public PTR_PCF_OBXNTEVAR getOBXNTEVAR() { 
	   PTR_PCF_OBXNTEVAR ret = null;
	   try {
	      ret = (PTR_PCF_OBXNTEVAR)this.get("OBXNTEVAR");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	...
	/**
	 * Returns a specific repetition of PTR_PCF_OBXNTEVAR
	 * (a Group object) - creates it if necessary
	 * throws HL7Exception if the repetition requested is more than one 
	 *     greater than the number of existing repetitions.
	 */
	public PTR_PCF_OBXNTEVAR getOBXNTEVAR(int rep) throws HL7Exception { 
	   return (PTR_PCF_OBXNTEVAR)this.get("OBXNTEVAR", rep);
	}

	/** 
	 * Returns the number of existing repetitions of PTR_PCF_OBXNTEVAR 
	 */ 
