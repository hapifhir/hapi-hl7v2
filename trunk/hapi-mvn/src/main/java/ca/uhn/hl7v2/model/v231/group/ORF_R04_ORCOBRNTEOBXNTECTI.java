...
/**
 * <p>Represents the ORF_R04_ORCOBRNTEOBXNTECTI Group.  A Group is an ordered collection of message 
 ...
 */
public class ORF_R04_ORCOBRNTEOBXNTECTI extends AbstractGroup {

	/** 
	 * Creates a new ORF_R04_ORCOBRNTEOBXNTECTI Group.
	 */
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public ORF_R04_OBXNTE getOBXNTE(int rep) throws HL7Exception { 
	   return (ORF_R04_OBXNTE)this.get("OBXNTE", rep);
	}
