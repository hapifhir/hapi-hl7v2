...
/**
 * <p>Represents a CRM_C01 message structure (see chapter null). This structure contains the 
...
public class CRM_C01 extends AbstractMessage  {
	...
	/**
	 * Returns  first repetition of CRM_C01_PIDPV1CSRCSP (a Group object) - creates it if necessary
	 */
	...
	/**
	 * Returns a specific repetition of CRM_C01_PIDPV1CSRCSP
	 * (a Group object) - creates it if necessary
	 * throws HL7Exception if the repetition requested is more than one 
	 *     greater than the number of existing repetitions.
	 */
	public CRM_C01_PIDPV1CSRCSP getPIDPV1CSRCSP(int rep) throws HL7Exception { 
	   return (CRM_C01_PIDPV1CSRCSP)this.get("PIDPV1CSRCSP", rep);
	}

	/** 
	 * Returns the number of existing repetitions of CRM_C01_PIDPV1CSRCSP 
	 */ 
