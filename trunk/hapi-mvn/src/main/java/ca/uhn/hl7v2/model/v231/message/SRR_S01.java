...
/**
 * <p>Represents a SRR_S01 message structure (see chapter null). This structure contains the 
...
public class SRR_S01 extends AbstractMessage  {
	...
	/**
	 * Returns SRR_S01_SCHNTEPIDPV1PV2DG1RGSAISNTEAIGNTEAILNTEAIPNTE (a Group object) - creates it if necessary
	 */
	public SRR_S01_SCHNTEPIDPV1PV2DG1RGSAISNTEAIGNTEAILNTEAIPNTE getSCHNTEPIDPV1PV2DG1RGSAISNTEAIGNTEAILNTEAIPNTE() { 
	   ...
	   try {
	      ret = (SRR_S01_SCHNTEPIDPV1PV2DG1RGSAISNTEAIGNTEAILNTEAIPNTE)this.get("SCHNTEPIDPV1PV2DG1RGSAISNTEAIGNTEAILNTEAIPNTE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
