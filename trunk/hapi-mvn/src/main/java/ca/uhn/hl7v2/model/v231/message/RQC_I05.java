...
public class RQC_I05 extends AbstractMessage  {
	...
	/**
	 * Returns  first repetition of RQC_I05_PRDCTD (a Group object) - creates it if necessary
	 */
	...
	/**
	 * Returns a specific repetition of RQC_I05_PRDCTD
	 * (a Group object) - creates it if necessary
	 * throws HL7Exception if the repetition requested is more than one 
	 *     greater than the number of existing repetitions.
	 */
	public RQC_I05_PRDCTD getPRDCTD(int rep) throws HL7Exception { 
	   return (RQC_I05_PRDCTD)this.get("PRDCTD", rep);
	}

	/** 
	 * Returns the number of existing repetitions of RQC_I05_PRDCTD 
	 */ 
