...
/**
 * <p>Represents the ORU_R01_PV1PV2 Group.  A Group is an ordered collection of message 
...
public class ORU_R01_PV1PV2 extends AbstractGroup {
	...
	public ORU_R01_PV1PV2(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating ORU_R01_PV1PV2 - this is probably a bug in the source code generator.", e);
	   }
	}
