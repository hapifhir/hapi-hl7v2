...
public class PR1 extends AbstractSegment  {
  ...
  public PR1(Group parent, ModelClassFactory factory) {
    ...
    try {
       ...
       this.add(IS.class, false, 1, 2, new Object[]{message, new Integer(89)});
       ...
       this.add(IS.class, true, 1, 2, new Object[]{message, new Integer(230)});
       ...
       this.add(NM.class, false, 1, 4, new Object[]{message});
       this.add(XCN.class, false, 0, 120, new Object[]{message});
       this.add(XCN.class, false, 0, 230, new Object[]{message});
