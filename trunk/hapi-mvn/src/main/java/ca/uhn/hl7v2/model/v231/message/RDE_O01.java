...
public class RDE_O01 extends AbstractMessage  {
	...
	/**
	 * Returns RDE_O01_PIDPD1NTEPV1PV2IN1IN2IN3GT1AL1 (a Group object) - creates it if necessary
	 */
	...
	/**
	 * Returns  first repetition of RDE_O01_ORCRXONTERXRRXCNTERXERXRRXCOBXNTECTI (a Group object) - creates it if necessary
	 */
	...
	/**
	 * Returns a specific repetition of RDE_O01_ORCRXONTERXRRXCNTERXERXRRXCOBXNTECTI
	 * (a Group object) - creates it if necessary
	 * throws HL7Exception if the repetition requested is more than one 
	 *     greater than the number of existing repetitions.
	 */
	public RDE_O01_ORCRXONTERXRRXCNTERXERXRRXCOBXNTECTI getORCRXONTERXRRXCNTERXERXRRXCOBXNTECTI(int rep) throws HL7Exception { 
	   return (RDE_O01_ORCRXONTERXRRXCNTERXERXRRXCOBXNTECTI)this.get("ORCRXONTERXRRXCNTERXERXRRXCOBXNTECTI", rep);
	}

	/** 
	 * Returns the number of existing repetitions of RDE_O01_ORCRXONTERXRRXCNTERXERXRRXCOBXNTECTI 
	 */ 
