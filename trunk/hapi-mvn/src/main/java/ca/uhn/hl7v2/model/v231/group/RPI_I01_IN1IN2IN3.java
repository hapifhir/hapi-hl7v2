...
/**
 * <p>Represents the RPI_I01_IN1IN2IN3 Group.  A Group is an ordered collection of message 
...
public class RPI_I01_IN1IN2IN3 extends AbstractGroup {
	...
	public RPI_I01_IN1IN2IN3(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RPI_I01_IN1IN2IN3 - this is probably a bug in the source code generator.", e);
	   }
	}
