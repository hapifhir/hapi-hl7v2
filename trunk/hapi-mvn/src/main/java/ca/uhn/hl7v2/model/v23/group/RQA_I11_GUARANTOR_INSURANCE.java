...
public class RQA_I11_GUARANTOR_INSURANCE extends AbstractGroup {
	...
	public RQA_I11_GUARANTOR_INSURANCE(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(RQA_I11_INSURANCE.class, true, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RQA_I11_GUARANTOR_INSURANCE - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public RQA_I11_INSURANCE getINSURANCE() { 
	   ...
	   try {
	      ret = (RQA_I11_INSURANCE)this.get("INSURANCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public RQA_I11_INSURANCE getINSURANCE(int rep) throws HL7Exception { 
	   return (RQA_I11_INSURANCE)this.get("INSURANCE", rep);
	}
