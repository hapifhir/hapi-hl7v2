...
/**
 * <p>Represents the RDO_O01_RXCNTE Group.  A Group is an ordered collection of message 
...
public class RDO_O01_RXCNTE extends AbstractGroup {
	...
	public RDO_O01_RXCNTE(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RDO_O01_RXCNTE - this is probably a bug in the source code generator.", e);
	   }
	}
