...
/**
 * <p>Represents a ADT_A46 message structure (see chapter ?). This structure contains the 
...
public class ADT_A46 extends AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating ADT_A46 - this is probably a bug in the source code generator.", e);
	   }
	}
