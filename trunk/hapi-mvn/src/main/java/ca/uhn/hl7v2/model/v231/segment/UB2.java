...
public class UB2 extends AbstractSegment  {
  ...
  public UB2(Group parent, ModelClassFactory factory) {
    ...
    try {
       ...
       this.add(IS.class, false, 7, 2, new Object[]{message, new Integer(43)});
       this.add(ST.class, false, 1, 3, new Object[]{message});
       this.add(ST.class, false, 1, 4, new Object[]{message});
       this.add(UVC.class, false, 12, 11, new Object[]{message});
       this.add(OCD.class, false, 8, 11, new Object[]{message});
       this.add(OSP.class, false, 2, 28, new Object[]{message});
