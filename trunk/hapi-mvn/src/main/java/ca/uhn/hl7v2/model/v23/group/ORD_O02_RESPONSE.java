...
public class ORD_O02_RESPONSE extends AbstractGroup {
	...
	public ORD_O02_RESPONSE(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      this.add(ORD_O02_PATIENT.class, false, false);
	      this.add(ORD_O02_ORDER_DIET.class, true, true);
	      this.add(ORD_O02_ORDER_TRAY.class, false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating ORD_O02_RESPONSE - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public ORD_O02_PATIENT getPATIENT() { 
	   ...
	   try {
	      ret = (ORD_O02_PATIENT)this.get("PATIENT");
	   } catch(HL7Exception e) {
	...
	public ORD_O02_ORDER_DIET getORDER_DIET() { 
	   ...
	   try {
	      ret = (ORD_O02_ORDER_DIET)this.get("ORDER_DIET");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 */
	public ORD_O02_ORDER_DIET getORDER_DIET(int rep) throws HL7Exception { 
	   return (ORD_O02_ORDER_DIET)this.get("ORDER_DIET", rep);
	}
	...
	public ORD_O02_ORDER_TRAY getORDER_TRAY() { 
	   ...
	   try {
	      ret = (ORD_O02_ORDER_TRAY)this.get("ORDER_TRAY");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public ORD_O02_ORDER_TRAY getORDER_TRAY(int rep) throws HL7Exception { 
	   return (ORD_O02_ORDER_TRAY)this.get("ORDER_TRAY", rep);
	}
