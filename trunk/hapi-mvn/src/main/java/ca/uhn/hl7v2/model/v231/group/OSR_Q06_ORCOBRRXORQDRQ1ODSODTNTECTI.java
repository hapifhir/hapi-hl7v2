...
/**
 * <p>Represents the OSR_Q06_ORCOBRRXORQDRQ1ODSODTNTECTI Group.  A Group is an ordered collection of message 
...
public class OSR_Q06_ORCOBRRXORQDRQ1ODSODTNTECTI extends AbstractGroup {
	...
	public OSR_Q06_ORCOBRRXORQDRQ1ODSODTNTECTI(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating OSR_Q06_ORCOBRRXORQDRQ1ODSODTNTECTI - this is probably a bug in the source code generator.", e);
	   }
	}
