...
/**
 * <p>Represents the ORL_O34_ORDER_SPECIMEN Group.  A Group is an ordered collection of message 
 * segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements: </p>
 * 0: SPM (Specimen) <b></b><br>
 * 1: SAC (Specimen Container detail) <b>optional repeating</b><br>
 */
public class ORL_O34_ORDER_SPECIMEN extends AbstractGroup {

	/** 
	 * Creates a new ORL_O34_ORDER_SPECIMEN Group.
	 */
	public ORL_O34_ORDER_SPECIMEN(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating ORL_O34_ORDER_SPECIMEN - this is probably a bug in the source code generator.", e);
	   }
	}
