...
public class PCR extends AbstractSegment  {
  ...
  public PCR(Group parent, ModelClassFactory factory) {
    ...
    try {
       ...
       this.add(ST.class, false, 0, 30, new Object[]{message});
       ...
       this.add(ID.class, false, 1, 1, new Object[]{message, new Integer(250)});
       this.add(ID.class, false, 0, 2, new Object[]{message, new Integer(251)});
       this.add(ID.class, false, 0, 2, new Object[]{message, new Integer(252)});
       this.add(ID.class, false, 0, 1, new Object[]{message, new Integer(253)});
