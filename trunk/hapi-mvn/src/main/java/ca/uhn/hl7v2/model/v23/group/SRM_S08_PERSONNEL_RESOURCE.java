...
public class SRM_S08_PERSONNEL_RESOURCE extends AbstractGroup {
	...
	public SRM_S08_PERSONNEL_RESOURCE(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating SRM_S08_PERSONNEL_RESOURCE - this is probably a bug in the source code generator.", e);
	   }
	}
