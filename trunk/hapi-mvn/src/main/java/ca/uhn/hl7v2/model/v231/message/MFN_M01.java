...
/**
 * <p>Represents a MFN_M01 message structure (see chapter null). This structure contains the 
...
public class MFN_M01 extends AbstractMessage  {
	...
	/**
	 * Returns  first repetition of MFN_M01_MFEZxx (a Group object) - creates it if necessary
	 */
	public MFN_M01_MFEZxx getMFEZxx() { 
	   MFN_M01_MFEZxx ret = null;
	   try {
	      ret = (MFN_M01_MFEZxx)this.get("MFEZxx");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 */
	public MFN_M01_MFEZxx getMFEZxx(int rep) throws HL7Exception { 
	   return (MFN_M01_MFEZxx)this.get("MFEZxx", rep);
	}

	/** 
	 * Returns the number of existing repetitions of MFN_M01_MFEZxx 
	 */ 
