...
public class ADT_A04 extends AbstractMessage  {
	...
	public ADT_A04_PROCEDURE getPROCEDURE() { 
	   ...
	   try {
	      ret = (ADT_A04_PROCEDURE)this.get("PROCEDURE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public ADT_A04_PROCEDURE getPROCEDURE(int rep) throws HL7Exception { 
	   return (ADT_A04_PROCEDURE)this.get("PROCEDURE", rep);
	}
	...
	public ADT_A04_INSURANCE getINSURANCE() { 
	   ...
	   try {
	      ret = (ADT_A04_INSURANCE)this.get("INSURANCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public ADT_A04_INSURANCE getINSURANCE(int rep) throws HL7Exception { 
	   return (ADT_A04_INSURANCE)this.get("INSURANCE", rep);
	}
