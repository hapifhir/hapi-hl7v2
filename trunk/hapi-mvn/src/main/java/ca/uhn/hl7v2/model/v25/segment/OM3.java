...
public class OM3 extends AbstractSegment  {
   ...
   * @throws HL7Exception if the repetition number is invalid.
   */
  public CE getAbnormalTextCodesForCategoricalObservations(int rep) throws HL7Exception {
    CE ret = null;
    try {
   ...
   * @throws HL7Exception if the repetition number is invalid.
   */
  public CE getCriticalTextCodesForCategoricalObservations(int rep) throws HL7Exception {
    CE ret = null;
    try {
