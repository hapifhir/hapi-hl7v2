...
/**
 * <p>Represents the RGV_O01_RXCNTE Group.  A Group is an ordered collection of message 
...
public class RGV_O01_RXCNTE extends AbstractGroup {
	...
	public RGV_O01_RXCNTE(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RGV_O01_RXCNTE - this is probably a bug in the source code generator.", e);
	   }
	}
