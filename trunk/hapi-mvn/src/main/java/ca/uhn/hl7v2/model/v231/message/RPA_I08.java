...
/**
 * <p>Represents a RPA_I08 message structure (see chapter null). This structure contains the 
...
public class RPA_I08 extends AbstractMessage  {
	...
	/**
	 * Returns  first repetition of RPA_I08_PRDCTD (a Group object) - creates it if necessary
	 */
	public RPA_I08_PRDCTD getPRDCTD() { 
	   RPA_I08_PRDCTD ret = null;
	   try {
	      ret = (RPA_I08_PRDCTD)this.get("PRDCTD");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	...
	/**
	 * Returns a specific repetition of RPA_I08_PRDCTD
	 * (a Group object) - creates it if necessary
	 * throws HL7Exception if the repetition requested is more than one 
	 *     greater than the number of existing repetitions.
	 */
	public RPA_I08_PRDCTD getPRDCTD(int rep) throws HL7Exception { 
	   return (RPA_I08_PRDCTD)this.get("PRDCTD", rep);
	}

	/** 
	 * Returns the number of existing repetitions of RPA_I08_PRDCTD 
	 */ 
	...
	/**
	 * Returns  first repetition of RPA_I08_IN1IN2IN3 (a Group object) - creates it if necessary
	 */
	public RPA_I08_IN1IN2IN3 getIN1IN2IN3() { 
	   RPA_I08_IN1IN2IN3 ret = null;
	   try {
	      ret = (RPA_I08_IN1IN2IN3)this.get("IN1IN2IN3");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	...
	/**
	 * Returns a specific repetition of RPA_I08_IN1IN2IN3
	 * (a Group object) - creates it if necessary
	 * throws HL7Exception if the repetition requested is more than one 
	 *     greater than the number of existing repetitions.
	 */
	public RPA_I08_IN1IN2IN3 getIN1IN2IN3(int rep) throws HL7Exception { 
	   return (RPA_I08_IN1IN2IN3)this.get("IN1IN2IN3", rep);
	}

	/** 
	 * Returns the number of existing repetitions of RPA_I08_IN1IN2IN3 
	 */ 
	...
	/**
	 * Returns  first repetition of RPA_I08_PR1AUTCTD (a Group object) - creates it if necessary
	 */
	public RPA_I08_PR1AUTCTD getPR1AUTCTD() { 
	   RPA_I08_PR1AUTCTD ret = null;
	   try {
	      ret = (RPA_I08_PR1AUTCTD)this.get("PR1AUTCTD");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	...
	/**
	 * Returns a specific repetition of RPA_I08_PR1AUTCTD
	 * (a Group object) - creates it if necessary
	 * throws HL7Exception if the repetition requested is more than one 
	 *     greater than the number of existing repetitions.
	 */
	public RPA_I08_PR1AUTCTD getPR1AUTCTD(int rep) throws HL7Exception { 
	   return (RPA_I08_PR1AUTCTD)this.get("PR1AUTCTD", rep);
	}

	/** 
	 * Returns the number of existing repetitions of RPA_I08_PR1AUTCTD 
	 */ 
	...
	/**
	 * Returns  first repetition of RPA_I08_OBRNTEOBXNTE (a Group object) - creates it if necessary
	 */
	public RPA_I08_OBRNTEOBXNTE getOBRNTEOBXNTE() { 
	   RPA_I08_OBRNTEOBXNTE ret = null;
	   try {
	      ret = (RPA_I08_OBRNTEOBXNTE)this.get("OBRNTEOBXNTE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	...
	/**
	 * Returns a specific repetition of RPA_I08_OBRNTEOBXNTE
	 * (a Group object) - creates it if necessary
	 * throws HL7Exception if the repetition requested is more than one 
	 *     greater than the number of existing repetitions.
	 */
	public RPA_I08_OBRNTEOBXNTE getOBRNTEOBXNTE(int rep) throws HL7Exception { 
	   return (RPA_I08_OBRNTEOBXNTE)this.get("OBRNTEOBXNTE", rep);
	}

	/** 
	 * Returns the number of existing repetitions of RPA_I08_OBRNTEOBXNTE 
	 */ 
	...
	/**
	 * Returns RPA_I08_PV1PV2 (a Group object) - creates it if necessary
	 */
	public RPA_I08_PV1PV2 getPV1PV2() { 
	   RPA_I08_PV1PV2 ret = null;
	   try {
	      ret = (RPA_I08_PV1PV2)this.get("PV1PV2");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
