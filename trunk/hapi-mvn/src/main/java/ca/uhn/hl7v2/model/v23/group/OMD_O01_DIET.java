...
public class OMD_O01_DIET extends AbstractGroup {
	...
	public OMD_O01_DIET(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(OMD_O01_OBSERVATION.class, true, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating OMD_O01_DIET - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public OMD_O01_OBSERVATION getOBSERVATION() { 
	   ...
	   try {
	      ret = (OMD_O01_OBSERVATION)this.get("OBSERVATION");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public OMD_O01_OBSERVATION getOBSERVATION(int rep) throws HL7Exception { 
	   return (OMD_O01_OBSERVATION)this.get("OBSERVATION", rep);
	}
