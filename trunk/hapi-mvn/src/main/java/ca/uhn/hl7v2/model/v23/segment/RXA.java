...
public class RXA extends AbstractSegment  {
  ...
  public RXA(Group parent, ModelClassFactory factory) {
    ...
    try {
       this.add(ID.class, true, 1, 4, new Object[]{message, new Integer(0)});
       ...
       this.add(XCN.class, false, 1, 200, new Object[]{message});
       this.add(CM_LA1.class, false, 1, 200, new Object[]{message});
   ...
   * @throws HL7Exception if the repetition number is invalid.
   */
  public CE getSubstanceRefusalReason(int rep) throws HL7Exception {
    CE ret = null;
    try {
