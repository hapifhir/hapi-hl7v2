...
public class OMD_O01 extends AbstractMessage  {
	...
	public OMD_O01_PATIENT getPATIENT() { 
	   ...
	   try {
	      ret = (OMD_O01_PATIENT)this.get("PATIENT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	...
	public OMD_O01_ORDER_DIET getORDER_DIET() { 
	   ...
	   try {
	      ret = (OMD_O01_ORDER_DIET)this.get("ORDER_DIET");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public OMD_O01_ORDER_DIET getORDER_DIET(int rep) throws HL7Exception { 
	   return (OMD_O01_ORDER_DIET)this.get("ORDER_DIET", rep);
	}
	...
	public OMD_O01_ORDER_TRAY getORDER_TRAY() { 
	   ...
	   try {
	      ret = (OMD_O01_ORDER_TRAY)this.get("ORDER_TRAY");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public OMD_O01_ORDER_TRAY getORDER_TRAY(int rep) throws HL7Exception { 
	   return (OMD_O01_ORDER_TRAY)this.get("ORDER_TRAY", rep);
	}
