...
public class CSU_C10 extends AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating CSU_C10 - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public CSU_C10_PATIENT getPATIENT() { 
	   ...
	   try {
	      ret = (CSU_C10_PATIENT)this.get("PATIENT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 */
	public CSU_C10_PATIENT getPATIENT(int rep) throws HL7Exception { 
	   return (CSU_C10_PATIENT)this.get("PATIENT", rep);
	}
