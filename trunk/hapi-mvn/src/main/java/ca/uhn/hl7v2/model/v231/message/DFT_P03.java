...
public class DFT_P03 extends AbstractMessage  {
	...
	/**
	 * Returns  first repetition of DFT_P03_FT1PR1ROL (a Group object) - creates it if necessary
	 */
	public DFT_P03_FT1PR1ROL getFT1PR1ROL() { 
	   DFT_P03_FT1PR1ROL ret = null;
	   try {
	      ret = (DFT_P03_FT1PR1ROL)this.get("FT1PR1ROL");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	...
	/**
	 * Returns a specific repetition of DFT_P03_FT1PR1ROL
	 * (a Group object) - creates it if necessary
	 * throws HL7Exception if the repetition requested is more than one 
	 *     greater than the number of existing repetitions.
	 */
	public DFT_P03_FT1PR1ROL getFT1PR1ROL(int rep) throws HL7Exception { 
	   return (DFT_P03_FT1PR1ROL)this.get("FT1PR1ROL", rep);
	}

	/** 
	 * Returns the number of existing repetitions of DFT_P03_FT1PR1ROL 
	 */ 
	...
	/**
	 * Returns  first repetition of DFT_P03_IN1IN2IN3 (a Group object) - creates it if necessary
	 */
	public DFT_P03_IN1IN2IN3 getIN1IN2IN3() { 
	   DFT_P03_IN1IN2IN3 ret = null;
	   try {
	      ret = (DFT_P03_IN1IN2IN3)this.get("IN1IN2IN3");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	...
	/**
	 * Returns a specific repetition of DFT_P03_IN1IN2IN3
	 * (a Group object) - creates it if necessary
	 * throws HL7Exception if the repetition requested is more than one 
	 *     greater than the number of existing repetitions.
	 */
	public DFT_P03_IN1IN2IN3 getIN1IN2IN3(int rep) throws HL7Exception { 
	   return (DFT_P03_IN1IN2IN3)this.get("IN1IN2IN3", rep);
	}

	/** 
	 * Returns the number of existing repetitions of DFT_P03_IN1IN2IN3 
	 */ 
