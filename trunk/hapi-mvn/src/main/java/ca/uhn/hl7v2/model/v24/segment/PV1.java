...
public class PV1 extends AbstractSegment  {
  ...
  public PV1(Group parent, ModelClassFactory factory) {
    ...
    try {
       ...
       this.add(IS.class, true, 1, 1, new Object[]{message, new Integer(4)});
       this.add(PL.class, false, 1, 80, new Object[]{message});
       this.add(IS.class, false, 1, 2, new Object[]{message, new Integer(7)});
       this.add(CX.class, false, 1, 250, new Object[]{message});
       this.add(PL.class, false, 1, 80, new Object[]{message});
       this.add(XCN.class, false, 0, 250, new Object[]{message});
       this.add(XCN.class, false, 0, 250, new Object[]{message});
       this.add(XCN.class, false, 0, 250, new Object[]{message});
       this.add(IS.class, false, 1, 3, new Object[]{message, new Integer(69)});
       this.add(PL.class, false, 1, 80, new Object[]{message});
       this.add(IS.class, false, 1, 2, new Object[]{message, new Integer(87)});
       this.add(IS.class, false, 1, 2, new Object[]{message, new Integer(92)});
       this.add(IS.class, false, 1, 6, new Object[]{message, new Integer(23)});
       ...
       this.add(IS.class, false, 1, 2, new Object[]{message, new Integer(32)});
       this.add(IS.class, false, 1, 2, new Object[]{message, new Integer(45)});
       this.add(IS.class, false, 1, 2, new Object[]{message, new Integer(46)});
       this.add(IS.class, false, 0, 2, new Object[]{message, new Integer(44)});
       ...
       this.add(IS.class, false, 1, 2, new Object[]{message, new Integer(73)});
       this.add(IS.class, false, 1, 1, new Object[]{message, new Integer(110)});
       this.add(DT.class, false, 1, 8, new Object[]{message});
       this.add(IS.class, false, 1, 10, new Object[]{message, new Integer(21)});
       this.add(NM.class, false, 1, 12, new Object[]{message});
       this.add(NM.class, false, 1, 12, new Object[]{message});
       this.add(IS.class, false, 1, 1, new Object[]{message, new Integer(111)});
       this.add(DT.class, false, 1, 8, new Object[]{message});
       this.add(IS.class, false, 1, 3, new Object[]{message, new Integer(112)});
       this.add(DLD.class, false, 1, 25, new Object[]{message});
       this.add(CE.class, false, 1, 250, new Object[]{message});
       this.add(IS.class, false, 1, 2, new Object[]{message, new Integer(115)});
       this.add(IS.class, false, 1, 1, new Object[]{message, new Integer(116)});
       this.add(IS.class, false, 1, 2, new Object[]{message, new Integer(117)});
       this.add(PL.class, false, 1, 80, new Object[]{message});
       this.add(PL.class, false, 1, 80, new Object[]{message});
   ...
   * @throws HL7Exception if the repetition number is invalid.
   */
  public TS getDischargeDateTime(int rep) throws HL7Exception {
    TS ret = null;
    try {
