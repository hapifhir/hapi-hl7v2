...
public class PEX_P08_EXPERIENCE extends AbstractGroup {
	...
	public PEX_P08_EXPERIENCE(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(PEX_P08_PEX_OBSERVATION.class, true, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating PEX_P08_EXPERIENCE - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public PEX_P08_PEX_OBSERVATION getPEX_OBSERVATION() { 
	   ...
	   try {
	      ret = (PEX_P08_PEX_OBSERVATION)this.get("PEX_OBSERVATION");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 */
	public PEX_P08_PEX_OBSERVATION getPEX_OBSERVATION(int rep) throws HL7Exception { 
	   return (PEX_P08_PEX_OBSERVATION)this.get("PEX_OBSERVATION", rep);
	}
