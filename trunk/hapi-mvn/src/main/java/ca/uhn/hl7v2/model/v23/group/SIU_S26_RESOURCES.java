...
public class SIU_S26_RESOURCES extends AbstractGroup {
	...
	public SIU_S26_RESOURCES(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(SIU_S26_SERVICE.class, false, true);
	      this.add(SIU_S26_GENERAL_RESOURCE.class, false, true);
	      this.add(SIU_S26_LOCATION_RESOURCE.class, false, true);
	      this.add(SIU_S26_PERSONNEL_RESOURCE.class, false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating SIU_S26_RESOURCES - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public SIU_S26_SERVICE getSERVICE() { 
	   ...
	   try {
	      ret = (SIU_S26_SERVICE)this.get("SERVICE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 */
	public SIU_S26_SERVICE getSERVICE(int rep) throws HL7Exception { 
	   return (SIU_S26_SERVICE)this.get("SERVICE", rep);
	}
	...
	public SIU_S26_GENERAL_RESOURCE getGENERAL_RESOURCE() { 
	   ...
	   try {
	      ret = (SIU_S26_GENERAL_RESOURCE)this.get("GENERAL_RESOURCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public SIU_S26_GENERAL_RESOURCE getGENERAL_RESOURCE(int rep) throws HL7Exception { 
	   return (SIU_S26_GENERAL_RESOURCE)this.get("GENERAL_RESOURCE", rep);
	}
	...
	public SIU_S26_LOCATION_RESOURCE getLOCATION_RESOURCE() { 
	   ...
	   try {
	      ret = (SIU_S26_LOCATION_RESOURCE)this.get("LOCATION_RESOURCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public SIU_S26_LOCATION_RESOURCE getLOCATION_RESOURCE(int rep) throws HL7Exception { 
	   return (SIU_S26_LOCATION_RESOURCE)this.get("LOCATION_RESOURCE", rep);
	}
	...
	public SIU_S26_PERSONNEL_RESOURCE getPERSONNEL_RESOURCE() { 
	   ...
	   try {
	      ret = (SIU_S26_PERSONNEL_RESOURCE)this.get("PERSONNEL_RESOURCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public SIU_S26_PERSONNEL_RESOURCE getPERSONNEL_RESOURCE(int rep) throws HL7Exception { 
	   return (SIU_S26_PERSONNEL_RESOURCE)this.get("PERSONNEL_RESOURCE", rep);
	}
