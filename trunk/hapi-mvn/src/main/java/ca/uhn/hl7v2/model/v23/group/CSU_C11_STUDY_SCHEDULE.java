...
public class CSU_C11_STUDY_SCHEDULE extends AbstractGroup {
	...
	public CSU_C11_STUDY_SCHEDULE(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating CSU_C11_STUDY_SCHEDULE - this is probably a bug in the source code generator.", e);
	   }
	}
	 ...
	 */
	public CSU_C11_STUDY_OBSERVATION getSTUDY_OBSERVATION(int rep) throws HL7Exception { 
	   return (CSU_C11_STUDY_OBSERVATION)this.get("STUDY_OBSERVATION", rep);
	}
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public CSU_C11_STUDY_PHARM getSTUDY_PHARM(int rep) throws HL7Exception { 
	   return (CSU_C11_STUDY_PHARM)this.get("STUDY_PHARM", rep);
	}
