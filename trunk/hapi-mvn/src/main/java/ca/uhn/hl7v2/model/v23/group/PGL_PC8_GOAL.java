...
public class PGL_PC8_GOAL extends AbstractGroup {
	...
	public PGL_PC8_GOAL(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(PGL_PC8_GOAL_ROLE.class, false, true);
	      this.add(PGL_PC8_PATHWAY.class, false, true);
	      this.add(PGL_PC8_OBSERVATION.class, false, true);
	      this.add(PGL_PC8_PROBLEM.class, false, true);
	      this.add(PGL_PC8_ORDER.class, false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating PGL_PC8_GOAL - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public PGL_PC8_GOAL_ROLE getGOAL_ROLE() { 
	   ...
	   try {
	      ret = (PGL_PC8_GOAL_ROLE)this.get("GOAL_ROLE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public PGL_PC8_GOAL_ROLE getGOAL_ROLE(int rep) throws HL7Exception { 
	   return (PGL_PC8_GOAL_ROLE)this.get("GOAL_ROLE", rep);
	}
	...
	public PGL_PC8_PATHWAY getPATHWAY() { 
	   ...
	   try {
	      ret = (PGL_PC8_PATHWAY)this.get("PATHWAY");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public PGL_PC8_PATHWAY getPATHWAY(int rep) throws HL7Exception { 
	   return (PGL_PC8_PATHWAY)this.get("PATHWAY", rep);
	}
	...
	public PGL_PC8_OBSERVATION getOBSERVATION() { 
	   ...
	   try {
	      ret = (PGL_PC8_OBSERVATION)this.get("OBSERVATION");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public PGL_PC8_OBSERVATION getOBSERVATION(int rep) throws HL7Exception { 
	   return (PGL_PC8_OBSERVATION)this.get("OBSERVATION", rep);
	}
	...
	public PGL_PC8_PROBLEM getPROBLEM() { 
	   ...
	   try {
	      ret = (PGL_PC8_PROBLEM)this.get("PROBLEM");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public PGL_PC8_PROBLEM getPROBLEM(int rep) throws HL7Exception { 
	   return (PGL_PC8_PROBLEM)this.get("PROBLEM", rep);
	}
	...
	public PGL_PC8_ORDER getORDER() { 
	   ...
	   try {
	      ret = (PGL_PC8_ORDER)this.get("ORDER");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public PGL_PC8_ORDER getORDER(int rep) throws HL7Exception { 
	   return (PGL_PC8_ORDER)this.get("ORDER", rep);
	}
