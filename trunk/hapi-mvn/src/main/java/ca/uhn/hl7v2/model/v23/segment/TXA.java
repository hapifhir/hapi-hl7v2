...
public class TXA extends AbstractSegment  {
  ...
  public TXA(Group parent, ModelClassFactory factory) {
    ...
    try {
       ...
       this.add(ID.class, true, 0, 2, new Object[]{message, new Integer(271)});
       ...
       this.add(ST.class, false, 1, 30, new Object[]{message});
       this.add(PPN.class, false, 0, 60, new Object[]{message});
       this.add(XCN.class, false, 0, 60, new Object[]{message});
   ...
   * @throws HL7Exception if the repetition number is invalid.
   */
  public ID getDocumentCompletionStatus(int rep) throws HL7Exception {
    ID ret = null;
    try {
