...
public class CSU_C12_STUDY_OBSERVATION extends AbstractGroup {
	...
	public CSU_C12_STUDY_OBSERVATION(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating CSU_C12_STUDY_OBSERVATION - this is probably a bug in the source code generator.", e);
	   }
	}
