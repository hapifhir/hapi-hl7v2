...
public class OMS_O01 extends AbstractMessage  {
	...
	/**
	 * Returns OMS_O01_PIDPD1NTEPV1PV2IN1IN2IN3GT1AL1 (a Group object) - creates it if necessary
	 */
	...
	/**
	 * Returns  first repetition of OMS_O01_ORCRQDNTEOBXNTEBLG (a Group object) - creates it if necessary
	 */
	...
	/**
	 * Returns a specific repetition of OMS_O01_ORCRQDNTEOBXNTEBLG
	 * (a Group object) - creates it if necessary
	 * throws HL7Exception if the repetition requested is more than one 
	 *     greater than the number of existing repetitions.
	 */
	public OMS_O01_ORCRQDNTEOBXNTEBLG getORCRQDNTEOBXNTEBLG(int rep) throws HL7Exception { 
	   return (OMS_O01_ORCRQDNTEOBXNTEBLG)this.get("ORCRQDNTEOBXNTEBLG", rep);
	}

	/** 
	 * Returns the number of existing repetitions of OMS_O01_ORCRQDNTEOBXNTEBLG 
	 */ 
