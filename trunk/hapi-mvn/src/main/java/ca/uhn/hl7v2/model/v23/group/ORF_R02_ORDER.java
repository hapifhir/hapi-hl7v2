...
public class ORF_R02_ORDER extends AbstractGroup {
	...
	public ORF_R02_ORDER(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(ORF_R02_OBSERVATION.class, true, true);
	      this.add(CTI.class, false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating ORF_R02_ORDER - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public ORF_R02_OBSERVATION getOBSERVATION() { 
	   ...
	   try {
	      ret = (ORF_R02_OBSERVATION)this.get("OBSERVATION");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public ORF_R02_OBSERVATION getOBSERVATION(int rep) throws HL7Exception { 
	   return (ORF_R02_OBSERVATION)this.get("OBSERVATION", rep);
	}
