...
/**
 * <p>Represents the RDR_RDR_RXERXRRXC Group.  A Group is an ordered collection of message 
...
public class RDR_RDR_RXERXRRXC extends AbstractGroup {
	...
	public RDR_RDR_RXERXRRXC(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RDR_RDR_RXERXRRXC - this is probably a bug in the source code generator.", e);
	   }
	}
