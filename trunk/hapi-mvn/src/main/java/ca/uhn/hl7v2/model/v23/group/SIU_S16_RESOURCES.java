...
public class SIU_S16_RESOURCES extends AbstractGroup {
	 ...
	 */
	public SIU_S16_SERVICE getSERVICE(int rep) throws HL7Exception { 
	   return (SIU_S16_SERVICE)this.get("SERVICE", rep);
	}
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public SIU_S16_GENERAL_RESOURCE getGENERAL_RESOURCE(int rep) throws HL7Exception { 
	   return (SIU_S16_GENERAL_RESOURCE)this.get("GENERAL_RESOURCE", rep);
	}
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public SIU_S16_LOCATIONL_RESOURCE getLOCATIONL_RESOURCE(int rep) throws HL7Exception { 
	   return (SIU_S16_LOCATIONL_RESOURCE)this.get("LOCATIONL_RESOURCE", rep);
	}
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public SIU_S16_PERSONNEL_RESOURCE getPERSONNEL_RESOURCE(int rep) throws HL7Exception { 
	   return (SIU_S16_PERSONNEL_RESOURCE)this.get("PERSONNEL_RESOURCE", rep);
	}
