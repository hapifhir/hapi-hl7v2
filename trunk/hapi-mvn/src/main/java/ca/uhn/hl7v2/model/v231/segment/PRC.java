...
public class PRC extends AbstractSegment  {
  ...
  public PRC(Group parent, ModelClassFactory factory) {
    ...
    try {
       ...
       this.add(TS.class, false, 1, 26, new Object[]{message});
       this.add(IS.class, false, 1, 1, new Object[]{message, new Integer(268)});
       this.add(CE.class, false, 0, 60, new Object[]{message});
       ...
       this.add(MO.class, false, 1, 12, new Object[]{message});
       this.add(IS.class, false, 1, 1, new Object[]{message, new Integer(269)});
   ...
   */
  public CE getFacilityIDPRC(int rep) throws HL7Exception {
    CE ret = null;
    try {
