...
public class PPP_PCD_PROBLEM extends AbstractGroup {
	...
	public PPP_PCD_PROBLEM(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(PPP_PCD_PROBLEM_ROLE.class, false, true);
	      this.add(PPP_PCD_PROBLEM_OBSERVATION.class, false, true);
	      this.add(PPP_PCD_GOAL.class, false, true);
	      this.add(PPP_PCD_ORDER.class, false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating PPP_PCD_PROBLEM - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public PPP_PCD_PROBLEM_ROLE getPROBLEM_ROLE() { 
	   ...
	   try {
	      ret = (PPP_PCD_PROBLEM_ROLE)this.get("PROBLEM_ROLE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public PPP_PCD_PROBLEM_ROLE getPROBLEM_ROLE(int rep) throws HL7Exception { 
	   return (PPP_PCD_PROBLEM_ROLE)this.get("PROBLEM_ROLE", rep);
	}
	...
	public PPP_PCD_PROBLEM_OBSERVATION getPROBLEM_OBSERVATION() { 
	   ...
	   try {
	      ret = (PPP_PCD_PROBLEM_OBSERVATION)this.get("PROBLEM_OBSERVATION");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public PPP_PCD_PROBLEM_OBSERVATION getPROBLEM_OBSERVATION(int rep) throws HL7Exception { 
	   return (PPP_PCD_PROBLEM_OBSERVATION)this.get("PROBLEM_OBSERVATION", rep);
	}
	...
	public PPP_PCD_GOAL getGOAL() { 
	   ...
	   try {
	      ret = (PPP_PCD_GOAL)this.get("GOAL");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public PPP_PCD_GOAL getGOAL(int rep) throws HL7Exception { 
	   return (PPP_PCD_GOAL)this.get("GOAL", rep);
	}
	...
	public PPP_PCD_ORDER getORDER() { 
	   ...
	   try {
	      ret = (PPP_PCD_ORDER)this.get("ORDER");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public PPP_PCD_ORDER getORDER(int rep) throws HL7Exception { 
	   return (PPP_PCD_ORDER)this.get("ORDER", rep);
	}
