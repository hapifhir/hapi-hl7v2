...
public class OM2 extends AbstractSegment  {
  ...
  public OM2(Group parent, ModelClassFactory factory) {
    ...
    try {
       ...
       this.add(RFR.class, false, 0, 250, new Object[]{message});
       this.add(RFR.class, false, 0, 205, new Object[]{message});
       this.add(RFR.class, false, 1, 250, new Object[]{message});
       this.add(DLT.class, false, 0, 250, new Object[]{message});
   ...
   * @throws HL7Exception if the repetition number is invalid.
   */
  public RFR getReferenceNormalRangeOrdinalAndContinuousObservations(int rep) throws HL7Exception {
    RFR ret = null;
    try {
