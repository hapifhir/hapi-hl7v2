...
public class ADT_A28 extends AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating ADT_A28 - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	/**
	 * Returns  first repetition of ADT_A28_PR1ROL (a Group object) - creates it if necessary
	 */
	public ADT_A28_PR1ROL getPR1ROL() { 
	   ADT_A28_PR1ROL ret = null;
	   try {
	      ret = (ADT_A28_PR1ROL)this.get("PR1ROL");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	...
	/**
	 * Returns a specific repetition of ADT_A28_PR1ROL
	 * (a Group object) - creates it if necessary
	 * throws HL7Exception if the repetition requested is more than one 
	 *     greater than the number of existing repetitions.
	 */
	public ADT_A28_PR1ROL getPR1ROL(int rep) throws HL7Exception { 
	   return (ADT_A28_PR1ROL)this.get("PR1ROL", rep);
	}

	/** 
	 * Returns the number of existing repetitions of ADT_A28_PR1ROL 
	 */ 
	...
	/**
	 * Returns  first repetition of ADT_A28_IN1IN2IN3 (a Group object) - creates it if necessary
	 */
	public ADT_A28_IN1IN2IN3 getIN1IN2IN3() { 
	   ADT_A28_IN1IN2IN3 ret = null;
	   try {
	      ret = (ADT_A28_IN1IN2IN3)this.get("IN1IN2IN3");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	...
	/**
	 * Returns a specific repetition of ADT_A28_IN1IN2IN3
	 * (a Group object) - creates it if necessary
	 * throws HL7Exception if the repetition requested is more than one 
	 *     greater than the number of existing repetitions.
	 */
	public ADT_A28_IN1IN2IN3 getIN1IN2IN3(int rep) throws HL7Exception { 
	   return (ADT_A28_IN1IN2IN3)this.get("IN1IN2IN3", rep);
	}

	/** 
	 * Returns the number of existing repetitions of ADT_A28_IN1IN2IN3 
	 */ 
