...
public class RQI_I03 extends AbstractMessage  {
	...
	public RQI_I03_PROVIDER getPROVIDER() { 
	   ...
	   try {
	      ret = (RQI_I03_PROVIDER)this.get("PROVIDER");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 */
	public RQI_I03_PROVIDER getPROVIDER(int rep) throws HL7Exception { 
	   return (RQI_I03_PROVIDER)this.get("PROVIDER", rep);
	}
	...
	public RQI_I03_GUARANTOR_INSURANCE getGUARANTOR_INSURANCE() { 
	   ...
	   try {
	      ret = (RQI_I03_GUARANTOR_INSURANCE)this.get("GUARANTOR_INSURANCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
