...
public class PEX_P08 extends AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating PEX_P08 - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public PEX_P08_VISIT getVISIT() { 
	   ...
	   try {
	      ret = (PEX_P08_VISIT)this.get("VISIT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	...
	public PEX_P08_EXPERIENCE getEXPERIENCE() { 
	   ...
	   try {
	      ret = (PEX_P08_EXPERIENCE)this.get("EXPERIENCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public PEX_P08_EXPERIENCE getEXPERIENCE(int rep) throws HL7Exception { 
	   return (PEX_P08_EXPERIENCE)this.get("EXPERIENCE", rep);
	}
