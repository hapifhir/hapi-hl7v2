...
public class OM1 extends AbstractSegment  {
  ...
  public OM1(Group parent, ModelClassFactory factory) {
    ...
    try {
       ...
       this.add(ID.class, false, 1, 1, new Object[]{message, new Integer(174)});
       this.add(CE.class, false, 1, 200, new Object[]{message});
       ...
       this.add(AD.class, false, 1, 1000, new Object[]{message});
       this.add(TN.class, false, 1, 400, new Object[]{message});
   ...
   * @throws HL7Exception if the repetition number is invalid.
   */
  public CE getIdentityOfInstrumentUsedToPerfromThisStudy(int rep) throws HL7Exception {
    CE ret = null;
    try {
