...
/**
 * <p>Represents the SRR_S01_PIDPV1PV2DG1 Group.  A Group is an ordered collection of message 
...
public class SRR_S01_PIDPV1PV2DG1 extends AbstractGroup {
	...
	public SRR_S01_PIDPV1PV2DG1(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating SRR_S01_PIDPV1PV2DG1 - this is probably a bug in the source code generator.", e);
	   }
	}
