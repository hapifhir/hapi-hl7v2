...
/**
 * <p>Represents the RCL_I06_PRDCTD Group.  A Group is an ordered collection of message 
 * segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements: </p>
 * 0: PRD (Provider Data) <b></b><br>
 * 1: CTD (Contact Data) <b>optional repeating</b><br>
 */
public class RCL_I06_PRDCTD extends AbstractGroup {

	/** 
	 * Creates a new RCL_I06_PRDCTD Group.
	 */
	public RCL_I06_PRDCTD(Group parent, ModelClassFactory factory) {
	   super(parent, factory);
	   try {
	      this.add(PRD.class, true, false);
	      this.add(CTD.class, false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RCL_I06_PRDCTD - this is probably a bug in the source code generator.", e);
	   }
	}
