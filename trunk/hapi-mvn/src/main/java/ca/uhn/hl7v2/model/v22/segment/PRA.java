...
public class PRA extends AbstractSegment  {
  ...
  public PRA(Group parent, ModelClassFactory factory) {
    ...
    try {
       ...
       this.add(ID.class, false, 0, 3, new Object[]{message, new Integer(186)});
       ...
       this.add(CM_PIP.class, false, 0, 20, new Object[]{message});
   ...
   * @throws HL7Exception if the repetition number is invalid.
   */
  public ID getPractitionerCategory(int rep) throws HL7Exception {
    ID ret = null;
    try {
