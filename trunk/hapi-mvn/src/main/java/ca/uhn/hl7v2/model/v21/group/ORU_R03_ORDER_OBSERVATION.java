...
public class ORU_R03_ORDER_OBSERVATION extends AbstractGroup {
	...
	public ORU_R03_ORDER_OBSERVATION(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating ORU_R03_ORDER_OBSERVATION - this is probably a bug in the source code generator.", e);
	   }
	}
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public ORU_R03_OBSERVATION getOBSERVATION(int rep) throws HL7Exception { 
	   return (ORU_R03_OBSERVATION)this.get("OBSERVATION", rep);
	}
