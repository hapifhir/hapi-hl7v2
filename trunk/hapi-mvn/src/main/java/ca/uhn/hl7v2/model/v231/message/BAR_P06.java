...
public class BAR_P06 extends AbstractMessage  {
	...
	/**
	 * Returns  first repetition of BAR_P06_PIDPV1 (a Group object) - creates it if necessary
	 */
	...
	/**
	 * Returns a specific repetition of BAR_P06_PIDPV1
	 * (a Group object) - creates it if necessary
	 * throws HL7Exception if the repetition requested is more than one 
	 *     greater than the number of existing repetitions.
	 */
	public BAR_P06_PIDPV1 getPIDPV1(int rep) throws HL7Exception { 
	   return (BAR_P06_PIDPV1)this.get("PIDPV1", rep);
	}

	/** 
	 * Returns the number of existing repetitions of BAR_P06_PIDPV1 
	 */ 
