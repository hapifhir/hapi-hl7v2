...
public class RPA_I10_RESULTS extends AbstractGroup {
	...
	public RPA_I10_RESULTS(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(RPA_I10_OBSERVATION.class, false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RPA_I10_RESULTS - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public RPA_I10_OBSERVATION getOBSERVATION() { 
	   ...
	   try {
	      ret = (RPA_I10_OBSERVATION)this.get("OBSERVATION");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public RPA_I10_OBSERVATION getOBSERVATION(int rep) throws HL7Exception { 
	   return (RPA_I10_OBSERVATION)this.get("OBSERVATION", rep);
	}
