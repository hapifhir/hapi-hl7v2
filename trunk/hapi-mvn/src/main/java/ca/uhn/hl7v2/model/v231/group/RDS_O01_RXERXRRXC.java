...
/**
 * <p>Represents the RDS_O01_RXERXRRXC Group.  A Group is an ordered collection of message 
 ...
 */
public class RDS_O01_RXERXRRXC extends AbstractGroup {

	/** 
	 * Creates a new RDS_O01_RXERXRRXC Group.
	 */
	public RDS_O01_RXERXRRXC(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RDS_O01_RXERXRRXC - this is probably a bug in the source code generator.", e);
	   }
	}
