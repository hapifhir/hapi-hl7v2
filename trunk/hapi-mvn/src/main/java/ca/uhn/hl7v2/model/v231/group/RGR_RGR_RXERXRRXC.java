...
/**
 * <p>Represents the RGR_RGR_RXERXRRXC Group.  A Group is an ordered collection of message 
 ...
 */
public class RGR_RGR_RXERXRRXC extends AbstractGroup {

	/** 
	 * Creates a new RGR_RGR_RXERXRRXC Group.
	 */
	public RGR_RGR_RXERXRRXC(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RGR_RGR_RXERXRRXC - this is probably a bug in the source code generator.", e);
	   }
	}
