...
/**
 * <p>Represents the ADT_A43_PIDPD1MRG Group.  A Group is an ordered collection of message 
...
public class ADT_A43_PIDPD1MRG extends AbstractGroup {
	...
	public ADT_A43_PIDPD1MRG(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating ADT_A43_PIDPD1MRG - this is probably a bug in the source code generator.", e);
	   }
	}
