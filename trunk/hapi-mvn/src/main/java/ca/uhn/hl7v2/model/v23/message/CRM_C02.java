...
public class CRM_C02 extends AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating CRM_C02 - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public CRM_C02_PATIENT getPATIENT() { 
	   ...
	   try {
	      ret = (CRM_C02_PATIENT)this.get("PATIENT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 */
	public CRM_C02_PATIENT getPATIENT(int rep) throws HL7Exception { 
	   return (CRM_C02_PATIENT)this.get("PATIENT", rep);
	}
