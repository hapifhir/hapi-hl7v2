...
public class OMN_O01 extends AbstractMessage  {
	...
	public OMN_O01_PATIENT getPATIENT() { 
	   ...
	   try {
	      ret = (OMN_O01_PATIENT)this.get("PATIENT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	...
	public OMN_O01_ORDER getORDER() { 
	   ...
	   try {
	      ret = (OMN_O01_ORDER)this.get("ORDER");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public OMN_O01_ORDER getORDER(int rep) throws HL7Exception { 
	   return (OMN_O01_ORDER)this.get("ORDER", rep);
	}
