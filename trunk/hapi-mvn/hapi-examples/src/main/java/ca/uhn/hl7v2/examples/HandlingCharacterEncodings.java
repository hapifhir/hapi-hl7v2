...
public class HandlingCharacterEncodings {
	...
	public static void main(String[] args) throws HL7Exception {
		...
		context.setLowerLayerProtocol(new MinLowerLayerProtocol()); // already the default
		SimpleServer s = context.getSimpleService(123, false);
		...
		s = context.getSimpleService(123, false);
		 ...
		 */
		ConnectionHub hub = context.getConnectionHub();
		 ...
		 * message which specified "8859/1", or ISO-8859-1 encoding, you have another option.
		 * 
		 * MSH|^~\&|4265-ADT|4265|eReferral|eReferral|201004141020||ADT^A45^ADT_A45|102416|T^|2.5^^||
		 * |NE|AL|CAN|8859/1 EVN|A45|201004141020|
		 * PID|1||7010226^^^4265^MR~0000000000^^^CANON^JHN^^^
		 * ^^^GP~1736465^^^4265^VN||Park^Green^^^MS.^^L||19890812|F|||123
		 * TestingLane^^TORONTO^CA-ON^
		 * M5G2C2^CAN^H^~^^^^^^^||^PRN^PH^^1^416^2525252^|^^^^^^^||||||||||||||||N
		 * PV1|1|I||||^^^WP^1469
		 * ^^^^^^^^|||||||||||^Derkach^Peter.^^^Dr.||20913000131||||||||||||||||
		 * |||||||||201004011340|201004141018
		 * 
		 * Another possibility (only available in HAPI 2.0+) is to read the value from MSH-18 and
		 ...
		 */
		context.setLowerLayerProtocol(new ExtendedMinLowerLayerProtocol());
		s = context.getSimpleService(123, false);
