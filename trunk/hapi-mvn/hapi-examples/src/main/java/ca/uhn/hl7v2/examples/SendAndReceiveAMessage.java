...
public class SendAndReceiveAMessage {
	...
	public static void main(String[] args) throws Exception {
		...
		SimpleServer server = context.getSimpleService(port, IS_TLS);
		...
		Connection connection = connectionHub.attach("localhost", port, IS_TLS);
		...
		/*
		 * Close the connection and server. Note that this method may close the connection. If you
		 * are designing a system which will continuously send out messages, you may want to
		 * consider keeping a copy of the Connection object between messages. That way, the same
		 * connection will be reused.
		 * 
		 * See http://hl7api.sourceforge.net/xref/ca/uhn/hl7v2/examples/SendLotsOfMessages.html for
		 * an example of this.
		 */
