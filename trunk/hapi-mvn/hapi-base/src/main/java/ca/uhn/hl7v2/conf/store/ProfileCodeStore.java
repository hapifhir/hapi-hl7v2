...
public class ProfileCodeStore extends AbstractCodeStore {
	...
	/**
	 * Retreives all codes for a given conformance profile and codeSystem. Note: The codeSystem
	...
	/**
	 * Validates the codeSytem against the input conformance profile. If valid then output is 'true'
	 * else 'false'. Note: The codeSystem parameter value must be a concatenation of a coding
