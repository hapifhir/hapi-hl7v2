...
/**
 * <p>Represents a RDE_O01_COMPONENT group structure (a Group object).
...
public class RDE_O01_COMPONENT extends AbstractGroup {

    /** 
     * Creates a new RDE_O01_COMPONENT group
     */
    public RDE_O01_COMPONENT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RDE_O01_COMPONENT - this is probably a bug in the source code generator.", e);
       }
    }
