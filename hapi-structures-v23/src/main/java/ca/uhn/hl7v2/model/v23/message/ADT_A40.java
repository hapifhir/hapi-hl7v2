 ...
 * <ul>
		                 ...
		                 * <li>3: ADT_A40_PATIENT (a Group object) <b> repeating</b> </li>
 * </ul>
 */
...
public class ADT_A40 extends AbstractMessage  {
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(ADT_A40_PATIENT.class, true, true);
    ...
    public ADT_A40_PATIENT getPATIENT() { 
       return getTyped("PATIENT", ADT_A40_PATIENT.class);
    }
    ...
    public ADT_A40_PATIENT getPATIENT(int rep) { 
       return getTyped("PATIENT", rep, ADT_A40_PATIENT.class);
    }
     ...
     * 
     */ 
    public java.util.List<ADT_A40_PATIENT> getPATIENTAll() throws HL7Exception {
    	return getAllAsList("PATIENT", ADT_A40_PATIENT.class);
    } 
