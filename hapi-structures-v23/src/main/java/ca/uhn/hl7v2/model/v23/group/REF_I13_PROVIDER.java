...
/**
 * <p>Represents a REF_I13_PROVIDER group structure (a Group object).
...
public class REF_I13_PROVIDER extends AbstractGroup {

    /** 
     * Creates a new REF_I13_PROVIDER group
     */
    public REF_I13_PROVIDER(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating REF_I13_PROVIDER - this is probably a bug in the source code generator.", e);
       }
    }
