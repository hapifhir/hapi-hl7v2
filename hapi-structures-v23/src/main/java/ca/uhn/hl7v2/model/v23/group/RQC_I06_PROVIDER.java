...
/**
 * <p>Represents a RQC_I06_PROVIDER group structure (a Group object).
...
public class RQC_I06_PROVIDER extends AbstractGroup {

    /** 
     * Creates a new RQC_I06_PROVIDER group
     */
    public RQC_I06_PROVIDER(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RQC_I06_PROVIDER - this is probably a bug in the source code generator.", e);
       }
    }
