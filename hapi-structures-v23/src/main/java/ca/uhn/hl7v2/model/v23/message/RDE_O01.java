 ...
 * <ul>
		                 ...
		                 * <li>3: RDE_O01_PATIENT (a Group object) <b>optional </b> </li>
		                 * <li>4: RDE_O01_ORDER (a Group object) <b> repeating</b> </li>
 * </ul>
 */
...
public class RDE_O01 extends AbstractMessage  {
    ...
    public RDE_O01_PATIENT getPATIENT() { 
       return getTyped("PATIENT", RDE_O01_PATIENT.class);
    }
    ...
    public RDE_O01_ORDER getORDER() { 
       return getTyped("ORDER", RDE_O01_ORDER.class);
    }
    ...
    public RDE_O01_ORDER getORDER(int rep) { 
       return getTyped("ORDER", rep, RDE_O01_ORDER.class);
    }
     ...
     * 
     */ 
    public java.util.List<RDE_O01_ORDER> getORDERAll() throws HL7Exception {
    	return getAllAsList("ORDER", RDE_O01_ORDER.class);
    } 
