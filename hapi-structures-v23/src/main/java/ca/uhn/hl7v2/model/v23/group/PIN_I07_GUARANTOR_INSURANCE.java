...
/**
 * <p>Represents a PIN_I07_GUARANTOR_INSURANCE group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: GT1 (Guarantor) <b>optional repeating </b></li>
                         * <li>2: PIN_I07_INSURANCE (a Group object) <b> repeating </b></li>
 * </ul>
 */
...
public class PIN_I07_GUARANTOR_INSURANCE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(PIN_I07_INSURANCE.class, true, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating PIN_I07_GUARANTOR_INSURANCE - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public PIN_I07_INSURANCE getINSURANCE() { 
       PIN_I07_INSURANCE retVal = getTyped("INSURANCE", PIN_I07_INSURANCE.class);
       return retVal;
    }
    ...
    public PIN_I07_INSURANCE getINSURANCE(int rep) { 
       PIN_I07_INSURANCE retVal = getTyped("INSURANCE", rep, PIN_I07_INSURANCE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PIN_I07_INSURANCE> getINSURANCEAll() throws HL7Exception {
    	return getAllAsList("INSURANCE", PIN_I07_INSURANCE.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertINSURANCE(PIN_I07_INSURANCE structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public PIN_I07_INSURANCE insertINSURANCE(int rep) throws HL7Exception { 
       return (PIN_I07_INSURANCE)super.insertRepetition("INSURANCE", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public PIN_I07_INSURANCE removeINSURANCE(int rep) throws HL7Exception { 
       return (PIN_I07_INSURANCE)super.removeRepetition("INSURANCE", rep);
    }
