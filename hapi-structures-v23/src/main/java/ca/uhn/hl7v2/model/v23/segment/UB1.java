 ...
 * <ul>
     ...
     * <li>UB1-10: Value Amount & Code (46-49) (CM_UVC) <b>optional repeating</b>
     * <li>UB1-11: Number Of Grace Days (90) (NM) <b>optional </b>
     * <li>UB1-12: Spec Program Indicator (44) (CE) <b>optional </b>
...
public class UB1 extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(NM.class, false, 1, 2, new Object[]{ getMessage() }, "Co Insurance Days (25)");
                                              this.add(IS.class, false, 5, 2, new Object[]{ getMessage(), new Integer(43) }, "Condition Code (35-39)");
                                  ...
                                  this.add(CM_UVC.class, false, 8, 12, new Object[]{ getMessage() }, "Value Amount & Code (46-49)");
                                  this.add(NM.class, false, 1, 2, new Object[]{ getMessage() }, "Number Of Grace Days (90)");
                                  this.add(CE.class, false, 1, 60, new Object[]{ getMessage() }, "Spec Program Indicator (44)");
                                              this.add(ID.class, false, 1, 60, new Object[]{ getMessage(), new Integer(0) }, "PSRO/UR Approval Indicator (87)");
     ...
     * Returns all repetitions of Value Amount & Code (46-49) (UB1-10).
     */
    public CM_UVC[] getUb110_ValueAmountCode4649() {
    	CM_UVC[] retVal = this.getTypedField(10, new CM_UVC[0]);
    	return retVal;
    }
     ...
     * @param rep The repetition index (0-indexed)
     */
    public CM_UVC getUb110_ValueAmountCode4649(int rep) { 
		CM_UVC retVal = this.getTypedField(10, rep);
		return retVal;
    }
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public CM_UVC insertValueAmountCode4649(int rep) throws HL7Exception { 
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public CM_UVC insertUb110_ValueAmountCode4649(int rep) throws HL7Exception { 
        return (CM_UVC) super.insertRepetition(10, rep);
    }
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public CM_UVC removeValueAmountCode4649(int rep) throws HL7Exception { 
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public CM_UVC removeUb110_ValueAmountCode4649(int rep) throws HL7Exception { 
        return (CM_UVC) super.removeRepetition(10, rep);
    }
    ...
    /**
     * Returns
     * UB1-12: "Spec Program Indicator (44)" - creates it if necessary
     */
    public CE getSpecProgramIndicator() { 
     ...
     * UB1-12: "Spec Program Indicator (44)" - creates it if necessary
     */
    public CE getUb112_SpecProgramIndicator() { 
		CE retVal = this.getTypedField(12, 0);
		return retVal;
    }
