...
/**
 * <p>Represents a CRM_C02_PATIENT group structure (a Group object).
...
public class CRM_C02_PATIENT extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating CRM_C02_PATIENT - this is probably a bug in the source code generator.", e);
       }
    }
