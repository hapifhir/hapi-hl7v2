 ...
 * <ul>
		                 ...
		                 * <li>5: ERQ (Event Replay Query Segment) <b> </b> </li>
...
public class ERP_Q01 extends AbstractMessage  {
    ...
    /**
     * Creates a new ERP_Q01 message with DefaultModelClassFactory. 
     */ 
    public ERP_Q01() { 
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ERP_Q01 - this is probably a bug in the source code generator.", e);
       }
    }
