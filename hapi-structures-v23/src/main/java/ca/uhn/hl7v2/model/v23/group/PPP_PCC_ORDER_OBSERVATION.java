...
/**
 * <p>Represents a PPP_PCC_ORDER_OBSERVATION group structure (a Group object).
...
public class PPP_PCC_ORDER_OBSERVATION extends AbstractGroup {

    /** 
     * Creates a new PPP_PCC_ORDER_OBSERVATION group
     */
    public PPP_PCC_ORDER_OBSERVATION(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PPP_PCC_ORDER_OBSERVATION - this is probably a bug in the source code generator.", e);
       }
    }
