...
/**
 * <p>Represents a REF_I14_INSURANCE group structure (a Group object).
...
public class REF_I14_INSURANCE extends AbstractGroup {

    /** 
     * Creates a new REF_I14_INSURANCE group
     */
    public REF_I14_INSURANCE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating REF_I14_INSURANCE - this is probably a bug in the source code generator.", e);
       }
    }
