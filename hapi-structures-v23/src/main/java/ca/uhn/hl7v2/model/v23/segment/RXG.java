...
/**
 *<p>Represents an HL7 RXG message segment (Pharmacy give segment). 
 * This segment has the following fields:</p>
 * <ul>
     * <li>RXG-1: Give Sub-ID Counter (ID) <b>optional </b>
     * <li>RXG-2: Dispense Sub-ID Counter (NM) <b> </b>
     * <li>RXG-3: Quantity/Timing (TQ) <b> </b>
     ...
     * <li>RXG-11: Dispense-To Location (CM_LA1) <b>optional </b>
     * <li>RXG-12: Needs Human Review (ID) <b>optional </b>
     * <li>RXG-13: Pharmacy Special Administration Instructions (CE) <b>optional </b>
     ...
     * <li>RXG-22: Indication (CE) <b>optional </b>
 * </ul>
 */
...
public class RXG extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                              this.add(ID.class, false, 1, 4, new Object[]{ getMessage(), new Integer(0) }, "Give Sub-ID Counter");
                                  ...
                                  this.add(CE.class, false, 1, 200, new Object[]{ getMessage() }, "Pharmacy Special Administration Instructions");
