...
/**
 * <p>Represents a OMD_O01_DIET group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>3: OMD_O01_OBSERVATION (a Group object) <b> repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class OMD_O01_DIET extends AbstractGroup {

    /** 
     * Creates a new OMD_O01_DIET group
     */
    public OMD_O01_DIET(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(OMD_O01_OBSERVATION.class, true, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating OMD_O01_DIET - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public OMD_O01_OBSERVATION getOBSERVATION() { 
       OMD_O01_OBSERVATION retVal = getTyped("OBSERVATION", OMD_O01_OBSERVATION.class);
       return retVal;
    }
    ...
    public OMD_O01_OBSERVATION getOBSERVATION(int rep) { 
       OMD_O01_OBSERVATION retVal = getTyped("OBSERVATION", rep, OMD_O01_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<OMD_O01_OBSERVATION> getOBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("OBSERVATION", OMD_O01_OBSERVATION.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertOBSERVATION(OMD_O01_OBSERVATION structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public OMD_O01_OBSERVATION insertOBSERVATION(int rep) throws HL7Exception { 
       return (OMD_O01_OBSERVATION)super.insertRepetition("OBSERVATION", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public OMD_O01_OBSERVATION removeOBSERVATION(int rep) throws HL7Exception { 
       return (OMD_O01_OBSERVATION)super.removeRepetition("OBSERVATION", rep);
    }
