...
/**
 * <p>Represents a REF_I12_PROVIDER group structure (a Group object).
...
public class REF_I12_PROVIDER extends AbstractGroup {

    /** 
     * Creates a new REF_I12_PROVIDER group
     */
    public REF_I12_PROVIDER(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating REF_I12_PROVIDER - this is probably a bug in the source code generator.", e);
       }
    }
