 ...
 * <ul>
		                 ...
		                 * <li>5: RRG_O02_RESPONSE (a Group object) <b>optional </b> </li>
 * </ul>
 */
...
public class RRG_O02 extends AbstractMessage  {
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(RRG_O02_RESPONSE.class, false, false);
     ...
     *
     */
    public RRG_O02_RESPONSE getRESPONSE() { 
       return getTyped("RESPONSE", RRG_O02_RESPONSE.class);
    }
