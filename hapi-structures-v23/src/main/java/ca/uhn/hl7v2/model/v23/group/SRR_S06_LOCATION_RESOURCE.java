...
/**
 * <p>Represents a SRR_S06_LOCATION_RESOURCE group structure (a Group object).
...
public class SRR_S06_LOCATION_RESOURCE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating SRR_S06_LOCATION_RESOURCE - this is probably a bug in the source code generator.", e);
       }
    }
