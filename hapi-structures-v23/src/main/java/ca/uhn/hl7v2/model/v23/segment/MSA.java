...
/**
 *<p>Represents an HL7 MSA message segment (Message acknowledgement segment). 
 ...
 * <ul>
     ...
     * <li>MSA-5: Delayed Acknowledgement Type (ID) <b>optional </b>
...
public class MSA extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(NM.class, false, 1, 15, new Object[]{ getMessage() }, "Expected Sequence Number");
                                              this.add(ID.class, false, 1, 1, new Object[]{ getMessage(), new Integer(102) }, "Delayed Acknowledgement Type");
                                  this.add(CE.class, false, 1, 100, new Object[]{ getMessage() }, "Error Condition");
    ...
    /**
     * Returns
     * MSA-5: "Delayed Acknowledgement Type" - creates it if necessary
     */
    public ID getDelayedAcknowledgementType() { 
     ...
     * MSA-5: "Delayed Acknowledgement Type" - creates it if necessary
     */
    public ID getMsa5_DelayedAcknowledgementType() { 
		ID retVal = this.getTypedField(5, 0);
		return retVal;
    }
