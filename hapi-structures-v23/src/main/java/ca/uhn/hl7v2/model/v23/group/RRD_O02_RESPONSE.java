...
/**
 * <p>Represents a RRD_O02_RESPONSE group structure (a Group object).
...
public class RRD_O02_RESPONSE extends AbstractGroup {

    /** 
     * Creates a new RRD_O02_RESPONSE group
     */
    public RRD_O02_RESPONSE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RRD_O02_RESPONSE - this is probably a bug in the source code generator.", e);
       }
    }
