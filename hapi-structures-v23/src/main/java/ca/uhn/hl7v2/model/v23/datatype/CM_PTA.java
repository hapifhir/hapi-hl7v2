 ...
 * 
 * The Original Code is "CM_PTA.java".  Description:
 * "Composite class CM_PTA"
 * 
...
/**
 * <p>Represents an HL7 CM_PTA (Policy Type) data type. 
...
public class CM_PTA extends AbstractComposite {
     ...
     * casting and handling an exception.
     */
    public IS getCm_pta1_PolicyType() {
       return getTyped(0, IS.class);
    }
     ...
     * casting and handling an exception.
     */
    public IS getCm_pta2_AmountClass() {
       return getTyped(1, IS.class);
    }


    /**
     * Returns amount (component 3).  This is a convenience method that saves you from 
     * casting and handling an exception.
     */
    public NM getAmount() {
