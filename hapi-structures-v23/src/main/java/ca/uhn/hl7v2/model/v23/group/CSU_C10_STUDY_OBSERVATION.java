...
/**
 * <p>Represents a CSU_C10_STUDY_OBSERVATION group structure (a Group object).
...
public class CSU_C10_STUDY_OBSERVATION extends AbstractGroup {

    /** 
     * Creates a new CSU_C10_STUDY_OBSERVATION group
     */
    public CSU_C10_STUDY_OBSERVATION(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating CSU_C10_STUDY_OBSERVATION - this is probably a bug in the source code generator.", e);
       }
    }
