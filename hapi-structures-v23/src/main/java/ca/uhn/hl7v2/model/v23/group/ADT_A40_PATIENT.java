...
/**
 * <p>Represents a ADT_A40_PATIENT group structure (a Group object).
...
public class ADT_A40_PATIENT extends AbstractGroup {

    /** 
     * Creates a new ADT_A40_PATIENT group
     */
    public ADT_A40_PATIENT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ADT_A40_PATIENT - this is probably a bug in the source code generator.", e);
       }
    }
