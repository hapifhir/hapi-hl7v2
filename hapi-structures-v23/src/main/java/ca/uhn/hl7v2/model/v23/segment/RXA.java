...
/**
 *<p>Represents an HL7 RXA message segment (Pharmacy administration segment). 
 * This segment has the following fields:</p>
 * <ul>
     * <li>RXA-1: Give Sub-ID Counter (ID) <b> </b>
     ...
     * <li>RXA-10: Administering Provider (XCN) <b>optional </b>
     ...
     * <li>RXA-18: Substance Refusal Reason (CE) <b>optional repeating</b>
...
public class RXA extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                              this.add(ID.class, true, 1, 4, new Object[]{ getMessage(), new Integer(0) }, "Give Sub-ID Counter");
                                  ...
                                  this.add(CE.class, false, 0, 200, new Object[]{ getMessage() }, "Administration Notes");
                                  this.add(XCN.class, false, 1, 200, new Object[]{ getMessage() }, "Administering Provider");
                                  this.add(CM_LA1.class, false, 1, 200, new Object[]{ getMessage() }, "Administered-at Location");
                                  ...
                                  this.add(CE.class, false, 1, 60, new Object[]{ getMessage() }, "Administered Strength Units");
                                  ...
                                  this.add(CE.class, false, 0, 60, new Object[]{ getMessage() }, "Substance Refusal Reason");
