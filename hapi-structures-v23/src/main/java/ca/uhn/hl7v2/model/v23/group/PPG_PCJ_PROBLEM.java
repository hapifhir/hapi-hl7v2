...
/**
 * <p>Represents a PPG_PCJ_PROBLEM group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>4: PPG_PCJ_PROBLEM_ROLE (a Group object) <b>optional repeating </b></li>
                         * <li>5: PPG_PCJ_PROBLEM_OBSERVATION (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class PPG_PCJ_PROBLEM extends AbstractGroup {

    /** 
     * Creates a new PPG_PCJ_PROBLEM group
     */
    public PPG_PCJ_PROBLEM(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(PPG_PCJ_PROBLEM_ROLE.class, false, true, false);
                                  this.add(PPG_PCJ_PROBLEM_OBSERVATION.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating PPG_PCJ_PROBLEM - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public PPG_PCJ_PROBLEM_ROLE getPROBLEM_ROLE() { 
       PPG_PCJ_PROBLEM_ROLE retVal = getTyped("PROBLEM_ROLE", PPG_PCJ_PROBLEM_ROLE.class);
       return retVal;
    }
    ...
    public PPG_PCJ_PROBLEM_ROLE getPROBLEM_ROLE(int rep) { 
       PPG_PCJ_PROBLEM_ROLE retVal = getTyped("PROBLEM_ROLE", rep, PPG_PCJ_PROBLEM_ROLE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PPG_PCJ_PROBLEM_ROLE> getPROBLEM_ROLEAll() throws HL7Exception {
    	return getAllAsList("PROBLEM_ROLE", PPG_PCJ_PROBLEM_ROLE.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertPROBLEM_ROLE(PPG_PCJ_PROBLEM_ROLE structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public PPG_PCJ_PROBLEM_ROLE insertPROBLEM_ROLE(int rep) throws HL7Exception { 
       return (PPG_PCJ_PROBLEM_ROLE)super.insertRepetition("PROBLEM_ROLE", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public PPG_PCJ_PROBLEM_ROLE removePROBLEM_ROLE(int rep) throws HL7Exception { 
       return (PPG_PCJ_PROBLEM_ROLE)super.removeRepetition("PROBLEM_ROLE", rep);
    }
    ...
    public PPG_PCJ_PROBLEM_OBSERVATION getPROBLEM_OBSERVATION() { 
       PPG_PCJ_PROBLEM_OBSERVATION retVal = getTyped("PROBLEM_OBSERVATION", PPG_PCJ_PROBLEM_OBSERVATION.class);
       return retVal;
    }
    ...
    public PPG_PCJ_PROBLEM_OBSERVATION getPROBLEM_OBSERVATION(int rep) { 
       PPG_PCJ_PROBLEM_OBSERVATION retVal = getTyped("PROBLEM_OBSERVATION", rep, PPG_PCJ_PROBLEM_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PPG_PCJ_PROBLEM_OBSERVATION> getPROBLEM_OBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("PROBLEM_OBSERVATION", PPG_PCJ_PROBLEM_OBSERVATION.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertPROBLEM_OBSERVATION(PPG_PCJ_PROBLEM_OBSERVATION structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public PPG_PCJ_PROBLEM_OBSERVATION insertPROBLEM_OBSERVATION(int rep) throws HL7Exception { 
       return (PPG_PCJ_PROBLEM_OBSERVATION)super.insertRepetition("PROBLEM_OBSERVATION", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public PPG_PCJ_PROBLEM_OBSERVATION removePROBLEM_OBSERVATION(int rep) throws HL7Exception { 
       return (PPG_PCJ_PROBLEM_OBSERVATION)super.removeRepetition("PROBLEM_OBSERVATION", rep);
    }
