...
/**
 * <p>Represents a PPG_PCJ_PATHWAY_ROLE group structure (a Group object).
...
public class PPG_PCJ_PATHWAY_ROLE extends AbstractGroup {

    /** 
     * Creates a new PPG_PCJ_PATHWAY_ROLE group
     */
    public PPG_PCJ_PATHWAY_ROLE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PPG_PCJ_PATHWAY_ROLE - this is probably a bug in the source code generator.", e);
       }
    }
