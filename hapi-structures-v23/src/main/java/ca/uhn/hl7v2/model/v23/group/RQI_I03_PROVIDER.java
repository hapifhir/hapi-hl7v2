...
/**
 * <p>Represents a RQI_I03_PROVIDER group structure (a Group object).
...
public class RQI_I03_PROVIDER extends AbstractGroup {

    /** 
     * Creates a new RQI_I03_PROVIDER group
     */
    public RQI_I03_PROVIDER(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RQI_I03_PROVIDER - this is probably a bug in the source code generator.", e);
       }
    }
