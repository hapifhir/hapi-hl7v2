...
/**
 * <p>Represents a PPG_PCH_PATHWAY group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>4: PPG_PCH_PATHWAY_ROLE (a Group object) <b>optional repeating </b></li>
                         * <li>5: PPG_PCH_GOAL (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class PPG_PCH_PATHWAY extends AbstractGroup {

    /** 
     * Creates a new PPG_PCH_PATHWAY group
     */
    public PPG_PCH_PATHWAY(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(PPG_PCH_PATHWAY_ROLE.class, false, true, false);
                                  this.add(PPG_PCH_GOAL.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating PPG_PCH_PATHWAY - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public PPG_PCH_PATHWAY_ROLE getPATHWAY_ROLE() { 
       PPG_PCH_PATHWAY_ROLE retVal = getTyped("PATHWAY_ROLE", PPG_PCH_PATHWAY_ROLE.class);
       return retVal;
    }
    ...
    public PPG_PCH_PATHWAY_ROLE getPATHWAY_ROLE(int rep) { 
       PPG_PCH_PATHWAY_ROLE retVal = getTyped("PATHWAY_ROLE", rep, PPG_PCH_PATHWAY_ROLE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PPG_PCH_PATHWAY_ROLE> getPATHWAY_ROLEAll() throws HL7Exception {
    	return getAllAsList("PATHWAY_ROLE", PPG_PCH_PATHWAY_ROLE.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertPATHWAY_ROLE(PPG_PCH_PATHWAY_ROLE structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public PPG_PCH_PATHWAY_ROLE insertPATHWAY_ROLE(int rep) throws HL7Exception { 
       return (PPG_PCH_PATHWAY_ROLE)super.insertRepetition("PATHWAY_ROLE", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public PPG_PCH_PATHWAY_ROLE removePATHWAY_ROLE(int rep) throws HL7Exception { 
       return (PPG_PCH_PATHWAY_ROLE)super.removeRepetition("PATHWAY_ROLE", rep);
    }
    ...
    public PPG_PCH_GOAL getGOAL() { 
       PPG_PCH_GOAL retVal = getTyped("GOAL", PPG_PCH_GOAL.class);
       return retVal;
    }
    ...
    public PPG_PCH_GOAL getGOAL(int rep) { 
       PPG_PCH_GOAL retVal = getTyped("GOAL", rep, PPG_PCH_GOAL.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PPG_PCH_GOAL> getGOALAll() throws HL7Exception {
    	return getAllAsList("GOAL", PPG_PCH_GOAL.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertGOAL(PPG_PCH_GOAL structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public PPG_PCH_GOAL insertGOAL(int rep) throws HL7Exception { 
       return (PPG_PCH_GOAL)super.insertRepetition("GOAL", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public PPG_PCH_GOAL removeGOAL(int rep) throws HL7Exception { 
       return (PPG_PCH_GOAL)super.removeRepetition("GOAL", rep);
    }
