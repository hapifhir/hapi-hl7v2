 ...
 * <ul>
		                 ...
		                 * <li>13: ADT_A28_PROCEDURE (a Group object) <b>optional repeating</b> </li>
		                 * <li>14: GT1 (Guarantor) <b>optional repeating</b> </li>
		                 * <li>15: ADT_A28_INSURANCE (a Group object) <b>optional repeating</b> </li>
...
public class ADT_A28 extends AbstractMessage  {
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(ADT_A28_PROCEDURE.class, false, true);
	                          this.add(GT1.class, false, true);
	                          this.add(ADT_A28_INSURANCE.class, false, true);
    ...
    public ADT_A28_PROCEDURE getPROCEDURE() { 
       return getTyped("PROCEDURE", ADT_A28_PROCEDURE.class);
    }
    ...
    public ADT_A28_PROCEDURE getPROCEDURE(int rep) { 
       return getTyped("PROCEDURE", rep, ADT_A28_PROCEDURE.class);
    }
     ...
     * 
     */ 
    public java.util.List<ADT_A28_PROCEDURE> getPROCEDUREAll() throws HL7Exception {
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertPROCEDURE(ADT_A28_PROCEDURE structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public ADT_A28_PROCEDURE insertPROCEDURE(int rep) throws HL7Exception { 
       return (ADT_A28_PROCEDURE)super.insertRepetition("PROCEDURE", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public ADT_A28_PROCEDURE removePROCEDURE(int rep) throws HL7Exception { 
       return (ADT_A28_PROCEDURE)super.removeRepetition("PROCEDURE", rep);
    }
    ...
    public ADT_A28_INSURANCE getINSURANCE() { 
       return getTyped("INSURANCE", ADT_A28_INSURANCE.class);
    }
    ...
    public ADT_A28_INSURANCE getINSURANCE(int rep) { 
       return getTyped("INSURANCE", rep, ADT_A28_INSURANCE.class);
    }
     ...
     * 
     */ 
    public java.util.List<ADT_A28_INSURANCE> getINSURANCEAll() throws HL7Exception {
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertINSURANCE(ADT_A28_INSURANCE structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public ADT_A28_INSURANCE insertINSURANCE(int rep) throws HL7Exception { 
       return (ADT_A28_INSURANCE)super.insertRepetition("INSURANCE", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public ADT_A28_INSURANCE removeINSURANCE(int rep) throws HL7Exception { 
       return (ADT_A28_INSURANCE)super.removeRepetition("INSURANCE", rep);
    }
