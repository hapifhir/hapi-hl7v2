...
/**
 * <p>Represents a PPR_PC3_PATHWAY group structure (a Group object).
...
public class PPR_PC3_PATHWAY extends AbstractGroup {

    /** 
     * Creates a new PPR_PC3_PATHWAY group
     */
    public PPR_PC3_PATHWAY(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PPR_PC3_PATHWAY - this is probably a bug in the source code generator.", e);
       }
    }
