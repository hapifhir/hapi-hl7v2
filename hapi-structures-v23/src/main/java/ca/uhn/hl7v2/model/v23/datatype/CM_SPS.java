 ...
 * 
 * The Original Code is "CM_SPS.java".  Description:
 * "Composite class CM_SPS"
 * 
 ...
 * <li>body site (CE)
 * <li>site modifier (CE)
 * <li>collection modifier method code (CE)
 * </ul>
 */
...
public class CM_SPS extends AbstractComposite {
    ...
    /**
     * Returns collection modifier method code (component 6).  This is a convenience method that saves you from 
     * casting and handling an exception.
     */
    public CE getCollectionModifierMethodCode() {
       return getTyped(5, CE.class);
    }
     ...
     * casting and handling an exception.
     */
    public CE getCm_sps6_CollectionModifierMethodCode() {
       return getTyped(5, CE.class);
    }
