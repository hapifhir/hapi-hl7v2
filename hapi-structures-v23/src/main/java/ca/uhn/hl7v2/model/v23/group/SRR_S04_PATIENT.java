...
/**
 * <p>Represents a SRR_S04_PATIENT group structure (a Group object).
...
public class SRR_S04_PATIENT extends AbstractGroup {

    /** 
     * Creates a new SRR_S04_PATIENT group
     */
    public SRR_S04_PATIENT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating SRR_S04_PATIENT - this is probably a bug in the source code generator.", e);
       }
    }
