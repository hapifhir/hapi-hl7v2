...
/**
 *<p>Represents an HL7 RF1 message segment (Referral Information Segment). 
...
public class RF1 extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(CE.class, false, 1, 200, new Object[]{ getMessage() }, "Referral Status");
                                  this.add(CE.class, false, 1, 200, new Object[]{ getMessage() }, "Referral Priority");
                                  this.add(CE.class, false, 1, 200, new Object[]{ getMessage() }, "Referral Type");
                                  this.add(CE.class, false, 0, 200, new Object[]{ getMessage() }, "Referral Disposition");
                                  this.add(CE.class, false, 1, 200, new Object[]{ getMessage() }, "Referral Category");
                                  ...
                                  this.add(CE.class, false, 0, 200, new Object[]{ getMessage() }, "Referral Reason");
