 ...
 * <ul>
		                 ...
		                 * <li>3: PPG_PCH_PATIENT_VISIT (a Group object) <b>optional </b> </li>
		                 * <li>4: PPG_PCH_PATHWAY (a Group object) <b> repeating</b> </li>
 * </ul>
 */
...
public class PPG_PCH extends AbstractMessage  {
    ...
    /**
     * Creates a new PPG_PCH message with DefaultModelClassFactory. 
     */ 
    public PPG_PCH() { 
    ...
    /** 
     * Creates a new PPG_PCH message with custom ModelClassFactory.
     */
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PPG_PCH - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public PPG_PCH_PATIENT_VISIT getPATIENT_VISIT() { 
       return getTyped("PATIENT_VISIT", PPG_PCH_PATIENT_VISIT.class);
    }
    ...
    public PPG_PCH_PATHWAY getPATHWAY() { 
       return getTyped("PATHWAY", PPG_PCH_PATHWAY.class);
    }
    ...
    public PPG_PCH_PATHWAY getPATHWAY(int rep) { 
       return getTyped("PATHWAY", rep, PPG_PCH_PATHWAY.class);
    }
     ...
     * 
     */ 
    public java.util.List<PPG_PCH_PATHWAY> getPATHWAYAll() throws HL7Exception {
    	return getAllAsList("PATHWAY", PPG_PCH_PATHWAY.class);
    } 
     ...
     */
    public void insertPATHWAY(PPG_PCH_PATHWAY structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public PPG_PCH_PATHWAY insertPATHWAY(int rep) throws HL7Exception { 
       return (PPG_PCH_PATHWAY)super.insertRepetition("PATHWAY", rep);
    }
     ...
     */
    public PPG_PCH_PATHWAY removePATHWAY(int rep) throws HL7Exception { 
       return (PPG_PCH_PATHWAY)super.removeRepetition("PATHWAY", rep);
    }
