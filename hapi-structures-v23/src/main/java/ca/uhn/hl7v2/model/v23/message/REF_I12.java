 ...
 * <ul>
		                 ...
		                 * <li>3: REF_I12_AUTHORIZATION (a Group object) <b>optional </b> </li>
		                 * <li>4: REF_I12_PROVIDER (a Group object) <b> repeating</b> </li>
		                 ...
		                 * <li>8: REF_I12_INSURANCE (a Group object) <b>optional repeating</b> </li>
		                 ...
		                 * <li>13: REF_I12_PROCEDURE (a Group object) <b>optional repeating</b> </li>
		                 * <li>14: REF_I12_RESULTS (a Group object) <b>optional repeating</b> </li>
		                 * <li>15: REF_I12_VISIT (a Group object) <b>optional </b> </li>
...
public class REF_I12 extends AbstractMessage  {
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(REF_I12_PROVIDER.class, true, true);
	                          ...
	                          this.add(REF_I12_RESULTS.class, false, true);
	                          this.add(REF_I12_VISIT.class, false, false);
    ...
    public REF_I12_AUTHORIZATION getAUTHORIZATION() { 
       return getTyped("AUTHORIZATION", REF_I12_AUTHORIZATION.class);
    }
    ...
    public REF_I12_PROVIDER getPROVIDER() { 
       return getTyped("PROVIDER", REF_I12_PROVIDER.class);
    }
    ...
    public REF_I12_PROVIDER getPROVIDER(int rep) { 
       return getTyped("PROVIDER", rep, REF_I12_PROVIDER.class);
    }
     ...
     * 
     */ 
    public java.util.List<REF_I12_PROVIDER> getPROVIDERAll() throws HL7Exception {
    	return getAllAsList("PROVIDER", REF_I12_PROVIDER.class);
    } 
     ...
     */
    public void insertPROVIDER(REF_I12_PROVIDER structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public REF_I12_PROVIDER insertPROVIDER(int rep) throws HL7Exception { 
       return (REF_I12_PROVIDER)super.insertRepetition("PROVIDER", rep);
    }
     ...
     */
    public REF_I12_PROVIDER removePROVIDER(int rep) throws HL7Exception { 
       return (REF_I12_PROVIDER)super.removeRepetition("PROVIDER", rep);
    }
    ...
    public REF_I12_RESULTS getRESULTS() { 
       return getTyped("RESULTS", REF_I12_RESULTS.class);
    }
    ...
    public REF_I12_RESULTS getRESULTS(int rep) { 
       return getTyped("RESULTS", rep, REF_I12_RESULTS.class);
    }
     ...
     * 
     */ 
    public java.util.List<REF_I12_RESULTS> getRESULTSAll() throws HL7Exception {
    	return getAllAsList("RESULTS", REF_I12_RESULTS.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertRESULTS(REF_I12_RESULTS structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public REF_I12_RESULTS insertRESULTS(int rep) throws HL7Exception { 
       return (REF_I12_RESULTS)super.insertRepetition("RESULTS", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public REF_I12_RESULTS removeRESULTS(int rep) throws HL7Exception { 
       return (REF_I12_RESULTS)super.removeRepetition("RESULTS", rep);
    }
     ...
     *
     */
    public REF_I12_VISIT getVISIT() { 
       return getTyped("VISIT", REF_I12_VISIT.class);
    }
