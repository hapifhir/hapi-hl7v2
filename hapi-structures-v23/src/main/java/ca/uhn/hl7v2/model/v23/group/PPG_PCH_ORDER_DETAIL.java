...
/**
 * <p>Represents a PPG_PCH_ORDER_DETAIL group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>4: PPG_PCH_ORDER_OBSERVATION (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class PPG_PCH_ORDER_DETAIL extends AbstractGroup {

    /** 
     * Creates a new PPG_PCH_ORDER_DETAIL group
     */
    public PPG_PCH_ORDER_DETAIL(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(PPG_PCH_ORDER_OBSERVATION.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating PPG_PCH_ORDER_DETAIL - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public PPG_PCH_ORDER_OBSERVATION getORDER_OBSERVATION() { 
       PPG_PCH_ORDER_OBSERVATION retVal = getTyped("ORDER_OBSERVATION", PPG_PCH_ORDER_OBSERVATION.class);
       return retVal;
    }
    ...
    public PPG_PCH_ORDER_OBSERVATION getORDER_OBSERVATION(int rep) { 
       PPG_PCH_ORDER_OBSERVATION retVal = getTyped("ORDER_OBSERVATION", rep, PPG_PCH_ORDER_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PPG_PCH_ORDER_OBSERVATION> getORDER_OBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("ORDER_OBSERVATION", PPG_PCH_ORDER_OBSERVATION.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertORDER_OBSERVATION(PPG_PCH_ORDER_OBSERVATION structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public PPG_PCH_ORDER_OBSERVATION insertORDER_OBSERVATION(int rep) throws HL7Exception { 
       return (PPG_PCH_ORDER_OBSERVATION)super.insertRepetition("ORDER_OBSERVATION", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public PPG_PCH_ORDER_OBSERVATION removeORDER_OBSERVATION(int rep) throws HL7Exception { 
       return (PPG_PCH_ORDER_OBSERVATION)super.removeRepetition("ORDER_OBSERVATION", rep);
    }
