...
/**
 * <p>Represents a RGV_O01_GIVE group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: RXG (Pharmacy give segment) <b>  </b></li>
                         * <li>2: RXR (Pharmacy route segment) <b> repeating </b></li>
                         * <li>3: RXC (Pharmacy component order segment) <b>optional repeating </b></li>
                         * <li>4: RGV_O01_OBSERVATION (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
...
public class RGV_O01_GIVE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(RGV_O01_OBSERVATION.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating RGV_O01_GIVE - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public RGV_O01_OBSERVATION getOBSERVATION() { 
       RGV_O01_OBSERVATION retVal = getTyped("OBSERVATION", RGV_O01_OBSERVATION.class);
       return retVal;
    }
    ...
    public RGV_O01_OBSERVATION getOBSERVATION(int rep) { 
       RGV_O01_OBSERVATION retVal = getTyped("OBSERVATION", rep, RGV_O01_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<RGV_O01_OBSERVATION> getOBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("OBSERVATION", RGV_O01_OBSERVATION.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertOBSERVATION(RGV_O01_OBSERVATION structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public RGV_O01_OBSERVATION insertOBSERVATION(int rep) throws HL7Exception { 
       return (RGV_O01_OBSERVATION)super.insertRepetition("OBSERVATION", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public RGV_O01_OBSERVATION removeOBSERVATION(int rep) throws HL7Exception { 
       return (RGV_O01_OBSERVATION)super.removeRepetition("OBSERVATION", rep);
    }
