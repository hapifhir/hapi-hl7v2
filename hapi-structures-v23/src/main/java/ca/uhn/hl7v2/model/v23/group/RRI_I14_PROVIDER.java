...
/**
 * <p>Represents a RRI_I14_PROVIDER group structure (a Group object).
...
public class RRI_I14_PROVIDER extends AbstractGroup {

    /** 
     * Creates a new RRI_I14_PROVIDER group
     */
    public RRI_I14_PROVIDER(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RRI_I14_PROVIDER - this is probably a bug in the source code generator.", e);
       }
    }
