 ...
 * <ul>
		                 ...
		                 * <li>2: CSU_C11_PATIENT (a Group object) <b> repeating</b> </li>
 * </ul>
 */
...
public class CSU_C11 extends AbstractMessage  {
    ...
    /**
     * Creates a new CSU_C11 message with DefaultModelClassFactory. 
     */ 
    public CSU_C11() { 
    ...
    /** 
     * Creates a new CSU_C11 message with custom ModelClassFactory.
     */
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating CSU_C11 - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public CSU_C11_PATIENT getPATIENT(int rep) { 
       return getTyped("PATIENT", rep, CSU_C11_PATIENT.class);
    }
     ...
     * 
     */ 
    public java.util.List<CSU_C11_PATIENT> getPATIENTAll() throws HL7Exception {
     ...
     */
    public void insertPATIENT(CSU_C11_PATIENT structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public CSU_C11_PATIENT insertPATIENT(int rep) throws HL7Exception { 
       return (CSU_C11_PATIENT)super.insertRepetition("PATIENT", rep);
    }
     ...
     */
    public CSU_C11_PATIENT removePATIENT(int rep) throws HL7Exception { 
       return (CSU_C11_PATIENT)super.removeRepetition("PATIENT", rep);
    }
