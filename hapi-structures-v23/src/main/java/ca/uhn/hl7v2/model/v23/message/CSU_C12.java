...
/**
 * <p>Represents a CSU_C12 message structure (see chapter ?). This structure contains the 
 * following elements: </p>
 * <ul>
		                 * <li>1: MSH (Message header segment) <b> </b> </li>
		                 * <li>2: CSU_C12_PATIENT (a Group object) <b> repeating</b> </li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class CSU_C12 extends AbstractMessage  {

    /**
     * Creates a new CSU_C12 message with DefaultModelClassFactory. 
     */ 
    public CSU_C12() { 
    ...
    /** 
     * Creates a new CSU_C12 message with custom ModelClassFactory.
     */
    ...
    public CSU_C12_PATIENT getPATIENT() { 
       return getTyped("PATIENT", CSU_C12_PATIENT.class);
    }
    ...
    public CSU_C12_PATIENT getPATIENT(int rep) { 
       return getTyped("PATIENT", rep, CSU_C12_PATIENT.class);
    }
     ...
     * 
     */ 
    public java.util.List<CSU_C12_PATIENT> getPATIENTAll() throws HL7Exception {
    	return getAllAsList("PATIENT", CSU_C12_PATIENT.class);
    } 
