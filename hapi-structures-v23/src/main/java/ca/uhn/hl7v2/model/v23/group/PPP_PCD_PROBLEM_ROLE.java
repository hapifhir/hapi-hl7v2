...
/**
 * <p>Represents a PPP_PCD_PROBLEM_ROLE group structure (a Group object).
...
public class PPP_PCD_PROBLEM_ROLE extends AbstractGroup {

    /** 
     * Creates a new PPP_PCD_PROBLEM_ROLE group
     */
    public PPP_PCD_PROBLEM_ROLE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PPP_PCD_PROBLEM_ROLE - this is probably a bug in the source code generator.", e);
       }
    }
