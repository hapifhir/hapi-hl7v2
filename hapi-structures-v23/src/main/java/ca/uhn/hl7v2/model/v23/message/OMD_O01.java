 ...
 * <ul>
		                 ...
		                 * <li>3: OMD_O01_PATIENT (a Group object) <b>optional </b> </li>
		                 * <li>4: OMD_O01_ORDER_DIET (a Group object) <b> repeating</b> </li>
		                 * <li>5: OMD_O01_ORDER_TRAY (a Group object) <b>optional repeating</b> </li>
 * </ul>
 */
...
public class OMD_O01 extends AbstractMessage  {
    ...
    public OMD_O01_PATIENT getPATIENT() { 
       return getTyped("PATIENT", OMD_O01_PATIENT.class);
    }
    ...
    public OMD_O01_ORDER_DIET getORDER_DIET() { 
       return getTyped("ORDER_DIET", OMD_O01_ORDER_DIET.class);
    }
    ...
    public OMD_O01_ORDER_DIET getORDER_DIET(int rep) { 
       return getTyped("ORDER_DIET", rep, OMD_O01_ORDER_DIET.class);
    }
     ...
     * 
     */ 
    public java.util.List<OMD_O01_ORDER_DIET> getORDER_DIETAll() throws HL7Exception {
    	return getAllAsList("ORDER_DIET", OMD_O01_ORDER_DIET.class);
    } 
    ...
    public OMD_O01_ORDER_TRAY getORDER_TRAY() { 
       return getTyped("ORDER_TRAY", OMD_O01_ORDER_TRAY.class);
    }
    ...
    public OMD_O01_ORDER_TRAY getORDER_TRAY(int rep) { 
       return getTyped("ORDER_TRAY", rep, OMD_O01_ORDER_TRAY.class);
    }
     ...
     * 
     */ 
    public java.util.List<OMD_O01_ORDER_TRAY> getORDER_TRAYAll() throws HL7Exception {
    	return getAllAsList("ORDER_TRAY", OMD_O01_ORDER_TRAY.class);
    } 
