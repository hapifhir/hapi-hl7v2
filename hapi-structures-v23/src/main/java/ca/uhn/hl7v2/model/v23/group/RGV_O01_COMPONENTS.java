...
/**
 * <p>Represents a RGV_O01_COMPONENTS group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: RXC (Pharmacy component order segment) <b> repeating </b></li>
                         * <li>2: NTE (Notes and comments segment) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class RGV_O01_COMPONENTS extends AbstractGroup {

    /** 
     * Creates a new RGV_O01_COMPONENTS group
     */
    public RGV_O01_COMPONENTS(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RGV_O01_COMPONENTS - this is probably a bug in the source code generator.", e);
       }
    }
