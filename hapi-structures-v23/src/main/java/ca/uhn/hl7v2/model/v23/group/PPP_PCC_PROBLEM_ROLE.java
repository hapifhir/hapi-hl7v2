...
/**
 * <p>Represents a PPP_PCC_PROBLEM_ROLE group structure (a Group object).
...
public class PPP_PCC_PROBLEM_ROLE extends AbstractGroup {

    /** 
     * Creates a new PPP_PCC_PROBLEM_ROLE group
     */
    public PPP_PCC_PROBLEM_ROLE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PPP_PCC_PROBLEM_ROLE - this is probably a bug in the source code generator.", e);
       }
    }
