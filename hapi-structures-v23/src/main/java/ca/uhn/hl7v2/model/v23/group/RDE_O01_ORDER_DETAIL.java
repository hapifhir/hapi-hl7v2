...
/**
 * <p>Represents a RDE_O01_ORDER_DETAIL group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>4: RDE_O01_COMPONENT (a Group object) <b>optional  </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class RDE_O01_ORDER_DETAIL extends AbstractGroup {

    /** 
     * Creates a new RDE_O01_ORDER_DETAIL group
     */
    public RDE_O01_ORDER_DETAIL(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(RDE_O01_COMPONENT.class, false, false, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating RDE_O01_ORDER_DETAIL - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     */
    public RDE_O01_COMPONENT getCOMPONENT() { 
       RDE_O01_COMPONENT retVal = getTyped("COMPONENT", RDE_O01_COMPONENT.class);
       return retVal;
    }
