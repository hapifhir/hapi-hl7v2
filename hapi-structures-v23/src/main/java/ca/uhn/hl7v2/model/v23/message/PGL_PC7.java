...
/**
 * <p>Represents a PGL_PC7 message structure (see chapter ?). This structure contains the 
 * following elements: </p>
 * <ul>
		                 * <li>1: MSH (Message header segment) <b> </b> </li>
		                 * <li>2: PID (Patient Identification) <b> </b> </li>
		                 * <li>3: PGL_PC7_PATIENT_VISIT (a Group object) <b>optional </b> </li>
		                 * <li>4: PGL_PC7_GOAL (a Group object) <b> repeating</b> </li>
 * </ul>
 */
...
public class PGL_PC7 extends AbstractMessage  {
    ...
    /**
     * Creates a new PGL_PC7 message with DefaultModelClassFactory. 
     */ 
    public PGL_PC7() { 
    ...
    /** 
     * Creates a new PGL_PC7 message with custom ModelClassFactory.
     */
    ...
    public PGL_PC7_PATIENT_VISIT getPATIENT_VISIT() { 
       return getTyped("PATIENT_VISIT", PGL_PC7_PATIENT_VISIT.class);
    }
    ...
    public PGL_PC7_GOAL getGOAL() { 
       return getTyped("GOAL", PGL_PC7_GOAL.class);
    }
    ...
    public PGL_PC7_GOAL getGOAL(int rep) { 
       return getTyped("GOAL", rep, PGL_PC7_GOAL.class);
    }
     ...
     * 
     */ 
    public java.util.List<PGL_PC7_GOAL> getGOALAll() throws HL7Exception {
    	return getAllAsList("GOAL", PGL_PC7_GOAL.class);
    } 
