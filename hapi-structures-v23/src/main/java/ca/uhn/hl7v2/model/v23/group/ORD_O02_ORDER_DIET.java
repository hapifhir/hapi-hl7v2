...
/**
 * <p>Represents a ORD_O02_ORDER_DIET group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: ORC (Common order segment) <b>  </b></li>
                         * <li>2: ODS (Dietary orders, supplements, and preferences) <b>optional repeating </b></li>
                         * <li>3: NTE (Notes and comments segment) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class ORD_O02_ORDER_DIET extends AbstractGroup {

    /** 
     * Creates a new ORD_O02_ORDER_DIET group
     */
    public ORD_O02_ORDER_DIET(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ORD_O02_ORDER_DIET - this is probably a bug in the source code generator.", e);
       }
    }
