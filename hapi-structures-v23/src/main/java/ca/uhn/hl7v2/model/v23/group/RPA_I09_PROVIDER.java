...
/**
 * <p>Represents a RPA_I09_PROVIDER group structure (a Group object).
...
public class RPA_I09_PROVIDER extends AbstractGroup {

    /** 
     * Creates a new RPA_I09_PROVIDER group
     */
    public RPA_I09_PROVIDER(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RPA_I09_PROVIDER - this is probably a bug in the source code generator.", e);
       }
    }
