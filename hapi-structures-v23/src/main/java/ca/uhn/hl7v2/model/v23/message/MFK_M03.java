 ...
 * <ul>
		                 ...
		                 * <li>4: MFI (Master file identification segment) <b> </b> </li>
...
public class MFK_M03 extends AbstractMessage  {
    ...
    /**
     * Creates a new MFK_M03 message with DefaultModelClassFactory. 
     */ 
    public MFK_M03() { 
    ...
    /** 
     * Creates a new MFK_M03 message with custom ModelClassFactory.
     */
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating MFK_M03 - this is probably a bug in the source code generator.", e);
       }
    }
