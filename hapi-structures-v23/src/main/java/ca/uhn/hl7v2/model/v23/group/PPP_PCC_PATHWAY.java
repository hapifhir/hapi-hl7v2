...
/**
 * <p>Represents a PPP_PCC_PATHWAY group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>4: PPP_PCC_PATHWAY_ROLE (a Group object) <b>optional repeating </b></li>
                         * <li>5: PPP_PCC_PROBLEM (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class PPP_PCC_PATHWAY extends AbstractGroup {

    /** 
     * Creates a new PPP_PCC_PATHWAY group
     */
    public PPP_PCC_PATHWAY(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(PPP_PCC_PATHWAY_ROLE.class, false, true, false);
                                  this.add(PPP_PCC_PROBLEM.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating PPP_PCC_PATHWAY - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public PPP_PCC_PATHWAY_ROLE getPATHWAY_ROLE() { 
       PPP_PCC_PATHWAY_ROLE retVal = getTyped("PATHWAY_ROLE", PPP_PCC_PATHWAY_ROLE.class);
       return retVal;
    }
    ...
    public PPP_PCC_PATHWAY_ROLE getPATHWAY_ROLE(int rep) { 
       PPP_PCC_PATHWAY_ROLE retVal = getTyped("PATHWAY_ROLE", rep, PPP_PCC_PATHWAY_ROLE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PPP_PCC_PATHWAY_ROLE> getPATHWAY_ROLEAll() throws HL7Exception {
    	return getAllAsList("PATHWAY_ROLE", PPP_PCC_PATHWAY_ROLE.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertPATHWAY_ROLE(PPP_PCC_PATHWAY_ROLE structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public PPP_PCC_PATHWAY_ROLE insertPATHWAY_ROLE(int rep) throws HL7Exception { 
       return (PPP_PCC_PATHWAY_ROLE)super.insertRepetition("PATHWAY_ROLE", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public PPP_PCC_PATHWAY_ROLE removePATHWAY_ROLE(int rep) throws HL7Exception { 
       return (PPP_PCC_PATHWAY_ROLE)super.removeRepetition("PATHWAY_ROLE", rep);
    }
    ...
    public PPP_PCC_PROBLEM getPROBLEM() { 
       PPP_PCC_PROBLEM retVal = getTyped("PROBLEM", PPP_PCC_PROBLEM.class);
       return retVal;
    }
    ...
    public PPP_PCC_PROBLEM getPROBLEM(int rep) { 
       PPP_PCC_PROBLEM retVal = getTyped("PROBLEM", rep, PPP_PCC_PROBLEM.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PPP_PCC_PROBLEM> getPROBLEMAll() throws HL7Exception {
    	return getAllAsList("PROBLEM", PPP_PCC_PROBLEM.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertPROBLEM(PPP_PCC_PROBLEM structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public PPP_PCC_PROBLEM insertPROBLEM(int rep) throws HL7Exception { 
       return (PPP_PCC_PROBLEM)super.insertRepetition("PROBLEM", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public PPP_PCC_PROBLEM removePROBLEM(int rep) throws HL7Exception { 
       return (PPP_PCC_PROBLEM)super.removeRepetition("PROBLEM", rep);
    }
