...
/**
 * <p>Represents a EDR_Q01 message structure (see chapter ?). This structure contains the 
 ...
 * <ul>
		                 ...
		                 * <li>5: DSP (Display data segment) <b> repeating</b> </li>
...
public class EDR_Q01 extends AbstractMessage  {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating EDR_Q01 - this is probably a bug in the source code generator.", e);
       }
    }
