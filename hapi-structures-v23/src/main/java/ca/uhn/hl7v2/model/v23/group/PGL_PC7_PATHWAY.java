...
/**
 * <p>Represents a PGL_PC7_PATHWAY group structure (a Group object).
...
public class PGL_PC7_PATHWAY extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PGL_PC7_PATHWAY - this is probably a bug in the source code generator.", e);
       }
    }
