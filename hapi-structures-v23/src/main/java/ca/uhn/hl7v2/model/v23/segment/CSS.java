...
/**
 *<p>Represents an HL7 CSS message segment (Clinical Study Data Schedule). 
 * This segment has the following fields:</p>
 * <ul>
     * <li>CSS-1: Study Scheduled Time Point (CE) <b>optional </b>
...
public class CSS extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(CE.class, false, 1, 60, new Object[]{ getMessage() }, "Study Scheduled Time Point");
                                  this.add(TS.class, false, 1, 26, new Object[]{ getMessage() }, "Study Scheduled Patient Time Point");
                                  this.add(CE.class, false, 3, 60, new Object[]{ getMessage() }, "Study Quality Control Codes");
