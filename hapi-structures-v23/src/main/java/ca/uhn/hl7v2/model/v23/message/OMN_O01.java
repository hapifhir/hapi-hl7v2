 ...
 * <ul>
		                 ...
		                 * <li>3: OMN_O01_PATIENT (a Group object) <b>optional </b> </li>
		                 * <li>4: OMN_O01_ORDER (a Group object) <b> repeating</b> </li>
 * </ul>
 */
...
public class OMN_O01 extends AbstractMessage  {
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(OMN_O01_PATIENT.class, false, false);
	                          this.add(OMN_O01_ORDER.class, true, true);
     ...
     *
     */
    public OMN_O01_PATIENT getPATIENT() { 
       return getTyped("PATIENT", OMN_O01_PATIENT.class);
    }
    ...
    public OMN_O01_ORDER getORDER() { 
       return getTyped("ORDER", OMN_O01_ORDER.class);
    }
    ...
    public OMN_O01_ORDER getORDER(int rep) { 
       return getTyped("ORDER", rep, OMN_O01_ORDER.class);
    }
     ...
     * 
     */ 
    public java.util.List<OMN_O01_ORDER> getORDERAll() throws HL7Exception {
    	return getAllAsList("ORDER", OMN_O01_ORDER.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertORDER(OMN_O01_ORDER structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public OMN_O01_ORDER insertORDER(int rep) throws HL7Exception { 
       return (OMN_O01_ORDER)super.insertRepetition("ORDER", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public OMN_O01_ORDER removeORDER(int rep) throws HL7Exception { 
       return (OMN_O01_ORDER)super.removeRepetition("ORDER", rep);
    }
