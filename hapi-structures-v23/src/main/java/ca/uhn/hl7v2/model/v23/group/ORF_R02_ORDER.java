...
/**
 * <p>Represents a ORF_R02_ORDER group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: ORC (Common order segment) <b>optional  </b></li>
                         * <li>2: OBR (Observation request segment) <b>  </b></li>
                         * <li>3: NTE (Notes and comments segment) <b>optional repeating </b></li>
                         * <li>4: ORF_R02_OBSERVATION (a Group object) <b> repeating </b></li>
                         * <li>5: CTI (Clinical Trial Identification) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class ORF_R02_ORDER extends AbstractGroup {

    /** 
     * Creates a new ORF_R02_ORDER group
     */
    public ORF_R02_ORDER(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(ORF_R02_OBSERVATION.class, true, true, false);
                                  this.add(CTI.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating ORF_R02_ORDER - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public ORF_R02_OBSERVATION getOBSERVATION() { 
       ORF_R02_OBSERVATION retVal = getTyped("OBSERVATION", ORF_R02_OBSERVATION.class);
       return retVal;
    }
    ...
    public ORF_R02_OBSERVATION getOBSERVATION(int rep) { 
       ORF_R02_OBSERVATION retVal = getTyped("OBSERVATION", rep, ORF_R02_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<ORF_R02_OBSERVATION> getOBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("OBSERVATION", ORF_R02_OBSERVATION.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertOBSERVATION(ORF_R02_OBSERVATION structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public ORF_R02_OBSERVATION insertOBSERVATION(int rep) throws HL7Exception { 
       return (ORF_R02_OBSERVATION)super.insertRepetition("OBSERVATION", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public ORF_R02_OBSERVATION removeOBSERVATION(int rep) throws HL7Exception { 
       return (ORF_R02_OBSERVATION)super.removeRepetition("OBSERVATION", rep);
    }
