...
/**
 * <p>Represents a ADT_A41_PATIENT group structure (a Group object).
...
public class ADT_A41_PATIENT extends AbstractGroup {
     ...
     */
    public ADT_A41_PATIENT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ADT_A41_PATIENT - this is probably a bug in the source code generator.", e);
       }
    }
