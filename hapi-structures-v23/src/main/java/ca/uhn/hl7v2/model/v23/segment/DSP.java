...
/**
 *<p>Represents an HL7 DSP message segment (Display data segment). 
 * This segment has the following fields:</p>
 * <ul>
     * <li>DSP-1: Set ID - Display Data (SI) <b>optional </b>
...
public class DSP extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(SI.class, false, 1, 4, new Object[]{ getMessage() }, "Set ID - Display Data");
