...
/**
 *<p>Represents an HL7 PRA message segment (Practitioner detail segment). 
 * This segment has the following fields:</p>
 * <ul>
     * <li>PRA-1: PRA - Primary Key Value (ST) <b> </b>
     * <li>PRA-2: Practioner Group (CE) <b>optional repeating</b>
     * <li>PRA-3: Practioner Category (ID) <b>optional repeating</b>
...
public class PRA extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CE.class, false, 0, 60, new Object[]{ getMessage() }, "Practioner Group");
                                              this.add(ID.class, false, 0, 3, new Object[]{ getMessage(), new Integer(0) }, "Practioner Category");
                                              this.add(ID.class, false, 1, 1, new Object[]{ getMessage(), new Integer(186) }, "Provider Billing");
                                  ...
                                  this.add(CM_PIP.class, false, 0, 200, new Object[]{ getMessage() }, "Privileges");
