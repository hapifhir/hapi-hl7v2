 ...
 * <ul>
		                 ...
		                 * <li>13: ADT_A13_PROCEDURE (a Group object) <b>optional repeating</b> </li>
		                 * <li>14: GT1 (Guarantor) <b>optional repeating</b> </li>
		                 * <li>15: ADT_A13_INSURANCE (a Group object) <b>optional repeating</b> </li>
...
public class ADT_A13 extends AbstractMessage  {
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(ADT_A13_PROCEDURE.class, false, true);
    ...
    public ADT_A13_PROCEDURE getPROCEDURE() { 
       return getTyped("PROCEDURE", ADT_A13_PROCEDURE.class);
    }
    ...
    public ADT_A13_PROCEDURE getPROCEDURE(int rep) { 
       return getTyped("PROCEDURE", rep, ADT_A13_PROCEDURE.class);
    }
     ...
     * 
     */ 
    public java.util.List<ADT_A13_PROCEDURE> getPROCEDUREAll() throws HL7Exception {
    	return getAllAsList("PROCEDURE", ADT_A13_PROCEDURE.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertPROCEDURE(ADT_A13_PROCEDURE structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public ADT_A13_PROCEDURE insertPROCEDURE(int rep) throws HL7Exception { 
       return (ADT_A13_PROCEDURE)super.insertRepetition("PROCEDURE", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public ADT_A13_PROCEDURE removePROCEDURE(int rep) throws HL7Exception { 
       return (ADT_A13_PROCEDURE)super.removeRepetition("PROCEDURE", rep);
    }
