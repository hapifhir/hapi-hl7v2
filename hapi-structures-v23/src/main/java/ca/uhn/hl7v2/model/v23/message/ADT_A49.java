...
/**
 * <p>Represents a ADT_A49 message structure (see chapter ?). This structure contains the 
...
public class ADT_A49 extends AbstractMessage  {

    /**
     * Creates a new ADT_A49 message with DefaultModelClassFactory. 
     */ 
    public ADT_A49() { 
    ...
    /** 
     * Creates a new ADT_A49 message with custom ModelClassFactory.
     */
    public ADT_A49(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ADT_A49 - this is probably a bug in the source code generator.", e);
       }
    }
