...
/**
 * <p>Represents a PPP_PCD message structure (see chapter ?). This structure contains the 
 * following elements: </p>
 * <ul>
		                 * <li>1: MSH (Message header segment) <b> </b> </li>
		                 * <li>2: PID (Patient Identification) <b> </b> </li>
		                 * <li>3: PPP_PCD_PATIENT_VISIT (a Group object) <b>optional </b> </li>
		                 * <li>4: PPP_PCD_PATHWAY (a Group object) <b> repeating</b> </li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class PPP_PCD extends AbstractMessage  {

    /**
     * Creates a new PPP_PCD message with DefaultModelClassFactory. 
     */ 
    public PPP_PCD() { 
    ...
    /** 
     * Creates a new PPP_PCD message with custom ModelClassFactory.
     */
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PPP_PCD - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public PPP_PCD_PATIENT_VISIT getPATIENT_VISIT() { 
       return getTyped("PATIENT_VISIT", PPP_PCD_PATIENT_VISIT.class);
    }
    ...
    public PPP_PCD_PATHWAY getPATHWAY() { 
       return getTyped("PATHWAY", PPP_PCD_PATHWAY.class);
    }
    ...
    public PPP_PCD_PATHWAY getPATHWAY(int rep) { 
       return getTyped("PATHWAY", rep, PPP_PCD_PATHWAY.class);
    }
     ...
     * 
     */ 
    public java.util.List<PPP_PCD_PATHWAY> getPATHWAYAll() throws HL7Exception {
    	return getAllAsList("PATHWAY", PPP_PCD_PATHWAY.class);
    } 
