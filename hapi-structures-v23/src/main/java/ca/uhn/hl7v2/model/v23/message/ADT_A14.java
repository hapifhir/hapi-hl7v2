 ...
 * <ul>
		                 ...
		                 * <li>8: DB1 (Disability Segment) <b>optional repeating</b> </li>
		                 * <li>9: OBX (Observation segment) <b>optional repeating</b> </li>
		                 ...
		                 * <li>13: ADT_A14_PROCEDURE (a Group object) <b>optional repeating</b> </li>
		                 * <li>14: GT1 (Guarantor) <b>optional repeating</b> </li>
		                 * <li>15: ADT_A14_INSURANCE (a Group object) <b>optional repeating</b> </li>
		                 * <li>16: ACC (Accident) <b>optional </b> </li>
		                 * <li>17: UB1 (UB82  data) <b>optional </b> </li>
		                 * <li>18: UB2 (UB92 data) <b>optional </b> </li>
 * </ul>
 */
...
public class ADT_A14 extends AbstractMessage  {
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(ADT_A14_PROCEDURE.class, false, true);
	                          this.add(GT1.class, false, true);
	                          this.add(ADT_A14_INSURANCE.class, false, true);
    ...
    public ADT_A14_PROCEDURE getPROCEDURE() { 
       return getTyped("PROCEDURE", ADT_A14_PROCEDURE.class);
    }
    ...
    public ADT_A14_PROCEDURE getPROCEDURE(int rep) { 
       return getTyped("PROCEDURE", rep, ADT_A14_PROCEDURE.class);
    }
     ...
     * 
     */ 
    public java.util.List<ADT_A14_PROCEDURE> getPROCEDUREAll() throws HL7Exception {
    	return getAllAsList("PROCEDURE", ADT_A14_PROCEDURE.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertPROCEDURE(ADT_A14_PROCEDURE structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public ADT_A14_PROCEDURE insertPROCEDURE(int rep) throws HL7Exception { 
       return (ADT_A14_PROCEDURE)super.insertRepetition("PROCEDURE", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public ADT_A14_PROCEDURE removePROCEDURE(int rep) throws HL7Exception { 
       return (ADT_A14_PROCEDURE)super.removeRepetition("PROCEDURE", rep);
    }
    ...
    public ADT_A14_INSURANCE getINSURANCE() { 
       return getTyped("INSURANCE", ADT_A14_INSURANCE.class);
    }
    ...
    public ADT_A14_INSURANCE getINSURANCE(int rep) { 
       return getTyped("INSURANCE", rep, ADT_A14_INSURANCE.class);
    }
     ...
     * 
     */ 
    public java.util.List<ADT_A14_INSURANCE> getINSURANCEAll() throws HL7Exception {
    	return getAllAsList("INSURANCE", ADT_A14_INSURANCE.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertINSURANCE(ADT_A14_INSURANCE structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public ADT_A14_INSURANCE insertINSURANCE(int rep) throws HL7Exception { 
       return (ADT_A14_INSURANCE)super.insertRepetition("INSURANCE", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public ADT_A14_INSURANCE removeINSURANCE(int rep) throws HL7Exception { 
       return (ADT_A14_INSURANCE)super.removeRepetition("INSURANCE", rep);
    }
