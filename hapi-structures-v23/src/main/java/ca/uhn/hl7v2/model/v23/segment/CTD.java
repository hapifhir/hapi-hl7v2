 ...
 * <ul>
     ...
     * <li>CTD-7: Contact Identifiers (CM_PI) <b>optional repeating</b>
 * </ul>
 */
...
public class CTD extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(XTN.class, false, 0, 20, new Object[]{ getMessage() }, "Contact Communication Information");
                                  this.add(CE.class, false, 1, 200, new Object[]{ getMessage() }, "Preferred Method of Contact");
                                  this.add(CM_PI.class, false, 0, 100, new Object[]{ getMessage() }, "Contact Identifiers");
