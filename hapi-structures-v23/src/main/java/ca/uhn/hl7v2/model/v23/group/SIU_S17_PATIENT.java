...
/**
 * <p>Represents a SIU_S17_PATIENT group structure (a Group object).
...
public class SIU_S17_PATIENT extends AbstractGroup {

    /** 
     * Creates a new SIU_S17_PATIENT group
     */
    public SIU_S17_PATIENT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating SIU_S17_PATIENT - this is probably a bug in the source code generator.", e);
       }
    }
