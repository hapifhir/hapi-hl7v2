...
/**
 * <p>Represents a RRI_I15_PROCEDURE group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: PR1 (Procedures) <b>  </b></li>
                         * <li>2: RRI_I15_AUTHORIZATION (a Group object) <b>optional  </b></li>
 * </ul>
 */
...
public class RRI_I15_PROCEDURE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(RRI_I15_AUTHORIZATION.class, false, false, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating RRI_I15_PROCEDURE - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public RRI_I15_AUTHORIZATION getAUTHORIZATION() { 
       RRI_I15_AUTHORIZATION retVal = getTyped("AUTHORIZATION", RRI_I15_AUTHORIZATION.class);
       return retVal;
    }
