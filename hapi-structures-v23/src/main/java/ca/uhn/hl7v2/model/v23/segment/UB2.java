 ...
 * <ul>
     ...
     * <li>UB2-6: Value Amount & Code (CM_UVC) <b>optional repeating</b>
     * <li>UB2-7: Occurrence Code & Date (32-35) (CM_OCD) <b>optional repeating</b>
...
public class UB2 extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CM_UVC.class, false, 12, 11, new Object[]{ getMessage() }, "Value Amount & Code");
                                  this.add(CM_OCD.class, false, 8, 11, new Object[]{ getMessage() }, "Occurrence Code & Date (32-35)");
     ...
     * Returns all repetitions of Value Amount & Code (UB2-6).
     */
    public CM_UVC[] getUb26_ValueAmountCode() {
    	CM_UVC[] retVal = this.getTypedField(6, new CM_UVC[0]);
    	return retVal;
    }
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public CM_UVC insertUb26_ValueAmountCode(int rep) throws HL7Exception { 
        return (CM_UVC) super.insertRepetition(6, rep);
    }
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public CM_UVC removeUb26_ValueAmountCode(int rep) throws HL7Exception { 
        return (CM_UVC) super.removeRepetition(6, rep);
    }
     ...
     * Returns all repetitions of Occurrence Code & Date (32-35) (UB2-7).
     */
    public CM_OCD[] getUb27_OccurrenceCodeDate3235() {
    	CM_OCD[] retVal = this.getTypedField(7, new CM_OCD[0]);
    	return retVal;
    }
     ...
     * @param rep The repetition index (0-indexed)
     */
    public CM_OCD getUb27_OccurrenceCodeDate3235(int rep) { 
		CM_OCD retVal = this.getTypedField(7, rep);
		return retVal;
    }
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public CM_OCD insertOccurrenceCodeDate3235(int rep) throws HL7Exception { 
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public CM_OCD insertUb27_OccurrenceCodeDate3235(int rep) throws HL7Exception { 
        return (CM_OCD) super.insertRepetition(7, rep);
    }
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public CM_OCD removeOccurrenceCodeDate3235(int rep) throws HL7Exception { 
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public CM_OCD removeUb27_OccurrenceCodeDate3235(int rep) throws HL7Exception { 
        return (CM_OCD) super.removeRepetition(7, rep);
    }
