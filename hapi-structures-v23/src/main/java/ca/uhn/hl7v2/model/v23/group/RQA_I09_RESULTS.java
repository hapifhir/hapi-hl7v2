...
/**
 * <p>Represents a RQA_I09_RESULTS group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>3: RQA_I09_OBSERVATION (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
...
public class RQA_I09_RESULTS extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RQA_I09_RESULTS - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public RQA_I09_OBSERVATION getOBSERVATION() { 
       RQA_I09_OBSERVATION retVal = getTyped("OBSERVATION", RQA_I09_OBSERVATION.class);
       return retVal;
    }
    ...
    public RQA_I09_OBSERVATION getOBSERVATION(int rep) { 
       RQA_I09_OBSERVATION retVal = getTyped("OBSERVATION", rep, RQA_I09_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<RQA_I09_OBSERVATION> getOBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("OBSERVATION", RQA_I09_OBSERVATION.class);
    } 
