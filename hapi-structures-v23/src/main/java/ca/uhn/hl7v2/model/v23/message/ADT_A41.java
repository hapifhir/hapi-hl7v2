 ...
 * <ul>
		                 ...
		                 * <li>3: ADT_A41_PATIENT (a Group object) <b> repeating</b> </li>
 * </ul>
 */
...
public class ADT_A41 extends AbstractMessage  {
    ...
    public ADT_A41_PATIENT getPATIENT() { 
       return getTyped("PATIENT", ADT_A41_PATIENT.class);
    }
    ...
    public ADT_A41_PATIENT getPATIENT(int rep) { 
       return getTyped("PATIENT", rep, ADT_A41_PATIENT.class);
    }
     ...
     * 
     */ 
    public java.util.List<ADT_A41_PATIENT> getPATIENTAll() throws HL7Exception {
    	return getAllAsList("PATIENT", ADT_A41_PATIENT.class);
    } 
     ...
     */
    public void insertPATIENT(ADT_A41_PATIENT structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public ADT_A41_PATIENT insertPATIENT(int rep) throws HL7Exception { 
       return (ADT_A41_PATIENT)super.insertRepetition("PATIENT", rep);
    }
     ...
     */
    public ADT_A41_PATIENT removePATIENT(int rep) throws HL7Exception { 
       return (ADT_A41_PATIENT)super.removeRepetition("PATIENT", rep);
    }
