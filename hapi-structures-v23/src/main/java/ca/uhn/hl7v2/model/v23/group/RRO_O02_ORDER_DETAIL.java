...
/**
 * <p>Represents a RRO_O02_ORDER_DETAIL group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>4: RXC (Pharmacy component order segment) <b>optional repeating </b></li>
...
public class RRO_O02_ORDER_DETAIL extends AbstractGroup {
     ...
     */
    public RRO_O02_ORDER_DETAIL(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RRO_O02_ORDER_DETAIL - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * Returns
     * the first repetition of 
     * NTE2 (Notes and comments segment) - creates it if necessary
     */
    public NTE getNTE2() { 
