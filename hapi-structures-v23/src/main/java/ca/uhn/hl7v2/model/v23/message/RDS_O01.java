 ...
 * <ul>
		                 ...
		                 * <li>3: RDS_O01_PATIENT (a Group object) <b>optional </b> </li>
		                 * <li>4: RDS_O01_ORDER (a Group object) <b> repeating</b> </li>
 * </ul>
 */
...
public class RDS_O01 extends AbstractMessage  {
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(RDS_O01_PATIENT.class, false, false);
	                          this.add(RDS_O01_ORDER.class, true, true);
     ...
     *
     */
    public RDS_O01_PATIENT getPATIENT() { 
       return getTyped("PATIENT", RDS_O01_PATIENT.class);
    }
    ...
    public RDS_O01_ORDER getORDER() { 
       return getTyped("ORDER", RDS_O01_ORDER.class);
    }
    ...
    public RDS_O01_ORDER getORDER(int rep) { 
       return getTyped("ORDER", rep, RDS_O01_ORDER.class);
    }
     ...
     * 
     */ 
    public java.util.List<RDS_O01_ORDER> getORDERAll() throws HL7Exception {
    	return getAllAsList("ORDER", RDS_O01_ORDER.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertORDER(RDS_O01_ORDER structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public RDS_O01_ORDER insertORDER(int rep) throws HL7Exception { 
       return (RDS_O01_ORDER)super.insertRepetition("ORDER", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public RDS_O01_ORDER removeORDER(int rep) throws HL7Exception { 
       return (RDS_O01_ORDER)super.removeRepetition("ORDER", rep);
    }
