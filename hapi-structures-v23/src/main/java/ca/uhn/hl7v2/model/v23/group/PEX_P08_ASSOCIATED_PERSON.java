...
/**
 * <p>Represents a PEX_P08_ASSOCIATED_PERSON group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: NK1 (Next of kin) <b>  </b></li>
                         * <li>2: PEX_P08_ASSOCIATED_RX_ORDER (a Group object) <b>optional  </b></li>
                         * <li>3: PEX_P08_ASSOCIATED_RX_ADMIN (a Group object) <b>optional repeating </b></li>
                         * <li>4: PRB (Problem Detail) <b>optional repeating </b></li>
                         * <li>5: OBX (Observation segment) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class PEX_P08_ASSOCIATED_PERSON extends AbstractGroup {

    /** 
     * Creates a new PEX_P08_ASSOCIATED_PERSON group
     */
    public PEX_P08_ASSOCIATED_PERSON(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(PEX_P08_ASSOCIATED_RX_ORDER.class, false, false, false);
                                  this.add(PEX_P08_ASSOCIATED_RX_ADMIN.class, false, true, false);
                                  this.add(PRB.class, false, true, false);
                                  this.add(OBX.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating PEX_P08_ASSOCIATED_PERSON - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     */
    public PEX_P08_ASSOCIATED_RX_ORDER getASSOCIATED_RX_ORDER() { 
       PEX_P08_ASSOCIATED_RX_ORDER retVal = getTyped("ASSOCIATED_RX_ORDER", PEX_P08_ASSOCIATED_RX_ORDER.class);
       return retVal;
    }
    ...
    public PEX_P08_ASSOCIATED_RX_ADMIN getASSOCIATED_RX_ADMIN() { 
       PEX_P08_ASSOCIATED_RX_ADMIN retVal = getTyped("ASSOCIATED_RX_ADMIN", PEX_P08_ASSOCIATED_RX_ADMIN.class);
       return retVal;
    }
    ...
    public PEX_P08_ASSOCIATED_RX_ADMIN getASSOCIATED_RX_ADMIN(int rep) { 
       PEX_P08_ASSOCIATED_RX_ADMIN retVal = getTyped("ASSOCIATED_RX_ADMIN", rep, PEX_P08_ASSOCIATED_RX_ADMIN.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PEX_P08_ASSOCIATED_RX_ADMIN> getASSOCIATED_RX_ADMINAll() throws HL7Exception {
    	return getAllAsList("ASSOCIATED_RX_ADMIN", PEX_P08_ASSOCIATED_RX_ADMIN.class);
    } 
     ...
     */
    public void insertASSOCIATED_RX_ADMIN(PEX_P08_ASSOCIATED_RX_ADMIN structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public PEX_P08_ASSOCIATED_RX_ADMIN insertASSOCIATED_RX_ADMIN(int rep) throws HL7Exception { 
       return (PEX_P08_ASSOCIATED_RX_ADMIN)super.insertRepetition("ASSOCIATED_RX_ADMIN", rep);
    }
     ...
     */
    public PEX_P08_ASSOCIATED_RX_ADMIN removeASSOCIATED_RX_ADMIN(int rep) throws HL7Exception { 
       return (PEX_P08_ASSOCIATED_RX_ADMIN)super.removeRepetition("ASSOCIATED_RX_ADMIN", rep);
    }
