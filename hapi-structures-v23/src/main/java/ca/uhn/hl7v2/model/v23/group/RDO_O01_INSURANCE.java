...
/**
 * <p>Represents a RDO_O01_INSURANCE group structure (a Group object).
...
public class RDO_O01_INSURANCE extends AbstractGroup {

    /** 
     * Creates a new RDO_O01_INSURANCE group
     */
    public RDO_O01_INSURANCE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RDO_O01_INSURANCE - this is probably a bug in the source code generator.", e);
       }
    }
