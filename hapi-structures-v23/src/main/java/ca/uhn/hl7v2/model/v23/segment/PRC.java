 ...
 * <ul>
     * <li>PRC-1: Primary Key Value (CE) <b> </b>
     * <li>PRC-2: Facility ID (EI) <b> repeating</b>
     * <li>PRC-3: Department (CE) <b>optional repeating</b>
     * <li>PRC-4: Valid Patient Classes (ID) <b>optional repeating</b>
     ...
     * <li>PRC-13: Price Override Flag (ID) <b>optional </b>
     ...
     * <li>PRC-18: Charge On Indicator (ID) <b>optional </b>
 * </ul>
 */
...
public class PRC extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(CE.class, true, 1, 200, new Object[]{ getMessage() }, "Primary Key Value");
                                  this.add(EI.class, true, 0, 60, new Object[]{ getMessage() }, "Facility ID");
                                  this.add(CE.class, false, 0, 30, new Object[]{ getMessage() }, "Department");
                                  ...
                                  this.add(TS.class, false, 1, 26, new Object[]{ getMessage() }, "Effective End Date");
                                              this.add(ID.class, false, 1, 1, new Object[]{ getMessage(), new Integer(268) }, "Price Override Flag");
                                  this.add(CE.class, false, 0, 60, new Object[]{ getMessage() }, "Billing Category");
                                  ...
                                  this.add(MO.class, false, 1, 12, new Object[]{ getMessage() }, "Cost");
                                              this.add(ID.class, false, 1, 1, new Object[]{ getMessage(), new Integer(269) }, "Charge On Indicator");
    ...
    /**
     * Returns
     * PRC-1: "Primary Key Value" - creates it if necessary
     */
    ...
    /**
     * Returns a count of the current number of repetitions of Facility ID (PRC-2).
     ...
     * PRC-2: "Facility ID" - creates it if necessary
     *
     ...
     * PRC-2: "Facility ID" at a specific index
     *
     * @param rep The repetition index (0-indexed)
    ...
    protected Type createNewTypeWithoutReflection(int field) {
       switch (field) {
          ...
          case 3: return new ID(getMessage(), new Integer( 4 ));
          ...
          case 12: return new ID(getMessage(), new Integer( 268 ));
          ...
          case 17: return new ID(getMessage(), new Integer( 269 ));
          default: return null;
       }
   }
