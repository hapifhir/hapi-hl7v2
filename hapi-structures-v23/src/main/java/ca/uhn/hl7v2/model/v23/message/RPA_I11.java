...
/**
 * <p>Represents a RPA_I11 message structure (see chapter ?). This structure contains the 
 ...
 * <ul>
		                 ...
		                 * <li>4: RPA_I11_AUTHORIZATION (a Group object) <b>optional </b> </li>
		                 * <li>5: RPA_I11_PROVIDER (a Group object) <b> repeating</b> </li>
		                 ...
		                 * <li>9: RPA_I11_INSURANCE (a Group object) <b>optional repeating</b> </li>
		                 ...
		                 * <li>14: RPA_I11_PROCEDURE (a Group object) <b> repeating</b> </li>
		                 * <li>15: RPA_I11_RESULTS (a Group object) <b>optional repeating</b> </li>
		                 * <li>16: RPA_I11_VISIT (a Group object) <b>optional </b> </li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class RPA_I11 extends AbstractMessage  {

    /**
     * Creates a new RPA_I11 message with DefaultModelClassFactory. 
     */ 
    public RPA_I11() { 
    ...
    /** 
     * Creates a new RPA_I11 message with custom ModelClassFactory.
     */
    public RPA_I11(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(RPA_I11_AUTHORIZATION.class, false, false);
	                          this.add(RPA_I11_PROVIDER.class, true, true);
	                          this.add(PID.class, true, false);
	                          this.add(NK1.class, false, true);
	                          this.add(GT1.class, false, true);
	                          this.add(RPA_I11_INSURANCE.class, false, true);
	                          this.add(ACC.class, false, false);
	                          this.add(DG1.class, false, true);
	                          this.add(DRG.class, false, true);
	                          this.add(AL1.class, false, true);
	                          this.add(RPA_I11_PROCEDURE.class, true, true);
	                          this.add(RPA_I11_RESULTS.class, false, true);
	                          this.add(RPA_I11_VISIT.class, false, false);
	       } catch(HL7Exception e) {
          log.error("Unexpected error creating RPA_I11 - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     *
     */
    public RPA_I11_AUTHORIZATION getAUTHORIZATION() { 
       return getTyped("AUTHORIZATION", RPA_I11_AUTHORIZATION.class);
    }
    ...
    public RPA_I11_PROVIDER getPROVIDER() { 
       return getTyped("PROVIDER", RPA_I11_PROVIDER.class);
    }
    ...
    public RPA_I11_PROVIDER getPROVIDER(int rep) { 
       return getTyped("PROVIDER", rep, RPA_I11_PROVIDER.class);
    }
     ...
     * 
     */ 
    public java.util.List<RPA_I11_PROVIDER> getPROVIDERAll() throws HL7Exception {
    	return getAllAsList("PROVIDER", RPA_I11_PROVIDER.class);
    } 
     ...
     */
    public void insertPROVIDER(RPA_I11_PROVIDER structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public RPA_I11_PROVIDER insertPROVIDER(int rep) throws HL7Exception { 
       return (RPA_I11_PROVIDER)super.insertRepetition("PROVIDER", rep);
    }
     ...
     */
    public RPA_I11_PROVIDER removePROVIDER(int rep) throws HL7Exception { 
       return (RPA_I11_PROVIDER)super.removeRepetition("PROVIDER", rep);
    }
    ...
    public RPA_I11_INSURANCE getINSURANCE() { 
       return getTyped("INSURANCE", RPA_I11_INSURANCE.class);
    }
    ...
    public RPA_I11_INSURANCE getINSURANCE(int rep) { 
       return getTyped("INSURANCE", rep, RPA_I11_INSURANCE.class);
    }
     ...
     * 
     */ 
    public java.util.List<RPA_I11_INSURANCE> getINSURANCEAll() throws HL7Exception {
    	return getAllAsList("INSURANCE", RPA_I11_INSURANCE.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertINSURANCE(RPA_I11_INSURANCE structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public RPA_I11_INSURANCE insertINSURANCE(int rep) throws HL7Exception { 
       return (RPA_I11_INSURANCE)super.insertRepetition("INSURANCE", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public RPA_I11_INSURANCE removeINSURANCE(int rep) throws HL7Exception { 
       return (RPA_I11_INSURANCE)super.removeRepetition("INSURANCE", rep);
    }
    ...
    public RPA_I11_PROCEDURE getPROCEDURE() { 
       return getTyped("PROCEDURE", RPA_I11_PROCEDURE.class);
    }
    ...
    public RPA_I11_PROCEDURE getPROCEDURE(int rep) { 
       return getTyped("PROCEDURE", rep, RPA_I11_PROCEDURE.class);
    }
     ...
     * 
     */ 
    public java.util.List<RPA_I11_PROCEDURE> getPROCEDUREAll() throws HL7Exception {
    	return getAllAsList("PROCEDURE", RPA_I11_PROCEDURE.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertPROCEDURE(RPA_I11_PROCEDURE structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public RPA_I11_PROCEDURE insertPROCEDURE(int rep) throws HL7Exception { 
       return (RPA_I11_PROCEDURE)super.insertRepetition("PROCEDURE", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public RPA_I11_PROCEDURE removePROCEDURE(int rep) throws HL7Exception { 
       return (RPA_I11_PROCEDURE)super.removeRepetition("PROCEDURE", rep);
    }
    ...
    public RPA_I11_RESULTS getRESULTS() { 
       return getTyped("RESULTS", RPA_I11_RESULTS.class);
    }
    ...
    public RPA_I11_RESULTS getRESULTS(int rep) { 
       return getTyped("RESULTS", rep, RPA_I11_RESULTS.class);
    }
     ...
     * 
     */ 
    public java.util.List<RPA_I11_RESULTS> getRESULTSAll() throws HL7Exception {
    	return getAllAsList("RESULTS", RPA_I11_RESULTS.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertRESULTS(RPA_I11_RESULTS structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public RPA_I11_RESULTS insertRESULTS(int rep) throws HL7Exception { 
       return (RPA_I11_RESULTS)super.insertRepetition("RESULTS", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public RPA_I11_RESULTS removeRESULTS(int rep) throws HL7Exception { 
       return (RPA_I11_RESULTS)super.removeRepetition("RESULTS", rep);
    }
     ...
     *
     */
    public RPA_I11_VISIT getVISIT() { 
       return getTyped("VISIT", RPA_I11_VISIT.class);
    }
