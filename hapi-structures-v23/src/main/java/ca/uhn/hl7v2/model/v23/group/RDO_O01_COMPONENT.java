...
/**
 * <p>Represents a RDO_O01_COMPONENT group structure (a Group object).
...
public class RDO_O01_COMPONENT extends AbstractGroup {

    /** 
     * Creates a new RDO_O01_COMPONENT group
     */
    public RDO_O01_COMPONENT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RDO_O01_COMPONENT - this is probably a bug in the source code generator.", e);
       }
    }
