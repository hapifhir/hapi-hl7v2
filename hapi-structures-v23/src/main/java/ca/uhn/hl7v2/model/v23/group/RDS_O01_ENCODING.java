...
/**
 * <p>Represents a RDS_O01_ENCODING group structure (a Group object).
...
public class RDS_O01_ENCODING extends AbstractGroup {

    /** 
     * Creates a new RDS_O01_ENCODING group
     */
    public RDS_O01_ENCODING(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RDS_O01_ENCODING - this is probably a bug in the source code generator.", e);
       }
    }
