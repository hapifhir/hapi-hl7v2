...
/**
 * <p>Represents a RQI_I02_PROVIDER group structure (a Group object).
...
public class RQI_I02_PROVIDER extends AbstractGroup {

    /** 
     * Creates a new RQI_I02_PROVIDER group
     */
    public RQI_I02_PROVIDER(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RQI_I02_PROVIDER - this is probably a bug in the source code generator.", e);
       }
    }
