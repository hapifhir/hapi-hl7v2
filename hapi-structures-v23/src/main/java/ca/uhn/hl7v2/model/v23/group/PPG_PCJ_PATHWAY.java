...
/**
 * <p>Represents a PPG_PCJ_PATHWAY group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>4: PPG_PCJ_PATHWAY_ROLE (a Group object) <b>optional repeating </b></li>
                         * <li>5: PPG_PCJ_GOAL (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
...
public class PPG_PCJ_PATHWAY extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(PPG_PCJ_PATHWAY_ROLE.class, false, true, false);
                                  this.add(PPG_PCJ_GOAL.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating PPG_PCJ_PATHWAY - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public PPG_PCJ_PATHWAY_ROLE getPATHWAY_ROLE() { 
       PPG_PCJ_PATHWAY_ROLE retVal = getTyped("PATHWAY_ROLE", PPG_PCJ_PATHWAY_ROLE.class);
       return retVal;
    }
    ...
    public PPG_PCJ_PATHWAY_ROLE getPATHWAY_ROLE(int rep) { 
       PPG_PCJ_PATHWAY_ROLE retVal = getTyped("PATHWAY_ROLE", rep, PPG_PCJ_PATHWAY_ROLE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PPG_PCJ_PATHWAY_ROLE> getPATHWAY_ROLEAll() throws HL7Exception {
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertPATHWAY_ROLE(PPG_PCJ_PATHWAY_ROLE structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public PPG_PCJ_PATHWAY_ROLE insertPATHWAY_ROLE(int rep) throws HL7Exception { 
       return (PPG_PCJ_PATHWAY_ROLE)super.insertRepetition("PATHWAY_ROLE", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public PPG_PCJ_PATHWAY_ROLE removePATHWAY_ROLE(int rep) throws HL7Exception { 
       return (PPG_PCJ_PATHWAY_ROLE)super.removeRepetition("PATHWAY_ROLE", rep);
    }
    ...
    public PPG_PCJ_GOAL getGOAL() { 
       PPG_PCJ_GOAL retVal = getTyped("GOAL", PPG_PCJ_GOAL.class);
       return retVal;
    }
    ...
    public PPG_PCJ_GOAL getGOAL(int rep) { 
       PPG_PCJ_GOAL retVal = getTyped("GOAL", rep, PPG_PCJ_GOAL.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PPG_PCJ_GOAL> getGOALAll() throws HL7Exception {
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertGOAL(PPG_PCJ_GOAL structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public PPG_PCJ_GOAL insertGOAL(int rep) throws HL7Exception { 
       return (PPG_PCJ_GOAL)super.insertRepetition("GOAL", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public PPG_PCJ_GOAL removeGOAL(int rep) throws HL7Exception { 
       return (PPG_PCJ_GOAL)super.removeRepetition("GOAL", rep);
    }
