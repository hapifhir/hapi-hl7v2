...
/**
 *<p>Represents an HL7 RQ1 message segment (Requisition detail-1 segment). 
 * This segment has the following fields:</p>
 * <ul>
     * <li>RQ1-1: Anticipated Price (ST) <b>optional </b>
     * <li>RQ1-2: Manufactured ID (CE) <b>optional </b>
...
public class RQ1 extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CE.class, false, 1, 60, new Object[]{ getMessage() }, "Manufactured ID");
