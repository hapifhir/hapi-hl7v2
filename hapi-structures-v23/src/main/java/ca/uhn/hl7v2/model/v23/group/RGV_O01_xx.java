...
/**
 * <p>Represents a RGV_O01_xx group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: AL1 (Patient allergy information) <b> repeating </b></li>
                         * <li>2: RGV_O01_PATIENT_VISIT (a Group object) <b>optional  </b></li>
 * </ul>
 */
...
public class RGV_O01_xx extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(RGV_O01_PATIENT_VISIT.class, false, false, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating RGV_O01_xx - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public RGV_O01_PATIENT_VISIT getPATIENT_VISIT() { 
       RGV_O01_PATIENT_VISIT retVal = getTyped("PATIENT_VISIT", RGV_O01_PATIENT_VISIT.class);
       return retVal;
    }
