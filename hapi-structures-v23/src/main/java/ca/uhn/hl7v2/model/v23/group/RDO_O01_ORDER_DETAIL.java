...
/**
 * <p>Represents a RDO_O01_ORDER_DETAIL group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: RXO (Pharmacy prescription order segment) <b>  </b></li>
                         * <li>2: NTE (Notes and comments segment) <b>optional repeating </b></li>
                         * <li>3: RXR (Pharmacy route segment) <b> repeating </b></li>
                         * <li>4: RDO_O01_COMPONENT (a Group object) <b>optional  </b></li>
                         * <li>5: RDO_O01_OBSERVATION (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
...
public class RDO_O01_ORDER_DETAIL extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(RDO_O01_COMPONENT.class, false, false, false);
                                  this.add(RDO_O01_OBSERVATION.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating RDO_O01_ORDER_DETAIL - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    /**
     * Returns
     * RXO (Pharmacy prescription order segment) - creates it if necessary
     */
    public RXO getRXO() { 
    ...
    public RDO_O01_COMPONENT getCOMPONENT() { 
       RDO_O01_COMPONENT retVal = getTyped("COMPONENT", RDO_O01_COMPONENT.class);
       return retVal;
    }
    ...
    public RDO_O01_OBSERVATION getOBSERVATION() { 
       RDO_O01_OBSERVATION retVal = getTyped("OBSERVATION", RDO_O01_OBSERVATION.class);
       return retVal;
    }
    ...
    public RDO_O01_OBSERVATION getOBSERVATION(int rep) { 
       RDO_O01_OBSERVATION retVal = getTyped("OBSERVATION", rep, RDO_O01_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<RDO_O01_OBSERVATION> getOBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("OBSERVATION", RDO_O01_OBSERVATION.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertOBSERVATION(RDO_O01_OBSERVATION structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public RDO_O01_OBSERVATION insertOBSERVATION(int rep) throws HL7Exception { 
       return (RDO_O01_OBSERVATION)super.insertRepetition("OBSERVATION", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public RDO_O01_OBSERVATION removeOBSERVATION(int rep) throws HL7Exception { 
       return (RDO_O01_OBSERVATION)super.removeRepetition("OBSERVATION", rep);
    }
