 ...
 * 
 * The Original Code is "CM_DDI.java".  Description:
 * "Composite class CM_DDI"
 * 
...
/**
 * <p>Represents an HL7 CM_DDI (daily deductible) data type. 
...
public class CM_DDI extends AbstractComposite {
     ...
     * casting and handling an exception.
     */
    public NM getCm_ddi1_DelayDays() {
       return getTyped(0, NM.class);
    }
     ...
     * casting and handling an exception.
     */
    public NM getCm_ddi3_NumberOfDays() {
       return getTyped(2, NM.class);
    }
