...
/**
 * <p>Represents a RRI_I14 message structure (see chapter ?). This structure contains the 
 ...
 * <ul>
		                 ...
		                 * <li>4: RRI_I14_AUTHORIZATION (a Group object) <b>optional </b> </li>
		                 * <li>5: RRI_I14_PROVIDER (a Group object) <b> repeating</b> </li>
		                 ...
		                 * <li>11: RRI_I14_PROCEDURE (a Group object) <b>optional repeating</b> </li>
		                 * <li>12: RRI_I14_RESULTS (a Group object) <b>optional repeating</b> </li>
		                 * <li>13: RRI_I14_VISIT (a Group object) <b>optional </b> </li>
		                 * <li>14: NTE (Notes and comments segment) <b>optional repeating</b> </li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class RRI_I14 extends AbstractMessage  {

    /**
     * Creates a new RRI_I14 message with DefaultModelClassFactory. 
     */ 
    public RRI_I14() { 
    ...
    /** 
     * Creates a new RRI_I14 message with custom ModelClassFactory.
     */
    public RRI_I14(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(RRI_I14_AUTHORIZATION.class, false, false);
	                          this.add(RRI_I14_PROVIDER.class, true, true);
	                          this.add(PID.class, true, false);
	                          this.add(ACC.class, false, false);
	                          this.add(DG1.class, false, true);
	                          this.add(DRG.class, false, true);
	                          this.add(AL1.class, false, true);
	                          this.add(RRI_I14_PROCEDURE.class, false, true);
	                          this.add(RRI_I14_RESULTS.class, false, true);
	                          this.add(RRI_I14_VISIT.class, false, false);
	                          this.add(NTE.class, false, true);
	       } catch(HL7Exception e) {
          log.error("Unexpected error creating RRI_I14 - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     *
     */
    public RRI_I14_AUTHORIZATION getAUTHORIZATION() { 
       return getTyped("AUTHORIZATION", RRI_I14_AUTHORIZATION.class);
    }
    ...
    public RRI_I14_PROVIDER getPROVIDER() { 
       return getTyped("PROVIDER", RRI_I14_PROVIDER.class);
    }
    ...
    public RRI_I14_PROVIDER getPROVIDER(int rep) { 
       return getTyped("PROVIDER", rep, RRI_I14_PROVIDER.class);
    }
     ...
     * 
     */ 
    public java.util.List<RRI_I14_PROVIDER> getPROVIDERAll() throws HL7Exception {
    	return getAllAsList("PROVIDER", RRI_I14_PROVIDER.class);
    } 
     ...
     */
    public void insertPROVIDER(RRI_I14_PROVIDER structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public RRI_I14_PROVIDER insertPROVIDER(int rep) throws HL7Exception { 
       return (RRI_I14_PROVIDER)super.insertRepetition("PROVIDER", rep);
    }
     ...
     */
    public RRI_I14_PROVIDER removePROVIDER(int rep) throws HL7Exception { 
       return (RRI_I14_PROVIDER)super.removeRepetition("PROVIDER", rep);
    }
    ...
    public RRI_I14_PROCEDURE getPROCEDURE() { 
       return getTyped("PROCEDURE", RRI_I14_PROCEDURE.class);
    }
    ...
    public RRI_I14_PROCEDURE getPROCEDURE(int rep) { 
       return getTyped("PROCEDURE", rep, RRI_I14_PROCEDURE.class);
    }
     ...
     * 
     */ 
    public java.util.List<RRI_I14_PROCEDURE> getPROCEDUREAll() throws HL7Exception {
    	return getAllAsList("PROCEDURE", RRI_I14_PROCEDURE.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertPROCEDURE(RRI_I14_PROCEDURE structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public RRI_I14_PROCEDURE insertPROCEDURE(int rep) throws HL7Exception { 
       return (RRI_I14_PROCEDURE)super.insertRepetition("PROCEDURE", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public RRI_I14_PROCEDURE removePROCEDURE(int rep) throws HL7Exception { 
       return (RRI_I14_PROCEDURE)super.removeRepetition("PROCEDURE", rep);
    }
    ...
    public RRI_I14_RESULTS getRESULTS() { 
       return getTyped("RESULTS", RRI_I14_RESULTS.class);
    }
    ...
    public RRI_I14_RESULTS getRESULTS(int rep) { 
       return getTyped("RESULTS", rep, RRI_I14_RESULTS.class);
    }
     ...
     * 
     */ 
    public java.util.List<RRI_I14_RESULTS> getRESULTSAll() throws HL7Exception {
    	return getAllAsList("RESULTS", RRI_I14_RESULTS.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertRESULTS(RRI_I14_RESULTS structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public RRI_I14_RESULTS insertRESULTS(int rep) throws HL7Exception { 
       return (RRI_I14_RESULTS)super.insertRepetition("RESULTS", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public RRI_I14_RESULTS removeRESULTS(int rep) throws HL7Exception { 
       return (RRI_I14_RESULTS)super.removeRepetition("RESULTS", rep);
    }
     ...
     *
     */
    public RRI_I14_VISIT getVISIT() { 
       return getTyped("VISIT", RRI_I14_VISIT.class);
    }
