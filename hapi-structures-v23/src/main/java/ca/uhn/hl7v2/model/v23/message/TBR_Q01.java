...
/**
 * <p>Represents a TBR_Q01 message structure (see chapter ?). This structure contains the 
 ...
 * <ul>
		                 ...
		                 * <li>5: RDF (Table Row Definition) <b> </b> </li>
		                 * <li>6: RDT (Table Row Data) <b> repeating</b> </li>
...
public class TBR_Q01 extends AbstractMessage  {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating TBR_Q01 - this is probably a bug in the source code generator.", e);
       }
    }
