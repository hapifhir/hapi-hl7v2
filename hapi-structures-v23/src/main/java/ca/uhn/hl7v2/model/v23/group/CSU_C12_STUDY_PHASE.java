...
/**
 * <p>Represents a CSU_C12_STUDY_PHASE group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: CSP (Clinical Study Phase) <b>optional  </b></li>
                         * <li>2: CSU_C12_STUDY_SCHEDULE (a Group object) <b> repeating </b></li>
 * </ul>
 */
...
public class CSU_C12_STUDY_PHASE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CSU_C12_STUDY_SCHEDULE.class, true, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating CSU_C12_STUDY_PHASE - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public CSU_C12_STUDY_SCHEDULE getSTUDY_SCHEDULE() { 
       CSU_C12_STUDY_SCHEDULE retVal = getTyped("STUDY_SCHEDULE", CSU_C12_STUDY_SCHEDULE.class);
       return retVal;
    }
    ...
    public CSU_C12_STUDY_SCHEDULE getSTUDY_SCHEDULE(int rep) { 
       CSU_C12_STUDY_SCHEDULE retVal = getTyped("STUDY_SCHEDULE", rep, CSU_C12_STUDY_SCHEDULE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<CSU_C12_STUDY_SCHEDULE> getSTUDY_SCHEDULEAll() throws HL7Exception {
    	return getAllAsList("STUDY_SCHEDULE", CSU_C12_STUDY_SCHEDULE.class);
    } 
