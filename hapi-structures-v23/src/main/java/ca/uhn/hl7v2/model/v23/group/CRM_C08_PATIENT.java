...
/**
 * <p>Represents a CRM_C08_PATIENT group structure (a Group object).
...
public class CRM_C08_PATIENT extends AbstractGroup {
     ...
     */
    public CRM_C08_PATIENT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating CRM_C08_PATIENT - this is probably a bug in the source code generator.", e);
       }
    }
