...
/**
 * <p>Represents a ADT_A13_PROCEDURE group structure (a Group object).
...
public class ADT_A13_PROCEDURE extends AbstractGroup {

    /** 
     * Creates a new ADT_A13_PROCEDURE group
     */
    public ADT_A13_PROCEDURE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ADT_A13_PROCEDURE - this is probably a bug in the source code generator.", e);
       }
    }
