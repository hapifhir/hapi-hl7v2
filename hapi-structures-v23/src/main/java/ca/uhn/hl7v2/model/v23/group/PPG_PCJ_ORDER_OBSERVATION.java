...
/**
 * <p>Represents a PPG_PCJ_ORDER_OBSERVATION group structure (a Group object).
...
public class PPG_PCJ_ORDER_OBSERVATION extends AbstractGroup {

    /** 
     * Creates a new PPG_PCJ_ORDER_OBSERVATION group
     */
    public PPG_PCJ_ORDER_OBSERVATION(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PPG_PCJ_ORDER_OBSERVATION - this is probably a bug in the source code generator.", e);
       }
    }
