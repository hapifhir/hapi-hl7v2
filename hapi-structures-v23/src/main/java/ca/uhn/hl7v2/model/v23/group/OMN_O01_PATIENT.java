...
/**
 * <p>Represents a OMN_O01_PATIENT group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>4: OMN_O01_PATIENT_VISIT (a Group object) <b>optional  </b></li>
                         * <li>5: OMN_O01_INSURANCE (a Group object) <b>optional repeating </b></li>
                         * <li>6: GT1 (Guarantor) <b>optional  </b></li>
                         * <li>7: AL1 (Patient allergy information) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class OMN_O01_PATIENT extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(OMN_O01_PATIENT_VISIT.class, false, false, false);
                                  this.add(OMN_O01_INSURANCE.class, false, true, false);
                                  this.add(GT1.class, false, false, false);
                                  this.add(AL1.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating OMN_O01_PATIENT - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public OMN_O01_PATIENT_VISIT getPATIENT_VISIT() { 
       OMN_O01_PATIENT_VISIT retVal = getTyped("PATIENT_VISIT", OMN_O01_PATIENT_VISIT.class);
       return retVal;
    }
    ...
    public OMN_O01_INSURANCE getINSURANCE() { 
       OMN_O01_INSURANCE retVal = getTyped("INSURANCE", OMN_O01_INSURANCE.class);
       return retVal;
    }
    ...
    public OMN_O01_INSURANCE getINSURANCE(int rep) { 
       OMN_O01_INSURANCE retVal = getTyped("INSURANCE", rep, OMN_O01_INSURANCE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<OMN_O01_INSURANCE> getINSURANCEAll() throws HL7Exception {
    	return getAllAsList("INSURANCE", OMN_O01_INSURANCE.class);
    } 
