...
/**
 * <p>Represents a RQI_I02_GUARANTOR_INSURANCE group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: GT1 (Guarantor) <b>optional repeating </b></li>
                         * <li>2: RQI_I02_INSURANCE (a Group object) <b> repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class RQI_I02_GUARANTOR_INSURANCE extends AbstractGroup {

    /** 
     * Creates a new RQI_I02_GUARANTOR_INSURANCE group
     */
    public RQI_I02_GUARANTOR_INSURANCE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(RQI_I02_INSURANCE.class, true, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating RQI_I02_GUARANTOR_INSURANCE - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public RQI_I02_INSURANCE getINSURANCE() { 
       RQI_I02_INSURANCE retVal = getTyped("INSURANCE", RQI_I02_INSURANCE.class);
       return retVal;
    }
    ...
    public RQI_I02_INSURANCE getINSURANCE(int rep) { 
       RQI_I02_INSURANCE retVal = getTyped("INSURANCE", rep, RQI_I02_INSURANCE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<RQI_I02_INSURANCE> getINSURANCEAll() throws HL7Exception {
    	return getAllAsList("INSURANCE", RQI_I02_INSURANCE.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertINSURANCE(RQI_I02_INSURANCE structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public RQI_I02_INSURANCE insertINSURANCE(int rep) throws HL7Exception { 
       return (RQI_I02_INSURANCE)super.insertRepetition("INSURANCE", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public RQI_I02_INSURANCE removeINSURANCE(int rep) throws HL7Exception { 
       return (RQI_I02_INSURANCE)super.removeRepetition("INSURANCE", rep);
    }
