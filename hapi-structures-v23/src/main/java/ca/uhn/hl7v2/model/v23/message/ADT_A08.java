 ...
 * <ul>
		                 ...
		                 * <li>13: ADT_A08_PROCEDURE (a Group object) <b>optional repeating</b> </li>
		                 * <li>14: GT1 (Guarantor) <b>optional repeating</b> </li>
		                 * <li>15: ADT_A08_INSURANCE (a Group object) <b>optional repeating</b> </li>
...
public class ADT_A08 extends AbstractMessage  {
    ...
    public ADT_A08_PROCEDURE getPROCEDURE() { 
       return getTyped("PROCEDURE", ADT_A08_PROCEDURE.class);
    }
    ...
    public ADT_A08_PROCEDURE getPROCEDURE(int rep) { 
       return getTyped("PROCEDURE", rep, ADT_A08_PROCEDURE.class);
    }
     ...
     * 
     */ 
    public java.util.List<ADT_A08_PROCEDURE> getPROCEDUREAll() throws HL7Exception {
    	return getAllAsList("PROCEDURE", ADT_A08_PROCEDURE.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertPROCEDURE(ADT_A08_PROCEDURE structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public ADT_A08_PROCEDURE insertPROCEDURE(int rep) throws HL7Exception { 
       return (ADT_A08_PROCEDURE)super.insertRepetition("PROCEDURE", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public ADT_A08_PROCEDURE removePROCEDURE(int rep) throws HL7Exception { 
       return (ADT_A08_PROCEDURE)super.removeRepetition("PROCEDURE", rep);
    }
    ...
    public ADT_A08_INSURANCE getINSURANCE() { 
       return getTyped("INSURANCE", ADT_A08_INSURANCE.class);
    }
    ...
    public ADT_A08_INSURANCE getINSURANCE(int rep) { 
       return getTyped("INSURANCE", rep, ADT_A08_INSURANCE.class);
    }
     ...
     * 
     */ 
    public java.util.List<ADT_A08_INSURANCE> getINSURANCEAll() throws HL7Exception {
    	return getAllAsList("INSURANCE", ADT_A08_INSURANCE.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertINSURANCE(ADT_A08_INSURANCE structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public ADT_A08_INSURANCE insertINSURANCE(int rep) throws HL7Exception { 
       return (ADT_A08_INSURANCE)super.insertRepetition("INSURANCE", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public ADT_A08_INSURANCE removeINSURANCE(int rep) throws HL7Exception { 
       return (ADT_A08_INSURANCE)super.removeRepetition("INSURANCE", rep);
    }
