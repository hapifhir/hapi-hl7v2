...
/**
 * <p>Represents a SRM_S05_PATIENT group structure (a Group object).
...
public class SRM_S05_PATIENT extends AbstractGroup {

    /** 
     * Creates a new SRM_S05_PATIENT group
     */
    public SRM_S05_PATIENT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating SRM_S05_PATIENT - this is probably a bug in the source code generator.", e);
       }
    }
