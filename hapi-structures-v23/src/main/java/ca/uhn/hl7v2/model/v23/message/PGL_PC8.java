 ...
 * <ul>
		                 ...
		                 * <li>3: PGL_PC8_PATIENT_VISIT (a Group object) <b>optional </b> </li>
		                 * <li>4: PGL_PC8_GOAL (a Group object) <b> repeating</b> </li>
 * </ul>
 */
...
public class PGL_PC8 extends AbstractMessage  {
    ...
    /**
     * Creates a new PGL_PC8 message with DefaultModelClassFactory. 
     */ 
    public PGL_PC8() { 
    ...
    /** 
     * Creates a new PGL_PC8 message with custom ModelClassFactory.
     */
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PGL_PC8 - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public PGL_PC8_PATIENT_VISIT getPATIENT_VISIT() { 
       return getTyped("PATIENT_VISIT", PGL_PC8_PATIENT_VISIT.class);
    }
    ...
    public PGL_PC8_GOAL getGOAL() { 
       return getTyped("GOAL", PGL_PC8_GOAL.class);
    }
    ...
    public PGL_PC8_GOAL getGOAL(int rep) { 
       return getTyped("GOAL", rep, PGL_PC8_GOAL.class);
    }
     ...
     * 
     */ 
    public java.util.List<PGL_PC8_GOAL> getGOALAll() throws HL7Exception {
    	return getAllAsList("GOAL", PGL_PC8_GOAL.class);
    } 
     ...
     */
    public void insertGOAL(PGL_PC8_GOAL structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public PGL_PC8_GOAL insertGOAL(int rep) throws HL7Exception { 
       return (PGL_PC8_GOAL)super.insertRepetition("GOAL", rep);
    }
     ...
     */
    public PGL_PC8_GOAL removeGOAL(int rep) throws HL7Exception { 
       return (PGL_PC8_GOAL)super.removeRepetition("GOAL", rep);
    }
