...
/**
 * <p>Represents a RRE_O01 message structure (see chapter ?). This structure contains the 
 ...
 * <ul>
		                 ...
		                 * <li>5: RRE_O01_RESPONSE (a Group object) <b>optional </b> </li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class RRE_O01 extends AbstractMessage  {

    /**
     * Creates a new RRE_O01 message with DefaultModelClassFactory. 
     */ 
    public RRE_O01() { 
    ...
    /** 
     * Creates a new RRE_O01 message with custom ModelClassFactory.
     */
    public RRE_O01(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(RRE_O01_RESPONSE.class, false, false);
	       } catch(HL7Exception e) {
          log.error("Unexpected error creating RRE_O01 - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     *
     */
    public RRE_O01_RESPONSE getRESPONSE() { 
       return getTyped("RESPONSE", RRE_O01_RESPONSE.class);
    }
