 ...
 * <ul>
		                 ...
		                 * <li>4: SIU_S14_PATIENT (a Group object) <b>optional repeating</b> </li>
		                 * <li>5: SIU_S14_RESOURCES (a Group object) <b> repeating</b> </li>
 * </ul>
 */
...
public class SIU_S14 extends AbstractMessage  {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating SIU_S14 - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public SIU_S14_PATIENT getPATIENT() { 
       return getTyped("PATIENT", SIU_S14_PATIENT.class);
    }
    ...
    public SIU_S14_PATIENT getPATIENT(int rep) { 
       return getTyped("PATIENT", rep, SIU_S14_PATIENT.class);
    }
     ...
     * 
     */ 
    public java.util.List<SIU_S14_PATIENT> getPATIENTAll() throws HL7Exception {
    	return getAllAsList("PATIENT", SIU_S14_PATIENT.class);
    } 
    ...
    public SIU_S14_RESOURCES getRESOURCES() { 
       return getTyped("RESOURCES", SIU_S14_RESOURCES.class);
    }
    ...
    public SIU_S14_RESOURCES getRESOURCES(int rep) { 
       return getTyped("RESOURCES", rep, SIU_S14_RESOURCES.class);
    }
     ...
     * 
     */ 
    public java.util.List<SIU_S14_RESOURCES> getRESOURCESAll() throws HL7Exception {
    	return getAllAsList("RESOURCES", SIU_S14_RESOURCES.class);
    } 
