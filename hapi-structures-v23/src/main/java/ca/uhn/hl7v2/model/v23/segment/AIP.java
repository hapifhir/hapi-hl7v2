 ...
 * <ul>
     ...
     * <li>AIP-3: Personnel Resource ID (XCN) <b>optional </b>
     * <li>AIP-4: Resource Role (CE) <b> </b>
     * <li>AIP-5: Resource Group (CE) <b>optional repeating</b>
...
public class AIP extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(XCN.class, false, 1, 80, new Object[]{ getMessage() }, "Personnel Resource ID");
                                  this.add(CE.class, true, 1, 60, new Object[]{ getMessage() }, "Resource Role");
                                  this.add(CE.class, false, 0, 200, new Object[]{ getMessage() }, "Resource Group");
    ...
    /**
     * Returns
     * AIP-4: "Resource Role" - creates it if necessary
     */
    ...
    /**
     * Returns a count of the current number of repetitions of Resource Group (AIP-5).
     ...
     * AIP-5: "Resource Group" at a specific index
     *
     * @param rep The repetition index (0-indexed)
