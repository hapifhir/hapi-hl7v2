...
/**
 * <p>Represents a SIU_S21 message structure (see chapter ?). This structure contains the 
 ...
 * <ul>
		                 ...
		                 * <li>4: SIU_S21_PATIENT (a Group object) <b>optional repeating</b> </li>
		                 * <li>5: SIU_S21_RESOURCES (a Group object) <b> repeating</b> </li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class SIU_S21 extends AbstractMessage  {

    /**
     * Creates a new SIU_S21 message with DefaultModelClassFactory. 
     */ 
    public SIU_S21() { 
    ...
    /** 
     * Creates a new SIU_S21 message with custom ModelClassFactory.
     */
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating SIU_S21 - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public SIU_S21_PATIENT getPATIENT() { 
       return getTyped("PATIENT", SIU_S21_PATIENT.class);
    }
    ...
    public SIU_S21_PATIENT getPATIENT(int rep) { 
       return getTyped("PATIENT", rep, SIU_S21_PATIENT.class);
    }
     ...
     * 
     */ 
    public java.util.List<SIU_S21_PATIENT> getPATIENTAll() throws HL7Exception {
    	return getAllAsList("PATIENT", SIU_S21_PATIENT.class);
    } 
    ...
    public SIU_S21_RESOURCES getRESOURCES() { 
       return getTyped("RESOURCES", SIU_S21_RESOURCES.class);
    }
    ...
    public SIU_S21_RESOURCES getRESOURCES(int rep) { 
       return getTyped("RESOURCES", rep, SIU_S21_RESOURCES.class);
    }
     ...
     * 
     */ 
    public java.util.List<SIU_S21_RESOURCES> getRESOURCESAll() throws HL7Exception {
    	return getAllAsList("RESOURCES", SIU_S21_RESOURCES.class);
    } 
