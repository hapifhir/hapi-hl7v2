...
/**
 * <p>Represents a RRI_I13_PROVIDER group structure (a Group object).
...
public class RRI_I13_PROVIDER extends AbstractGroup {

    /** 
     * Creates a new RRI_I13_PROVIDER group
     */
    public RRI_I13_PROVIDER(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RRI_I13_PROVIDER - this is probably a bug in the source code generator.", e);
       }
    }
