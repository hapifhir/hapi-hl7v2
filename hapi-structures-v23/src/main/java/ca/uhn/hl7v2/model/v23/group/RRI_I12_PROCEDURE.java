 ...
 * <ul>
                         ...
                         * <li>2: RRI_I12_AUTHORIZATION (a Group object) <b>optional  </b></li>
 * </ul>
 */
...
public class RRI_I12_PROCEDURE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(RRI_I12_AUTHORIZATION.class, false, false, false);
    ...
    public RRI_I12_AUTHORIZATION getAUTHORIZATION() { 
       RRI_I12_AUTHORIZATION retVal = getTyped("AUTHORIZATION", RRI_I12_AUTHORIZATION.class);
       return retVal;
    }
