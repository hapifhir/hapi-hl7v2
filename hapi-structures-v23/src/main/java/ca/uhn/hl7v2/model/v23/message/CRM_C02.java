...
/**
 * <p>Represents a CRM_C02 message structure (see chapter ?). This structure contains the 
 * following elements: </p>
 * <ul>
		                 * <li>1: MSH (Message header segment) <b> </b> </li>
		                 * <li>2: CRM_C02_PATIENT (a Group object) <b> repeating</b> </li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class CRM_C02 extends AbstractMessage  {

    /**
     * Creates a new CRM_C02 message with DefaultModelClassFactory. 
     */ 
    public CRM_C02() { 
    ...
    /** 
     * Creates a new CRM_C02 message with custom ModelClassFactory.
     */
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating CRM_C02 - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public CRM_C02_PATIENT getPATIENT() { 
       return getTyped("PATIENT", CRM_C02_PATIENT.class);
    }
    ...
    public CRM_C02_PATIENT getPATIENT(int rep) { 
       return getTyped("PATIENT", rep, CRM_C02_PATIENT.class);
    }
     ...
     * 
     */ 
    public java.util.List<CRM_C02_PATIENT> getPATIENTAll() throws HL7Exception {
    	return getAllAsList("PATIENT", CRM_C02_PATIENT.class);
    } 
