...
/**
 * <p>Represents a CRM_C05 message structure (see chapter ?). This structure contains the 
 * following elements: </p>
 * <ul>
		                 * <li>1: MSH (Message header segment) <b> </b> </li>
		                 * <li>2: CRM_C05_PATIENT (a Group object) <b> repeating</b> </li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class CRM_C05 extends AbstractMessage  {

    /**
     * Creates a new CRM_C05 message with DefaultModelClassFactory. 
     */ 
    public CRM_C05() { 
    ...
    /** 
     * Creates a new CRM_C05 message with custom ModelClassFactory.
     */
    ...
    public CRM_C05_PATIENT getPATIENT() { 
       return getTyped("PATIENT", CRM_C05_PATIENT.class);
    }
    ...
    public CRM_C05_PATIENT getPATIENT(int rep) { 
       return getTyped("PATIENT", rep, CRM_C05_PATIENT.class);
    }
     ...
     * 
     */ 
    public java.util.List<CRM_C05_PATIENT> getPATIENTAll() throws HL7Exception {
    	return getAllAsList("PATIENT", CRM_C05_PATIENT.class);
    } 
