 ...
 * <ul>
		                 ...
		                 * <li>3: OMS_O01_PATIENT (a Group object) <b>optional </b> </li>
		                 * <li>4: OMS_O01_ORDER (a Group object) <b> repeating</b> </li>
 * </ul>
 */
...
public class OMS_O01 extends AbstractMessage  {
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(OMS_O01_PATIENT.class, false, false);
	                          this.add(OMS_O01_ORDER.class, true, true);
	       } catch(HL7Exception e) {
          log.error("Unexpected error creating OMS_O01 - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     *
     */
    public OMS_O01_PATIENT getPATIENT() { 
       return getTyped("PATIENT", OMS_O01_PATIENT.class);
    }
    ...
    public OMS_O01_ORDER getORDER() { 
       return getTyped("ORDER", OMS_O01_ORDER.class);
    }
    ...
    public OMS_O01_ORDER getORDER(int rep) { 
       return getTyped("ORDER", rep, OMS_O01_ORDER.class);
    }
     ...
     * 
     */ 
    public java.util.List<OMS_O01_ORDER> getORDERAll() throws HL7Exception {
    	return getAllAsList("ORDER", OMS_O01_ORDER.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertORDER(OMS_O01_ORDER structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public OMS_O01_ORDER insertORDER(int rep) throws HL7Exception { 
       return (OMS_O01_ORDER)super.insertRepetition("ORDER", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public OMS_O01_ORDER removeORDER(int rep) throws HL7Exception { 
       return (OMS_O01_ORDER)super.removeRepetition("ORDER", rep);
    }
