...
/**
 * <p>Represents a RRI_I15_VISIT group structure (a Group object).
...
public class RRI_I15_VISIT extends AbstractGroup {
     ...
     */
    public RRI_I15_VISIT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RRI_I15_VISIT - this is probably a bug in the source code generator.", e);
       }
    }
