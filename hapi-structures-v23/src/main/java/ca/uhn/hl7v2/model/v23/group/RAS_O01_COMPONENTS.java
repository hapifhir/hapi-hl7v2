...
/**
 * <p>Represents a RAS_O01_COMPONENTS group structure (a Group object).
...
public class RAS_O01_COMPONENTS extends AbstractGroup {

    /** 
     * Creates a new RAS_O01_COMPONENTS group
     */
    public RAS_O01_COMPONENTS(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RAS_O01_COMPONENTS - this is probably a bug in the source code generator.", e);
       }
    }
