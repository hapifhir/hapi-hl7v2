...
public class MFK_M07 extends AbstractMessage  {
    ...
    /**
     * Creates a new MFK_M07 message with DefaultModelClassFactory. 
     */ 
    public MFK_M07() { 
    ...
    /** 
     * Creates a new MFK_M07 message with custom ModelClassFactory.
     */
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating MFK_M07 - this is probably a bug in the source code generator.", e);
       }
    }
