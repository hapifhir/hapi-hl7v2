 ...
 * 
 * The Original Code is "CM_PI.java".  Description:
 * "Composite class CM_PI"
 * 
...
/**
 * <p>Represents an HL7 CM_PI (person identifier) data type. 
 * This type consists of the following components:</p>
 * <ul>
 * <li>ID number (ST) (ST)
 * <li>type of ID number (IS) (IS)
 * <li>other qualifying info (ST)
 * </ul>
 */
@SuppressWarnings("unused")
public class CM_PI extends AbstractComposite {

    private Type[] data;

    /** 
     * Creates a new CM_PI type
     */
     ...
     * casting and handling an exception.
     */
    public IS getCm_pi2_TypeOfIDNumber() {
       return getTyped(1, IS.class);
    }


    /**
     * Returns other qualifying info (component 3).  This is a convenience method that saves you from 
     * casting and handling an exception.
     */
     ...
     * casting and handling an exception.
     */
    public ST getCm_pi3_OtherQualifyingInfo() {
       return getTyped(2, ST.class);
    }
