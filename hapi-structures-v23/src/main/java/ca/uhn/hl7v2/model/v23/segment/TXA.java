...
/**
 *<p>Represents an HL7 TXA message segment (Document notification segment). 
 ...
 * <ul>
     ...
     * <li>TXA-5: Primary Activity Provider Code/Name (XCN) <b>optional </b>
     ...
     * <li>TXA-9: Originator Code/Name (XCN) <b>optional </b>
     * <li>TXA-10: Assigned Document Authenticator (XCN) <b>optional repeating</b>
     * <li>TXA-11: Transcriptionist Code/Name (XCN) <b>optional </b>
     ...
     * <li>TXA-17: Document Completion Status (ID) <b> repeating</b>
...
public class TXA extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(XCN.class, false, 1, 60, new Object[]{ getMessage() }, "Primary Activity Provider Code/Name");
                                  ...
                                  this.add(XCN.class, false, 1, 60, new Object[]{ getMessage() }, "Originator Code/Name");
                                  this.add(XCN.class, false, 0, 60, new Object[]{ getMessage() }, "Assigned Document Authenticator");
                                  this.add(XCN.class, false, 1, 48, new Object[]{ getMessage() }, "Transcriptionist Code/Name");
                                  ...
                                  this.add(ST.class, false, 1, 30, new Object[]{ getMessage() }, "Unique Document File Name");
                                              this.add(ID.class, true, 0, 2, new Object[]{ getMessage(), new Integer(271) }, "Document Completion Status");
                                  ...
                                  this.add(PPN.class, false, 0, 60, new Object[]{ getMessage() }, "Authentication Person, Time Stamp");
                                  this.add(XCN.class, false, 0, 60, new Object[]{ getMessage() }, "Distributed Copies (Code and Name of Recipients)");
