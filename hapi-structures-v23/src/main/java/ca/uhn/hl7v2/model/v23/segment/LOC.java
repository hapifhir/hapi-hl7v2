 ...
 * <ul>
     * <li>LOC-1: Primary Key Value (PL) <b> </b>
     * <li>LOC-2: Location Description (ST) <b>optional </b>
     * <li>LOC-3: Location Type (IS) <b> repeating</b>
     * <li>LOC-4: Organization Name (XON) <b>optional </b>
     * <li>LOC-5: Location Address (XAD) <b>optional </b>
     * <li>LOC-6: Location Phone (XTN) <b>optional repeating</b>
     * <li>LOC-7: License Number (CE) <b>optional repeating</b>
     * <li>LOC-8: Location Equipment (ID) <b>optional repeating</b>
 * </ul>
 */
...
public class LOC extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(ST.class, false, 1, 48, new Object[]{ getMessage() }, "Location Description");
                                              this.add(IS.class, true, 0, 2, new Object[]{ getMessage(), new Integer(260) }, "Location Type");
                                  this.add(XON.class, false, 1, 90, new Object[]{ getMessage() }, "Organization Name");
                                  this.add(XAD.class, false, 1, 106, new Object[]{ getMessage() }, "Location Address");
                                  this.add(XTN.class, false, 0, 40, new Object[]{ getMessage() }, "Location Phone");
                                  this.add(CE.class, false, 0, 60, new Object[]{ getMessage() }, "License Number");
                                              this.add(ID.class, false, 0, 3, new Object[]{ getMessage(), new Integer(261) }, "Location Equipment");
    ...
    protected Type createNewTypeWithoutReflection(int field) {
       switch (field) {
          ...
          case 7: return new ID(getMessage(), new Integer( 261 ));
          default: return null;
       }
   }
