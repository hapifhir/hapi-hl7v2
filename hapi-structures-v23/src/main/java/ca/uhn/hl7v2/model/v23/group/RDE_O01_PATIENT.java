...
/**
 * <p>Represents a RDE_O01_PATIENT group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>4: RDE_O01_PATIENT_VISIT (a Group object) <b>optional  </b></li>
                         * <li>5: RDE_O01_INSURANCE (a Group object) <b>optional repeating </b></li>
                         * <li>6: GT1 (Guarantor) <b>optional  </b></li>
                         * <li>7: AL1 (Patient allergy information) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class RDE_O01_PATIENT extends AbstractGroup {

    /** 
     * Creates a new RDE_O01_PATIENT group
     */
    public RDE_O01_PATIENT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(RDE_O01_PATIENT_VISIT.class, false, false, false);
                                  this.add(RDE_O01_INSURANCE.class, false, true, false);
                                  this.add(GT1.class, false, false, false);
                                  this.add(AL1.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating RDE_O01_PATIENT - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     */
    public RDE_O01_PATIENT_VISIT getPATIENT_VISIT() { 
       RDE_O01_PATIENT_VISIT retVal = getTyped("PATIENT_VISIT", RDE_O01_PATIENT_VISIT.class);
       return retVal;
    }
    ...
    public RDE_O01_INSURANCE getINSURANCE() { 
       RDE_O01_INSURANCE retVal = getTyped("INSURANCE", RDE_O01_INSURANCE.class);
       return retVal;
    }
    ...
    public RDE_O01_INSURANCE getINSURANCE(int rep) { 
       RDE_O01_INSURANCE retVal = getTyped("INSURANCE", rep, RDE_O01_INSURANCE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<RDE_O01_INSURANCE> getINSURANCEAll() throws HL7Exception {
    	return getAllAsList("INSURANCE", RDE_O01_INSURANCE.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertINSURANCE(RDE_O01_INSURANCE structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public RDE_O01_INSURANCE insertINSURANCE(int rep) throws HL7Exception { 
       return (RDE_O01_INSURANCE)super.insertRepetition("INSURANCE", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public RDE_O01_INSURANCE removeINSURANCE(int rep) throws HL7Exception { 
       return (RDE_O01_INSURANCE)super.removeRepetition("INSURANCE", rep);
    }
