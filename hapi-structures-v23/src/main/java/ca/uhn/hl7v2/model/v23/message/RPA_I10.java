 ...
 * <ul>
		                 ...
		                 * <li>4: RPA_I10_AUTHORIZATION (a Group object) <b>optional </b> </li>
		                 * <li>5: RPA_I10_PROVIDER (a Group object) <b> repeating</b> </li>
		                 ...
		                 * <li>9: RPA_I10_INSURANCE (a Group object) <b>optional repeating</b> </li>
		                 ...
		                 * <li>14: RPA_I10_PROCEDURE (a Group object) <b> repeating</b> </li>
		                 * <li>15: RPA_I10_RESULTS (a Group object) <b>optional repeating</b> </li>
		                 * <li>16: RPA_I10_VISIT (a Group object) <b>optional </b> </li>
 * </ul>
 */
...
public class RPA_I10 extends AbstractMessage  {
    ...
    /**
     * Creates a new RPA_I10 message with DefaultModelClassFactory. 
     */ 
    public RPA_I10() { 
    ...
    /** 
     * Creates a new RPA_I10 message with custom ModelClassFactory.
     */
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RPA_I10 - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public RPA_I10_AUTHORIZATION getAUTHORIZATION() { 
       return getTyped("AUTHORIZATION", RPA_I10_AUTHORIZATION.class);
    }
    ...
    public RPA_I10_PROVIDER getPROVIDER() { 
       return getTyped("PROVIDER", RPA_I10_PROVIDER.class);
    }
    ...
    public RPA_I10_PROVIDER getPROVIDER(int rep) { 
       return getTyped("PROVIDER", rep, RPA_I10_PROVIDER.class);
    }
     ...
     * 
     */ 
    public java.util.List<RPA_I10_PROVIDER> getPROVIDERAll() throws HL7Exception {
    	return getAllAsList("PROVIDER", RPA_I10_PROVIDER.class);
    } 
     ...
     */
    public void insertPROVIDER(RPA_I10_PROVIDER structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public RPA_I10_PROVIDER insertPROVIDER(int rep) throws HL7Exception { 
       return (RPA_I10_PROVIDER)super.insertRepetition("PROVIDER", rep);
    }
     ...
     */
    public RPA_I10_PROVIDER removePROVIDER(int rep) throws HL7Exception { 
       return (RPA_I10_PROVIDER)super.removeRepetition("PROVIDER", rep);
    }
    ...
    public RPA_I10_INSURANCE getINSURANCE() { 
       return getTyped("INSURANCE", RPA_I10_INSURANCE.class);
    }
    ...
    public RPA_I10_INSURANCE getINSURANCE(int rep) { 
       return getTyped("INSURANCE", rep, RPA_I10_INSURANCE.class);
    }
     ...
     * 
     */ 
    public java.util.List<RPA_I10_INSURANCE> getINSURANCEAll() throws HL7Exception {
    	return getAllAsList("INSURANCE", RPA_I10_INSURANCE.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertINSURANCE(RPA_I10_INSURANCE structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public RPA_I10_INSURANCE insertINSURANCE(int rep) throws HL7Exception { 
       return (RPA_I10_INSURANCE)super.insertRepetition("INSURANCE", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public RPA_I10_INSURANCE removeINSURANCE(int rep) throws HL7Exception { 
       return (RPA_I10_INSURANCE)super.removeRepetition("INSURANCE", rep);
    }
    ...
    public RPA_I10_PROCEDURE getPROCEDURE() { 
       return getTyped("PROCEDURE", RPA_I10_PROCEDURE.class);
    }
    ...
    public RPA_I10_PROCEDURE getPROCEDURE(int rep) { 
       return getTyped("PROCEDURE", rep, RPA_I10_PROCEDURE.class);
    }
     ...
     * 
     */ 
    public java.util.List<RPA_I10_PROCEDURE> getPROCEDUREAll() throws HL7Exception {
    	return getAllAsList("PROCEDURE", RPA_I10_PROCEDURE.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertPROCEDURE(RPA_I10_PROCEDURE structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public RPA_I10_PROCEDURE insertPROCEDURE(int rep) throws HL7Exception { 
       return (RPA_I10_PROCEDURE)super.insertRepetition("PROCEDURE", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public RPA_I10_PROCEDURE removePROCEDURE(int rep) throws HL7Exception { 
       return (RPA_I10_PROCEDURE)super.removeRepetition("PROCEDURE", rep);
    }
    ...
    public RPA_I10_RESULTS getRESULTS() { 
       return getTyped("RESULTS", RPA_I10_RESULTS.class);
    }
    ...
    public RPA_I10_RESULTS getRESULTS(int rep) { 
       return getTyped("RESULTS", rep, RPA_I10_RESULTS.class);
    }
     ...
     * 
     */ 
    public java.util.List<RPA_I10_RESULTS> getRESULTSAll() throws HL7Exception {
    	return getAllAsList("RESULTS", RPA_I10_RESULTS.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertRESULTS(RPA_I10_RESULTS structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public RPA_I10_RESULTS insertRESULTS(int rep) throws HL7Exception { 
       return (RPA_I10_RESULTS)super.insertRepetition("RESULTS", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public RPA_I10_RESULTS removeRESULTS(int rep) throws HL7Exception { 
       return (RPA_I10_RESULTS)super.removeRepetition("RESULTS", rep);
    }
    ...
    public RPA_I10_VISIT getVISIT() { 
       return getTyped("VISIT", RPA_I10_VISIT.class);
    }
