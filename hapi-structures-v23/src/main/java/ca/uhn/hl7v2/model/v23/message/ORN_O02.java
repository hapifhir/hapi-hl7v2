 ...
 * <ul>
		                 ...
		                 * <li>5: ORN_O02_RESPONSE (a Group object) <b>optional </b> </li>
 * </ul>
 */
...
public class ORN_O02 extends AbstractMessage  {
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(ORN_O02_RESPONSE.class, false, false);
     ...
     *
     */
    public ORN_O02_RESPONSE getRESPONSE() { 
       return getTyped("RESPONSE", ORN_O02_RESPONSE.class);
    }
