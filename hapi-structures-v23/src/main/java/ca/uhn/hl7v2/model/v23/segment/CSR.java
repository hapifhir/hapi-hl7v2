 ...
 * <ul>
     ...
     * <li>CSR-5: Alternate Patient ID (CX) <b>optional </b>
     * <li>CSR-6: Date/Time of Patient Study Registration (TS) <b>optional </b>
     * <li>CSR-7: Person Performing Study Registration (XCN) <b>optional </b>
     * <li>CSR-8: Study Authorizing Provider (XCN) <b> </b>
     ...
     * <li>CSR-12: Study Randomized Arm (CE) <b>optional repeating</b>
...
public class CSR extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CE.class, false, 1, 60, new Object[]{ getMessage() }, "Institution Registering the Patient");
                                  this.add(CX.class, true, 1, 30, new Object[]{ getMessage() }, "Sponsor Patient ID");
                                  this.add(CX.class, false, 1, 30, new Object[]{ getMessage() }, "Alternate Patient ID");
                                  this.add(TS.class, false, 1, 26, new Object[]{ getMessage() }, "Date/Time of Patient Study Registration");
                                  this.add(XCN.class, false, 1, 60, new Object[]{ getMessage() }, "Person Performing Study Registration");
                                  this.add(XCN.class, true, 1, 60, new Object[]{ getMessage() }, "Study Authorizing Provider");
                                  this.add(TS.class, false, 1, 26, new Object[]{ getMessage() }, "Date/time Patient Study Consent Signed");
                                  this.add(CE.class, false, 1, 60, new Object[]{ getMessage() }, "Patient Study Eligibility Status");
                                  this.add(TS.class, false, 3, 26, new Object[]{ getMessage() }, "Study Randomization Date/time");
                                  this.add(CE.class, false, 3, 200, new Object[]{ getMessage() }, "Study Randomized Arm");
                                  this.add(CE.class, false, 3, 200, new Object[]{ getMessage() }, "Stratum for Study Randomization");
                                  this.add(CE.class, false, 1, 60, new Object[]{ getMessage() }, "Patient Evaluability Status");
                                  this.add(TS.class, false, 1, 26, new Object[]{ getMessage() }, "Date/time Ended Study");
                                  this.add(CE.class, false, 1, 60, new Object[]{ getMessage() }, "Reason Ended Study");
    ...
    /**
     * Returns
     * CSR-5: "Alternate Patient ID" - creates it if necessary
     */
    ...
    /**
     * Returns a count of the current number of repetitions of Study Randomized Arm (CSR-12).
     * This method does not create a repetition, so if no repetitions have currently been defined or accessed,
     * it will return zero.
     */
    ...
    /**
     * Returns a specific repetition of
     * CSR-12: "Study Randomized Arm" - creates it if necessary
     *
     * @param rep The repetition index (0-indexed)
     */
    ...
    /**
     * Inserts a repetition of
     * CSR-12: "Study Randomized Arm" at a specific index
     *
     * @param rep The repetition index (0-indexed)
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
