...
/**
 * <p>Represents a RQA_I09_PROVIDER group structure (a Group object).
...
public class RQA_I09_PROVIDER extends AbstractGroup {

    /** 
     * Creates a new RQA_I09_PROVIDER group
     */
    public RQA_I09_PROVIDER(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RQA_I09_PROVIDER - this is probably a bug in the source code generator.", e);
       }
    }
