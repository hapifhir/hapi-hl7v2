...
/**
 *<p>Represents an HL7 BLG message segment (Billing Segment). 
 * This segment has the following fields:</p>
 * <ul>
     * <li>BLG-1: When to Charge (CM_CCD) <b>optional </b>
     * <li>BLG-2: Charge Type (ID) <b>optional </b>
     * <li>BLG-3: Account ID (CK) <b>optional </b>
 * </ul>
 */
...
public class BLG extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(CM_CCD.class, false, 1, 15, new Object[]{ getMessage() }, "When to Charge");
                                              this.add(ID.class, false, 1, 50, new Object[]{ getMessage(), new Integer(122) }, "Charge Type");
                                  this.add(CK.class, false, 1, 100, new Object[]{ getMessage() }, "Account ID");
    ...
    public CM_CCD getWhenToCharge() { 
		CM_CCD retVal = this.getTypedField(1, 0);
		return retVal;
    }
     ...
     * BLG-1: "When to Charge" - creates it if necessary
     */
    public CM_CCD getBlg1_WhenToCharge() { 
		CM_CCD retVal = this.getTypedField(1, 0);
		return retVal;
    }
    ...
    protected Type createNewTypeWithoutReflection(int field) {
       switch (field) {
          case 0: return new CM_CCD(getMessage());
