...
/**
 * <p>Represents a SRM_S02_PATIENT group structure (a Group object).
...
public class SRM_S02_PATIENT extends AbstractGroup {

    /** 
     * Creates a new SRM_S02_PATIENT group
     */
    public SRM_S02_PATIENT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating SRM_S02_PATIENT - this is probably a bug in the source code generator.", e);
       }
    }
