 ...
 * 
 * The Original Code is "CM_CD_ELECTRODE.java".  Description:
 * "Composite class CM_CD_ELECTRODE"
 * 
...
/**
 * <p>Represents an HL7 CM_CD_ELECTRODE data type. 
...
public class CM_CD_ELECTRODE extends AbstractComposite {
     ...
     */
    public CM_CD_ELECTRODE(Message message) {
        super(message);
        init();
    }
    ...
    /**
     * Returns source name 1 (component 1).  This is a convenience method that saves you from 
    ...
    /**
     * Returns source name 2 (component 2).  This is a convenience method that saves you from 
     * casting and handling an exception.
     */
