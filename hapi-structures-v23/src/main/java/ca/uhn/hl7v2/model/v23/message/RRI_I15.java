...
/**
 * <p>Represents a RRI_I15 message structure (see chapter ?). This structure contains the 
 ...
 * <ul>
		                 ...
		                 * <li>4: RRI_I15_AUTHORIZATION (a Group object) <b>optional </b> </li>
		                 * <li>5: RRI_I15_PROVIDER (a Group object) <b> repeating</b> </li>
		                 ...
		                 * <li>11: RRI_I15_PROCEDURE (a Group object) <b>optional repeating</b> </li>
		                 * <li>12: RRI_I15_RESULTS (a Group object) <b>optional repeating</b> </li>
		                 * <li>13: RRI_I15_VISIT (a Group object) <b>optional </b> </li>
		                 * <li>14: NTE (Notes and comments segment) <b>optional repeating</b> </li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class RRI_I15 extends AbstractMessage  {

    /**
     * Creates a new RRI_I15 message with DefaultModelClassFactory. 
     */ 
    public RRI_I15() { 
    ...
    /** 
     * Creates a new RRI_I15 message with custom ModelClassFactory.
     */
    public RRI_I15(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(RRI_I15_PROVIDER.class, true, true);
	                          this.add(PID.class, true, false);
	                          this.add(ACC.class, false, false);
	                          this.add(DG1.class, false, true);
	                          this.add(DRG.class, false, true);
	                          this.add(AL1.class, false, true);
	                          this.add(RRI_I15_PROCEDURE.class, false, true);
	                          this.add(RRI_I15_RESULTS.class, false, true);
	                          this.add(RRI_I15_VISIT.class, false, false);
	                          this.add(NTE.class, false, true);
	       } catch(HL7Exception e) {
          log.error("Unexpected error creating RRI_I15 - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public RRI_I15_AUTHORIZATION getAUTHORIZATION() { 
       return getTyped("AUTHORIZATION", RRI_I15_AUTHORIZATION.class);
    }
    ...
    public RRI_I15_PROVIDER getPROVIDER() { 
       return getTyped("PROVIDER", RRI_I15_PROVIDER.class);
    }
    ...
    public RRI_I15_PROVIDER getPROVIDER(int rep) { 
       return getTyped("PROVIDER", rep, RRI_I15_PROVIDER.class);
    }
     ...
     * 
     */ 
    public java.util.List<RRI_I15_PROVIDER> getPROVIDERAll() throws HL7Exception {
    	return getAllAsList("PROVIDER", RRI_I15_PROVIDER.class);
    } 
     ...
     */
    public void insertPROVIDER(RRI_I15_PROVIDER structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public RRI_I15_PROVIDER insertPROVIDER(int rep) throws HL7Exception { 
       return (RRI_I15_PROVIDER)super.insertRepetition("PROVIDER", rep);
    }
     ...
     */
    public RRI_I15_PROVIDER removePROVIDER(int rep) throws HL7Exception { 
       return (RRI_I15_PROVIDER)super.removeRepetition("PROVIDER", rep);
    }
    ...
    public RRI_I15_PROCEDURE getPROCEDURE() { 
       return getTyped("PROCEDURE", RRI_I15_PROCEDURE.class);
    }
    ...
    public RRI_I15_PROCEDURE getPROCEDURE(int rep) { 
       return getTyped("PROCEDURE", rep, RRI_I15_PROCEDURE.class);
    }
     ...
     * 
     */ 
    public java.util.List<RRI_I15_PROCEDURE> getPROCEDUREAll() throws HL7Exception {
    	return getAllAsList("PROCEDURE", RRI_I15_PROCEDURE.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertPROCEDURE(RRI_I15_PROCEDURE structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public RRI_I15_PROCEDURE insertPROCEDURE(int rep) throws HL7Exception { 
       return (RRI_I15_PROCEDURE)super.insertRepetition("PROCEDURE", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public RRI_I15_PROCEDURE removePROCEDURE(int rep) throws HL7Exception { 
       return (RRI_I15_PROCEDURE)super.removeRepetition("PROCEDURE", rep);
    }
    ...
    public RRI_I15_RESULTS getRESULTS() { 
       return getTyped("RESULTS", RRI_I15_RESULTS.class);
    }
    ...
    public RRI_I15_RESULTS getRESULTS(int rep) { 
       return getTyped("RESULTS", rep, RRI_I15_RESULTS.class);
    }
     ...
     * 
     */ 
    public java.util.List<RRI_I15_RESULTS> getRESULTSAll() throws HL7Exception {
    	return getAllAsList("RESULTS", RRI_I15_RESULTS.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertRESULTS(RRI_I15_RESULTS structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public RRI_I15_RESULTS insertRESULTS(int rep) throws HL7Exception { 
       return (RRI_I15_RESULTS)super.insertRepetition("RESULTS", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public RRI_I15_RESULTS removeRESULTS(int rep) throws HL7Exception { 
       return (RRI_I15_RESULTS)super.removeRepetition("RESULTS", rep);
    }
     ...
     *
     */
    public RRI_I15_VISIT getVISIT() { 
       return getTyped("VISIT", RRI_I15_VISIT.class);
    }
