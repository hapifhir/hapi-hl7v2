...
/**
 * <p>Represents a PPP_PCC_ORDER_DETAIL group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>4: PPP_PCC_ORDER_OBSERVATION (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class PPP_PCC_ORDER_DETAIL extends AbstractGroup {

    /** 
     * Creates a new PPP_PCC_ORDER_DETAIL group
     */
    public PPP_PCC_ORDER_DETAIL(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(PPP_PCC_ORDER_OBSERVATION.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating PPP_PCC_ORDER_DETAIL - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public PPP_PCC_ORDER_OBSERVATION getORDER_OBSERVATION() { 
       PPP_PCC_ORDER_OBSERVATION retVal = getTyped("ORDER_OBSERVATION", PPP_PCC_ORDER_OBSERVATION.class);
       return retVal;
    }
    ...
    public PPP_PCC_ORDER_OBSERVATION getORDER_OBSERVATION(int rep) { 
       PPP_PCC_ORDER_OBSERVATION retVal = getTyped("ORDER_OBSERVATION", rep, PPP_PCC_ORDER_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PPP_PCC_ORDER_OBSERVATION> getORDER_OBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("ORDER_OBSERVATION", PPP_PCC_ORDER_OBSERVATION.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertORDER_OBSERVATION(PPP_PCC_ORDER_OBSERVATION structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public PPP_PCC_ORDER_OBSERVATION insertORDER_OBSERVATION(int rep) throws HL7Exception { 
       return (PPP_PCC_ORDER_OBSERVATION)super.insertRepetition("ORDER_OBSERVATION", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public PPP_PCC_ORDER_OBSERVATION removeORDER_OBSERVATION(int rep) throws HL7Exception { 
       return (PPP_PCC_ORDER_OBSERVATION)super.removeRepetition("ORDER_OBSERVATION", rep);
    }
