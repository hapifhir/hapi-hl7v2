 ...
 * <ul>
     ...
     * <li>VAR-4: Variance Originator (XCN) <b>optional </b>
...
public class VAR extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(XCN.class, false, 1, 860, new Object[]{ getMessage() }, "Variance Originator");
                                  this.add(CE.class, false, 1, 60, new Object[]{ getMessage() }, "Variance Classification");
