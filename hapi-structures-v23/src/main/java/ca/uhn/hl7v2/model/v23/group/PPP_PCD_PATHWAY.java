...
/**
 * <p>Represents a PPP_PCD_PATHWAY group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>4: PPP_PCD_PATHWAY_ROLE (a Group object) <b>optional repeating </b></li>
                         * <li>5: PPP_PCD_PROBLEM (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class PPP_PCD_PATHWAY extends AbstractGroup {

    /** 
     * Creates a new PPP_PCD_PATHWAY group
     */
    public PPP_PCD_PATHWAY(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(PPP_PCD_PATHWAY_ROLE.class, false, true, false);
                                  this.add(PPP_PCD_PROBLEM.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating PPP_PCD_PATHWAY - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public PPP_PCD_PATHWAY_ROLE getPATHWAY_ROLE() { 
       PPP_PCD_PATHWAY_ROLE retVal = getTyped("PATHWAY_ROLE", PPP_PCD_PATHWAY_ROLE.class);
       return retVal;
    }
    ...
    public PPP_PCD_PATHWAY_ROLE getPATHWAY_ROLE(int rep) { 
       PPP_PCD_PATHWAY_ROLE retVal = getTyped("PATHWAY_ROLE", rep, PPP_PCD_PATHWAY_ROLE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PPP_PCD_PATHWAY_ROLE> getPATHWAY_ROLEAll() throws HL7Exception {
    	return getAllAsList("PATHWAY_ROLE", PPP_PCD_PATHWAY_ROLE.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertPATHWAY_ROLE(PPP_PCD_PATHWAY_ROLE structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public PPP_PCD_PATHWAY_ROLE insertPATHWAY_ROLE(int rep) throws HL7Exception { 
       return (PPP_PCD_PATHWAY_ROLE)super.insertRepetition("PATHWAY_ROLE", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public PPP_PCD_PATHWAY_ROLE removePATHWAY_ROLE(int rep) throws HL7Exception { 
       return (PPP_PCD_PATHWAY_ROLE)super.removeRepetition("PATHWAY_ROLE", rep);
    }
    ...
    public PPP_PCD_PROBLEM getPROBLEM() { 
       PPP_PCD_PROBLEM retVal = getTyped("PROBLEM", PPP_PCD_PROBLEM.class);
       return retVal;
    }
    ...
    public PPP_PCD_PROBLEM getPROBLEM(int rep) { 
       PPP_PCD_PROBLEM retVal = getTyped("PROBLEM", rep, PPP_PCD_PROBLEM.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PPP_PCD_PROBLEM> getPROBLEMAll() throws HL7Exception {
    	return getAllAsList("PROBLEM", PPP_PCD_PROBLEM.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertPROBLEM(PPP_PCD_PROBLEM structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public PPP_PCD_PROBLEM insertPROBLEM(int rep) throws HL7Exception { 
       return (PPP_PCD_PROBLEM)super.insertRepetition("PROBLEM", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public PPP_PCD_PROBLEM removePROBLEM(int rep) throws HL7Exception { 
       return (PPP_PCD_PROBLEM)super.removeRepetition("PROBLEM", rep);
    }
