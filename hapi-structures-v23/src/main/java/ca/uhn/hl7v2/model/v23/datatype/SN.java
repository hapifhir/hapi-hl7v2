...
public class SN extends AbstractComposite {
    ...
    /**
     * Returns separator or suffix (component 3).  This is a convenience method that saves you from 
     * casting and handling an exception.
     */
    public ST getSeparatorOrSuffix() {
     ...
     * casting and handling an exception.
     */
    public ST getSn3_SeparatorOrSuffix() {
       return getTyped(2, ST.class);
    }
