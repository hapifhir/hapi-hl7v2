 ...
 * <ul>
		                 ...
		                 * <li>5: SRM_S09_PATIENT (a Group object) <b>optional repeating</b> </li>
		                 * <li>6: SRM_S09_RESOURCES (a Group object) <b> repeating</b> </li>
 * </ul>
 */
...
public class SRM_S09 extends AbstractMessage  {
    ...
    /**
     * Creates a new SRM_S09 message with DefaultModelClassFactory. 
     */ 
    public SRM_S09() { 
    ...
    /** 
     * Creates a new SRM_S09 message with custom ModelClassFactory.
     */
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating SRM_S09 - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public SRM_S09_PATIENT getPATIENT() { 
       return getTyped("PATIENT", SRM_S09_PATIENT.class);
    }
    ...
    public SRM_S09_PATIENT getPATIENT(int rep) { 
       return getTyped("PATIENT", rep, SRM_S09_PATIENT.class);
    }
     ...
     * 
     */ 
    public java.util.List<SRM_S09_PATIENT> getPATIENTAll() throws HL7Exception {
    	return getAllAsList("PATIENT", SRM_S09_PATIENT.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertPATIENT(SRM_S09_PATIENT structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public SRM_S09_PATIENT insertPATIENT(int rep) throws HL7Exception { 
       return (SRM_S09_PATIENT)super.insertRepetition("PATIENT", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public SRM_S09_PATIENT removePATIENT(int rep) throws HL7Exception { 
       return (SRM_S09_PATIENT)super.removeRepetition("PATIENT", rep);
    }
    ...
    public SRM_S09_RESOURCES getRESOURCES() { 
       return getTyped("RESOURCES", SRM_S09_RESOURCES.class);
    }
    ...
    public SRM_S09_RESOURCES getRESOURCES(int rep) { 
       return getTyped("RESOURCES", rep, SRM_S09_RESOURCES.class);
    }
     ...
     * 
     */ 
    public java.util.List<SRM_S09_RESOURCES> getRESOURCESAll() throws HL7Exception {
    	return getAllAsList("RESOURCES", SRM_S09_RESOURCES.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertRESOURCES(SRM_S09_RESOURCES structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public SRM_S09_RESOURCES insertRESOURCES(int rep) throws HL7Exception { 
       return (SRM_S09_RESOURCES)super.insertRepetition("RESOURCES", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public SRM_S09_RESOURCES removeRESOURCES(int rep) throws HL7Exception { 
       return (SRM_S09_RESOURCES)super.removeRepetition("RESOURCES", rep);
    }
