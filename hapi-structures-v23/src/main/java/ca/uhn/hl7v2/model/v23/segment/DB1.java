...
/**
 *<p>Represents an HL7 DB1 message segment (Disability Segment). 
...
public class DB1 extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(SI.class, true, 1, 4, new Object[]{ getMessage() }, "Set ID - DB1");
                                              this.add(IS.class, false, 1, 2, new Object[]{ getMessage(), new Integer(33) }, "Disabled person code");
                                  this.add(CX.class, false, 0, 32, new Object[]{ getMessage() }, "Disabled person identifier");
    ...
    protected Type createNewTypeWithoutReflection(int field) {
       switch (field) {
          ...
          case 1: return new IS(getMessage(), new Integer( 33 ));
