 ...
 * <ul>
		                 ...
		                 * <li>5: RRA_O02_RESPONSE (a Group object) <b>optional </b> </li>
 * </ul>
 */
...
public class RRA_O02 extends AbstractMessage  {
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(RRA_O02_RESPONSE.class, false, false);
     ...
     *
     */
    public RRA_O02_RESPONSE getRESPONSE() { 
       return getTyped("RESPONSE", RRA_O02_RESPONSE.class);
    }
