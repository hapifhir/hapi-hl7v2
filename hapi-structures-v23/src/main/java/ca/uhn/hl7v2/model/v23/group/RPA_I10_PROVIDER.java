...
/**
 * <p>Represents a RPA_I10_PROVIDER group structure (a Group object).
...
public class RPA_I10_PROVIDER extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RPA_I10_PROVIDER - this is probably a bug in the source code generator.", e);
       }
    }
