...
/**
 * <p>Represents a REF_I13 message structure (see chapter ?). This structure contains the 
 * following elements: </p>
 * <ul>
		                 * <li>1: MSH (Message header segment) <b> </b> </li>
		                 * <li>2: RF1 (Referral Information Segment) <b>optional </b> </li>
		                 * <li>3: REF_I13_AUTHORIZATION (a Group object) <b>optional </b> </li>
		                 * <li>4: REF_I13_PROVIDER (a Group object) <b> repeating</b> </li>
		                 ...
		                 * <li>8: REF_I13_INSURANCE (a Group object) <b>optional repeating</b> </li>
		                 ...
		                 * <li>13: REF_I13_PROCEDURE (a Group object) <b>optional repeating</b> </li>
		                 * <li>14: REF_I13_RESULTS (a Group object) <b>optional repeating</b> </li>
		                 * <li>15: REF_I13_VISIT (a Group object) <b>optional </b> </li>
		                 * <li>16: NTE (Notes and comments segment) <b>optional repeating</b> </li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class REF_I13 extends AbstractMessage  {

    /**
     * Creates a new REF_I13 message with DefaultModelClassFactory. 
     */ 
    public REF_I13() { 
    ...
    /** 
     * Creates a new REF_I13 message with custom ModelClassFactory.
     */
    public REF_I13(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(REF_I13_AUTHORIZATION.class, false, false);
	                          this.add(REF_I13_PROVIDER.class, true, true);
	                          this.add(PID.class, true, false);
	                          this.add(NK1.class, false, true);
	                          this.add(GT1.class, false, true);
	                          this.add(REF_I13_INSURANCE.class, false, true);
	                          this.add(ACC.class, false, false);
	                          this.add(DG1.class, false, true);
	                          this.add(DRG.class, false, true);
	                          this.add(AL1.class, false, true);
	                          this.add(REF_I13_PROCEDURE.class, false, true);
	                          this.add(REF_I13_RESULTS.class, false, true);
	                          this.add(REF_I13_VISIT.class, false, false);
	                          this.add(NTE.class, false, true);
	       } catch(HL7Exception e) {
          log.error("Unexpected error creating REF_I13 - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public REF_I13_PROVIDER getPROVIDER() { 
       return getTyped("PROVIDER", REF_I13_PROVIDER.class);
    }
    ...
    public REF_I13_PROVIDER getPROVIDER(int rep) { 
       return getTyped("PROVIDER", rep, REF_I13_PROVIDER.class);
    }
     ...
     * 
     */ 
    public java.util.List<REF_I13_PROVIDER> getPROVIDERAll() throws HL7Exception {
    	return getAllAsList("PROVIDER", REF_I13_PROVIDER.class);
    } 
     ...
     */
    public void insertPROVIDER(REF_I13_PROVIDER structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public REF_I13_PROVIDER insertPROVIDER(int rep) throws HL7Exception { 
       return (REF_I13_PROVIDER)super.insertRepetition("PROVIDER", rep);
    }
     ...
     */
    public REF_I13_PROVIDER removePROVIDER(int rep) throws HL7Exception { 
       return (REF_I13_PROVIDER)super.removeRepetition("PROVIDER", rep);
    }
    ...
    public REF_I13_INSURANCE getINSURANCE() { 
       return getTyped("INSURANCE", REF_I13_INSURANCE.class);
    }
    ...
    public REF_I13_INSURANCE getINSURANCE(int rep) { 
       return getTyped("INSURANCE", rep, REF_I13_INSURANCE.class);
    }
     ...
     * 
     */ 
    public java.util.List<REF_I13_INSURANCE> getINSURANCEAll() throws HL7Exception {
    	return getAllAsList("INSURANCE", REF_I13_INSURANCE.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertINSURANCE(REF_I13_INSURANCE structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public REF_I13_INSURANCE insertINSURANCE(int rep) throws HL7Exception { 
       return (REF_I13_INSURANCE)super.insertRepetition("INSURANCE", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public REF_I13_INSURANCE removeINSURANCE(int rep) throws HL7Exception { 
       return (REF_I13_INSURANCE)super.removeRepetition("INSURANCE", rep);
    }
    ...
    public REF_I13_PROCEDURE getPROCEDURE() { 
       return getTyped("PROCEDURE", REF_I13_PROCEDURE.class);
    }
    ...
    public REF_I13_PROCEDURE getPROCEDURE(int rep) { 
       return getTyped("PROCEDURE", rep, REF_I13_PROCEDURE.class);
    }
     ...
     * 
     */ 
    public java.util.List<REF_I13_PROCEDURE> getPROCEDUREAll() throws HL7Exception {
    	return getAllAsList("PROCEDURE", REF_I13_PROCEDURE.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertPROCEDURE(REF_I13_PROCEDURE structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public REF_I13_PROCEDURE insertPROCEDURE(int rep) throws HL7Exception { 
       return (REF_I13_PROCEDURE)super.insertRepetition("PROCEDURE", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public REF_I13_PROCEDURE removePROCEDURE(int rep) throws HL7Exception { 
       return (REF_I13_PROCEDURE)super.removeRepetition("PROCEDURE", rep);
    }
    ...
    public REF_I13_RESULTS getRESULTS() { 
       return getTyped("RESULTS", REF_I13_RESULTS.class);
    }
    ...
    public REF_I13_RESULTS getRESULTS(int rep) { 
       return getTyped("RESULTS", rep, REF_I13_RESULTS.class);
    }
     ...
     * 
     */ 
    public java.util.List<REF_I13_RESULTS> getRESULTSAll() throws HL7Exception {
    	return getAllAsList("RESULTS", REF_I13_RESULTS.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertRESULTS(REF_I13_RESULTS structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public REF_I13_RESULTS insertRESULTS(int rep) throws HL7Exception { 
       return (REF_I13_RESULTS)super.insertRepetition("RESULTS", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public REF_I13_RESULTS removeRESULTS(int rep) throws HL7Exception { 
       return (REF_I13_RESULTS)super.removeRepetition("RESULTS", rep);
    }
     ...
     *
     */
    public REF_I13_VISIT getVISIT() { 
       return getTyped("VISIT", REF_I13_VISIT.class);
    }
