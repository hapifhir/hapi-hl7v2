 ...
 * <ul>
		                 ...
		                 * <li>3: PPP_PCC_PATIENT_VISIT (a Group object) <b>optional </b> </li>
		                 * <li>4: PPP_PCC_PATHWAY (a Group object) <b> repeating</b> </li>
 * </ul>
 */
...
public class PPP_PCC extends AbstractMessage  {
    ...
    /**
     * Creates a new PPP_PCC message with DefaultModelClassFactory. 
     */ 
    public PPP_PCC() { 
    ...
    /** 
     * Creates a new PPP_PCC message with custom ModelClassFactory.
     */
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PPP_PCC - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public PPP_PCC_PATIENT_VISIT getPATIENT_VISIT() { 
       return getTyped("PATIENT_VISIT", PPP_PCC_PATIENT_VISIT.class);
    }
    ...
    public PPP_PCC_PATHWAY getPATHWAY() { 
       return getTyped("PATHWAY", PPP_PCC_PATHWAY.class);
    }
    ...
    public PPP_PCC_PATHWAY getPATHWAY(int rep) { 
       return getTyped("PATHWAY", rep, PPP_PCC_PATHWAY.class);
    }
     ...
     * 
     */ 
    public java.util.List<PPP_PCC_PATHWAY> getPATHWAYAll() throws HL7Exception {
    	return getAllAsList("PATHWAY", PPP_PCC_PATHWAY.class);
    } 
     ...
     */
    public void insertPATHWAY(PPP_PCC_PATHWAY structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public PPP_PCC_PATHWAY insertPATHWAY(int rep) throws HL7Exception { 
       return (PPP_PCC_PATHWAY)super.insertRepetition("PATHWAY", rep);
    }
     ...
     */
    public PPP_PCC_PATHWAY removePATHWAY(int rep) throws HL7Exception { 
       return (PPP_PCC_PATHWAY)super.removeRepetition("PATHWAY", rep);
    }
