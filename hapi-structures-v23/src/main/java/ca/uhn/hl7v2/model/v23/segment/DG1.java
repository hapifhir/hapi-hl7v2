 ...
 * <ul>
     ...
     * <li>DG1-3: Diagnosis Code (CE) <b>optional </b>
...
public class DG1 extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CE.class, false, 1, 60, new Object[]{ getMessage() }, "Diagnosis Code");
                                  ...
                                  this.add(CE.class, false, 1, 4, new Object[]{ getMessage() }, "Diagnostic Related Group");
                                              this.add(ID.class, false, 1, 2, new Object[]{ getMessage(), new Integer(136) }, "DRG Approval Indicator");
                                  ...
                                  this.add(NM.class, false, 1, 2, new Object[]{ getMessage() }, "Diagnosis Priority");
     ...
     * DG1-3: "Diagnosis Code" - creates it if necessary
     */
    public CE getDg13_DiagnosisCode() { 
		CE retVal = this.getTypedField(3, 0);
		return retVal;
    }
