...
/**
 * <p>Represents a OMD_O01_PATIENT group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: PID (Patient Identification) <b>  </b></li>
                         * <li>2: PD1 (Patient Demographic) <b>optional  </b></li>
                         * <li>3: NTE (Notes and comments segment) <b>optional repeating </b></li>
                         * <li>4: OMD_O01_PATIENT_VISIT (a Group object) <b>optional  </b></li>
                         * <li>5: OMD_O01_INSURANCE (a Group object) <b>optional repeating </b></li>
                         * <li>6: GT1 (Guarantor) <b>optional  </b></li>
                         * <li>7: AL1 (Patient allergy information) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class OMD_O01_PATIENT extends AbstractGroup {

    /** 
     * Creates a new OMD_O01_PATIENT group
     */
    public OMD_O01_PATIENT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(OMD_O01_PATIENT_VISIT.class, false, false, false);
                                  this.add(OMD_O01_INSURANCE.class, false, true, false);
                                  this.add(GT1.class, false, false, false);
                                  this.add(AL1.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating OMD_O01_PATIENT - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     */
    public OMD_O01_PATIENT_VISIT getPATIENT_VISIT() { 
       OMD_O01_PATIENT_VISIT retVal = getTyped("PATIENT_VISIT", OMD_O01_PATIENT_VISIT.class);
       return retVal;
    }
    ...
    public OMD_O01_INSURANCE getINSURANCE() { 
       OMD_O01_INSURANCE retVal = getTyped("INSURANCE", OMD_O01_INSURANCE.class);
       return retVal;
    }
    ...
    public OMD_O01_INSURANCE getINSURANCE(int rep) { 
       OMD_O01_INSURANCE retVal = getTyped("INSURANCE", rep, OMD_O01_INSURANCE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<OMD_O01_INSURANCE> getINSURANCEAll() throws HL7Exception {
    	return getAllAsList("INSURANCE", OMD_O01_INSURANCE.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertINSURANCE(OMD_O01_INSURANCE structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public OMD_O01_INSURANCE insertINSURANCE(int rep) throws HL7Exception { 
       return (OMD_O01_INSURANCE)super.insertRepetition("INSURANCE", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public OMD_O01_INSURANCE removeINSURANCE(int rep) throws HL7Exception { 
       return (OMD_O01_INSURANCE)super.removeRepetition("INSURANCE", rep);
    }
