...
/**
 * <p>Represents a ADT_A26 message structure (see chapter ?). This structure contains the 
...
public class ADT_A26 extends AbstractMessage  {

    /**
     * Creates a new ADT_A26 message with DefaultModelClassFactory. 
     */ 
    public ADT_A26() { 
    ...
    /** 
     * Creates a new ADT_A26 message with custom ModelClassFactory.
     */
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ADT_A26 - this is probably a bug in the source code generator.", e);
       }
    }
