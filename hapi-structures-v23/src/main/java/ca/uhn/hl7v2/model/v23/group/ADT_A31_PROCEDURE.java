...
/**
 * <p>Represents a ADT_A31_PROCEDURE group structure (a Group object).
...
public class ADT_A31_PROCEDURE extends AbstractGroup {

    /** 
     * Creates a new ADT_A31_PROCEDURE group
     */
    public ADT_A31_PROCEDURE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ADT_A31_PROCEDURE - this is probably a bug in the source code generator.", e);
       }
    }
