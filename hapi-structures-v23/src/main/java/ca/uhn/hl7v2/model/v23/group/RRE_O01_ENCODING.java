...
/**
 * <p>Represents a RRE_O01_ENCODING group structure (a Group object).
...
public class RRE_O01_ENCODING extends AbstractGroup {

    /** 
     * Creates a new RRE_O01_ENCODING group
     */
    public RRE_O01_ENCODING(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RRE_O01_ENCODING - this is probably a bug in the source code generator.", e);
       }
    }
