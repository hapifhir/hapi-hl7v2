...
/**
 * <p>Represents a PEX_P08_ASSOCIATED_RX_ORDER group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: RXE (Pharmacy encoded order segment) <b>  </b></li>
                         * <li>2: RXR (Pharmacy route segment) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class PEX_P08_ASSOCIATED_RX_ORDER extends AbstractGroup {

    /** 
     * Creates a new PEX_P08_ASSOCIATED_RX_ORDER group
     */
    public PEX_P08_ASSOCIATED_RX_ORDER(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PEX_P08_ASSOCIATED_RX_ORDER - this is probably a bug in the source code generator.", e);
       }
    }
