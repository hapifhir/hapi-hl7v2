...
/**
 * <p>Represents a PPG_PCH_PROBLEM_ROLE group structure (a Group object).
...
public class PPG_PCH_PROBLEM_ROLE extends AbstractGroup {

    /** 
     * Creates a new PPG_PCH_PROBLEM_ROLE group
     */
    public PPG_PCH_PROBLEM_ROLE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PPG_PCH_PROBLEM_ROLE - this is probably a bug in the source code generator.", e);
       }
    }
