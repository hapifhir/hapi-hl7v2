 ...
 * <ul>
     ...
     * <li>OM2-6: Reference (Normal) Range - Ordinal & Continuous Obs (CM_RFR) <b>optional </b>
     * <li>OM2-7: Critical Range for Ordinal & Continuous Obs (CM_RANGE) <b>optional </b>
     * <li>OM2-8: Absolute Range for Ordinal & Continuous Obs (CM_ABS_RANGE) <b>optional </b>
     * <li>OM2-9: Delta Check Criteria (CM_DLT) <b>optional repeating</b>
...
public class OM2 extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CM_RFR.class, false, 1, 200, new Object[]{ getMessage() }, "Reference (Normal) Range - Ordinal & Continuous Obs");
                                  this.add(CM_RANGE.class, false, 1, 200, new Object[]{ getMessage() }, "Critical Range for Ordinal & Continuous Obs");
                                  this.add(CM_ABS_RANGE.class, false, 1, 200, new Object[]{ getMessage() }, "Absolute Range for Ordinal & Continuous Obs");
    ...
    /**
     * Returns
     * OM2-6: "Reference (Normal) Range - Ordinal & Continuous Obs" - creates it if necessary
     */
    public CM_RFR getReferenceNormalRangeOrdinalContinuousObs() { 
		CM_RFR retVal = this.getTypedField(6, 0);
		return retVal;
    }
    ...
    /**
     * Returns
     * OM2-7: "Critical Range for Ordinal & Continuous Obs" - creates it if necessary
     */
    public CM_RANGE getCriticalRangeForOrdinalContinuousObs() { 
		CM_RANGE retVal = this.getTypedField(7, 0);
		return retVal;
    }
    ...
    /**
     * Returns
     * OM2-8: "Absolute Range for Ordinal & Continuous Obs" - creates it if necessary
     */
    public CM_ABS_RANGE getAbsoluteRangeForOrdinalContinuousObs() { 
		CM_ABS_RANGE retVal = this.getTypedField(8, 0);
		return retVal;
    }
    ...
    public CM_DLT[] getDeltaCheckCriteria() {
    	CM_DLT[] retVal = this.getTypedField(9, new CM_DLT[0]);
    	return retVal;
    }
    ...
    public CM_DLT getDeltaCheckCriteria(int rep) { 
		CM_DLT retVal = this.getTypedField(9, rep);
		return retVal;
    }
    ...
    protected Type createNewTypeWithoutReflection(int field) {
       switch (field) {
          ...
          case 5: return new CM_RFR(getMessage());
          case 6: return new CM_RANGE(getMessage());
          case 7: return new CM_ABS_RANGE(getMessage());
          case 8: return new CM_DLT(getMessage());
