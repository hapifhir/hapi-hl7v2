...
/**
 * <p>Represents a CSU_C12_RX_ADMIN group structure (a Group object).
...
public class CSU_C12_RX_ADMIN extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating CSU_C12_RX_ADMIN - this is probably a bug in the source code generator.", e);
       }
    }
