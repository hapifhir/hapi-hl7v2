...
/**
 * <p>Represents a RRA_O02_ADMINISTRATION group structure (a Group object).
...
public class RRA_O02_ADMINISTRATION extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RRA_O02_ADMINISTRATION - this is probably a bug in the source code generator.", e);
       }
    }
