...
/**
 * <p>Represents a ADT_A32 message structure (see chapter ?). This structure contains the 
...
public class ADT_A32 extends AbstractMessage  {

    /**
     * Creates a new ADT_A32 message with DefaultModelClassFactory. 
     */ 
    public ADT_A32() { 
    ...
    /** 
     * Creates a new ADT_A32 message with custom ModelClassFactory.
     */
    public ADT_A32(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ADT_A32 - this is probably a bug in the source code generator.", e);
       }
    }
