...
/**
 * <p>Represents a ADT_A36 message structure (see chapter ?). This structure contains the 
...
public class ADT_A36 extends AbstractMessage  {

    /**
     * Creates a new ADT_A36 message with DefaultModelClassFactory. 
     */ 
    public ADT_A36() { 
    ...
    /** 
     * Creates a new ADT_A36 message with custom ModelClassFactory.
     */
    public ADT_A36(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ADT_A36 - this is probably a bug in the source code generator.", e);
       }
    }
