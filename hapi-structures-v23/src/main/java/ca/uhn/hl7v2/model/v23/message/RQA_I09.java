...
/**
 * <p>Represents a RQA_I09 message structure (see chapter ?). This structure contains the 
 * following elements: </p>
 * <ul>
		                 * <li>1: MSH (Message header segment) <b> </b> </li>
		                 * <li>2: RF1 (Referral Information Segment) <b>optional </b> </li>
		                 * <li>3: RQA_I09_AUTHORIZATION (a Group object) <b>optional </b> </li>
		                 * <li>4: RQA_I09_PROVIDER (a Group object) <b> repeating</b> </li>
		                 * <li>5: PID (Patient Identification) <b> </b> </li>
		                 * <li>6: NK1 (Next of kin) <b>optional repeating</b> </li>
		                 * <li>7: RQA_I09_GUARANTOR_INSURANCE (a Group object) <b>optional </b> </li>
		                 ...
		                 * <li>12: RQA_I09_PROCEDURE (a Group object) <b>optional repeating</b> </li>
		                 * <li>13: RQA_I09_RESULTS (a Group object) <b>optional repeating</b> </li>
		                 * <li>14: RQA_I09_VISIT (a Group object) <b>optional </b> </li>
		                 * <li>15: NTE (Notes and comments segment) <b>optional repeating</b> </li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class RQA_I09 extends AbstractMessage  {

    /**
     * Creates a new RQA_I09 message with DefaultModelClassFactory. 
     */ 
    public RQA_I09() { 
    ...
    /** 
     * Creates a new RQA_I09 message with custom ModelClassFactory.
     */
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RQA_I09 - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public RQA_I09_AUTHORIZATION getAUTHORIZATION() { 
       return getTyped("AUTHORIZATION", RQA_I09_AUTHORIZATION.class);
    }
    ...
    public RQA_I09_PROVIDER getPROVIDER() { 
       return getTyped("PROVIDER", RQA_I09_PROVIDER.class);
    }
    ...
    public RQA_I09_PROVIDER getPROVIDER(int rep) { 
       return getTyped("PROVIDER", rep, RQA_I09_PROVIDER.class);
    }
     ...
     * 
     */ 
    public java.util.List<RQA_I09_PROVIDER> getPROVIDERAll() throws HL7Exception {
    	return getAllAsList("PROVIDER", RQA_I09_PROVIDER.class);
    } 
    ...
    public RQA_I09_GUARANTOR_INSURANCE getGUARANTOR_INSURANCE() { 
       return getTyped("GUARANTOR_INSURANCE", RQA_I09_GUARANTOR_INSURANCE.class);
    }
    ...
    public RQA_I09_PROCEDURE getPROCEDURE() { 
       return getTyped("PROCEDURE", RQA_I09_PROCEDURE.class);
    }
    ...
    public RQA_I09_PROCEDURE getPROCEDURE(int rep) { 
       return getTyped("PROCEDURE", rep, RQA_I09_PROCEDURE.class);
    }
     ...
     * 
     */ 
    public java.util.List<RQA_I09_PROCEDURE> getPROCEDUREAll() throws HL7Exception {
    	return getAllAsList("PROCEDURE", RQA_I09_PROCEDURE.class);
    } 
    ...
    public RQA_I09_RESULTS getRESULTS() { 
       return getTyped("RESULTS", RQA_I09_RESULTS.class);
    }
    ...
    public RQA_I09_RESULTS getRESULTS(int rep) { 
       return getTyped("RESULTS", rep, RQA_I09_RESULTS.class);
    }
     ...
     * 
     */ 
    public java.util.List<RQA_I09_RESULTS> getRESULTSAll() throws HL7Exception {
    	return getAllAsList("RESULTS", RQA_I09_RESULTS.class);
    } 
    ...
    public RQA_I09_VISIT getVISIT() { 
       return getTyped("VISIT", RQA_I09_VISIT.class);
    }
