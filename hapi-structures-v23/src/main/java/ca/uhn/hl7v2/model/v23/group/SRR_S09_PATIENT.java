...
/**
 * <p>Represents a SRR_S09_PATIENT group structure (a Group object).
...
public class SRR_S09_PATIENT extends AbstractGroup {

    /** 
     * Creates a new SRR_S09_PATIENT group
     */
    public SRR_S09_PATIENT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating SRR_S09_PATIENT - this is probably a bug in the source code generator.", e);
       }
    }
