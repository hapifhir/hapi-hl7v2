 ...
 * <ul>
     ...
     * <li>AIL-3: Location Resource ID (PL) <b> </b>
     * <li>AIL-4: Location Type (CE) <b>optional </b>
...
public class AIL extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(PL.class, true, 1, 80, new Object[]{ getMessage() }, "Location Resource ID");
                                  this.add(CE.class, false, 1, 15, new Object[]{ getMessage() }, "Location Type");
    ...
    /**
     * Returns
     * AIL-4: "Location Type" - creates it if necessary
     */
     ...
     * AIL-4: "Location Type" - creates it if necessary
     */
    public CE getAil4_LocationType() { 
		CE retVal = this.getTypedField(4, 0);
		return retVal;
    }
