...
/**
 * <p>Represents a PEX_P08_RX_ADMINISTRATION group structure (a Group object).
...
public class PEX_P08_RX_ADMINISTRATION extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PEX_P08_RX_ADMINISTRATION - this is probably a bug in the source code generator.", e);
       }
    }
