...
/**
 * <p>Represents a SRM_S04 message structure (see chapter ?). This structure contains the 
 ...
 * <ul>
		                 ...
		                 * <li>5: SRM_S04_PATIENT (a Group object) <b>optional repeating</b> </li>
		                 * <li>6: SRM_S04_RESOURCES (a Group object) <b> repeating</b> </li>
 * </ul>
 */
...
public class SRM_S04 extends AbstractMessage  {
    ...
    /**
     * Creates a new SRM_S04 message with DefaultModelClassFactory. 
     */ 
    public SRM_S04() { 
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(SRM_S04_PATIENT.class, false, true);
	                          this.add(SRM_S04_RESOURCES.class, true, true);
    ...
    public SRM_S04_PATIENT getPATIENT() { 
       return getTyped("PATIENT", SRM_S04_PATIENT.class);
    }
    ...
    public SRM_S04_PATIENT getPATIENT(int rep) { 
       return getTyped("PATIENT", rep, SRM_S04_PATIENT.class);
    }
     ...
     * 
     */ 
    public java.util.List<SRM_S04_PATIENT> getPATIENTAll() throws HL7Exception {
    	return getAllAsList("PATIENT", SRM_S04_PATIENT.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertPATIENT(SRM_S04_PATIENT structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public SRM_S04_PATIENT insertPATIENT(int rep) throws HL7Exception { 
       return (SRM_S04_PATIENT)super.insertRepetition("PATIENT", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public SRM_S04_PATIENT removePATIENT(int rep) throws HL7Exception { 
       return (SRM_S04_PATIENT)super.removeRepetition("PATIENT", rep);
    }
    ...
    public SRM_S04_RESOURCES getRESOURCES() { 
       return getTyped("RESOURCES", SRM_S04_RESOURCES.class);
    }
    ...
    public SRM_S04_RESOURCES getRESOURCES(int rep) { 
       return getTyped("RESOURCES", rep, SRM_S04_RESOURCES.class);
    }
     ...
     * 
     */ 
    public java.util.List<SRM_S04_RESOURCES> getRESOURCESAll() throws HL7Exception {
    	return getAllAsList("RESOURCES", SRM_S04_RESOURCES.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertRESOURCES(SRM_S04_RESOURCES structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public SRM_S04_RESOURCES insertRESOURCES(int rep) throws HL7Exception { 
       return (SRM_S04_RESOURCES)super.insertRepetition("RESOURCES", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public SRM_S04_RESOURCES removeRESOURCES(int rep) throws HL7Exception { 
       return (SRM_S04_RESOURCES)super.removeRepetition("RESOURCES", rep);
    }
