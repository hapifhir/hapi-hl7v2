 ...
 * <ul>
     * <li>OM1-1: Sequence Number - Test/ Observation Master File (NM) <b>optional </b>
     * <li>OM1-2: Producer's Test/Observation ID (CE) <b> </b>
     * <li>OM1-3: Permitted Data Types (ID) <b>optional repeating</b>
     * <li>OM1-4: Specimen Required (ID) <b> </b>
     * <li>OM1-5: Producer ID (CE) <b> </b>
     * <li>OM1-6: Observation Description (CE) <b>optional </b>
     * <li>OM1-7: Other Test/Observation IDs for the Observation (CE) <b>optional </b>
     ...
     * <li>OM1-13: Identity of Instrument Used to Perfrom this Study (CE) <b>optional repeating</b>
     * <li>OM1-14: Coded Representation of Method (CE) <b>optional </b>
     * <li>OM1-15: Portable (ID) <b>optional </b>
     * <li>OM1-16: Observation Producing Department/Section (CE) <b>optional repeating</b>
     * <li>OM1-17: Telephone Number of Section (TN) <b>optional </b>
     * <li>OM1-18: Nature of Test/Observation (ID) <b>optional </b>
     * <li>OM1-19: Report Subheader (CE) <b>optional </b>
     * <li>OM1-20: Report Display Order (ST) <b>optional </b>
     * <li>OM1-21: Date/Time Stamp for any change in Def Attri for Obs (TS) <b>optional </b>
     * <li>OM1-22: Effective Date/Time of Change in Test Proc. that make Results Non-Comparable (TS) <b>optional </b>
     ...
     * <li>OM1-28: Address of Outside Site(s) (AD) <b>optional </b>
     * <li>OM1-29: Phone Number of Outside Site (TN) <b>optional </b>
     * <li>OM1-30: Confidentiality Code (ID) <b>optional </b>
     ...
     * <li>OM1-35: Rules that Trigger Reflex Testing (ST) <b>optional </b>
     ...
     * <li>OM1-39: Factors that may Effect the Observation (TX) <b>optional </b>
     * <li>OM1-40: Test/Observation Performance Schedule (ST) <b>optional repeating</b>
...
public class OM1 extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CE.class, false, 1, 200, new Object[]{ getMessage() }, "Observation Description");
                                  ...
                                  this.add(CE.class, false, 0, 60, new Object[]{ getMessage() }, "Identity of Instrument Used to Perfrom this Study");
                                  this.add(CE.class, false, 1, 200, new Object[]{ getMessage() }, "Coded Representation of Method");
                                              this.add(ID.class, false, 1, 1, new Object[]{ getMessage(), new Integer(136) }, "Portable");
                                  this.add(CE.class, false, 0, 60, new Object[]{ getMessage() }, "Observation Producing Department/Section");
                                  this.add(TN.class, false, 1, 40, new Object[]{ getMessage() }, "Telephone Number of Section");
                                              this.add(ID.class, false, 1, 1, new Object[]{ getMessage(), new Integer(174) }, "Nature of Test/Observation");
                                  ...
                                  this.add(TS.class, false, 1, 26, new Object[]{ getMessage() }, "Date/Time Stamp for any change in Def Attri for Obs");
                                  this.add(TS.class, false, 1, 26, new Object[]{ getMessage() }, "Effective Date/Time of Change in Test Proc. that make Results Non-Comparable");
                                  ...
                                  this.add(AD.class, false, 1, 1000, new Object[]{ getMessage() }, "Address of Outside Site(s)");
                                  this.add(TN.class, false, 1, 400, new Object[]{ getMessage() }, "Phone Number of Outside Site");
                                              this.add(ID.class, false, 1, 1, new Object[]{ getMessage(), new Integer(177) }, "Confidentiality Code");
                                  this.add(CE.class, false, 1, 200, new Object[]{ getMessage() }, "Observations Required to Interpret the Observation");
     ...
     */
    public CE getObservationDescription() { 
     ...
     * OM1-6: "Observation Description" - creates it if necessary
     */
    public CE getOm16_ObservationDescription() { 
		CE retVal = this.getTypedField(6, 0);
		return retVal;
    }
     ...
     * Returns all repetitions of Identity of Instrument Used to Perfrom this Study (OM1-13).
     */
    public CE[] getOm113_IdentityOfInstrumentUsedToPerfromThisStudy() {
    	CE[] retVal = this.getTypedField(13, new CE[0]);
    	return retVal;
    }
    ...
    /**
     * Returns a count of the current number of repetitions of Identity of Instrument Used to Perfrom this Study (OM1-13).
     * This method does not create a repetition, so if no repetitions have currently been defined or accessed,
     * it will return zero.
     */
    public int getIdentityOfInstrumentUsedToPerfromThisStudyReps() {
    ...
    /**
     * Returns a specific repetition of
     * OM1-13: "Identity of Instrument Used to Perfrom this Study" - creates it if necessary
     *
     * @param rep The repetition index (0-indexed)
     */
     ...
     * @param rep The repetition index (0-indexed)
     */
    public CE getOm113_IdentityOfInstrumentUsedToPerfromThisStudy(int rep) { 
		CE retVal = this.getTypedField(13, rep);
		return retVal;
    }
     ...
     * it will return zero.
     */
    public int getOm113_IdentityOfInstrumentUsedToPerfromThisStudyReps() {
    	return this.getReps(13);
    }
    ...
    /**
     * Inserts a repetition of
     * OM1-13: "Identity of Instrument Used to Perfrom this Study" at a specific index
     *
     * @param rep The repetition index (0-indexed)
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public CE insertIdentityOfInstrumentUsedToPerfromThisStudy(int rep) throws HL7Exception { 
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public CE insertOm113_IdentityOfInstrumentUsedToPerfromThisStudy(int rep) throws HL7Exception { 
        return (CE) super.insertRepetition(13, rep);
    }
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public CE removeIdentityOfInstrumentUsedToPerfromThisStudy(int rep) throws HL7Exception { 
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public CE removeOm113_IdentityOfInstrumentUsedToPerfromThisStudy(int rep) throws HL7Exception { 
        return (CE) super.removeRepetition(13, rep);
    }
    ...
    public TN getTelephoneNumberOfSection() { 
		TN retVal = this.getTypedField(17, 0);
		return retVal;
    }
     ...
     * OM1-17: "Telephone Number of Section" - creates it if necessary
     */
    public TN getOm117_TelephoneNumberOfSection() { 
		TN retVal = this.getTypedField(17, 0);
		return retVal;
    }
     ...
     * OM1-18: "Nature of Test/Observation" - creates it if necessary
     */
    public ID getOm118_NatureOfTestObservation() { 
		ID retVal = this.getTypedField(18, 0);
		return retVal;
    }
    ...
    /**
     * Returns
     * OM1-21: "Date/Time Stamp for any change in Def Attri for Obs" - creates it if necessary
     */
    public TS getDateTimeStampForAnyChangeInDefAttriForObs() { 
     ...
     * OM1-21: "Date/Time Stamp for any change in Def Attri for Obs" - creates it if necessary
     */
    public TS getOm121_DateTimeStampForAnyChangeInDefAttriForObs() { 
		TS retVal = this.getTypedField(21, 0);
		return retVal;
    }
    ...
    /**
     * Returns
     * OM1-22: "Effective Date/Time of Change in Test Proc. that make Results Non-Comparable" - creates it if necessary
     */
    public TS getEffectiveDateTimeOfChangeInTestProcThatMakeResultsNonComparable() { 
     ...
     * OM1-22: "Effective Date/Time of Change in Test Proc. that make Results Non-Comparable" - creates it if necessary
     */
    public TS getOm122_EffectiveDateTimeOfChangeInTestProcThatMakeResultsNonComparable() { 
		TS retVal = this.getTypedField(22, 0);
		return retVal;
    }
    ...
    public AD getAddressOfOutsideSiteS() { 
		AD retVal = this.getTypedField(28, 0);
		return retVal;
    }
     ...
     * OM1-28: "Address of Outside Site(s)" - creates it if necessary
     */
    public AD getOm128_AddressOfOutsideSiteS() { 
		AD retVal = this.getTypedField(28, 0);
		return retVal;
    }
    ...
    public TN getPhoneNumberOfOutsideSite() { 
		TN retVal = this.getTypedField(29, 0);
		return retVal;
    }
     ...
     * OM1-29: "Phone Number of Outside Site" - creates it if necessary
     */
    public TN getOm129_PhoneNumberOfOutsideSite() { 
		TN retVal = this.getTypedField(29, 0);
		return retVal;
    }
     ...
     * OM1-30: "Confidentiality Code" - creates it if necessary
     */
    public ID getOm130_ConfidentialityCode() { 
		ID retVal = this.getTypedField(30, 0);
		return retVal;
    }
     ...
     * OM1-35: "Rules that Trigger Reflex Testing" - creates it if necessary
     */
    public ST getOm135_RulesThatTriggerReflexTesting() { 
		ST retVal = this.getTypedField(35, 0);
		return retVal;
    }
    ...
    protected Type createNewTypeWithoutReflection(int field) {
       switch (field) {
          ...
          case 17: return new ID(getMessage(), new Integer( 174 ));
          ...
          case 27: return new AD(getMessage());
          case 28: return new TN(getMessage());
          case 29: return new ID(getMessage(), new Integer( 177 ));
