 ...
 * <ul>
		                 ...
		                 * <li>3: RDO_O01_PATIENT (a Group object) <b>optional </b> </li>
		                 * <li>4: RDO_O01_ORDER (a Group object) <b> repeating</b> </li>
 * </ul>
 */
...
public class RDO_O01 extends AbstractMessage  {
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(RDO_O01_PATIENT.class, false, false);
	                          this.add(RDO_O01_ORDER.class, true, true);
     ...
     *
     */
    public RDO_O01_PATIENT getPATIENT() { 
       return getTyped("PATIENT", RDO_O01_PATIENT.class);
    }
    ...
    public RDO_O01_ORDER getORDER() { 
       return getTyped("ORDER", RDO_O01_ORDER.class);
    }
    ...
    public RDO_O01_ORDER getORDER(int rep) { 
       return getTyped("ORDER", rep, RDO_O01_ORDER.class);
    }
     ...
     * 
     */ 
    public java.util.List<RDO_O01_ORDER> getORDERAll() throws HL7Exception {
    	return getAllAsList("ORDER", RDO_O01_ORDER.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertORDER(RDO_O01_ORDER structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public RDO_O01_ORDER insertORDER(int rep) throws HL7Exception { 
       return (RDO_O01_ORDER)super.insertRepetition("ORDER", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public RDO_O01_ORDER removeORDER(int rep) throws HL7Exception { 
       return (RDO_O01_ORDER)super.removeRepetition("ORDER", rep);
    }
