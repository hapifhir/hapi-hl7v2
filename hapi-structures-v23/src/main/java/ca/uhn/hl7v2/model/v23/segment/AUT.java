 ...
 * <ul>
     * <li>AUT-1: Authorizing Payor, Plan Code (CE) <b>optional </b>
...
public class AUT extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(CE.class, false, 1, 200, new Object[]{ getMessage() }, "Authorizing Payor, Plan Code");
    ...
    /**
     * Returns
     * AUT-1: "Authorizing Payor, Plan Code" - creates it if necessary
     */
     ...
     * AUT-1: "Authorizing Payor, Plan Code" - creates it if necessary
     */
    public CE getAut1_AuthorizingPayorPlanCode() { 
		CE retVal = this.getTypedField(1, 0);
		return retVal;
    }
