...
/**
 * <p>Represents a RAS_O01_ENCODING group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: RXE (Pharmacy encoded order segment) <b>  </b></li>
                         * <li>2: RXR (Pharmacy route segment) <b> repeating </b></li>
                         * <li>3: RXC (Pharmacy component order segment) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class RAS_O01_ENCODING extends AbstractGroup {

    /** 
     * Creates a new RAS_O01_ENCODING group
     */
    public RAS_O01_ENCODING(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RAS_O01_ENCODING - this is probably a bug in the source code generator.", e);
       }
    }
