...
/**
 * <p>Represents a RRI_I13 message structure (see chapter ?). This structure contains the 
 ...
 * <ul>
		                 ...
		                 * <li>4: RRI_I13_AUTHORIZATION (a Group object) <b>optional </b> </li>
		                 * <li>5: RRI_I13_PROVIDER (a Group object) <b> repeating</b> </li>
		                 ...
		                 * <li>11: RRI_I13_PROCEDURE (a Group object) <b>optional repeating</b> </li>
		                 * <li>12: RRI_I13_RESULTS (a Group object) <b>optional repeating</b> </li>
		                 * <li>13: RRI_I13_VISIT (a Group object) <b>optional </b> </li>
...
public class RRI_I13 extends AbstractMessage  {
    ...
    /**
     * Creates a new RRI_I13 message with DefaultModelClassFactory. 
     */ 
    public RRI_I13() { 
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RRI_I13 - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public RRI_I13_AUTHORIZATION getAUTHORIZATION() { 
       return getTyped("AUTHORIZATION", RRI_I13_AUTHORIZATION.class);
    }
    ...
    public RRI_I13_PROVIDER getPROVIDER() { 
       return getTyped("PROVIDER", RRI_I13_PROVIDER.class);
    }
    ...
    public RRI_I13_PROVIDER getPROVIDER(int rep) { 
       return getTyped("PROVIDER", rep, RRI_I13_PROVIDER.class);
    }
     ...
     * 
     */ 
    public java.util.List<RRI_I13_PROVIDER> getPROVIDERAll() throws HL7Exception {
    	return getAllAsList("PROVIDER", RRI_I13_PROVIDER.class);
    } 
    ...
    public RRI_I13_PROCEDURE getPROCEDURE() { 
       return getTyped("PROCEDURE", RRI_I13_PROCEDURE.class);
    }
    ...
    public RRI_I13_PROCEDURE getPROCEDURE(int rep) { 
       return getTyped("PROCEDURE", rep, RRI_I13_PROCEDURE.class);
    }
     ...
     * 
     */ 
    public java.util.List<RRI_I13_PROCEDURE> getPROCEDUREAll() throws HL7Exception {
    	return getAllAsList("PROCEDURE", RRI_I13_PROCEDURE.class);
    } 
    ...
    public RRI_I13_RESULTS getRESULTS() { 
       return getTyped("RESULTS", RRI_I13_RESULTS.class);
    }
    ...
    public RRI_I13_RESULTS getRESULTS(int rep) { 
       return getTyped("RESULTS", rep, RRI_I13_RESULTS.class);
    }
     ...
     * 
     */ 
    public java.util.List<RRI_I13_RESULTS> getRESULTSAll() throws HL7Exception {
    	return getAllAsList("RESULTS", RRI_I13_RESULTS.class);
    } 
    ...
    public RRI_I13_VISIT getVISIT() { 
       return getTyped("VISIT", RRI_I13_VISIT.class);
    }
