...
/**
 * <p>Represents a RRI_I12_RESULTS group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>3: RRI_I12_OBSERVATION (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
...
public class RRI_I12_RESULTS extends AbstractGroup {
     ...
     */
    public RRI_I12_RESULTS(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(RRI_I12_OBSERVATION.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating RRI_I12_RESULTS - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public RRI_I12_OBSERVATION getOBSERVATION() { 
       RRI_I12_OBSERVATION retVal = getTyped("OBSERVATION", RRI_I12_OBSERVATION.class);
       return retVal;
    }
    ...
    public RRI_I12_OBSERVATION getOBSERVATION(int rep) { 
       RRI_I12_OBSERVATION retVal = getTyped("OBSERVATION", rep, RRI_I12_OBSERVATION.class);
       return retVal;
    }
