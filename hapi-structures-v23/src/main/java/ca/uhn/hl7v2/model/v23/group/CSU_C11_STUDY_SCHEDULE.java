...
/**
 * <p>Represents a CSU_C11_STUDY_SCHEDULE group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: CSS (Clinical Study Data Schedule) <b>optional  </b></li>
                         * <li>2: CSU_C11_STUDY_OBSERVATION (a Group object) <b>optional repeating </b></li>
                         * <li>3: CSU_C11_STUDY_PHARM (a Group object) <b> repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class CSU_C11_STUDY_SCHEDULE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CSU_C11_STUDY_OBSERVATION.class, false, true, false);
                                  this.add(CSU_C11_STUDY_PHARM.class, true, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating CSU_C11_STUDY_SCHEDULE - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public CSU_C11_STUDY_OBSERVATION getSTUDY_OBSERVATION() { 
       CSU_C11_STUDY_OBSERVATION retVal = getTyped("STUDY_OBSERVATION", CSU_C11_STUDY_OBSERVATION.class);
       return retVal;
    }
    ...
    public CSU_C11_STUDY_OBSERVATION getSTUDY_OBSERVATION(int rep) { 
       CSU_C11_STUDY_OBSERVATION retVal = getTyped("STUDY_OBSERVATION", rep, CSU_C11_STUDY_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<CSU_C11_STUDY_OBSERVATION> getSTUDY_OBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("STUDY_OBSERVATION", CSU_C11_STUDY_OBSERVATION.class);
    } 
    ...
    public CSU_C11_STUDY_PHARM getSTUDY_PHARM() { 
       CSU_C11_STUDY_PHARM retVal = getTyped("STUDY_PHARM", CSU_C11_STUDY_PHARM.class);
       return retVal;
    }
    ...
    public CSU_C11_STUDY_PHARM getSTUDY_PHARM(int rep) { 
       CSU_C11_STUDY_PHARM retVal = getTyped("STUDY_PHARM", rep, CSU_C11_STUDY_PHARM.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<CSU_C11_STUDY_PHARM> getSTUDY_PHARMAll() throws HL7Exception {
    	return getAllAsList("STUDY_PHARM", CSU_C11_STUDY_PHARM.class);
    } 
