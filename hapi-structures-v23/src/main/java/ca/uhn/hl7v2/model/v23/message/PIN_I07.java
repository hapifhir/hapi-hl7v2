...
/**
 * <p>Represents a PIN_I07 message structure (see chapter ?). This structure contains the 
 * following elements: </p>
 * <ul>
		                 * <li>1: MSH (Message header segment) <b> </b> </li>
		                 * <li>2: PIN_I07_PROVIDER (a Group object) <b> repeating</b> </li>
		                 * <li>3: PID (Patient Identification) <b> </b> </li>
		                 * <li>4: NK1 (Next of kin) <b>optional repeating</b> </li>
		                 * <li>5: PIN_I07_GUARANTOR_INSURANCE (a Group object) <b>optional </b> </li>
		                 * <li>6: NTE (Notes and comments segment) <b>optional repeating</b> </li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class PIN_I07 extends AbstractMessage  {

    /**
     * Creates a new PIN_I07 message with DefaultModelClassFactory. 
     */ 
    public PIN_I07() { 
    ...
    /** 
     * Creates a new PIN_I07 message with custom ModelClassFactory.
     */
    public PIN_I07(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          this.add(PIN_I07_PROVIDER.class, true, true);
	                          this.add(PID.class, true, false);
	                          this.add(NK1.class, false, true);
	                          this.add(PIN_I07_GUARANTOR_INSURANCE.class, false, false);
	                          this.add(NTE.class, false, true);
	       } catch(HL7Exception e) {
          log.error("Unexpected error creating PIN_I07 - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public PIN_I07_PROVIDER getPROVIDER() { 
       return getTyped("PROVIDER", PIN_I07_PROVIDER.class);
    }
    ...
    public PIN_I07_PROVIDER getPROVIDER(int rep) { 
       return getTyped("PROVIDER", rep, PIN_I07_PROVIDER.class);
    }
     ...
     * 
     */ 
    public java.util.List<PIN_I07_PROVIDER> getPROVIDERAll() throws HL7Exception {
    	return getAllAsList("PROVIDER", PIN_I07_PROVIDER.class);
    } 
     ...
     */
    public void insertPROVIDER(PIN_I07_PROVIDER structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public PIN_I07_PROVIDER insertPROVIDER(int rep) throws HL7Exception { 
       return (PIN_I07_PROVIDER)super.insertRepetition("PROVIDER", rep);
    }
     ...
     */
    public PIN_I07_PROVIDER removePROVIDER(int rep) throws HL7Exception { 
       return (PIN_I07_PROVIDER)super.removeRepetition("PROVIDER", rep);
    }
     ...
     *
     */
    public PIN_I07_GUARANTOR_INSURANCE getGUARANTOR_INSURANCE() { 
       return getTyped("GUARANTOR_INSURANCE", PIN_I07_GUARANTOR_INSURANCE.class);
    }
