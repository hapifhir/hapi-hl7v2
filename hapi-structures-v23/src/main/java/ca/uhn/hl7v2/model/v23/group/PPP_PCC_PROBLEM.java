...
/**
 * <p>Represents a PPP_PCC_PROBLEM group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>4: PPP_PCC_PROBLEM_ROLE (a Group object) <b>optional repeating </b></li>
                         * <li>5: PPP_PCC_PROBLEM_OBSERVATION (a Group object) <b>optional repeating </b></li>
                         * <li>6: PPP_PCC_GOAL (a Group object) <b>optional repeating </b></li>
                         * <li>7: PPP_PCC_ORDER (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
...
public class PPP_PCC_PROBLEM extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(PPP_PCC_PROBLEM_ROLE.class, false, true, false);
                                  this.add(PPP_PCC_PROBLEM_OBSERVATION.class, false, true, false);
                                  this.add(PPP_PCC_GOAL.class, false, true, false);
                                  this.add(PPP_PCC_ORDER.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating PPP_PCC_PROBLEM - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public PPP_PCC_PROBLEM_ROLE getPROBLEM_ROLE() { 
       PPP_PCC_PROBLEM_ROLE retVal = getTyped("PROBLEM_ROLE", PPP_PCC_PROBLEM_ROLE.class);
       return retVal;
    }
    ...
    public PPP_PCC_PROBLEM_ROLE getPROBLEM_ROLE(int rep) { 
       PPP_PCC_PROBLEM_ROLE retVal = getTyped("PROBLEM_ROLE", rep, PPP_PCC_PROBLEM_ROLE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PPP_PCC_PROBLEM_ROLE> getPROBLEM_ROLEAll() throws HL7Exception {
    	return getAllAsList("PROBLEM_ROLE", PPP_PCC_PROBLEM_ROLE.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertPROBLEM_ROLE(PPP_PCC_PROBLEM_ROLE structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public PPP_PCC_PROBLEM_ROLE insertPROBLEM_ROLE(int rep) throws HL7Exception { 
       return (PPP_PCC_PROBLEM_ROLE)super.insertRepetition("PROBLEM_ROLE", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public PPP_PCC_PROBLEM_ROLE removePROBLEM_ROLE(int rep) throws HL7Exception { 
       return (PPP_PCC_PROBLEM_ROLE)super.removeRepetition("PROBLEM_ROLE", rep);
    }
    ...
    public PPP_PCC_PROBLEM_OBSERVATION getPROBLEM_OBSERVATION() { 
       PPP_PCC_PROBLEM_OBSERVATION retVal = getTyped("PROBLEM_OBSERVATION", PPP_PCC_PROBLEM_OBSERVATION.class);
       return retVal;
    }
    ...
    public PPP_PCC_PROBLEM_OBSERVATION getPROBLEM_OBSERVATION(int rep) { 
       PPP_PCC_PROBLEM_OBSERVATION retVal = getTyped("PROBLEM_OBSERVATION", rep, PPP_PCC_PROBLEM_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PPP_PCC_PROBLEM_OBSERVATION> getPROBLEM_OBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("PROBLEM_OBSERVATION", PPP_PCC_PROBLEM_OBSERVATION.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertPROBLEM_OBSERVATION(PPP_PCC_PROBLEM_OBSERVATION structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public PPP_PCC_PROBLEM_OBSERVATION insertPROBLEM_OBSERVATION(int rep) throws HL7Exception { 
       return (PPP_PCC_PROBLEM_OBSERVATION)super.insertRepetition("PROBLEM_OBSERVATION", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public PPP_PCC_PROBLEM_OBSERVATION removePROBLEM_OBSERVATION(int rep) throws HL7Exception { 
       return (PPP_PCC_PROBLEM_OBSERVATION)super.removeRepetition("PROBLEM_OBSERVATION", rep);
    }
    ...
    public PPP_PCC_GOAL getGOAL() { 
       PPP_PCC_GOAL retVal = getTyped("GOAL", PPP_PCC_GOAL.class);
       return retVal;
    }
    ...
    public PPP_PCC_GOAL getGOAL(int rep) { 
       PPP_PCC_GOAL retVal = getTyped("GOAL", rep, PPP_PCC_GOAL.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PPP_PCC_GOAL> getGOALAll() throws HL7Exception {
    	return getAllAsList("GOAL", PPP_PCC_GOAL.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertGOAL(PPP_PCC_GOAL structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public PPP_PCC_GOAL insertGOAL(int rep) throws HL7Exception { 
       return (PPP_PCC_GOAL)super.insertRepetition("GOAL", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public PPP_PCC_GOAL removeGOAL(int rep) throws HL7Exception { 
       return (PPP_PCC_GOAL)super.removeRepetition("GOAL", rep);
    }
    ...
    public PPP_PCC_ORDER getORDER() { 
       PPP_PCC_ORDER retVal = getTyped("ORDER", PPP_PCC_ORDER.class);
       return retVal;
    }
    ...
    public PPP_PCC_ORDER getORDER(int rep) { 
       PPP_PCC_ORDER retVal = getTyped("ORDER", rep, PPP_PCC_ORDER.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PPP_PCC_ORDER> getORDERAll() throws HL7Exception {
    	return getAllAsList("ORDER", PPP_PCC_ORDER.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertORDER(PPP_PCC_ORDER structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public PPP_PCC_ORDER insertORDER(int rep) throws HL7Exception { 
       return (PPP_PCC_ORDER)super.insertRepetition("ORDER", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public PPP_PCC_ORDER removeORDER(int rep) throws HL7Exception { 
       return (PPP_PCC_ORDER)super.removeRepetition("ORDER", rep);
    }
