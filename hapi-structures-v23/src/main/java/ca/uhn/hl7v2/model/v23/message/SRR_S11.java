 ...
 * <ul>
		                 ...
		                 * <li>4: SRR_S11_SCHEDULE (a Group object) <b>optional </b> </li>
 * </ul>
 */
...
public class SRR_S11 extends AbstractMessage  {
    ...
    /**
     * Creates a new SRR_S11 message with DefaultModelClassFactory. 
     */ 
    public SRR_S11() { 
    ...
    /** 
     * Creates a new SRR_S11 message with custom ModelClassFactory.
     */
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating SRR_S11 - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public SRR_S11_SCHEDULE getSCHEDULE() { 
       return getTyped("SCHEDULE", SRR_S11_SCHEDULE.class);
    }
