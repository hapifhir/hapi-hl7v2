...
/**
 * <p>Represents a OMS_O01_INSURANCE group structure (a Group object).
...
public class OMS_O01_INSURANCE extends AbstractGroup {

    /** 
     * Creates a new OMS_O01_INSURANCE group
     */
    public OMS_O01_INSURANCE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating OMS_O01_INSURANCE - this is probably a bug in the source code generator.", e);
       }
    }
