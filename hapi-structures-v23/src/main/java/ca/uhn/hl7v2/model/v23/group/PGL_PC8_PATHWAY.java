...
/**
 * <p>Represents a PGL_PC8_PATHWAY group structure (a Group object).
...
public class PGL_PC8_PATHWAY extends AbstractGroup {
     ...
     */
    public PGL_PC8_PATHWAY(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PGL_PC8_PATHWAY - this is probably a bug in the source code generator.", e);
       }
    }
