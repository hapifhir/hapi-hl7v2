 ...
 * <ul>
		                 ...
		                 * <li>5: ORF_R02_QUERY_RESPONSE (a Group object) <b> repeating</b> </li>
...
public class ORF_R02 extends AbstractMessage  {
    ...
    /**
     * Creates a new ORF_R02 message with DefaultModelClassFactory. 
     */ 
    public ORF_R02() { 
    ...
    /** 
     * Creates a new ORF_R02 message with custom ModelClassFactory.
     */
    ...
    public ORF_R02_QUERY_RESPONSE getQUERY_RESPONSE() { 
       return getTyped("QUERY_RESPONSE", ORF_R02_QUERY_RESPONSE.class);
    }
    ...
    public ORF_R02_QUERY_RESPONSE getQUERY_RESPONSE(int rep) { 
       return getTyped("QUERY_RESPONSE", rep, ORF_R02_QUERY_RESPONSE.class);
    }
     ...
     * 
     */ 
    public java.util.List<ORF_R02_QUERY_RESPONSE> getQUERY_RESPONSEAll() throws HL7Exception {
    	return getAllAsList("QUERY_RESPONSE", ORF_R02_QUERY_RESPONSE.class);
    } 
