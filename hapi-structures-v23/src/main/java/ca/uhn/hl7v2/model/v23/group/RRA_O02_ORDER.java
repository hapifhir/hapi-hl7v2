...
/**
 * <p>Represents a RRA_O02_ORDER group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: ORC (Common order segment) <b>  </b></li>
                         * <li>2: RRA_O02_ADMINISTRATION (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
...
public class RRA_O02_ORDER extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(RRA_O02_ADMINISTRATION.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating RRA_O02_ORDER - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public RRA_O02_ADMINISTRATION getADMINISTRATION() { 
       RRA_O02_ADMINISTRATION retVal = getTyped("ADMINISTRATION", RRA_O02_ADMINISTRATION.class);
       return retVal;
    }
    ...
    public RRA_O02_ADMINISTRATION getADMINISTRATION(int rep) { 
       RRA_O02_ADMINISTRATION retVal = getTyped("ADMINISTRATION", rep, RRA_O02_ADMINISTRATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<RRA_O02_ADMINISTRATION> getADMINISTRATIONAll() throws HL7Exception {
