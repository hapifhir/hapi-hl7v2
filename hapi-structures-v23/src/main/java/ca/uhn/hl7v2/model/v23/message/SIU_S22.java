...
/**
 * <p>Represents a SIU_S22 message structure (see chapter ?). This structure contains the 
 ...
 * <ul>
		                 ...
		                 * <li>4: SIU_S22_PATIENT (a Group object) <b>optional repeating</b> </li>
		                 * <li>5: SIU_S22_RESOURCES (a Group object) <b> repeating</b> </li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class SIU_S22 extends AbstractMessage  {

    /**
     * Creates a new SIU_S22 message with DefaultModelClassFactory. 
     */ 
    public SIU_S22() { 
    ...
    /** 
     * Creates a new SIU_S22 message with custom ModelClassFactory.
     */
    ...
    public SIU_S22_PATIENT getPATIENT() { 
       return getTyped("PATIENT", SIU_S22_PATIENT.class);
    }
    ...
    public SIU_S22_PATIENT getPATIENT(int rep) { 
       return getTyped("PATIENT", rep, SIU_S22_PATIENT.class);
    }
     ...
     * 
     */ 
    public java.util.List<SIU_S22_PATIENT> getPATIENTAll() throws HL7Exception {
    	return getAllAsList("PATIENT", SIU_S22_PATIENT.class);
    } 
    ...
    public SIU_S22_RESOURCES getRESOURCES() { 
       return getTyped("RESOURCES", SIU_S22_RESOURCES.class);
    }
    ...
    public SIU_S22_RESOURCES getRESOURCES(int rep) { 
       return getTyped("RESOURCES", rep, SIU_S22_RESOURCES.class);
    }
     ...
     * 
     */ 
    public java.util.List<SIU_S22_RESOURCES> getRESOURCESAll() throws HL7Exception {
    	return getAllAsList("RESOURCES", SIU_S22_RESOURCES.class);
    } 
