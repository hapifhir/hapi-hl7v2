...
/**
 * <p>Represents a PIN_I07_PROVIDER group structure (a Group object).
...
public class PIN_I07_PROVIDER extends AbstractGroup {

    /** 
     * Creates a new PIN_I07_PROVIDER group
     */
    public PIN_I07_PROVIDER(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PIN_I07_PROVIDER - this is probably a bug in the source code generator.", e);
       }
    }
