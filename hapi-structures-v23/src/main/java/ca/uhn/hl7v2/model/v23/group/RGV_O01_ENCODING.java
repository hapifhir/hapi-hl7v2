...
/**
 * <p>Represents a RGV_O01_ENCODING group structure (a Group object).
...
public class RGV_O01_ENCODING extends AbstractGroup {

    /** 
     * Creates a new RGV_O01_ENCODING group
     */
    public RGV_O01_ENCODING(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RGV_O01_ENCODING - this is probably a bug in the source code generator.", e);
       }
    }
