...
/**
 * <p>Represents a RPA_I11_RESULTS group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>3: RPA_I11_OBSERVATION (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class RPA_I11_RESULTS extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RPA_I11_RESULTS - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public RPA_I11_OBSERVATION getOBSERVATION() { 
       RPA_I11_OBSERVATION retVal = getTyped("OBSERVATION", RPA_I11_OBSERVATION.class);
       return retVal;
    }
    ...
    public RPA_I11_OBSERVATION getOBSERVATION(int rep) { 
       RPA_I11_OBSERVATION retVal = getTyped("OBSERVATION", rep, RPA_I11_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<RPA_I11_OBSERVATION> getOBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("OBSERVATION", RPA_I11_OBSERVATION.class);
    } 
