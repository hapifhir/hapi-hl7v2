 ...
 * <li>pre-certification windwow (TS)
 * </ul>
 */
...
public class CM_PCF extends AbstractComposite {
     ...
     * casting and handling an exception.
     */
    public IS getCm_pcf1_PreCertificationPatientType() {
       return getTyped(0, IS.class);
    }
     ...
     * casting and handling an exception.
     */
    public ID getCm_pcf2_PreCertificationRequired() {
       return getTyped(1, ID.class);
    }


    /**
     * Returns pre-certification windwow (component 3).  This is a convenience method that saves you from 
     * casting and handling an exception.
     */
     ...
     * casting and handling an exception.
     */
    public TS getCm_pcf3_PreCertificationWindwow() {
       return getTyped(2, TS.class);
    }
