...
/**
 * <p>Represents a MFN_M07_MF_PHASE_SCHED_DETAIL group structure (a Group object).
...
public class MFN_M07_MF_PHASE_SCHED_DETAIL extends AbstractGroup {

    /** 
     * Creates a new MFN_M07_MF_PHASE_SCHED_DETAIL group
     */
    public MFN_M07_MF_PHASE_SCHED_DETAIL(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating MFN_M07_MF_PHASE_SCHED_DETAIL - this is probably a bug in the source code generator.", e);
       }
    }
