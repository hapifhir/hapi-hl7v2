...
/**
 * <p>Represents a PPG_PCH_GOAL group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>4: PPG_PCH_GOAL_ROLE (a Group object) <b>optional repeating </b></li>
                         * <li>5: PPG_PCH_GOAL_OBSERVATION (a Group object) <b>optional repeating </b></li>
                         * <li>6: PPG_PCH_PROBLEM (a Group object) <b>optional repeating </b></li>
                         * <li>7: PPG_PCH_ORDER (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
...
public class PPG_PCH_GOAL extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PPG_PCH_GOAL - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public PPG_PCH_GOAL_ROLE getGOAL_ROLE() { 
       PPG_PCH_GOAL_ROLE retVal = getTyped("GOAL_ROLE", PPG_PCH_GOAL_ROLE.class);
       return retVal;
    }
    ...
    public PPG_PCH_GOAL_ROLE getGOAL_ROLE(int rep) { 
       PPG_PCH_GOAL_ROLE retVal = getTyped("GOAL_ROLE", rep, PPG_PCH_GOAL_ROLE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PPG_PCH_GOAL_ROLE> getGOAL_ROLEAll() throws HL7Exception {
    	return getAllAsList("GOAL_ROLE", PPG_PCH_GOAL_ROLE.class);
    } 
    ...
    public PPG_PCH_GOAL_OBSERVATION getGOAL_OBSERVATION() { 
       PPG_PCH_GOAL_OBSERVATION retVal = getTyped("GOAL_OBSERVATION", PPG_PCH_GOAL_OBSERVATION.class);
       return retVal;
    }
    ...
    public PPG_PCH_GOAL_OBSERVATION getGOAL_OBSERVATION(int rep) { 
       PPG_PCH_GOAL_OBSERVATION retVal = getTyped("GOAL_OBSERVATION", rep, PPG_PCH_GOAL_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PPG_PCH_GOAL_OBSERVATION> getGOAL_OBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("GOAL_OBSERVATION", PPG_PCH_GOAL_OBSERVATION.class);
    } 
    ...
    public PPG_PCH_PROBLEM getPROBLEM() { 
       PPG_PCH_PROBLEM retVal = getTyped("PROBLEM", PPG_PCH_PROBLEM.class);
       return retVal;
    }
    ...
    public PPG_PCH_PROBLEM getPROBLEM(int rep) { 
       PPG_PCH_PROBLEM retVal = getTyped("PROBLEM", rep, PPG_PCH_PROBLEM.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PPG_PCH_PROBLEM> getPROBLEMAll() throws HL7Exception {
    	return getAllAsList("PROBLEM", PPG_PCH_PROBLEM.class);
    } 
    ...
    public PPG_PCH_ORDER getORDER() { 
       PPG_PCH_ORDER retVal = getTyped("ORDER", PPG_PCH_ORDER.class);
       return retVal;
    }
    ...
    public PPG_PCH_ORDER getORDER(int rep) { 
       PPG_PCH_ORDER retVal = getTyped("ORDER", rep, PPG_PCH_ORDER.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PPG_PCH_ORDER> getORDERAll() throws HL7Exception {
    	return getAllAsList("ORDER", PPG_PCH_ORDER.class);
    } 
