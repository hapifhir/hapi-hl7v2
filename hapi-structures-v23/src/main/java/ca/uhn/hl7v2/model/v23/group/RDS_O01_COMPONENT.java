...
/**
 * <p>Represents a RDS_O01_COMPONENT group structure (a Group object).
...
public class RDS_O01_COMPONENT extends AbstractGroup {

    /** 
     * Creates a new RDS_O01_COMPONENT group
     */
    public RDS_O01_COMPONENT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RDS_O01_COMPONENT - this is probably a bug in the source code generator.", e);
       }
    }
