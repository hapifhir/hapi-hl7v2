...
/**
 * <p>Represents a RAS_O01_PATIENT group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>5: RAS_O01_PATIENT_VISIT (a Group object) <b>optional  </b></li>
 * </ul>
 */
...
public class RAS_O01_PATIENT extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(RAS_O01_PATIENT_VISIT.class, false, false, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating RAS_O01_PATIENT - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public RAS_O01_PATIENT_VISIT getPATIENT_VISIT() { 
       RAS_O01_PATIENT_VISIT retVal = getTyped("PATIENT_VISIT", RAS_O01_PATIENT_VISIT.class);
       return retVal;
    }
