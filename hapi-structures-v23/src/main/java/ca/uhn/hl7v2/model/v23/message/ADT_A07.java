 ...
 * <ul>
		                 ...
		                 * <li>15: ADT_A07_PROCEDURE (a Group object) <b>optional repeating</b> </li>
		                 * <li>16: GT1 (Guarantor) <b>optional repeating</b> </li>
		                 * <li>17: ADT_A07_INSURANCE (a Group object) <b>optional repeating</b> </li>
...
public class ADT_A07 extends AbstractMessage  {
    ...
    public ADT_A07_PROCEDURE getPROCEDURE() { 
       return getTyped("PROCEDURE", ADT_A07_PROCEDURE.class);
    }
    ...
    public ADT_A07_PROCEDURE getPROCEDURE(int rep) { 
       return getTyped("PROCEDURE", rep, ADT_A07_PROCEDURE.class);
    }
     ...
     * 
     */ 
    public java.util.List<ADT_A07_PROCEDURE> getPROCEDUREAll() throws HL7Exception {
    	return getAllAsList("PROCEDURE", ADT_A07_PROCEDURE.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertPROCEDURE(ADT_A07_PROCEDURE structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public ADT_A07_PROCEDURE insertPROCEDURE(int rep) throws HL7Exception { 
       return (ADT_A07_PROCEDURE)super.insertRepetition("PROCEDURE", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public ADT_A07_PROCEDURE removePROCEDURE(int rep) throws HL7Exception { 
       return (ADT_A07_PROCEDURE)super.removeRepetition("PROCEDURE", rep);
    }
