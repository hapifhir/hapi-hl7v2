...
/**
 * <p>Represents a RPA_I09_VISIT group structure (a Group object).
...
public class RPA_I09_VISIT extends AbstractGroup {

    /** 
     * Creates a new RPA_I09_VISIT group
     */
    public RPA_I09_VISIT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RPA_I09_VISIT - this is probably a bug in the source code generator.", e);
       }
    }
