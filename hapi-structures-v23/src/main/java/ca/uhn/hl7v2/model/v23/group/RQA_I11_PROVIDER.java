...
/**
 * <p>Represents a RQA_I11_PROVIDER group structure (a Group object).
...
public class RQA_I11_PROVIDER extends AbstractGroup {

    /** 
     * Creates a new RQA_I11_PROVIDER group
     */
    public RQA_I11_PROVIDER(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RQA_I11_PROVIDER - this is probably a bug in the source code generator.", e);
       }
    }
