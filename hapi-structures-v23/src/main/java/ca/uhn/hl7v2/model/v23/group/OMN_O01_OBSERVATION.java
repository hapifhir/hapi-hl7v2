...
/**
 * <p>Represents a OMN_O01_OBSERVATION group structure (a Group object).
...
public class OMN_O01_OBSERVATION extends AbstractGroup {

    /** 
     * Creates a new OMN_O01_OBSERVATION group
     */
    public OMN_O01_OBSERVATION(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating OMN_O01_OBSERVATION - this is probably a bug in the source code generator.", e);
       }
    }
