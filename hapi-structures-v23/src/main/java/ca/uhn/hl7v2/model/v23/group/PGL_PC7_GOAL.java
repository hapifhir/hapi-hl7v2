...
/**
 * <p>Represents a PGL_PC7_GOAL group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>4: PGL_PC7_GOAL_ROLE (a Group object) <b>optional repeating </b></li>
                         * <li>5: PGL_PC7_PATHWAY (a Group object) <b>optional repeating </b></li>
                         * <li>6: PGL_PC7_OBSERVATION (a Group object) <b>optional repeating </b></li>
                         * <li>7: PGL_PC7_PROBLEM (a Group object) <b>optional repeating </b></li>
                         * <li>8: PGL_PC7_ORDER (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class PGL_PC7_GOAL extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(PGL_PC7_GOAL_ROLE.class, false, true, false);
                                  this.add(PGL_PC7_PATHWAY.class, false, true, false);
                                  this.add(PGL_PC7_OBSERVATION.class, false, true, false);
                                  this.add(PGL_PC7_PROBLEM.class, false, true, false);
                                  this.add(PGL_PC7_ORDER.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating PGL_PC7_GOAL - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public PGL_PC7_GOAL_ROLE getGOAL_ROLE() { 
       PGL_PC7_GOAL_ROLE retVal = getTyped("GOAL_ROLE", PGL_PC7_GOAL_ROLE.class);
       return retVal;
    }
    ...
    public PGL_PC7_GOAL_ROLE getGOAL_ROLE(int rep) { 
       PGL_PC7_GOAL_ROLE retVal = getTyped("GOAL_ROLE", rep, PGL_PC7_GOAL_ROLE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PGL_PC7_GOAL_ROLE> getGOAL_ROLEAll() throws HL7Exception {
    	return getAllAsList("GOAL_ROLE", PGL_PC7_GOAL_ROLE.class);
    } 
    ...
    public PGL_PC7_PATHWAY getPATHWAY() { 
       PGL_PC7_PATHWAY retVal = getTyped("PATHWAY", PGL_PC7_PATHWAY.class);
       return retVal;
    }
    ...
    public PGL_PC7_PATHWAY getPATHWAY(int rep) { 
       PGL_PC7_PATHWAY retVal = getTyped("PATHWAY", rep, PGL_PC7_PATHWAY.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PGL_PC7_PATHWAY> getPATHWAYAll() throws HL7Exception {
    	return getAllAsList("PATHWAY", PGL_PC7_PATHWAY.class);
    } 
    ...
    public PGL_PC7_OBSERVATION getOBSERVATION() { 
       PGL_PC7_OBSERVATION retVal = getTyped("OBSERVATION", PGL_PC7_OBSERVATION.class);
       return retVal;
    }
    ...
    public PGL_PC7_OBSERVATION getOBSERVATION(int rep) { 
       PGL_PC7_OBSERVATION retVal = getTyped("OBSERVATION", rep, PGL_PC7_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PGL_PC7_OBSERVATION> getOBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("OBSERVATION", PGL_PC7_OBSERVATION.class);
    } 
    ...
    public PGL_PC7_PROBLEM getPROBLEM() { 
       PGL_PC7_PROBLEM retVal = getTyped("PROBLEM", PGL_PC7_PROBLEM.class);
       return retVal;
    }
    ...
    public PGL_PC7_PROBLEM getPROBLEM(int rep) { 
       PGL_PC7_PROBLEM retVal = getTyped("PROBLEM", rep, PGL_PC7_PROBLEM.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PGL_PC7_PROBLEM> getPROBLEMAll() throws HL7Exception {
    	return getAllAsList("PROBLEM", PGL_PC7_PROBLEM.class);
    } 
    ...
    public PGL_PC7_ORDER getORDER() { 
       PGL_PC7_ORDER retVal = getTyped("ORDER", PGL_PC7_ORDER.class);
       return retVal;
    }
    ...
    public PGL_PC7_ORDER getORDER(int rep) { 
       PGL_PC7_ORDER retVal = getTyped("ORDER", rep, PGL_PC7_ORDER.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PGL_PC7_ORDER> getORDERAll() throws HL7Exception {
    	return getAllAsList("ORDER", PGL_PC7_ORDER.class);
    } 
