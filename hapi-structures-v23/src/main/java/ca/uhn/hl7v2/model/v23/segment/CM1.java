 ...
 * <ul>
     * <li>CM1-1: CM1 - Set ID (SI) <b> </b>
     * <li>CM1-2: Study Phase Identifier (CE) <b>optional </b>
...
public class CM1 extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(SI.class, true, 1, 4, new Object[]{ getMessage() }, "CM1 - Set ID");
                                  this.add(CE.class, false, 1, 60, new Object[]{ getMessage() }, "Study Phase Identifier");
    ...
    /**
     * Returns
     * CM1-1: "CM1 - Set ID" - creates it if necessary
     */
    public SI getCM1SetID() { 
