 ...
 * <ul>
     ...
     * <li>ROL-3: Role (CE) <b>optional </b>
     * <li>ROL-4: Role Person (XCN) <b> </b>
     ...
     * <li>ROL-8: Role Action (Assumption) Reason (CE) <b>optional </b>
 * </ul>
 */
...
public class ROL extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CE.class, false, 1, 0, new Object[]{ getMessage() }, "Role");
                                  this.add(XCN.class, true, 1, 80, new Object[]{ getMessage() }, "Role Person");
                                  ...
                                  this.add(CE.class, false, 1, 80, new Object[]{ getMessage() }, "Role Action (Assumption) Reason");
    ...
    /**
     * Returns
     * ROL-3: "Role" - creates it if necessary
     */
    public CE getRole() { 
    ...
    /**
     * Returns
     * ROL-8: "Role Action (Assumption) Reason" - creates it if necessary
     */
