 ...
 * <ul>
     * <li>CM2-1: CM2 - Set ID (SI) <b>optional </b>
...
public class CM2 extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(SI.class, false, 1, 4, new Object[]{ getMessage() }, "CM2 - Set ID");
                                  this.add(CE.class, true, 1, 60, new Object[]{ getMessage() }, "Scheduled Time Point");
                                  this.add(ST.class, false, 1, 300, new Object[]{ getMessage() }, "Description of Time Point");
                                  this.add(CE.class, true, 200, 60, new Object[]{ getMessage() }, "Events Scheduled This Time Point");
