...
/**
 * <p>Represents a RRI_I15_PROVIDER group structure (a Group object).
...
public class RRI_I15_PROVIDER extends AbstractGroup {

    /** 
     * Creates a new RRI_I15_PROVIDER group
     */
    public RRI_I15_PROVIDER(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RRI_I15_PROVIDER - this is probably a bug in the source code generator.", e);
       }
    }
