...
/**
 * <p>Represents a REF_I12_RESULTS group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>3: REF_I12_OBSERVATION (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class REF_I12_RESULTS extends AbstractGroup {

    /** 
     * Creates a new REF_I12_RESULTS group
     */
    public REF_I12_RESULTS(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(REF_I12_OBSERVATION.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating REF_I12_RESULTS - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public REF_I12_OBSERVATION getOBSERVATION() { 
       REF_I12_OBSERVATION retVal = getTyped("OBSERVATION", REF_I12_OBSERVATION.class);
       return retVal;
    }
    ...
    public REF_I12_OBSERVATION getOBSERVATION(int rep) { 
       REF_I12_OBSERVATION retVal = getTyped("OBSERVATION", rep, REF_I12_OBSERVATION.class);
       return retVal;
    }
