...
/**
 * <p>Represents a RDS_O01_ORDER group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: ORC (Common order segment) <b>  </b></li>
                         * <li>2: RDS_O01_ORDER_DETAIL (a Group object) <b>optional  </b></li>
                         * <li>3: RDS_O01_ENCODING (a Group object) <b>optional  </b></li>
                         * <li>4: RXD (Pharmacy dispense segment) <b>  </b></li>
                         * <li>5: RXR (Pharmacy route segment) <b> repeating </b></li>
                         * <li>6: RXC (Pharmacy component order segment) <b>optional repeating </b></li>
                         * <li>7: RDS_O01_OBSERVATION (a Group object) <b> repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class RDS_O01_ORDER extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RDS_O01_ORDER - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public RDS_O01_ORDER_DETAIL getORDER_DETAIL() { 
       RDS_O01_ORDER_DETAIL retVal = getTyped("ORDER_DETAIL", RDS_O01_ORDER_DETAIL.class);
       return retVal;
    }
    ...
    public RDS_O01_ENCODING getENCODING() { 
       RDS_O01_ENCODING retVal = getTyped("ENCODING", RDS_O01_ENCODING.class);
       return retVal;
    }
    ...
    /**
     * Returns
     * RXD (Pharmacy dispense segment) - creates it if necessary
     */
    public RXD getRXD() { 
    ...
    public RDS_O01_OBSERVATION getOBSERVATION() { 
       RDS_O01_OBSERVATION retVal = getTyped("OBSERVATION", RDS_O01_OBSERVATION.class);
       return retVal;
    }
    ...
    public RDS_O01_OBSERVATION getOBSERVATION(int rep) { 
       RDS_O01_OBSERVATION retVal = getTyped("OBSERVATION", rep, RDS_O01_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<RDS_O01_OBSERVATION> getOBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("OBSERVATION", RDS_O01_OBSERVATION.class);
    } 
