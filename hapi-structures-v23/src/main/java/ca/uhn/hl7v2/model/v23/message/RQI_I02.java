 ...
 * <ul>
		                 ...
		                 * <li>2: RQI_I02_PROVIDER (a Group object) <b> repeating</b> </li>
		                 * <li>3: PID (Patient Identification) <b> </b> </li>
		                 * <li>4: NK1 (Next of kin) <b>optional repeating</b> </li>
		                 * <li>5: RQI_I02_GUARANTOR_INSURANCE (a Group object) <b>optional </b> </li>
...
public class RQI_I02 extends AbstractMessage  {
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          this.add(RQI_I02_PROVIDER.class, true, true);
	                          this.add(PID.class, true, false);
	                          this.add(NK1.class, false, true);
	                          this.add(RQI_I02_GUARANTOR_INSURANCE.class, false, false);
    ...
    public RQI_I02_PROVIDER getPROVIDER() { 
       return getTyped("PROVIDER", RQI_I02_PROVIDER.class);
    }
    ...
    public RQI_I02_PROVIDER getPROVIDER(int rep) { 
       return getTyped("PROVIDER", rep, RQI_I02_PROVIDER.class);
    }
     ...
     * 
     */ 
    public java.util.List<RQI_I02_PROVIDER> getPROVIDERAll() throws HL7Exception {
    	return getAllAsList("PROVIDER", RQI_I02_PROVIDER.class);
    } 
     ...
     */
    public void insertPROVIDER(RQI_I02_PROVIDER structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public RQI_I02_PROVIDER insertPROVIDER(int rep) throws HL7Exception { 
       return (RQI_I02_PROVIDER)super.insertRepetition("PROVIDER", rep);
    }
     ...
     */
    public RQI_I02_PROVIDER removePROVIDER(int rep) throws HL7Exception { 
       return (RQI_I02_PROVIDER)super.removeRepetition("PROVIDER", rep);
    }
     ...
     *
     */
    public RQI_I02_GUARANTOR_INSURANCE getGUARANTOR_INSURANCE() { 
       return getTyped("GUARANTOR_INSURANCE", RQI_I02_GUARANTOR_INSURANCE.class);
    }
