...
/**
 *<p>Represents an HL7 QRD message segment (Query definition segment). 
 * This segment has the following fields:</p>
 * <ul>
     * <li>QRD-1: Query Date/Time (TS) <b>optional </b>
...
public class QRD extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(TS.class, false, 1, 26, new Object[]{ getMessage() }, "Query Date/Time");
                                  ...
                                  this.add(XCN.class, true, 0, 60, new Object[]{ getMessage() }, "Who Subject Filter");
                                  this.add(CE.class, true, 0, 60, new Object[]{ getMessage() }, "What Subject Filter");
                                  this.add(CE.class, true, 0, 60, new Object[]{ getMessage() }, "What Department Data Code");
