...
/**
 * <p>Represents a SIU_S19 message structure (see chapter ?). This structure contains the 
 ...
 * <ul>
		                 ...
		                 * <li>4: SIU_S19_PATIENT (a Group object) <b>optional repeating</b> </li>
		                 * <li>5: SIU_S19_RESOURCES (a Group object) <b> repeating</b> </li>
 * </ul>
 */
...
public class SIU_S19 extends AbstractMessage  {
    ...
    /**
     * Creates a new SIU_S19 message with DefaultModelClassFactory. 
     */ 
    public SIU_S19() { 
    ...
    /** 
     * Creates a new SIU_S19 message with custom ModelClassFactory.
     */
    public SIU_S19(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(SIU_S19_PATIENT.class, false, true);
	                          this.add(SIU_S19_RESOURCES.class, true, true);
	       } catch(HL7Exception e) {
          log.error("Unexpected error creating SIU_S19 - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public SIU_S19_PATIENT getPATIENT(int rep) { 
       return getTyped("PATIENT", rep, SIU_S19_PATIENT.class);
    }
     ...
     * 
     */ 
    public java.util.List<SIU_S19_PATIENT> getPATIENTAll() throws HL7Exception {
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertPATIENT(SIU_S19_PATIENT structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public SIU_S19_PATIENT insertPATIENT(int rep) throws HL7Exception { 
       return (SIU_S19_PATIENT)super.insertRepetition("PATIENT", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public SIU_S19_PATIENT removePATIENT(int rep) throws HL7Exception { 
       return (SIU_S19_PATIENT)super.removeRepetition("PATIENT", rep);
    }
    ...
    public SIU_S19_RESOURCES getRESOURCES(int rep) { 
       return getTyped("RESOURCES", rep, SIU_S19_RESOURCES.class);
    }
     ...
     * 
     */ 
    public java.util.List<SIU_S19_RESOURCES> getRESOURCESAll() throws HL7Exception {
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertRESOURCES(SIU_S19_RESOURCES structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public SIU_S19_RESOURCES insertRESOURCES(int rep) throws HL7Exception { 
       return (SIU_S19_RESOURCES)super.insertRepetition("RESOURCES", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public SIU_S19_RESOURCES removeRESOURCES(int rep) throws HL7Exception { 
       return (SIU_S19_RESOURCES)super.removeRepetition("RESOURCES", rep);
    }
