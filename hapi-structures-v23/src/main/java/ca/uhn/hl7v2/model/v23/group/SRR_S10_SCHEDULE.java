...
/**
 * <p>Represents a SRR_S10_SCHEDULE group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>3: SRR_S10_PATIENT (a Group object) <b>optional repeating </b></li>
                         * <li>4: SRR_S10_RESOURCES (a Group object) <b> repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class SRR_S10_SCHEDULE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating SRR_S10_SCHEDULE - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public SRR_S10_PATIENT getPATIENT() { 
       SRR_S10_PATIENT retVal = getTyped("PATIENT", SRR_S10_PATIENT.class);
       return retVal;
    }
    ...
    public SRR_S10_PATIENT getPATIENT(int rep) { 
       SRR_S10_PATIENT retVal = getTyped("PATIENT", rep, SRR_S10_PATIENT.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<SRR_S10_PATIENT> getPATIENTAll() throws HL7Exception {
    	return getAllAsList("PATIENT", SRR_S10_PATIENT.class);
    } 
    ...
    public SRR_S10_RESOURCES getRESOURCES() { 
       SRR_S10_RESOURCES retVal = getTyped("RESOURCES", SRR_S10_RESOURCES.class);
       return retVal;
    }
    ...
    public SRR_S10_RESOURCES getRESOURCES(int rep) { 
       SRR_S10_RESOURCES retVal = getTyped("RESOURCES", rep, SRR_S10_RESOURCES.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<SRR_S10_RESOURCES> getRESOURCESAll() throws HL7Exception {
    	return getAllAsList("RESOURCES", SRR_S10_RESOURCES.class);
    } 
