...
/**
 * <p>Represents a RRI_I12_PROVIDER group structure (a Group object).
...
public class RRI_I12_PROVIDER extends AbstractGroup {

    /** 
     * Creates a new RRI_I12_PROVIDER group
     */
    public RRI_I12_PROVIDER(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RRI_I12_PROVIDER - this is probably a bug in the source code generator.", e);
       }
    }
