...
/**
 * <p>Represents a SRM_S08_PATIENT group structure (a Group object).
...
public class SRM_S08_PATIENT extends AbstractGroup {

    /** 
     * Creates a new SRM_S08_PATIENT group
     */
    public SRM_S08_PATIENT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating SRM_S08_PATIENT - this is probably a bug in the source code generator.", e);
       }
    }
