...
/**
 * <p>Represents a SIU_S16 message structure (see chapter ?). This structure contains the 
 ...
 * <ul>
		                 ...
		                 * <li>4: SIU_S16_PATIENT (a Group object) <b>optional repeating</b> </li>
		                 * <li>5: SIU_S16_RESOURCES (a Group object) <b> repeating</b> </li>
 * </ul>
 */
...
public class SIU_S16 extends AbstractMessage  {
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(SIU_S16_PATIENT.class, false, true);
	                          this.add(SIU_S16_RESOURCES.class, true, true);
    ...
    public SIU_S16_PATIENT getPATIENT() { 
       return getTyped("PATIENT", SIU_S16_PATIENT.class);
    }
    ...
    public SIU_S16_PATIENT getPATIENT(int rep) { 
       return getTyped("PATIENT", rep, SIU_S16_PATIENT.class);
    }
     ...
     * 
     */ 
    public java.util.List<SIU_S16_PATIENT> getPATIENTAll() throws HL7Exception {
    	return getAllAsList("PATIENT", SIU_S16_PATIENT.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertPATIENT(SIU_S16_PATIENT structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public SIU_S16_PATIENT insertPATIENT(int rep) throws HL7Exception { 
       return (SIU_S16_PATIENT)super.insertRepetition("PATIENT", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public SIU_S16_PATIENT removePATIENT(int rep) throws HL7Exception { 
       return (SIU_S16_PATIENT)super.removeRepetition("PATIENT", rep);
    }
    ...
    public SIU_S16_RESOURCES getRESOURCES() { 
       return getTyped("RESOURCES", SIU_S16_RESOURCES.class);
    }
    ...
    public SIU_S16_RESOURCES getRESOURCES(int rep) { 
       return getTyped("RESOURCES", rep, SIU_S16_RESOURCES.class);
    }
     ...
     * 
     */ 
    public java.util.List<SIU_S16_RESOURCES> getRESOURCESAll() throws HL7Exception {
    	return getAllAsList("RESOURCES", SIU_S16_RESOURCES.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertRESOURCES(SIU_S16_RESOURCES structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public SIU_S16_RESOURCES insertRESOURCES(int rep) throws HL7Exception { 
       return (SIU_S16_RESOURCES)super.insertRepetition("RESOURCES", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public SIU_S16_RESOURCES removeRESOURCES(int rep) throws HL7Exception { 
       return (SIU_S16_RESOURCES)super.removeRepetition("RESOURCES", rep);
    }
