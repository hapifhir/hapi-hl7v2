 ...
 * <ul>
		                 ...
		                 * <li>3: PPR_PC3_PATIENT_VISIT (a Group object) <b>optional </b> </li>
		                 * <li>4: PPR_PC3_PROBLEM (a Group object) <b> repeating</b> </li>
 * </ul>
 */
...
public class PPR_PC3 extends AbstractMessage  {
    ...
    /**
     * Creates a new PPR_PC3 message with DefaultModelClassFactory. 
     */ 
    public PPR_PC3() { 
    ...
    /** 
     * Creates a new PPR_PC3 message with custom ModelClassFactory.
     */
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PPR_PC3 - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public PPR_PC3_PATIENT_VISIT getPATIENT_VISIT() { 
       return getTyped("PATIENT_VISIT", PPR_PC3_PATIENT_VISIT.class);
    }
    ...
    public PPR_PC3_PROBLEM getPROBLEM() { 
       return getTyped("PROBLEM", PPR_PC3_PROBLEM.class);
    }
    ...
    public PPR_PC3_PROBLEM getPROBLEM(int rep) { 
       return getTyped("PROBLEM", rep, PPR_PC3_PROBLEM.class);
    }
     ...
     * 
     */ 
    public java.util.List<PPR_PC3_PROBLEM> getPROBLEMAll() throws HL7Exception {
    	return getAllAsList("PROBLEM", PPR_PC3_PROBLEM.class);
    } 
