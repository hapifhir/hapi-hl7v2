 ...
 * <ul>
     * <li>CDM-1: Primary Key Value (CE) <b> </b>
     ...
     * <li>CDM-5: Description Override Indicator (ID) <b>optional </b>
     ...
     * <li>CDM-12: Contract Organization (XON) <b>optional </b>
...
public class CDM extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(ST.class, false, 1, 250, new Object[]{ getMessage() }, "Charge Description Long");
                                              this.add(ID.class, false, 1, 1, new Object[]{ getMessage(), new Integer(268) }, "Description Override Indicator");
                                  this.add(CE.class, false, 0, 60, new Object[]{ getMessage() }, "Exploding Charges");
                                  this.add(CE.class, false, 0, 200, new Object[]{ getMessage() }, "Procedure Code");
                                  ...
                                  this.add(XON.class, false, 1, 200, new Object[]{ getMessage() }, "Contract Organization");
    ...
    /**
     * Returns
     * CDM-1: "Primary Key Value" - creates it if necessary
     */
     ...
     * CDM-1: "Primary Key Value" - creates it if necessary
     */
    public CE getCdm1_PrimaryKeyValue() { 
		CE retVal = this.getTypedField(1, 0);
		return retVal;
    }
     ...
     * CDM-5: "Description Override Indicator" - creates it if necessary
     */
    public ID getCdm5_DescriptionOverrideIndicator() { 
		ID retVal = this.getTypedField(5, 0);
		return retVal;
    }
    ...
    public XON getContractOrganization() { 
		XON retVal = this.getTypedField(12, 0);
		return retVal;
    }
    ...
    protected Type createNewTypeWithoutReflection(int field) {
       switch (field) {
          ...
          case 4: return new ID(getMessage(), new Integer( 268 ));
