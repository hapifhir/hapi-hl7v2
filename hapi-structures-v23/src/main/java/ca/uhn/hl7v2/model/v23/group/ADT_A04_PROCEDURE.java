...
/**
 * <p>Represents a ADT_A04_PROCEDURE group structure (a Group object).
...
public class ADT_A04_PROCEDURE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ADT_A04_PROCEDURE - this is probably a bug in the source code generator.", e);
       }
    }
