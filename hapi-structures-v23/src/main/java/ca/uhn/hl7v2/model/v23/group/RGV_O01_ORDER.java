...
public class RGV_O01_ORDER extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(RGV_O01_ORDER_DETAIL.class, false, false, false);
                                  this.add(RGV_O01_ENCODING.class, false, false, false);
                                  this.add(RGV_O01_GIVE.class, true, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating RGV_O01_ORDER - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public RGV_O01_ORDER_DETAIL getORDER_DETAIL() { 
       RGV_O01_ORDER_DETAIL retVal = getTyped("ORDER_DETAIL", RGV_O01_ORDER_DETAIL.class);
       return retVal;
    }
    ...
    public RGV_O01_ENCODING getENCODING() { 
       RGV_O01_ENCODING retVal = getTyped("ENCODING", RGV_O01_ENCODING.class);
       return retVal;
    }
    ...
    public RGV_O01_GIVE getGIVE() { 
       RGV_O01_GIVE retVal = getTyped("GIVE", RGV_O01_GIVE.class);
       return retVal;
    }
    ...
    public RGV_O01_GIVE getGIVE(int rep) { 
       RGV_O01_GIVE retVal = getTyped("GIVE", rep, RGV_O01_GIVE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<RGV_O01_GIVE> getGIVEAll() throws HL7Exception {
    	return getAllAsList("GIVE", RGV_O01_GIVE.class);
    } 
