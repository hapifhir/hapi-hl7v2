...
/**
 * <p>Represents a ADT_A51 message structure (see chapter ?). This structure contains the 
...
public class ADT_A51 extends AbstractMessage  {

    /**
     * Creates a new ADT_A51 message with DefaultModelClassFactory. 
     */ 
    public ADT_A51() { 
    ...
    /** 
     * Creates a new ADT_A51 message with custom ModelClassFactory.
     */
    public ADT_A51(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ADT_A51 - this is probably a bug in the source code generator.", e);
       }
    }
