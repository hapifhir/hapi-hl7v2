...
public class PV1 extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CX.class, false, 1, 20, new Object[]{ getMessage() }, "Preadmit Number");
                                  this.add(PL.class, false, 1, 12, new Object[]{ getMessage() }, "Prior Patient Location");
                                  this.add(XCN.class, false, 0, 60, new Object[]{ getMessage() }, "Attending Doctor");
                                  this.add(XCN.class, false, 0, 60, new Object[]{ getMessage() }, "Referring Doctor");
                                  this.add(XCN.class, false, 0, 60, new Object[]{ getMessage() }, "Consulting Doctor");
                                              this.add(ID.class, false, 1, 3, new Object[]{ getMessage(), new Integer(69) }, "Hospital Service");
                                  this.add(PL.class, false, 1, 12, new Object[]{ getMessage() }, "Temporary Location");
                                  ...
                                  this.add(XCN.class, false, 0, 60, new Object[]{ getMessage() }, "Admitting Doctor");
                                              this.add(ID.class, false, 1, 2, new Object[]{ getMessage(), new Integer(18) }, "Patient Type");
                                  this.add(CX.class, false, 1, 15, new Object[]{ getMessage() }, "Visit Number");
                                  ...
                                  this.add(PL.class, false, 1, 12, new Object[]{ getMessage() }, "Pending Location");
                                  this.add(PL.class, false, 1, 12, new Object[]{ getMessage() }, "Prior Temporary Location");
                                  ...
                                  this.add(CX.class, false, 1, 20, new Object[]{ getMessage() }, "Alternate Visit ID");
                                              this.add(IS.class, false, 1, 1, new Object[]{ getMessage(), new Integer(326) }, "Visit Indicator");
                                  this.add(XCN.class, false, 0, 60, new Object[]{ getMessage() }, "Other Healthcare Provider");
