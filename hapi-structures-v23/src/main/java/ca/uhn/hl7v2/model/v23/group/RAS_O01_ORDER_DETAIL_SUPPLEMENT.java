...
/**
 * <p>Represents a RAS_O01_ORDER_DETAIL_SUPPLEMENT group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: NTE (Notes and comments segment) <b> repeating </b></li>
                         * <li>2: RXR (Pharmacy route segment) <b> repeating </b></li>
                         * <li>3: RAS_O01_COMPONENTS (a Group object) <b>optional  </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class RAS_O01_ORDER_DETAIL_SUPPLEMENT extends AbstractGroup {

    /** 
     * Creates a new RAS_O01_ORDER_DETAIL_SUPPLEMENT group
     */
    public RAS_O01_ORDER_DETAIL_SUPPLEMENT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(RAS_O01_COMPONENTS.class, false, false, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating RAS_O01_ORDER_DETAIL_SUPPLEMENT - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     */
    public RAS_O01_COMPONENTS getCOMPONENTS() { 
       RAS_O01_COMPONENTS retVal = getTyped("COMPONENTS", RAS_O01_COMPONENTS.class);
       return retVal;
    }
