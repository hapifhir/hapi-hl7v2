...
/**
 * <p>Represents a PEX_P08_RX_ORDER group structure (a Group object).
...
public class PEX_P08_RX_ORDER extends AbstractGroup {

    /** 
     * Creates a new PEX_P08_RX_ORDER group
     */
    public PEX_P08_RX_ORDER(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating PEX_P08_RX_ORDER - this is probably a bug in the source code generator.", e);
       }
    }
