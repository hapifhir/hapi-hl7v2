 ...
 * <ul>
     ...
     * <li>PEO-7: Event Location Occurred Address (XAD) <b>optional </b>
     ...
     * <li>PEO-19: Primary Observer Name (XPN) <b>optional </b>
...
public class PEO extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(XAD.class, false, 1, 106, new Object[]{ getMessage() }, "Event Location Occurred Address");
                                  ...
                                  this.add(CE.class, false, 0, 30, new Object[]{ getMessage() }, "Cause Of Death");
                                  this.add(XPN.class, false, 1, 46, new Object[]{ getMessage() }, "Primary Observer Name");
    ...
    public XAD getEventLocationOccurredAddress() { 
		XAD retVal = this.getTypedField(7, 0);
		return retVal;
    }
    ...
    public XPN getPrimaryObserverName() { 
		XPN retVal = this.getTypedField(19, 0);
		return retVal;
    }
