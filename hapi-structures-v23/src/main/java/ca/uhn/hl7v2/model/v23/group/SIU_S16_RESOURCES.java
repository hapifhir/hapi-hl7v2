...
public class SIU_S16_RESOURCES extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating SIU_S16_RESOURCES - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public SIU_S16_SERVICE getSERVICE() { 
       SIU_S16_SERVICE retVal = getTyped("SERVICE", SIU_S16_SERVICE.class);
       return retVal;
    }
    ...
    public SIU_S16_SERVICE getSERVICE(int rep) { 
       SIU_S16_SERVICE retVal = getTyped("SERVICE", rep, SIU_S16_SERVICE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<SIU_S16_SERVICE> getSERVICEAll() throws HL7Exception {
    	return getAllAsList("SERVICE", SIU_S16_SERVICE.class);
    } 
    ...
    public SIU_S16_GENERAL_RESOURCE getGENERAL_RESOURCE() { 
       SIU_S16_GENERAL_RESOURCE retVal = getTyped("GENERAL_RESOURCE", SIU_S16_GENERAL_RESOURCE.class);
       return retVal;
    }
    ...
    public SIU_S16_GENERAL_RESOURCE getGENERAL_RESOURCE(int rep) { 
       SIU_S16_GENERAL_RESOURCE retVal = getTyped("GENERAL_RESOURCE", rep, SIU_S16_GENERAL_RESOURCE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<SIU_S16_GENERAL_RESOURCE> getGENERAL_RESOURCEAll() throws HL7Exception {
    	return getAllAsList("GENERAL_RESOURCE", SIU_S16_GENERAL_RESOURCE.class);
    } 
    ...
    public SIU_S16_LOCATIONL_RESOURCE getLOCATIONL_RESOURCE() { 
       SIU_S16_LOCATIONL_RESOURCE retVal = getTyped("LOCATIONL_RESOURCE", SIU_S16_LOCATIONL_RESOURCE.class);
       return retVal;
    }
    ...
    public SIU_S16_LOCATIONL_RESOURCE getLOCATIONL_RESOURCE(int rep) { 
       SIU_S16_LOCATIONL_RESOURCE retVal = getTyped("LOCATIONL_RESOURCE", rep, SIU_S16_LOCATIONL_RESOURCE.class);
       return retVal;
    }
    ...
    public int getLOCATIONL_RESOURCEReps() {  
        return getReps("LOCATIONL_RESOURCE");
    } 
     ...
     * <p>
     * <p>
     * Note that unlike {@link #getLOCATIONL_RESOURCE()}, this method will not create any reps
     * if none are already present, so an empty list may be returned.
     * </p>
     */ 
    public java.util.List<SIU_S16_LOCATIONL_RESOURCE> getLOCATIONL_RESOURCEAll() throws HL7Exception {
    	return getAllAsList("LOCATIONL_RESOURCE", SIU_S16_LOCATIONL_RESOURCE.class);
    } 
    ...
    public SIU_S16_PERSONNEL_RESOURCE getPERSONNEL_RESOURCE() { 
       SIU_S16_PERSONNEL_RESOURCE retVal = getTyped("PERSONNEL_RESOURCE", SIU_S16_PERSONNEL_RESOURCE.class);
       return retVal;
    }
    ...
    public SIU_S16_PERSONNEL_RESOURCE getPERSONNEL_RESOURCE(int rep) { 
       SIU_S16_PERSONNEL_RESOURCE retVal = getTyped("PERSONNEL_RESOURCE", rep, SIU_S16_PERSONNEL_RESOURCE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<SIU_S16_PERSONNEL_RESOURCE> getPERSONNEL_RESOURCEAll() throws HL7Exception {
    	return getAllAsList("PERSONNEL_RESOURCE", SIU_S16_PERSONNEL_RESOURCE.class);
    } 
