...
/**
 * <p>Represents a RGV_O01_PATIENT group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>3: RGV_O01_xx (a Group object) <b>optional  </b></li>
                         * <li>4: RGV_O01_ORDER (a Group object) <b> repeating </b></li>
 * </ul>
 */
...
public class RGV_O01_PATIENT extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RGV_O01_PATIENT - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    /**
     * Returns
     * xx (a Group object) - creates it if necessary
     */
    public RGV_O01_xx getxx() { 
       RGV_O01_xx retVal = getTyped("xx", RGV_O01_xx.class);
       return retVal;
    }
    ...
    public RGV_O01_ORDER getORDER() { 
       RGV_O01_ORDER retVal = getTyped("ORDER", RGV_O01_ORDER.class);
       return retVal;
    }
    ...
    public RGV_O01_ORDER getORDER(int rep) { 
       RGV_O01_ORDER retVal = getTyped("ORDER", rep, RGV_O01_ORDER.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<RGV_O01_ORDER> getORDERAll() throws HL7Exception {
    	return getAllAsList("ORDER", RGV_O01_ORDER.class);
    } 
