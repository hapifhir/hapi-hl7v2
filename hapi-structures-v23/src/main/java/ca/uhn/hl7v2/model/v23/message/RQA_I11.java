...
/**
 * <p>Represents a RQA_I11 message structure (see chapter ?). This structure contains the 
 * following elements: </p>
 * <ul>
		                 * <li>1: MSH (Message header segment) <b> </b> </li>
		                 * <li>2: RF1 (Referral Information Segment) <b>optional </b> </li>
		                 * <li>3: RQA_I11_AUTHORIZATION (a Group object) <b>optional </b> </li>
		                 * <li>4: RQA_I11_PROVIDER (a Group object) <b> repeating</b> </li>
		                 * <li>5: PID (Patient Identification) <b> </b> </li>
		                 * <li>6: NK1 (Next of kin) <b>optional repeating</b> </li>
		                 * <li>7: RQA_I11_GUARANTOR_INSURANCE (a Group object) <b>optional </b> </li>
		                 ...
		                 * <li>12: RQA_I11_PROCEDURE (a Group object) <b>optional repeating</b> </li>
		                 * <li>13: RQA_I11_RESULTS (a Group object) <b>optional repeating</b> </li>
		                 * <li>14: RQA_I11_VISIT (a Group object) <b>optional </b> </li>
...
public class RQA_I11 extends AbstractMessage  {
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(RQA_I11_AUTHORIZATION.class, false, false);
	                          this.add(RQA_I11_PROVIDER.class, true, true);
	                          this.add(PID.class, true, false);
	                          this.add(NK1.class, false, true);
	                          this.add(RQA_I11_GUARANTOR_INSURANCE.class, false, false);
	                          this.add(ACC.class, false, false);
	                          this.add(DG1.class, false, true);
	                          this.add(DRG.class, false, true);
	                          this.add(AL1.class, false, true);
	                          this.add(RQA_I11_PROCEDURE.class, false, true);
	                          this.add(RQA_I11_RESULTS.class, false, true);
	                          this.add(RQA_I11_VISIT.class, false, false);
	                          this.add(NTE.class, false, true);
	       } catch(HL7Exception e) {
          log.error("Unexpected error creating RQA_I11 - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     *
     */
    public RQA_I11_AUTHORIZATION getAUTHORIZATION() { 
       return getTyped("AUTHORIZATION", RQA_I11_AUTHORIZATION.class);
    }
    ...
    public RQA_I11_PROVIDER getPROVIDER() { 
       return getTyped("PROVIDER", RQA_I11_PROVIDER.class);
    }
    ...
    public RQA_I11_PROVIDER getPROVIDER(int rep) { 
       return getTyped("PROVIDER", rep, RQA_I11_PROVIDER.class);
    }
     ...
     * 
     */ 
    public java.util.List<RQA_I11_PROVIDER> getPROVIDERAll() throws HL7Exception {
    	return getAllAsList("PROVIDER", RQA_I11_PROVIDER.class);
    } 
    ...
    public RQA_I11_PROVIDER insertPROVIDER(int rep) throws HL7Exception { 
       return (RQA_I11_PROVIDER)super.insertRepetition("PROVIDER", rep);
    }
    ...
    public RQA_I11_PROVIDER removePROVIDER(int rep) throws HL7Exception { 
       return (RQA_I11_PROVIDER)super.removeRepetition("PROVIDER", rep);
    }
     ...
     *
     */
    public RQA_I11_GUARANTOR_INSURANCE getGUARANTOR_INSURANCE() { 
       return getTyped("GUARANTOR_INSURANCE", RQA_I11_GUARANTOR_INSURANCE.class);
    }
    ...
    public RQA_I11_PROCEDURE getPROCEDURE() { 
       return getTyped("PROCEDURE", RQA_I11_PROCEDURE.class);
    }
    ...
    public RQA_I11_PROCEDURE getPROCEDURE(int rep) { 
       return getTyped("PROCEDURE", rep, RQA_I11_PROCEDURE.class);
    }
     ...
     * 
     */ 
    public java.util.List<RQA_I11_PROCEDURE> getPROCEDUREAll() throws HL7Exception {
    	return getAllAsList("PROCEDURE", RQA_I11_PROCEDURE.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public RQA_I11_PROCEDURE insertPROCEDURE(int rep) throws HL7Exception { 
       return (RQA_I11_PROCEDURE)super.insertRepetition("PROCEDURE", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public RQA_I11_PROCEDURE removePROCEDURE(int rep) throws HL7Exception { 
       return (RQA_I11_PROCEDURE)super.removeRepetition("PROCEDURE", rep);
    }
    ...
    public RQA_I11_RESULTS getRESULTS() { 
       return getTyped("RESULTS", RQA_I11_RESULTS.class);
    }
    ...
    public RQA_I11_RESULTS getRESULTS(int rep) { 
       return getTyped("RESULTS", rep, RQA_I11_RESULTS.class);
    }
     ...
     * 
     */ 
    public java.util.List<RQA_I11_RESULTS> getRESULTSAll() throws HL7Exception {
    	return getAllAsList("RESULTS", RQA_I11_RESULTS.class);
    } 
    ...
    public RQA_I11_RESULTS insertRESULTS(int rep) throws HL7Exception { 
       return (RQA_I11_RESULTS)super.insertRepetition("RESULTS", rep);
    }
    ...
    public RQA_I11_RESULTS removeRESULTS(int rep) throws HL7Exception { 
       return (RQA_I11_RESULTS)super.removeRepetition("RESULTS", rep);
    }
     ...
     *
     */
    public RQA_I11_VISIT getVISIT() { 
       return getTyped("VISIT", RQA_I11_VISIT.class);
    }
