 ...
 * <ul>
		                 ...
		                 * <li>13: ADT_A31_PROCEDURE (a Group object) <b>optional repeating</b> </li>
		                 * <li>14: GT1 (Guarantor) <b>optional repeating</b> </li>
		                 * <li>15: ADT_A31_INSURANCE (a Group object) <b>optional repeating</b> </li>
...
public class ADT_A31 extends AbstractMessage  {
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(ADT_A31_PROCEDURE.class, false, true);
	                          this.add(GT1.class, false, true);
	                          this.add(ADT_A31_INSURANCE.class, false, true);
    ...
    public ADT_A31_PROCEDURE getPROCEDURE() { 
       return getTyped("PROCEDURE", ADT_A31_PROCEDURE.class);
    }
    ...
    public ADT_A31_PROCEDURE getPROCEDURE(int rep) { 
       return getTyped("PROCEDURE", rep, ADT_A31_PROCEDURE.class);
    }
     ...
     * 
     */ 
    public java.util.List<ADT_A31_PROCEDURE> getPROCEDUREAll() throws HL7Exception {
    	return getAllAsList("PROCEDURE", ADT_A31_PROCEDURE.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertPROCEDURE(ADT_A31_PROCEDURE structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public ADT_A31_PROCEDURE insertPROCEDURE(int rep) throws HL7Exception { 
       return (ADT_A31_PROCEDURE)super.insertRepetition("PROCEDURE", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public ADT_A31_PROCEDURE removePROCEDURE(int rep) throws HL7Exception { 
       return (ADT_A31_PROCEDURE)super.removeRepetition("PROCEDURE", rep);
    }
    ...
    public ADT_A31_INSURANCE getINSURANCE() { 
       return getTyped("INSURANCE", ADT_A31_INSURANCE.class);
    }
    ...
    public ADT_A31_INSURANCE getINSURANCE(int rep) { 
       return getTyped("INSURANCE", rep, ADT_A31_INSURANCE.class);
    }
     ...
     * 
     */ 
    public java.util.List<ADT_A31_INSURANCE> getINSURANCEAll() throws HL7Exception {
    	return getAllAsList("INSURANCE", ADT_A31_INSURANCE.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertINSURANCE(ADT_A31_INSURANCE structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public ADT_A31_INSURANCE insertINSURANCE(int rep) throws HL7Exception { 
       return (ADT_A31_INSURANCE)super.insertRepetition("INSURANCE", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public ADT_A31_INSURANCE removeINSURANCE(int rep) throws HL7Exception { 
       return (ADT_A31_INSURANCE)super.removeRepetition("INSURANCE", rep);
    }
