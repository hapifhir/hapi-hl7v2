...
/**
 * <p>Represents a ADT_A35 message structure (see chapter ?). This structure contains the 
 ...
 * <ul>
		                 ...
		                 * <li>5: MRG (Merge patient information) <b> </b> </li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class ADT_A35 extends AbstractMessage  {

    /**
     * Creates a new ADT_A35 message with DefaultModelClassFactory. 
     */ 
    public ADT_A35() { 
    ...
    /** 
     * Creates a new ADT_A35 message with custom ModelClassFactory.
     */
    public ADT_A35(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ADT_A35 - this is probably a bug in the source code generator.", e);
       }
    }
