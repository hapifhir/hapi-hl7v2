...
/**
 * <p>Represents a CRM_C06_PATIENT group structure (a Group object).
...
public class CRM_C06_PATIENT extends AbstractGroup {

    /** 
     * Creates a new CRM_C06_PATIENT group
     */
    public CRM_C06_PATIENT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating CRM_C06_PATIENT - this is probably a bug in the source code generator.", e);
       }
    }
