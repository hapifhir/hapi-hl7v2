...
public class NewPipeParserTest extends TestCase {
	...
	public void testParseCorrectClass() throws EncodingNotSupportedException, HL7Exception {
		...
		String sn = "MSH|^~\\&|RIS 2.0|KIR|InterRis 2.0|Receiving facility|20110309132505||ORM^O01|MSG00001|1|2.3.1|1||||SL|UNICODE UTF-8|SL\r"
				+ "PID|||123^^^^^BIS~1234^^^^^HIS~12345^^^^^KZZZ||Lastname^Name^J^Mr|||M\r" + "PV1||E||||||2314^Novak&Janez^^^^Dr.|||||||||||123365\r" + "ORC|AF|1123abc^marand||3|||1^once^^^^U\r"
	...
	public void testAddExtraSegmentToEnd() throws EncodingNotSupportedException, HL7Exception {
		...
		String msgString = "MSH|^~\\&|REG|W|||201103230042||ADT^A06|32153168-A06|P|2.2\r" + "PV2||F||||||||||||||||||||N||AI|Emergency||||||N|||||||OTH^Self^03ZBrInBy\r" + "NK1||||^^^^^^M|||NK\r"
				+ "DG1||IN|MISC|Transient Ischemic Attack / Stroke\r" + "MRG|2804019||11020086571";
	...
	public void testLotsOfExtraSegments() throws EncodingNotSupportedException, HL7Exception {
		...
		String messageText = "MSH|^~\\&|ULTRA|TML|TML||200903120021||ADT^A17|66239404|T|2.3.1\r" + "EVN|A17|201002130003||||201002130003|G^4265^L\r" + "PID|1\r" + "ZZA|ZZAVALUE\r" + "ZZA|ZZAVALUE\r"
				+ "ZZB|ZZBVALUE\r" + "ZZB|ZZBVALUE\r" + "PV1||E\r" + "PID|2\r" + "ZZA|ZZAVALUE\r" + "ZZA|ZZAVALUE\r" + "ZZB|ZZBVALUE\r" + "ZZB|ZZBVALUE\r" + "ZZC|ZZCVALUE\r";
		...
		String encoded = msg.encode();
		Assert.assertEquals(messageText, encoded);
	...
	public void testNestedRepeatingGroups() throws EncodingNotSupportedException, HL7Exception {
		...
		String messageText = "MSH|^~\\&|ORSOS|G|PRECASE^SCHEDULING||20100406132803||SIU^S14| 38762|P|2.3\r"
				...
				+ "PID||990119205^^^R1^MR|990119205|000533921J^^^R1^VN|TEST MP3^TEST MP3|||||||||||||000533921J\r" + "PV1|1|U|||||51873^AL-RADI OO|51873^AL-RADI OO|||||||||||569576^R1 caseno\r"
				+ "DG1|1|||||U\r" + "RGS|1|1|abc\r" + "AIS|1|1|G014080^BYPASS AXILLOFEMORAL|20100406161000|||255|000000\r" + "AIG|1|1|51873|STAFF|||||20100407164000\r"
				+ "AIL|1|1|OR 4^OR 4||||||40800|0\r" + "AIP|1|1|51873^ALRADI^OSMAN|^1\r" + "RGS|2|2|abc\r" + "AIS|2|2|G11455^BYPASS AORTOCORONARY USING RADIAL ARTERY|20100406161000|||15\r"
				+ "AIG|2|2|33043|STAFF|||||20100407212500\r" + "AIL|2|2|OR 4^OR 4|||||||0\r" + "AIP|2|2|33043^AUNE^KELLY|^1\r" + "RGS|3|3|abc\r" + "AIS|3|3|G014045^ANGIOPLASTY|20100406161000|||5\r"
				+ "AIG|3|3|102694|STAFF|||||20100407214000\r" + "AIL|3|3|OR 4^OR 4|||||||0\r" + "AIP|3|3|102694^ANGELINI^MARK|^1\r" + "RGS|4|4|abc\r"
