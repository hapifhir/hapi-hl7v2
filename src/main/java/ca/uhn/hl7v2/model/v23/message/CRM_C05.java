...
public class CRM_C05 extends AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating CRM_C05 - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public CRM_C05_PATIENT getPATIENT() { 
	   ...
	   try {
	      ret = (CRM_C05_PATIENT)this.get("PATIENT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 */
	public CRM_C05_PATIENT getPATIENT(int rep) throws HL7Exception { 
	   return (CRM_C05_PATIENT)this.get("PATIENT", rep);
	}
