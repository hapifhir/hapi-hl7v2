...
public class RAS_O01_ORDER_DETAIL_SUPPLEMENT extends AbstractGroup {
	...
	public RAS_O01_ORDER_DETAIL_SUPPLEMENT(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(RAS_O01_COMPONENTS.class, false, false);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RAS_O01_ORDER_DETAIL_SUPPLEMENT - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public RAS_O01_COMPONENTS getCOMPONENTS() { 
	   ...
	   try {
	      ret = (RAS_O01_COMPONENTS)this.get("COMPONENTS");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
