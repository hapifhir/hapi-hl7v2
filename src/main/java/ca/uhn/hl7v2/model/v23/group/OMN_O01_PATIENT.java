...
public class OMN_O01_PATIENT extends AbstractGroup {
	...
	public OMN_O01_PATIENT(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating OMN_O01_PATIENT - this is probably a bug in the source code generator.", e);
	   }
	}
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public OMN_O01_INSURANCE getINSURANCE(int rep) throws HL7Exception { 
	   return (OMN_O01_INSURANCE)this.get("INSURANCE", rep);
	}
