...
public class SRM_S04_GENERAL_RESOURCE extends AbstractGroup {
	...
	public SRM_S04_GENERAL_RESOURCE(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating SRM_S04_GENERAL_RESOURCE - this is probably a bug in the source code generator.", e);
	   }
	}
