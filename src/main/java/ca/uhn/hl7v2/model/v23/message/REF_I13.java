...
public class REF_I13 extends AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating REF_I13 - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public REF_I13_PROVIDER getPROVIDER() { 
	   ...
	   try {
	      ret = (REF_I13_PROVIDER)this.get("PROVIDER");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 */
	public REF_I13_PROVIDER getPROVIDER(int rep) throws HL7Exception { 
	   return (REF_I13_PROVIDER)this.get("PROVIDER", rep);
	}
	...
	public REF_I13_INSURANCE getINSURANCE() { 
	   ...
	   try {
	      ret = (REF_I13_INSURANCE)this.get("INSURANCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public REF_I13_INSURANCE getINSURANCE(int rep) throws HL7Exception { 
	   return (REF_I13_INSURANCE)this.get("INSURANCE", rep);
	}
	...
	public REF_I13_PROCEDURE getPROCEDURE() { 
	   ...
	   try {
	      ret = (REF_I13_PROCEDURE)this.get("PROCEDURE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public REF_I13_PROCEDURE getPROCEDURE(int rep) throws HL7Exception { 
	   return (REF_I13_PROCEDURE)this.get("PROCEDURE", rep);
	}
	...
	public REF_I13_RESULTS getRESULTS() { 
	   ...
	   try {
	      ret = (REF_I13_RESULTS)this.get("RESULTS");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public REF_I13_RESULTS getRESULTS(int rep) throws HL7Exception { 
	   return (REF_I13_RESULTS)this.get("RESULTS", rep);
	}
	...
	public REF_I13_VISIT getVISIT() { 
	   ...
	   try {
	      ret = (REF_I13_VISIT)this.get("VISIT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
