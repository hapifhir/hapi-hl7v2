...
public class RDO_O01_ORDER extends AbstractGroup {
	...
	public RDO_O01_ORDER(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(RDO_O01_ORDER_DETAIL.class, false, false);
	      this.add(BLG.class, false, false);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RDO_O01_ORDER - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public RDO_O01_ORDER_DETAIL getORDER_DETAIL() { 
	   ...
	   try {
	      ret = (RDO_O01_ORDER_DETAIL)this.get("ORDER_DETAIL");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
