...
public class PIN_I07 extends AbstractMessage  {
	...
	public PIN_I07_PROVIDER getPROVIDER() { 
	   ...
	   try {
	      ret = (PIN_I07_PROVIDER)this.get("PROVIDER");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 */
	public PIN_I07_PROVIDER getPROVIDER(int rep) throws HL7Exception { 
	   return (PIN_I07_PROVIDER)this.get("PROVIDER", rep);
	}
	...
	public PIN_I07_GUARANTOR_INSURANCE getGUARANTOR_INSURANCE() { 
	   ...
	   try {
	      ret = (PIN_I07_GUARANTOR_INSURANCE)this.get("GUARANTOR_INSURANCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
