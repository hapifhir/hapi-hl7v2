...
public class PPG_PCJ_PROBLEM extends AbstractGroup {
	...
	public PPG_PCJ_PROBLEM(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(PPG_PCJ_PROBLEM_ROLE.class, false, true);
	      this.add(PPG_PCJ_PROBLEM_OBSERVATION.class, false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating PPG_PCJ_PROBLEM - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public PPG_PCJ_PROBLEM_ROLE getPROBLEM_ROLE() { 
	   ...
	   try {
	      ret = (PPG_PCJ_PROBLEM_ROLE)this.get("PROBLEM_ROLE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public PPG_PCJ_PROBLEM_ROLE getPROBLEM_ROLE(int rep) throws HL7Exception { 
	   return (PPG_PCJ_PROBLEM_ROLE)this.get("PROBLEM_ROLE", rep);
	}
	...
	public PPG_PCJ_PROBLEM_OBSERVATION getPROBLEM_OBSERVATION() { 
	   ...
	   try {
	      ret = (PPG_PCJ_PROBLEM_OBSERVATION)this.get("PROBLEM_OBSERVATION");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public PPG_PCJ_PROBLEM_OBSERVATION getPROBLEM_OBSERVATION(int rep) throws HL7Exception { 
	   return (PPG_PCJ_PROBLEM_OBSERVATION)this.get("PROBLEM_OBSERVATION", rep);
	}
