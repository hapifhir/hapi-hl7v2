...
public class SRM_S06_RESOURCES extends AbstractGroup {
	...
	public SRM_S06_RESOURCES(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(SRM_S06_SERVICE.class, false, true);
	      this.add(SRM_S06_GENERAL_RESOURCE.class, false, true);
	      this.add(SRM_S06_LOCATION_RESOURCE.class, false, true);
	      this.add(SRM_S06_PERSONNEL_RESOURCE.class, false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating SRM_S06_RESOURCES - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public SRM_S06_SERVICE getSERVICE() { 
	   ...
	   try {
	      ret = (SRM_S06_SERVICE)this.get("SERVICE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 */
	public SRM_S06_SERVICE getSERVICE(int rep) throws HL7Exception { 
	   return (SRM_S06_SERVICE)this.get("SERVICE", rep);
	}
	...
	public SRM_S06_GENERAL_RESOURCE getGENERAL_RESOURCE() { 
	   ...
	   try {
	      ret = (SRM_S06_GENERAL_RESOURCE)this.get("GENERAL_RESOURCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public SRM_S06_GENERAL_RESOURCE getGENERAL_RESOURCE(int rep) throws HL7Exception { 
	   return (SRM_S06_GENERAL_RESOURCE)this.get("GENERAL_RESOURCE", rep);
	}
	...
	public SRM_S06_LOCATION_RESOURCE getLOCATION_RESOURCE() { 
	   ...
	   try {
	      ret = (SRM_S06_LOCATION_RESOURCE)this.get("LOCATION_RESOURCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public SRM_S06_LOCATION_RESOURCE getLOCATION_RESOURCE(int rep) throws HL7Exception { 
	   return (SRM_S06_LOCATION_RESOURCE)this.get("LOCATION_RESOURCE", rep);
	}
	...
	public SRM_S06_PERSONNEL_RESOURCE getPERSONNEL_RESOURCE() { 
	   ...
	   try {
	      ret = (SRM_S06_PERSONNEL_RESOURCE)this.get("PERSONNEL_RESOURCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public SRM_S06_PERSONNEL_RESOURCE getPERSONNEL_RESOURCE(int rep) throws HL7Exception { 
	   return (SRM_S06_PERSONNEL_RESOURCE)this.get("PERSONNEL_RESOURCE", rep);
	}
