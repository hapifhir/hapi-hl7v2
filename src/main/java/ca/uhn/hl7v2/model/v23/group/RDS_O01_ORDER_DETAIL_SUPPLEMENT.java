...
public class RDS_O01_ORDER_DETAIL_SUPPLEMENT extends AbstractGroup {
	...
	public RDS_O01_ORDER_DETAIL_SUPPLEMENT(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(RDS_O01_COMPONENT.class, false, false);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RDS_O01_ORDER_DETAIL_SUPPLEMENT - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public RDS_O01_COMPONENT getCOMPONENT() { 
	   ...
	   try {
	      ret = (RDS_O01_COMPONENT)this.get("COMPONENT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
