 ...
 */
public class RAS_O01_PATIENT extends AbstractGroup {

	/** 
	 * Creates a new RAS_O01_PATIENT Group.
	 */
	public RAS_O01_PATIENT(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(RAS_O01_PATIENT_VISIT.class, false, false);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RAS_O01_PATIENT - this is probably a bug in the source code generator.", e);
	   }
	}
	 ...
	 */
	public RAS_O01_PATIENT_VISIT getPATIENT_VISIT() { 
	   RAS_O01_PATIENT_VISIT ret = null;
	   try {
	      ret = (RAS_O01_PATIENT_VISIT)this.get("PATIENT_VISIT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
