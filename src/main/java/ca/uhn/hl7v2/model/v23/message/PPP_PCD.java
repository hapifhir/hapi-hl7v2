...
public class PPP_PCD extends AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating PPP_PCD - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public PPP_PCD_PATIENT_VISIT getPATIENT_VISIT() { 
	   ...
	   try {
	      ret = (PPP_PCD_PATIENT_VISIT)this.get("PATIENT_VISIT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	...
	public PPP_PCD_PATHWAY getPATHWAY() { 
	   ...
	   try {
	      ret = (PPP_PCD_PATHWAY)this.get("PATHWAY");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 */
	public PPP_PCD_PATHWAY getPATHWAY(int rep) throws HL7Exception { 
	   return (PPP_PCD_PATHWAY)this.get("PATHWAY", rep);
	}
