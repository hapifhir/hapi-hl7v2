...
public class SRM_S02 extends AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating SRM_S02 - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public SRM_S02_PATIENT getPATIENT() { 
	   ...
	   try {
	      ret = (SRM_S02_PATIENT)this.get("PATIENT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public SRM_S02_PATIENT getPATIENT(int rep) throws HL7Exception { 
	   return (SRM_S02_PATIENT)this.get("PATIENT", rep);
	}
	...
	public SRM_S02_RESOURCES getRESOURCES() { 
	   ...
	   try {
	      ret = (SRM_S02_RESOURCES)this.get("RESOURCES");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public SRM_S02_RESOURCES getRESOURCES(int rep) throws HL7Exception { 
	   return (SRM_S02_RESOURCES)this.get("RESOURCES", rep);
	}
