...
public class MFN_M07_MF_PHASE_SCHED_DETAIL extends AbstractGroup {
	...
	public MFN_M07_MF_PHASE_SCHED_DETAIL(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating MFN_M07_MF_PHASE_SCHED_DETAIL - this is probably a bug in the source code generator.", e);
	   }
	}
