...
public class RDS_O01_ORDER extends AbstractGroup {
	...
	public RDS_O01_ORDER(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(RDS_O01_ORDER_DETAIL.class, false, false);
	      this.add(RDS_O01_ENCODING.class, false, false);
	      this.add(RXD.class, true, false);
	      this.add(RXR.class, true, true);
	      this.add(RXC.class, false, true);
	      this.add(RDS_O01_OBSERVATION.class, true, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RDS_O01_ORDER - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public RDS_O01_ORDER_DETAIL getORDER_DETAIL() { 
	   ...
	   try {
	      ret = (RDS_O01_ORDER_DETAIL)this.get("ORDER_DETAIL");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	...
	public RDS_O01_ENCODING getENCODING() { 
	   ...
	   try {
	      ret = (RDS_O01_ENCODING)this.get("ENCODING");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	...
	public RDS_O01_OBSERVATION getOBSERVATION() { 
	   ...
	   try {
	      ret = (RDS_O01_OBSERVATION)this.get("OBSERVATION");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public RDS_O01_OBSERVATION getOBSERVATION(int rep) throws HL7Exception { 
	   return (RDS_O01_OBSERVATION)this.get("OBSERVATION", rep);
	}
