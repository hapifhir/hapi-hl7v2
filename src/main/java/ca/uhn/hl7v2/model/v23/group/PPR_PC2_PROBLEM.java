...
public class PPR_PC2_PROBLEM extends AbstractGroup {
	...
	public PPR_PC2_PROBLEM(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(PPR_PC2_PROBLEM_ROLE.class, false, true);
	      this.add(PPR_PC2_PATHWAY.class, false, true);
	      this.add(PPR_PC2_PROBLEM_OBSERVATION.class, false, true);
	      this.add(PPR_PC2_GOAL.class, false, true);
	      this.add(PPR_PC2_ORDER.class, false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating PPR_PC2_PROBLEM - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public PPR_PC2_PROBLEM_ROLE getPROBLEM_ROLE() { 
	   ...
	   try {
	      ret = (PPR_PC2_PROBLEM_ROLE)this.get("PROBLEM_ROLE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public PPR_PC2_PROBLEM_ROLE getPROBLEM_ROLE(int rep) throws HL7Exception { 
	   return (PPR_PC2_PROBLEM_ROLE)this.get("PROBLEM_ROLE", rep);
	}
	...
	public PPR_PC2_PATHWAY getPATHWAY() { 
	   ...
	   try {
	      ret = (PPR_PC2_PATHWAY)this.get("PATHWAY");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public PPR_PC2_PATHWAY getPATHWAY(int rep) throws HL7Exception { 
	   return (PPR_PC2_PATHWAY)this.get("PATHWAY", rep);
	}
	...
	public PPR_PC2_PROBLEM_OBSERVATION getPROBLEM_OBSERVATION() { 
	   ...
	   try {
	      ret = (PPR_PC2_PROBLEM_OBSERVATION)this.get("PROBLEM_OBSERVATION");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public PPR_PC2_PROBLEM_OBSERVATION getPROBLEM_OBSERVATION(int rep) throws HL7Exception { 
	   return (PPR_PC2_PROBLEM_OBSERVATION)this.get("PROBLEM_OBSERVATION", rep);
	}
	...
	public PPR_PC2_GOAL getGOAL() { 
	   ...
	   try {
	      ret = (PPR_PC2_GOAL)this.get("GOAL");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public PPR_PC2_GOAL getGOAL(int rep) throws HL7Exception { 
	   return (PPR_PC2_GOAL)this.get("GOAL", rep);
	}
	...
	public PPR_PC2_ORDER getORDER() { 
	   ...
	   try {
	      ret = (PPR_PC2_ORDER)this.get("ORDER");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public PPR_PC2_ORDER getORDER(int rep) throws HL7Exception { 
	   return (PPR_PC2_ORDER)this.get("ORDER", rep);
	}
