...
public class RRI_I15 extends AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RRI_I15 - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public RRI_I15_PROVIDER getPROVIDER() { 
	   ...
	   try {
	      ret = (RRI_I15_PROVIDER)this.get("PROVIDER");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 */
	public RRI_I15_PROVIDER getPROVIDER(int rep) throws HL7Exception { 
	   return (RRI_I15_PROVIDER)this.get("PROVIDER", rep);
	}
	...
	public RRI_I15_PROCEDURE getPROCEDURE() { 
	   ...
	   try {
	      ret = (RRI_I15_PROCEDURE)this.get("PROCEDURE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public RRI_I15_PROCEDURE getPROCEDURE(int rep) throws HL7Exception { 
	   return (RRI_I15_PROCEDURE)this.get("PROCEDURE", rep);
	}
	...
	public RRI_I15_RESULTS getRESULTS() { 
	   ...
	   try {
	      ret = (RRI_I15_RESULTS)this.get("RESULTS");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public RRI_I15_RESULTS getRESULTS(int rep) throws HL7Exception { 
	   return (RRI_I15_RESULTS)this.get("RESULTS", rep);
	}
	...
	public RRI_I15_VISIT getVISIT() { 
	   ...
	   try {
	      ret = (RRI_I15_VISIT)this.get("VISIT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
