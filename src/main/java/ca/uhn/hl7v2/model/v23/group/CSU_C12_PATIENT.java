...
public class CSU_C12_PATIENT extends AbstractGroup {
	...
	public CSU_C12_PATIENT(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(CSU_C12_VISIT.class, false, false);
	      this.add(CSR.class, true, false);
	      this.add(CSU_C12_STUDY_PHASE.class, true, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating CSU_C12_PATIENT - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public CSU_C12_VISIT getVISIT() { 
	   ...
	   try {
	      ret = (CSU_C12_VISIT)this.get("VISIT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	...
	public CSU_C12_STUDY_PHASE getSTUDY_PHASE() { 
	   ...
	   try {
	      ret = (CSU_C12_STUDY_PHASE)this.get("STUDY_PHASE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public CSU_C12_STUDY_PHASE getSTUDY_PHASE(int rep) throws HL7Exception { 
	   return (CSU_C12_STUDY_PHASE)this.get("STUDY_PHASE", rep);
	}
