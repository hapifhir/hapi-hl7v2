...
public class CSU_C12 extends AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating CSU_C12 - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public CSU_C12_PATIENT getPATIENT() { 
	   ...
	   try {
	      ret = (CSU_C12_PATIENT)this.get("PATIENT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 */
	public CSU_C12_PATIENT getPATIENT(int rep) throws HL7Exception { 
	   return (CSU_C12_PATIENT)this.get("PATIENT", rep);
	}
