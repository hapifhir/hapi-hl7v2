...
public class PGL_PC7_GOAL extends AbstractGroup {
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public PGL_PC7_GOAL_ROLE getGOAL_ROLE(int rep) throws HL7Exception { 
	   return (PGL_PC7_GOAL_ROLE)this.get("GOAL_ROLE", rep);
	}
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public PGL_PC7_PATHWAY getPATHWAY(int rep) throws HL7Exception { 
	   return (PGL_PC7_PATHWAY)this.get("PATHWAY", rep);
	}
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public PGL_PC7_OBSERVATION getOBSERVATION(int rep) throws HL7Exception { 
	   return (PGL_PC7_OBSERVATION)this.get("OBSERVATION", rep);
	}
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public PGL_PC7_PROBLEM getPROBLEM(int rep) throws HL7Exception { 
	   return (PGL_PC7_PROBLEM)this.get("PROBLEM", rep);
	}
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public PGL_PC7_ORDER getORDER(int rep) throws HL7Exception { 
	   return (PGL_PC7_ORDER)this.get("ORDER", rep);
	}
