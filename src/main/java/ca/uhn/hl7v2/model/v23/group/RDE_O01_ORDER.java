...
public class RDE_O01_ORDER extends AbstractGroup {
	...
	public RDE_O01_ORDER(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(RDE_O01_ORDER_DETAIL.class, false, false);
	      this.add(RXE.class, true, false);
	      this.add(RXR.class, true, true);
	      this.add(RXC.class, false, true);
	      this.add(RDE_O01_OBSERVATION.class, true, true);
	      this.add(CTI.class, false, false);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RDE_O01_ORDER - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public RDE_O01_ORDER_DETAIL getORDER_DETAIL() { 
	   ...
	   try {
	      ret = (RDE_O01_ORDER_DETAIL)this.get("ORDER_DETAIL");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	...
	public RDE_O01_OBSERVATION getOBSERVATION() { 
	   ...
	   try {
	      ret = (RDE_O01_OBSERVATION)this.get("OBSERVATION");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public RDE_O01_OBSERVATION getOBSERVATION(int rep) throws HL7Exception { 
	   return (RDE_O01_OBSERVATION)this.get("OBSERVATION", rep);
	}
