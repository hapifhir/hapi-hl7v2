...
public class PEX_P08_ASSOCIATED_PERSON extends AbstractGroup {
	...
	public PEX_P08_ASSOCIATED_PERSON(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(PEX_P08_ASSOCIATED_RX_ORDER.class, false, false);
	      this.add(PEX_P08_ASSOCIATED_RX_ADMIN.class, false, true);
	      this.add(PRB.class, false, true);
	      this.add(OBX.class, false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating PEX_P08_ASSOCIATED_PERSON - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public PEX_P08_ASSOCIATED_RX_ORDER getASSOCIATED_RX_ORDER() { 
	   ...
	   try {
	      ret = (PEX_P08_ASSOCIATED_RX_ORDER)this.get("ASSOCIATED_RX_ORDER");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	...
	public PEX_P08_ASSOCIATED_RX_ADMIN getASSOCIATED_RX_ADMIN() { 
	   ...
	   try {
	      ret = (PEX_P08_ASSOCIATED_RX_ADMIN)this.get("ASSOCIATED_RX_ADMIN");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 */
	public PEX_P08_ASSOCIATED_RX_ADMIN getASSOCIATED_RX_ADMIN(int rep) throws HL7Exception { 
	   return (PEX_P08_ASSOCIATED_RX_ADMIN)this.get("ASSOCIATED_RX_ADMIN", rep);
	}
