...
public class SRR_S08_RESOURCES extends AbstractGroup {
	...
	public SRR_S08_RESOURCES(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(SRR_S08_SERVICE.class, false, true);
	      this.add(SRR_S08_GENERAL_RESOURCE.class, false, true);
	      this.add(SRR_S08_LOCATION_RESOURCE.class, false, true);
	      this.add(SRR_S08_PERSONNEL_RESOURCE.class, false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating SRR_S08_RESOURCES - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public SRR_S08_SERVICE getSERVICE() { 
	   ...
	   try {
	      ret = (SRR_S08_SERVICE)this.get("SERVICE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 */
	public SRR_S08_SERVICE getSERVICE(int rep) throws HL7Exception { 
	   return (SRR_S08_SERVICE)this.get("SERVICE", rep);
	}
	...
	public SRR_S08_GENERAL_RESOURCE getGENERAL_RESOURCE() { 
	   ...
	   try {
	      ret = (SRR_S08_GENERAL_RESOURCE)this.get("GENERAL_RESOURCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public SRR_S08_GENERAL_RESOURCE getGENERAL_RESOURCE(int rep) throws HL7Exception { 
	   return (SRR_S08_GENERAL_RESOURCE)this.get("GENERAL_RESOURCE", rep);
	}
	...
	public SRR_S08_LOCATION_RESOURCE getLOCATION_RESOURCE() { 
	   ...
	   try {
	      ret = (SRR_S08_LOCATION_RESOURCE)this.get("LOCATION_RESOURCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public SRR_S08_LOCATION_RESOURCE getLOCATION_RESOURCE(int rep) throws HL7Exception { 
	   return (SRR_S08_LOCATION_RESOURCE)this.get("LOCATION_RESOURCE", rep);
	}
	...
	public SRR_S08_PERSONNEL_RESOURCE getPERSONNEL_RESOURCE() { 
	   ...
	   try {
	      ret = (SRR_S08_PERSONNEL_RESOURCE)this.get("PERSONNEL_RESOURCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public SRR_S08_PERSONNEL_RESOURCE getPERSONNEL_RESOURCE(int rep) throws HL7Exception { 
	   return (SRR_S08_PERSONNEL_RESOURCE)this.get("PERSONNEL_RESOURCE", rep);
	}
