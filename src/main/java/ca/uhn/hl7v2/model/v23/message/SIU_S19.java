...
public class SIU_S19 extends AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating SIU_S19 - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public SIU_S19_PATIENT getPATIENT() { 
	   ...
	   try {
	      ret = (SIU_S19_PATIENT)this.get("PATIENT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public SIU_S19_PATIENT getPATIENT(int rep) throws HL7Exception { 
	   return (SIU_S19_PATIENT)this.get("PATIENT", rep);
	}
	...
	public SIU_S19_RESOURCES getRESOURCES() { 
	   ...
	   try {
	      ret = (SIU_S19_RESOURCES)this.get("RESOURCES");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public SIU_S19_RESOURCES getRESOURCES(int rep) throws HL7Exception { 
	   return (SIU_S19_RESOURCES)this.get("RESOURCES", rep);
	}
