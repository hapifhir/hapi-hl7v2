...
public class RQA_I11 extends AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RQA_I11 - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public RQA_I11_AUTHORIZATION getAUTHORIZATION() { 
	   ...
	   try {
	      ret = (RQA_I11_AUTHORIZATION)this.get("AUTHORIZATION");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	...
	public RQA_I11_PROVIDER getPROVIDER() { 
	   ...
	   try {
	      ret = (RQA_I11_PROVIDER)this.get("PROVIDER");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 */
	public RQA_I11_PROVIDER getPROVIDER(int rep) throws HL7Exception { 
	   return (RQA_I11_PROVIDER)this.get("PROVIDER", rep);
	}
	...
	public RQA_I11_GUARANTOR_INSURANCE getGUARANTOR_INSURANCE() { 
	   ...
	   try {
	      ret = (RQA_I11_GUARANTOR_INSURANCE)this.get("GUARANTOR_INSURANCE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	...
	public RQA_I11_PROCEDURE getPROCEDURE() { 
	   ...
	   try {
	      ret = (RQA_I11_PROCEDURE)this.get("PROCEDURE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public RQA_I11_PROCEDURE getPROCEDURE(int rep) throws HL7Exception { 
	   return (RQA_I11_PROCEDURE)this.get("PROCEDURE", rep);
	}
	...
	public RQA_I11_RESULTS getRESULTS() { 
	   ...
	   try {
	      ret = (RQA_I11_RESULTS)this.get("RESULTS");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public RQA_I11_RESULTS getRESULTS(int rep) throws HL7Exception { 
	   return (RQA_I11_RESULTS)this.get("RESULTS", rep);
	}
	...
	public RQA_I11_VISIT getVISIT() { 
	   ...
	   try {
	      ret = (RQA_I11_VISIT)this.get("VISIT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
