...
public class REF_I12 extends AbstractMessage  {
	...
	public REF_I12_PROVIDER getPROVIDER() { 
	   ...
	   try {
	      ret = (REF_I12_PROVIDER)this.get("PROVIDER");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 */
	public REF_I12_PROVIDER getPROVIDER(int rep) throws HL7Exception { 
	   return (REF_I12_PROVIDER)this.get("PROVIDER", rep);
	}
	...
	public REF_I12_RESULTS getRESULTS() { 
	   ...
	   try {
	      ret = (REF_I12_RESULTS)this.get("RESULTS");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public REF_I12_RESULTS getRESULTS(int rep) throws HL7Exception { 
	   return (REF_I12_RESULTS)this.get("RESULTS", rep);
	}
	...
	public REF_I12_VISIT getVISIT() { 
	   ...
	   try {
	      ret = (REF_I12_VISIT)this.get("VISIT");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
