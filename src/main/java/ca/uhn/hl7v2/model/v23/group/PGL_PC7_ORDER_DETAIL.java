...
public class PGL_PC7_ORDER_DETAIL extends AbstractGroup {
	...
	public PGL_PC7_ORDER_DETAIL(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(PGL_PC7_ORDER_OBSERVATION.class, false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating PGL_PC7_ORDER_DETAIL - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public PGL_PC7_ORDER_OBSERVATION getORDER_OBSERVATION() { 
	   ...
	   try {
	      ret = (PGL_PC7_ORDER_OBSERVATION)this.get("ORDER_OBSERVATION");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public PGL_PC7_ORDER_OBSERVATION getORDER_OBSERVATION(int rep) throws HL7Exception { 
	   return (PGL_PC7_ORDER_OBSERVATION)this.get("ORDER_OBSERVATION", rep);
	}
