...
public class SRM_S06_LOCATION_RESOURCE extends AbstractGroup {
	...
	public SRM_S06_LOCATION_RESOURCE(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating SRM_S06_LOCATION_RESOURCE - this is probably a bug in the source code generator.", e);
	   }
	}
