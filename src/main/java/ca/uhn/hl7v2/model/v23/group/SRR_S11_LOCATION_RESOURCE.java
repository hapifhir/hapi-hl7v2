...
public class SRR_S11_LOCATION_RESOURCE extends AbstractGroup {
	...
	public SRR_S11_LOCATION_RESOURCE(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating SRR_S11_LOCATION_RESOURCE - this is probably a bug in the source code generator.", e);
	   }
	}
