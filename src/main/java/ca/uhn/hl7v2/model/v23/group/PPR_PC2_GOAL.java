...
public class PPR_PC2_GOAL extends AbstractGroup {
	...
	public PPR_PC2_GOAL(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(PPR_PC2_GOAL_ROLE.class, false, true);
	      this.add(PPR_PC2_GOAL_OBSERVATION.class, false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating PPR_PC2_GOAL - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public PPR_PC2_GOAL_ROLE getGOAL_ROLE() { 
	   ...
	   try {
	      ret = (PPR_PC2_GOAL_ROLE)this.get("GOAL_ROLE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public PPR_PC2_GOAL_ROLE getGOAL_ROLE(int rep) throws HL7Exception { 
	   return (PPR_PC2_GOAL_ROLE)this.get("GOAL_ROLE", rep);
	}
	...
	public PPR_PC2_GOAL_OBSERVATION getGOAL_OBSERVATION() { 
	   ...
	   try {
	      ret = (PPR_PC2_GOAL_OBSERVATION)this.get("GOAL_OBSERVATION");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 *     greater than the number of existing repetitions.
	 */
	public PPR_PC2_GOAL_OBSERVATION getGOAL_OBSERVATION(int rep) throws HL7Exception { 
	   return (PPR_PC2_GOAL_OBSERVATION)this.get("GOAL_OBSERVATION", rep);
	}
