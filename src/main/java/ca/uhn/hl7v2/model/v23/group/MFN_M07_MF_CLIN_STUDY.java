...
public class MFN_M07_MF_CLIN_STUDY extends AbstractGroup {
	...
	public MFN_M07_MF_CLIN_STUDY(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(MFN_M07_MF_PHASE_SCHED_DETAIL.class, false, true);
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating MFN_M07_MF_CLIN_STUDY - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public MFN_M07_MF_PHASE_SCHED_DETAIL getMF_PHASE_SCHED_DETAIL() { 
	   ...
	   try {
	      ret = (MFN_M07_MF_PHASE_SCHED_DETAIL)this.get("MF_PHASE_SCHED_DETAIL");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 */
	public MFN_M07_MF_PHASE_SCHED_DETAIL getMF_PHASE_SCHED_DETAIL(int rep) throws HL7Exception { 
	   return (MFN_M07_MF_PHASE_SCHED_DETAIL)this.get("MF_PHASE_SCHED_DETAIL", rep);
	}
