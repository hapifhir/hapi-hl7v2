...
public class SIU_S13_PERSONNEL_RESOURCE extends AbstractGroup {
	...
	public SIU_S13_PERSONNEL_RESOURCE(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating SIU_S13_PERSONNEL_RESOURCE - this is probably a bug in the source code generator.", e);
	   }
	}
