...
public class RSP_K22 extends AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RSP_K22 - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public RSP_K22_QUERY_RESPONSE getQUERY_RESPONSE() { 
	   ...
	   try {
	      ret = (RSP_K22_QUERY_RESPONSE)this.get("QUERY_RESPONSE");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 */
	public RSP_K22_QUERY_RESPONSE getQUERY_RESPONSE(int rep) throws HL7Exception { 
	   return (RSP_K22_QUERY_RESPONSE)this.get("QUERY_RESPONSE", rep);
	}
