...
public class RTB_Q13 extends AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RTB_Q13 - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	public RTB_Q13_ROW_DEFINITION getROW_DEFINITION() { 
	   ...
	   try {
	      ret = (RTB_Q13_ROW_DEFINITION)this.get("ROW_DEFINITION");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
