...
public class RQP_I04 extends AbstractMessage  {
	...
	/**
	 * Returns  first repetition of RQP_I04_PRDCTD (a Group object) - creates it if necessary
	 */
	public RQP_I04_PRDCTD getPRDCTD() { 
	   RQP_I04_PRDCTD ret = null;
	   try {
	      ret = (RQP_I04_PRDCTD)this.get("PRDCTD");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	...
	/**
	 * Returns a specific repetition of RQP_I04_PRDCTD
	 * (a Group object) - creates it if necessary
	 * throws HL7Exception if the repetition requested is more than one 
	 *     greater than the number of existing repetitions.
	 */
	public RQP_I04_PRDCTD getPRDCTD(int rep) throws HL7Exception { 
	   return (RQP_I04_PRDCTD)this.get("PRDCTD", rep);
	}

	/** 
	 * Returns the number of existing repetitions of RQP_I04_PRDCTD 
	 */ 
