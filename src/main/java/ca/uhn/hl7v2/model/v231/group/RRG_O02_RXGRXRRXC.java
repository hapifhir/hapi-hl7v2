...
/**
 * <p>Represents the RRG_O02_RXGRXRRXC Group.  A Group is an ordered collection of message 
...
public class RRG_O02_RXGRXRRXC extends AbstractGroup {
	...
	public RRG_O02_RXGRXRRXC(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RRG_O02_RXGRXRRXC - this is probably a bug in the source code generator.", e);
	   }
	}
