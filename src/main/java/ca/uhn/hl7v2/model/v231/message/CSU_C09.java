...
/**
 * <p>Represents a CSU_C09 message structure (see chapter null). This structure contains the 
...
public class CSU_C09 extends AbstractMessage  {
	...
	/**
	 * Returns  first repetition of CSU_C09_PIDPD1NTEPV1PV2CSRCSPCSSORCOBROBXORCRXARXR (a Group object) - creates it if necessary
	 */
	...
	/**
	 * Returns a specific repetition of CSU_C09_PIDPD1NTEPV1PV2CSRCSPCSSORCOBROBXORCRXARXR
	 * (a Group object) - creates it if necessary
	 * throws HL7Exception if the repetition requested is more than one 
	 *     greater than the number of existing repetitions.
	 */
	public CSU_C09_PIDPD1NTEPV1PV2CSRCSPCSSORCOBROBXORCRXARXR getPIDPD1NTEPV1PV2CSRCSPCSSORCOBROBXORCRXARXR(int rep) throws HL7Exception { 
	   return (CSU_C09_PIDPD1NTEPV1PV2CSRCSPCSSORCOBROBXORCRXARXR)this.get("PIDPD1NTEPV1PV2CSRCSPCSSORCOBROBXORCRXARXR", rep);
	}

	/** 
	 * Returns the number of existing repetitions of CSU_C09_PIDPD1NTEPV1PV2CSRCSPCSSORCOBROBXORCRXARXR 
	 */ 
