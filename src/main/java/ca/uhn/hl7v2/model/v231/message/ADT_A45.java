...
public class ADT_A45 extends AbstractMessage  {
	...
	/**
	 * Returns  first repetition of ADT_A45_MRGPV1 (a Group object) - creates it if necessary
	 */
	...
	/**
	 * Returns a specific repetition of ADT_A45_MRGPV1
	 * (a Group object) - creates it if necessary
	 * throws HL7Exception if the repetition requested is more than one 
	 *     greater than the number of existing repetitions.
	 */
	public ADT_A45_MRGPV1 getMRGPV1(int rep) throws HL7Exception { 
	   return (ADT_A45_MRGPV1)this.get("MRGPV1", rep);
	}

	/** 
	 * Returns the number of existing repetitions of ADT_A45_MRGPV1 
	 */ 
