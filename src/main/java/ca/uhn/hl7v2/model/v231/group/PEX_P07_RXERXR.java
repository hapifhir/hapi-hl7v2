...
/**
 * <p>Represents the PEX_P07_RXERXR Group.  A Group is an ordered collection of message 
...
public class PEX_P07_RXERXR extends AbstractGroup {
	...
	public PEX_P07_RXERXR(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating PEX_P07_RXERXR - this is probably a bug in the source code generator.", e);
	   }
	}
