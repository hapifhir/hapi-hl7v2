...
/**
 * <p>Represents the SQR_S25_PIDPV1PV2DG1 Group.  A Group is an ordered collection of message 
...
public class SQR_S25_PIDPV1PV2DG1 extends AbstractGroup {
	...
	public SQR_S25_PIDPV1PV2DG1(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating SQR_S25_PIDPV1PV2DG1 - this is probably a bug in the source code generator.", e);
	   }
	}
