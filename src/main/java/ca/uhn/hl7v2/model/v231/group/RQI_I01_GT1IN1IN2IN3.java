...
/**
 * <p>Represents the RQI_I01_GT1IN1IN2IN3 Group.  A Group is an ordered collection of message 
...
public class RQI_I01_GT1IN1IN2IN3 extends AbstractGroup {
	...
	/**
	 * Returns  first repetition of RQI_I01_IN1IN2IN3 (a Group object) - creates it if necessary
	 */
	...
	/**
	 * Returns a specific repetition of RQI_I01_IN1IN2IN3
	 * (a Group object) - creates it if necessary
	 * throws HL7Exception if the repetition requested is more than one 
	 *     greater than the number of existing repetitions.
	 */
	public RQI_I01_IN1IN2IN3 getIN1IN2IN3(int rep) throws HL7Exception { 
	   return (RQI_I01_IN1IN2IN3)this.get("IN1IN2IN3", rep);
	}

	/** 
	 * Returns the number of existing repetitions of RQI_I01_IN1IN2IN3 
	 */ 
