...
public class MFN_M06 extends AbstractMessage  {
	...
	/**
	 * Returns  first repetition of MFN_M06_MFECM0CM1CM2 (a Group object) - creates it if necessary
	 */
	...
	/**
	 * Returns a specific repetition of MFN_M06_MFECM0CM1CM2
	 * (a Group object) - creates it if necessary
	 * throws HL7Exception if the repetition requested is more than one 
	 *     greater than the number of existing repetitions.
	 */
	public MFN_M06_MFECM0CM1CM2 getMFECM0CM1CM2(int rep) throws HL7Exception { 
	   return (MFN_M06_MFECM0CM1CM2)this.get("MFECM0CM1CM2", rep);
	}

	/** 
	 * Returns the number of existing repetitions of MFN_M06_MFECM0CM1CM2 
	 */ 
