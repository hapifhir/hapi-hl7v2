...
/**
 * <p>Represents the OMD_O01_IN1IN2IN3 Group.  A Group is an ordered collection of message 
...
public class OMD_O01_IN1IN2IN3 extends AbstractGroup {
	...
	public OMD_O01_IN1IN2IN3(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating OMD_O01_IN1IN2IN3 - this is probably a bug in the source code generator.", e);
	   }
	}
