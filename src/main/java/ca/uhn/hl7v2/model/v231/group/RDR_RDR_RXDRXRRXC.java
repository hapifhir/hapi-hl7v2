...
/**
 * <p>Represents the RDR_RDR_RXDRXRRXC Group.  A Group is an ordered collection of message 
 ...
 */
public class RDR_RDR_RXDRXRRXC extends AbstractGroup {

	/** 
	 * Creates a new RDR_RDR_RXDRXRRXC Group.
	 */
	public RDR_RDR_RXDRXRRXC(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RDR_RDR_RXDRXRRXC - this is probably a bug in the source code generator.", e);
	   }
	}
