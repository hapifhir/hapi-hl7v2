...
public class RPL_I02 extends AbstractMessage  {
	...
	/**
	 * Returns  first repetition of RPL_I02_PRDCTD (a Group object) - creates it if necessary
	 */
	public RPL_I02_PRDCTD getPRDCTD() { 
	   RPL_I02_PRDCTD ret = null;
	   try {
	      ret = (RPL_I02_PRDCTD)this.get("PRDCTD");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	...
	/**
	 * Returns a specific repetition of RPL_I02_PRDCTD
	 * (a Group object) - creates it if necessary
	 * throws HL7Exception if the repetition requested is more than one 
	 *     greater than the number of existing repetitions.
	 */
	public RPL_I02_PRDCTD getPRDCTD(int rep) throws HL7Exception { 
	   return (RPL_I02_PRDCTD)this.get("PRDCTD", rep);
	}

	/** 
	 * Returns the number of existing repetitions of RPL_I02_PRDCTD 
	 */ 
