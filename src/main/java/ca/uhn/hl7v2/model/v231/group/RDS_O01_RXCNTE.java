...
/**
 * <p>Represents the RDS_O01_RXCNTE Group.  A Group is an ordered collection of message 
...
public class RDS_O01_RXCNTE extends AbstractGroup {
	...
	public RDS_O01_RXCNTE(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RDS_O01_RXCNTE - this is probably a bug in the source code generator.", e);
	   }
	}
