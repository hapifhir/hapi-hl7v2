...
public class RPI_I01 extends AbstractMessage  {
	...
	/**
	 * Returns  first repetition of RPI_I01_PRDCTD (a Group object) - creates it if necessary
	 */
	public RPI_I01_PRDCTD getPRDCTD() { 
	   RPI_I01_PRDCTD ret = null;
	   try {
	      ret = (RPI_I01_PRDCTD)this.get("PRDCTD");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	...
	/**
	 * Returns a specific repetition of RPI_I01_PRDCTD
	 * (a Group object) - creates it if necessary
	 * throws HL7Exception if the repetition requested is more than one 
	 *     greater than the number of existing repetitions.
	 */
	public RPI_I01_PRDCTD getPRDCTD(int rep) throws HL7Exception { 
	   return (RPI_I01_PRDCTD)this.get("PRDCTD", rep);
	}

	/** 
	 * Returns the number of existing repetitions of RPI_I01_PRDCTD 
	 */ 
	...
	/**
	 * Returns RPI_I01_GT1IN1IN2IN3 (a Group object) - creates it if necessary
	 */
	public RPI_I01_GT1IN1IN2IN3 getGT1IN1IN2IN3() { 
	   RPI_I01_GT1IN1IN2IN3 ret = null;
	   try {
	      ret = (RPI_I01_GT1IN1IN2IN3)this.get("GT1IN1IN2IN3");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
