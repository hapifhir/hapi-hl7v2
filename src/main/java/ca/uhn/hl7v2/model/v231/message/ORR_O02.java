...
public class ORR_O02 extends AbstractMessage  {
	...
	/**
	 * Returns ORR_O02_PIDNTEORCOBRRQDRQ1RXOODSODTNTECTI (a Group object) - creates it if necessary
	 */
	public ORR_O02_PIDNTEORCOBRRQDRQ1RXOODSODTNTECTI getPIDNTEORCOBRRQDRQ1RXOODSODTNTECTI() { 
	   ...
	   try {
	      ret = (ORR_O02_PIDNTEORCOBRRQDRQ1RXOODSODTNTECTI)this.get("PIDNTEORCOBRRQDRQ1RXOODSODTNTECTI");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
