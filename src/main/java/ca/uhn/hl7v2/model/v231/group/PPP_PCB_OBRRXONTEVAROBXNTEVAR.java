...
/**
 * <p>Represents the PPP_PCB_OBRRXONTEVAROBXNTEVAR Group.  A Group is an ordered collection of message 
...
public class PPP_PCB_OBRRXONTEVAROBXNTEVAR extends AbstractGroup {
	...
	/**
	 * Returns  first repetition of PPP_PCB_OBXNTEVAR (a Group object) - creates it if necessary
	 */
	...
	/**
	 * Returns a specific repetition of PPP_PCB_OBXNTEVAR
	 * (a Group object) - creates it if necessary
	 * throws HL7Exception if the repetition requested is more than one 
	 *     greater than the number of existing repetitions.
	 */
	public PPP_PCB_OBXNTEVAR getOBXNTEVAR(int rep) throws HL7Exception { 
	   return (PPP_PCB_OBXNTEVAR)this.get("OBXNTEVAR", rep);
	}

	/** 
	 * Returns the number of existing repetitions of PPP_PCB_OBXNTEVAR 
	 */ 
