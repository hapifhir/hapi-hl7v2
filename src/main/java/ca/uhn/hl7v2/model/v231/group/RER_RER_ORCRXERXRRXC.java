...
/**
 * <p>Represents the RER_RER_ORCRXERXRRXC Group.  A Group is an ordered collection of message 
...
public class RER_RER_ORCRXERXRRXC extends AbstractGroup {
	...
	public RER_RER_ORCRXERXRRXC(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RER_RER_ORCRXERXRRXC - this is probably a bug in the source code generator.", e);
	   }
	}
