...
/**
 * <p>Represents the PEX_P07_CSRCSP Group.  A Group is an ordered collection of message 
...
public class PEX_P07_CSRCSP extends AbstractGroup {
	...
	public PEX_P07_CSRCSP(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating PEX_P07_CSRCSP - this is probably a bug in the source code generator.", e);
	   }
	}
