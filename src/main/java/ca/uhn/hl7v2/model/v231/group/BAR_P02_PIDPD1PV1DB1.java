...
/**
 * <p>Represents the BAR_P02_PIDPD1PV1DB1 Group.  A Group is an ordered collection of message 
...
public class BAR_P02_PIDPD1PV1DB1 extends AbstractGroup {
	...
	public BAR_P02_PIDPD1PV1DB1(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating BAR_P02_PIDPD1PV1DB1 - this is probably a bug in the source code generator.", e);
	   }
	}
