...
/**
 * <p>Represents a MFN_M02 message structure (see chapter null). This structure contains the 
...
public class MFN_M02 extends AbstractMessage  {
	...
	/**
	 * Returns  first repetition of MFN_M02_MFESTFPRA (a Group object) - creates it if necessary
	 */
	...
	/**
	 * Returns a specific repetition of MFN_M02_MFESTFPRA
	 * (a Group object) - creates it if necessary
	 * throws HL7Exception if the repetition requested is more than one 
	 *     greater than the number of existing repetitions.
	 */
	public MFN_M02_MFESTFPRA getMFESTFPRA(int rep) throws HL7Exception { 
	   return (MFN_M02_MFESTFPRA)this.get("MFESTFPRA", rep);
	}

	/** 
	 * Returns the number of existing repetitions of MFN_M02_MFESTFPRA 
	 */ 
