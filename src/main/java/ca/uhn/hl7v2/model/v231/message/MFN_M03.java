...
public class MFN_M03 extends AbstractMessage  {
	...
	/**
	 * Returns  first repetition of MFN_M03_MFEOM1Hxx (a Group object) - creates it if necessary
	 */
	...
	/**
	 * Returns a specific repetition of MFN_M03_MFEOM1Hxx
	 * (a Group object) - creates it if necessary
	 * throws HL7Exception if the repetition requested is more than one 
	 *     greater than the number of existing repetitions.
	 */
	public MFN_M03_MFEOM1Hxx getMFEOM1Hxx(int rep) throws HL7Exception { 
	   return (MFN_M03_MFEOM1Hxx)this.get("MFEOM1Hxx", rep);
	}

	/** 
	 * Returns the number of existing repetitions of MFN_M03_MFEOM1Hxx 
	 */ 
