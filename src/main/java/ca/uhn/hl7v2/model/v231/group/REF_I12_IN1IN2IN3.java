...
/**
 * <p>Represents the REF_I12_IN1IN2IN3 Group.  A Group is an ordered collection of message 
...
public class REF_I12_IN1IN2IN3 extends AbstractGroup {
	...
	public REF_I12_IN1IN2IN3(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating REF_I12_IN1IN2IN3 - this is probably a bug in the source code generator.", e);
	   }
	}
