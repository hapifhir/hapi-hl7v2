...
/**
 * <p>Represents the SRM_S01_AIGAPRNTE Group.  A Group is an ordered collection of message 
...
public class SRM_S01_AIGAPRNTE extends AbstractGroup {
	...
	public SRM_S01_AIGAPRNTE(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating SRM_S01_AIGAPRNTE - this is probably a bug in the source code generator.", e);
	   }
	}
