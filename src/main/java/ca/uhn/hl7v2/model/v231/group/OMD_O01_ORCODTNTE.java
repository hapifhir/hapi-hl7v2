...
/**
 * <p>Represents the OMD_O01_ORCODTNTE Group.  A Group is an ordered collection of message 
...
public class OMD_O01_ORCODTNTE extends AbstractGroup {
	...
	public OMD_O01_ORCODTNTE(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating OMD_O01_ORCODTNTE - this is probably a bug in the source code generator.", e);
	   }
	}
