...
/**
 * <p>Represents a MFR_M01 message structure (see chapter null). This structure contains the 
...
public class MFR_M01 extends AbstractMessage  {
	...
	/**
	 * Returns  first repetition of MFR_M01_MFEZxx (a Group object) - creates it if necessary
	 */
	public MFR_M01_MFEZxx getMFEZxx() { 
	   MFR_M01_MFEZxx ret = null;
	   try {
	      ret = (MFR_M01_MFEZxx)this.get("MFEZxx");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	...
	/**
	 * Returns a specific repetition of MFR_M01_MFEZxx
	 * (a Group object) - creates it if necessary
	 * throws HL7Exception if the repetition requested is more than one 
	 *     greater than the number of existing repetitions.
	 */
	public MFR_M01_MFEZxx getMFEZxx(int rep) throws HL7Exception { 
	   return (MFR_M01_MFEZxx)this.get("MFEZxx", rep);
	}

	/** 
	 * Returns the number of existing repetitions of MFR_M01_MFEZxx 
	 */ 
