...
/**
 * <p>Represents the ADT_A31_IN1IN2IN3 Group.  A Group is an ordered collection of message 
 ...
 */
public class ADT_A31_IN1IN2IN3 extends AbstractGroup {

	/** 
	 * Creates a new ADT_A31_IN1IN2IN3 Group.
	 */
	public ADT_A31_IN1IN2IN3(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating ADT_A31_IN1IN2IN3 - this is probably a bug in the source code generator.", e);
	   }
	}
