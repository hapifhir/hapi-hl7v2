...
/**
 * <p>Represents the RRD_O02_RXDRXRRXC Group.  A Group is an ordered collection of message 
...
public class RRD_O02_RXDRXRRXC extends AbstractGroup {
	...
	public RRD_O02_RXDRXRRXC(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RRD_O02_RXDRXRRXC - this is probably a bug in the source code generator.", e);
	   }
	}
