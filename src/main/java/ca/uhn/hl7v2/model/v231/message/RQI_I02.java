...
public class RQI_I02 extends AbstractMessage  {
	...
	private void init(ModelClassFactory factory) {
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RQI_I02 - this is probably a bug in the source code generator.", e);
	   }
	}
	...
	/**
	 * Returns  first repetition of RQI_I02_PRDCTD (a Group object) - creates it if necessary
	 */
	public RQI_I02_PRDCTD getPRDCTD() { 
	   RQI_I02_PRDCTD ret = null;
	   try {
	      ret = (RQI_I02_PRDCTD)this.get("PRDCTD");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	...
	/**
	 * Returns a specific repetition of RQI_I02_PRDCTD
	 * (a Group object) - creates it if necessary
	 * throws HL7Exception if the repetition requested is more than one 
	 *     greater than the number of existing repetitions.
	 */
	public RQI_I02_PRDCTD getPRDCTD(int rep) throws HL7Exception { 
	   return (RQI_I02_PRDCTD)this.get("PRDCTD", rep);
	}

	/** 
	 * Returns the number of existing repetitions of RQI_I02_PRDCTD 
	 */ 
	...
	/**
	 * Returns RQI_I02_GT1IN1IN2IN3 (a Group object) - creates it if necessary
	 */
	public RQI_I02_GT1IN1IN2IN3 getGT1IN1IN2IN3() { 
	   RQI_I02_GT1IN1IN2IN3 ret = null;
	   try {
	      ret = (RQI_I02_GT1IN1IN2IN3)this.get("GT1IN1IN2IN3");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
