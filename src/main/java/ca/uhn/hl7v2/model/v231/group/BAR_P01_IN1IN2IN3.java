...
/**
 * <p>Represents the BAR_P01_IN1IN2IN3 Group.  A Group is an ordered collection of message 
 ...
 */
public class BAR_P01_IN1IN2IN3 extends AbstractGroup {

	/** 
	 * Creates a new BAR_P01_IN1IN2IN3 Group.
	 */
	public BAR_P01_IN1IN2IN3(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating BAR_P01_IN1IN2IN3 - this is probably a bug in the source code generator.", e);
	   }
	}
