...
/**
 * <p>Represents the MFN_M10_OM5OM4 Group.  A Group is an ordered collection of message 
...
public class MFN_M10_OM5OM4 extends AbstractGroup {
	...
	public MFN_M10_OM5OM4(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating MFN_M10_OM5OM4 - this is probably a bug in the source code generator.", e);
	   }
	}
