...
/**
 * <p>Represents the VXR_V03_IN1IN2IN3 Group.  A Group is an ordered collection of message 
...
public class VXR_V03_IN1IN2IN3 extends AbstractGroup {
	...
	public VXR_V03_IN1IN2IN3(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating VXR_V03_IN1IN2IN3 - this is probably a bug in the source code generator.", e);
	   }
	}
