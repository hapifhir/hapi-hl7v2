...
public class ADT_A41 extends AbstractMessage  {
	...
	/**
	 * Returns  first repetition of ADT_A41_PIDPD1MRGPV1 (a Group object) - creates it if necessary
	 */
	public ADT_A41_PIDPD1MRGPV1 getPIDPD1MRGPV1() { 
	   ADT_A41_PIDPD1MRGPV1 ret = null;
	   try {
	      ret = (ADT_A41_PIDPD1MRGPV1)this.get("PIDPD1MRGPV1");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	...
	/**
	 * Returns a specific repetition of ADT_A41_PIDPD1MRGPV1
	 * (a Group object) - creates it if necessary
	 * throws HL7Exception if the repetition requested is more than one 
	 *     greater than the number of existing repetitions.
	 */
	public ADT_A41_PIDPD1MRGPV1 getPIDPD1MRGPV1(int rep) throws HL7Exception { 
	   return (ADT_A41_PIDPD1MRGPV1)this.get("PIDPD1MRGPV1", rep);
	}

	/** 
	 * Returns the number of existing repetitions of ADT_A41_PIDPD1MRGPV1 
	 */ 
