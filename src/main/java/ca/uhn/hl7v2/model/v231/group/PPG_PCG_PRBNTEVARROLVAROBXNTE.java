...
/**
 * <p>Represents the PPG_PCG_PRBNTEVARROLVAROBXNTE Group.  A Group is an ordered collection of message 
 ...
 */
public class PPG_PCG_PRBNTEVARROLVAROBXNTE extends AbstractGroup {

	/** 
	 * Creates a new PPG_PCG_PRBNTEVARROLVAROBXNTE Group.
	 */
	public PPG_PCG_PRBNTEVARROLVAROBXNTE(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating PPG_PCG_PRBNTEVARROLVAROBXNTE - this is probably a bug in the source code generator.", e);
	   }
	}
