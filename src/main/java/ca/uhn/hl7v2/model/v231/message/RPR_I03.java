...
public class RPR_I03 extends AbstractMessage  {
	...
	/**
	 * Returns  first repetition of RPR_I03_PRDCTD (a Group object) - creates it if necessary
	 */
	public RPR_I03_PRDCTD getPRDCTD() { 
	   RPR_I03_PRDCTD ret = null;
	   try {
	      ret = (RPR_I03_PRDCTD)this.get("PRDCTD");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	...
	/**
	 * Returns a specific repetition of RPR_I03_PRDCTD
	 * (a Group object) - creates it if necessary
	 * throws HL7Exception if the repetition requested is more than one 
	 *     greater than the number of existing repetitions.
	 */
	public RPR_I03_PRDCTD getPRDCTD(int rep) throws HL7Exception { 
	   return (RPR_I03_PRDCTD)this.get("PRDCTD", rep);
	}

	/** 
	 * Returns the number of existing repetitions of RPR_I03_PRDCTD 
	 */ 
