...
/**
 * <p>Represents the RQA_I08_IN1IN2IN3 Group.  A Group is an ordered collection of message 
...
public class RQA_I08_IN1IN2IN3 extends AbstractGroup {
	...
	public RQA_I08_IN1IN2IN3(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating RQA_I08_IN1IN2IN3 - this is probably a bug in the source code generator.", e);
	   }
	}
