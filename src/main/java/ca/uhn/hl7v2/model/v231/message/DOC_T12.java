...
public class DOC_T12 extends AbstractMessage  {
	...
	/**
	 * Returns  first repetition of DOC_T12_EVNPIDPV1TXAOBX (a Group object) - creates it if necessary
	 */
	...
	/**
	 * Returns a specific repetition of DOC_T12_EVNPIDPV1TXAOBX
	 * (a Group object) - creates it if necessary
	 * throws HL7Exception if the repetition requested is more than one 
	 *     greater than the number of existing repetitions.
	 */
	public DOC_T12_EVNPIDPV1TXAOBX getEVNPIDPV1TXAOBX(int rep) throws HL7Exception { 
	   return (DOC_T12_EVNPIDPV1TXAOBX)this.get("EVNPIDPV1TXAOBX", rep);
	}

	/** 
	 * Returns the number of existing repetitions of DOC_T12_EVNPIDPV1TXAOBX 
	 */ 
