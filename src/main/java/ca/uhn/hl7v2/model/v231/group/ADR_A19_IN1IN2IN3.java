...
/**
 * <p>Represents the ADR_A19_IN1IN2IN3 Group.  A Group is an ordered collection of message 
 ...
 */
public class ADR_A19_IN1IN2IN3 extends AbstractGroup {

	/** 
	 * Creates a new ADR_A19_IN1IN2IN3 Group.
	 */
	public ADR_A19_IN1IN2IN3(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error creating ADR_A19_IN1IN2IN3 - this is probably a bug in the source code generator.", e);
	   }
	}
