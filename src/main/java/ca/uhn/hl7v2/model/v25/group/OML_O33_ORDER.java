...
public class OML_O33_ORDER extends AbstractGroup {
	...
	public OML_O33_ORDER(Group parent, ModelClassFactory factory) {
	   ...
	   try {
	      ...
	      this.add(OML_O33_TIIMING.class, false, true);
	...
	public OML_O33_TIIMING getTIIMING() { 
	   ...
	   try {
	      ret = (OML_O33_TIIMING)this.get("TIIMING");
	   } catch(HL7Exception e) {
	      HapiLogFactory.getHapiLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
	      throw new RuntimeException(e);
	   }
	 ...
	 */
	public OML_O33_TIIMING getTIIMING(int rep) throws HL7Exception { 
	   return (OML_O33_TIIMING)this.get("TIIMING", rep);
	}
