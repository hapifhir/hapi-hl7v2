...
public class RXE extends AbstractSegment  {
  ...
  public RXE(Group parent, ModelClassFactory factory) {
    ...
    try {
       ...
       this.add(ID.class, false, 1, 1, new Object[]{message, new Integer(478)});
       this.add(CWE.class, false, 0, 60, new Object[]{message});
       this.add(CWE.class, false, 1, 250, new Object[]{message});
       this.add(NM.class, false, 1, 250, new Object[]{message});
       this.add(CWE.class, false, 1, 250, new Object[]{message});
