...
public class ORL_O34_OBSERVATION_REQUEST extends AbstractGroup {
	...
	/**
	 * Returns  first repetition of ORL_O34_ORDER_SPECIMEN (a Group object) - creates it if necessary
	 */
	...
	/**
	 * Returns a specific repetition of ORL_O34_ORDER_SPECIMEN
	 * (a Group object) - creates it if necessary
	 * throws HL7Exception if the repetition requested is more than one 
	 *     greater than the number of existing repetitions.
	 */
	public ORL_O34_ORDER_SPECIMEN getORDER_SPECIMEN(int rep) throws HL7Exception { 
	   return (ORL_O34_ORDER_SPECIMEN)this.get("ORDER_SPECIMEN", rep);
	}

	/** 
	 * Returns the number of existing repetitions of ORL_O34_ORDER_SPECIMEN 
	 */ 
