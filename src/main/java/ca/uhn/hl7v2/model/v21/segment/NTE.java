...
public class NTE extends AbstractSegment  {
  ...
  public NTE(Group parent, ModelClassFactory factory) {
    ...
    try {
       ...
       this.add(ID.class, false, 1, 8, new Object[]{message, new Integer(105)});
       this.add(TX.class, true, 0, 120, new Object[]{message});
   ...
   */
  public TX getCOMMENT(int rep) throws HL7Exception {
    TX ret = null;
    try {
