...
/**
 * <p>Represents a ORU_R03_ORDER_OBSERVATION group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: ORC (COMMOM ORDER) <b>optional  </b></li>
                         * <li>2: OBR (OBSERVATION REQUEST) <b>  </b></li>
                         * <li>3: NTE (NOTES AND COMMENTS) <b>optional repeating </b></li>
                         * <li>4: ORU_R03_OBSERVATION (a Group object) <b> repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class ORU_R03_ORDER_OBSERVATION extends AbstractGroup {
    ...
    /**
     * Returns
     * ORC (COMMOM ORDER) - creates it if necessary
     */
    public ORC getORC() { 
    ...
    public ORU_R03_OBSERVATION getOBSERVATION() { 
       ORU_R03_OBSERVATION retVal = getTyped("OBSERVATION", ORU_R03_OBSERVATION.class);
       return retVal;
    }
    ...
    public ORU_R03_OBSERVATION getOBSERVATION(int rep) { 
       ORU_R03_OBSERVATION retVal = getTyped("OBSERVATION", rep, ORU_R03_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<ORU_R03_OBSERVATION> getOBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("OBSERVATION", ORU_R03_OBSERVATION.class);
    } 
