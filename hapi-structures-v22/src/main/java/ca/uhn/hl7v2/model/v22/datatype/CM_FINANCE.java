 ...
 * 
 * The Original Code is "CM_FINANCE.java".  Description:
 * "Composite class CM_FINANCE"
 * 
...
/**
 * <p>Represents an HL7 CM_FINANCE (CM für Finanzen) data type. 
 * This type consists of the following components:</p>
 * <ul>
 * <li>financial class ID (ID)
...
public class CM_FINANCE extends AbstractComposite {
    ...
    /**
     * Returns financial class ID (component 1).  This is a convenience method that saves you from 
