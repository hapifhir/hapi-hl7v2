 ...
 * <ul>
     ...
     * <li>RQD-7: Department cost center (ID) <b>optional </b>
     * <li>RQD-8: Item Natural Account Code (ID) <b>optional </b>
...
public class RQD extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CE.class, false, 1, 60, new Object[]{ getMessage() }, "Requisition Unit of measure");
                                              this.add(ID.class, false, 1, 30, new Object[]{ getMessage(), new Integer(0) }, "Department cost center");
                                              this.add(ID.class, false, 1, 30, new Object[]{ getMessage(), new Integer(0) }, "Item Natural Account Code");
    ...
    /**
     * Returns
     * RQD-7: "Department cost center" - creates it if necessary
     */
