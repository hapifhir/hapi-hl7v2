...
/**
 * <p>Represents a MFD_M03 message structure (see chapter ?). This structure contains the 
...
public class MFD_M03 extends AbstractMessage  {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating MFD_M03 - this is probably a bug in the source code generator.", e);
       }
    }
