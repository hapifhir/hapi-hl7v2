 ...
 * 
 * The Original Code is "CM_ELD.java".  Description:
 * "Composite class CM_ELD"
 * 
...
/**
 * <p>Represents an HL7 CM_ELD (error) data type. 
...
public class CM_ELD extends AbstractComposite {
     ...
     * casting and handling an exception.
     */
    public ST getCm_eld1_SegmentID() {
       return getTyped(0, ST.class);
    }


    /**
     * Returns Sequence (component 2).  This is a convenience method that saves you from 
     * casting and handling an exception.
     */
     ...
     * casting and handling an exception.
     */
    public NM getCm_eld3_FieldPosition() {
       return getTyped(2, NM.class);
    }
     ...
     * casting and handling an exception.
     */
    public CE getCm_eld4_CodeIdentifyingError() {
       return getTyped(3, CE.class);
    }
