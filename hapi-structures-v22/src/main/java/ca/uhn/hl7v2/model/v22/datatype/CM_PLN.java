 ...
 * 
 * The Original Code is "CM_PLN.java".  Description:
 * "Composite class CM_PLN"
 * 
...
/**
 * <p>Represents an HL7 CM_PLN (Practitioner ID Numbers) data type. 
 * This type consists of the following components:</p>
 * <ul>
 * <li>ID number (ST)
 * <li>type of ID number (ID) (ID)
 * <li>state/other qualifiying info (ST)
 * </ul>
 */
...
public class CM_PLN extends AbstractComposite {
    ...
    /**
     * Returns type of ID number (ID) (component 2).  This is a convenience method that saves you from 
     * casting and handling an exception.
     */
    ...
    /**
     * Returns state/other qualifiying info (component 3).  This is a convenience method that saves you from 
     * casting and handling an exception.
     */
