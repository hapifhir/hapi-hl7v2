...
/**
 * <p>Represents a ADT_A33 message structure (see chapter ?). This structure contains the 
...
public class ADT_A33 extends AbstractMessage  {

    /**
     * Creates a new ADT_A33 message with DefaultModelClassFactory. 
     */ 
    public ADT_A33() { 
    ...
    /** 
     * Creates a new ADT_A33 message with custom ModelClassFactory.
     */
    public ADT_A33(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ADT_A33 - this is probably a bug in the source code generator.", e);
       }
    }
