...
/**
 * <p>Represents a MFK_M02 message structure (see chapter ?). This structure contains the 
 ...
 * <ul>
		                 ...
		                 * <li>5: MFA (MASTER FILE ACKNOWLEDGEMENT) <b>optional repeating</b> </li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class MFK_M02 extends AbstractMessage  {

    /**
     * Creates a new MFK_M02 message with DefaultModelClassFactory. 
     */ 
    public MFK_M02() { 
    ...
    /** 
     * Creates a new MFK_M02 message with custom ModelClassFactory.
     */
    public MFK_M02(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating MFK_M02 - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * MFA (MASTER FILE ACKNOWLEDGEMENT) - creates it if necessary
     * </p>
     * 
     *
     */
