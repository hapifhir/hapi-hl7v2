...
public class BHS extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(ST.class, false, 1, 30, new Object[]{ getMessage() }, "Batch Receiving Application");
                                  this.add(ST.class, false, 1, 30, new Object[]{ getMessage() }, "Batch Receiving Facility");
