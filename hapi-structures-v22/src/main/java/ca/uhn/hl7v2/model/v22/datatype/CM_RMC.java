 ...
 * 
 * The Original Code is "CM_RMC.java".  Description:
 * "Composite class CM_RMC"
 * 
...
/**
 * <p>Represents an HL7 CM_RMC (Room Coverage) data type. 
...
public class CM_RMC extends AbstractComposite {
     ...
     * casting and handling an exception.
     */
    public ID getCm_rmc2_AmountType() {
       return getTyped(1, ID.class);
    }
