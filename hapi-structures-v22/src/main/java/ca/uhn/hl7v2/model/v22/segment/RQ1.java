...
/**
 *<p>Represents an HL7 RQ1 message segment (REQUISITION DETAIL-!). 
 * This segment has the following fields:</p>
 * <ul>
     * <li>RQ1-1: Anticipated Price (SI) <b>optional </b>
...
public class RQ1 extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(SI.class, false, 1, 10, new Object[]{ getMessage() }, "Anticipated Price");
