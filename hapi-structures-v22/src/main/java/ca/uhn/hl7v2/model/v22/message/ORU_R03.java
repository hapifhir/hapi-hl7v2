 ...
 * <ul>
		                 ...
		                 * <li>2: ORU_R03_PATIENT_RESULT (a Group object) <b> repeating</b> </li>
...
public class ORU_R03 extends AbstractMessage  {
    ...
    /**
     * Creates a new ORU_R03 message with DefaultModelClassFactory. 
     */ 
    public ORU_R03() { 
    ...
    /** 
     * Creates a new ORU_R03 message with custom ModelClassFactory.
     */
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ORU_R03 - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public ORU_R03_PATIENT_RESULT getPATIENT_RESULT() { 
       return getTyped("PATIENT_RESULT", ORU_R03_PATIENT_RESULT.class);
    }
    ...
    public ORU_R03_PATIENT_RESULT getPATIENT_RESULT(int rep) { 
       return getTyped("PATIENT_RESULT", rep, ORU_R03_PATIENT_RESULT.class);
    }
     ...
     * 
     */ 
    public java.util.List<ORU_R03_PATIENT_RESULT> getPATIENT_RESULTAll() throws HL7Exception {
    	return getAllAsList("PATIENT_RESULT", ORU_R03_PATIENT_RESULT.class);
    } 
     ...
     */
    public void insertPATIENT_RESULT(ORU_R03_PATIENT_RESULT structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public ORU_R03_PATIENT_RESULT insertPATIENT_RESULT(int rep) throws HL7Exception { 
       return (ORU_R03_PATIENT_RESULT)super.insertRepetition("PATIENT_RESULT", rep);
    }
     ...
     */
    public ORU_R03_PATIENT_RESULT removePATIENT_RESULT(int rep) throws HL7Exception { 
       return (ORU_R03_PATIENT_RESULT)super.removeRepetition("PATIENT_RESULT", rep);
    }
