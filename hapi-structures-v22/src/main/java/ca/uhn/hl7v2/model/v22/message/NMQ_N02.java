 ...
 * <ul>
		                 ...
		                 * <li>2: NMQ_N02_QRY_WITH_DETAIL (a Group object) <b>optional </b> </li>
		                 * <li>3: NMQ_N02_CLOCK_AND_STATISTICS (a Group object) <b> repeating</b> </li>
 * </ul>
 */
...
public class NMQ_N02 extends AbstractMessage  {
    ...
    /**
     * Creates a new NMQ_N02 message with DefaultModelClassFactory. 
     */ 
    public NMQ_N02() { 
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating NMQ_N02 - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public NMQ_N02_QRY_WITH_DETAIL getQRY_WITH_DETAIL() { 
       return getTyped("QRY_WITH_DETAIL", NMQ_N02_QRY_WITH_DETAIL.class);
    }
    ...
    public NMQ_N02_CLOCK_AND_STATISTICS getCLOCK_AND_STATISTICS() { 
       return getTyped("CLOCK_AND_STATISTICS", NMQ_N02_CLOCK_AND_STATISTICS.class);
    }
    ...
    public NMQ_N02_CLOCK_AND_STATISTICS getCLOCK_AND_STATISTICS(int rep) { 
       return getTyped("CLOCK_AND_STATISTICS", rep, NMQ_N02_CLOCK_AND_STATISTICS.class);
    }
     ...
     * 
     */ 
    public java.util.List<NMQ_N02_CLOCK_AND_STATISTICS> getCLOCK_AND_STATISTICSAll() throws HL7Exception {
    	return getAllAsList("CLOCK_AND_STATISTICS", NMQ_N02_CLOCK_AND_STATISTICS.class);
    } 
