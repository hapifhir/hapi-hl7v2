 ...
 * <ul>
		                 ...
		                 * <li>7: MFR_M03_MF_TEST (a Group object) <b> repeating</b> </li>
...
public class MFR_M03 extends AbstractMessage  {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating MFR_M03 - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public MFR_M03_MF_TEST getMF_TEST() { 
       return getTyped("MF_TEST", MFR_M03_MF_TEST.class);
    }
    ...
    public MFR_M03_MF_TEST getMF_TEST(int rep) { 
       return getTyped("MF_TEST", rep, MFR_M03_MF_TEST.class);
    }
     ...
     * 
     */ 
    public java.util.List<MFR_M03_MF_TEST> getMF_TESTAll() throws HL7Exception {
    	return getAllAsList("MF_TEST", MFR_M03_MF_TEST.class);
    } 
