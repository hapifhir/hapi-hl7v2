 ...
 * <ul>
     ...
     * <li>MFI-2: Master file application identifier (ID) <b>optional </b>
...
public class MFI extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(CE.class, true, 1, 60, new Object[]{ getMessage() }, "Master file identifier");
                                              this.add(ID.class, false, 1, 6, new Object[]{ getMessage(), new Integer(176) }, "Master file application identifier");
    ...
    protected Type createNewTypeWithoutReflection(int field) {
       switch (field) {
          ...
          case 1: return new ID(getMessage(), new Integer( 176 ));
