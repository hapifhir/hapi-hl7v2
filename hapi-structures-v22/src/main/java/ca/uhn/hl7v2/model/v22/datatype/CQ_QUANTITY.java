 ...
 * 
 * The Original Code is "CQ_QUANTITY.java".  Description:
 * "Composite class CQ_QUANTITY"
 * 
...
/**
 * <p>Represents an HL7 CQ_QUANTITY (CQ für Mengenangaben) data type. 
...
public class CQ_QUANTITY extends AbstractComposite {
    ...
    /** 
     * Creates a new CQ_QUANTITY type
     */
     ...
     * casting and handling an exception.
     */
    public ST getCq_quantity1_Quantity() {
       return getTyped(0, ST.class);
    }
     ...
     * casting and handling an exception.
     */
    public ST getCq_quantity2_Units() {
       return getTyped(1, ST.class);
    }
