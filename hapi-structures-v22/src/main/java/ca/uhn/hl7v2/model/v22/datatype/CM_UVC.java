 ...
 * 
 * The Original Code is "CM_UVC.java".  Description:
 * "Composite class CM_UVC"
 * 
...
/**
 * <p>Represents an HL7 CM_UVC (Value code and amount) data type. 
...
public class CM_UVC extends AbstractComposite {
     ...
     * casting and handling an exception.
     */
    public ID getCm_uvc1_ValueCode() {
       return getTyped(0, ID.class);
    }
