...
/**
 * <p>Represents a NMD_N01_CLOCK group structure (a Group object).
...
public class NMD_N01_CLOCK extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating NMD_N01_CLOCK - this is probably a bug in the source code generator.", e);
       }
    }
