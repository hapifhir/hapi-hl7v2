...
/**
 * <p>Represents a MFD_M02 message structure (see chapter ?). This structure contains the 
 * following elements: </p>
 * <ul>
		                 * <li>1: MSH (MESSAGE HEADER) <b> </b> </li>
		                 * <li>2: MFI (MASTER FILE IDENTIFICATION) <b> </b> </li>
		                 * <li>3: MFA (MASTER FILE ACKNOWLEDGEMENT) <b>optional repeating</b> </li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class MFD_M02 extends AbstractMessage  {

    /**
     * Creates a new MFD_M02 message with DefaultModelClassFactory. 
     */ 
    public MFD_M02() { 
     ...
     */
    public MFD_M02(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating MFD_M02 - this is probably a bug in the source code generator.", e);
       }
    }
