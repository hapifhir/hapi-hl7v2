...
/**
 * <p>Represents a ADT_A04_INSURANCE group structure (a Group object).
...
public class ADT_A04_INSURANCE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ADT_A04_INSURANCE - this is probably a bug in the source code generator.", e);
       }
    }
