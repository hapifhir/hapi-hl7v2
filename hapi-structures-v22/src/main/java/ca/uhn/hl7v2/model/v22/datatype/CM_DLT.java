 ...
 * 
 * The Original Code is "CM_DLT.java".  Description:
 * "Composite class CM_DLT"
 * 
...
/**
 * <p>Represents an HL7 CM_DLT (delta check) data type. 
...
public class CM_DLT extends AbstractComposite {
    ...
    /**
     * Returns change (component 3).  This is a convenience method that saves you from 
     * casting and handling an exception.
     */
    public ST getChange() {
