...
/**
 * <p>Represents a DSR_R03 message structure (see chapter ?). This structure contains the 
 * following elements: </p>
 * <ul>
		                 * <li>1: MSH (MESSAGE HEADER) <b> </b> </li>
		                 * <li>2: MSA (MESSAGE ACKNOWLEDGMENT) <b>optional </b> </li>
		                 * <li>3: QRD (QUERY DEFINITION) <b> </b> </li>
		                 * <li>4: QRF (QUERY FILTER) <b>optional </b> </li>
		                 * <li>5: DSP (DISPLAY DATA) <b> repeating</b> </li>
		                 * <li>6: DSC (CONTINUATION POINTER) <b>optional </b> </li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class DSR_R03 extends AbstractMessage  {

    /**
     * Creates a new DSR_R03 message with DefaultModelClassFactory. 
     */ 
    public DSR_R03() { 
    ...
    /** 
     * Creates a new DSR_R03 message with custom ModelClassFactory.
     */
    public DSR_R03(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating DSR_R03 - this is probably a bug in the source code generator.", e);
       }
    }
