 ...
 * <ul>
		                 ...
		                 * <li>4: QRD (QUERY DEFINITION) <b>optional </b> </li>
		                 * <li>5: NMR_N02_CLOCK_AND_STATS_WITH_NOTES_ALT (a Group object) <b> repeating</b> </li>
 * </ul>
 */
...
public class NMR_N02 extends AbstractMessage  {
    ...
    /**
     * Creates a new NMR_N02 message with DefaultModelClassFactory. 
     */ 
    public NMR_N02() { 
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating NMR_N02 - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public NMR_N02_CLOCK_AND_STATS_WITH_NOTES_ALT getCLOCK_AND_STATS_WITH_NOTES_ALT() { 
       return getTyped("CLOCK_AND_STATS_WITH_NOTES_ALT", NMR_N02_CLOCK_AND_STATS_WITH_NOTES_ALT.class);
    }
    ...
    public NMR_N02_CLOCK_AND_STATS_WITH_NOTES_ALT getCLOCK_AND_STATS_WITH_NOTES_ALT(int rep) { 
       return getTyped("CLOCK_AND_STATS_WITH_NOTES_ALT", rep, NMR_N02_CLOCK_AND_STATS_WITH_NOTES_ALT.class);
    }
     ...
     * 
     */ 
    public java.util.List<NMR_N02_CLOCK_AND_STATS_WITH_NOTES_ALT> getCLOCK_AND_STATS_WITH_NOTES_ALTAll() throws HL7Exception {
    	return getAllAsList("CLOCK_AND_STATS_WITH_NOTES_ALT", NMR_N02_CLOCK_AND_STATS_WITH_NOTES_ALT.class);
    } 
     ...
     */
    public void insertCLOCK_AND_STATS_WITH_NOTES_ALT(NMR_N02_CLOCK_AND_STATS_WITH_NOTES_ALT structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public NMR_N02_CLOCK_AND_STATS_WITH_NOTES_ALT insertCLOCK_AND_STATS_WITH_NOTES_ALT(int rep) throws HL7Exception { 
       return (NMR_N02_CLOCK_AND_STATS_WITH_NOTES_ALT)super.insertRepetition("CLOCK_AND_STATS_WITH_NOTES_ALT", rep);
    }
     ...
     */
    public NMR_N02_CLOCK_AND_STATS_WITH_NOTES_ALT removeCLOCK_AND_STATS_WITH_NOTES_ALT(int rep) throws HL7Exception { 
       return (NMR_N02_CLOCK_AND_STATS_WITH_NOTES_ALT)super.removeRepetition("CLOCK_AND_STATS_WITH_NOTES_ALT", rep);
    }
