 ...
 * <ul>
     ...
     * <li>NST-8: Message Received (NM) <b>optional </b>
     * <li>NST-9: Message Sent (NM) <b>optional </b>
...
public class NST extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(NM.class, false, 1, 10, new Object[]{ getMessage() }, "Message Received");
                                  this.add(NM.class, false, 1, 10, new Object[]{ getMessage() }, "Message Sent");
    ...
    /**
     * Returns
     * NST-8: "Message Received" - creates it if necessary
     */
    public NM getMessageReceived() { 
     ...
     * NST-8: "Message Received" - creates it if necessary
     */
    public NM getNst8_MessageReceived() { 
		NM retVal = this.getTypedField(8, 0);
		return retVal;
    }
    ...
    /**
     * Returns
     * NST-9: "Message Sent" - creates it if necessary
     */
    public NM getMessageSent() { 
