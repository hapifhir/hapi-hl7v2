 ...
 * 
 * The Original Code is "CM_DLD.java".  Description:
 * "Composite class CM_DLD"
 * 
...
/**
 * <p>Represents an HL7 CM_DLD (discharge location) data type. 
 * This type consists of the following components:</p>
 * <ul>
 * <li>discharge location (ID)
...
public class CM_DLD extends AbstractComposite {
     ...
     * casting and handling an exception.
     */
    public ID getCm_dld1_DischargeLocation() {
       return getTyped(0, ID.class);
    }
     ...
     * casting and handling an exception.
     */
    public TS getCm_dld2_EffectiveDate() {
       return getTyped(1, TS.class);
    }
