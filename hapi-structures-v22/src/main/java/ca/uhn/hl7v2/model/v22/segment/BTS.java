 ...
 * <ul>
     ...
     * <li>BTS-3: Batch Totals (CM_BATCH_TOTAL) <b>optional repeating</b>
 * </ul>
 */
...
public class BTS extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CM_BATCH_TOTAL.class, false, 0, 100, new Object[]{ getMessage() }, "Batch Totals");
    ...
    public CM_BATCH_TOTAL[] getBatchTotals() {
    	CM_BATCH_TOTAL[] retVal = this.getTypedField(3, new CM_BATCH_TOTAL[0]);
    	return retVal;
    }
    ...
    public CM_BATCH_TOTAL getBatchTotals(int rep) { 
		CM_BATCH_TOTAL retVal = this.getTypedField(3, rep);
		return retVal;
    }
    ...
    protected Type createNewTypeWithoutReflection(int field) {
       switch (field) {
          ...
          case 2: return new CM_BATCH_TOTAL(getMessage());
          default: return null;
       }
   }
