 ...
 * 
 * The Original Code is "CM_BATCH_TOTAL.java".  Description:
 * "Composite class CM_BATCH_TOTAL"
 * 
...
/**
 * <p>Represents an HL7 CM_BATCH_TOTAL (CM for Batch Totals) data type. 
...
public class CM_BATCH_TOTAL extends AbstractComposite {
    ...
    /**
     * Returns Batch total 1 (component 1).  This is a convenience method that saves you from 
    ...
    /**
     * Returns Batch total 2 (component 2).  This is a convenience method that saves you from 
     * casting and handling an exception.
     */
