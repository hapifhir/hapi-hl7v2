 ...
 * 
 * The Original Code is "CM_PCF.java".  Description:
 * "Composite class CM_PCF"
 * 
...
/**
 * <p>Represents an HL7 CM_PCF (Pre-certification required) data type. 
 * This type consists of the following components:</p>
 * <ul>
 * <li>pre-certification patient type (ID)
 * <li>pre-certication required (ID)
...
public class CM_PCF extends AbstractComposite {
     ...
     */
    public ID getPreCertificationPatientType() {
     ...
     * casting and handling an exception.
     */
    public ID getCm_pcf1_PreCertificationPatientType() {
       return getTyped(0, ID.class);
    }


    /**
     * Returns pre-certication required (component 2).  This is a convenience method that saves you from 
     * casting and handling an exception.
     */
    public ID getPreCerticationRequired() {
     ...
     * casting and handling an exception.
     */
    public ID getCm_pcf2_PreCerticationRequired() {
       return getTyped(1, ID.class);
    }
     ...
     * casting and handling an exception.
     */
    public TS getCm_pcf3_PreCertificationWindow() {
       return getTyped(2, TS.class);
    }
