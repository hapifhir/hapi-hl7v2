 ...
 * 
 * The Original Code is "CM_SPD.java".  Description:
 * "Composite class CM_SPD"
 * 
...
/**
 * <p>Represents an HL7 CM_SPD (Specialty) data type. 
...
public class CM_SPD extends AbstractComposite {
     ...
     * casting and handling an exception.
     */
    public ST getCm_spd1_SpecialtyName() {
       return getTyped(0, ST.class);
    }
     ...
     * casting and handling an exception.
     */
    public ST getCm_spd2_GoverningBoard() {
       return getTyped(1, ST.class);
    }
     ...
     * casting and handling an exception.
     */
    public ID getCm_spd3_EligibleOrCertified() {
       return getTyped(2, ID.class);
    }
     ...
     * casting and handling an exception.
     */
    public DT getCm_spd4_DateOfCertification() {
       return getTyped(3, DT.class);
    }
