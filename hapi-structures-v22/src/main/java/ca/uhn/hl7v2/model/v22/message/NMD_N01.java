 ...
 * <ul>
		                 ...
		                 * <li>2: NMD_N01_CLOCK_AND_STATS_WITH_NOTES (a Group object) <b> repeating</b> </li>
 * </ul>
 */
...
public class NMD_N01 extends AbstractMessage  {
    ...
    /**
     * Creates a new NMD_N01 message with DefaultModelClassFactory. 
     */ 
    public NMD_N01() { 
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating NMD_N01 - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public NMD_N01_CLOCK_AND_STATS_WITH_NOTES getCLOCK_AND_STATS_WITH_NOTES() { 
       return getTyped("CLOCK_AND_STATS_WITH_NOTES", NMD_N01_CLOCK_AND_STATS_WITH_NOTES.class);
    }
    ...
    public NMD_N01_CLOCK_AND_STATS_WITH_NOTES getCLOCK_AND_STATS_WITH_NOTES(int rep) { 
       return getTyped("CLOCK_AND_STATS_WITH_NOTES", rep, NMD_N01_CLOCK_AND_STATS_WITH_NOTES.class);
    }
     ...
     * 
     */ 
    public java.util.List<NMD_N01_CLOCK_AND_STATS_WITH_NOTES> getCLOCK_AND_STATS_WITH_NOTESAll() throws HL7Exception {
    	return getAllAsList("CLOCK_AND_STATS_WITH_NOTES", NMD_N01_CLOCK_AND_STATS_WITH_NOTES.class);
    } 
