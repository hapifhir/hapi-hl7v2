...
/**
 * <p>Represents a RDR_RDR message structure (see chapter 5.9.1.0). This structure contains the 
 * following elements: </p>
 * <ul>
		                 * <li>1: MSH (Message Header) <b> </b> </li>
		                 * <li>2: MSA (Message Acknowledgment) <b> </b> </li>
		                 * <li>3: ERR (Error) <b>optional repeating</b> </li>
		                 * <li>4: SFT (Software Segment) <b>optional </b> </li>
		                 * <li>5: UAC (User Authentication Credential Segment) <b>optional </b> </li>
		                 * <li>6: RDR_RDR_DEFINITION (a Group object) <b> repeating</b> </li>
