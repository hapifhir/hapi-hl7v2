...
/**
 * <p>Represents a CQU_I19_ROLE_CLINICAL_HISTORY group structure (a Group object).
...
public class CQU_I19_ROLE_CLINICAL_HISTORY extends AbstractGroup {

    /** 
     * Creates a new CQU_I19_ROLE_CLINICAL_HISTORY group
     */
    public CQU_I19_ROLE_CLINICAL_HISTORY(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating CQU_I19_ROLE_CLINICAL_HISTORY - this is probably a bug in the source code generator.", e);
       }
    }
