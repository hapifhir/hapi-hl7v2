...
public class BLG extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(CCD.class, false, 1, 0, new Object[]{ getMessage() }, "When to Charge");
                                              this.add(ID.class, false, 1, 2, new Object[]{ getMessage(), new Integer(122) }, "Charge Type");
                                  this.add(CX.class, false, 1, 0, new Object[]{ getMessage() }, "Account ID");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Charge Type Reason");
