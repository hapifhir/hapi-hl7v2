...
/**
 * <p>Represents a CCI_I22_ROLE_GOAL group structure (a Group object).
...
public class CCI_I22_ROLE_GOAL extends AbstractGroup {

    /** 
     * Creates a new CCI_I22_ROLE_GOAL group
     */
    public CCI_I22_ROLE_GOAL(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating CCI_I22_ROLE_GOAL - this is probably a bug in the source code generator.", e);
       }
    }
