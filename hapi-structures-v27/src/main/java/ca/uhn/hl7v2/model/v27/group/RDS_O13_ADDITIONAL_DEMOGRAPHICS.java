...
/**
 * <p>Represents a RDS_O13_ADDITIONAL_DEMOGRAPHICS group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: PD1 (Patient Additional Demographic) <b>  </b></li>
                         * <li>2: PRT (Participation Information) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class RDS_O13_ADDITIONAL_DEMOGRAPHICS extends AbstractGroup {

    /** 
     * Creates a new RDS_O13_ADDITIONAL_DEMOGRAPHICS group
     */
    public RDS_O13_ADDITIONAL_DEMOGRAPHICS(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(PD1.class, true, false, false);
                                  this.add(PRT.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating RDS_O13_ADDITIONAL_DEMOGRAPHICS - this is probably a bug in the source code generator.", e);
       }
    }
