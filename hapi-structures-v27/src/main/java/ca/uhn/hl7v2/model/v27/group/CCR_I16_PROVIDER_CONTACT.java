...
/**
 * <p>Represents a CCR_I16_PROVIDER_CONTACT group structure (a Group object).
...
public class CCR_I16_PROVIDER_CONTACT extends AbstractGroup {

    /** 
     * Creates a new CCR_I16_PROVIDER_CONTACT group
     */
    public CCR_I16_PROVIDER_CONTACT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating CCR_I16_PROVIDER_CONTACT - this is probably a bug in the source code generator.", e);
       }
    }
