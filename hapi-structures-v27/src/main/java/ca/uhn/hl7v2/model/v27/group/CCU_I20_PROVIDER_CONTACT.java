...
/**
 * <p>Represents a CCU_I20_PROVIDER_CONTACT group structure (a Group object).
...
public class CCU_I20_PROVIDER_CONTACT extends AbstractGroup {

    /** 
     * Creates a new CCU_I20_PROVIDER_CONTACT group
     */
    public CCU_I20_PROVIDER_CONTACT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating CCU_I20_PROVIDER_CONTACT - this is probably a bug in the source code generator.", e);
       }
    }
