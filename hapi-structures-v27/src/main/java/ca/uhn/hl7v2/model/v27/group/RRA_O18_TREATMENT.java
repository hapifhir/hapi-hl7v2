...
/**
 * <p>Represents a RRA_O18_TREATMENT group structure (a Group object).
...
public class RRA_O18_TREATMENT extends AbstractGroup {

    /** 
     * Creates a new RRA_O18_TREATMENT group
     */
    public RRA_O18_TREATMENT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RRA_O18_TREATMENT - this is probably a bug in the source code generator.", e);
       }
    }
