...
/**
 * <p>Represents a CCR_I16_ROLE_PATHWAY group structure (a Group object).
...
public class CCR_I16_ROLE_PATHWAY extends AbstractGroup {

    /** 
     * Creates a new CCR_I16_ROLE_PATHWAY group
     */
    public CCR_I16_ROLE_PATHWAY(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating CCR_I16_ROLE_PATHWAY - this is probably a bug in the source code generator.", e);
       }
    }
