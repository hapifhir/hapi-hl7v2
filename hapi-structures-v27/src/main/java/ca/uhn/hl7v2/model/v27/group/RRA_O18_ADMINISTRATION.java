 ...
 * </p>
 * <ul>
                         * <li>1: RRA_O18_TREATMENT (a Group object) <b> repeating </b></li>
...
public class RRA_O18_ADMINISTRATION extends AbstractGroup {
    ...
    public RRA_O18_TREATMENT getTREATMENT() { 
       RRA_O18_TREATMENT retVal = getTyped("TREATMENT", RRA_O18_TREATMENT.class);
       return retVal;
    }
    ...
    public RRA_O18_TREATMENT getTREATMENT(int rep) { 
       RRA_O18_TREATMENT retVal = getTyped("TREATMENT", rep, RRA_O18_TREATMENT.class);
       return retVal;
    }

    /** 
     * Returns the number of existing repetitions of TREATMENT 
     */ 
    public int getTREATMENTReps() {  
        return getReps("TREATMENT");
    } 
     ...
     * <p>
     * <p>
     * Note that unlike {@link #getTREATMENT()}, this method will not create any reps
     * if none are already present, so an empty list may be returned.
     * </p>
     */ 
    public java.util.List<RRA_O18_TREATMENT> getTREATMENTAll() throws HL7Exception {
    	return getAllAsList("TREATMENT", RRA_O18_TREATMENT.class);
    } 
    ...
    public void insertTREATMENT(RRA_O18_TREATMENT structure, int rep) throws HL7Exception { 
       super.insertRepetition("TREATMENT", structure, rep);
    }
