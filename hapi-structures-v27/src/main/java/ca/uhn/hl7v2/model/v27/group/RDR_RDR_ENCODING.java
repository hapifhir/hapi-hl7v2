 ...
 * <ul>
                         ...
                         * <li>2: RDR_RDR_TIMING_ENCODED (a Group object) <b>optional repeating </b></li>
...
public class RDR_RDR_ENCODING extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(RDR_RDR_TIMING_ENCODED.class, false, true, false);
                                  this.add(RXR.class, true, true, false);
                                  this.add(RXC.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating RDR_RDR_ENCODING - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public RDR_RDR_TIMING_ENCODED getTIMING_ENCODED() { 
       RDR_RDR_TIMING_ENCODED retVal = getTyped("TIMING_ENCODED", RDR_RDR_TIMING_ENCODED.class);
       return retVal;
    }
    ...
    public RDR_RDR_TIMING_ENCODED getTIMING_ENCODED(int rep) { 
       RDR_RDR_TIMING_ENCODED retVal = getTyped("TIMING_ENCODED", rep, RDR_RDR_TIMING_ENCODED.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<RDR_RDR_TIMING_ENCODED> getTIMING_ENCODEDAll() throws HL7Exception {
    	return getAllAsList("TIMING_ENCODED", RDR_RDR_TIMING_ENCODED.class);
    } 
     ...
     */
    public void insertTIMING_ENCODED(RDR_RDR_TIMING_ENCODED structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public RDR_RDR_TIMING_ENCODED insertTIMING_ENCODED(int rep) throws HL7Exception { 
       return (RDR_RDR_TIMING_ENCODED)super.insertRepetition("TIMING_ENCODED", rep);
    }
     ...
     */
    public RDR_RDR_TIMING_ENCODED removeTIMING_ENCODED(int rep) throws HL7Exception { 
       return (RDR_RDR_TIMING_ENCODED)super.removeRepetition("TIMING_ENCODED", rep);
    }
