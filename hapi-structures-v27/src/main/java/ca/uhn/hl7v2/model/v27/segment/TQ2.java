...
public class TQ2 extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(EI.class, false, 0, 0, new Object[]{ getMessage() }, "Related Placer Number");
                                  this.add(EI.class, false, 0, 0, new Object[]{ getMessage() }, "Related Filler Number");
                                  this.add(EI.class, false, 0, 0, new Object[]{ getMessage() }, "Related Placer Group Number");
