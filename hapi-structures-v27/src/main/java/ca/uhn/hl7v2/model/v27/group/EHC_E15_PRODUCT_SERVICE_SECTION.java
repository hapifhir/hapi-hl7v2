...
public class EHC_E15_PRODUCT_SERVICE_SECTION extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(EHC_E15_PRODUCT_SERVICE_GROUP.class, true, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating EHC_E15_PRODUCT_SERVICE_SECTION - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * </p>
     */ 
    public java.util.List<EHC_E15_PRODUCT_SERVICE_GROUP> getPRODUCT_SERVICE_GROUPAll() throws HL7Exception {
