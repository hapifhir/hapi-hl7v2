 ...
 * <ul>
     ...
     * <li>LOC-3: Location Type - LOC (CWE) <b> repeating</b>
     ...
     * <li>LOC-8: Location Equipment (CWE) <b>optional repeating</b>
     * <li>LOC-9: Location Service Code (CWE) <b>optional </b>
 * </ul>
 */
...
public class LOC extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(PL.class, true, 1, 0, new Object[]{ getMessage() }, "Primary Key Value - LOC");
                                  this.add(ST.class, false, 1, 0, new Object[]{ getMessage() }, "Location Description");
                                  this.add(CWE.class, true, 0, 0, new Object[]{ getMessage() }, "Location Type - LOC");
                                  this.add(XON.class, false, 0, 0, new Object[]{ getMessage() }, "Organization Name - LOC");
                                  this.add(XAD.class, false, 0, 0, new Object[]{ getMessage() }, "Location Address");
                                  this.add(XTN.class, false, 0, 0, new Object[]{ getMessage() }, "Location Phone");
                                  this.add(CWE.class, false, 0, 0, new Object[]{ getMessage() }, "License Number");
                                  this.add(CWE.class, false, 0, 0, new Object[]{ getMessage() }, "Location Equipment");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Location Service Code");
     ...
     * Returns all repetitions of Location Type - LOC (LOC-3).
     */
    public CWE[] getLoc3_LocationTypeLOC() {
    	CWE[] retVal = this.getTypedField(3, new CWE[0]);
    	return retVal;
    }
     ...
     * @param rep The repetition index (0-indexed)
     */
    public CWE getLoc3_LocationTypeLOC(int rep) { 
		CWE retVal = this.getTypedField(3, rep);
		return retVal;
    }
     ...
     */
    public CWE insertLocationTypeLOC(int rep) throws HL7Exception { 
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public CWE insertLoc3_LocationTypeLOC(int rep) throws HL7Exception { 
        return (CWE) super.insertRepetition(3, rep);
    }
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public CWE removeLocationTypeLOC(int rep) throws HL7Exception { 
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public CWE removeLoc3_LocationTypeLOC(int rep) throws HL7Exception { 
        return (CWE) super.removeRepetition(3, rep);
    }
     ...
     * Returns all repetitions of Location Equipment (LOC-8).
     */
    public CWE[] getLoc8_LocationEquipment() {
    	CWE[] retVal = this.getTypedField(8, new CWE[0]);
    	return retVal;
    }
     ...
     * @param rep The repetition index (0-indexed)
     */
    public CWE getLoc8_LocationEquipment(int rep) { 
		CWE retVal = this.getTypedField(8, rep);
		return retVal;
    }
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public CWE insertLocationEquipment(int rep) throws HL7Exception { 
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public CWE insertLoc8_LocationEquipment(int rep) throws HL7Exception { 
        return (CWE) super.insertRepetition(8, rep);
    }
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public CWE removeLocationEquipment(int rep) throws HL7Exception { 
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public CWE removeLoc8_LocationEquipment(int rep) throws HL7Exception { 
        return (CWE) super.removeRepetition(8, rep);
    }
     ...
     */
    public CWE getLocationServiceCode() { 
     ...
     * LOC-9: "Location Service Code" - creates it if necessary
     */
    public CWE getLoc9_LocationServiceCode() { 
		CWE retVal = this.getTypedField(9, 0);
		return retVal;
    }
