...
/**
 * <p>Represents a CCR_I16_PATIENT group structure (a Group object).
...
public class CCR_I16_PATIENT extends AbstractGroup {

    /** 
     * Creates a new CCR_I16_PATIENT group
     */
    public CCR_I16_PATIENT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating CCR_I16_PATIENT - this is probably a bug in the source code generator.", e);
       }
    }
