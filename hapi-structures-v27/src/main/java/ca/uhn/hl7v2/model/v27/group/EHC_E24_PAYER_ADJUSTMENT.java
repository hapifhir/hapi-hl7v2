 ...
 * </p>
 * <ul>
                         * <li>1: ADJ (Adjustment) <b>  choice</b></li>
 * </ul>
 * <p>
...
public class EHC_E24_PAYER_ADJUSTMENT extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(ADJ.class, true, false, true);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating EHC_E24_PAYER_ADJUSTMENT - this is probably a bug in the source code generator.", e);
       }
    }
