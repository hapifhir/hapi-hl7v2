...
/**
 * <p>Represents a MDM_T02 message structure (see chapter 9.6.2). This structure contains the 
 ...
 * <ul>
		                 ...
		                 * <li>9: CON_ (Consent Segment) <b>optional repeating</b> </li>
		                 * <li>10: MDM_T02_OBSERVATION (a Group object) <b> repeating</b> </li>
 * </ul>
 */
...
public class MDM_T02 extends AbstractMessage  {
     ...
     * Returns
     * the first repetition of 
     * CON_ (Consent Segment) - creates it if necessary
     * </p>
     * 
     *
     */
    public CON_ getCON_() { 
       return getTyped("CON_", CON_.class);
    }
    ...
    public CON_ getCON_(int rep) { 
       return getTyped("CON_", rep, CON_.class);
    }

    /** 
     * <p>
     * Returns the number of existing repetitions of CON_ 
     * </p>
     * 
     */ 
    ...
    /** 
     * <p>
     * Returns a non-modifiable List containing all current existing repetitions of CON_.
     * <p>
     * <p>
     * Note that unlike {@link #getCON_()}, this method will not create any reps
     * if none are already present, so an empty list may be returned.
     * </p>
     * 
     */ 
    public java.util.List<CON_> getCON_All() throws HL7Exception {
    	return getAllAsList("CON_", CON_.class);
    } 

    /**
     * <p>
     * Inserts a specific repetition of CON_ (Consent Segment)
     * </p>
     * 
     *
     * @see AbstractGroup#insertRepetition(Structure, int) 
    ...
    /**
     * <p>
     * Removes a specific repetition of CON_ (Consent Segment)
     * </p>
     * 
     *
     * @see AbstractGroup#removeRepetition(String, int) 
