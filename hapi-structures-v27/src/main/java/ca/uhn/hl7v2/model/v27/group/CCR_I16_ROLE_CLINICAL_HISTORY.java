...
/**
 * <p>Represents a CCR_I16_ROLE_CLINICAL_HISTORY group structure (a Group object).
...
public class CCR_I16_ROLE_CLINICAL_HISTORY extends AbstractGroup {

    /** 
     * Creates a new CCR_I16_ROLE_CLINICAL_HISTORY group
     */
    public CCR_I16_ROLE_CLINICAL_HISTORY(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating CCR_I16_ROLE_CLINICAL_HISTORY - this is probably a bug in the source code generator.", e);
       }
    }
