...
public class EHC_E12 extends AbstractMessage  {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating EHC_E12 - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * 
     */ 
    public java.util.List<EHC_E12_REQUEST> getREQUESTAll() throws HL7Exception {
