 ...
 * <ul>
     ...
     * <li>OM1-31: Observations Required to Interpret this Observation (CWE) <b>optional </b>
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CWE.class, true, 1, 0, new Object[]{ getMessage() }, "Producer's Service/Test/Observation ID");
                                              this.add(ID.class, false, 0, 3, new Object[]{ getMessage(), new Integer(125) }, "Permitted Data Types");
                                  ...
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Other Service/Test/Observation IDs for the Observation");
                                  this.add(ST.class, true, 0, 0, new Object[]{ getMessage() }, "Other Names");
                                  this.add(ST.class, false, 1, 0, new Object[]{ getMessage() }, "Preferred Report Name for the Observation");
                                  this.add(ST.class, false, 1, 8, new Object[]{ getMessage() }, "Preferred Short Name or Mnemonic for the Observation");
                                  ...
                                  this.add(CWE.class, true, 1, 1, new Object[]{ getMessage() }, "Nature of Service/Test/Observation");
                                  ...
                                  this.add(NM.class, false, 1, 0, new Object[]{ getMessage() }, "Processing Time");
                                              this.add(ID.class, false, 0, 1, new Object[]{ getMessage(), new Integer(168) }, "Processing Priority");
                                              this.add(ID.class, false, 1, 1, new Object[]{ getMessage(), new Integer(169) }, "Reporting Priority");
                                  ...
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Observations Required to Interpret this Observation");
                                  this.add(TX.class, false, 1, 0, new Object[]{ getMessage() }, "Interpretation of Observations");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Contraindications to Observations");
                                  this.add(CWE.class, false, 0, 0, new Object[]{ getMessage() }, "Reflex Tests/Observations");
                                  this.add(TX.class, false, 1, 0, new Object[]{ getMessage() }, "Rules that Trigger Reflex Testing");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Fixed Canned Message");
                                  this.add(TX.class, false, 1, 0, new Object[]{ getMessage() }, "Patient Preparation");
