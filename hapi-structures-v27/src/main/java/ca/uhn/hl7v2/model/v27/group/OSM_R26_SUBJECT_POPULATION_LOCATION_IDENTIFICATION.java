...
/**
 * <p>Represents a OSM_R26_SUBJECT_POPULATION_LOCATION_IDENTIFICATION group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>3: OSM_R26_PATIENT_VISIT_OBSERVATION (a Group object) <b>optional repeating </b></li>
                         * <li>4: PID (Patient Identification) <b>optional  </b></li>
...
public class OSM_R26_SUBJECT_POPULATION_LOCATION_IDENTIFICATION extends AbstractGroup {
    ...
    public OSM_R26_PATIENT_VISIT_OBSERVATION getPATIENT_VISIT_OBSERVATION() { 
       OSM_R26_PATIENT_VISIT_OBSERVATION retVal = getTyped("PATIENT_VISIT_OBSERVATION", OSM_R26_PATIENT_VISIT_OBSERVATION.class);
       return retVal;
    }
    ...
    public OSM_R26_PATIENT_VISIT_OBSERVATION getPATIENT_VISIT_OBSERVATION(int rep) { 
       OSM_R26_PATIENT_VISIT_OBSERVATION retVal = getTyped("PATIENT_VISIT_OBSERVATION", rep, OSM_R26_PATIENT_VISIT_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<OSM_R26_PATIENT_VISIT_OBSERVATION> getPATIENT_VISIT_OBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("PATIENT_VISIT_OBSERVATION", OSM_R26_PATIENT_VISIT_OBSERVATION.class);
    } 
