...
/**
 * <p>Represents a CCI_I22_PATIENT_VISITS group structure (a Group object).
...
public class CCI_I22_PATIENT_VISITS extends AbstractGroup {

    /** 
     * Creates a new CCI_I22_PATIENT_VISITS group
     */
    public CCI_I22_PATIENT_VISITS(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating CCI_I22_PATIENT_VISITS - this is probably a bug in the source code generator.", e);
       }
    }
