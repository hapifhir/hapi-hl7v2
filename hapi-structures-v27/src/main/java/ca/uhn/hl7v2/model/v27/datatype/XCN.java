...
public class XCN extends AbstractComposite {
    ...
    private void init() {
        ...
        data[23] = new ST(getMessage());
        data[24] = new ID(getMessage(), 904);
    }
     ...
     * casting and handling an exception.
     */
    public NULLDT getXcn7_DegreeEgMD() {
       return getTyped(6, NULLDT.class);
    }
