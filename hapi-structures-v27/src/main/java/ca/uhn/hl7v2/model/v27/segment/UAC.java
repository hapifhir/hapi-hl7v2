...
public class UAC extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(CWE.class, true, 1, 0, new Object[]{ getMessage() }, "User Authentication Credential Type Code");
                                  this.add(ED.class, true, 1, 0, new Object[]{ getMessage() }, "User Authentication Credential");
       } catch(HL7Exception e) {
          log.error("Unexpected error creating UAC - this is probably a bug in the source code generator.", e);
       }
    }
