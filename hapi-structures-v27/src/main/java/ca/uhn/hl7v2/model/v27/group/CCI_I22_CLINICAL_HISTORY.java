...
/**
 * <p>Represents a CCI_I22_CLINICAL_HISTORY group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: ORC (Common Order) <b>  </b></li>
                         * <li>2: CCI_I22_CLINICAL_HISTORY_DETAIL (a Group object) <b>optional repeating </b></li>
                         * <li>3: CCI_I22_ROLE_CLINICAL_HISTORY (a Group object) <b>optional repeating </b></li>
...
public class CCI_I22_CLINICAL_HISTORY extends AbstractGroup {
     ...
     */
    public CCI_I22_CLINICAL_HISTORY(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CCI_I22_CLINICAL_HISTORY_DETAIL.class, false, true, false);
                                  this.add(CCI_I22_ROLE_CLINICAL_HISTORY.class, false, true, false);
    ...
    public CCI_I22_CLINICAL_HISTORY_DETAIL getCLINICAL_HISTORY_DETAIL() { 
       CCI_I22_CLINICAL_HISTORY_DETAIL retVal = getTyped("CLINICAL_HISTORY_DETAIL", CCI_I22_CLINICAL_HISTORY_DETAIL.class);
       return retVal;
    }
    ...
    public CCI_I22_CLINICAL_HISTORY_DETAIL getCLINICAL_HISTORY_DETAIL(int rep) { 
       CCI_I22_CLINICAL_HISTORY_DETAIL retVal = getTyped("CLINICAL_HISTORY_DETAIL", rep, CCI_I22_CLINICAL_HISTORY_DETAIL.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<CCI_I22_CLINICAL_HISTORY_DETAIL> getCLINICAL_HISTORY_DETAILAll() throws HL7Exception {
     ...
     */
    public void insertCLINICAL_HISTORY_DETAIL(CCI_I22_CLINICAL_HISTORY_DETAIL structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public CCI_I22_CLINICAL_HISTORY_DETAIL insertCLINICAL_HISTORY_DETAIL(int rep) throws HL7Exception { 
       return (CCI_I22_CLINICAL_HISTORY_DETAIL)super.insertRepetition("CLINICAL_HISTORY_DETAIL", rep);
    }
     ...
     */
    public CCI_I22_CLINICAL_HISTORY_DETAIL removeCLINICAL_HISTORY_DETAIL(int rep) throws HL7Exception { 
       return (CCI_I22_CLINICAL_HISTORY_DETAIL)super.removeRepetition("CLINICAL_HISTORY_DETAIL", rep);
    }
    ...
    public CCI_I22_ROLE_CLINICAL_HISTORY getROLE_CLINICAL_HISTORY() { 
       CCI_I22_ROLE_CLINICAL_HISTORY retVal = getTyped("ROLE_CLINICAL_HISTORY", CCI_I22_ROLE_CLINICAL_HISTORY.class);
       return retVal;
    }
    ...
    public CCI_I22_ROLE_CLINICAL_HISTORY getROLE_CLINICAL_HISTORY(int rep) { 
       CCI_I22_ROLE_CLINICAL_HISTORY retVal = getTyped("ROLE_CLINICAL_HISTORY", rep, CCI_I22_ROLE_CLINICAL_HISTORY.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<CCI_I22_ROLE_CLINICAL_HISTORY> getROLE_CLINICAL_HISTORYAll() throws HL7Exception {
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertROLE_CLINICAL_HISTORY(CCI_I22_ROLE_CLINICAL_HISTORY structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public CCI_I22_ROLE_CLINICAL_HISTORY insertROLE_CLINICAL_HISTORY(int rep) throws HL7Exception { 
       return (CCI_I22_ROLE_CLINICAL_HISTORY)super.insertRepetition("ROLE_CLINICAL_HISTORY", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public CCI_I22_ROLE_CLINICAL_HISTORY removeROLE_CLINICAL_HISTORY(int rep) throws HL7Exception { 
       return (CCI_I22_ROLE_CLINICAL_HISTORY)super.removeRepetition("ROLE_CLINICAL_HISTORY", rep);
    }
