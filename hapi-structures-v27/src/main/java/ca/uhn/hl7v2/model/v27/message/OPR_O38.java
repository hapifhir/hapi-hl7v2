...
/**
 * <p>Represents a OPR_O38 message structure (see chapter 4.4.17). This structure contains the 
...
public class OPR_O38 extends AbstractMessage  {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating OPR_O38 - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * 
     */ 
    public java.util.List<OPR_O38_RESPONSE> getRESPONSEAll() throws HL7Exception {
