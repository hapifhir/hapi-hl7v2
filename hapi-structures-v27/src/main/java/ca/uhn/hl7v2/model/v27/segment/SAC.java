 ...
 * <ul>
     ...
     * <li>SAC-6: Specimen Source (NULLDT) <b>optional </b>
...
public class SAC extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(EI.class, false, 1, 0, new Object[]{ getMessage() }, "External Accession Identifier");
                                  this.add(EI.class, false, 1, 0, new Object[]{ getMessage() }, "Accession Identifier");
                                  this.add(EI.class, false, 1, 0, new Object[]{ getMessage() }, "Container Identifier");
                                  this.add(EI.class, false, 1, 0, new Object[]{ getMessage() }, "Primary (Parent) Container Identifier");
                                  this.add(EI.class, false, 1, 0, new Object[]{ getMessage() }, "Equipment Container Identifier");
                                  this.add(NULLDT.class, false, 1, 0, new Object[]{ getMessage() }, "Specimen Source");
                                  this.add(DTM.class, false, 1, 0, new Object[]{ getMessage() }, "Registration Date/Time");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Container Status");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Carrier Type");
                                  this.add(EI.class, false, 1, 0, new Object[]{ getMessage() }, "Carrier Identifier");
                                  this.add(NA.class, false, 1, 0, new Object[]{ getMessage() }, "Position in Carrier");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Tray Type - SAC");
                                  this.add(EI.class, false, 1, 0, new Object[]{ getMessage() }, "Tray Identifier");
                                  this.add(NA.class, false, 1, 0, new Object[]{ getMessage() }, "Position in Tray");
                                  this.add(CWE.class, false, 0, 0, new Object[]{ getMessage() }, "Location");
                                  this.add(NM.class, false, 1, 0, new Object[]{ getMessage() }, "Container Height");
                                  this.add(NM.class, false, 1, 0, new Object[]{ getMessage() }, "Container Diameter");
                                  this.add(NM.class, false, 1, 0, new Object[]{ getMessage() }, "Barrier Delta");
                                  this.add(NM.class, false, 1, 0, new Object[]{ getMessage() }, "Bottom Delta");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Container Height/Diameter/Delta Units");
                                  this.add(NM.class, false, 1, 0, new Object[]{ getMessage() }, "Container Volume");
                                  this.add(NM.class, false, 1, 0, new Object[]{ getMessage() }, "Available Specimen Volume");
                                  this.add(NM.class, false, 1, 0, new Object[]{ getMessage() }, "Initial Specimen Volume");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Volume Units");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Separator Type");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Cap Type");
                                  this.add(CWE.class, false, 0, 0, new Object[]{ getMessage() }, "Additive");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Specimen Component");
                                  this.add(SN.class, false, 1, 0, new Object[]{ getMessage() }, "Dilution Factor");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Treatment");
                                  this.add(SN.class, false, 1, 0, new Object[]{ getMessage() }, "Temperature");
                                  this.add(NM.class, false, 1, 0, new Object[]{ getMessage() }, "Hemolysis Index");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Hemolysis Index Units");
                                  this.add(NM.class, false, 1, 0, new Object[]{ getMessage() }, "Lipemia Index");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Lipemia Index Units");
                                  this.add(NM.class, false, 1, 0, new Object[]{ getMessage() }, "Icterus Index");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Icterus Index Units");
                                  this.add(NM.class, false, 1, 0, new Object[]{ getMessage() }, "Fibrin Index");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Fibrin Index Units");
                                  this.add(CWE.class, false, 0, 0, new Object[]{ getMessage() }, "System Induced Contaminants");
                                  this.add(CWE.class, false, 0, 0, new Object[]{ getMessage() }, "Drug Interference");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Artificial Blood");
                                  this.add(CWE.class, false, 0, 0, new Object[]{ getMessage() }, "Special Handling Code");
                                  this.add(CWE.class, false, 0, 0, new Object[]{ getMessage() }, "Other Environmental Factors");
     ...
     * SAC-6: "Specimen Source" - creates it if necessary
     */
    public NULLDT getSac6_SpecimenSource() { 
		NULLDT retVal = this.getTypedField(6, 0);
		return retVal;
    }
