...
/**
 * <p>Represents a CQU_I19_ROLE_PROBLEM group structure (a Group object).
...
public class CQU_I19_ROLE_PROBLEM extends AbstractGroup {

    /** 
     * Creates a new CQU_I19_ROLE_PROBLEM group
     */
    public CQU_I19_ROLE_PROBLEM(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating CQU_I19_ROLE_PROBLEM - this is probably a bug in the source code generator.", e);
       }
    }
