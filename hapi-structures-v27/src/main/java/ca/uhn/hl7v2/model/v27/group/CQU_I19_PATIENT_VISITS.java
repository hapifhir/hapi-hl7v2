...
/**
 * <p>Represents a CQU_I19_PATIENT_VISITS group structure (a Group object).
...
public class CQU_I19_PATIENT_VISITS extends AbstractGroup {

    /** 
     * Creates a new CQU_I19_PATIENT_VISITS group
     */
    public CQU_I19_PATIENT_VISITS(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating CQU_I19_PATIENT_VISITS - this is probably a bug in the source code generator.", e);
       }
    }
