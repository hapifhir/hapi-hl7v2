...
public class OM5 extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CWE.class, false, 0, 0, new Object[]{ getMessage() }, "Test/Observations Included Within an Ordered Test Battery");
                                  this.add(ST.class, false, 1, 0, new Object[]{ getMessage() }, "Observation ID Suffixes");
