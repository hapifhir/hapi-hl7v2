...
/**
 * <p>Represents a CSU_C09_COMMON_ORDER group structure (a Group object).
...
public class CSU_C09_COMMON_ORDER extends AbstractGroup {

    /** 
     * Creates a new CSU_C09_COMMON_ORDER group
     */
    public CSU_C09_COMMON_ORDER(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating CSU_C09_COMMON_ORDER - this is probably a bug in the source code generator.", e);
       }
    }
