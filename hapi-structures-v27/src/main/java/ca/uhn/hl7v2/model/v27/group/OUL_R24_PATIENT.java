 ...
 * <ul>
                         ...
                         * <li>5: OUL_R24_PATIENT_OBSERVATION (a Group object) <b>optional repeating </b></li>
                         * <li>6: OUL_R24_VISIT (a Group object) <b>optional  </b></li>
 * </ul>
 */
...
public class OUL_R24_PATIENT extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(OUL_R24_PATIENT_OBSERVATION.class, false, true, false);
                                  this.add(OUL_R24_VISIT.class, false, false, false);
    ...
    public OUL_R24_PATIENT_OBSERVATION getPATIENT_OBSERVATION() { 
       OUL_R24_PATIENT_OBSERVATION retVal = getTyped("PATIENT_OBSERVATION", OUL_R24_PATIENT_OBSERVATION.class);
       return retVal;
    }
    ...
    public OUL_R24_PATIENT_OBSERVATION getPATIENT_OBSERVATION(int rep) { 
       OUL_R24_PATIENT_OBSERVATION retVal = getTyped("PATIENT_OBSERVATION", rep, OUL_R24_PATIENT_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<OUL_R24_PATIENT_OBSERVATION> getPATIENT_OBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("PATIENT_OBSERVATION", OUL_R24_PATIENT_OBSERVATION.class);
    } 
    ...
    public OUL_R24_PATIENT_OBSERVATION insertPATIENT_OBSERVATION(int rep) throws HL7Exception { 
       return (OUL_R24_PATIENT_OBSERVATION)super.insertRepetition("PATIENT_OBSERVATION", rep);
    }
    ...
    public OUL_R24_PATIENT_OBSERVATION removePATIENT_OBSERVATION(int rep) throws HL7Exception { 
       return (OUL_R24_PATIENT_OBSERVATION)super.removeRepetition("PATIENT_OBSERVATION", rep);
    }
