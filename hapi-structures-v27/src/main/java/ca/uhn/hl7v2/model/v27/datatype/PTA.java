 ...
 * <li>Policy Type (CWE)
 * <li>Amount Class (CWE)
 * <li>Money or Percentage Quantity (NULLDT)
...
public class PTA extends AbstractComposite {
     ...
     * casting and handling an exception.
     */
    public CWE getPta2_AmountClass() {
       return getTyped(1, CWE.class);
    }
     ...
     * casting and handling an exception.
     */
    public NULLDT getMoneyOrPercentageQuantity() {
     ...
     * casting and handling an exception.
     */
    public NULLDT getPta3_MoneyOrPercentageQuantity() {
       return getTyped(2, NULLDT.class);
    }
