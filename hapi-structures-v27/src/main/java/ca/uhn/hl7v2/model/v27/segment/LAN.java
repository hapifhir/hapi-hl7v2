...
public class LAN extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(SI.class, true, 1, 4, new Object[]{ getMessage() }, "Set ID - LAN");
                                  this.add(CWE.class, true, 1, 0, new Object[]{ getMessage() }, "Language Code");
                                  this.add(CWE.class, false, 0, 0, new Object[]{ getMessage() }, "Language Ability Code");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Language Proficiency Code");
