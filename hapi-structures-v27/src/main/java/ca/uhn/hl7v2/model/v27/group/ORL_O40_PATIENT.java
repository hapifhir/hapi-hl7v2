...
/**
 * <p>Represents a ORL_O40_PATIENT group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>3: ORL_O40_ORDER (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class ORL_O40_PATIENT extends AbstractGroup {

    /** 
     * Creates a new ORL_O40_PATIENT group
     */
    public ORL_O40_PATIENT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(ORL_O40_ORDER.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating ORL_O40_PATIENT - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public ORL_O40_ORDER getORDER() { 
       ORL_O40_ORDER retVal = getTyped("ORDER", ORL_O40_ORDER.class);
       return retVal;
    }
    ...
    public ORL_O40_ORDER getORDER(int rep) { 
       ORL_O40_ORDER retVal = getTyped("ORDER", rep, ORL_O40_ORDER.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<ORL_O40_ORDER> getORDERAll() throws HL7Exception {
    	return getAllAsList("ORDER", ORL_O40_ORDER.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertORDER(ORL_O40_ORDER structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public ORL_O40_ORDER insertORDER(int rep) throws HL7Exception { 
       return (ORL_O40_ORDER)super.insertRepetition("ORDER", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public ORL_O40_ORDER removeORDER(int rep) throws HL7Exception { 
       return (ORL_O40_ORDER)super.removeRepetition("ORDER", rep);
    }
