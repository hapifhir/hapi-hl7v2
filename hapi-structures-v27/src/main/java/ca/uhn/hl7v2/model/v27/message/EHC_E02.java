...
public class EHC_E02 extends AbstractMessage  {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating EHC_E02 - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * 
     */ 
    public java.util.List<EHC_E02_PRODUCT_SERVICE_SECTION> getPRODUCT_SERVICE_SECTIONAll() throws HL7Exception {
