...
/**
 * <p>Represents a CCI_I22_INSURANCE group structure (a Group object).
...
public class CCI_I22_INSURANCE extends AbstractGroup {

    /** 
     * Creates a new CCI_I22_INSURANCE group
     */
    public CCI_I22_INSURANCE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating CCI_I22_INSURANCE - this is probably a bug in the source code generator.", e);
       }
    }
