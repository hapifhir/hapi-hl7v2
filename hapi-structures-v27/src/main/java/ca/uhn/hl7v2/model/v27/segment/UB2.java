 ...
 * <ul>
     ...
     * <li>UB2-10: Uniform Billing 11 (State) (ST) <b>optional repeating</b>
     * <li>UB2-11: Uniform Billing 31 (National) (ST) <b>optional </b>
     * <li>UB2-12: Document Control Number (ST) <b>optional repeating</b>
     * <li>UB2-13: Uniform Billing 49 (National) (ST) <b>optional repeating</b>
     * <li>UB2-14: Uniform Billing 56 (State) (ST) <b>optional repeating</b>
     * <li>UB2-15: Uniform Billing 57 (National) (ST) <b>optional </b>
     * <li>UB2-16: Uniform Billing 78 (State) (ST) <b>optional repeating</b>
...
public class UB2 extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(UVC.class, false, 12, 0, new Object[]{ getMessage() }, "Value Amount & Code");
                                  ...
                                  this.add(ST.class, false, 2, 29, new Object[]{ getMessage() }, "Uniform Billing Locator 2 (State)");
                                  this.add(ST.class, false, 2, 12, new Object[]{ getMessage() }, "Uniform Billing 11 (State)");
                                  this.add(ST.class, false, 1, 5, new Object[]{ getMessage() }, "Uniform Billing 31 (National)");
                                  this.add(ST.class, false, 3, 23, new Object[]{ getMessage() }, "Document Control Number");
                                  this.add(ST.class, false, 23, 4, new Object[]{ getMessage() }, "Uniform Billing 49 (National)");
                                  this.add(ST.class, false, 5, 14, new Object[]{ getMessage() }, "Uniform Billing 56 (State)");
                                  this.add(ST.class, false, 1, 27, new Object[]{ getMessage() }, "Uniform Billing 57 (National)");
                                  this.add(ST.class, false, 2, 2, new Object[]{ getMessage() }, "Uniform Billing 78 (State)");
     ...
     * Returns all repetitions of Uniform Billing 11 (State) (UB2-10).
     */
    public ST[] getUb210_UniformBilling11State() {
    	ST[] retVal = this.getTypedField(10, new ST[0]);
    	return retVal;
    }
    ...
    /**
     * Returns a count of the current number of repetitions of Uniform Billing 11 (State) (UB2-10).
     * This method does not create a repetition, so if no repetitions have currently been defined or accessed,
     * it will return zero.
     */
    public int getUniformBilling11StateReps() {
    ...
    /**
     * Returns a specific repetition of
     * UB2-10: "Uniform Billing 11 (State)" - creates it if necessary
     *
     * @param rep The repetition index (0-indexed)
     */
     ...
     * @param rep The repetition index (0-indexed)
     */
    public ST getUb210_UniformBilling11State(int rep) { 
		ST retVal = this.getTypedField(10, rep);
		return retVal;
    }
     ...
     * it will return zero.
     */
    public int getUb210_UniformBilling11StateReps() {
    	return this.getReps(10);
    }
    ...
    /**
     * Inserts a repetition of
     * UB2-10: "Uniform Billing 11 (State)" at a specific index
     *
     * @param rep The repetition index (0-indexed)
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public ST insertUniformBilling11State(int rep) throws HL7Exception { 
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public ST insertUb210_UniformBilling11State(int rep) throws HL7Exception { 
        return (ST) super.insertRepetition(10, rep);
    }
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public ST removeUniformBilling11State(int rep) throws HL7Exception { 
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public ST removeUb210_UniformBilling11State(int rep) throws HL7Exception { 
        return (ST) super.removeRepetition(10, rep);
    }
    ...
    /**
     * Returns
     * UB2-11: "Uniform Billing 31 (National)" - creates it if necessary
     */
    public ST getUniformBilling31National() { 
     ...
     * UB2-11: "Uniform Billing 31 (National)" - creates it if necessary
     */
    public ST getUb211_UniformBilling31National() { 
		ST retVal = this.getTypedField(11, 0);
		return retVal;
    }
     ...
     * Returns all repetitions of Uniform Billing 49 (National) (UB2-13).
     */
    public ST[] getUb213_UniformBilling49National() {
    	ST[] retVal = this.getTypedField(13, new ST[0]);
    	return retVal;
    }
    ...
    /**
     * Returns a count of the current number of repetitions of Uniform Billing 49 (National) (UB2-13).
     * This method does not create a repetition, so if no repetitions have currently been defined or accessed,
     * it will return zero.
     */
    public int getUniformBilling49NationalReps() {
    ...
    /**
     * Returns a specific repetition of
     * UB2-13: "Uniform Billing 49 (National)" - creates it if necessary
     *
     * @param rep The repetition index (0-indexed)
     */
     ...
     * @param rep The repetition index (0-indexed)
     */
    public ST getUb213_UniformBilling49National(int rep) { 
		ST retVal = this.getTypedField(13, rep);
		return retVal;
    }
     ...
     * it will return zero.
     */
    public int getUb213_UniformBilling49NationalReps() {
    	return this.getReps(13);
    }
    ...
    /**
     * Inserts a repetition of
     * UB2-13: "Uniform Billing 49 (National)" at a specific index
     *
     * @param rep The repetition index (0-indexed)
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public ST insertUniformBilling49National(int rep) throws HL7Exception { 
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public ST insertUb213_UniformBilling49National(int rep) throws HL7Exception { 
        return (ST) super.insertRepetition(13, rep);
    }
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public ST removeUniformBilling49National(int rep) throws HL7Exception { 
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public ST removeUb213_UniformBilling49National(int rep) throws HL7Exception { 
        return (ST) super.removeRepetition(13, rep);
    }
     ...
     * Returns all repetitions of Uniform Billing 56 (State) (UB2-14).
     */
    public ST[] getUb214_UniformBilling56State() {
    	ST[] retVal = this.getTypedField(14, new ST[0]);
    	return retVal;
    }
    ...
    /**
     * Returns a count of the current number of repetitions of Uniform Billing 56 (State) (UB2-14).
     * This method does not create a repetition, so if no repetitions have currently been defined or accessed,
     * it will return zero.
     */
    public int getUniformBilling56StateReps() {
    ...
    /**
     * Returns a specific repetition of
     * UB2-14: "Uniform Billing 56 (State)" - creates it if necessary
     *
     * @param rep The repetition index (0-indexed)
     */
     ...
     * @param rep The repetition index (0-indexed)
     */
    public ST getUb214_UniformBilling56State(int rep) { 
		ST retVal = this.getTypedField(14, rep);
		return retVal;
    }
     ...
     * it will return zero.
     */
    public int getUb214_UniformBilling56StateReps() {
    	return this.getReps(14);
    }
    ...
    /**
     * Inserts a repetition of
     * UB2-14: "Uniform Billing 56 (State)" at a specific index
     *
     * @param rep The repetition index (0-indexed)
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public ST insertUniformBilling56State(int rep) throws HL7Exception { 
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public ST insertUb214_UniformBilling56State(int rep) throws HL7Exception { 
        return (ST) super.insertRepetition(14, rep);
    }
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public ST removeUniformBilling56State(int rep) throws HL7Exception { 
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public ST removeUb214_UniformBilling56State(int rep) throws HL7Exception { 
        return (ST) super.removeRepetition(14, rep);
    }
    ...
    /**
     * Returns
     * UB2-15: "Uniform Billing 57 (National)" - creates it if necessary
     */
    public ST getUniformBilling57National() { 
     ...
     * UB2-15: "Uniform Billing 57 (National)" - creates it if necessary
     */
    public ST getUb215_UniformBilling57National() { 
		ST retVal = this.getTypedField(15, 0);
		return retVal;
    }
     ...
     * Returns all repetitions of Uniform Billing 78 (State) (UB2-16).
     */
    public ST[] getUb216_UniformBilling78State() {
    	ST[] retVal = this.getTypedField(16, new ST[0]);
    	return retVal;
    }
    ...
    /**
     * Returns a count of the current number of repetitions of Uniform Billing 78 (State) (UB2-16).
     * This method does not create a repetition, so if no repetitions have currently been defined or accessed,
     * it will return zero.
     */
    public int getUniformBilling78StateReps() {
    ...
    /**
     * Returns a specific repetition of
     * UB2-16: "Uniform Billing 78 (State)" - creates it if necessary
     *
     * @param rep The repetition index (0-indexed)
     */
     ...
     * @param rep The repetition index (0-indexed)
     */
    public ST getUb216_UniformBilling78State(int rep) { 
		ST retVal = this.getTypedField(16, rep);
		return retVal;
    }
     ...
     * it will return zero.
     */
    public int getUb216_UniformBilling78StateReps() {
    	return this.getReps(16);
    }
    ...
    /**
     * Inserts a repetition of
     * UB2-16: "Uniform Billing 78 (State)" at a specific index
     *
     * @param rep The repetition index (0-indexed)
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public ST insertUniformBilling78State(int rep) throws HL7Exception { 
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public ST insertUb216_UniformBilling78State(int rep) throws HL7Exception { 
        return (ST) super.insertRepetition(16, rep);
    }
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public ST removeUniformBilling78State(int rep) throws HL7Exception { 
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public ST removeUb216_UniformBilling78State(int rep) throws HL7Exception { 
        return (ST) super.removeRepetition(16, rep);
    }
