 ...
 * <ul>
                         ...
                         * <li>2: RDR_RDR_TIMING (a Group object) <b>optional repeating </b></li>
                         * <li>3: RDR_RDR_ENCODING (a Group object) <b>optional  </b></li>
                         * <li>4: RDR_RDR_DISPENSE (a Group object) <b> repeating </b></li>
 * </ul>
 */
...
public class RDR_RDR_ORDER extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(RDR_RDR_TIMING.class, false, true, false);
                                  this.add(RDR_RDR_ENCODING.class, false, false, false);
                                  this.add(RDR_RDR_DISPENSE.class, true, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating RDR_RDR_ORDER - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public RDR_RDR_TIMING getTIMING() { 
       RDR_RDR_TIMING retVal = getTyped("TIMING", RDR_RDR_TIMING.class);
       return retVal;
    }
    ...
    public RDR_RDR_TIMING getTIMING(int rep) { 
       RDR_RDR_TIMING retVal = getTyped("TIMING", rep, RDR_RDR_TIMING.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<RDR_RDR_TIMING> getTIMINGAll() throws HL7Exception {
    	return getAllAsList("TIMING", RDR_RDR_TIMING.class);
    } 
     ...
     */
    public void insertTIMING(RDR_RDR_TIMING structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public RDR_RDR_TIMING insertTIMING(int rep) throws HL7Exception { 
       return (RDR_RDR_TIMING)super.insertRepetition("TIMING", rep);
    }
     ...
     */
    public RDR_RDR_TIMING removeTIMING(int rep) throws HL7Exception { 
       return (RDR_RDR_TIMING)super.removeRepetition("TIMING", rep);
    }
     ...
     * </p>
     */ 
    public java.util.List<RDR_RDR_DISPENSE> getDISPENSEAll() throws HL7Exception {
