...
/**
 * <p>Represents a OMP_O09_ADDITIONAL_DEMOGRAPHICS group structure (a Group object).
...
public class OMP_O09_ADDITIONAL_DEMOGRAPHICS extends AbstractGroup {

    /** 
     * Creates a new OMP_O09_ADDITIONAL_DEMOGRAPHICS group
     */
    public OMP_O09_ADDITIONAL_DEMOGRAPHICS(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating OMP_O09_ADDITIONAL_DEMOGRAPHICS - this is probably a bug in the source code generator.", e);
       }
    }
