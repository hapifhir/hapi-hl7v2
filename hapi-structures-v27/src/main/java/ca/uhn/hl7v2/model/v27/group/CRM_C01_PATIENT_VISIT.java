...
/**
 * <p>Represents a CRM_C01_PATIENT_VISIT group structure (a Group object).
...
public class CRM_C01_PATIENT_VISIT extends AbstractGroup {

    /** 
     * Creates a new CRM_C01_PATIENT_VISIT group
     */
    public CRM_C01_PATIENT_VISIT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating CRM_C01_PATIENT_VISIT - this is probably a bug in the source code generator.", e);
       }
    }
