...
/**
 * <p>Represents a RSP_K11 message structure (see chapter 5.3.1.1). This structure contains the 
 ...
 * <ul>
		                 ...
		                 * <li>8: RSP_K11_SEGMENT_PATTERN (a Group object) <b>optional </b> </li>
...
public class RSP_K11 extends AbstractMessage  {
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(RSP_K11_SEGMENT_PATTERN.class, false, false);
     ...
     * <p>
     * Returns
     * SEGMENT_PATTERN (a Group object) - creates it if necessary
     * </p>
     * 
     *
     */
    public RSP_K11_SEGMENT_PATTERN getSEGMENT_PATTERN() { 
       return getTyped("SEGMENT_PATTERN", RSP_K11_SEGMENT_PATTERN.class);
    }
