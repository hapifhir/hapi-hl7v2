...
/**
 * <p>Represents a CCM_I21_PATIENT_VISITS group structure (a Group object).
...
public class CCM_I21_PATIENT_VISITS extends AbstractGroup {

    /** 
     * Creates a new CCM_I21_PATIENT_VISITS group
     */
    public CCM_I21_PATIENT_VISITS(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating CCM_I21_PATIENT_VISITS - this is probably a bug in the source code generator.", e);
       }
    }
