...
/**
 * <p>Represents a CCR_I16_INSURANCE group structure (a Group object).
...
public class CCR_I16_INSURANCE extends AbstractGroup {

    /** 
     * Creates a new CCR_I16_INSURANCE group
     */
    public CCR_I16_INSURANCE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating CCR_I16_INSURANCE - this is probably a bug in the source code generator.", e);
       }
    }
