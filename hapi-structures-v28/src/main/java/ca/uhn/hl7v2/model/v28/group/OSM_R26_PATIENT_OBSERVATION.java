...
/**
 * <p>Represents a OSM_R26_PATIENT_OBSERVATION group structure (a Group object).
...
public class OSM_R26_PATIENT_OBSERVATION extends AbstractGroup {

    /** 
     * Creates a new OSM_R26_PATIENT_OBSERVATION group
     */
    public OSM_R26_PATIENT_OBSERVATION(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating OSM_R26_PATIENT_OBSERVATION - this is probably a bug in the source code generator.", e);
       }
    }
