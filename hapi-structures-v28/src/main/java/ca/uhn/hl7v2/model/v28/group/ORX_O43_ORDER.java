...
/**
 * <p>Represents a ORX_O43_ORDER group structure (a Group object).
...
public class ORX_O43_ORDER extends AbstractGroup {

    /** 
     * Creates a new ORX_O43_ORDER group
     */
    public ORX_O43_ORDER(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ORX_O43_ORDER - this is probably a bug in the source code generator.", e);
       }
    }
