...
/**
 * <p>Represents a OSU_O41_ORDER_STATUS group structure (a Group object).
...
public class OSU_O41_ORDER_STATUS extends AbstractGroup {

    /** 
     * Creates a new OSU_O41_ORDER_STATUS group
     */
    public OSU_O41_ORDER_STATUS(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating OSU_O41_ORDER_STATUS - this is probably a bug in the source code generator.", e);
       }
    }
