...
/**
 * <p>Represents a CQU_I19_CLINICAL_HISTORY_DETAIL group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>13: CQU_I19_CLINICAL_HISTORY_OBSERVATION (a Group object) <b>optional repeating </b></li>
 * </ul>
 * <p>
...
public class CQU_I19_CLINICAL_HISTORY_DETAIL extends AbstractGroup {

    /** 
     * Creates a new CQU_I19_CLINICAL_HISTORY_DETAIL group
     */
    public CQU_I19_CLINICAL_HISTORY_DETAIL(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CQU_I19_CLINICAL_HISTORY_OBSERVATION.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating CQU_I19_CLINICAL_HISTORY_DETAIL - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public CQU_I19_CLINICAL_HISTORY_OBSERVATION getCLINICAL_HISTORY_OBSERVATION() { 
       CQU_I19_CLINICAL_HISTORY_OBSERVATION retVal = getTyped("CLINICAL_HISTORY_OBSERVATION", CQU_I19_CLINICAL_HISTORY_OBSERVATION.class);
       return retVal;
    }
    ...
    public CQU_I19_CLINICAL_HISTORY_OBSERVATION getCLINICAL_HISTORY_OBSERVATION(int rep) { 
       CQU_I19_CLINICAL_HISTORY_OBSERVATION retVal = getTyped("CLINICAL_HISTORY_OBSERVATION", rep, CQU_I19_CLINICAL_HISTORY_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<CQU_I19_CLINICAL_HISTORY_OBSERVATION> getCLINICAL_HISTORY_OBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("CLINICAL_HISTORY_OBSERVATION", CQU_I19_CLINICAL_HISTORY_OBSERVATION.class);
    } 
     ...
     */
    public void insertCLINICAL_HISTORY_OBSERVATION(CQU_I19_CLINICAL_HISTORY_OBSERVATION structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public CQU_I19_CLINICAL_HISTORY_OBSERVATION insertCLINICAL_HISTORY_OBSERVATION(int rep) throws HL7Exception { 
       return (CQU_I19_CLINICAL_HISTORY_OBSERVATION)super.insertRepetition("CLINICAL_HISTORY_OBSERVATION", rep);
    }
     ...
     */
    public CQU_I19_CLINICAL_HISTORY_OBSERVATION removeCLINICAL_HISTORY_OBSERVATION(int rep) throws HL7Exception { 
       return (CQU_I19_CLINICAL_HISTORY_OBSERVATION)super.removeRepetition("CLINICAL_HISTORY_OBSERVATION", rep);
    }
