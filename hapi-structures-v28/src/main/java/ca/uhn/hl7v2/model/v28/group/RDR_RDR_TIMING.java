...
/**
 * <p>Represents a RDR_RDR_TIMING group structure (a Group object).
...
public class RDR_RDR_TIMING extends AbstractGroup {

    /** 
     * Creates a new RDR_RDR_TIMING group
     */
    public RDR_RDR_TIMING(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RDR_RDR_TIMING - this is probably a bug in the source code generator.", e);
       }
    }
