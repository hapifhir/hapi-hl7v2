...
/**
 * <p>Represents a OML_O39_PATIENT group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>7: OML_O39_PATIENT_VISIT (a Group object) <b>optional  </b></li>
                         * <li>8: OML_O39_INSURANCE (a Group object) <b>optional repeating </b></li>
                         * <li>9: GT1 (Guarantor) <b>optional  </b></li>
                         * <li>10: AL1 (Patient Allergy Information) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class OML_O39_PATIENT extends AbstractGroup {

    /** 
     * Creates a new OML_O39_PATIENT group
     */
    public OML_O39_PATIENT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(OML_O39_PATIENT_VISIT.class, false, false, false);
                                  this.add(OML_O39_INSURANCE.class, false, true, false);
                                  this.add(GT1.class, false, false, false);
                                  this.add(AL1.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating OML_O39_PATIENT - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     */
    public OML_O39_PATIENT_VISIT getPATIENT_VISIT() { 
       OML_O39_PATIENT_VISIT retVal = getTyped("PATIENT_VISIT", OML_O39_PATIENT_VISIT.class);
       return retVal;
    }
    ...
    public OML_O39_INSURANCE getINSURANCE() { 
       OML_O39_INSURANCE retVal = getTyped("INSURANCE", OML_O39_INSURANCE.class);
       return retVal;
    }
    ...
    public OML_O39_INSURANCE getINSURANCE(int rep) { 
       OML_O39_INSURANCE retVal = getTyped("INSURANCE", rep, OML_O39_INSURANCE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<OML_O39_INSURANCE> getINSURANCEAll() throws HL7Exception {
    	return getAllAsList("INSURANCE", OML_O39_INSURANCE.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertINSURANCE(OML_O39_INSURANCE structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public OML_O39_INSURANCE insertINSURANCE(int rep) throws HL7Exception { 
       return (OML_O39_INSURANCE)super.insertRepetition("INSURANCE", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public OML_O39_INSURANCE removeINSURANCE(int rep) throws HL7Exception { 
       return (OML_O39_INSURANCE)super.removeRepetition("INSURANCE", rep);
    }
