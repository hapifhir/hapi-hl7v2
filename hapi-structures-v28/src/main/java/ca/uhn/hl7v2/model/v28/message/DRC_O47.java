 ...
 * <ul>
		                 ...
		                 * <li>5: DRC_O47_DONATION_ORDER (a Group object) <b> repeating</b> </li>
 * </ul>
 */
...
public class DRC_O47 extends AbstractMessage  {
    ...
    public DRC_O47_DONATION_ORDER getDONATION_ORDER() { 
       return getTyped("DONATION_ORDER", DRC_O47_DONATION_ORDER.class);
    }
    ...
    public DRC_O47_DONATION_ORDER getDONATION_ORDER(int rep) { 
       return getTyped("DONATION_ORDER", rep, DRC_O47_DONATION_ORDER.class);
    }
     ...
     * 
     */ 
    public java.util.List<DRC_O47_DONATION_ORDER> getDONATION_ORDERAll() throws HL7Exception {
    	return getAllAsList("DONATION_ORDER", DRC_O47_DONATION_ORDER.class);
    } 
