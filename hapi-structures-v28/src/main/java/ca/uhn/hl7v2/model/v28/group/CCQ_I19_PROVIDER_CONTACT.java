...
/**
 * <p>Represents a CCQ_I19_PROVIDER_CONTACT group structure (a Group object).
...
public class CCQ_I19_PROVIDER_CONTACT extends AbstractGroup {

    /** 
     * Creates a new CCQ_I19_PROVIDER_CONTACT group
     */
    public CCQ_I19_PROVIDER_CONTACT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating CCQ_I19_PROVIDER_CONTACT - this is probably a bug in the source code generator.", e);
       }
    }
