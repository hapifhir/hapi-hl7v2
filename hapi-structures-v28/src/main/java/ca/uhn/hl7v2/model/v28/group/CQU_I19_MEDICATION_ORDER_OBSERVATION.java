...
/**
 * <p>Represents a CQU_I19_MEDICATION_ORDER_OBSERVATION group structure (a Group object).
...
public class CQU_I19_MEDICATION_ORDER_OBSERVATION extends AbstractGroup {

    /** 
     * Creates a new CQU_I19_MEDICATION_ORDER_OBSERVATION group
     */
    public CQU_I19_MEDICATION_ORDER_OBSERVATION(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating CQU_I19_MEDICATION_ORDER_OBSERVATION - this is probably a bug in the source code generator.", e);
       }
    }
