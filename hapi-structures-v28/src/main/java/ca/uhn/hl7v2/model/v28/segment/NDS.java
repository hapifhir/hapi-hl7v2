...
public class NDS extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(NM.class, true, 1, 0, new Object[]{ getMessage() }, "Notification Reference Number");
                                  this.add(DTM.class, true, 1, 0, new Object[]{ getMessage() }, "Notification Date/Time");
                                  this.add(CWE.class, true, 1, 0, new Object[]{ getMessage() }, "Notification Alert Severity");
                                  this.add(CWE.class, true, 1, 0, new Object[]{ getMessage() }, "Notification Code");
