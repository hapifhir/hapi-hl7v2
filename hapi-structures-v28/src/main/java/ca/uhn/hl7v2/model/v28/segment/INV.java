 ...
 * <ul>
     ...
     * <li>INV-14: On Board Stability Duration (NULLDT) <b>optional </b>
...
public class INV extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(CWE.class, true, 1, 0, new Object[]{ getMessage() }, "Substance Identifier");
                                  this.add(CWE.class, true, 0, 0, new Object[]{ getMessage() }, "Substance Status");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Substance Type");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Inventory Container Identifier");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Container Carrier Identifier");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Position on Carrier");
                                  this.add(NM.class, false, 1, 0, new Object[]{ getMessage() }, "Initial Quantity");
                                  this.add(NM.class, false, 1, 0, new Object[]{ getMessage() }, "Current Quantity");
                                  this.add(NM.class, false, 1, 0, new Object[]{ getMessage() }, "Available Quantity");
                                  this.add(NM.class, false, 1, 0, new Object[]{ getMessage() }, "Consumption Quantity");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Quantity Units");
                                  this.add(DTM.class, false, 1, 0, new Object[]{ getMessage() }, "Expiration Date/Time");
                                  this.add(DTM.class, false, 1, 0, new Object[]{ getMessage() }, "First Used Date/Time");
                                  this.add(NULLDT.class, false, 1, 0, new Object[]{ getMessage() }, "On Board Stability Duration");
                                  this.add(CWE.class, false, 0, 0, new Object[]{ getMessage() }, "Test/Fluid Identifier(s)");
                                  this.add(ST.class, false, 1, 0, new Object[]{ getMessage() }, "Manufacturer Lot Number");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Manufacturer Identifier");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Supplier Identifier");
                                  this.add(CQ.class, false, 1, 0, new Object[]{ getMessage() }, "On Board Stability Time");
                                  this.add(CQ.class, false, 1, 0, new Object[]{ getMessage() }, "Target Value");
