...
/**
 * <p>Represents a ORU_R01_COMMON_ORDER group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>3: ORU_R01_ORDER_DOCUMENT (a Group object) <b>optional  </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class ORU_R01_COMMON_ORDER extends AbstractGroup {

    /** 
     * Creates a new ORU_R01_COMMON_ORDER group
     */
    public ORU_R01_COMMON_ORDER(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(ORU_R01_ORDER_DOCUMENT.class, false, false, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating ORU_R01_COMMON_ORDER - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     */
    public ORU_R01_ORDER_DOCUMENT getORDER_DOCUMENT() { 
       ORU_R01_ORDER_DOCUMENT retVal = getTyped("ORDER_DOCUMENT", ORU_R01_ORDER_DOCUMENT.class);
       return retVal;
    }
