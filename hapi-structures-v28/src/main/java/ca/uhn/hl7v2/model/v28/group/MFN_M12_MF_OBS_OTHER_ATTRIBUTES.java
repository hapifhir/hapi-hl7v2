...
/**
 * <p>Represents a MFN_M12_MF_OBS_OTHER_ATTRIBUTES group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: OM7 (Additional Basic Attributes) <b>  </b></li>
                         * <li>2: PRT (Participation Information) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class MFN_M12_MF_OBS_OTHER_ATTRIBUTES extends AbstractGroup {

    /** 
     * Creates a new MFN_M12_MF_OBS_OTHER_ATTRIBUTES group
     */
    public MFN_M12_MF_OBS_OTHER_ATTRIBUTES(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(OM7.class, true, false, false);
                                  this.add(PRT.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating MFN_M12_MF_OBS_OTHER_ATTRIBUTES - this is probably a bug in the source code generator.", e);
       }
    }
