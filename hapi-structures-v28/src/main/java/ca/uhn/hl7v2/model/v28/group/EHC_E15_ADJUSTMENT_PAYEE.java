 ...
 * <ul>
                         ...
                         * <li>2: PRT (Participation Information) <b>optional  </b></li>
                         * <li>3: ROL (Role) <b>optional  </b></li>
 * </ul>
 */
...
public class EHC_E15_ADJUSTMENT_PAYEE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(ADJ.class, true, false, false);
                                  this.add(PRT.class, false, false, false);
                                  this.add(ROL.class, false, false, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating EHC_E15_ADJUSTMENT_PAYEE - this is probably a bug in the source code generator.", e);
       }
    }
