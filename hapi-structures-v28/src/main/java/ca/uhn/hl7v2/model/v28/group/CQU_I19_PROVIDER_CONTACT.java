...
/**
 * <p>Represents a CQU_I19_PROVIDER_CONTACT group structure (a Group object).
...
public class CQU_I19_PROVIDER_CONTACT extends AbstractGroup {

    /** 
     * Creates a new CQU_I19_PROVIDER_CONTACT group
     */
    public CQU_I19_PROVIDER_CONTACT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating CQU_I19_PROVIDER_CONTACT - this is probably a bug in the source code generator.", e);
       }
    }
