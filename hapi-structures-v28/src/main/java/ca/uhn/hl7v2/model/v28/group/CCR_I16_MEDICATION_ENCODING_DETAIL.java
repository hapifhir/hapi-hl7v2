...
/**
 * <p>Represents a CCR_I16_MEDICATION_ENCODING_DETAIL group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>4: CCR_I16_MEDICATION_ENCODING_OBSERVATION (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class CCR_I16_MEDICATION_ENCODING_DETAIL extends AbstractGroup {

    /** 
     * Creates a new CCR_I16_MEDICATION_ENCODING_DETAIL group
     */
    public CCR_I16_MEDICATION_ENCODING_DETAIL(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CCR_I16_MEDICATION_ENCODING_OBSERVATION.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating CCR_I16_MEDICATION_ENCODING_DETAIL - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * Returns
     * the first repetition of 
     * MEDICATION_ENCODING_OBSERVATION (a Group object) - creates it if necessary
     */
    public CCR_I16_MEDICATION_ENCODING_OBSERVATION getMEDICATION_ENCODING_OBSERVATION() { 
       CCR_I16_MEDICATION_ENCODING_OBSERVATION retVal = getTyped("MEDICATION_ENCODING_OBSERVATION", CCR_I16_MEDICATION_ENCODING_OBSERVATION.class);
       return retVal;
    }
    ...
    public CCR_I16_MEDICATION_ENCODING_OBSERVATION getMEDICATION_ENCODING_OBSERVATION(int rep) { 
       CCR_I16_MEDICATION_ENCODING_OBSERVATION retVal = getTyped("MEDICATION_ENCODING_OBSERVATION", rep, CCR_I16_MEDICATION_ENCODING_OBSERVATION.class);
       return retVal;
    }

    /** 
     * Returns the number of existing repetitions of MEDICATION_ENCODING_OBSERVATION 
     */ 
    public int getMEDICATION_ENCODING_OBSERVATIONReps() {  
        return getReps("MEDICATION_ENCODING_OBSERVATION");
    } 

    /** 
     * <p>
     * Returns a non-modifiable List containing all current existing repetitions of MEDICATION_ENCODING_OBSERVATION.
     * <p>
     * <p>
     * Note that unlike {@link #getMEDICATION_ENCODING_OBSERVATION()}, this method will not create any reps
     * if none are already present, so an empty list may be returned.
     * </p>
     */ 
    public java.util.List<CCR_I16_MEDICATION_ENCODING_OBSERVATION> getMEDICATION_ENCODING_OBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("MEDICATION_ENCODING_OBSERVATION", CCR_I16_MEDICATION_ENCODING_OBSERVATION.class);
    } 

    /**
     * Inserts a specific repetition of MEDICATION_ENCODING_OBSERVATION (a Group object)
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertMEDICATION_ENCODING_OBSERVATION(CCR_I16_MEDICATION_ENCODING_OBSERVATION structure, int rep) throws HL7Exception { 
       super.insertRepetition("MEDICATION_ENCODING_OBSERVATION", structure, rep);
    }
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public CCR_I16_MEDICATION_ENCODING_OBSERVATION insertMEDICATION_ENCODING_OBSERVATION(int rep) throws HL7Exception { 
       return (CCR_I16_MEDICATION_ENCODING_OBSERVATION)super.insertRepetition("MEDICATION_ENCODING_OBSERVATION", rep);
    }


    /**
     * Removes a specific repetition of MEDICATION_ENCODING_OBSERVATION (a Group object)
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public CCR_I16_MEDICATION_ENCODING_OBSERVATION removeMEDICATION_ENCODING_OBSERVATION(int rep) throws HL7Exception { 
       return (CCR_I16_MEDICATION_ENCODING_OBSERVATION)super.removeRepetition("MEDICATION_ENCODING_OBSERVATION", rep);
    }
