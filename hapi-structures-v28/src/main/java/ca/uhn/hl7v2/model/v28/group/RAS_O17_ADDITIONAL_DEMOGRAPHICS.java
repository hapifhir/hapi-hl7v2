...
/**
 * <p>Represents a RAS_O17_ADDITIONAL_DEMOGRAPHICS group structure (a Group object).
...
public class RAS_O17_ADDITIONAL_DEMOGRAPHICS extends AbstractGroup {

    /** 
     * Creates a new RAS_O17_ADDITIONAL_DEMOGRAPHICS group
     */
    public RAS_O17_ADDITIONAL_DEMOGRAPHICS(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RAS_O17_ADDITIONAL_DEMOGRAPHICS - this is probably a bug in the source code generator.", e);
       }
    }
