    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Modality of Imaging Measurement");
                                              this.add(ID.class, false, 1, 1, new Object[]{ getMessage(), new Integer(919) }, "Exclusive Test");
                                              this.add(ID.class, false, 1, 3, new Object[]{ getMessage(), new Integer(74) }, "Diagnostic Serv Sect ID");
