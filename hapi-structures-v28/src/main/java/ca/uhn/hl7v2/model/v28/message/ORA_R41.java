...
/**
 * <p>Represents a ORA_R41 message structure (see chapter 7.3.13). This structure contains the 
...
public class ORA_R41 extends AbstractMessage  {

    /**
     * Creates a new ORA_R41 message with DefaultModelClassFactory. 
     */ 
    public ORA_R41() { 
    ...
    /** 
     * Creates a new ORA_R41 message with custom ModelClassFactory.
     */
    public ORA_R41(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ORA_R41 - this is probably a bug in the source code generator.", e);
       }
    }
