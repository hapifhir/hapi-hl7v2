...
/**
 * <p>Represents a CQU_I19_PROBLEM group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>3: CQU_I19_ROLE_PROBLEM (a Group object) <b>optional repeating </b></li>
                         * <li>4: CQU_I19_PROBLEM_OBSERVATION (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class CQU_I19_PROBLEM extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CQU_I19_PROBLEM_OBSERVATION.class, false, true, false);
    ...
    public CQU_I19_ROLE_PROBLEM getROLE_PROBLEM() { 
       CQU_I19_ROLE_PROBLEM retVal = getTyped("ROLE_PROBLEM", CQU_I19_ROLE_PROBLEM.class);
       return retVal;
    }
    ...
    public CQU_I19_ROLE_PROBLEM getROLE_PROBLEM(int rep) { 
       CQU_I19_ROLE_PROBLEM retVal = getTyped("ROLE_PROBLEM", rep, CQU_I19_ROLE_PROBLEM.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<CQU_I19_ROLE_PROBLEM> getROLE_PROBLEMAll() throws HL7Exception {
    	return getAllAsList("ROLE_PROBLEM", CQU_I19_ROLE_PROBLEM.class);
    } 
    ...
    public CQU_I19_PROBLEM_OBSERVATION getPROBLEM_OBSERVATION() { 
       CQU_I19_PROBLEM_OBSERVATION retVal = getTyped("PROBLEM_OBSERVATION", CQU_I19_PROBLEM_OBSERVATION.class);
       return retVal;
    }
    ...
    public CQU_I19_PROBLEM_OBSERVATION getPROBLEM_OBSERVATION(int rep) { 
       CQU_I19_PROBLEM_OBSERVATION retVal = getTyped("PROBLEM_OBSERVATION", rep, CQU_I19_PROBLEM_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<CQU_I19_PROBLEM_OBSERVATION> getPROBLEM_OBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("PROBLEM_OBSERVATION", CQU_I19_PROBLEM_OBSERVATION.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertPROBLEM_OBSERVATION(CQU_I19_PROBLEM_OBSERVATION structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public CQU_I19_PROBLEM_OBSERVATION insertPROBLEM_OBSERVATION(int rep) throws HL7Exception { 
       return (CQU_I19_PROBLEM_OBSERVATION)super.insertRepetition("PROBLEM_OBSERVATION", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public CQU_I19_PROBLEM_OBSERVATION removePROBLEM_OBSERVATION(int rep) throws HL7Exception { 
       return (CQU_I19_PROBLEM_OBSERVATION)super.removeRepetition("PROBLEM_OBSERVATION", rep);
    }
