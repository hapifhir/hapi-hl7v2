...
/**
 * <p>Represents a CQU_I19_INSURANCE group structure (a Group object).
...
public class CQU_I19_INSURANCE extends AbstractGroup {

    /** 
     * Creates a new CQU_I19_INSURANCE group
     */
    public CQU_I19_INSURANCE(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating CQU_I19_INSURANCE - this is probably a bug in the source code generator.", e);
       }
    }
