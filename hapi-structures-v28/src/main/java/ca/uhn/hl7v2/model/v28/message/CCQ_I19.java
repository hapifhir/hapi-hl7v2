...
/**
 * <p>Represents a CCQ_I19 message structure (see chapter 11.7.1). This structure contains the 
 ...
 * <ul>
		                 ...
		                 * <li>5: CCQ_I19_PROVIDER_CONTACT (a Group object) <b>optional repeating</b> </li>
		                 * <li>6: REL (Clinical Relationship Segment) <b>optional repeating</b> </li>
 * </ul>
 */
...
public class CCQ_I19 extends AbstractMessage  {
    ...
    /**
     * Creates a new CCQ_I19 message with DefaultModelClassFactory. 
     */ 
    public CCQ_I19() { 
    ...
    /** 
     * Creates a new CCQ_I19 message with custom ModelClassFactory.
     */
    ...
    public CCQ_I19_PROVIDER_CONTACT getPROVIDER_CONTACT(int rep) { 
       return getTyped("PROVIDER_CONTACT", rep, CCQ_I19_PROVIDER_CONTACT.class);
    }
     ...
     * 
     */ 
    public java.util.List<CCQ_I19_PROVIDER_CONTACT> getPROVIDER_CONTACTAll() throws HL7Exception {
