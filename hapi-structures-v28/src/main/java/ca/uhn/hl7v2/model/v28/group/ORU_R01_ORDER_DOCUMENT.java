...
/**
 * <p>Represents a ORU_R01_ORDER_DOCUMENT group structure (a Group object).
...
public class ORU_R01_ORDER_DOCUMENT extends AbstractGroup {

    /** 
     * Creates a new ORU_R01_ORDER_DOCUMENT group
     */
    public ORU_R01_ORDER_DOCUMENT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ORU_R01_ORDER_DOCUMENT - this is probably a bug in the source code generator.", e);
       }
    }
