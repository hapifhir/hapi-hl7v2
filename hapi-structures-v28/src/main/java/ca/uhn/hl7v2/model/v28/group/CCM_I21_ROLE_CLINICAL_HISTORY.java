...
/**
 * <p>Represents a CCM_I21_ROLE_CLINICAL_HISTORY group structure (a Group object).
...
public class CCM_I21_ROLE_CLINICAL_HISTORY extends AbstractGroup {

    /** 
     * Creates a new CCM_I21_ROLE_CLINICAL_HISTORY group
     */
    public CCM_I21_ROLE_CLINICAL_HISTORY(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating CCM_I21_ROLE_CLINICAL_HISTORY - this is probably a bug in the source code generator.", e);
       }
    }
