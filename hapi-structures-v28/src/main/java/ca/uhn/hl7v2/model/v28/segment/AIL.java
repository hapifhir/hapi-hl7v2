 ...
 * <ul>
     ...
     * <li>AIL-11: Allow Substitution Code (CWE) <b>optional </b>
...
public class AIL extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(PL.class, false, 0, 0, new Object[]{ getMessage() }, "Location Resource ID");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Location Type - AIL");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Location Group");
     ...
     * AIL-11: "Allow Substitution Code" - creates it if necessary
     */
    public CWE getAil11_AllowSubstitutionCode() { 
		CWE retVal = this.getTypedField(11, 0);
		return retVal;
    }
