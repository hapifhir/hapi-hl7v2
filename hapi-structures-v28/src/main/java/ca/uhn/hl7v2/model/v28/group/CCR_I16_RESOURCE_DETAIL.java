...
/**
 * <p>Represents a CCR_I16_RESOURCE_DETAIL group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>5: CCR_I16_RESOURCE_OBSERVATION (a Group object) <b>optional repeating </b></li>
 * </ul>
 * <p>
...
public class CCR_I16_RESOURCE_DETAIL extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CCR_I16_RESOURCE_OBSERVATION.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating CCR_I16_RESOURCE_DETAIL - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public CCR_I16_RESOURCE_OBSERVATION getRESOURCE_OBSERVATION() { 
       CCR_I16_RESOURCE_OBSERVATION retVal = getTyped("RESOURCE_OBSERVATION", CCR_I16_RESOURCE_OBSERVATION.class);
       return retVal;
    }
    ...
    public CCR_I16_RESOURCE_OBSERVATION getRESOURCE_OBSERVATION(int rep) { 
       CCR_I16_RESOURCE_OBSERVATION retVal = getTyped("RESOURCE_OBSERVATION", rep, CCR_I16_RESOURCE_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<CCR_I16_RESOURCE_OBSERVATION> getRESOURCE_OBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("RESOURCE_OBSERVATION", CCR_I16_RESOURCE_OBSERVATION.class);
    } 
     ...
     */
    public void insertRESOURCE_OBSERVATION(CCR_I16_RESOURCE_OBSERVATION structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public CCR_I16_RESOURCE_OBSERVATION insertRESOURCE_OBSERVATION(int rep) throws HL7Exception { 
       return (CCR_I16_RESOURCE_OBSERVATION)super.insertRepetition("RESOURCE_OBSERVATION", rep);
    }
     ...
     */
    public CCR_I16_RESOURCE_OBSERVATION removeRESOURCE_OBSERVATION(int rep) throws HL7Exception { 
       return (CCR_I16_RESOURCE_OBSERVATION)super.removeRepetition("RESOURCE_OBSERVATION", rep);
    }
