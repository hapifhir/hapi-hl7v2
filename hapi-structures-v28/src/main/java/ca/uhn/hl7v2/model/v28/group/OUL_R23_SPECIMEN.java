 ...
 * <ul>
                         ...
                         * <li>2: OUL_R23_SPECIMEN_OBSERVATION (a Group object) <b>optional repeating </b></li>
...
public class OUL_R23_SPECIMEN extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(OUL_R23_SPECIMEN_OBSERVATION.class, false, true, false);
    ...
    public OUL_R23_SPECIMEN_OBSERVATION getSPECIMEN_OBSERVATION() { 
       OUL_R23_SPECIMEN_OBSERVATION retVal = getTyped("SPECIMEN_OBSERVATION", OUL_R23_SPECIMEN_OBSERVATION.class);
       return retVal;
    }
    ...
    public OUL_R23_SPECIMEN_OBSERVATION getSPECIMEN_OBSERVATION(int rep) { 
       OUL_R23_SPECIMEN_OBSERVATION retVal = getTyped("SPECIMEN_OBSERVATION", rep, OUL_R23_SPECIMEN_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<OUL_R23_SPECIMEN_OBSERVATION> getSPECIMEN_OBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("SPECIMEN_OBSERVATION", OUL_R23_SPECIMEN_OBSERVATION.class);
    } 
     ...
     */
    public void insertSPECIMEN_OBSERVATION(OUL_R23_SPECIMEN_OBSERVATION structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public OUL_R23_SPECIMEN_OBSERVATION insertSPECIMEN_OBSERVATION(int rep) throws HL7Exception { 
       return (OUL_R23_SPECIMEN_OBSERVATION)super.insertRepetition("SPECIMEN_OBSERVATION", rep);
    }
     ...
     */
    public OUL_R23_SPECIMEN_OBSERVATION removeSPECIMEN_OBSERVATION(int rep) throws HL7Exception { 
       return (OUL_R23_SPECIMEN_OBSERVATION)super.removeRepetition("SPECIMEN_OBSERVATION", rep);
    }
