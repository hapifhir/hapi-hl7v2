 ...
 * <ul>
                         ...
                         * <li>5: PEX_P07_OBSERVATION (a Group object) <b>optional repeating </b></li>
...
public class PEX_P07_PEX_CAUSE extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(PEX_P07_OBSERVATION.class, false, true, false);
    ...
    public PEX_P07_OBSERVATION getOBSERVATION() { 
       PEX_P07_OBSERVATION retVal = getTyped("OBSERVATION", PEX_P07_OBSERVATION.class);
       return retVal;
    }
    ...
    public PEX_P07_OBSERVATION getOBSERVATION(int rep) { 
       PEX_P07_OBSERVATION retVal = getTyped("OBSERVATION", rep, PEX_P07_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<PEX_P07_OBSERVATION> getOBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("OBSERVATION", PEX_P07_OBSERVATION.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertOBSERVATION(PEX_P07_OBSERVATION structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public PEX_P07_OBSERVATION insertOBSERVATION(int rep) throws HL7Exception { 
       return (PEX_P07_OBSERVATION)super.insertRepetition("OBSERVATION", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public PEX_P07_OBSERVATION removeOBSERVATION(int rep) throws HL7Exception { 
       return (PEX_P07_OBSERVATION)super.removeRepetition("OBSERVATION", rep);
    }
