...
/**
 * <p>Represents a CCI_I22_APPOINTMENT_HISTORY group structure (a Group object).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: SCH (Scheduling Activity Information) <b>  </b></li>
                         * <li>2: CCI_I22_RESOURCES (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
...
public class CCI_I22_APPOINTMENT_HISTORY extends AbstractGroup {
     ...
     */
    public CCI_I22_APPOINTMENT_HISTORY(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CCI_I22_RESOURCES.class, false, true, false);
    ...
    public CCI_I22_RESOURCES getRESOURCES() { 
       CCI_I22_RESOURCES retVal = getTyped("RESOURCES", CCI_I22_RESOURCES.class);
       return retVal;
    }
    ...
    public CCI_I22_RESOURCES getRESOURCES(int rep) { 
       CCI_I22_RESOURCES retVal = getTyped("RESOURCES", rep, CCI_I22_RESOURCES.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<CCI_I22_RESOURCES> getRESOURCESAll() throws HL7Exception {
     ...
     */
    public void insertRESOURCES(CCI_I22_RESOURCES structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public CCI_I22_RESOURCES insertRESOURCES(int rep) throws HL7Exception { 
       return (CCI_I22_RESOURCES)super.insertRepetition("RESOURCES", rep);
    }
     ...
     */
    public CCI_I22_RESOURCES removeRESOURCES(int rep) throws HL7Exception { 
       return (CCI_I22_RESOURCES)super.removeRepetition("RESOURCES", rep);
    }
