...
/**
 * <p>Represents a EHC_E10_PSGPSLADJ group structure (a Group object).
...
public class EHC_E10_PSGPSLADJ extends AbstractGroup {

    /** 
     * Creates a new EHC_E10_PSGPSLADJ group
     */
    public EHC_E10_PSGPSLADJ(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(PSG.class, true, false, false);
                                  this.add(EHC_E10_PRODUCT_SERVICE_LINE_INFO.class, true, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating EHC_E10_PSGPSLADJ - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * </p>
     */ 
    public java.util.List<EHC_E10_PRODUCT_SERVICE_LINE_INFO> getPRODUCT_SERVICE_LINE_INFOAll() throws HL7Exception {
