...
/**
 * <p>Represents a CCU_I20_RESOURCE_DETAIL group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>5: CCU_I20_RESOURCE_OBSERVATION (a Group object) <b>optional repeating </b></li>
 * </ul>
 * <p>
...
public class CCU_I20_RESOURCE_DETAIL extends AbstractGroup {
     ...
     */
    public CCU_I20_RESOURCE_DETAIL(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CCU_I20_RESOURCE_OBSERVATION.class, false, true, false);
    ...
    public CCU_I20_RESOURCE_OBSERVATION getRESOURCE_OBSERVATION() { 
       CCU_I20_RESOURCE_OBSERVATION retVal = getTyped("RESOURCE_OBSERVATION", CCU_I20_RESOURCE_OBSERVATION.class);
       return retVal;
    }
    ...
    public CCU_I20_RESOURCE_OBSERVATION getRESOURCE_OBSERVATION(int rep) { 
       CCU_I20_RESOURCE_OBSERVATION retVal = getTyped("RESOURCE_OBSERVATION", rep, CCU_I20_RESOURCE_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<CCU_I20_RESOURCE_OBSERVATION> getRESOURCE_OBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("RESOURCE_OBSERVATION", CCU_I20_RESOURCE_OBSERVATION.class);
    } 
     ...
     */
    public void insertRESOURCE_OBSERVATION(CCU_I20_RESOURCE_OBSERVATION structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public CCU_I20_RESOURCE_OBSERVATION insertRESOURCE_OBSERVATION(int rep) throws HL7Exception { 
       return (CCU_I20_RESOURCE_OBSERVATION)super.insertRepetition("RESOURCE_OBSERVATION", rep);
    }
     ...
     */
    public CCU_I20_RESOURCE_OBSERVATION removeRESOURCE_OBSERVATION(int rep) throws HL7Exception { 
       return (CCU_I20_RESOURCE_OBSERVATION)super.removeRepetition("RESOURCE_OBSERVATION", rep);
    }
