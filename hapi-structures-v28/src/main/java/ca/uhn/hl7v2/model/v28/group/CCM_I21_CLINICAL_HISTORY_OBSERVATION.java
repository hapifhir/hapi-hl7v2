...
/**
 * <p>Represents a CCM_I21_CLINICAL_HISTORY_OBSERVATION group structure (a Group object).
...
public class CCM_I21_CLINICAL_HISTORY_OBSERVATION extends AbstractGroup {

    /** 
     * Creates a new CCM_I21_CLINICAL_HISTORY_OBSERVATION group
     */
    public CCM_I21_CLINICAL_HISTORY_OBSERVATION(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating CCM_I21_CLINICAL_HISTORY_OBSERVATION - this is probably a bug in the source code generator.", e);
       }
    }
