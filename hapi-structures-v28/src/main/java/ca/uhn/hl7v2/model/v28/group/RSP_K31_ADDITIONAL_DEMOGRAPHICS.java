...
/**
 * <p>Represents a RSP_K31_ADDITIONAL_DEMOGRAPHICS group structure (a Group object).
...
public class RSP_K31_ADDITIONAL_DEMOGRAPHICS extends AbstractGroup {

    /** 
     * Creates a new RSP_K31_ADDITIONAL_DEMOGRAPHICS group
     */
    public RSP_K31_ADDITIONAL_DEMOGRAPHICS(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RSP_K31_ADDITIONAL_DEMOGRAPHICS - this is probably a bug in the source code generator.", e);
       }
    }
