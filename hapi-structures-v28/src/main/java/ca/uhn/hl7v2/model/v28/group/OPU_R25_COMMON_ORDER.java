...
/**
 * <p>Represents a OPU_R25_COMMON_ORDER group structure (a Group object).
...
public class OPU_R25_COMMON_ORDER extends AbstractGroup {

    /** 
     * Creates a new OPU_R25_COMMON_ORDER group
     */
    public OPU_R25_COMMON_ORDER(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating OPU_R25_COMMON_ORDER - this is probably a bug in the source code generator.", e);
       }
    }
