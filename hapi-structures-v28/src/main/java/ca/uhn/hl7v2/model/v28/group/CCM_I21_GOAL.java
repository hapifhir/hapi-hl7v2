...
/**
 * <p>Represents a CCM_I21_GOAL group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>3: CCM_I21_ROLE_GOAL (a Group object) <b>optional repeating </b></li>
                         * <li>4: CCM_I21_GOAL_OBSERVATION (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class CCM_I21_GOAL extends AbstractGroup {

    /** 
     * Creates a new CCM_I21_GOAL group
     */
    public CCM_I21_GOAL(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CCM_I21_ROLE_GOAL.class, false, true, false);
                                  this.add(CCM_I21_GOAL_OBSERVATION.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating CCM_I21_GOAL - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public CCM_I21_ROLE_GOAL getROLE_GOAL() { 
       CCM_I21_ROLE_GOAL retVal = getTyped("ROLE_GOAL", CCM_I21_ROLE_GOAL.class);
       return retVal;
    }
    ...
    public CCM_I21_ROLE_GOAL getROLE_GOAL(int rep) { 
       CCM_I21_ROLE_GOAL retVal = getTyped("ROLE_GOAL", rep, CCM_I21_ROLE_GOAL.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<CCM_I21_ROLE_GOAL> getROLE_GOALAll() throws HL7Exception {
    	return getAllAsList("ROLE_GOAL", CCM_I21_ROLE_GOAL.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertROLE_GOAL(CCM_I21_ROLE_GOAL structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public CCM_I21_ROLE_GOAL insertROLE_GOAL(int rep) throws HL7Exception { 
       return (CCM_I21_ROLE_GOAL)super.insertRepetition("ROLE_GOAL", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public CCM_I21_ROLE_GOAL removeROLE_GOAL(int rep) throws HL7Exception { 
       return (CCM_I21_ROLE_GOAL)super.removeRepetition("ROLE_GOAL", rep);
    }
    ...
    public CCM_I21_GOAL_OBSERVATION getGOAL_OBSERVATION() { 
       CCM_I21_GOAL_OBSERVATION retVal = getTyped("GOAL_OBSERVATION", CCM_I21_GOAL_OBSERVATION.class);
       return retVal;
    }
    ...
    public CCM_I21_GOAL_OBSERVATION getGOAL_OBSERVATION(int rep) { 
       CCM_I21_GOAL_OBSERVATION retVal = getTyped("GOAL_OBSERVATION", rep, CCM_I21_GOAL_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<CCM_I21_GOAL_OBSERVATION> getGOAL_OBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("GOAL_OBSERVATION", CCM_I21_GOAL_OBSERVATION.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertGOAL_OBSERVATION(CCM_I21_GOAL_OBSERVATION structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public CCM_I21_GOAL_OBSERVATION insertGOAL_OBSERVATION(int rep) throws HL7Exception { 
       return (CCM_I21_GOAL_OBSERVATION)super.insertRepetition("GOAL_OBSERVATION", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public CCM_I21_GOAL_OBSERVATION removeGOAL_OBSERVATION(int rep) throws HL7Exception { 
       return (CCM_I21_GOAL_OBSERVATION)super.removeRepetition("GOAL_OBSERVATION", rep);
    }
