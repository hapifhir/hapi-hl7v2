...
public class LCH extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(PL.class, true, 1, 0, new Object[]{ getMessage() }, "Primary Key Value - LCH");
                                  ...
                                  this.add(CWE.class, true, 1, 0, new Object[]{ getMessage() }, "Location Characteristic ID");
                                  this.add(CWE.class, true, 1, 0, new Object[]{ getMessage() }, "Location Characteristic Value - LCH");
