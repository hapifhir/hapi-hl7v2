 ...
 * <ul>
     ...
     * <li>AIP-11: Allow Substitution Code (CWE) <b>optional </b>
...
public class AIP extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(XCN.class, false, 0, 0, new Object[]{ getMessage() }, "Personnel Resource ID");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Resource Type");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Resource Group");
