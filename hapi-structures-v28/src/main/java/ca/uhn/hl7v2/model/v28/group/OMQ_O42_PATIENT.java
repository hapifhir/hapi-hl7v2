...
/**
 * <p>Represents a OMQ_O42_PATIENT group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>7: OMQ_O42_PATIENT_VISIT (a Group object) <b>optional  </b></li>
                         * <li>8: OMQ_O42_INSURANCE (a Group object) <b>optional repeating </b></li>
                         * <li>9: GT1 (Guarantor) <b>optional  </b></li>
                         * <li>10: AL1 (Patient Allergy Information) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class OMQ_O42_PATIENT extends AbstractGroup {

    /** 
     * Creates a new OMQ_O42_PATIENT group
     */
    public OMQ_O42_PATIENT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(OMQ_O42_PATIENT_VISIT.class, false, false, false);
                                  this.add(OMQ_O42_INSURANCE.class, false, true, false);
                                  this.add(GT1.class, false, false, false);
                                  this.add(AL1.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating OMQ_O42_PATIENT - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     */
    public OMQ_O42_PATIENT_VISIT getPATIENT_VISIT() { 
       OMQ_O42_PATIENT_VISIT retVal = getTyped("PATIENT_VISIT", OMQ_O42_PATIENT_VISIT.class);
       return retVal;
    }
    ...
    public OMQ_O42_INSURANCE getINSURANCE() { 
       OMQ_O42_INSURANCE retVal = getTyped("INSURANCE", OMQ_O42_INSURANCE.class);
       return retVal;
    }
    ...
    public OMQ_O42_INSURANCE getINSURANCE(int rep) { 
       OMQ_O42_INSURANCE retVal = getTyped("INSURANCE", rep, OMQ_O42_INSURANCE.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<OMQ_O42_INSURANCE> getINSURANCEAll() throws HL7Exception {
    	return getAllAsList("INSURANCE", OMQ_O42_INSURANCE.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertINSURANCE(OMQ_O42_INSURANCE structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public OMQ_O42_INSURANCE insertINSURANCE(int rep) throws HL7Exception { 
       return (OMQ_O42_INSURANCE)super.insertRepetition("INSURANCE", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public OMQ_O42_INSURANCE removeINSURANCE(int rep) throws HL7Exception { 
       return (OMQ_O42_INSURANCE)super.removeRepetition("INSURANCE", rep);
    }
