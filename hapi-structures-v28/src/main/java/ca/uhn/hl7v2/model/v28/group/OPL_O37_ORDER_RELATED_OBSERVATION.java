...
/**
 * <p>Represents a OPL_O37_ORDER_RELATED_OBSERVATION group structure (a Group object).
...
public class OPL_O37_ORDER_RELATED_OBSERVATION extends AbstractGroup {

    /** 
     * Creates a new OPL_O37_ORDER_RELATED_OBSERVATION group
     */
    public OPL_O37_ORDER_RELATED_OBSERVATION(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating OPL_O37_ORDER_RELATED_OBSERVATION - this is probably a bug in the source code generator.", e);
       }
    }
