 ...
 * <ul>
                         ...
                         * <li>6: OUL_R22_PATIENT_OBSERVATION (a Group object) <b>optional repeating </b></li>
                         * <li>7: OUL_R22_VISIT (a Group object) <b>optional  </b></li>
 * </ul>
 */
...
public class OUL_R22_PATIENT extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(OUL_R22_PATIENT_OBSERVATION.class, false, true, false);
                                  this.add(OUL_R22_VISIT.class, false, false, false);
    ...
    public OUL_R22_PATIENT_OBSERVATION getPATIENT_OBSERVATION() { 
       OUL_R22_PATIENT_OBSERVATION retVal = getTyped("PATIENT_OBSERVATION", OUL_R22_PATIENT_OBSERVATION.class);
       return retVal;
    }
    ...
    public OUL_R22_PATIENT_OBSERVATION getPATIENT_OBSERVATION(int rep) { 
       OUL_R22_PATIENT_OBSERVATION retVal = getTyped("PATIENT_OBSERVATION", rep, OUL_R22_PATIENT_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<OUL_R22_PATIENT_OBSERVATION> getPATIENT_OBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("PATIENT_OBSERVATION", OUL_R22_PATIENT_OBSERVATION.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertPATIENT_OBSERVATION(OUL_R22_PATIENT_OBSERVATION structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public OUL_R22_PATIENT_OBSERVATION insertPATIENT_OBSERVATION(int rep) throws HL7Exception { 
       return (OUL_R22_PATIENT_OBSERVATION)super.insertRepetition("PATIENT_OBSERVATION", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public OUL_R22_PATIENT_OBSERVATION removePATIENT_OBSERVATION(int rep) throws HL7Exception { 
       return (OUL_R22_PATIENT_OBSERVATION)super.removeRepetition("PATIENT_OBSERVATION", rep);
    }
