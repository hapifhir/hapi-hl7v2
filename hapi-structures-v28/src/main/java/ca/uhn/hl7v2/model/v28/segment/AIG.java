 ...
 * <ul>
     ...
     * <li>AIG-13: Allow Substitution Code (CWE) <b>optional </b>
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(SI.class, true, 1, 4, new Object[]{ getMessage() }, "Set ID - AIG");
                                              this.add(ID.class, false, 1, 1, new Object[]{ getMessage(), new Integer(206) }, "Segment Action Code");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Resource ID");
                                  this.add(CWE.class, true, 1, 0, new Object[]{ getMessage() }, "Resource Type");
                                  this.add(CWE.class, false, 0, 0, new Object[]{ getMessage() }, "Resource Group");
                                  this.add(NM.class, false, 1, 0, new Object[]{ getMessage() }, "Resource Quantity");
                                  this.add(CNE.class, false, 1, 0, new Object[]{ getMessage() }, "Resource Quantity Units");
                                  this.add(DTM.class, false, 1, 0, new Object[]{ getMessage() }, "Start Date/Time");
                                  this.add(NM.class, false, 1, 0, new Object[]{ getMessage() }, "Start Date/Time Offset");
                                  this.add(CNE.class, false, 1, 0, new Object[]{ getMessage() }, "Start Date/Time Offset Units");
                                  this.add(NM.class, false, 1, 0, new Object[]{ getMessage() }, "Duration");
                                  this.add(CNE.class, false, 1, 0, new Object[]{ getMessage() }, "Duration Units");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Allow Substitution Code");
