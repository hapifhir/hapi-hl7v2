...
/**
 * <p>Represents a CCM_I21_ROLE_PROBLEM group structure (a Group object).
...
public class CCM_I21_ROLE_PROBLEM extends AbstractGroup {

    /** 
     * Creates a new CCM_I21_ROLE_PROBLEM group
     */
    public CCM_I21_ROLE_PROBLEM(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating CCM_I21_ROLE_PROBLEM - this is probably a bug in the source code generator.", e);
       }
    }
