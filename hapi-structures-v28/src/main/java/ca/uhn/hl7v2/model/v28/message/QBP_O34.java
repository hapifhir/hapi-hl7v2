...
/**
 * <p>Represents a QBP_O34 message structure (see chapter 4.16.8). This structure contains the 
...
public class QBP_O34 extends AbstractMessage  {

    /**
     * Creates a new QBP_O34 message with DefaultModelClassFactory. 
     */ 
    public QBP_O34() { 
    ...
    /** 
     * Creates a new QBP_O34 message with custom ModelClassFactory.
     */
    public QBP_O34(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating QBP_O34 - this is probably a bug in the source code generator.", e);
       }
    }
