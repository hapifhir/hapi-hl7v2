...
/**
 * <p>Represents a CCM_I21_PATHWAY group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>3: CCM_I21_ROLE_PATHWAY (a Group object) <b>optional repeating </b></li>
                         * <li>4: CCM_I21_PATHWAY_OBSERVATION (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class CCM_I21_PATHWAY extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CCM_I21_PATHWAY_OBSERVATION.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating CCM_I21_PATHWAY - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public CCM_I21_ROLE_PATHWAY getROLE_PATHWAY() { 
       CCM_I21_ROLE_PATHWAY retVal = getTyped("ROLE_PATHWAY", CCM_I21_ROLE_PATHWAY.class);
       return retVal;
    }
    ...
    public CCM_I21_ROLE_PATHWAY getROLE_PATHWAY(int rep) { 
       CCM_I21_ROLE_PATHWAY retVal = getTyped("ROLE_PATHWAY", rep, CCM_I21_ROLE_PATHWAY.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<CCM_I21_ROLE_PATHWAY> getROLE_PATHWAYAll() throws HL7Exception {
    	return getAllAsList("ROLE_PATHWAY", CCM_I21_ROLE_PATHWAY.class);
    } 
    ...
    public CCM_I21_PATHWAY_OBSERVATION getPATHWAY_OBSERVATION() { 
       CCM_I21_PATHWAY_OBSERVATION retVal = getTyped("PATHWAY_OBSERVATION", CCM_I21_PATHWAY_OBSERVATION.class);
       return retVal;
    }
    ...
    public CCM_I21_PATHWAY_OBSERVATION getPATHWAY_OBSERVATION(int rep) { 
       CCM_I21_PATHWAY_OBSERVATION retVal = getTyped("PATHWAY_OBSERVATION", rep, CCM_I21_PATHWAY_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<CCM_I21_PATHWAY_OBSERVATION> getPATHWAY_OBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("PATHWAY_OBSERVATION", CCM_I21_PATHWAY_OBSERVATION.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertPATHWAY_OBSERVATION(CCM_I21_PATHWAY_OBSERVATION structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public CCM_I21_PATHWAY_OBSERVATION insertPATHWAY_OBSERVATION(int rep) throws HL7Exception { 
       return (CCM_I21_PATHWAY_OBSERVATION)super.insertRepetition("PATHWAY_OBSERVATION", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public CCM_I21_PATHWAY_OBSERVATION removePATHWAY_OBSERVATION(int rep) throws HL7Exception { 
       return (CCM_I21_PATHWAY_OBSERVATION)super.removeRepetition("PATHWAY_OBSERVATION", rep);
    }
