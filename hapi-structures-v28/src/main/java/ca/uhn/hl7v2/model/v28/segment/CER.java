 ...
 * <ul>
     ...
     * <li>CER-6: Signature (ED) <b>optional </b>
     ...
     * <li>CER-12: Subject ID (EI) <b>optional </b>
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Authority Key Identifier");
                                              this.add(ID.class, false, 1, 1, new Object[]{ getMessage(), new Integer(136) }, "Basic Constraint");
