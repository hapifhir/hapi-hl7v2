...
/**
 * <p>Represents a OSU_O41 message structure (see chapter 4.4.18). This structure contains the 
 ...
 * <ul>
		                 ...
		                 * <li>7: PID (Patient Identification) <b>optional </b> </li>
		                 * <li>8: ARV (Access Restriction) <b>optional repeating</b> </li>
		                 * <li>9: OSU_O41_ORDER_STATUS (a Group object) <b> repeating</b> </li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class OSU_O41 extends AbstractMessage  {

    /**
     * Creates a new OSU_O41 message with DefaultModelClassFactory. 
     */ 
    public OSU_O41() { 
    ...
    /** 
     * Creates a new OSU_O41 message with custom ModelClassFactory.
     */
    public OSU_O41(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(OSU_O41_ORDER_STATUS.class, true, true);
	       } catch(HL7Exception e) {
          log.error("Unexpected error creating OSU_O41 - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * Returns
     * the first repetition of 
     * ORDER_STATUS (a Group object) - creates it if necessary
     * </p>
     * 
     *
     */
    public OSU_O41_ORDER_STATUS getORDER_STATUS() { 
       return getTyped("ORDER_STATUS", OSU_O41_ORDER_STATUS.class);
    }
    ...
    public OSU_O41_ORDER_STATUS getORDER_STATUS(int rep) { 
       return getTyped("ORDER_STATUS", rep, OSU_O41_ORDER_STATUS.class);
    }

    /** 
     * <p>
     * Returns the number of existing repetitions of ORDER_STATUS 
     * </p>
     * 
     */ 
    public int getORDER_STATUSReps() { 
    	return getReps("ORDER_STATUS");
    } 

    /** 
     * <p>
     * Returns a non-modifiable List containing all current existing repetitions of ORDER_STATUS.
     * <p>
     * <p>
     * Note that unlike {@link #getORDER_STATUS()}, this method will not create any reps
     * if none are already present, so an empty list may be returned.
     * </p>
     * 
     */ 
    public java.util.List<OSU_O41_ORDER_STATUS> getORDER_STATUSAll() throws HL7Exception {
    	return getAllAsList("ORDER_STATUS", OSU_O41_ORDER_STATUS.class);
    } 

    /**
     * <p>
     * Inserts a specific repetition of ORDER_STATUS (a Group object)
     * </p>
     * 
     *
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertORDER_STATUS(OSU_O41_ORDER_STATUS structure, int rep) throws HL7Exception { 
       super.insertRepetition( "ORDER_STATUS", structure, rep);
    }
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public OSU_O41_ORDER_STATUS insertORDER_STATUS(int rep) throws HL7Exception { 
       return (OSU_O41_ORDER_STATUS)super.insertRepetition("ORDER_STATUS", rep);
    }


    /**
     * <p>
     * Removes a specific repetition of ORDER_STATUS (a Group object)
     * </p>
     * 
     *
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public OSU_O41_ORDER_STATUS removeORDER_STATUS(int rep) throws HL7Exception { 
       return (OSU_O41_ORDER_STATUS)super.removeRepetition("ORDER_STATUS", rep);
    }
