...
/**
 * <p>Represents a CCU_I20_PATHWAY group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>3: CCU_I20_ROLE_PATHWAY (a Group object) <b>optional repeating </b></li>
                         * <li>4: CCU_I20_PATHWAY_OBSERVATION (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class CCU_I20_PATHWAY extends AbstractGroup {

    /** 
     * Creates a new CCU_I20_PATHWAY group
     */
    public CCU_I20_PATHWAY(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CCU_I20_ROLE_PATHWAY.class, false, true, false);
                                  this.add(CCU_I20_PATHWAY_OBSERVATION.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating CCU_I20_PATHWAY - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public CCU_I20_ROLE_PATHWAY getROLE_PATHWAY() { 
       CCU_I20_ROLE_PATHWAY retVal = getTyped("ROLE_PATHWAY", CCU_I20_ROLE_PATHWAY.class);
       return retVal;
    }
    ...
    public CCU_I20_ROLE_PATHWAY getROLE_PATHWAY(int rep) { 
       CCU_I20_ROLE_PATHWAY retVal = getTyped("ROLE_PATHWAY", rep, CCU_I20_ROLE_PATHWAY.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<CCU_I20_ROLE_PATHWAY> getROLE_PATHWAYAll() throws HL7Exception {
    	return getAllAsList("ROLE_PATHWAY", CCU_I20_ROLE_PATHWAY.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertROLE_PATHWAY(CCU_I20_ROLE_PATHWAY structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public CCU_I20_ROLE_PATHWAY insertROLE_PATHWAY(int rep) throws HL7Exception { 
       return (CCU_I20_ROLE_PATHWAY)super.insertRepetition("ROLE_PATHWAY", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public CCU_I20_ROLE_PATHWAY removeROLE_PATHWAY(int rep) throws HL7Exception { 
       return (CCU_I20_ROLE_PATHWAY)super.removeRepetition("ROLE_PATHWAY", rep);
    }
    ...
    public CCU_I20_PATHWAY_OBSERVATION getPATHWAY_OBSERVATION() { 
       CCU_I20_PATHWAY_OBSERVATION retVal = getTyped("PATHWAY_OBSERVATION", CCU_I20_PATHWAY_OBSERVATION.class);
       return retVal;
    }
    ...
    public CCU_I20_PATHWAY_OBSERVATION getPATHWAY_OBSERVATION(int rep) { 
       CCU_I20_PATHWAY_OBSERVATION retVal = getTyped("PATHWAY_OBSERVATION", rep, CCU_I20_PATHWAY_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<CCU_I20_PATHWAY_OBSERVATION> getPATHWAY_OBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("PATHWAY_OBSERVATION", CCU_I20_PATHWAY_OBSERVATION.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertPATHWAY_OBSERVATION(CCU_I20_PATHWAY_OBSERVATION structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public CCU_I20_PATHWAY_OBSERVATION insertPATHWAY_OBSERVATION(int rep) throws HL7Exception { 
       return (CCU_I20_PATHWAY_OBSERVATION)super.insertRepetition("PATHWAY_OBSERVATION", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public CCU_I20_PATHWAY_OBSERVATION removePATHWAY_OBSERVATION(int rep) throws HL7Exception { 
       return (CCU_I20_PATHWAY_OBSERVATION)super.removeRepetition("PATHWAY_OBSERVATION", rep);
    }
