...
/**
 * <p>Represents a OMQ_O42_OBSERVATION group structure (a Group object).
...
public class OMQ_O42_OBSERVATION extends AbstractGroup {

    /** 
     * Creates a new OMQ_O42_OBSERVATION group
     */
    public OMQ_O42_OBSERVATION(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating OMQ_O42_OBSERVATION - this is probably a bug in the source code generator.", e);
       }
    }
