...
/**
 * <p>Represents a RSP_Z84 message structure (see chapter 5.3.1.2). This structure contains the 
 ...
 * <ul>
		                 ...
		                 * <li>8: RSP_Z84_ROW_DEFINITION (a Group object) <b>optional </b> </li>
		                 * <li>9: DSC (Continuation Pointer) <b>optional </b> </li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class RSP_Z84 extends AbstractMessage  {

    /**
     * Creates a new RSP_Z84 message with DefaultModelClassFactory. 
     */ 
    public RSP_Z84() { 
    ...
    /** 
     * Creates a new RSP_Z84 message with custom ModelClassFactory.
     */
    public RSP_Z84(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(RSP_Z84_ROW_DEFINITION.class, false, false);
	                          this.add(DSC.class, false, false);
	       } catch(HL7Exception e) {
          log.error("Unexpected error creating RSP_Z84 - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     *
     */
    public RSP_Z84_ROW_DEFINITION getROW_DEFINITION() { 
       return getTyped("ROW_DEFINITION", RSP_Z84_ROW_DEFINITION.class);
    }
