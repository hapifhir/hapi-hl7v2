...
/**
 * <p>Represents a OUL_R24_ORDER_DOCUMENT group structure (a Group object).
...
public class OUL_R24_ORDER_DOCUMENT extends AbstractGroup {

    /** 
     * Creates a new OUL_R24_ORDER_DOCUMENT group
     */
    public OUL_R24_ORDER_DOCUMENT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating OUL_R24_ORDER_DOCUMENT - this is probably a bug in the source code generator.", e);
       }
    }
