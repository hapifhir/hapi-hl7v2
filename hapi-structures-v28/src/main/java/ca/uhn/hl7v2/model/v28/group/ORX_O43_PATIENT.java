...
/**
 * <p>Represents a ORX_O43_PATIENT group structure (a Group object).
...
public class ORX_O43_PATIENT extends AbstractGroup {

    /** 
     * Creates a new ORX_O43_PATIENT group
     */
    public ORX_O43_PATIENT(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ORX_O43_PATIENT - this is probably a bug in the source code generator.", e);
       }
    }
