...
public class OM3 extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Preferred Coding System");
                                  this.add(CWE.class, false, 0, 0, new Object[]{ getMessage() }, "Valid Coded \"Answers\"");
                                  this.add(CWE.class, false, 0, 0, new Object[]{ getMessage() }, "Normal Text/Codes for Categorical Observations");
                                  this.add(CWE.class, false, 0, 0, new Object[]{ getMessage() }, "Abnormal Text/Codes for Categorical Observations");
                                  this.add(CWE.class, false, 0, 0, new Object[]{ getMessage() }, "Critical Text/Codes for Categorical Observations");
