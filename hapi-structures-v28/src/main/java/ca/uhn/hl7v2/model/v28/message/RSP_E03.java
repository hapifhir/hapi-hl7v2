 ...
 * <ul>
		                 ...
		                 * <li>8: IPR (Invoice Processing Results) <b>optional repeating</b> </li>
 * </ul>
 */
...
public class RSP_E03 extends AbstractMessage  {
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(IPR.class, false, true);
	       } catch(HL7Exception e) {
          log.error("Unexpected error creating RSP_E03 - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public IPR getIPR(int rep) { 
       return getTyped("IPR", rep, IPR.class);
    }
