...
/**
 * <p>Represents a VXU_V04_PATIENT_VISIT group structure (a Group object).
...
public class VXU_V04_PATIENT_VISIT extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating VXU_V04_PATIENT_VISIT - this is probably a bug in the source code generator.", e);
       }
    }
