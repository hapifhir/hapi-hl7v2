 ...
 * <ul>
                         ...
                         * <li>5: AUT (Authorization Information) <b>optional repeating </b></li>
                         * <li>6: RF1 (Referral Information) <b>optional repeating </b></li>
 * </ul>
 */
...
public class ADT_A05_INSURANCE extends AbstractGroup {
    ...
    public AUT getAUT(int rep) { 
       AUT retVal = getTyped("AUT", rep, AUT.class);
       return retVal;
    }
    ...
    /** 
     * <p>
     * Returns a non-modifiable List containing all current existing repetitions of AUT.
     * <p>
     * <p>
     * Note that unlike {@link #getAUT()}, this method will not create any reps
     * if none are already present, so an empty list may be returned.
     * </p>
     */ 
    public java.util.List<AUT> getAUTAll() throws HL7Exception {
    	return getAllAsList("AUT", AUT.class);
    } 

    /**
     * Inserts a specific repetition of AUT (Authorization Information)
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertAUT(AUT structure, int rep) throws HL7Exception { 
       super.insertRepetition("AUT", structure, rep);
    }
    ...
    /**
     * Removes a specific repetition of AUT (Authorization Information)
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    ...
    public RF1 getRF1(int rep) { 
       RF1 retVal = getTyped("RF1", rep, RF1.class);
       return retVal;
    }
