...
public class MSH extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(ST.class, true, 1, 5, new Object[]{ getMessage() }, "Encoding Characters");
                                  this.add(HD.class, false, 1, 0, new Object[]{ getMessage() }, "Sending Application");
                                  this.add(HD.class, false, 1, 0, new Object[]{ getMessage() }, "Sending Facility");
                                  this.add(HD.class, false, 1, 0, new Object[]{ getMessage() }, "Receiving Application");
                                  this.add(HD.class, false, 1, 0, new Object[]{ getMessage() }, "Receiving Facility");
                                  this.add(DTM.class, true, 1, 0, new Object[]{ getMessage() }, "Date/Time of Message");
                                  ...
                                  this.add(ST.class, false, 1, 0, new Object[]{ getMessage() }, "Continuation Pointer");
                                              ...
                                              this.add(ID.class, false, 0, 15, new Object[]{ getMessage(), new Integer(211) }, "Character Set");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Principal Language Of Message");
                                              this.add(ID.class, false, 1, 13, new Object[]{ getMessage(), new Integer(356) }, "Alternate Character Set Handling Scheme");
                                  this.add(EI.class, false, 0, 0, new Object[]{ getMessage() }, "Message Profile Identifier");
                                  this.add(XON.class, false, 1, 0, new Object[]{ getMessage() }, "Sending Responsible Organization");
                                  this.add(XON.class, false, 1, 0, new Object[]{ getMessage() }, "Receiving Responsible Organization");
                                  this.add(HD.class, false, 1, 0, new Object[]{ getMessage() }, "Sending Network Address");
                                  this.add(HD.class, false, 1, 0, new Object[]{ getMessage() }, "Receiving Network Address");
