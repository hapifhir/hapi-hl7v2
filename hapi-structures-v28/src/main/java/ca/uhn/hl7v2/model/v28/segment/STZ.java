...
public class STZ extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Sterilization Type");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Sterilization Cycle");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Maintenance Cycle");
                                  this.add(CWE.class, false, 1, 0, new Object[]{ getMessage() }, "Maintenance Type");
