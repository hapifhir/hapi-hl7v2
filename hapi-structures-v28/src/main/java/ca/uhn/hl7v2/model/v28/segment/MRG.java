 ...
 * <ul>
     ...
     * <li>MRG-2: Prior Alternate Patient ID (NULLDT) <b>optional </b>
     * <li>MRG-3: Prior Patient Account Number (CX) <b>optional </b>
     * <li>MRG-4: Prior Patient ID (NULLDT) <b>optional </b>
     * <li>MRG-5: Prior Visit Number (CX) <b>optional </b>
     * <li>MRG-6: Prior Alternate Visit ID (CX) <b>optional repeating</b>
...
public class MRG extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(CX.class, true, 0, 0, new Object[]{ getMessage() }, "Prior Patient Identifier List");
                                  this.add(NULLDT.class, false, 1, 0, new Object[]{ getMessage() }, "Prior Alternate Patient ID");
                                  this.add(CX.class, false, 1, 0, new Object[]{ getMessage() }, "Prior Patient Account Number");
                                  this.add(NULLDT.class, false, 1, 0, new Object[]{ getMessage() }, "Prior Patient ID");
                                  this.add(CX.class, false, 1, 0, new Object[]{ getMessage() }, "Prior Visit Number");
                                  this.add(CX.class, false, 0, 0, new Object[]{ getMessage() }, "Prior Alternate Visit ID");
                                  this.add(XPN.class, false, 0, 0, new Object[]{ getMessage() }, "Prior Patient Name");
     ...
     */
    public NULLDT getPriorAlternatePatientID() { 
     ...
     * MRG-2: "Prior Alternate Patient ID" - creates it if necessary
     */
    public NULLDT getMrg2_PriorAlternatePatientID() { 
		NULLDT retVal = this.getTypedField(2, 0);
		return retVal;
    }
     ...
     */
    public NULLDT getPriorPatientID() { 
     ...
     * MRG-4: "Prior Patient ID" - creates it if necessary
     */
    public NULLDT getMrg4_PriorPatientID() { 
		NULLDT retVal = this.getTypedField(4, 0);
		return retVal;
    }
    ...
    public CX[] getPriorAlternateVisitID() {
    	CX[] retVal = this.getTypedField(6, new CX[0]);
    	return retVal;
    }
    ...
    /**
     * Returns a count of the current number of repetitions of Prior Alternate Visit ID (MRG-6).
     * This method does not create a repetition, so if no repetitions have currently been defined or accessed,
     * it will return zero.
     */
    public int getPriorAlternateVisitIDReps() {
    ...
    public CX getPriorAlternateVisitID(int rep) { 
		CX retVal = this.getTypedField(6, rep);
		return retVal;
    }
     ...
     * @param rep The repetition index (0-indexed)
     */
    public CX getMrg6_PriorAlternateVisitID(int rep) { 
		CX retVal = this.getTypedField(6, rep);
		return retVal;
    }
     ...
     * it will return zero.
     */
    public int getMrg6_PriorAlternateVisitIDReps() {
    	return this.getReps(6);
    }
    ...
    /**
     * Inserts a repetition of
     * MRG-6: "Prior Alternate Visit ID" at a specific index
     *
     * @param rep The repetition index (0-indexed)
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public CX insertPriorAlternateVisitID(int rep) throws HL7Exception { 
        return (CX) super.insertRepetition(6, rep);
    }
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public CX insertMrg6_PriorAlternateVisitID(int rep) throws HL7Exception { 
        return (CX) super.insertRepetition(6, rep);
    }
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public CX removePriorAlternateVisitID(int rep) throws HL7Exception { 
        return (CX) super.removeRepetition(6, rep);
    }
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public CX removeMrg6_PriorAlternateVisitID(int rep) throws HL7Exception { 
        return (CX) super.removeRepetition(6, rep);
    }
