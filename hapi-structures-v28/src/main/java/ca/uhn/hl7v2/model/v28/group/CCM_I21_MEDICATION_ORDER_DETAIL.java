...
/**
 * <p>Represents a CCM_I21_MEDICATION_ORDER_DETAIL group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>4: CCM_I21_MEDICATION_ORDER_OBSERVATION (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class CCM_I21_MEDICATION_ORDER_DETAIL extends AbstractGroup {

    /** 
     * Creates a new CCM_I21_MEDICATION_ORDER_DETAIL group
     */
    public CCM_I21_MEDICATION_ORDER_DETAIL(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CCM_I21_MEDICATION_ORDER_OBSERVATION.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating CCM_I21_MEDICATION_ORDER_DETAIL - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public CCM_I21_MEDICATION_ORDER_OBSERVATION getMEDICATION_ORDER_OBSERVATION() { 
       CCM_I21_MEDICATION_ORDER_OBSERVATION retVal = getTyped("MEDICATION_ORDER_OBSERVATION", CCM_I21_MEDICATION_ORDER_OBSERVATION.class);
       return retVal;
    }
    ...
    public CCM_I21_MEDICATION_ORDER_OBSERVATION getMEDICATION_ORDER_OBSERVATION(int rep) { 
       CCM_I21_MEDICATION_ORDER_OBSERVATION retVal = getTyped("MEDICATION_ORDER_OBSERVATION", rep, CCM_I21_MEDICATION_ORDER_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<CCM_I21_MEDICATION_ORDER_OBSERVATION> getMEDICATION_ORDER_OBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("MEDICATION_ORDER_OBSERVATION", CCM_I21_MEDICATION_ORDER_OBSERVATION.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertMEDICATION_ORDER_OBSERVATION(CCM_I21_MEDICATION_ORDER_OBSERVATION structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public CCM_I21_MEDICATION_ORDER_OBSERVATION insertMEDICATION_ORDER_OBSERVATION(int rep) throws HL7Exception { 
       return (CCM_I21_MEDICATION_ORDER_OBSERVATION)super.insertRepetition("MEDICATION_ORDER_OBSERVATION", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public CCM_I21_MEDICATION_ORDER_OBSERVATION removeMEDICATION_ORDER_OBSERVATION(int rep) throws HL7Exception { 
       return (CCM_I21_MEDICATION_ORDER_OBSERVATION)super.removeRepetition("MEDICATION_ORDER_OBSERVATION", rep);
    }
