 ...
 * <li>Second Alternate Formatted Text (FT)
...
public class CF extends AbstractComposite {
     ...
     * casting and handling an exception.
     */
    public ST getCf7_CodingSystemVersionID() {
       return getTyped(6, ST.class);
    }
     ...
     * casting and handling an exception.
     */
    public ST getCf8_AlternateCodingSystemVersionID() {
       return getTyped(7, ST.class);
    }
     ...
     * casting and handling an exception.
     */
    public ST getCf10_SecondAlternateIdentifier() {
       return getTyped(9, ST.class);
    }


    /**
     * Returns Second Alternate Formatted Text (component 11).  This is a convenience method that saves you from 
     * casting and handling an exception.
     */
    public FT getSecondAlternateFormattedText() {
       return getTyped(10, FT.class);
    }
     ...
     * casting and handling an exception.
     */
    public FT getCf11_SecondAlternateFormattedText() {
       return getTyped(10, FT.class);
    }
     ...
     * casting and handling an exception.
     */
    public ID getCf12_NameOfSecondAlternateCodingSystem() {
       return getTyped(11, ID.class);
    }
     ...
     * casting and handling an exception.
     */
    public ST getCf13_SecondAlternateCodingSystemVersionID() {
       return getTyped(12, ST.class);
    }
     ...
     * casting and handling an exception.
     */
    public ST getCf14_CodingSystemOID() {
       return getTyped(13, ST.class);
    }
     ...
     * casting and handling an exception.
     */
    public DTM getCf16_ValueSetVersionID() {
       return getTyped(15, DTM.class);
    }
     ...
     * casting and handling an exception.
     */
    public ST getCf17_AlternateCodingSystemOID() {
       return getTyped(16, ST.class);
    }
     ...
     * casting and handling an exception.
     */
    public ST getCf18_AlternateValueSetOID() {
       return getTyped(17, ST.class);
    }
     ...
     * casting and handling an exception.
     */
    public DTM getCf19_AlternateValueSetVersionID() {
       return getTyped(18, DTM.class);
    }
     ...
     * casting and handling an exception.
     */
    public ST getCf20_SecondAlternateCodingSystemOID() {
       return getTyped(19, ST.class);
    }
     ...
     * casting and handling an exception.
     */
    public ST getCf21_SecondAlternateValueSetOID() {
       return getTyped(20, ST.class);
    }
     ...
     * casting and handling an exception.
     */
    public DTM getCf22_SecondAlternateValueSetVersionID() {
       return getTyped(21, DTM.class);
    }
