...
/**
 * <p>Represents a CCU_I20_MEDICATION_ORDER_DETAIL group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>4: CCU_I20_MEDICATION_ORDER_OBSERVATION (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class CCU_I20_MEDICATION_ORDER_DETAIL extends AbstractGroup {

    /** 
     * Creates a new CCU_I20_MEDICATION_ORDER_DETAIL group
     */
    public CCU_I20_MEDICATION_ORDER_DETAIL(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CCU_I20_MEDICATION_ORDER_OBSERVATION.class, false, true, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating CCU_I20_MEDICATION_ORDER_DETAIL - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public CCU_I20_MEDICATION_ORDER_OBSERVATION getMEDICATION_ORDER_OBSERVATION() { 
       CCU_I20_MEDICATION_ORDER_OBSERVATION retVal = getTyped("MEDICATION_ORDER_OBSERVATION", CCU_I20_MEDICATION_ORDER_OBSERVATION.class);
       return retVal;
    }
    ...
    public CCU_I20_MEDICATION_ORDER_OBSERVATION getMEDICATION_ORDER_OBSERVATION(int rep) { 
       CCU_I20_MEDICATION_ORDER_OBSERVATION retVal = getTyped("MEDICATION_ORDER_OBSERVATION", rep, CCU_I20_MEDICATION_ORDER_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<CCU_I20_MEDICATION_ORDER_OBSERVATION> getMEDICATION_ORDER_OBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("MEDICATION_ORDER_OBSERVATION", CCU_I20_MEDICATION_ORDER_OBSERVATION.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertMEDICATION_ORDER_OBSERVATION(CCU_I20_MEDICATION_ORDER_OBSERVATION structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public CCU_I20_MEDICATION_ORDER_OBSERVATION insertMEDICATION_ORDER_OBSERVATION(int rep) throws HL7Exception { 
       return (CCU_I20_MEDICATION_ORDER_OBSERVATION)super.insertRepetition("MEDICATION_ORDER_OBSERVATION", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public CCU_I20_MEDICATION_ORDER_OBSERVATION removeMEDICATION_ORDER_OBSERVATION(int rep) throws HL7Exception { 
       return (CCU_I20_MEDICATION_ORDER_OBSERVATION)super.removeRepetition("MEDICATION_ORDER_OBSERVATION", rep);
    }
