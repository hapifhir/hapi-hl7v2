...
public class UB2 extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(ST.class, false, 2, 12, new Object[]{ getMessage() }, "Uniform Billing Locator 11 (state)");
                                  this.add(ST.class, false, 1, 5, new Object[]{ getMessage() }, "Uniform Billing Locator 31 (national)");
                                  this.add(ST.class, false, 3, 23, new Object[]{ getMessage() }, "Document Control Number");
                                  this.add(ST.class, false, 23, 4, new Object[]{ getMessage() }, "Uniform Billing Locator 49 (national)");
                                  this.add(ST.class, false, 5, 14, new Object[]{ getMessage() }, "Uniform Billing Locator 56 (state)");
                                  this.add(ST.class, false, 1, 27, new Object[]{ getMessage() }, "Uniform Billing Locator 57 (sational)");
                                  this.add(ST.class, false, 2, 2, new Object[]{ getMessage() }, "Uniform Billing Locator 78 (state)");
