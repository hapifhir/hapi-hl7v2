...
/**
 * <p>Represents a ADT_A44 message structure (see chapter 3.3.44). This structure contains the 
 ...
 * <ul>
		                 ...
		                 * <li>5: ADT_A44_PATIENT (a Group object) <b> repeating</b> </li>
 * </ul>
 */
...
public class ADT_A44 extends AbstractMessage  {
    ...
    private void init(ModelClassFactory factory) {
       try {
                          this.add(MSH.class, true, false);
	                          ...
	                          this.add(ADT_A44_PATIENT.class, true, true);
	       } catch(HL7Exception e) {
          log.error("Unexpected error creating ADT_A44 - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public ADT_A44_PATIENT getPATIENT() { 
       return getTyped("PATIENT", ADT_A44_PATIENT.class);
    }
    ...
    public ADT_A44_PATIENT getPATIENT(int rep) { 
       return getTyped("PATIENT", rep, ADT_A44_PATIENT.class);
    }
     ...
     * 
     */ 
    public java.util.List<ADT_A44_PATIENT> getPATIENTAll() throws HL7Exception {
    	return getAllAsList("PATIENT", ADT_A44_PATIENT.class);
    } 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public void insertPATIENT(ADT_A44_PATIENT structure, int rep) throws HL7Exception { 
     ...
     * @see AbstractGroup#insertRepetition(Structure, int) 
     */
    public ADT_A44_PATIENT insertPATIENT(int rep) throws HL7Exception { 
       return (ADT_A44_PATIENT)super.insertRepetition("PATIENT", rep);
    }
     ...
     * @see AbstractGroup#removeRepetition(String, int) 
     */
    public ADT_A44_PATIENT removePATIENT(int rep) throws HL7Exception { 
       return (ADT_A44_PATIENT)super.removeRepetition("PATIENT", rep);
    }
