...
public class TQ1 extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(RPT.class, false, 0, 0, new Object[]{ getMessage() }, "Repeat Pattern");
                                  this.add(TM.class, false, 0, 0, new Object[]{ getMessage() }, "Explicit Time");
                                  this.add(CQ.class, false, 0, 0, new Object[]{ getMessage() }, "Relative Time and Units");
                                  ...
                                  this.add(CWE.class, false, 0, 0, new Object[]{ getMessage() }, "Priority");
                                  ...
                                  this.add(TX.class, false, 1, 0, new Object[]{ getMessage() }, "Text instruction");
                                              this.add(ID.class, false, 1, 1, new Object[]{ getMessage(), new Integer(472) }, "Conjunction");
                                  this.add(CQ.class, false, 1, 0, new Object[]{ getMessage() }, "Occurrence duration");
                                  this.add(NM.class, false, 1, 0, new Object[]{ getMessage() }, "Total occurrences");
