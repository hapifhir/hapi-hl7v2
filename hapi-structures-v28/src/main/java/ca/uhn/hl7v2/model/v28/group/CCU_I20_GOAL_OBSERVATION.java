...
/**
 * <p>Represents a CCU_I20_GOAL_OBSERVATION group structure (a Group object).
...
public class CCU_I20_GOAL_OBSERVATION extends AbstractGroup {

    /** 
     * Creates a new CCU_I20_GOAL_OBSERVATION group
     */
    public CCU_I20_GOAL_OBSERVATION(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating CCU_I20_GOAL_OBSERVATION - this is probably a bug in the source code generator.", e);
       }
    }
