...
/**
 * <p>Represents a CCI_I22_GOAL group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>3: CCI_I22_ROLE_GOAL (a Group object) <b>optional repeating </b></li>
                         * <li>4: CCI_I22_GOAL_OBSERVATION (a Group object) <b>optional repeating </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class CCI_I22_GOAL extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating CCI_I22_GOAL - this is probably a bug in the source code generator.", e);
       }
    }
    ...
    public CCI_I22_ROLE_GOAL getROLE_GOAL() { 
       CCI_I22_ROLE_GOAL retVal = getTyped("ROLE_GOAL", CCI_I22_ROLE_GOAL.class);
       return retVal;
    }
    ...
    public CCI_I22_ROLE_GOAL getROLE_GOAL(int rep) { 
       CCI_I22_ROLE_GOAL retVal = getTyped("ROLE_GOAL", rep, CCI_I22_ROLE_GOAL.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<CCI_I22_ROLE_GOAL> getROLE_GOALAll() throws HL7Exception {
    	return getAllAsList("ROLE_GOAL", CCI_I22_ROLE_GOAL.class);
    } 
    ...
    public CCI_I22_GOAL_OBSERVATION getGOAL_OBSERVATION() { 
       CCI_I22_GOAL_OBSERVATION retVal = getTyped("GOAL_OBSERVATION", CCI_I22_GOAL_OBSERVATION.class);
       return retVal;
    }
    ...
    public CCI_I22_GOAL_OBSERVATION getGOAL_OBSERVATION(int rep) { 
       CCI_I22_GOAL_OBSERVATION retVal = getTyped("GOAL_OBSERVATION", rep, CCI_I22_GOAL_OBSERVATION.class);
       return retVal;
    }
     ...
     * </p>
     */ 
    public java.util.List<CCI_I22_GOAL_OBSERVATION> getGOAL_OBSERVATIONAll() throws HL7Exception {
    	return getAllAsList("GOAL_OBSERVATION", CCI_I22_GOAL_OBSERVATION.class);
    } 
