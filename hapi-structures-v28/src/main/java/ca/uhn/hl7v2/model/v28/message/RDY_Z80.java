...
/**
 * <p>Represents a RDY_Z80 message structure (see chapter 5.9.6.1). This structure contains the 
...
public class RDY_Z80 extends AbstractMessage  {

    /**
     * Creates a new RDY_Z80 message with DefaultModelClassFactory. 
     */ 
    public RDY_Z80() { 
    ...
    /** 
     * Creates a new RDY_Z80 message with custom ModelClassFactory.
     */
    public RDY_Z80(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating RDY_Z80 - this is probably a bug in the source code generator.", e);
       }
    }
