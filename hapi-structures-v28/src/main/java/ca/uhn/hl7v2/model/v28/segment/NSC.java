 ...
 * <ul>
     * <li>NSC-1: Application Change Type (CWE) <b> </b>
...
public class NSC extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(CWE.class, true, 1, 0, new Object[]{ getMessage() }, "Application Change Type");
                                  ...
                                  this.add(HD.class, false, 1, 0, new Object[]{ getMessage() }, "Current Application");
                                  this.add(HD.class, false, 1, 0, new Object[]{ getMessage() }, "Current Facility");
                                  ...
                                  this.add(HD.class, false, 1, 0, new Object[]{ getMessage() }, "New Application");
                                  this.add(HD.class, false, 1, 0, new Object[]{ getMessage() }, "New Facility");
     ...
     */
    public CWE getApplicationChangeType() { 
     ...
     * NSC-1: "Application Change Type" - creates it if necessary
     */
    public CWE getNsc1_ApplicationChangeType() { 
		CWE retVal = this.getTypedField(1, 0);
		return retVal;
    }
