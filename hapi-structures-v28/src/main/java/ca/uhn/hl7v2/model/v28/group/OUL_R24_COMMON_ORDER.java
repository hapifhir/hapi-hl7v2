...
/**
 * <p>Represents a OUL_R24_COMMON_ORDER group structure (a Group object).
 ...
 * <ul>
                         ...
                         * <li>3: OUL_R24_ORDER_DOCUMENT (a Group object) <b>optional  </b></li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class OUL_R24_COMMON_ORDER extends AbstractGroup {

    /** 
     * Creates a new OUL_R24_COMMON_ORDER group
     */
    public OUL_R24_COMMON_ORDER(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(OUL_R24_ORDER_DOCUMENT.class, false, false, false);
       } catch(HL7Exception e) {
          log.error("Unexpected error creating OUL_R24_COMMON_ORDER - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     */
    public OUL_R24_ORDER_DOCUMENT getORDER_DOCUMENT() { 
       OUL_R24_ORDER_DOCUMENT retVal = getTyped("ORDER_DOCUMENT", OUL_R24_ORDER_DOCUMENT.class);
       return retVal;
    }
