...
/**
 * <p>Represents a CCR_I16_CLINICAL_HISTORY_OBSERVATION group structure (a Group object).
...
public class CCR_I16_CLINICAL_HISTORY_OBSERVATION extends AbstractGroup {

    /** 
     * Creates a new CCR_I16_CLINICAL_HISTORY_OBSERVATION group
     */
    public CCR_I16_CLINICAL_HISTORY_OBSERVATION(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating CCR_I16_CLINICAL_HISTORY_OBSERVATION - this is probably a bug in the source code generator.", e);
       }
    }
