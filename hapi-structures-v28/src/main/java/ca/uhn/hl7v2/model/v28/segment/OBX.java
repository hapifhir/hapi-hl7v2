...
public class OBX extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(ST.class, true, 1, 0, new Object[]{ getMessage() }, "Observation Sub-ID");
                                  ...
                                  this.add(XCN.class, false, 1, 0, new Object[]{ getMessage() }, "Performing Organization Medical Director");
                                              this.add(ID.class, false, 1, 10, new Object[]{ getMessage(), new Integer(909) }, "Patient Results Release Category");
