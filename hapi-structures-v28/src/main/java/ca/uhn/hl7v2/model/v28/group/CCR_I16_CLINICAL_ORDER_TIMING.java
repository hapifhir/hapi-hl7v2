...
/**
 * <p>Represents a CCR_I16_CLINICAL_ORDER_TIMING group structure (a Group object).
...
public class CCR_I16_CLINICAL_ORDER_TIMING extends AbstractGroup {

    /** 
     * Creates a new CCR_I16_CLINICAL_ORDER_TIMING group
     */
    public CCR_I16_CLINICAL_ORDER_TIMING(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating CCR_I16_CLINICAL_ORDER_TIMING - this is probably a bug in the source code generator.", e);
       }
    }
