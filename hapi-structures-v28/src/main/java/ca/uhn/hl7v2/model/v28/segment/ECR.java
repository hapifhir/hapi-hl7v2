...
public class ECR extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(CWE.class, true, 1, 0, new Object[]{ getMessage() }, "Command Response");
                                  this.add(DTM.class, true, 1, 0, new Object[]{ getMessage() }, "Date/Time Completed");
                                  this.add(TX.class, false, 0, 0, new Object[]{ getMessage() }, "Command Response Parameters");
