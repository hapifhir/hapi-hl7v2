...
/**
 * <p>Represents a CCR_I16_ROLE_PROBLEM group structure (a Group object).
...
public class CCR_I16_ROLE_PROBLEM extends AbstractGroup {

    /** 
     * Creates a new CCR_I16_ROLE_PROBLEM group
     */
    public CCR_I16_ROLE_PROBLEM(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating CCR_I16_ROLE_PROBLEM - this is probably a bug in the source code generator.", e);
       }
    }
